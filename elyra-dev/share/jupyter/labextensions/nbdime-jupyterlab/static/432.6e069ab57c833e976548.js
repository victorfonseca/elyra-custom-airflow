...
(self.webpackChunknbdime_jupyterlab =
  ...
  [432],
  {
    ...
    2591: (e) => {
      ...
      function r(e, r) {
        for (var d = {}, i = [], a = 0; a < e.length; a++) {
          var l = e[a],
            p = r.base ? l[0] + r.base : l[0],
            c = d[p] || 0,
            m = ''.concat(p, ' ').concat(c);
          d[p] = c + 1;
          var f = o(m),
          ...
          if (-1 !== f) n[f].references++, n[f].updater(g);
          else {
            var u = t(g, r);
            (r.byIndex = a),
              n.splice(a, 0, { identifier: m, updater: u, references: 1 });
          }
          i.push(m);
        }
        return i;
      ...
      e.exports = function (e, t) {
        ...
        return function (e) {
          ...
          for (var l = r(e, t), p = 0; p < d.length; p++) {
            var c = o(d[p]);
