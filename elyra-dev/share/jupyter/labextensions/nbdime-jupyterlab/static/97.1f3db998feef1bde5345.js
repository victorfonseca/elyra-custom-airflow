(self.webpackChunknbdime_jupyterlab =
  ...
  [97],
  {
    1692: function (e, t, r) {
      ...
      !(function (e) {
        ...
        function r(...e) {
          ...
          const r = '' === t.protocol && t.slashes;
          r && (t = (0, i.default)(e[0], 'https:' + e[0]));
          const n = `${r ? '' : t.protocol}${t.slashes ? '//' : ''}${t.auth}${t.auth ? '@' : ''}${t.host}`,
            s = o.posix.join(
              `${n && '/' !== t.pathname[0] ? '/' : ''}${t.pathname}`,
              ...e.slice(1)
            );
          return `${n}${'.' === s ? '' : s}`;
        }
        (e.parse = t),
          ...
          (e.encodeParts = function (e) {
            return r(...e.split('/').map(encodeURIComponent));
          }),
          (e.objectToQueryString = function (e) {
            ...
            return t.length
              ? '?' +
                  t
                    .map((t) => {
                      const r = encodeURIComponent(String(e[t]));
                      return t + (r ? '=' + r : '');
                    })
                    .join('&')
              : '';
          ...
          (e.queryStringToObject = function (e) {
            return e
              ...
              .reduce((e, t) => {
                const [r, n] = t.split('=');
                return r.length > 0 && (e[r] = decodeURIComponent(n || '')), e;
              }, {});
          }),
          (e.isLocal = function (e) {
            const { protocol: r } = t(e);
            return (
              (!r || 0 !== e.toLowerCase().indexOf(r)) && 0 !== e.indexOf('/')
            );
          });
      })(t.URLExt || (t.URLExt = {}));
    },
    5172: (e, t, r) => {
      'use strict';
      var n = 'undefined' != typeof JSON ? JSON : r(6998),
        o =
          Array.isArray ||
          function (e) {
      ...
      e.exports = function (e, t) {
        ...
        return (function e(t, s, f, h) {
          ...
          if (
            ...
            l.push(f);
            var v = i(f).sort(u && u(f));
            for (g = [], m = 0; m < v.length; m++) {
              var b = e(f, (s = v[m]), f[s], h + 1);
              if (b) {
                var w = n.stringify(s) + d + b;
                g.push(p + r + w);
              }
            }
            return l.splice(l.indexOf(f), 1), '{' + g.join(',') + p + '}';
          }
        })({ '': e }, '', e, 0);
      };
    },
    6998: (e, t, r) => {
      'use strict';
      (t.parse = r(6921)), (t.stringify = r(9191));
    },
    6921: (e) => {
      'use strict';
      var t,
      ...
      function s(e) {
        return (
          e && e !== r && i("Expected '" + e + "' instead of '" + r + "'"),
          (r = n.charAt(t)),
          (t += 1),
          r
        );
                ...
                if (s && 'object' == typeof s)
                  for (n in l)
                    Object.prototype.hasOwnProperty.call(s, n) &&
                      (void 0 === (i = e(s, n)) ? delete s[n] : (s[n] = i));
                return o.call(t, r, s);
              })({ '': s }, '')
            : s
        );
        ...
        switch (
          ...
          case 'object':
            ...
            if (
              ...
              for (l = p.length, i = 0; i < l; i += 1) f[i] = a(i, p) || 'null';
              return (
                (u =
                  0 === f.length
                    ? '[]'
    ...
    9942: (e, t, r) => {
                ...
                if (n.length > 2) {
                  ...
                  if (c !== n.length - 1) {
                    -1 === c
                      ? ((n = ''), (o = 0))
                      : (o =
                          (n = n.slice(0, c)).length - 1 - n.lastIndexOf('/')),
                      (i = a),
                      (s = 0);
                    continue;
                  }
      ...
      var s = {
        resolve: function () {
          for (
            var e, t = '', r = !1, s = arguments.length - 1;
            s >= -1 && !r;
            s--
          ) {
            var a;
            s >= 0
              ? (a = arguments[s])
              : (void 0 === e && (e = n.cwd()), (a = e)),
              o(a),
              0 !== a.length &&
                ((t = a + '/' + t), (r = 47 === a.charCodeAt(0)));
          }
          return (
            (t = i(t, !r)),
        ...
        relative: function (e, t) {
          ...
          for (
            var n = e.length, i = n - r, a = 1;
            a < t.length && 47 === t.charCodeAt(a);
            ++a
          );
          for (
            var c = t.length - a, u = i < c ? i : c, l = -1, f = 0;
            f <= u;
            ++f
          ) {
            if (f === u) {
              if (c > u) {
                if (47 === t.charCodeAt(a + f)) return t.slice(a + f + 1);
                if (0 === f) return t.slice(a + f);
              } else
                i > u &&
                  (47 === e.charCodeAt(r + f) ? (l = f) : 0 === f && (l = 0));
              break;
            }
            var h = e.charCodeAt(r + f);
            if (h !== t.charCodeAt(a + f)) break;
            47 === h && (l = f);
          }
          var p = '';
          for (f = r + l + 1; f <= n; ++f)
          ...
          return p.length > 0
            ? p + t.slice(a + l)
            : ((a += l), 47 === t.charCodeAt(a) && ++a, t.slice(a));
        },
        ...
        basename: function (e, t) {
          ...
          if (void 0 !== t && t.length > 0 && t.length <= e.length) {
            ...
            return (
              n === i ? (i = c) : -1 === i && (i = e.length), e.slice(n, i)
            );
          }
          for (r = e.length - 1; r >= 0; --r)
        ...
        extname: function (e) {
          o(e);
          for (
            var t = -1, r = 0, n = -1, i = !0, s = 0, a = e.length - 1;
            a >= 0;
            --a
          ) {
        ...
        parse: function (e) {
          ...
          i ? ((t.root = '/'), (r = 1)) : (r = 0);
          for (
            var s = -1, a = 0, c = -1, u = !0, l = e.length - 1, f = 0;
            l >= r;
            --l
          )
          ...
          return (
            ...
            (1 === f && s === c - 1 && s === a + 1)
              ? -1 !== c &&
                (t.base = t.name = 0 === a && i ? e.slice(1, c) : e.slice(a, c))
              : (0 === a && i
                  ? ((t.name = e.slice(1, s)), (t.base = e.slice(1, c)))
                  : ((t.name = e.slice(a, s)), (t.base = e.slice(a, c))),
                (t.ext = e.slice(s, c))),
    ...
    2225: (e, t, r) => {
      ...
      function d(e) {
        ...
        else if ('string' === i) for (t in ((o = new y(e, {})), p)) delete o[t];
        else if ('object' === i) {
        ...
        return (
          ...
          'file:' === o
            ...
            : g(o)
              ...
              : o
                ? i && (r = r.slice(2))
                : c >= 2 && g(t.protocol) && (r = n[4]),
          { protocol: o, slashes: i || g(o), slashesCount: c, rest: r }
        );
      }
      function y(e, t, r) {
        if (((e = (e = f(e)).replace(s, '')), !(this instanceof y)))
          return new y(e, t, r);
        var i,
          a,
          c,
        ...
        for (
          'object' !== w && 'string' !== w && ((r = t), (t = null)),
            ...
            i = !(a = m(e || '', (t = d(t)))).protocol && !a.slashes,
            C.slashes = a.slashes || (i && t.slashes),
            C.protocol = a.protocol || t.protocol || '',
            e = a.rest,
            (('file:' === a.protocol && (2 !== a.slashesCount || l.test(e))) ||
              (!a.slashes &&
                (a.protocol || a.slashesCount < 2 || !g(C.protocol)))) &&
              (b[3] = [/(.*)/, 'pathname']);
          x < b.length;
          x++
        )
              ...
              c != c
                ...
                : 'string' == typeof c
                  ? ~(p = '@' === c ? e.lastIndexOf(c) : e.indexOf(c)) &&
                    ('number' == typeof u[2]
                      ? ((C[v] = e.slice(0, p)), (e = e.slice(p + u[2])))
                      : ((C[v] = e.slice(p)), (e = e.slice(0, p))))
                  : (p = c.exec(e)) &&
                    ((C[v] = p[1]), (e = e.slice(0, p.index))),
              (C[v] = C[v] || (i && u[3] && t[v]) || ''),
              u[4] && (C[v] = C[v].toLowerCase()))
            : (e = u(e, C));
        r && (C.query = r(C.query)),
          i &&
            t.slashes &&
          ...
          n(C.port, C.protocol) || ((C.host = C.hostname), (C.port = '')),
          (C.username = C.password = ''),
          C.auth &&
            (~(p = C.auth.indexOf(':'))
              ? ((C.username = C.auth.slice(0, p)),
                (C.username = encodeURIComponent(
                  decodeURIComponent(C.username)
                )),
                (C.password = C.auth.slice(p + 1)),
      ...
      (y.prototype = {
        set: function (e, t, r) {
          ...
          return (
            ...
            (i.origin =
              'file:' !== i.protocol && g(i.protocol) && i.host
                ? i.protocol + '//' + i.host
                : 'null'),
            (i.href = i.toString()),
            i
        ...
        toString: function (e) {
          ...
          var s = i + ((r.protocol && r.slashes) || g(r.protocol) ? '//' : '');
          return (
            r.username
              ? ((s += r.username),
              ...
              : r.password
                ...
                : 'file:' !== r.protocol &&
                  ...
                  '/' !== r.pathname &&
                  (s += '@'),
            (':' === n[n.length - 1] || (c.test(r.hostname) && !r.port)) &&
              (n += ':'),
            (s += n + r.pathname),
