  ...
  [224, 795, 606],
  {
    7560: (n, e, t) => {
      ...
      o.push([
        ...
        {
          version: 3,
          sources: ['webpack://./../theme-material/style/completer.css'],
          names: [],
          mappings:
            'AAAA;EACE,kBAAkB;EAClB,QAAQ;EACR,SAAS;EACT,WAAW;EACX,YAAY;AACd;;AAEA;EACE,WAAW;AACb',
          sourcesContent: [
            '.lsp-completer-theme-material .jp-Completer-icon svg {\n  position: relative;\n  top: 2px;\n  left: 2px;\n  width: 16px;\n  height: 16px;\n}\n\n.lsp-completer-theme-material .jp-Completer-item.jp-mod-active svg path {\n  fill: white;\n}\n'
          ],
          sourceRoot: ''
    ...
    8224: (n, e, t) => {
      t.r(e), t.d(e, { default: () => u, plugin: () => C });
      var i = t(2108),
        s = t.n(i),
        r = t(7020),
        o = t.n(r),
      ...
      const m = {
          ...
          icons: {
            ...
            light: {
              ...
              File: '<svg xmlns="http://www.w3.org/2000/svg" width="24" viewBox="0 0 24 24">\n<g class="jp-icon3" fill="#616161" shape-rendering="geometricPrecision">\n    <path d="M14,2H6A2,2 0 0,0 4,4V20A2,2 0 0,0 6,22H18A2,2 0 0,0 20,20V8L14,2M18,20H6V4H13V9H18V20Z" />\n</g>\n</svg>\n',
              Reference:
        ...
        C = {
          ...
          requires: [d.ILSPCompletionThemeManager],
          activate: (n, e) => {
            e.registerTheme(m);
          },
          autoStart: !0
    ...
    2108: (n) => {
      ...
      function i(n, i) {
        for (var r = {}, o = [], a = 0; a < n.length; a++) {
          ...
          if (-1 !== H) e[H].references++, e[H].updater(V);
          else {
            var w = s(V, i);
            (i.byIndex = a),
              e.splice(a, 0, { identifier: l, updater: w, references: 1 });
          }
          o.push(l);
        }
        return o;
      ...
      n.exports = function (n, s) {
        ...
        return function (n) {
          ...
          for (var c = i(n, s), g = 0; g < r.length; g++) {
            var p = t(r[g]);
...
//# sourceMappingURL=224.8e4b125226225aa8fca7.js.map?v=8e4b125226225aa8fca7
