...
(self.webpackChunk_jupyter_lsp_jupyterlab_lsp =
  ...
  [716, 795, 336, 954],
  {
    ...
    3260: (e) => {
      e.exports = function (e) {
        ...
        if ('function' == typeof btoa) {
          var l = btoa(unescape(encodeURIComponent(JSON.stringify(n)))),
            a =
    ...
    716: (e, t, n) => {
      n.r(t),
        n.d(t, {
          COMPLETER_THEME_PREFIX: () => g,
          COMPLETION_THEME_MANAGER: () => I,
          CompletionThemeManager: () => _,
          ILSPCompletionThemeManager: () => k,
          KernelKind: () => j,
          PLUGIN_ID: () => B
        });
      var l = n(2108),
      ...
      const B = '@jupyter-lsp/completion-manager',
        j = 'Kernel',
        k = new w.Token(B + ':ILSPCompletionThemeManager');
      function T(e, t) {
        let n = t.themes.map((n) =>
          (function (e, t, n, l) {
            let a = [];
            for (let [e, l] of n(t))
              a.push(
                v().createElement(
                  'div',
                  { className: 'lsp-completer-icon-row' },
                  v().createElement('div', null, e),
                  v().createElement(
                    'div',
                    { className: 'jp-Completer-icon' },
                    v().createElement(l.react, null)
                  )
                )
              );
            return v().createElement(
              'div',
              { className: 'lsp-completer-themes ' + g + t.id },
              v().createElement(
                'h4',
                null,
                t.name,
              ...
              v().createElement(
                ...
                v().createElement(
                  ...
                  { key: 'id' },
                  'ID: ',
                  v().createElement('code', null, t.id)
                ),
                v().createElement(
                  'li',
                  { key: 'licence' },
                  ...
                  v().createElement(
                    'div',
                    { className: 'lsp-licence' },
                    v().createElement(
                      'a',
                      { href: o.link, title: o.name },
                      o.abbreviation
                    ),
                    ' ',
                    o.licensor
                ...
                v().createElement(
                  ...
                  void 0 === t.icons.dark
                    ? ''
                    : e.__('Includes dedicated dark mode icons set')
                )
              ),
              v().createElement(
                'div',
                { className: 'lsp-completer-theme-icons' },
                a
              )
            );
            var o;
          })(e, n, t.getSet, n == t.current)
        );
        return v().createElement('div', null, n);
      }
      class _ {
        constructor(e, t) {
          (this.themeManager = e),
            ...
            e.themeChanged.connect(this.updateIconsSet, this),
            (this._trans = t);
        }
        isThemeLight() {
          const e = this.themeManager.theme;
          return !e || this.themeManager.isLight(e);
        }
        getIconSet(e) {
          var t, n;
          const l = e.icons,
            a = this.isThemeLight() || void 0 === l.dark ? l.light : l.dark,
            o = new Map();
          let r =
            (null ===
              (n =
                null === (t = this.currentTheme) || void 0 === t
                  ? void 0
                  : t.icons) || void 0 === n
              ? void 0
              : n.options) || {};
          const i = this.isThemeLight() ? 'light' : 'dark';
          for (let [t, n] of Object.entries(a)) {
            let l,
              a = 'lsp:' + e.id + '-' + t.toLowerCase() + '-' + i;
            this._iconsCache.has(a)
              ? (l = this._iconsCache.get(a))
              : ((l = new f.LabIcon({ name: a, svgstr: n })),
                this._iconsCache.set(a, l)),
              o.set(t, l.bindprops(r));
          }
          return o;
        }
        updateIconsSet() {
          null !== this.currentTheme &&
            (this.currentIcons = this.getIconSet(this.currentTheme));
        }
        getIcon(e) {
          return null === this.currentTheme
            ? null
            : (e &&
                (this._iconOverrides.has(e.toLowerCase()) &&
                  (e = this._iconOverrides.get(e.toLowerCase())),
                (e =
                  e.substring(0, 1).toUpperCase() +
                  e.substring(1).toLowerCase())),
              this.currentIcons.has(e)
                ? this.currentIcons.get(e)
                : e === j
                  ? f.kernelIcon
                  : null);
        }
        get currentThemeClass() {
          return g + this._currentThemeId;
        }
        setTheme(e) {
          this._currentThemeId &&
            ...
            e &&
              !this.themes.has(e) &&
              console.warn(
                `[LSP][Completer] Icons theme ${e} cannot be set yet (it may be loaded later).`
              ),
            (this._currentThemeId = e),
            null !== e && document.body.classList.add(this.currentThemeClass),
            this.updateIconsSet();
        }
        get currentTheme() {
          return this._currentThemeId && this.themes.has(this._currentThemeId)
            ? this.themes.get(this._currentThemeId)
            : null;
        }
        registerTheme(e) {
          this.themes.has(e.id) &&
            console.warn(
              'Theme with name',
              e.id,
        ...
        displayThemes() {
          (0, y.showDialog)({
            ...
            buttons: [y.Dialog.okButton({ label: this._trans.__('OK') })]
          }).catch(console.warn);
        }
        setIconsOverrides(e) {
          this._iconOverrides = new Map(
            Object.keys(e).map((t) => [t.toLowerCase(), e[t]])
          );
        }
      }
      const I = {
        id: B,
        requires: [y.IThemeManager, y.ICommandPalette, E.ITranslator],
        activate: (e, t, n, l) => {
          const a = l.load('jupyterlab_lsp');
          let o = new _(t, a);
          const r = 'lsp:completer-about-themes';
          return (
            e.commands.addCommand(r, {
              label: a.__('Display the completer themes'),
              execute: () => {
                o.displayThemes();
              }
            }),
    ...
    2108: (e) => {
      ...
      function l(e, l) {
        for (var o = {}, r = [], i = 0; i < e.length; i++) {
          ...
          if (-1 !== m) t[m].references++, t[m].updater(h);
            ...
            var A = a(h, l);
            (l.byIndex = i),
              t.splice(i, 0, { identifier: d, updater: A, references: 1 });
          }
          r.push(d);
        }
        return r;
      ...
      e.exports = function (e, a) {
        ...
        return function (e) {
          ...
          for (var s = l(e, a), p = 0; p < o.length; p++) {
            var c = n(o[p]);
      ...
      e.exports = function (e) {
        ...
        return {
          update: function (n) {
            !(function (e, t, n) {
              var l = '';
              n.supports && (l += '@supports ('.concat(n.supports, ') {')),
                n.media && (l += '@media '.concat(n.media, ' {'));
              ...
              o &&
                ...
                t.styleTagTransform(l, e, t.options);
            })(t, e, n);
          },
          remove: function () {
            !(function (e) {
