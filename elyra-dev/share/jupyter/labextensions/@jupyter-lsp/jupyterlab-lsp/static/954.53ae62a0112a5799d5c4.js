...
(self.webpackChunk_jupyter_lsp_jupyterlab_lsp =
  ...
  [954, 336],
  {
    ...
    716: (e, t, l) => {
      l.r(t),
        l.d(t, {
          COMPLETER_THEME_PREFIX: () => x,
          COMPLETION_THEME_MANAGER: () => I,
          CompletionThemeManager: () => T,
      ...
      const f = '@jupyter-lsp/completion-manager',
        j = 'Kernel',
        k = new v.Token(f + ':ILSPCompletionThemeManager');
      function _(e, t) {
        let l = t.themes.map((l) =>
          (function (e, t, l, n) {
            let a = [];
            for (let [e, n] of l(t))
              a.push(
                g().createElement(
                  ...
                  g().createElement('div', null, e),
                  g().createElement(
                    'div',
                    { className: 'jp-Completer-icon' },
                    g().createElement(n.react, null)
                  )
                )
              );
            return g().createElement(
              'div',
              { className: 'lsp-completer-themes ' + x + t.id },
              g().createElement(
                'h4',
                null,
                t.name,
              ...
              g().createElement(
                ...
                g().createElement(
                  ...
                  { key: 'id' },
                  'ID: ',
                  g().createElement('code', null, t.id)
                ),
                g().createElement(
                  'li',
                  { key: 'licence' },
            ...
            var o;
          })(e, l, t.getSet, l == t.current)
        );
        return g().createElement('div', null, l);
      }
      class T {
        constructor(e, t) {
          (this.themeManager = e),
        ...
        getIconSet(e) {
          var t, l;
          const n = e.icons,
            a = this.isThemeLight() || void 0 === n.dark ? n.light : n.dark,
            o = new Map();
          let r =
            (null ===
              (l =
          ...
          for (let [t, l] of Object.entries(a)) {
            ...
            this._iconsCache.has(a)
              ? (n = this._iconsCache.get(a))
              : ((n = new w.LabIcon({ name: a, svgstr: l })),
                this._iconsCache.set(a, n)),
              o.set(t, n.bindprops(r));
          }
          return o;
        }
        updateIconsSet() {
        ...
        displayThemes() {
          (0, E.showDialog)({
            ...
            buttons: [E.Dialog.okButton({ label: this._trans.__('OK') })]
          }).catch(console.warn);
        }
        setIconsOverrides(e) {
          this._iconOverrides = new Map(
      ...
      const I = {
        id: f,
        requires: [E.IThemeManager, E.ICommandPalette, y.ITranslator],
        activate: (e, t, l, n) => {
          const a = n.load('jupyterlab_lsp');
          let o = new T(t, a);
...
//# sourceMappingURL=954.53ae62a0112a5799d5c4.js.map?v=53ae62a0112a5799d5c4
