          ...
          return (
            ...
            (r._onResize = function () {
              var e = r.props,
                ...
                n = e.onResize;
              if (r._parentNode) {
                var s = r._parentNode.offsetHeight || 0,
                  o = r._parentNode.offsetWidth || 0,
                  a = window.getComputedStyle(r._parentNode) || {},
                  _ = parseInt(a.paddingLeft, 10) || 0,
                  l = parseInt(a.paddingRight, 10) || 0,
                  d = parseInt(a.paddingTop, 10) || 0,
                  c = parseInt(a.paddingBottom, 10) || 0,
                  h = s - d - c,
                  f = o - _ - l;
                ((!t && r.state.height !== h) || (!i && r.state.width !== f)) &&
                  (r.setState({ height: s - d - c, width: o - _ - l }),
                  n({ height: s, width: o }));
              }
            }),
                ...
                this._autoSizer &&
                  ...
                  (this._detectElementResize = (function (e) {
                    ...
                    if (!c) {
                      ...
                      if (
                        (void 0 !== g.style.animationName && (h = !0), !1 === h)
                      )
                        for (var m = 0; m < u.length; m++)
                          if (void 0 !== g.style[u[m] + 'AnimationName']) {
                            (f = '-' + u[m].toLowerCase() + '-'),
                              (r = p[m]),
                              (h = !0);
                            break;
                    ...
                    return {
                      addResizeListener: function (s, _) {
                        if (c) s.attachEvent('onresize', _);
                        else {
                          if (!s.__resizeTriggers__) {
                            var l = s.ownerDocument,
                              h = a.getComputedStyle(s);
                            h &&
                              'static' === h.position &&
                                ...
                                if (!i.getElementById('detectElementResize')) {
                                  ...
                                  (o.id = 'detectElementResize'),
                                    ...
                                    o.styleSheet
                                      ...
                                      : o.appendChild(i.createTextNode(r)),
                                    s.appendChild(o);
                                }
                              })(l),
                              (s.__resizeLast__ = {}),
            ...
            },
            {
              ...
              value: function () {
                var e = this.props,
                  ...
                  f = !1;
                return (
                  n || (0 === l && (f = !0), (c.height = 0), (h.height = l)),
                  o || (0 === d && (f = !0), (c.width = 0), (h.width = d)),
                  (0, r.createElement)(
                    'div',
                    { className: i, ref: this._setRef, style: s({}, c, a) },
                    !f && t(h)
                  )
                );
              }
