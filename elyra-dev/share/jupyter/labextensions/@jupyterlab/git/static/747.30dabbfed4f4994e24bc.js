  ...
  [747],
  {
    ...
    3379: n => {
      ...
      function o(n, o) {
        for (var i = {}, a = [], p = 0; p < n.length; p++) {
          ...
          if (-1 !== s) e[s].references++, e[s].updater(g);
          else {
            var u = t(g, o);
            (o.byIndex = p),
              e.splice(p, 0, { identifier: f, updater: u, references: 1 });
          }
          a.push(f);
        }
        return a;
      ...
      n.exports = function (n, t) {
        ...
        return function (n) {
          ...
          for (var d = o(n, t), c = 0; c < i.length; c++) {
            var l = r(i[c]);
    ...
    9747: (n, e, r) => {
      ...
      var o = r(3379),
        ...
        m = r(1150),
        j = {};
      (j.styleTagTransform = u()),
        (j.setAttributes = l()),
        (j.insert = d().bind(null, 'head')),
        (j.domAPI = a()),
        (j.insertStyleElement = s()),
        t()(m.Z, j),
