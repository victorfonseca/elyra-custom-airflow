      ...
      var n = {
        ...
        f = function (e, r) {
          switch (e) {
            ...
            case 'animationName':
              if ('string' == typeof r)
                return r.replace(a, function (e, r, t) {
                  return (d = { name: r, styles: t, next: d }), r;
                });
          }
        ...
        switch (typeof t) {
          ...
          case 'object':
            ...
            return (function (e, r, t) {
              var n = '';
              if (Array.isArray(t))
                for (var o = 0; o < t.length; o++) n += c(e, r, t[o]) + ';';
              else
                for (var i in t) {
                  var a = t[i];
                  if ('object' != typeof a)
      ...
      var o = function (e, r, t) {
        ...
        i = function (e, r, t) {
          ...
          if (void 0 === e.inserted[r.name]) {
            var i = r;
            do {
              e.insert(r === i ? '.' + n : '', i, e.sheet, !0), (i = i.next);
            } while (void 0 !== i);
          }
        };
    }
