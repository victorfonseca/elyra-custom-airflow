    ...
    2027: t => {
      ...
      (e.Diff = function (t, e) {
        ...
        (e.prototype.diff_main = function (t, n, i, r) {
          ...
          void 0 === i && (i = !0);
          var s = i,
            f = this.diff_commonPrefix(t, n),
            a = t.substring(0, f);
          (t = t.substring(f)),
            (n = n.substring(f)),
            (f = this.diff_commonSuffix(t, n));
          var l = t.substring(t.length - f);
          (t = t.substring(0, t.length - f)),
            (n = n.substring(0, n.length - f));
          var g = this.diff_compute_(t, n, s, h);
          return (
        ...
        (e.prototype.diff_compute_ = function (t, i, r, h) {
          var s;
          if (!t) return [new e.Diff(1, i)];
          if (!i) return [new e.Diff(n, t)];
          var f = t.length > i.length ? t : i,
            a = t.length > i.length ? i : t,
            l = f.indexOf(a);
          if (-1 != l)
            return (
              (s = [
                new e.Diff(1, f.substring(0, l)),
                new e.Diff(0, a),
                new e.Diff(1, f.substring(l + a.length))
              ]),
              t.length > i.length && (s[0][0] = s[2][0] = n),
              s
            );
          ...
          if (g) {
            var o = g[0],
              ...
              p = g[3],
              d = g[4],
              _ = this.diff_main(o, u, r, h),
              b = this.diff_main(c, p, r, h);
            return _.concat([new e.Diff(0, d)], b);
          }
          return r && t.length > 100 && i.length > 100
            ? this.diff_lineMode_(t, i, h)
            : this.diff_bisect_(t, i, h);
        }),
        (e.prototype.diff_lineMode_ = function (t, i, r) {
          var h = this.diff_linesToChars_(t, i);
          (t = h.chars1), (i = h.chars2);
          var s = h.lineArray,
            f = this.diff_main(t, i, !1, r);
        ...
        (e.prototype.diff_bisect_ = function (t, i, r) {
          ...
          (g[a + 1] = 0), (o[a + 1] = 0);
          for (
            var u = h - s, p = u % 2 != 0, d = 0, _ = 0, b = 0, v = 0, m = 0;
            m < f && !(new Date().getTime() > r);
            m++
          ) {
            ...
            for (var D = -m + b; D <= m - v; D += 2) {
                  ...
                  A =
                    (y =
                      D == -m || (D != m && o[k - 1] < o[k + 1])
                        ? o[k + 1]
                        : o[k - 1] + 1) - D;
                y < h && A < s && t.charAt(h - y - 1) == i.charAt(s - A - 1);
              ...
              if (((o[k] = y), y > h)) v += 2;
                ...
                var E;
                if ((x = a + u - D) >= 0 && x < l && -1 != g[x])
                  if (((M = a + (E = g[x]) - x), E >= (y = h - y)))
                    return this.diff_bisectSplit_(t, i, E, M, r);
              }
            }
          }
        ...
        (e.prototype.diff_charsToLines_ = function (t, e) {
          for (var n = 0; n < t.length; n++) {
            for (var i = t[n][1], r = [], h = 0; h < i.length; h++)
              r[h] = e[i.charCodeAt(h)];
            t[n][1] = r.join('');
          }
        }),
        (e.prototype.diff_commonPrefix = function (t, e) {
          ...
          for (
            var n = 0, i = Math.min(t.length, e.length), r = i, h = 0;
            n < r;
        ...
        (e.prototype.diff_commonSuffix = function (t, e) {
          ...
          for (
            ...
            t.substring(t.length - r, t.length - h) ==
            e.substring(e.length - r, e.length - h)
              ? (h = n = r)
              : (i = r),
              (r = Math.floor((i - n) / 2 + n));
          return r;
        ...
        (e.prototype.diff_commonOverlap_ = function (t, e) {
          ...
          for (var h = 0, s = 1; ; ) {
            ...
            if (-1 == a) return h;
            (s += a),
              (0 != a && t.substring(r - s) != e.substring(0, s)) ||
                ((h = s), s++);
          }
        }),
            ...
            0 == t[f][0]
              ...
              : (1 == t[f][0] ? (g += t[f][1].length) : (o += t[f][1].length),
                s &&
                  ...
                  s.length <= Math.max(g, o) &&
                  (t.splice(r[h - 1], 0, new e.Diff(n, s)),
                  (t[r[h - 1] + 1][0] = 1),
                  h--,
                  (f = --h > 0 ? r[h - 1] : -1),
                  (a = 0),
            ...
            if (t[f - 1][0] == n && 1 == t[f][0]) {
              ...
              p >= d
                ? (p >= c.length / 2 || p >= u.length / 2) &&
                  (t.splice(f, 0, new e.Diff(0, u.substring(0, p))),
                  (t[f - 1][1] = c.substring(0, c.length - p)),
                  (t[f + 1][1] = u.substring(p)),
                  f++)
                : (d >= c.length / 2 || d >= u.length / 2) &&
                  (t.splice(f, 0, new e.Diff(0, c.substring(0, d))),
                  (t[f - 1][0] = 1),
        ...
        (e.prototype.diff_cleanupSemanticLossless = function (t) {
          function n(t, n) {
            ...
            var i = t.charAt(t.length - 1),
              ...
              f = h && i.match(e.whitespaceRegex_),
              a = s && r.match(e.whitespaceRegex_),
              l = f && i.match(e.linebreakRegex_),
          ...
          for (var i = 1; i < t.length - 1; ) {
            if (0 == t[i - 1][0] && 0 == t[i + 1][0]) {
              var r = t[i - 1][1],
                h = t[i][1],
                s = t[i + 1][1],
                f = this.diff_commonSuffix(r, h);
              if (f) {
                var a = h.substring(h.length - f);
                (r = r.substring(0, r.length - f)),
                  (h = a + h.substring(0, h.length - f)),
                  (s = a + s);
              }
              for (
                var l = r, g = h, o = s, c = n(r, h) + n(h, s);
                h.charAt(0) === s.charAt(0);

              ) {
                (r += h.charAt(0)),
                  (h = h.substring(1) + s.charAt(0)),
                  (s = s.substring(1));
                var u = n(r, h) + n(h, s);
                u >= c && ((c = u), (l = r), (g = h), (o = s));
              }
        ...
        (e.prototype.diff_cleanupMerge = function (t) {
          t.push(new e.Diff(0, ''));
          for (var i, r = 0, h = 0, s = 0, f = '', a = ''; r < t.length; )
            switch (t[r][0]) {
              case 1:
                s++, (a += t[r][1]), r++;
                break;
              ...
              case 0:
                h + s > 1
                  ? (0 !== h &&
                      0 !== s &&
                      (0 !== (i = this.diff_commonPrefix(a, f)) &&
                        (r - h - s > 0 && 0 == t[r - h - s - 1][0]
                          ? (t[r - h - s - 1][1] += a.substring(0, i))
                          : (t.splice(0, 0, new e.Diff(0, a.substring(0, i))),
                            r++),
                        (a = a.substring(i)),
                        (f = f.substring(i))),
                      0 !== (i = this.diff_commonSuffix(a, f)) &&
                        ((t[r][1] = a.substring(a.length - i) + t[r][1]),
                        (a = a.substring(0, a.length - i)),
                        (f = f.substring(0, f.length - i)))),
                    (r -= h + s),
                    t.splice(r, h + s),
                    f.length && (t.splice(r, 0, new e.Diff(n, f)), r++),
        ...
        (e.prototype.diff_xIndex = function (t, e) {
          ...
          for (
            ...
            t[i][0] !== n && (h += t[i][1].length),
            !(r > e));
            i++
          )
            (s = r), (f = h);
          return t.length != i && t[i][0] === n ? f : f + (e - s);
        }),
        ...
        (e.prototype.diff_levenshtein = function (t) {
          for (var e = 0, i = 0, r = 0, h = 0; h < t.length; h++) {
            var s = t[h][0],
              f = t[h][1];
            switch (s) {
              case 1:
          ...
          for (
            ...
            switch (f[a].charAt(0)) {
              ...
              default:
                if (f[a])
                  throw new Error(
                    'Invalid diff operation in diff_fromDelta: ' + f[a]
                  );
            }
          }
          if (s != t.length)
        ...
        (e.prototype.match_bitap_ = function (t, e, n) {
          ...
          -1 != f &&
            ((s = Math.min(h(0, f), s)),
            -1 != (f = t.lastIndexOf(e, n + e.length)) &&
              (s = Math.min(h(0, f), s)));
          var a,
            l,
            g = 1 << (e.length - 1);
        ...
        (e.prototype.patch_addContext_ = function (t, n) {
          if (0 != n.length) {
            ...
            r += this.Patch_Margin;
            var h = n.substring(t.start2 - r, t.start2);
            h && t.diffs.unshift(new e.Diff(0, h));
            var s = n.substring(t.start2 + t.length1, t.start2 + t.length1 + r);
            s && t.diffs.push(new e.Diff(0, s)),
              (t.start1 -= h.length),
              (t.start2 -= h.length),
              (t.length1 += h.length + s.length),
              (t.length2 += h.length + s.length);
          }
        }),
        (e.prototype.patch_make = function (t, i, r) {
          var h, s;
          if ('string' == typeof t && 'string' == typeof i && void 0 === r)
            (h = t),
              (s = this.diff_main(h, i, !0)).length > 2 &&
                (this.diff_cleanupSemantic(s), this.diff_cleanupEfficiency(s));
          else if (t && 'object' == typeof t && void 0 === i && void 0 === r)
            (s = t), (h = this.diff_text1(s));
          else if (
            'string' == typeof t &&
            i &&
            'object' == typeof i &&
          ...
          for (
            ...
            switch ((l || 0 === d || ((a.start1 = g), (a.start2 = o)), d)) {
              ...
              case n:
                ...
                break;
              case 0:
                _.length <= 2 * this.Patch_Margin && l && s.length != p + 1
                  ? ((a.diffs[l++] = s[p]),
                    (a.length1 += _.length),
                    (a.length2 += _.length))
        ...
        (e.prototype.patch_deepCopy = function (t) {
          for (var n = [], i = 0; i < t.length; i++) {
            ...
            for (var s = 0; s < r.diffs.length; s++)
              h.diffs[s] = new e.Diff(r.diffs[s][0], r.diffs[s][1]);
            (h.start1 = r.start1),
              (h.start2 = r.start2),
              (h.length1 = r.length1),
              (h.length2 = r.length2),
        ...
        (e.prototype.patch_apply = function (t, e) {
          ...
          for (var r = 0, h = [], s = 0; s < t.length; s++) {
            var f,
              a,
              l = t[s].start2 + r,
              g = this.diff_text1(t[s].diffs),
              o = -1;
            if (
              ...
              (h[s] = !1), (r -= t[s].length2 - t[s].length1);
            else if (
              ((h[s] = !0),
              (r = f - l),
              g ==
                (a =
                  -1 == o
                    ? e.substring(f, f + g.length)
                    : e.substring(f, o + this.Match_MaxBits)))
            )
              e =
                e.substring(0, f) +
                this.diff_text2(t[s].diffs) +
                e.substring(f + g.length);
            else {
              ...
              if (
                ...
                for (var u, p = 0, d = 0; d < t[s].diffs.length; d++) {
                  var _ = t[s].diffs[d];
                    ...
                    1 === _[0]
                      ...
                      : _[0] === n &&
                        (e =
                          e.substring(0, f + u) +
                          e.substring(
                            f + this.diff_xIndex(c, p + _[1].length)
                          )),
                    _[0] !== n && (p += _[1].length);
                }
              }
        ...
        (e.prototype.patch_addPadding = function (t) {
          ...
          if (0 == s.length || 0 != s[0][0])
            s.unshift(new e.Diff(0, i)),
              (h.start1 -= n),
              (h.start2 -= n),
              (h.length1 += n),
              (h.length2 += n);
          else if (n > s[0][1].length) {
            var f = n - s[0][1].length;
            (s[0][1] = i.substring(s[0][1].length) + s[0][1]),
              (h.start1 -= f),
              (h.start2 -= f),
              (h.length1 += f),
              (h.length2 += f);
          ...
          return (
            0 == (s = (h = t[t.length - 1]).diffs).length ||
            0 != s[s.length - 1][0]
              ? (s.push(new e.Diff(0, i)), (h.length1 += n), (h.length2 += n))
              : n > s[s.length - 1][1].length &&
                ((f = n - s[s.length - 1][1].length),
                (s[s.length - 1][1] += i.substring(0, f)),
                (h.length1 += f),
                (h.length2 += f)),
            i
          );
            ...
            if (!(t[r].length1 <= i)) {
              ...
              for (
                ...
                for (
                  ...
                  0 !== h.diffs.length && l.length1 < i - this.Patch_Margin;
                  ...
                  1 === o
                    ...
                    : o === n &&
                      ...
                      : ((c = c.substring(
                          0,
                          i - l.length1 - this.Patch_Margin
                        )),
                        (l.length1 += c.length),
                        (s += c.length),
                        0 === o
                          ? ((l.length2 += c.length), (f += c.length))
                          : (g = !1),
                        l.diffs.push(new e.Diff(o, c)),
                        c == h.diffs[0][1]
                          ? h.diffs.shift()
                ...
                var u = this.diff_text1(h.diffs).substring(
                  0,
                  this.Patch_Margin
                );
                '' !== u &&
        ...
        (e.prototype.patch_fromText = function (t) {
          ...
          for (
            ...
            var f = r[h].match(s);
            if (!f) throw new Error('Invalid patch string: ' + r[h]);
            ...
            for (
              ...
              var l = r[h].charAt(0);
              try {
                var g = decodeURI(r[h].substring(1));
              } catch (t) {
