...
(self['webpackChunk_elyra_script_debugger_extension'] =
  ...
  \**********************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const debugger_1 = __webpack_require__(
          /*! @jupyterlab/debugger */ 'webpack/sharing/consume/default/@jupyterlab/debugger'
        );
        ...
        const scriptEditorDebuggerExtension = {
          ...
          activate: (app, debug, editorTracker, labShell) => {
              ...
              __awaiter(void 0, void 0, void 0, function* () {
                ...
                try {
                  ...
                  if (!sessionModel) {
                    ...
                    const sessionConnection = yield startSession(
                      kernelSelection,
                      path
                    );
                  ...
                  if (sessionModel) {
                    ...
                    if (!sessionConnection) {
                      ...
                      sessionConnection = sessions.connectTo({
                        model: sessionModel
                      });
                      activeSessions[sessionModel.id] = sessionConnection;
                    }
            ...
            const startSession = (kernelSelection, path) =>
              __awaiter(void 0, void 0, void 0, function* () {
                const options = {
                  kernel: {
                ...
                try {
                  if (kernelSelection) {
                    ...
                    console.log(
                      `Kernel session started for ${kernelSelection} kernel`
                    );
                  }
                } catch (error) {
                  console.warn(
                    'Exception: start session = ' + JSON.stringify(error)
                  );
                }
                return sessionConnection;
              });
            const updateKernel = (sessionConnection, kernelSelection) =>
              __awaiter(void 0, void 0, void 0, function* () {
                var _a;
                try {
                  const prev =
                    (_a = sessionConnection.kernel) === null || _a === void 0
                      ? void 0
                      : _a.name;
                  if (kernelSelection && prev !== kernelSelection) {
                    yield sessionConnection.changeKernel({
                      name: kernelSelection
                    });
                    console.log(
                      `Kernel change from ${prev} to ${kernelSelection}`
                    );
                  }
                } catch (error) {
                  console.warn(
                    'Exception: change kernel = ' + JSON.stringify(error)
                  );
                }
              });
          }
...
//# sourceMappingURL=lib_index_js.a9578f4824329adc2947.js.map
