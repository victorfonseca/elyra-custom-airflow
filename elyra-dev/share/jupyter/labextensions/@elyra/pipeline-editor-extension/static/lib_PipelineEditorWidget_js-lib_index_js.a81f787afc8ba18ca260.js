...
(self['webpackChunk_elyra_pipeline_editor_extension'] =
  ...
  \****************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        exports.ComponentCatalogsWidget =
          exports.COMPONENT_CATALOGS_SCHEMASPACE = void 0;
        const metadata_common_1 = __webpack_require__(
          /*! @elyra/metadata-common */ 'webpack/sharing/consume/default/@elyra/metadata-common/@elyra/metadata-common'
        );
        const services_1 = __webpack_require__(
          /*! @elyra/services */ 'webpack/sharing/consume/default/@elyra/services/@elyra/services'
        );
        const ui_components_1 = __webpack_require__(
          /*! @elyra/ui-components */ 'webpack/sharing/consume/default/@elyra/ui-components/@elyra/ui-components'
        );
        const ui_components_2 = __webpack_require__(
        ...
        const PipelineService_1 = __webpack_require__(
          /*! ./PipelineService */ './lib/PipelineService.js'
        );
        ...
        class ComponentCatalogsDisplay extends metadata_common_1.MetadataDisplay {
          ...
          renderExpandableContent(metadata) {
            ...
            if (metadata.metadata.categories) {
              category_output = metadata.metadata.categories.map((category) =>
                react_1.default.createElement('li', { key: category }, category)
              );
            }
            return react_1.default.createElement(
              ...
              (_a = metadata.metadata.description) !== null && _a !== void 0
                ? _a
                : 'No description',
              react_1.default.createElement('br', null),
              react_1.default.createElement('br', null),
        ...
        class ComponentCatalogsWidget extends metadata_common_1.MetadataWidget {
          ...
          getSchemas() {
            return __awaiter(this, void 0, void 0, function* () {
              var _a, _b, _c;
              try {
                const schemas = yield services_1.MetadataService.getSchema(
                ...
                this.runtimeTypes =
                  yield PipelineService_1.PipelineService.getRuntimeTypes();
                const sortedSchema = schemas.sort((a, b) => {
                  var _a, _b;
                  return (
                    (_a = a.title) !== null && _a !== void 0 ? _a : ''
                  ).localeCompare(
                    (_b = b.title) !== null && _b !== void 0 ? _b : ''
                  );
                });
                this.schemas = sortedSchema.filter((schema) => {
                  return !!this.runtimeTypes.find((r) => {
                    var _a, _b, _c;
                    const metadata =
                      (_a = schema.properties) === null || _a === void 0
                        ? void 0
                        : _a.metadata;
                    return (
                      ((_c =
                        (_b =
                          metadata === null || metadata === void 0
                            ? void 0
                            : metadata.properties.runtime_type) === null ||
                        _b === void 0
                          ? void 0
                          : _b.enum) === null || _c === void 0
                        ? void 0
                        : _c.includes(r.id)) && r.runtime_enabled
                    );
                  });
                });
                if (
                  (_b =
                    (_a = this.schemas) === null || _a === void 0
                      ? void 0
                      : _a.length) !== null && _b !== void 0
                    ? _b
                    : 0 > 1
                ) {
                  for (const schema of (_c = this.schemas) !== null &&
                  _c !== void 0
                    ? _c
                    : []) {
          ...
          renderDisplay(metadata) {
            if (Array.isArray(metadata) && !metadata.length) {
              ...
              return react_1.default.createElement(
                ...
                react_1.default.createElement(
                  'h6',
                  { className: 'elyra-no-metadata-msg' },
            ...
            const filteredMetadata = metadata.filter((m) => {
              return !!this.runtimeTypes.find((r) => {
                var _a;
                return (
                  ((_a = m.metadata) === null || _a === void 0
                    ? void 0
                    : _a.runtime_type) === r.id
                );
              });
            });
            return react_1.default.createElement(ComponentCatalogsDisplay, {
  ...
  \*************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        exports.EmptyPlatformSpecificPipeline = exports.EmptyGenericPipeline =
          void 0;
        const ui_components_1 = __webpack_require__(
          /*! @elyra/ui-components */ 'webpack/sharing/consume/default/@elyra/ui-components/@elyra/ui-components'
        );
        ...
        const EmptyGenericPipeline = ({ onOpenSettings }) => {
          return react_1.default.createElement(
            'div',
            null,
            react_1.default.createElement(ui_components_1.dragDropIcon.react, {
            ...
            react_1.default.createElement(
              ...
              react_1.default.createElement(
                ...
                react_1.default.createElement(
                  ui_components_2.settingsIcon.react,
                  { className: ICON_CLASS, tag: 'div', height: '24px' }
                )
              ),
              ' ',
        ...
        const EmptyPlatformSpecificPipeline = ({
          onOpenCatalog,
          onOpenSettings
        }) => {
          ...
          return react_1.default.createElement(
            ...
            react_1.default.createElement(
              ...
              react_1.default.createElement(
                'button',
                { className: BUTTON_CLASS, onClick: onOpenCatalog },
                react_1.default.createElement(
                  ui_components_1.componentCatalogIcon.react,
                  { className: ICON_CLASS, tag: 'div', height: '24px' }
                )
              ),
              ' ',
  ...
  \*************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const RuntimeConfigSelect_1 = __importDefault(
          __webpack_require__(
            /*! ./RuntimeConfigSelect */ './lib/RuntimeConfigSelect.js'
          )
        );
        const utils_1 = __importDefault(
        ...
        const EnvForm = ({ env }) => {
          if (env.length > 0) {
            return React.createElement(
              ...
              React.createElement('br', null),
              utils_1.default.chunkArray(env, 4).map((col, i) =>
                React.createElement(
                  'div',
                  { key: i },
                  col.map((envVar) =>
        ...
        const FileSubmissionDialog = ({
          env,
          images,
          dependencyFileExtension,
          runtimeData
        }) => {
          const [includeDependency, setIncludeDependency] =
            React.useState(true);
          const handleToggle = () => {
          ...
          return React.createElement(
            'form',
            { className: 'elyra-dialog-form' },
            React.createElement(RuntimeConfigSelect_1.default, {
            ...
            React.createElement(
              'div',
              { className: 'elyra-resourcesWrapper' },
              React.createElement(
                'div',
                { className: 'elyra-resourceInput' },
                React.createElement(
                  'label',
                  { htmlFor: 'cpu' },
                  ' CPU request:'
                ...
                React.createElement(
                  ...
                  'For CPU-intensive workloads, you can request more than 1 CPU (e.g. 1.5, this is optional).'
                ),
                React.createElement('input', {
                  id: 'cpu',
                  type: 'number',
          ...
          return parameters && parameters.length > 0
            ? react_1.default.createElement(
                ...
                parameters.map((param) => {
                  ...
                  const required =
                    param.required === true &&
                    ((_a = param.default_value) === null || _a === void 0
                      ? void 0
                      : _a.value) === ''
                      ? true
                      : undefined;
                  let type = 'text';
                  switch (
                    (_b = param.default_value) === null || _b === void 0
                      ? void 0
                      : _b.type
                  ) {
                    case 'Bool':
                  ...
                  if (type === 'checkbox') {
                    return react_1.default.createElement(
                      ...
                      react_1.default.createElement('input', {
                        ...
                        defaultChecked:
                          (_c = param.default_value) === null || _c === void 0
                            ? void 0
                            : _c.value,
                        type: 'checkbox'
                      }),
                  ...
                  return react_1.default.createElement(
                    ...
                    react_1.default.createElement('input', {
                      ...
                      type: type,
                      placeholder:
                        (_d = param.default_value) === null || _d === void 0
                          ? void 0
                          : _d.value,
  ...
  \*************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const pipeline_editor_1 = __webpack_require__(
          /*! @elyra/pipeline-editor */ 'webpack/sharing/consume/default/@elyra/pipeline-editor/@elyra/pipeline-editor'
        );
        const pipeline_services_1 = __webpack_require__(
          /*! @elyra/pipeline-services */ 'webpack/sharing/consume/default/@elyra/pipeline-services/@elyra/pipeline-services?261f'
        );
        const services_1 = __webpack_require__(
          /*! @elyra/services */ 'webpack/sharing/consume/default/@elyra/services/@elyra/services'
        );
        ...
        const coreutils_1 = __webpack_require__(
          /*! @jupyterlab/coreutils */ 'webpack/sharing/consume/default/@jupyterlab/coreutils'
        );
        const docregistry_1 = __webpack_require__(
          /*! @jupyterlab/docregistry */ 'webpack/sharing/consume/default/@jupyterlab/docregistry'
        );
        __webpack_require__(
          /*! carbon-components/css/carbon-components.min.css */ '../../node_modules/carbon-components/css/carbon-components.min.css'
        );
        const algorithm_1 = __webpack_require__(
          /*! @lumino/algorithm */ 'webpack/sharing/consume/default/@lumino/algorithm'
        );
        const signaling_1 = __webpack_require__(
        ...
        const react_toastify_1 = __webpack_require__(
          /*! react-toastify */ 'webpack/sharing/consume/default/react-toastify/react-toastify'
        );
        __webpack_require__(
          /*! react-toastify/dist/ReactToastify.css */ '../../node_modules/react-toastify/dist/ReactToastify.css'
        );
        const EmptyPipelineContent_1 = __webpack_require__(
          /*! ./EmptyPipelineContent */ './lib/EmptyPipelineContent.js'
        );
        const formDialogWidget_1 = __webpack_require__(
          /*! ./formDialogWidget */ './lib/formDialogWidget.js'
        );
        const pipeline_hooks_1 = __webpack_require__(
          /*! ./pipeline-hooks */ './lib/pipeline-hooks.js'
        );
        const PipelineExportDialog_1 = __webpack_require__(
          /*! ./PipelineExportDialog */ './lib/PipelineExportDialog.js'
        );
        const PipelineService_1 = __webpack_require__(
          /*! ./PipelineService */ './lib/PipelineService.js'
        );
        const PipelineSubmissionDialog_1 = __webpack_require__(
          /*! ./PipelineSubmissionDialog */ './lib/PipelineSubmissionDialog.js'
        );
        const runtime_utils_1 = __webpack_require__(
          /*! ./runtime-utils */ './lib/runtime-utils.js'
        );
        ...
        const ExtendedThemeProvider = (_a) => {
          ...
          return react_1.default.createElement(
            pipeline_editor_1.ThemeProvider,
            Object.assign({}, props),
            children
          );
        };
        ...
        const getDisplayName = (runtimesSchema, type) => {
          ...
          const schema =
            runtimesSchema === null || runtimesSchema === void 0
              ? void 0
              : runtimesSchema.find((s) => s.runtime_type === type);
          ...
          constructor(args) {
            ...
            this.args.context.fileChanged.connect(() => {
              if (this.args.context.model.toJSON() === null) {
                const pipelineJson = (0, index_1.getEmptyPipelineJson)(
                  this.args.defaultRuntimeType
                );
                this.args.context.model.fromString(
          ...
          render() {
            ...
            if (this.args.context.model.toJSON() === null) {
              return react_1.default.createElement('div', {
                className: 'elyra-loader'
              });
            }
            return react_1.default.createElement(PipelineWrapper, {
              ...
              widgetId:
                (_a = this.parent) === null || _a === void 0 ? void 0 : _a.id,
        ...
        const PipelineWrapper = ({
          ...
          const type =
            (_c =
              (_b =
                (_a =
                  pipeline === null || pipeline === void 0
                    ? void 0
                    : pipeline.pipelines) === null || _a === void 0
                  ? void 0
                  : _a[0]) === null || _b === void 0
                ? void 0
                : _b.app_data) === null || _c === void 0
              ? void 0
              : _c.runtime_type;
          const { data: runtimesSchema, error: runtimesSchemaError } = (0,
          pipeline_hooks_1.useRuntimesSchema)();
          const doubleClickToOpenProperties =
            (_d =
              settings === null || settings === void 0
                ? void 0
                : settings.composite['doubleClickToOpenProperties']) !== null &&
            _d !== void 0
              ? _d
              : true;
          const runtimeDisplayName =
            (_e = getDisplayName(runtimesSchema, type)) !== null &&
            _e !== void 0
              ? _e
              : 'Generic';
            ...
            const pipelineDefaultRuntimeImage =
              (_e =
                (_d =
                  ...
                  ? void 0
                  : _d.pipeline_defaults) === null || _e === void 0
                ? void 0
                : _e.runtime_image;
            if (
              (pipelineDefaultRuntimeImage === null ||
              pipelineDefaultRuntimeImage === void 0
                ? void 0
                : pipelineDefaultRuntimeImage.length) > 0
            ) {
            ...
            const nodes =
              (_g =
                (_f =
                  pipeline === null || pipeline === void 0
                    ? void 0
                    : pipeline.pipelines) === null || _f === void 0
                  ? void 0
                  : _f[0]) === null || _g === void 0
                ? void 0
                : _g.nodes;
            if (
              (nodes === null || nodes === void 0 ? void 0 : nodes.length) > 0
            ) {
                  ...
                  (_j =
                    (_h =
                      node === null || node === void 0
                        ? void 0
                        : node.app_data) === null || _h === void 0
                      ? void 0
                      : _h.component_parameters) === null || _j === void 0
                    ? void 0
                    : _j.runtime_image;
                if (
                  (nodeRuntimeImage === null || nodeRuntimeImage === void 0
                    ? void 0
                    : nodeRuntimeImage.length) > 0
                ) {
          ...
          } = (0, pipeline_hooks_1.usePalette)(
            type,
            filePersistedRuntimeImages
          );
          (0, react_1.useEffect)(() => {
            const handleMutateSignal = () => {
              mutatePalette === null || mutatePalette === void 0
                ? void 0
                : mutatePalette();
            };
          ...
          const { data: runtimeImages, error: runtimeImagesError } = (0,
          pipeline_hooks_1.useRuntimeImages)();
          (0, react_1.useEffect)(() => {
            if (
              (runtimeImages === null || runtimeImages === void 0
                ? void 0
          ...
          (0, react_1.useEffect)(() => {
            if (paletteError) {
              ui_components_1.RequestErrors.serverError(paletteError).then(
                () => {
                  var _a;
                  (_a = shell.currentWidget) === null || _a === void 0
                    ? void 0
                    : _a.close();
                }
              );
          ...
          (0, react_1.useEffect)(() => {
            if (runtimeImagesError) {
              ui_components_1.RequestErrors.serverError(
                runtimeImagesError
              ).then(() => {
                var _a;
                (_a = shell.currentWidget) === null || _a === void 0
          ...
          (0, react_1.useEffect)(() => {
            ...
            const changeHandler = () => {
              ...
              const nodes =
                (_b =
                  (_a =
                    pipelineJson === null || pipelineJson === void 0
                      ? void 0
                      : pipelineJson.pipelines) === null || _a === void 0
                    ? void 0
                    : _a[0]) === null || _b === void 0
                  ? void 0
                  : _b.nodes;
                ...
                for (const node of nodes) {
                  if (
                    (_c =
                      node === null || node === void 0
                        ? void 0
                        : node.app_data) === null || _c === void 0
                      ? void 0
                      : _c.component_parameters
                  ) {
                    for (const [key, val] of Object.entries(
                      (_d =
                        node === null || node === void 0
                          ? void 0
                          : node.app_data) === null || _d === void 0
                        ? void 0
                        : _d.component_parameters
                    )) {
                      if (val === null) {
              ...
              if (
                (_f =
                  (_e =
                    pipelineJson === null || pipelineJson === void 0
                      ? void 0
                      : pipelineJson.pipelines) === null || _e === void 0
                    ? void 0
                    : _e[0]) === null || _f === void 0
                  ? void 0
                  : _f.app_data
                ...
                const pipeline_name = coreutils_1.PathExt.basename(
                  pipeline_path,
                  coreutils_1.PathExt.extname(pipeline_path)
                );
                pipelineJson.pipelines[0].app_data.properties.name =
                  pipeline_name;
            ...
            for (const node of (_c =
              (_b =
                (_a =
                  ...
                  : _a[0]) === null || _b === void 0
                ? void 0
                : _b.nodes) !== null && _c !== void 0
              ? _c
              : []) {
              removeNullValues(
                (_d = node.app_data) !== null && _d !== void 0 ? _d : {}
              );
            }
            removeNullValues(
              (_j =
                  ...
                  (_g =
                    (_f =
                      (_e =
                        ...
                        : _e[0]) === null || _f === void 0
                      ? void 0
                      : _f.app_data) === null || _g === void 0
                    ? void 0
                    : _g.properties) === null || _h === void 0
                  ? void 0
                  : _h.pipeline_defaults) !== null && _j !== void 0
                ? _j
                : {}
            );
                ...
                (0, apputils_1.showDialog)({
                  ...
                  __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    if (result.button.accept) {
                      ...
                      try {
                        const migratedPipeline = (0,
                        pipeline_services_1.migrate)(
                          pipelineJSON,
                          (pipeline) => {
                            ...
                            for (const node of pipeline.nodes) {
                              node.app_data.filename =
                                PipelineService_1.PipelineService.getPipelineRelativeNodePath(
                        ...
                        if (
                          migrationError instanceof
                          pipeline_services_1.ComponentNotFoundError
                        ) {
                          (0, apputils_1.showDialog)({
                            ...
                            buttons: [
                              apputils_1.Dialog.okButton({ label: 'Close' })
                            ]
                          }).then(() => {
                            var _a;
                            (_a = shell.currentWidget) === null || _a === void 0
          ...
          const onFileRequested = (args) =>
            __awaiter(void 0, void 0, void 0, function* () {
              var _a, _b, _c;
              const pipelineFilePath = contextRef.current.path;
              const contextFilePath = args.filename
                ? PipelineService_1.PipelineService.getWorkspaceRelativeNodePath(
                    pipelineFilePath,
                    args.filename
                  )
                : pipelineFilePath;
              const contextFolderPath =
                coreutils_1.PathExt.dirname(contextFilePath);
              if (
                (_a = args.propertyID) === null || _a === void 0
                  ? void 0
                  : _a.includes('dependencies')
              ) {
                ...
                const res = yield (0, ui_components_1.showBrowseFileDialog)({
                  ...
                  filter: (model) => {
                    var _a;
                    if (
                      ((_a = args.filters) === null || _a === void 0
                        ? void 0
                        : _a.File) === undefined ||
          ...
          const onPropertiesUpdateRequested = (args) =>
            __awaiter(void 0, void 0, void 0, function* () {
              var _a, _b, _c;
              if (
                !contextRef.current.path ||
                !((_a = args.component_parameters) === null || _a === void 0
                  ? void 0
                  : _a.filename)
              ) {
                return args;
              ...
              const new_env_vars = yield services_1.ContentParser.getEnvVars(
                path
              ).then((response) =>
                response.map((str) => {
                  return { env_var: str };
              ...
              const env_vars =
                (_c =
                  (_b = args.component_parameters) === null || _b === void 0
                    ? void 0
                    : _b.env_vars) !== null && _c !== void 0
                  ? _c
                  : [];
              ...
              return Object.assign(Object.assign({}, args), {
                component_parameters: Object.assign(
                  Object.assign({}, args.component_parameters),
                  { env_vars: merged_env_vars.filter(Boolean) }
                )
              });
            });
          const handleOpenComponentDef = (0, react_1.useCallback)(
            (componentId, componentSource) => {
              ...
              if (!componentId) {
                ...
                try {
                  ...
                  dialogBody.push(
                    `catalog_type: ${componentSourceJson.catalog_type}`
                  );
              ...
              return PipelineService_1.PipelineService.getComponentDef(
                type,
                componentId
              )
                .then((res) => {
                  ...
                  commands.execute(exports.commandIDs.openViewer, {
                    ...
                    label:
                      (_a =
                        nodeDef === null || nodeDef === void 0
                          ? void 0
                          : nodeDef.label) !== null && _a !== void 0
                        ? _a
                        : componentId
                  });
                })
                .catch((e) =>
                  __awaiter(void 0, void 0, void 0, function* () {
                    return yield ui_components_1.RequestErrors.serverError(e);
                  })
                );
            },
          ...
          const onDoubleClick = (data) => {
            ...
            for (let i = 0; i < data.selectedObjectIds.length; i++) {
              ...
              const nodeDef = getAllPaletteNodes(palette).find(
                (n) =>
                  n.op === (node === null || node === void 0 ? void 0 : node.op)
              );
              if (
                (_b =
                  (_a =
                    node === null || node === void 0
                      ? void 0
                      : node.app_data) === null || _a === void 0
                    ? void 0
                    : _a.component_parameters) === null || _b === void 0
                  ? void 0
                  : _b.filename
              ) {
                commands.execute(exports.commandIDs.openDocManager, {
                  path: PipelineService_1.PipelineService.getWorkspaceRelativeNodePath(
                    contextRef.current.path,
                ...
                nodeDef &&
                !((_d =
                  (_c = nodeDef.app_data) === null || _c === void 0
                    ? void 0
                    : _c.parameter_refs) === null || _d === void 0
                  ? void 0
                  : _d.filehandler)
              ) {
          ...
          const handleSubmission = (0, react_1.useCallback)(
            (actionType) =>
              __awaiter(void 0, void 0, void 0, function* () {
                var _a, _b, _c, _d, _e, _f, _g, _h;
                const pipelineJson = context.model.toJSON();
                // Check that all nodes are valid
                const errorMessages = (0, pipeline_services_1.validate)(
                  JSON.stringify(pipelineJson),
                ...
                if (errorMessages && errorMessages.length > 0) {
                  ...
                  react_toastify_1.toast.error(
                    `Failed ${actionType}: ${errorMessage}`
                  );
                  return;
                }
                if (contextRef.current.model.dirty) {
                  ...
                  if (
                    dialogResult.button &&
                    dialogResult.button.accept === true
                  ) {
                ...
                const pipelineName = coreutils_1.PathExt.basename(
                  contextRef.current.path,
                  coreutils_1.PathExt.extname(contextRef.current.path)
                );
                // TODO: Parallelize this
                const runtimeTypes =
                  yield PipelineService_1.PipelineService.getRuntimeTypes();
                const runtimes =
                  yield PipelineService_1.PipelineService.getRuntimes()
                    .then((runtimeList) => {
                      return runtimeList === null || runtimeList === void 0
                        ? void 0
                        : runtimeList.filter((runtime) => {
                            return (
                              !runtime.metadata.runtime_enabled &&
                              !!runtimeTypes.find(
                                (r) => runtime.metadata.runtime_type === r.id
                              )
                            );
                          });
                    })
                ...
                const schema =
                  yield PipelineService_1.PipelineService.getRuntimesSchema().catch(
                    (error) =>
                      __awaiter(void 0, void 0, void 0, function* () {
                        yield ui_components_1.RequestErrors.serverError(error);
                      })
                ...
                if (!runtimes) {
                  yield ui_components_1.RequestErrors.noMetadataError(
                    'runtime'
                  );
                  return;
                }
                ...
                if (actionType === 'export' || type !== undefined) {
                  if (!isRuntimeTypeAvailable(runtimeData, type)) {
                    ...
                    if (
                      res.button.label.includes(
                        PipelineService_1.RUNTIMES_SCHEMASPACE
                      )
                    ) {
                      // Open the runtimes widget
                      shell.activateById(
                        `elyra-metadata:${PipelineService_1.RUNTIMES_SCHEMASPACE}`
                      );
                    }
                    return;
                  }
                ...
                pipelineJson.pipelines[0].app_data.properties.pipeline_parameters =
                  (_a =
                    pipelineJson.pipelines[0].app_data.properties
                      .pipeline_parameters) === null || _a === void 0
                    ? void 0
                    : _a.filter((param) => {
                        return !!pipelineJson.pipelines[0].nodes.find(
                          (node) => {
                            ...
                            return (
                              param.name !== '' &&
                              (((_b =
                                (_a = node.app_data.component_parameters) ===
                                  null || _a === void 0
                                  ? void 0
                                  : _a.pipeline_parameters) === null ||
                              _b === void 0
                                ? void 0
                                : _b.includes(param.name)) ||
                ...
                switch (actionType) {
                  case 'run':
                    dialogOptions = {
                      title,
                      body: (0, formDialogWidget_1.formDialogWidget)(
                        react_1.default.createElement(
                          PipelineSubmissionDialog_1.PipelineSubmissionDialog,
                          {
                            name: pipelineName,
                            runtimeData: runtimeData,
                            pipelineType: type,
                  ...
                  case 'export':
                    dialogOptions = {
                      ...
                      body: (0, formDialogWidget_1.formDialogWidget)(
                        react_1.default.createElement(
                          PipelineExportDialog_1.PipelineExportDialog,
                          {
                            runtimeData: runtimeData,
                ...
                const dialogResult = yield (0, ui_components_1.showFormDialog)(
                  dialogOptions
                );
                ...
                for (const node of pipelineJson.pipelines[0].nodes) {
                  ...
                  if (
                    node.app_data.component_parameters.memory_limit === null
                  ) {
                ...
                const configDetails = (0, runtime_utils_1.getConfigDetails)(
                  runtimeData,
                  dialogResult.value.runtime_config
                );
                PipelineService_1.PipelineService.setNodePathsRelativeToWorkspace(
                ...
                pipelineJson.pipelines[0].app_data.name =
                  (_b = dialogResult.value.pipeline_name) !== null &&
                  _b !== void 0
                    ? _b
                    : pipelineName;
                pipelineJson.pipelines[0].app_data.source =
                  coreutils_1.PathExt.basename(contextRef.current.path);
                // Pipeline parameter overrides
                for (const paramIndex in parameters !== null &&
                parameters !== void 0
                  ? parameters
                  : []) {
                  ...
                  if (param.name) {
                    let paramOverride =
                      dialogResult.value[`${param.name}-paramInput`];
                    if (
                      (((_c = param.default_value) === null || _c === void 0
                        ? void 0
                        : _c.type) === 'Integer' ||
                    ...
                    pipelineJson.pipelines[0].app_data.properties.pipeline_parameters[
                      ...
                      paramOverride === ''
                        ? (_e = param.default_value) === null || _e === void 0
                          ? void 0
                          : _e.value
                        : paramOverride;
                  }
                ...
                // Pipeline name
                pipelineJson.pipelines[0].app_data.name =
                  (_f = dialogResult.value.pipeline_name) !== null &&
                  _f !== void 0
                    ? _f
                    : pipelineName;
                // Runtime info
                pipelineJson.pipelines[0].app_data.runtime_config =
                  (_g =
                    configDetails === null || configDetails === void 0
                      ? void 0
                      : configDetails.id) !== null && _g !== void 0
                    ? _g
                    : null;
                // Export info
                const pipeline_dir = coreutils_1.PathExt.dirname(
                  contextRef.current.path
                );
                ...
                switch (actionType) {
                  case 'run':
                    PipelineService_1.PipelineService.submitPipeline(
                      pipelineJson,
                      (_h =
                        configDetails === null || configDetails === void 0
                          ? void 0
                          : configDetails.platform.displayName) !== null &&
                        _h !== void 0
                        ? _h
                        : ''
                    ).catch((error) =>
                    ...
                    break;
                  case 'export':
                    PipelineService_1.PipelineService.exportPipeline(
                      pipelineJson,
                      exportType,
                      exportPath,
          ...
          const handleClearPipeline = (0, react_1.useCallback)(
            () =>
              __awaiter(void 0, void 0, void 0, function* () {
                return (0, apputils_1.showDialog)({
                  ...
                  if (result.button.accept) {
                    ...
                    if (
                      ((_c =
                        (_b =
                          (_a =
                            newPipeline === null || newPipeline === void 0
                              ? void 0
                              : newPipeline.pipelines) === null || _a === void 0
                            ? void 0
                            : _a[0]) === null || _b === void 0
                          ? void 0
                          : _b.nodes) === null || _c === void 0
            ...
            (args) => {
              switch (args.type) {
                ...
                case 'openRuntimeImages':
                  shell.activateById(
                    `elyra-metadata:${PipelineService_1.RUNTIME_IMAGES_SCHEMASPACE}`
                  );
                  break;
                case 'openComponentCatalogs':
                  shell.activateById(
                    `elyra-metadata:${PipelineService_1.COMPONENT_CATALOGS_SCHEMASPACE}`
                  );
                  break;
                case 'openFile':
          ...
          const toolbar = {
            leftBar: [
              ...
              },
              {
                ...
                label: 'Save Pipeline',
                enable: true,
                iconEnabled: ui_components_1.IconUtil.encode(
                  ui_components_1.savePipelineIcon
                ),
                iconDisabled: ui_components_1.IconUtil.encode(
                  ui_components_1.savePipelineIcon
                )
              },
              {
                ...
                enable: true,
                iconEnabled: ui_components_1.IconUtil.encode(
                  ui_components_1.exportPipelineIcon
                ),
                iconDisabled: ui_components_1.IconUtil.encode(
                  ui_components_1.exportPipelineIcon
                )
              },
              {
                ...
                enable: true,
                iconEnabled: ui_components_1.IconUtil.encode(
                  ui_components_1.clearPipelineIcon
                ),
                iconDisabled: ui_components_1.IconUtil.encode(
                  ui_components_1.clearPipelineIcon
                )
              ...
              },
              {
                ...
                enable: true,
                iconEnabled: ui_components_1.IconUtil.encode(
                  ui_components_1.componentCatalogIcon
                ),
                iconDisabled: ui_components_1.IconUtil.encode(
                  ui_components_1.componentCatalogIcon
                )
          ...
          const [defaultPosition, setDefaultPosition] = (0, react_1.useState)(
            10
          );
          const handleAddFileToPipeline = (0, react_1.useCallback)(
            (location) => {
              var _a;
              ...
              // eslint-disable-next-line @typescript-eslint/no-explicit-any -- PipelineEditor API not typed
              (0, algorithm_1.toArray)(fileBrowser.selectedItems()).map(
                (item) => {
                  var _a, _b, _c;
                  if (PipelineService_1.PipelineService.isSupportedNode(item)) {
                    item.op = PipelineService_1.PipelineService.getNodeType(
                      item.path
                    );
                    item.path =
                      PipelineService_1.PipelineService.getPipelineRelativeNodePath(
          ...
          const handleOpenSettings = () => {
            commands.execute('settingeditor:open', {
              query: 'Pipeline Editor'
            });
          };
          return react_1.default.createElement(
            ExtendedThemeProvider,
            { theme: theme_1.theme },
            react_1.default.createElement(react_toastify_1.ToastContainer, {
            ...
            react_1.default.createElement(
              ui_components_1.Dropzone,
              { onDrop: handleDrop },
              react_1.default.createElement(
                pipeline_editor_1.PipelineEditor,
                {
                  ref: ref,
                  palette: palette,
                  ...
                  onAction: onAction,
                  onChange: onChange,
                  onDoubleClickNode: doubleClickToOpenProperties
                    ? undefined
                    : onDoubleClick,
                  onError: onError,
                ...
                type === undefined
                  ? react_1.default.createElement(
                      EmptyPipelineContent_1.EmptyGenericPipeline,
                      { onOpenSettings: handleOpenSettings }
                    )
                  : react_1.default.createElement(
                      EmptyPipelineContent_1.EmptyPlatformSpecificPipeline,
                      {
        ...
        class PipelineEditorFactory extends docregistry_1.ABCWidgetFactory {
          ...
          get addFileToPipelineSignal() {
            var _a;
            return (_a = this.content) === null || _a === void 0
              ? void 0
              : _a.addFileToPipelineSignal;
          }
          get refreshPaletteSignal() {
            var _a;
            return (_a = this.content) === null || _a === void 0
              ? void 0
              : _a.refreshPaletteSignal;
          }
  ...
  \*************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const ParameterInputForm_1 = __webpack_require__(
          /*! ./ParameterInputForm */ './lib/ParameterInputForm.js'
        );
        const RuntimeConfigSelect_1 = __importDefault(
          __webpack_require__(
            /*! ./RuntimeConfigSelect */ './lib/RuntimeConfigSelect.js'
        ...
        const PipelineExportDialog = ({
          ...
          return React.createElement(
            ...
            { className: 'elyra-dialog-form' },
            React.createElement(
              RuntimeConfigSelect_1.default,
              { runtimeData: runtimeData, pipelineType: pipelineType },
              (platform) => {
                var _a;
                const info = runtimeTypeInfo.find((i) => i.id === platform);
                return React.createElement(FileTypeSelect, {
                  fileTypes:
                    (_a =
                      info === null || info === void 0
                        ? void 0
                        : info.export_file_types) !== null && _a !== void 0
                      ? _a
                      : []
                });
              }
            ...
            React.createElement('br', null),
            React.createElement('br', null),
            React.createElement(ParameterInputForm_1.ParameterInputForm, {
              parameters: parameters
            })
          );
        };
  ...
  \********************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        exports.PipelineService =
          exports.COMPONENT_CATALOGS_SCHEMASPACE =
          exports.RUNTIME_IMAGES_SCHEMASPACE =
          exports.RUNTIMES_SCHEMASPACE =
          exports.KFP_SCHEMA =
            void 0;
        const services_1 = __webpack_require__(
          /*! @elyra/services */ 'webpack/sharing/consume/default/@elyra/services/@elyra/services'
        ...
        class PipelineService {
          ...
          static getRuntimeTypes() {
            return __awaiter(this, void 0, void 0, function* () {
              const res = yield services_1.RequestHandler.makeGetRequest(
          ...
          static getRuntimes() {
            return __awaiter(this, void 0, void 0, function* () {
              return services_1.MetadataService.getMetadata(
                exports.RUNTIMES_SCHEMASPACE
              );
            });
          }
          ...
          static getRuntimesSchema() {
            return __awaiter(this, void 0, void 0, function* () {
              return services_1.MetadataService.getSchema(
                exports.RUNTIMES_SCHEMASPACE
              ).then((schema) => {
                if (!schema) {
                  return;
          ...
          static getRuntimeImages() {
            return __awaiter(this, void 0, void 0, function* () {
              try {
                let runtimeImages =
                  yield services_1.MetadataService.getMetadata(
                    'runtime-images'
                  );
                if (
                  !(runtimeImages === null || runtimeImages === void 0
          ...
          static getComponentDef() {
            return __awaiter(
              ...
              arguments,
              void 0,
              function* (type = 'local', componentID) {
                return yield services_1.RequestHandler.makeGetRequest(
          ...
          static refreshComponentsCache(catalogName) {
            return __awaiter(this, void 0, void 0, function* () {
              return yield services_1.RequestHandler.makePutRequest(
          ...
          static submitPipeline(pipeline, runtimeName) {
            return __awaiter(this, void 0, void 0, function* () {
              return services_1.RequestHandler.makePostRequest(
                ...
                __awaiter(this, void 0, void 0, function* () {
                  ...
                  if (response['run_url']) {
                    ...
                    dialogTitle =
                      'Job submission to ' + runtimeName + ' succeeded';
          ...
          static getPipelineRelativeNodePath(pipelinePath, nodePath) {
            const relativePath = coreutils_1.PathExt.relative(
              coreutils_1.PathExt.dirname(pipelinePath),
              nodePath
            );
            return relativePath;
          }
          static getWorkspaceRelativeNodePath(pipelinePath, nodePath) {
            ...
            const workspacePath = coreutils_1.PathExt.resolve(
              coreutils_1.PathExt.dirname(pipelinePath),
              nodePath
            );
            ...
            for (const node of pipeline.nodes) {
              ...
              const parameters =
                (_a =
                  nodeDef === null || nodeDef === void 0
                    ? void 0
                    : nodeDef.app_data.properties) === null || _a === void 0
                  ? void 0
                  : _a.properties.component_parameters.properties;
              for (const param in parameters) {
                if (
                  ((_b = parameters[param].uihints) === null || _b === void 0
                    ? void 0
                    : _b['ui:widget']) === 'file'
                ) {
                  ...
                  ((_c = node.app_data.component_parameters[param]) === null ||
                  _c === void 0
                    ? void 0
                    : _c.widget) === 'file'
                ) {
  ...
  \*****************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const PipelineSubmissionDialog = ({
          name,
          runtimeData,
          pipelineType,
          parameters
      ...
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const RuntimeConfigSelect = ({
          ...
          const [platform, setPlatform] = React.useState(
            pipelineType !== null && pipelineType !== void 0
              ? pipelineType
              : (_a = filteredPlatforms[0]) === null || _a === void 0
                ? void 0
                : _a.id
          );
          ...
          const configs =
            (_c =
              (_b = filteredPlatforms.find((p) => p.id === platform)) ===
                null || _b === void 0
                ? void 0
                : _b.configs) !== null && _c !== void 0
              ? _c
              : [];
          ...
          return React.createElement(
            ...
            React.createElement(
              ...
              {
                style: {
                  display: platform === RUN_LOCALLY_ID ? 'none' : 'block'
                }
              },
              React.createElement(
                'label',
  ...
  \************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        exports.RuntimeImagesWidget = exports.RUNTIME_IMAGES_SCHEMASPACE =
          void 0;
        const metadata_common_1 = __webpack_require__(
          /*! @elyra/metadata-common */ 'webpack/sharing/consume/default/@elyra/metadata-common/@elyra/metadata-common'
        );
        ...
        class RuntimeImagesWidget extends metadata_common_1.MetadataWidget {
          ...
          renderDisplay(metadata) {
            ...
            return react_1.default.createElement(RuntimeImagesDisplay, {
              metadata: metadata,
              updateMetadata: this.updateMetadata,
              openMetadataEditor: this.openMetadataEditor,
              schemaspace: exports.RUNTIME_IMAGES_SCHEMASPACE,
              sortMetadata: true,
      ...
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        class RuntimesDisplay extends metadata_common_1.MetadataDisplay {
          renderExpandableContent(metadata) {
            ...
            for (const schema of (_a = this.props.schemas) !== null &&
            _a !== void 0
              ? _a
              : []) {
            ...
            if (metadata.schema_name === 'airflow' && metadata_props) {
              const githubRepoUrl =
                ...
                '/';
              githubRepoElement = react_1.default.createElement(
                'span',
                null,
                react_1.default.createElement(
                  'h6',
            ...
            if (metadata.schema_name === 'kfp') {
              if (metadata.metadata.public_api_endpoint) {
                ...
                apiEndpoint = addTrailingSlash(
                  metadata.metadata.public_api_endpoint
                );
              }
            }
            if (metadata.metadata.public_cos_endpoint) {
              ...
              cosEndpoint = addTrailingSlash(
                metadata.metadata.public_cos_endpoint
              );
            }
            return react_1.default.createElement(
              'div',
              ...
              react_1.default.createElement(
                ...
                null,
                metadata_props
                  ? metadata_props.api_endpoint.title
                  : 'API Endpoint'
              ),
              react_1.default.createElement(
                'a',
        ...
        class RuntimesWidget extends metadata_common_1.MetadataWidget {
            ...
            this.getSchemaTitle = (metadata) => {
              ...
              if (this.schemas) {
                for (const schema of this.schemas) {
                  if (schema.name === metadata.schema_name) {
                    return (_a = schema.title) !== null && _a !== void 0
                      ? _a
                      : '';
                  }
                }
          ...
          fetchMetadata() {
            return __awaiter(this, void 0, void 0, function* () {
              return yield PipelineService_1.PipelineService.getRuntimes().catch(
                (error) =>
                  __awaiter(this, void 0, void 0, function* () {
                    yield ui_components_1.RequestErrors.serverError(error);
                    return [];
              ...
              try {
                ...
                this.schemas = sortedSchema.filter((schema) => {
                  ...
                  return !!this.runtimeTypes.find(
                    (r) =>
                      r.id === runtimeSchema.runtime_type && r.runtime_enabled
                  );
                });
                if (
                  (_b =
          ...
          renderDisplay(metadata) {
            ...
            return react_1.default.createElement(RuntimesDisplay, {
              metadata: filteredMetadata,
              updateMetadata: this.updateMetadata,
              openMetadataEditor: this.openMetadataEditor,
  ...
  \******************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const FileSubmissionDialog_1 = __webpack_require__(
          /*! ./FileSubmissionDialog */ './lib/FileSubmissionDialog.js'
        );
        const formDialogWidget_1 = __webpack_require__(
          /*! ./formDialogWidget */ './lib/formDialogWidget.js'
        );
          ...
          constructor() {
            this.showWidget = (document) =>
              __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                  const env = yield services_1.ContentParser.getEnvVars(
                    context.path
                  );
                  const runtimeTypes =
                    yield PipelineService_1.PipelineService.getRuntimeTypes();
                  const runtimes =
                    yield PipelineService_1.PipelineService.getRuntimes().then(
                      (runtimeList) => {
                        return runtimeList === null || runtimeList === void 0
                          ? void 0
                          : runtimeList.filter((runtime) => {
                  ...
                  const images =
                    yield PipelineService_1.PipelineService.getRuntimeImages();
                  const schema =
                    yield PipelineService_1.PipelineService.getRuntimesSchema();
                  if (!schema) {
                    yield ui_components_1.RequestErrors.noMetadataError(
                      'schema'
                    );
                  ...
                  if (
                    !runtimeData.platforms.find((p) => p.configs.length > 0)
                  ) {
                    const res =
                      yield ui_components_1.RequestErrors.noMetadataError(
                        'runtime',
                    ...
                    if (
                      ...
                      // Open the runtimes widget
                      (_a = utils_1.default.getLabShell(document)) === null ||
                      _a === void 0
                        ? void 0
                        : _a.activateById(
                            `elyra-metadata:${PipelineService_1.RUNTIMES_SCHEMASPACE}`
                  ...
                  let dependencyFileExtension = coreutils_1.PathExt.extname(
                    context.path
                  );
                  ...
                  const dialogOptions = {
                    ...
                    body: (0, formDialogWidget_1.formDialogWidget)(
                      React.createElement(
                        FileSubmissionDialog_1.FileSubmissionDialog,
                        {
                          env: env,
                  ...
                  const dialogResult = yield (0,
                  ui_components_1.showFormDialog)(dialogOptions);
                  if (dialogResult.value === null) {
                    // When Cancel is clicked on the dialog, just return
                    return;
                  }
                  const _c = dialogResult.value,
                    {
                      runtime_config,
                      framework,
                      cpu,
                  ...
                  const pipeline = utils_1.default.generateSingleFilePipeline(
                    context.path,
                    configDetails,
                    framework,
  ...
  \*********************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const widgets_1 = __webpack_require__(
        ...
        const formDialogWidget = (dialogComponent) => {
          ...
          messaging_1.MessageLoop.sendMessage(
            widget,
            widgets_1.Widget.Msg.UpdateRequest
          );
          widget.getValue = () => {
            var _a;
            ...
            for (const element of Object.values(
              (_a =
                form === null || form === void 0 ? void 0 : form.elements) !==
                null && _a !== void 0
                ? _a
                : []
            )) {
  ...
  \**********************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const ComponentCatalogsWidget_1 = __webpack_require__(
          /*! ./ComponentCatalogsWidget */ './lib/ComponentCatalogsWidget.js'
        );
        const PipelineEditorWidget_1 = __webpack_require__(
          /*! ./PipelineEditorWidget */ './lib/PipelineEditorWidget.js'
        );
        const PipelineService_1 = __webpack_require__(
          /*! ./PipelineService */ './lib/PipelineService.js'
        );
        const RuntimeImagesWidget_1 = __webpack_require__(
          /*! ./RuntimeImagesWidget */ './lib/RuntimeImagesWidget.js'
        );
        const RuntimesWidget_1 = __webpack_require__(
          /*! ./RuntimesWidget */ './lib/RuntimesWidget.js'
        );
        const SubmitFileButtonExtension_1 = __webpack_require__(
          /*! ./SubmitFileButtonExtension */ './lib/SubmitFileButtonExtension.js'
        );
        ...
        const createRemoteIcon = (_a) =>
          __awaiter(void 0, [_a], void 0, function* ({ name, url }) {
            const svgstr = yield services_1.RequestHandler.makeServerRequest(
              url,
              {
                method: 'GET',
                type: 'text'
        ...
        const extension = {
          ...
          activate: (
            ...
            __awaiter(void 0, void 0, void 0, function* () {
              ...
              PipelineService_1.PipelineService.getRuntimeTypes()
                .then((types) =>
                  __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    const promises = filteredTypes.map((t) =>
                      __awaiter(void 0, void 0, void 0, function* () {
                        return Object.assign(Object.assign({}, t), {
                          icon: yield createRemoteIcon({
                    ...
                    const pipelineEditorFactory =
                      new PipelineEditorWidget_1.PipelineEditorFactory({
                        ...
                        settings: settings,
                        defaultRuntimeType:
                          (_a = resolvedTypes[0]) === null || _a === void 0
                            ? void 0
                            : _a.id
                      });
                    ...
                    pipelineEditorFactory.widgetCreated.connect(
                      (_sender, widget) => {
                    ...
                    const addFileToPipelineCommand =
                      PipelineEditorWidget_1.commandIDs.addFileToPipeline;
                    app.commands.addCommand(addFileToPipelineCommand, {
                      label: 'Add File to Pipeline',
                      icon: ui_components_2.addIcon,
                      execute: (args) => {
                        var _a;
                        (_a = pipelineEditorFactory.addFileToPipelineSignal) ===
                          null || _a === void 0
                          ? void 0
                          : _a.emit(args);
                      }
                    });
                    const refreshPaletteCommand =
                      PipelineEditorWidget_1.commandIDs.refreshPalette;
                    app.commands.addCommand(refreshPaletteCommand, {
                      label: 'Refresh Pipeline Palette',
                      icon: ui_components_2.refreshIcon,
                      execute: (args) => {
                        var _a;
                        (_a = pipelineEditorFactory.refreshPaletteSignal) ===
                          null || _a === void 0
                          ? void 0
                          : _a.emit(args);
                      }
                    ...
                    const openPipelineEditorCommand =
                      PipelineEditorWidget_1.commandIDs.openPipelineEditor;
                    app.commands.addCommand(openPipelineEditorCommand, {
                      label: (args) => {
                        ...
                        if (
                          ((_a = commandArgs.runtimeType) === null ||
                          _a === void 0
                            ? void 0
                            : _a.id) === 'LOCAL'
                        ) {
                          const contextMenuPrefix = commandArgs.isContextMenu
                            ? 'New '
                            : '';
                      ...
                      icon: (args) => {
                        ...
                        return (_a = commandArgs.runtimeType) === null ||
                          _a === void 0
                          ? void 0
                          : _a.icon;
                      },
                      execute: (args) => {
                        ...
                        app.commands
                          .execute(
                            PipelineEditorWidget_1.commandIDs.newDocManager,
                            {
                              type: 'file',
                          ...
                          .then((model) =>
                            __awaiter(void 0, void 0, void 0, function* () {
                              ...
                              const pipelineJson = (0,
                              exports.getEmptyPipelineJson)(runtime_type);
                              const newWidget = yield app.commands.execute(
                                PipelineEditorWidget_1.commandIDs
                                  .openDocManager,
                                {
                                  path: model.path,
                                  factory: PIPELINE_EDITOR
              ...
              const notebookButtonExtension =
                new SubmitFileButtonExtension_1.SubmitFileButtonExtension();
              ...
              const runtimeImagesWidget =
                new RuntimeImagesWidget_1.RuntimeImagesWidget({
                  app,
              ...
              const componentCatalogWidget =
                new ComponentCatalogsWidget_1.ComponentCatalogsWidget({
                  app,
                  display_name: 'Component Catalogs', // TODO: This info should come from the server for all schemaspaces
                  schemaspace:
                    ComponentCatalogsWidget_1.COMPONENT_CATALOGS_SCHEMASPACE,
              ...
              componentCatalogWidget.title.icon =
                ui_components_1.componentCatalogIcon;
  ...
  \*******************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        exports.usePalette =
          exports.componentFetcher =
          exports.sortPalette =
          exports.useRuntimesSchema =
          exports.useRuntimeImages =
          exports.GENERIC_CATEGORY_ID =
            void 0;
        const services_1 = __webpack_require__(
          /*! @elyra/services */ 'webpack/sharing/consume/default/@elyra/services/@elyra/services'
        );
        ...
        const services_2 = __webpack_require__(
          /*! @jupyterlab/services */ 'webpack/sharing/consume/default/@jupyterlab/services'
        );
        const immer_1 = __importDefault(
          __webpack_require__(
            /*! immer */ 'webpack/sharing/consume/default/immer/immer'
          )
        );
        const swr_1 = __importDefault(
          __webpack_require__(
            /*! swr */ 'webpack/sharing/consume/default/swr/swr'
          )
        );
        const PipelineService_1 = __webpack_require__(
          /*! ./PipelineService */ './lib/PipelineService.js'
              ...
              (runtimeImage) =>
                ...
                additionalRuntimeImages.findIndex(
                  (additionalRuntimeImage) =>
                    ...
                    runtimeImage.display_name ===
                      additionalRuntimeImage.display_name &&
        ...
        const componentFetcher = (type) =>
          __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b, _c;
            const palettePromise = services_1.RequestHandler.makeGetRequest(
              `elyra/pipeline/components/${type}`
            );
            const pipelinePropertiesPromise =
              services_1.RequestHandler.makeGetRequest(
            ...
            const propertiesPromises = componentList.map((componentID) =>
              __awaiter(void 0, void 0, void 0, function* () {
                const res = yield services_1.RequestHandler.makeGetRequest(
            ...
            for (const category of palette.categories) {
              ...
              const category_runtime_type =
                (_c =
                  (_b =
                    (_a = category.node_types) === null || _a === void 0
                      ? void 0
                      : _a[0]) === null || _b === void 0
                    ? void 0
                    : _b.runtime_type) !== null && _c !== void 0
                  ? _c
                  : 'LOCAL';
              const type = types.find((t) => t.id === category_runtime_type);
              const baseUrl =
                services_2.ServerConnection.makeSettings().baseUrl;
              const defaultIcon = coreutils_1.URLExt.parse(
                coreutils_1.URLExt.join(
                  baseUrl,
              ...
              for (const node of category.node_types) {
                ...
                const nodeIcon = genericNodeIcon
                  ? coreutils_1.URLExt.parse(
                      coreutils_1.URLExt.join(baseUrl, genericNodeIcon)
                    ).pathname
                  : defaultIcon;
                ...
                node.app_data.properties =
                  prop === null || prop === void 0 ? void 0 : prop.properties;
              }
            }
        ...
        const updateRuntimeImages = (properties, runtimeImages) => {
                ...
                (_b =
                  (_a =
                    properties === null || properties === void 0
                      ? void 0
                      : properties.properties) === null || _a === void 0
                    ? void 0
                    : _a.component_parameters) === null || _b === void 0
                  ? void 0
                  : _b.properties) === null || _c === void 0
                ? void 0
                : _c.runtime_image) !== null && _d !== void 0
              ? _d
              : (_g =
                    (_f =
                      (_e =
                        properties === null || properties === void 0
                          ? void 0
                          : properties.properties) === null || _e === void 0
                        ? void 0
                        : _e.pipeline_defaults) === null || _f === void 0
                      ? void 0
                      : _f.properties) === null || _g === void 0
                ? void 0
                : _g.runtime_image;
          const imageNames = (
            runtimeImages !== null && runtimeImages !== void 0
          ...
          if (runtimeImageProperties) {
            runtimeImageProperties.enumNames = (
              runtimeImages !== null && runtimeImages !== void 0
                ? runtimeImages
                : []
        ...
        const usePalette = (type = 'local', additionalRuntimeImages) => {
          const { data: runtimeImages, error: runtimeError } = (0,
          exports.useRuntimeImages)(additionalRuntimeImages);
          const {
            data: palette,
            error: paletteError,
            mutate: mutate
          } = (0, swr_1.default)(type, exports.componentFetcher);
          let updatedPalette;
          ...
          return {
            data: updatedPalette,
            error:
              runtimeError !== null && runtimeError !== void 0
                ? runtimeError
                : paletteError,
            mutate: mutate
          };
  ...
  \**********************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const theme = {
          ...
          overrides: {
            deleteIcon: ui_components_2.LabIcon.resolveReact({
              icon: ui_components_1.trashIcon
            }),
            editIcon: ui_components_2.LabIcon.resolveReact({
              icon: ui_components_2.editIcon
            }),
            folderIcon: ui_components_2.LabIcon.resolveReact({
              icon: ui_components_2.folderIcon
            }),
            closeIcon: ui_components_2.LabIcon.resolveReact({
              icon: ui_components_2.closeIcon
            }),
            propertiesIcon: React.createElement(
              SvgIcon,
              null,
            ...
            paletteIcon: ui_components_2.LabIcon.resolveReact({
              icon: ui_components_2.paletteIcon
            }),
            checkIcon: React.createElement(
              SvgIcon,
              null,
              React.createElement('path', {
            ...
            chevronDownIcon: ui_components_2.LabIcon.resolveReact({
              icon: ui_components_2.caretDownEmptyIcon
            })
          }
        };
        exports.theme = theme;
  ...
  \**********************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const v4_1 = __importDefault(
          __webpack_require__(/*! uuid/v4 */ '../../node_modules/uuid/v4.js')
        );
        /**
        ...
        class Utils {
          ...
          static generateSingleFilePipeline(
            ...
            const artifactName = coreutils_1.PathExt.basename(
              filename,
              coreutils_1.PathExt.extname(filename)
            );
        ...
        Utils.getLabShell = (widget) => {
          while (
            widget !== null &&
            !(widget instanceof application_1.LabShell)
          ) {
...
//# sourceMappingURL=lib_PipelineEditorWidget_js-lib_index_js.a81f787afc8ba18ca260.js.map
