(self["webpackChunk_elyra_pipeline_editor_extension"] = self["webpackChunk_elyra_pipeline_editor_extension"] || []).push([["vendors-node_modules_rjsf_core_lib_index_js-node_modules_rjsf_validator-ajv8_lib_index_js-nod-1f57ca"],{
...
/* harmony import */ var lodash_es_isObject_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lodash-es/isObject.js */ "../../node_modules/lodash-es/isObject.js");
/* harmony import */ var _rjsf_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @rjsf/utils */ "../../node_modules/@rjsf/utils/lib/index.js");
...
function createAjvInstance(additionalMetaSchemas, customFormats, ajvOptionsOverrides = {}, ajvFormatOptions, AjvClass = (ajv__WEBPACK_IMPORTED_MODULE_0___default())) {
    ...
    ajv.addKeyword(_rjsf_utils__WEBPACK_IMPORTED_MODULE_2__.ADDITIONAL_PROPERTY_FLAG);
    ajv.addKeyword(_rjsf_utils__WEBPACK_IMPORTED_MODULE_2__.RJSF_ADDITIONAL_PROPERTIES_FLAG);
    // add more schemas to validate against
    if (Array.isArray(additionalMetaSchemas)) {
        ajv.addMetaSchema(additionalMetaSchemas);
    }
    // add more custom formats to validate against
    if ((0,lodash_es_isObject_js__WEBPACK_IMPORTED_MODULE_3__["default"])(customFormats)) {
...
/* harmony export */ });
/* harmony import */ var _precompiledValidator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./precompiledValidator.js */ "../../node_modules/@rjsf/validator-ajv8/lib/precompiledValidator.js");
...
function createPrecompiledValidator(validateFns, rootSchema, localizer) {
    return new _precompiledValidator_js__WEBPACK_IMPORTED_MODULE_0__["default"](validateFns, rootSchema, localizer);
}
...
/* harmony export */ });
/* harmony import */ var _validator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validator.js */ "../../node_modules/@rjsf/validator-ajv8/lib/validator.js");
...
function customizeValidator(options = {}, localizer) {
    return new _validator_js__WEBPACK_IMPORTED_MODULE_0__["default"](options, localizer);
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   createPrecompiledValidator: () => (/* reexport safe */ _createPrecompiledValidator_js__WEBPACK_IMPORTED_MODULE_1__["default"]),
/* harmony export */   customizeValidator: () => (/* reexport safe */ _customizeValidator_js__WEBPACK_IMPORTED_MODULE_0__["default"]),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _customizeValidator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./customizeValidator.js */ "../../node_modules/@rjsf/validator-ajv8/lib/customizeValidator.js");
/* harmony import */ var _createPrecompiledValidator_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createPrecompiledValidator.js */ "../../node_modules/@rjsf/validator-ajv8/lib/createPrecompiledValidator.js");
/* harmony import */ var _types_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./types.js */ "../../node_modules/@rjsf/validator-ajv8/lib/types.js");




/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_customizeValidator_js__WEBPACK_IMPORTED_MODULE_0__["default"])());
...
/* harmony export */ });
/* harmony import */ var lodash_es_get_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! lodash-es/get.js */ "../../node_modules/lodash-es/get.js");
/* harmony import */ var _rjsf_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @rjsf/utils */ "../../node_modules/@rjsf/utils/lib/index.js");
/* harmony import */ var _processRawValidationErrors_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./processRawValidationErrors.js */ "../../node_modules/@rjsf/validator-ajv8/lib/processRawValidationErrors.js");
...
class AJV8PrecompiledValidator {
     ...
     */
    getValidator(schema) {
        const key = (0,lodash_es_get_js__WEBPACK_IMPORTED_MODULE_2__["default"])(schema, _rjsf_utils__WEBPACK_IMPORTED_MODULE_0__.ID_KEY) || (0,_rjsf_utils__WEBPACK_IMPORTED_MODULE_0__.hashForSchema)(schema);
    ...
    ensureSameRootSchema(schema, formData) {
        if (!(0,_rjsf_utils__WEBPACK_IMPORTED_MODULE_0__.deepEquals)(schema, this.rootSchema)) {
            // Resolve the root schema with the passed in form data since that may affect the resolution
            const resolvedRootSchema = (0,_rjsf_utils__WEBPACK_IMPORTED_MODULE_0__.retrieveSchema)(this, this.rootSchema, this.rootSchema, formData);
            if (!(0,_rjsf_utils__WEBPACK_IMPORTED_MODULE_0__.deepEquals)(schema, resolvedRootSchema)) {
    ...
    validateFormData(formData, schema, customValidate, transformErrors, uiSchema) {
        ...
        return (0,_processRawValidationErrors_js__WEBPACK_IMPORTED_MODULE_1__["default"])(this, rawErrors, formData, schema, customValidate, transformErrors, uiSchema);
    }
    ...
    isValid(schema, formData, rootSchema) {
        ...
        if ((0,lodash_es_get_js__WEBPACK_IMPORTED_MODULE_2__["default"])(schema, _rjsf_utils__WEBPACK_IMPORTED_MODULE_0__.ID_KEY) === _rjsf_utils__WEBPACK_IMPORTED_MODULE_0__.JUNK_OPTION_ID) {
            return false;
        }
    ...
    return errors.map((e) => {
        ...
        if (rawPropertyNames.length > 0) {
            rawPropertyNames.forEach((currentProperty) => {
                ...
                let uiSchemaTitle = (0,_rjsf_utils__WEBPACK_IMPORTED_MODULE_0__.getUiOptions)((0,lodash_es_get_js__WEBPACK_IMPORTED_MODULE_1__["default"])(uiSchema, `${path.replace(/^\./, '')}`)).title;
                if (uiSchemaTitle === undefined) {
                    ...
                    uiSchemaTitle = (0,_rjsf_utils__WEBPACK_IMPORTED_MODULE_0__.getUiOptions)((0,lodash_es_get_js__WEBPACK_IMPORTED_MODULE_1__["default"])(uiSchema, uiSchemaPath)).title;
                }
                if (uiSchemaTitle) {
                    message = message.replace(`'${currentProperty}'`, `'${uiSchemaTitle}'`);
                }
                else {
                    const parentSchemaTitle = (0,lodash_es_get_js__WEBPACK_IMPORTED_MODULE_1__["default"])(parentSchema, [_rjsf_utils__WEBPACK_IMPORTED_MODULE_0__.PROPERTIES_KEY, currentProperty, 'title']);
            ...
            const uiSchemaTitle = (0,_rjsf_utils__WEBPACK_IMPORTED_MODULE_0__.getUiOptions)((0,lodash_es_get_js__WEBPACK_IMPORTED_MODULE_1__["default"])(uiSchema, `${property.replace(/^\./, '')}`)).title;
            if (uiSchemaTitle) {
...
function processRawValidationErrors(validator, rawErrors, formData, schema, customValidate, transformErrors, uiSchema) {
    ...
    let errorSchema = (0,_rjsf_utils__WEBPACK_IMPORTED_MODULE_0__.toErrorSchema)(errors);
    if (invalidSchemaError) {
        errorSchema = {
            ...errorSchema,
            $schema: {
    ...
    const newFormData = (0,_rjsf_utils__WEBPACK_IMPORTED_MODULE_0__.getDefaultFormState)(validator, schema, formData, schema, true);
    const errorHandler = customValidate(newFormData, (0,_rjsf_utils__WEBPACK_IMPORTED_MODULE_0__.createErrorHandler)(newFormData), uiSchema);
    const userErrorSchema = (0,_rjsf_utils__WEBPACK_IMPORTED_MODULE_0__.unwrapErrorHandler)(errorHandler);
    return (0,_rjsf_utils__WEBPACK_IMPORTED_MODULE_0__.validationDataMerge)({ errors, errorSchema }, userErrorSchema);
}
...
/* harmony export */ });
/* harmony import */ var _rjsf_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @rjsf/utils */ "../../node_modules/@rjsf/utils/lib/index.js");
/* harmony import */ var _createAjvInstance_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createAjvInstance.js */ "../../node_modules/@rjsf/validator-ajv8/lib/createAjvInstance.js");
/* harmony import */ var _processRawValidationErrors_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./processRawValidationErrors.js */ "../../node_modules/@rjsf/validator-ajv8/lib/processRawValidationErrors.js");
...
class AJV8Validator {
    ...
    constructor(options, localizer) {
        ...
        this.ajv = (0,_createAjvInstance_js__WEBPACK_IMPORTED_MODULE_1__["default"])(additionalMetaSchemas, customFormats, ajvOptionsOverrides, ajvFormatOptions, AjvClass);
        this.localizer = localizer;
    }
    ...
    validateFormData(formData, schema, customValidate, transformErrors, uiSchema) {
        const rawErrors = this.rawValidation(schema, formData);
        return (0,_processRawValidationErrors_js__WEBPACK_IMPORTED_MODULE_2__["default"])(this, rawErrors, formData, schema, customValidate, transformErrors, uiSchema);
    }
    /**
...
//# sourceMappingURL=vendors-node_modules_rjsf_core_lib_index_js-node_modules_rjsf_validator-ajv8_lib_index_js-nod-1f57ca.b14744809994ce06e21c.js.map