...
`,
      ...
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        class FilterTools extends react_1.default.Component {
          ...
          createFilterBox() {
            ...
            filterOption === null || filterOption === void 0
              ? void 0
          ...
          renderTags() {
            ...
            return react_1.default.createElement(
              'div',
              { className: FILTER_TAGS },
              this.props.tags.sort().map((tag, index) => {
          ...
          renderAppliedTag(tag, index) {
            return react_1.default.createElement(
              ...
              react_1.default.createElement(
                'span',
                { className: FILTER_TAG_LABEL },
                tag
              ),
              react_1.default.createElement(ui_components_2.checkIcon.react, {
          ...
          filterMetadata() {
            var _a;
            const isTagFilterOpen =
              (_a = document.querySelector(
                `#${this.props.schemaspace} .${FILTER_OPTION}`
              )) === null || _a === void 0
                ? void 0
                : _a.classList.contains('idle');
            this.props.onFilter(
          ...
          render() {
            return react_1.default.createElement(
              'div',
              { className: FILTER_TOOLS },
              react_1.default.createElement(
                'div',
                { className: FILTER_SEARCHBAR },
                react_1.default.createElement(ui_components_2.InputGroup, {
              ...
              this.props.omitTags
                ...
                : react_1.default.createElement(
                    'div',
                    { className: FILTER_CLASS, id: this.props.schemaspace },
                    react_1.default.createElement(
                      'button',
                      {
                        title: 'Filter by tag',
  ...
  \************************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const MetadataEditor = ({
          ...
          const schema =
            (_a = schemaTop.properties) === null || _a === void 0
              ? void 0
              : _a.metadata;
          const [metadata, setMetadata] = React.useState(initialMetadata);
          const displayName =
            (_b =
              initialMetadata === null || initialMetadata === void 0
                ? void 0
                : initialMetadata['_noCategory']) === null || _b === void 0
              ? void 0
              : _b['display_name'];
          const referenceURL =
            (_c = schemaTop.uihints) === null || _c === void 0
              ? void 0
              : _c.reference_url;
          ...
          const saveMetadata = () => {
              ...
              display_name:
                (_a =
                  metadata === null || metadata === void 0
                    ? void 0
                    : metadata['_noCategory']) === null || _a === void 0
                  ? void 0
                  : _a['display_name'],
            ...
            if (!name) {
              ...
              services_1.MetadataService.putMetadata(
                schemaspace,
                name,
                newMetadata
              )
          ...
          return React.createElement(
            'div',
            { onKeyPress: onKeyPress, className: ELYRA_METADATA_EDITOR_CLASS },
            ...
            React.createElement(ui_components_1.FormEditor, {
              ref: formRef,
              schema: schema,
              onChange: (formData) => {
            ...
            React.createElement(
              'div',
              {
                className: `elyra-metadataEditor-formInput elyra-metadataEditor-saveButton ${invalidForm ? 'errorForm' : ''}`,
                key: 'SaveButton'
              },
              invalidForm
                ? React.createElement(
  ...
  \******************************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const MetadataEditor_1 = __webpack_require__(
          /*! ./MetadataEditor */ '../metadata-common/lib/MetadataEditor.js'
        );
        ...
        class MetadataEditorWidget extends apputils_1.ReactWidget {
          ...
          loadSchemaAndMetadata() {
            return __awaiter(this, void 0, void 0, function* () {
              ...
              try {
                ...
                const allSchema = yield services_1.MetadataService.getSchema(
                  this.props.schemaspace
                );
                this.allMetadata = yield services_1.MetadataService.getMetadata(
                  this.props.schemaspace
                );
                if (!this.allMetadata) {
                  throw new Error(
                ...
                const schema =
                  allSchema === null || allSchema === void 0
                    ? void 0
                    : allSchema.find((s) => {
                ...
                if (!schema) {
                  throw new Error(
                    `Schema not found for ${this.props.schemaName}`
                  );
                }
                if (
                ...
                const schemaMetadata =
                  (_b = schema.properties) === null || _b === void 0
                    ...
                    : _b.metadata;
                const properties =
                  schemaMetadata === null || schemaMetadata === void 0
                    ? void 0
                ...
                for (const prop in properties) {
                  if (
                    (_c = properties[prop].uihints) === null || _c === void 0
                      ? void 0
                      : _c.hidden
                  ) {
                ...
                for (const schemaProperty in schemaMetadata.properties) {
                  ...
                  const category =
                    (_d = properties.uihints && properties.uihints.category) !==
                      null && _d !== void 0
                      ? _d
                      : '_noCategory';
                  ...
                  metadataWithCategories[category][schemaProperty] =
                    (_f =
                      (_e =
                        metadata === null || metadata === void 0
                          ? void 0
                          : metadata.metadata) === null || _e === void 0
                        ? void 0
                        : _e[schemaProperty]) !== null && _f !== void 0
                      ? _f
                      : properties.default;
                  ...
                  if (
                    (_g = schemaMetadata.required) === null || _g === void 0
                      ? void 0
                      : _g.includes(schemaProperty)
                  ) {
                    schemaPropertiesByCategory[category].required.push(
                      schemaProperty
                    );
                ...
                this.schema = schema;
                ((_h = this.schema.properties) === null || _h === void 0
                  ? void 0
                  : _h.metadata
                ).properties = schemaPropertiesByCategory;
                ((_j = this.schema.properties) === null || _j === void 0
                  ? void 0
                  : _j.metadata
                ...
                this.title.label =
                  (_k =
                    metadata === null || metadata === void 0
                      ? void 0
                      : metadata.display_name) !== null && _k !== void 0
                    ? _k
                    : `New ${this.schema.title}`;
                this.loading = false;
                this.update();
              } catch (error) {
                yield ui_components_1.RequestErrors.serverError(error);
          ...
          setFormFocus() {
            var _a;
            const isFocused =
              (_a = document.querySelector(`.${this.widgetClass}`)) === null ||
              _a === void 0
                ? void 0
          ...
          getDefaultChoices(fieldName) {
            ...
            const schema =
              (_a = this.schema.properties) === null || _a === void 0
                ? void 0
                : _a.metadata;
            for (const category in schema.properties) {
              const properties =
                schema.properties[category].properties[fieldName];
              if (!properties) {
                continue;
              }
              ...
              for (const otherMetadata of this.allMetadata) {
                if (
                  ...
                  otherMetadata !==
                    ((_b = this.metadata) === null || _b === void 0
                      ? void 0
                      : _b.metadata) &&
  ...
  \************************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        exports.MetadataWidget =
          exports.MetadataDisplay =
          exports.METADATA_ITEM =
          exports.METADATA_HEADER_CLASS =
          exports.METADATA_CLASS =
            void 0;
        const services_1 = __webpack_require__(
          /*! @elyra/services */ 'webpack/sharing/consume/default/@elyra/services/@elyra/services'
        );
        ...
        const FilterTools_1 = __webpack_require__(
          /*! ./FilterTools */ '../metadata-common/lib/FilterTools.js'
        );
        const MetadataCommonService_1 = __webpack_require__(
          /*! ./MetadataCommonService */ '../metadata-common/lib/MetadataCommonService.js'
        );
        /**
        ...
        class MetadataDisplay extends react_1.default.Component {
          constructor(props) {
            ...
            this.deleteMetadata = (metadata) => {
              return (0, apputils_1.showDialog)({
                ...
                if (result.button.accept) {
                  services_1.MetadataService.deleteMetadata(
                    this.props.schemaspace,
                    metadata.name
                  ).catch((error) =>
            ...
            this.renderMetadata = (metadata) => {
              return react_1.default.createElement(
                ...
                {
                  key: metadata.name,
                  className: exports.METADATA_ITEM,
                  style: this.state.metadata.includes(metadata)
                    ? {}
                    : { display: 'none' }
                },
                react_1.default.createElement(
                  ui_components_1.ExpandableComponent,
                  {
          ...
          actionButtons(metadata) {
            return [
              ...
              },
              {
                ...
                onClick: () => {
                  MetadataCommonService_1.MetadataCommonService.duplicateMetadataInstance(
                    this.props.schemaspace,
                    metadata,
                    this.props.metadata
                  )
          ...
          renderExpandableContent(metadata) {
            ...
            return react_1.default.createElement(
              ...
              react_1.default.createElement(ui_components_1.JSONComponent, {
                json: metadataWithoutTags
              })
            );
          }
          /**
          ...
          matchesTags(filterTags, metadata) {
            ...
            return (
              ...
              (tags === null || tags === void 0
                ? void 0
                : tags.some((tag) => filterTags.has(tag)))
            );
          }
          ...
          render() {
            ...
            return react_1.default.createElement(
              'div',
              { id: 'elyra-metadata', className: this.props.className },
              react_1.default.createElement(FilterTools_1.FilterTools, {
        ...
        class MetadataWidget extends apputils_1.ReactWidget {
          ...
          getSchemas() {
            return __awaiter(this, void 0, void 0, function* () {
              var _a, _b;
              try {
                this.schemas = yield services_1.MetadataService.getSchema(
                  this.props.schemaspace
                );
                const sortedSchema =
                  (_b =
          ...
          fetchMetadata() {
            return __awaiter(this, void 0, void 0, function* () {
              try {
                return yield services_1.MetadataService.getMetadata(
                  this.props.schemaspace
                );
              } catch (error) {
                yield ui_components_1.RequestErrors.serverError(error);
          ...
          omitTags() {
            var _a, _b, _c;
            for (const schema of (_a = this.schemas) !== null && _a !== void 0
              ? _a
              : []) {
              const metadata =
                (_b = schema.properties) === null || _b === void 0
              ...
              if (
                (_c =
                  metadata === null || metadata === void 0
                    ? void 0
                    : metadata.properties) === null || _c === void 0
                  ? void 0
                  : _c.tags
              ) {
                return false;
          ...
          renderDisplay(metadata) {
            ...
            return react_1.default.createElement(MetadataDisplay, {
              metadata: metadata,
              updateMetadata: this.updateMetadata,
              openMetadataEditor: this.openMetadataEditor,
              schemaspace: this.props.schemaspace,
              sortMetadata: true,
              className: `${exports.METADATA_CLASS}-${this.props.schemaspace}`,
          ...
          render() {
            ...
            return react_1.default.createElement(
              'div',
              { id: this.props.schemaspace, className: exports.METADATA_CLASS },
              react_1.default.createElement(
                'header',
                { className: exports.METADATA_HEADER_CLASS },
                react_1.default.createElement(
                  'div',
                  { style: { display: 'flex' } },
                  react_1.default.createElement(this.props.icon.react, {
                    tag: 'span',
                    width: 'auto',
                    height: '24px',
                ...
                react_1.default.createElement(
                  'div',
                  { className: 'elyra-metadataHeader-buttons' },
                  react_1.default.createElement(
                    'button',
                    {
                      ...
                      title:
                        (_b = this.refreshButtonTooltip) !== null &&
                        _b !== void 0
                          ? _b
                          : 'Refresh list'
                    },
                    react_1.default.createElement(
                      ui_components_2.refreshIcon.react,
                      { tag: 'span', elementPosition: 'center', width: '16px' }
                    )
                  ),
                  react_1.default.createElement('div', {
                    className: 'elyra-metadataHeader-buttonDivider'
                  }),
                  react_1.default.createElement(
                    'button',
                    {
                      className: `${METADATA_HEADER_BUTTON_CLASS} elyra-metadataHeader-addButton`,
                      onClick: singleSchema
                        ? () => {
                            var _a, _b;
  ...
  \***************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, '__esModule', { value: true });
        __webpack_require__(
          /*! ../style/index.css */ '../metadata-common/style/index.css'
        );
        __exportStar(
          __webpack_require__(
            /*! ./MetadataEditor */ '../metadata-common/lib/MetadataEditor.js'
        ...
        __exportStar(
          __webpack_require__(
            /*! ./MetadataWidget */ '../metadata-common/lib/MetadataWidget.js'
          ),
          exports
        );
        __exportStar(
        ...
        __exportStar(
          __webpack_require__(
            /*! ./MetadataEditorWidget */ '../metadata-common/lib/MetadataEditorWidget.js'
          ),
          exports
        );
  ...
  \******************************************/
      /***/ (
        ...
        /* harmony import */ var _node_modules_css_loader_dist_cjs_js_index_css__WEBPACK_IMPORTED_MODULE_6__ =
          __webpack_require__(
            /*! !!../../../node_modules/css-loader/dist/cjs.js!./index.css */ '../../node_modules/css-loader/dist/cjs.js!../metadata-common/style/index.css'
          );
...
//# sourceMappingURL=metadata-common_lib_index_js.ec65a47a670ceb775add.js.map
