...
`,
          ...
          {
            version: 3,
            sources: ['webpack://./../services/style/index.css'],
            names: [],
            mappings: 'AAAA;;;;;;;;;;;;;;EAcE',
            sourcesContent: [
              '/*\n * Copyright 2018-2025 Elyra Authors\n *\n * Licensed under the Apache License, Version 2.0 (the "License");\n * you may not use this file except in compliance with the License.\n * You may obtain a copy of the License at\n *\n * http://www.apache.org/licenses/LICENSE-2.0\n *\n * Unless required by applicable law or agreed to in writing, software\n * distributed under the License is distributed on an "AS IS" BASIS,\n * WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n * See the License for the specific language governing permissions and\n * limitations under the License.\n */\n'
  ...
  \********************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        __webpack_require__(
          /*! ../style/index.css */ '../services/style/index.css'
        );
        __exportStar(
          __webpack_require__(/*! ./parsing */ '../services/lib/parsing.js'),
          exports
        );
        __exportStar(
          __webpack_require__(/*! ./metadata */ '../services/lib/metadata.js'),
          exports
        );
        __exportStar(
          __webpack_require__(/*! ./requests */ '../services/lib/requests.js'),
          exports
        );
        __exportStar(
          __webpack_require__(/*! ./types */ '../services/lib/types.js'),
          exports
        );
  ...
  \***********************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const requests_1 = __webpack_require__(
          /*! ./requests */ '../services/lib/requests.js'
        );
        ...
        class MetadataService {
          ...
          static postMetadata(schemaspace, requestBody) {
            return __awaiter(this, void 0, void 0, function* () {
              return requests_1.RequestHandler.makePostRequest(
                ELYRA_METADATA_API_ENDPOINT + schemaspace,
          ...
          static putMetadata(schemaspace, name, requestBody) {
            return __awaiter(this, void 0, void 0, function* () {
              return requests_1.RequestHandler.makePutRequest(
          ...
          static deleteMetadata(schemaspace, name) {
            return __awaiter(this, void 0, void 0, function* () {
              yield requests_1.RequestHandler.makeDeleteRequest(
                `${ELYRA_METADATA_API_ENDPOINT}${schemaspace}/${name}`
              );
            });
          }
          ...
          static getSchema(schemaspace) {
            return __awaiter(this, void 0, void 0, function* () {
              if (this.schemaCache[schemaspace]) {
                ...
                return JSON.parse(
                  JSON.stringify(this.schemaCache[schemaspace])
                );
              }
              return requests_1.RequestHandler.makeGetRequest(
          ...
          static getAllSchema() {
            return __awaiter(this, void 0, void 0, function* () {
              var _a;
              try {
                const response = yield requests_1.RequestHandler.makeGetRequest(
                  ELYRA_SCHEMASPACE_API_ENDPOINT
                );
                const schemas = [];
                for (const schemaspace of (_a =
                  response === null || response === void 0
                    ? void 0
                    : response.schemaspaces) !== null && _a !== void 0
                  ? _a
                  : []) {
              ...
              try {
                ...
                return Object.keys(
                  (_a =
                    response === null || response === void 0
                      ? void 0
                      : response.env_vars) !== null && _a !== void 0
                    ? _a
                    : {}
                );
              } catch (error) {
        ...
        class RequestHandler {
          ...
          static makeServerRequest(requestPath, options, longRequestDialog) {
            return __awaiter(this, void 0, void 0, function* () {
              ...
              const requestUrl = coreutils_1.URLExt.join(
                settings.baseUrl,
                requestPath
              );
              const { type = 'json' } = options,
                requestInit = __rest(options, ['type']);
              console.log(
                `Sending a ${requestInit.method} request to ${requestUrl}`
              );
              if (longRequestDialog) {
                longRequestDialog.launch();
              }
              const getServerResponse = new Promise((resolve, reject) => {
                services_1.ServerConnection.makeRequest(
                  requestUrl,
                  requestInit,
                  settings
                ).then(
  ...
  \***********************************/
      /***/ (
        ...
        /* harmony import */ var _node_modules_css_loader_dist_cjs_js_index_css__WEBPACK_IMPORTED_MODULE_6__ =
          __webpack_require__(
            /*! !!../../../node_modules/css-loader/dist/cjs.js!./index.css */ '../../node_modules/css-loader/dist/cjs.js!../services/style/index.css'
          );
...
//# sourceMappingURL=services_lib_index_js.19db0cc9112d7e843c07.js.map
