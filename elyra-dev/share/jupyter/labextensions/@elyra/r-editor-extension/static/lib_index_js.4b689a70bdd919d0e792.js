...
(self['webpackChunk_elyra_r_editor_extension'] =
  ...
  \**********************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const REditor_1 = __webpack_require__(
          /*! ./REditor */ './lib/REditor.js'
        );
        ...
        const extension = {
          ...
          activate: (
            ...
            app.commands.addCommand(commandIDs.createNewREditor, {
              label: (args) =>
                args['isPalette'] ? 'New R Editor' : 'R Editor',
              caption: 'Create a new R Editor',
              icon: (args) =>
                args['isPalette'] ? undefined : ui_components_1.rIcon,
              execute: (args) => {
                //Use file browser's current path instead of defaultBrowser.model.path
                const fileBrowser =
                  browserFactory.createFileBrowser('myFileBrowser');
                const cwd = args['cwd']
                  ? String(args['cwd'])
...
//# sourceMappingURL=lib_index_js.4b689a70bdd919d0e792.js.map
