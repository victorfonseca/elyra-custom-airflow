...
(self['webpackChunk_elyra_r_editor_extension'] =
  ...
  \**********************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const DropDown = (0, react_1.forwardRef)(
          ({ specs, defaultKernel, callback }, select) => {
            const kernelspecs = (0, react_1.useMemo)(
              () => Object.assign({}, specs.kernelspecs),
              [specs]
            );
              ...
              : Object.entries(kernelspecs).map(([key, val]) => {
                  ...
                  return react_1.default.createElement(
                    ...
                    (_a =
                      val === null || val === void 0
                        ? void 0
                        : val.display_name) !== null && _a !== void 0
                      ? _a
                      : key
                  );
                });
            ...
            return react_1.default.createElement(
              ui_components_1.HTMLSelect,
              { onChange: handleSelection, value: selection },
              kernelOptions
            );
          }
        );
        ...
        class KernelDropdown extends apputils_1.ReactWidget {
          ...
          render() {
            return react_1.default.createElement(DropDown, {
              ref: this.ref,
              specs: this.specs,
  ...
  \********************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const logconsole_1 = __webpack_require__(
          /*! @jupyterlab/logconsole */ 'webpack/sharing/consume/default/@jupyterlab/logconsole'
        );
        const outputarea_1 = __webpack_require__(
          /*! @jupyterlab/outputarea */ 'webpack/sharing/consume/default/@jupyterlab/outputarea'
        );
        const rendermime_1 = __webpack_require__(
        ...
        const KernelDropdown_1 = __webpack_require__(
          /*! ./KernelDropdown */ '../script-editor/lib/KernelDropdown.js'
        );
        const ScriptEditorController_1 = __webpack_require__(
          /*! ./ScriptEditorController */ '../script-editor/lib/ScriptEditorController.js'
        );
        const ScriptRunner_1 = __webpack_require__(
          /*! ./ScriptRunner */ '../script-editor/lib/ScriptRunner.js'
        );
        /**
        ...
        class ScriptEditor extends docregistry_1.DocumentWidget {
          ...
          constructor(options) {
            super(options);
            this.debuggerAvailable = (kernelName) =>
              __awaiter(this, void 0, void 0, function* () {
                return yield this.controller.debuggerAvailable(kernelName);
              });
            /**
            ...
            this.initializeKernelSpecs = () =>
              __awaiter(this, void 0, void 0, function* () {
                ...
                const kernelSpecs =
                  yield this.controller.getKernelSpecsByLanguage(language);
                this.defaultKernel =
                  yield this.controller.getDefaultKernel(language);
                ...
                if (kernelSpecs !== null) {
                  this.toolbar.insertItem(
                    4,
                    'select',
                    new KernelDropdown_1.KernelDropdown(
                      kernelSpecs,
                      this.defaultKernel,
            ...
            this.handleKernelSelectionUpdate = (selectedKernel) =>
              __awaiter(this, void 0, void 0, function* () {
            ...
            this.createOutputAreaWidget = () => {
              ...
              this.dockPanel = new ui_components_2.DockPanelSvg({
                tabsMovable: false
              });
              widgets_1.Widget.attach(this.dockPanel, document.body);
              window.addEventListener('resize', () => {
                var _a;
                (_a = this.dockPanel) === null || _a === void 0
                  ? void 0
                  : _a.fit();
              });
              // Create output area widget
              const model = new outputarea_1.OutputAreaModel();
              const renderMimeRegistry = new rendermime_1.RenderMimeRegistry({
            ...
            this.clearOutputArea = () => {
              ...
              (_a = this.dockPanel) === null || _a === void 0
                ? void 0
                : _a.hide();
              (_b = this.outputAreaWidget) === null || _b === void 0
                ? void 0
                : _b.model.clear();
              (_c = this.outputAreaWidget) === null || _c === void 0
                ? void 0
                : _c.removeClass(OUTPUT_AREA_ERROR_CLASS); // if no error class is found, command is ignored
            };
            /**
            ...
            this.createScrollButtons = (scrollingWidget) => {
              ...
              scrollDownButton.onclick = function () {
                scrollingWidget.node.scrollTop =
                  scrollingWidget.node.scrollHeight;
              };
              ...
              (_a = this.dockPanel) === null || _a === void 0
                ? void 0
                : _a.node.appendChild(scrollUpButton);
              (_b = this.dockPanel) === null || _b === void 0
                ? void 0
                : _b.node.appendChild(scrollDownButton);
            };
            /**
            ...
            this.displayOutputArea = () => {
              ...
              if (
                ...
                !((_b =
                  (_a = this.kernelSelectorRef) === null || _a === void 0
                    ? void 0
              ...
              (_c = this.dockPanel) === null || _c === void 0
                ? void 0
                : _c.show();
              ...
              if (
                (_d = this.dockPanel) === null || _d === void 0
                  ? void 0
                  : _d.isEmpty
              ) {
                ...
                (_e = this.dockPanel) === null || _e === void 0
                  ? void 0
                  : _e.addWidget(this.scrollingWidget, {
                      mode: 'split-bottom'
                    });
                const outputTab =
                  (_f = this.dockPanel) === null || _f === void 0
                    ? void 0
                    : _f.tabBars().next().value;
            ...
            this.displayOutput = (output) => {
              ...
              if (output) {
                ...
                if (this.emptyOutput) {
                  ...
                  (_a = this.outputAreaWidget) === null || _a === void 0
                    ? void 0
                    : _a.model.clear(false);
                  (_b = this.outputAreaWidget) === null || _b === void 0
                    ? void 0
                    : _b.model.add(options);
                  ...
                  (_d = this.outputAreaWidget) === null || _d === void 0
                    ? void 0
                    : _d.model.add(options);
                }
                this.updatePromptText('*');
                this.setOutputAreaClasses();
              }
            ...
            this.setOutputAreaClasses = () => {
              ...
              this.getOutputAreaOutputWidget().addClass(
                OUTPUT_AREA_OUTPUT_CLASS
              );
              this.getOutputAreaPromptWidget().addClass(
                OUTPUT_AREA_PROMPT_CLASS
              );
            };
            /**
            ...
            this.getOutputAreaOutputWidget = () => {
              const outputAreaChildLayout =
                this.getOutputAreaChildWidget().layout;
            ...
            this.runner = new ScriptRunner_1.ScriptRunner(
              this.disableRunButton
            );
            this.kernelSelectorRef = null;
            this.emptyOutput = true;
            this.controller =
              new ScriptEditorController_1.ScriptEditorController();
          ...
          get kernelSelection() {
            var _a, _b;
            return (_b =
              (_a = this.kernelName) !== null && _a !== void 0
                ? _a
                : this.defaultKernel) !== null && _b !== void 0
              ? _b
              : '';
          }
        }
      ...
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        class ScriptEditorController {
          constructor() {
             ...
             */
            this.getKernelSpecsByLanguage = (language) =>
              __awaiter(this, void 0, void 0, function* () {
                var _a;
                const specs = yield this.getKernelSpecs();
                Object.entries(
                  (_a =
                    specs === null || specs === void 0
                      ? void 0
                      : specs.kernelspecs) !== null && _a !== void 0
                    ? _a
                    : []
                )
                  .filter((entry) => {
                    var _a;
                    return (
                      ((_a = entry[1]) === null || _a === void 0
                        ? void 0
                        : _a.language.includes(language)) === false
                    );
                  })
                  .forEach((entry) =>
                    specs === null || specs === void 0
                      ? true
                      : delete specs.kernelspecs[entry[0]]
                  );
                return specs;
              });
            /**
             ...
             */
            this.getKernelSpecsByName = (kernelName) =>
              __awaiter(this, void 0, void 0, function* () {
                var _a;
                const specs = yield this.getKernelSpecs();
                Object.entries(
             ...
             */
            this.getDefaultKernel = (language) =>
              __awaiter(this, void 0, void 0, function* () {
                var _a;
                ...
                if (
                  (_a = kernelSpecs.default) === null || _a === void 0
                    ? void 0
                    : _a.includes(language)
                ) {
                  return kernelSpecs.default;
                }
                return this.getFirstKernelName(language);
              });
            this.getFirstKernelName = (language) =>
              __awaiter(this, void 0, void 0, function* () {
                var _a;
                const specsByLang =
                  yield this.getKernelSpecsByLanguage(language);
                const empty = '';
                if (
                  specsByLang &&
                  Object.keys(specsByLang.kernelspecs).length !== 0
                ) {
                  const [key, value] = Object.entries(
                    specsByLang.kernelspecs
                  )[0];
                  return (_a =
                    value === null || value === void 0
                      ? void 0
                      : value.name) !== null && _a !== void 0
                    ? _a
                    : key;
                }
                return empty;
                ...
                return !!((_c =
                  (_b =
                    (_a =
                      specs === null || specs === void 0
                        ? void 0
                        : specs.kernelspecs[kernelName]) === null ||
                    _a === void 0
                      ? void 0
                      : _a.metadata) === null || _b === void 0
                    ? void 0
                    : _b['debugger']) !== null && _c !== void 0
                  ? _c
                  : false);
              });
        ...
        class ScriptEditorWidgetFactory extends docregistry_1.ABCWidgetFactory {
          ...
          createNewWidget(context) {
            const newDocumentEditor =
              this._services.factoryService.newDocumentEditor;
      ...
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        class ScriptRunner {
          ...
          constructor(disableButton) {
             ...
             */
            this.runScript = (kernelName, contextPath, code, handleKernelMsg) =>
              __awaiter(this, void 0, void 0, function* () {
                var _a;
                ...
                if (
                  !((_a = this.sessionConnection) === null || _a === void 0
                    ? void 0
                    : _a.kernel)
                ) {
                ...
                const future = this.sessionConnection.kernel.requestExecute({
                  code
                });
                future.onIOPub = (msg) => {
                  ...
                  if (msgType === 'error') {
                    ...
                    if ('text/plain' in resultMsg.content.data) {
                      ...
                      console.log(
                        'Ignoring received message ' + JSON.stringify(msg)
                      );
                    }
             ...
             */
            this.startSession = (kernelName, contextPath) =>
              __awaiter(this, void 0, void 0, function* () {
                const options = {
                  kernel: {
                    name: kernelName
                ...
                if (!this.sessionConnection || !this.sessionConnection.kernel) {
                  try {
                    this.sessionConnection =
                      yield this.sessionManager.startNew(options);
                    this.sessionConnection.setPath(contextPath);
                  } catch (e) {
                    console.log(
                      'Exception: kernel start = ' + JSON.stringify(e)
                    );
                  }
                }
              });
            ...
            this.shutdownSession = () =>
              __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.sessionConnection) {
                  const name =
                    (_a = this.sessionConnection.kernel) === null ||
                    _a === void 0
                      ? void 0
                      : _a.name;
                  try {
                    ...
                    console.log(
                      'Exception: session shutdown = ' + JSON.stringify(e)
                    );
                  }
                }
              });
            ...
            this.shutdownKernel = () =>
              __awaiter(this, void 0, void 0, function* () {
                if (this.sessionConnection) {
                  ...
                  try {
                    kernel &&
                      (yield services_1.KernelAPI.shutdownKernel(kernel.id));
                    console.log(
                      (kernel === null || kernel === void 0
                        ? void 0
                        : kernel.name) + ' kernel shutdown'
                    );
                  } catch (e) {
                    console.log(
                      'Exception: kernel shutdown = ' + JSON.stringify(e)
                    );
                  }
                }
              });
            ...
            this.interruptKernel = () =>
              __awaiter(this, void 0, void 0, function* () {
                if (this.sessionConnection) {
                  ...
                  try {
                    kernel &&
                      (yield services_1.KernelAPI.interruptKernel(
                        kernel.id,
                    ...
                    console.log(
                      (kernel === null || kernel === void 0
                        ? void 0
                        : kernel.name) + ' kernel interrupted.'
                    );
                    this.disableButton(false);
                  } catch (e) {
                    console.log(
                      'Exception: kernel interrupt = ' + JSON.stringify(e)
                    );
                  }
                }
              });
  ...
  \*************************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        __exportStar(
          __webpack_require__(
            /*! ./ScriptEditor */ '../script-editor/lib/ScriptEditor.js'
          ),
          exports
        );
        __exportStar(
        ...
        __exportStar(
          __webpack_require__(
            /*! ./ScriptEditorWidgetFactory */ '../script-editor/lib/ScriptEditorWidgetFactory.js'
          ),
          exports
        );
...
//# sourceMappingURL=script-editor_lib_index_js.1eadc057f4766f48a07e.js.map
