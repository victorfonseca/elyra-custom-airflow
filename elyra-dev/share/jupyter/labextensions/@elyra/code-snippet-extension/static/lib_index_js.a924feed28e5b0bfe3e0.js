...
(self['webpackChunk_elyra_code_snippet_extension'] =
  ...
  \***********************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        exports.CodeSnippetService =
          exports.CODE_SNIPPET_SCHEMA =
          exports.CODE_SNIPPET_SCHEMASPACE =
            void 0;
        ...
        class CodeSnippetService {
          static findAll() {
            return __awaiter(this, void 0, void 0, function* () {
              var _a;
              return (_a = yield services_1.MetadataService.getMetadata(
                exports.CODE_SNIPPET_SCHEMASPACE
              )) !== null && _a !== void 0
                ? _a
                : [];
          ...
          static deleteCodeSnippet(codeSnippet) {
            return (0, apputils_1.showDialog)({
              ...
              if (result.button.accept) {
                return services_1.MetadataService.deleteMetadata(
                  exports.CODE_SNIPPET_SCHEMASPACE,
                  codeSnippet.name
                ).then(() => true);
              } else {
  ...
  \**********************************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const cells_1 = __webpack_require__(
          /*! @jupyterlab/cells */ 'webpack/sharing/consume/default/@jupyterlab/cells'
        );
        const codeeditor_1 = __webpack_require__(
          /*! @jupyterlab/codeeditor */ 'webpack/sharing/consume/default/@jupyterlab/codeeditor'
        );
        const codemirror_1 = __webpack_require__(
          /*! @jupyterlab/codemirror */ 'webpack/sharing/consume/default/@jupyterlab/codemirror'
        );
        ...
        const notebook_1 = __webpack_require__(
        ...
        const coreutils_2 = __webpack_require__(
          /*! @lumino/coreutils */ 'webpack/sharing/consume/default/@lumino/coreutils'
        );
        const dragdrop_1 = __webpack_require__(
          /*! @lumino/dragdrop */ 'webpack/sharing/consume/default/@lumino/dragdrop'
        );
        ...
        const CodeSnippetService_1 = __webpack_require__(
          /*! ./CodeSnippetService */ './lib/CodeSnippetService.js'
        );
        ...
        class CodeSnippetDisplay extends metadata_common_1.MetadataDisplay {
          constructor(props) {
            ...
            this.insertCodeSnippet = (snippet) =>
              __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.isFileEditor(widget)) {
                  ...
                  if (
                    coreutils_1.PathExt.extname(widget.context.path).match(
                      markdownRegex
                    ) !== null &&
                    snippetLanguage.toLowerCase() !== 'markdown'
                  ) {
                    (_a = fileEditor.replaceSelection) === null || _a === void 0
                      ? void 0
                      : _a.call(
                          fileEditor,
                    ...
                    yield this.verifyLanguageAndInsert(
                      snippet,
                      editorLanguage,
                      fileEditor
                    );
                  } else {
                    (_b = fileEditor.replaceSelection) === null || _b === void 0
                      ? void 0
                      : _b.call(fileEditor, codeSnippet);
                  }
                  ...
                  if (notebookCellEditor !== null) {
                    if (notebookCell instanceof cells_1.CodeCell) {
                      const kernelInfo = yield (_d =
                        (_c = notebookWidget.sessionContext.session) === null ||
                        _c === void 0
                          ? void 0
                          : _c.kernel) === null || _d === void 0
                        ? void 0
                        : _d.info;
                      const kernelLanguage =
                        (kernelInfo === null || kernelInfo === void 0
                          ? void 0
                          : kernelInfo.language_info.name) || '';
                      yield this.verifyLanguageAndInsert(
                        snippet,
                        kernelLanguage,
                        notebookCellEditor
                      ...
                      notebookCell instanceof cells_1.MarkdownCell &&
                      snippetLanguage.toLowerCase() !== 'markdown'
                    ) {
                      (_e = notebookCellEditor.replaceSelection) === null ||
                      _e === void 0
                        ? void 0
                        : _e.call(
                            notebookCellEditor,
                      ...
                      (_f = notebookCellEditor.replaceSelection) === null ||
                      _f === void 0
                        ? void 0
                        : _f.call(notebookCellEditor, codeSnippet);
                    }
                    const notebookContent = notebookWidget.content;
                    const activeCellIndex =
                      (_g = notebookContent.activeCellIndex) !== null &&
                      _g !== void 0
                        ? _g
                        : -1;
                    const contentFactory =
                      new notebook_1.NotebookPanel.ContentFactory({
                        editorFactory:
                          this.props.editorServices.factoryService
                            .newInlineEditor
                      });
                    /*
                    ...
                    */
                    const options = {
                      model:
                        (_h = notebookContent.activeCell) === null ||
                        _h === void 0
                          ? void 0
                          : _h.model,
                    ...
                    (_j = widget.content.model) === null || _j === void 0
                      ? void 0
                      : _j.sharedModel.insertCell(activeCellIndex, codeCell);
                    //update the active cell index to the newly inserted cell
                    notebookWidget.content.activeCellIndex =
                      activeCellIndex + 1;
                  } else {
                    this.showErrDialog(
                      'notebookCellEditor have to be not null'
                    );
                  }
                } else {
                  this.showErrDialog(
            ...
            this.getEditorLanguage = (widget) => {
              ...
              const editorLanguage =
                codemirror_1.EditorLanguageRegistry.getDefaultLanguages().find(
                  (language) =>
                    language.mime.includes(widget.content.model.mimeType)
                );
              return (_a =
                editorLanguage === null || editorLanguage === void 0
                  ? void 0
                  : editorLanguage.displayName) !== null && _a !== void 0
                ? _a
                : '';
            };
            ...
            this.verifyLanguageAndInsert = (snippet, editorLanguage, editor) =>
              __awaiter(this, void 0, void 0, function* () {
                var _a, _b;
                const codeSnippet = this.extractMetadataCodeSnippet(snippet);
                const snippetLanguage = this.extractMetadataLanguage(snippet);
                if (
                  ...
                  const result = yield this.showWarnDialog(
                    editorLanguage,
                    snippet.display_name
                  );
                  if (result.button.accept) {
                    (_a = editor.replaceSelection) === null || _a === void 0
                      ? void 0
                      : _a.call(editor, codeSnippet);
                  }
                } else {
                  // Language match or editorLanguage is unavailable
                  (_b = editor.replaceSelection) === null || _b === void 0
                    ? void 0
                    : _b.call(editor, codeSnippet);
                }
              });
            // Display warning dialog when inserting a code snippet incompatible with editor's language
            this.showWarnDialog = (editorLanguage, snippetName) =>
              __awaiter(this, void 0, void 0, function* () {
                return (0, apputils_1.showDialog)({
                  title: 'Warning',
            ...
            this.extractMetadataCodeSnippet = (metadata) => {
              var _a;
              const codeLines =
                (_a = metadata.metadata.code) !== null && _a !== void 0
                  ? _a
                  : [];
            ...
            this.extractMetadataLanguage = (metadata) => {
              var _a;
              return (_a = metadata.metadata.language) !== null && _a !== void 0
                ? _a
                : 'Unknown';
            };
            this.extractMetadataDescription = (metadata) => {
              var _a;
              return (_a = metadata.metadata.description) !== null &&
                _a !== void 0
                ? _a
                : '';
            };
              ...
              return [
                {
                  ...
                  feedback: 'Copied!',
                  onClick: () => {
                    apputils_1.Clipboard.copyToSystem(
                      this.extractMetadataCodeSnippet(metadata)
                    );
                  }
                },
                ...
                },
                {
                  ...
                  onClick: () => {
                    this.props.openMetadataEditor({
                      ...
                      schemaspace:
                        CodeSnippetService_1.CODE_SNIPPET_SCHEMASPACE,
                ...
                },
                {
                  ...
                  onClick: () => {
                    metadata_common_1.MetadataCommonService.duplicateMetadataInstance(
                      CodeSnippetService_1.CODE_SNIPPET_SCHEMASPACE,
                      metadata,
                      this.props.metadata
                    )
                      ...
                      .catch((error) =>
                        __awaiter(this, void 0, void 0, function* () {
                          yield ui_components_1.RequestErrors.serverError(
                            error
                          );
                        })
                      );
                ...
                },
                {
                  ...
                  onClick: () => {
                    CodeSnippetService_1.CodeSnippetService.deleteCodeSnippet(
                      metadata
                    )
                      .then((deleted) => {
                        if (deleted) {
                          ...
                          const editorWidget = (0, algorithm_1.find)(
            ...
            this.renderMetadata = (metadata) => {
              return react_1.default.createElement(
                'div',
                {
                  ...
                  className: metadata_common_1.METADATA_ITEM,
            ...
            this.createPreviewEditors = () => {
              ...
              this.props.metadata.map((codeSnippet) => {
                ...
                if (codeSnippet.name in this.editors) {
                  ...
                  this.editors[codeSnippet.name].model.sharedModel.setSource(
                    content
                  );
                } else {
                  // Add new snippets
                  const snippetElement = document.getElementById(
                    codeSnippet.name
                  );
          ...
          startDrag(dragImage, metadata, clientX, clientY) {
            return __awaiter(this, void 0, void 0, function* () {
              ...
              const options = {
                model:
                  (_a = notebookContent.activeCell) === null || _a === void 0
                    ? void 0
                    : _a.model,
                rendermime: notebookContent.rendermime,
                contentFactory: contentFactory
              ...
              const options2 = {
                model:
                  (_b = notebookContent.activeCell) === null || _b === void 0
                    ? void 0
                    : _b.model,
                rendermime: notebookContent.rendermime,
                contentFactory: contentFactory
        ...
        class CodeSnippetWidget extends metadata_common_1.MetadataWidget {
          ...
          fetchMetadata() {
            return __awaiter(this, void 0, void 0, function* () {
              return CodeSnippetService_1.CodeSnippetService.findAll().catch(
                (error) =>
                  __awaiter(this, void 0, void 0, function* () {
          ...
          renderDisplay(metadata) {
            ...
            return react_1.default.createElement(CodeSnippetDisplay, {
              metadata: metadata,
  ...
  \**********************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const markdownviewer_1 = __webpack_require__(
          /*! @jupyterlab/markdownviewer */ 'webpack/sharing/consume/default/@jupyterlab/markdownviewer'
        );
        const notebook_1 = __webpack_require__(
          /*! @jupyterlab/notebook */ 'webpack/sharing/consume/default/@jupyterlab/notebook'
        );
        ...
        const CodeSnippetWidget_1 = __webpack_require__(
          /*! ./CodeSnippetWidget */ './lib/CodeSnippetWidget.js'
        );
        ...
        exports.code_snippet_extension = {
          ...
          activate: (app, palette, restorer, editorServices) => {
            ...
            app.commands.addCommand(commandIDs.saveAsSnippet, {
              ...
              isEnabled: () => {
                ...
                if (editor) {
                  ...
                  selection =
                    (_b =
                      (_a = document.getSelection()) === null || _a === void 0
                        ? void 0
            ...
            const isFileEditor = (currentWidget) => {
              return (
                currentWidget instanceof docregistry_1.DocumentWidget &&
            ...
            const getEditor = (currentWidget) => {
              if (isFileEditor(currentWidget)) {
                ...
                const notebookWidget = currentWidget;
                const notebookCell = notebookWidget.content.activeCell;
                return notebookCell === null || notebookCell === void 0
                  ? void 0
                  : notebookCell.editor;
              }
              return undefined;
