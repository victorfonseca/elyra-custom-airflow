...
(self['webpackChunk_elyra_scala_editor_extension'] =
  ...
  \**********************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const ScalaEditor_1 = __webpack_require__(
          /*! ./ScalaEditor */ './lib/ScalaEditor.js'
        );
          ...
          activate: (
            ...
            const factory = new script_editor_1.ScriptEditorWidgetFactory({
              ...
              instanceCreator: (options) =>
                new ScalaEditor_1.ScalaEditor(options)
            });
            ...
            app.commands.addCommand(commandIDs.createNewScalaEditor, {
              ...
              icon: (args) =>
                args['isPalette'] ? undefined : ui_components_1.scalaIcon,
              execute: (args) => {
...
//# sourceMappingURL=lib_index_js.f1a9d8ba4b1a8c16f8a4.js.map
