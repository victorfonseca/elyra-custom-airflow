...
(self['webpackChunk_elyra_metadata_extension'] =
  ...
  \**********************/
      /***/ function (__unused_webpack_module, exports, __webpack_require__) {
        ...
        const translation_1 = __webpack_require__(
          ...
          activate: (
            ...
            __awaiter(void 0, void 0, void 0, function* () {
              ...
              componentRegistry.addRenderer(
                `${METADATA_EXTENSION_ID}:plugin.code`,
                {
                  fieldRenderer: (props) => {
              ...
              componentRegistry.addRenderer(
                `${METADATA_EXTENSION_ID}:plugin.tags`,
                {
                  fieldRenderer: (props) => {
              ...
              componentRegistry.addRenderer(
                `${METADATA_EXTENSION_ID}:plugin.dropdown`,
                {
                  fieldRenderer: (props) => {
              ...
              componentRegistry.addRenderer(
                `${METADATA_EXTENSION_ID}:plugin.password`,
                {
                  fieldRenderer: (props) => {
              ...
              const openMetadataEditor = (args) => {
                ...
                const openWidget = (0, algorithm_1.find)(
                ...
                const metadataEditorWidget =
                  new metadata_common_1.MetadataEditorWidget(
                ...
                const main = new apputils_1.MainAreaWidget({
                  content: metadataEditorWidget
                });
              ...
              const openMetadataWidget = (args) => {
                const labIcon = ui_components_2.LabIcon.resolve({
                  icon: args.icon
                });
              ...
              app.commands.addCommand(closeTabCommand, {
                ...
                execute: (_args) => {
                  ...
                  if (contextNode) {
                    ...
                    const widget = (0, algorithm_1.find)(
                      app.shell.widgets('left'),
                      (widget, _index) => {
                        return widget.id === id;
                      }
                ...
                for (const schema of schemas) {
                  ...
                  palette.addItem({
                    ...
                    args: {
                      ...
                      display_name:
                        (_b =
                          (_a = schema.uihints) === null || _a === void 0
                            ? void 0
...
//# sourceMappingURL=lib_index_js.b47dbcd7edb21bf37664.js.map
