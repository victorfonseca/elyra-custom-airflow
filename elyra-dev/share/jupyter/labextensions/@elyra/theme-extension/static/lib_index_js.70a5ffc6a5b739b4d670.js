...
(self['webpackChunk_elyra_theme_extension'] =
  ...
  \**********************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const launcher_2 = __webpack_require__(
          ...
          activate: (app, translator, labShell, mainMenu, palette) => {
            ...
            commands.addCommand(CommandIDs.create, {
              ...
              execute: (args) => {
                ...
                main.title.closable = !!(0, algorithm_1.toArray)(
                  labShell.widgets('main')
                ).length;
                main.id = id;
                shell.add(main, 'main', {
                ...
                labShell.layoutModified.connect(() => {
                  ...
                  main.title.closable =
                    (0, algorithm_1.toArray)(labShell.widgets('main')).length >
                    1;
                }, main);
                return main;
              }
            ...
            if (labShell) {
              ...
              labShell.addRequested.connect((sender, arg) => {
                ...
                const ref =
                  ((_a = arg.currentTitle) === null || _a === void 0
                    ? void 0
                    : _a.owner.id) ||
            ...
            this.itemsList.forEach((item) => {
              ...
              if (
                !(
                  ...
                  ((pyEditorInstalled &&
                    ((_a = item.args) === null || _a === void 0
                      ? void 0
                      : _a.fileExt) === 'py') ||
                    (rEditorInstalled &&
                      ((_b = item.args) === null || _b === void 0
                        ? void 0
                        : _b.fileExt) === 'r'))
                )
              ) {
        ...
        class Launcher extends launcher_1.Launcher {
                  ...
                  const grandchildren = React.Children.map(
                    ...
                    (grandchild) => {
                      if (
                        ...
                        return React.createElement(icon.react, {
          ...
          render() {
            ...
            const launcherContent =
              launcherBody === null || launcherBody === void 0
                ? void 0
                : launcherBody.props.children;
              ...
              React.Children.forEach(launcherCategories, (cat) => {
                if (cat.key === category) {
                  if (cat.key === ELYRA_CATEGORY) {
                    cat = this.replaceCategoryIcon(
                      cat,
                      ui_components_1.elyraIcon
                    );
                  }
                  categories.push(cat);
                }
...
//# sourceMappingURL=lib_index_js.70a5ffc6a5b739b4d670.js.map
