  ...
  [2707],
  {
    59171: function (e, t) {
      ...
      var i = (function () {
        function e(e) {
          ...
          try {
            for (
              var n = r(Object.keys(e)), i = n.next();
              !i.done;
              i = n.next()
            ) {
              var o = i.value;
    ...
    37720: function (e, t, r) {
      ...
      var u = (function () {
        ...
        e.prototype.create = function (e) {
          ...
          return (t = this.factory.configuration.nodeFactory).create.apply(
            t,
            i([e], n(r), false)
          );
        };
      ...
      var c = (function (e) {
        ...
        t.prototype.clearEnv = function () {
          ...
          try {
            for (
              var r = o(Object.keys(this.env)), a = r.next();
              !a.done;
              a = r.next()
            ) {
              var n = a.value;
    ...
    11252: function (e, t, r) {
      ...
      function S(e) {
        ...
        try {
          for (
            var n = s(a.getList('nonscript')), i = n.next();
            !i.done;
            i = n.next()
          ) {
            var o = i.value;
    ...
    94650: function (e, t, r) {
        ...
        t.prototype.checkItem = function (t) {
          ...
          if (e.prototype.checkItem.call(this, t)[1]) {
            ...
            throw new (c.default.bind.apply(
              c.default,
              i([void 0, l[0], l[1]], n(l.splice(2)), false)
            ))();
          }
          return null;
        };
        ...
        t.prototype.checkItem = function (t) {
          ...
          if (r) {
            ...
            if (!t.isKind('fn')) {
              ...
              if (
                (p.default.isType(a, 'mstyle') &&
                  a.childNodes.length &&
                  p.default.isType(a.childNodes[0].childNodes[0], 'mspace')) ||
      ...
      var k = (function (e) {
        ...
        t.prototype.checkItem = function (e) {
          ...
          if (
            e.isKind('mml') &&
            (p.default.isType(e.First, 'mo') ||
              p.default.isType(e.First, 'mi') ||
              p.default.isType(e.First, 'mtext'))
          ) {
            t = e.First;
            r = p.default.getText(t);
            if (
              r.length === 1 &&
              !p.default.getProperty(t, 'movesupsub') &&
              p.default.getChildren(t).length === 1
            ) {
      ...
      var N = (function (e) {
          ...
          if (this.hfill.length) {
            ...
            if (this.hfill[this.hfill.length - 1] === this.Size()) {
              p.default.setAttribute(
                e,
                'columnalign',
                p.default.getAttribute(e, 'columnalign') ? 'center' : 'left'
              );
            }
          }
          this.row.push(e);
        ...
        t.prototype.addRowSpacing = function (e) {
          if (this.arraydef['rowspacing']) {
            ...
            t[this.table.length - 1] = f.default.Em(
              Math.max(0, a + f.default.dimen2em(e))
            );
            this.arraydef['rowspacing'] = t.join(' ');
          }
        };
      ...
      var _ = (function (e) {
        ...
        t.prototype.checkItem = function (t) {
          if (t.isKind('end')) {
            ...
            this.factory.configuration.tags.end();
            return [
              [a ? this.factory.configuration.tags.enTag(r, a) : r, t],
              true
            ];
          }
          if (t.isKind('stop')) {
    ...
    69447: function (e, t, r) {
      ...
      new s.CharacterMap('mathchar0mo', c.default.mathchar0mo, {
        ...
        intop: [
          '∫',
          { texClass: p.TEXCLASS.OP, movesupsub: true, movablelimits: true }
        ],
    ...
    38364: function (e, t, r) {
      ...
      A.Superscript = function (e, t) {
        ...
        if (e.GetNext().match(/\d/)) {
          e.string =
            e.string.substr(0, e.i + 1) + ' ' + e.string.substr(e.i + 1);
        }
        var a;
        var n;
        var i = e.stack.Top();
        ...
        if (
          (c.default.isType(n, 'msubsup') &&
            !c.default.isType(n, 'msup') &&
            c.default.getChildAt(n, n.sup)) ||
        ...
        e.Push(
          e.itemFactory
            .create('subsup', n)
            .setProperties({ position: l, primes: a, movesupsub: o })
        );
      };
      ...
      A.SetStyle = function (e, t, r, a, n) {
        ...
        e.Push(
          e.itemFactory
            .create('style')
            .setProperty('styles', { displaystyle: a, scriptlevel: n })
        );
      };
      ...
      A.Limits = function (e, t, r) {
        ...
        if (
          !a ||
          (c.default.getTexClass(c.default.getCoreMO(a)) !== m.TEXCLASS.OP &&
            c.default.getProperty(a, 'movesupsub') == null)
        ) {
          throw new f.default(
            'MisplacedLimits',
        ...
        c.default.setProperties(c.default.getCoreMO(a), {
          movablelimits: false
        });
        if (
          c.default.getAttribute(a, 'movablelimits') ||
          c.default.getProperty(a, 'movablelimits')
        ) {
      ...
      A.Accent = function (e, t, r, n) {
        var i = e.ParseArg(t);
        var o = a(a({}, d.default.getFontDef(e)), {
          accent: true,
          mathaccent: true
        });
        ...
        if (
          c.default.isType(f, 'mo') ||
          c.default.getProperty(f, 'movablelimits')
        ) {
      ...
      A.Overunderset = function (e, t) {
        ...
        var i = e.create('node', 'munderover', [n, a, r], {
          accent: false,
          accentunder: false
        });
        e.Push(i);
      ...
      A.RaiseLower = function (e, t) {
        ...
        var a = e.itemFactory
          .create('position')
          .setProperties({ name: e.currentCS, move: 'vertical' });
        if (r.charAt(0) === '-') {
          r = r.slice(1);
      ...
      A.MoveLeftRight = function (e, t) {
        ...
        e.Push(
          e.itemFactory.create('position').setProperties({
            name: e.currentCS,
            move: 'horizontal',
      ...
      A.FrameBox = function (e, t) {
        ...
        var i = e.create(
          'node',
          'TeXAtom',
          [e.create('node', 'menclose', n, { notation: 'box' })],
      ...
      A.Dots = function (e, t) {
        ...
        e.Push(
          e.itemFactory.create('dots').setProperties({ ldots: n, cdots: i })
        );
      };
      ...
      A.Entry = function (e, t) {
        ...
        var o = 0,
          ...
          u = i.length;
        var c = a
          ? new RegExp('^\\\\end\\s*\\{'.concat(a.replace(/\*/, '\\*'), '\\}'))
          : null;
        while (l < u) {
          var p = i.charAt(l);
          if (p === '{') {
        ...
        if (
          !m.match(/^\s*\\text[^a-zA-Z]/) ||
          s !== m.replace(/\s+$/, '').length - 1
        ) {
      ...
      A.Cr = function (e, t) {
        e.Push(
          e.itemFactory.create('cell').setProperties({ isCR: true, name: t })
        );
      };
      A.CrLaTeX = function (e, t, r) {
        ...
        e.Push(
          e.itemFactory
            .create('cell')
            .setProperties({ isCR: true, name: t, linebreak: true })
        );
        var c = e.stack.Top();
        var p;
      ...
      A.HLine = function (e, t, r) {
        ...
        if (!a.table.length) {
          ...
          var n = a.arraydef['rowlines']
            ? a.arraydef['rowlines'].split(/ /)
            : [];
      ...
      A.HandleLabel = function (e, t) {
        ...
        if (!e.tags.refUpdate) {
          ...
          e.tags.label = r;
          if (
            (e.tags.allLabels[r] || e.tags.labels[r]) &&
            !e.options['ignoreDuplicateLabels']
          ) {
            throw new f.default(
              'MultipleLabel',
      ...
      A.HandleRef = function (e, t, r) {
        ...
        var o = e.create('node', 'mrow', d.default.internalMath(e, i), {
          href: e.tags.formatUrl(n.id, e.options.baseURL),
          class: 'MathJax_ref'
        });
        e.Push(o);
      };
