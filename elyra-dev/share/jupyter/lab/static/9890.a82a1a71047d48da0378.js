...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [9890],
  {
    ...
    /***/ 99890: /***/ (
      ...
      /* harmony import */ var _chunk_4BMEZGHF_mjs__WEBPACK_IMPORTED_MODULE_0__ =
      ...
      /* harmony import */ var _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ =
        __webpack_require__(75905);
      /* harmony import */ var _mermaid_js_parser__WEBPACK_IMPORTED_MODULE_4__ =
        __webpack_require__(24010);
      /* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_5__ =
          ...
          () => {
            ...
            return {
              ...
              branchConfig: /* @__PURE__ */ new Map([
                [
                  mainBranchName,
                  { name: mainBranchName, order: mainBranchOrder }
                ]
              ]),
      ...
      function getID() {
        return (0,
        _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .random */.yT)({
          length: 7
        });
      }
      ...
      var setOptions = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        function (rawOptString) {
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        function (commitDB) {
          ...
          const config = getConfig3();
          id =
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.Y2.sanitizeText(
              id,
              config
            );
          msg =
          ...
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .log */.Rm.debug(
            'in pushCommit ' + newCommit.id
          );
        },
        'commit'
      );
      var branch = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        function (branchDB) {
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (mergeDB) => {
          ...
          if (
            currentCommit &&
            otherCommit &&
            currentCommit.branch === otherBranch
          ) {
            throw new Error(
          ...
          const commit2 = {
            ...
            parents:
              state.records.head == null
                ? []
                : [state.records.head.id, verifiedBranch],
            branch: state.records.currBranch,
      ...
      var cherryPick = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        function (cherryPickDB) {
      ...
      var prettyPrint = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        function () {
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .log */.Rm.debug(
            state.records.commits
          );
      ...
      var getBranchesAsObjArray = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        function () {
          const branchesArray = [...state.records.branchConfig.values()]
            .map((branchConfig, i) => {
              if (
                branchConfig.order !== null &&
                branchConfig.order !== void 0
              ) {
                return branchConfig;
              }
              return {
      ...
      var getCommitsArray = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        function () {
      ...
      var getCurrentBranch = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        function () {
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (ast, db2) => {
          (0,
          _chunk_4BMEZGHF_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .populateCommonDb */.S)(
            ast,
            db2
          );
          if (ast.dir) {
      ...
      var parseStatement = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (statement, db2) => {
          const parsers = {
            Commit: /* @__PURE__ */ (0,
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
              (stmt) => db2.commit(parseCommit(stmt)),
              'Commit'
            ),
            Branch: /* @__PURE__ */ (0,
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
              (stmt) => db2.branch(parseBranch(stmt)),
              'Branch'
            ),
            Merge: /* @__PURE__ */ (0,
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
              (stmt) => db2.merge(parseMerge(stmt)),
              'Merge'
            ),
            Checkout: /* @__PURE__ */ (0,
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
              (stmt) => db2.checkout(parseCheckout(stmt)),
              'Checkout'
            ),
            CherryPicking: /* @__PURE__ */ (0,
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
      ...
      var parseCherryPicking = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (cherryPicking) => {
          const cherryPickDB = {
            id: cherryPicking.id,
            targetId: '',
            tags:
              cherryPicking.tags?.length === 0 ? void 0 : cherryPicking.tags,
      ...
      var parser = {
        ...
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
          async (input) => {
            const ast = await (0,
            _mermaid_js_parser__WEBPACK_IMPORTED_MODULE_4__ /* .parse */.qg)(
              'gitGraph',
              input
            );
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .log */.Rm.debug(
      ...
      var findClosestParent = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (parents) => {
          let closestParent;
          let comparisonFunc;
      ...
      var findClosestParentBT = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (parents) => {
          let closestParent = '';
      ...
      var setParallelBTPos = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (sortedKeys, commits, defaultPos2) => {
      ...
      var findClosestParentPos = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (commit2) => {
          ...
          if (!closestParent) {
            throw new Error(
              `Closest parent not found for commit ${commit2.id}`
            );
          }
      ...
      var calculateCommitPosition = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (commit2) => {
      ...
      var setCommitPosition = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (commit2, curPos) => {
      ...
      var setRootPosition = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (commit2, curPos, defaultPos2) => {
          const branch2 = branchPos.get(commit2.branch);
          if (!branch2) {
            throw new Error(`Branch not found for commit ${commit2.id}`);
          }
      ...
      var drawCommitBullet = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (
          gBullets,
          commit2,
      ...
      var drawCommitLabel = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (gLabels, commit2, commitPosition, pos) => {
          if (
            commit2.type !== commitType.CHERRY_PICK &&
            ((commit2.customId && commit2.type === commitType.MERGE) ||
              commit2.type !== commitType.MERGE) &&
            DEFAULT_GITGRAPH_CONFIG2?.showCommitLabel
          ) {
            const wrapper = gLabels.append('g');
            const labelBkg = wrapper
              .insert('rect')
      ...
      var getCommitClassType = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (commit2) => {
      ...
      var calculatePosition = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (commit2, dir2, pos, commitPos2) => {
      ...
      var getCommitPosition = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (commit2, pos, isParallelCommits) => {
          const posWithOffset =
            dir === 'BT' && isParallelCommits ? pos : pos + LAYOUT_OFFSET;
          const y =
            dir === 'TB' || dir === 'BT'
              ? posWithOffset
              : branchPos.get(commit2.branch)?.pos;
          const x =
            dir === 'TB' || dir === 'BT'
              ? branchPos.get(commit2.branch)?.pos
              : posWithOffset;
      ...
      var drawCommits = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (svg, commits, modifyGraph) => {
          ...
          const isParallelCommits =
            DEFAULT_GITGRAPH_CONFIG2?.parallelCommits ?? false;
          const sortKeys = /* @__PURE__ */ (0,
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
            (a, b) => {
          ...
          sortedKeys.forEach((key) => {
            ...
            const commitPosition = getCommitPosition(
              commit2,
              pos,
              isParallelCommits
            );
      ...
      var shouldRerouteArrow = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (commitA, commitB, p1, p2, allCommits) => {
          const commitBIsFurthest =
            dir === 'TB' || dir === 'BT' ? p1.x < p2.x : p1.y < p2.y;
          const branchToGetCurve = commitBIsFurthest
            ? commitB.branch
            : commitA.branch;
          const isOnBranchToGetCurve = /* @__PURE__ */ (0,
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
            (x) => x.branch === branchToGetCurve,
            'isOnBranchToGetCurve'
          );
          const isBetweenCommits = /* @__PURE__ */ (0,
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
      ...
      var drawArrow = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (svg, commitA, commitB, allCommits) => {
          ...
          if (arrowNeedsRerouting) {
            ...
            offset = 10;
            const lineY =
              p1.y < p2.y ? findLane(p1.y, p2.y) : findLane(p2.y, p1.y);
            const lineX =
              p1.x < p2.x ? findLane(p1.x, p2.x) : findLane(p2.x, p1.x);
            if (dir === 'TB') {
              if (p1.x < p2.x) {
          ...
          branches.forEach((branch2, index) => {
            ...
            bkg
              ...
              .attr(
                ...
                -bbox.width -
                  4 -
                  (DEFAULT_GITGRAPH_CONFIG2?.rotateCommitLabel === true
                    ? 30
                    : 0)
              )
            ...
            if (dir === 'TB') {
              ...
              bkg.attr(
                'transform',
                'translate(-19, ' + (pos - bbox.height / 2) + ')'
              );
            }
          });
        },
      ...
      var setBranchPosition = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        function (name, pos, index, bbox, rotateCommitLabel) {
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        function (txt, id, ver, diagObj) {
          ...
          const rotateCommitLabel =
            DEFAULT_GITGRAPH_CONFIG2.rotateCommitLabel ?? false;
          const db2 = diagObj.db;
          allCommitsDict = db2.getCommits();
          const branches = db2.getBranchesAsObjArray();
          dir = db2.getDirection();
          const diagram2 = (0,
          d3__WEBPACK_IMPORTED_MODULE_5__ /* .select */.Ltv)(`[id="${id}"]`);
          let pos = 0;
          branches.forEach((branch2, index) => {
          ...
          (0,
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .setupGraphViewbox2 */.mj)(
            void 0,
            diagram2,
...
//# sourceMappingURL=9890.a82a1a71047d48da0378.js.map?v=a82a1a71047d48da0378
