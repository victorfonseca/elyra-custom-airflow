...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [321],
  {
    90321: (e, t, n) => {
      ...
      var o = r(['true', 'false', 'nil', 'self', 'super', '_']);
      var u = r([
        'Array',
        'Bool',
        'Character',
      ...
      var d = /^\-?\d[\d_]*(?:\.\d[\d_]*)?(?:[Ee]\-?\d[\d_]*)?/;
      var v = /^\$\d+|(`?)[_A-Za-z][_A-Za-z$0-9]*\1/;
      var h = /^\.(?:\$\d+|(`?)[_A-Za-z][_A-Za-z$0-9]*\1)/;
      var m = /^\#[A-Za-z]+/;
      var _ = /^@(?:\$\d+|(`?)[_A-Za-z][_A-Za-z$0-9]*\1)/;
      function k(e, t, n) {
        ...
        var k;
        if ((k = e.match(/("""|"|')/))) {
          var w = y.bind(null, k[0]);
          t.tokenize.push(w);
          return w(e, t);
        }
        if (e.match(v)) {
          var b = e.current();
          if (u.hasOwnProperty(b)) return 'type';
          if (o.hasOwnProperty(b)) return 'atom';
          if (i.hasOwnProperty(b)) {
            if (a.hasOwnProperty(b)) t.prev = 'define';
            return 'keyword';
          }
          if (n == 'define') return 'def';
          return 'variable';
        }
        e.next();
        return null;
      ...
      const A = {
        ...
        token: function (e, t) {
          var n = t.prev;
          t.prev = null;
          var r = t.tokenize[t.tokenize.length - 1] || k;
          var i = r(e, t, n);
          if (!i || i == 'comment') t.prev = n;
