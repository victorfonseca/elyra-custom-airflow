  ...
  [8313],
  {
    48313: (t, e, n) => {
      ...
      class k {
        ...
        findRegions(t) {
          let e = t.facet(L);
          if ((e === null || e === void 0 ? void 0 : e.data) == this.data)
              ...
              if (s.tree.prop(p) == this.data) {
                if (s.overlay)
                  for (let t of s.overlay)
                    n.push({ from: t.from + e, to: t.to + e });
      ...
      function w(t, e, n) {
        ...
        if (!i || i.allowsNesting) {
          for (let t = s; t; t = t.enter(e, n, r.IterMode.ExcludeBuffers))
            if (t.type.isTop) s = t;
        }
        return s;
      }
      class v extends k {
        ...
        static define(t) {
          ...
          return new v(
            e,
            t.parser.configure({
              props: [p.add((t) => (t.isTop ? e : undefined))]
            }),
            t.name
          );
        }
      ...
      function x(t, e, n = 50) {
        var r;
        let i =
          (r = t.field(k.state, false)) === null || r === void 0
            ? void 0
            : r.context;
        if (!i) return null;
        let s = i.viewport;
      ...
      function y(t, e = t.doc.length) {
        var n;
        return (
          ((n = t.field(k.state, false)) === null || n === void 0
            ? void 0
            : n.context.isDone(e)) || false
        );
      }
      ...
      class C {
        ...
        work(t, e) {
          ...
          if (
            this.tree != r.Tree.empty &&
            this.isDone(e !== null && e !== void 0 ? e : this.state.doc.length)
          ) {
            this.takeTree();
            return true;
          }
          return this.withContext(() => {
            ...
            for (;;) {
              ...
              if (i) {
                ...
                if (
                  this.treeLen <
                  (e !== null && e !== void 0 ? e : this.state.doc.length)
                )
        ...
        takeTree() {
          ...
          if (this.parse && (t = this.parse.parsedPos) >= this.treeLen) {
            if (this.parse.stoppedAt == null || this.parse.stoppedAt > t)
              this.parse.stopAt(t);
            this.withContext(() => {
            ...
            this.tree = e;
            this.fragments = this.withoutTempSkipped(
              r.TreeFragment.addTree(this.tree, this.fragments, true)
            );
            this.parse = null;
          }
        }
        ...
        changes(t, e) {
          ...
          if (!t.empty) {
            let e = [];
            t.iterChangedRanges((t, n, r, i) =>
              e.push({ fromA: t, toA: n, fromB: r, toB: i })
            );
        ...
        isDone(t) {
          ...
          return (
            this.treeLen >= t && e.length && e[0].from == 0 && e[0].to >= t
          );
        }
        static get() {
          return A;
      ...
      function D(t, e, n) {
        return r.TreeFragment.applyChanges(t, [
          { fromA: e, toA: n, fromB: e, toB: n }
        ]);
      }
      class I {
        constructor(t) {
      ...
      const O =
        ...
        ((d = navigator.scheduling) === null || d === void 0
          ? void 0
          : d.isInputPending)
        ...
        class t {
          ...
          scheduleWork() {
            ...
            let { state: t } = this.view,
              e = t.field(k.state);
            if (e.tree != e.context.tree || !e.context.isDone(t.doc.length))
              this.working = N(this.work);
          }
          work(t) {
            this.working = null;
            let e = Date.now();
            ...
            let s =
              ...
              Math.min(
                this.chunkBudget,
                100,
                t && !O ? Math.max(25, t.timeRemaining() - 5) : 1e9
              );
            let o = i.context.treeLen < r && n.doc.length > r + 1e3;
            let a = i.context.work(
              () => (O && O()) || Date.now() > s,
              r + (o ? 0 : 1e5)
            );
      ...
      function H(t, e, n) {
        ...
        if (i != r.node) {
          ...
          for (
            let e = i;
            e && !(e.from == r.node.from && e.type == r.node.type);
            e = e.parent
          )
            t.push(e);
      ...
      function q(t) {
        ...
        if (n && (i = n.type.prop(r.NodeProp.closedBy))) {
          ...
          return (t) =>
            Z(t, true, 1, undefined, n && !_(t) ? e.from : undefined);
        }
      ...
      function rt() {
        return s.EditorState.transactionFilter.of((t) => {
          ...
          for (let { head: f } of o.selection.ranges) {
            ...
            let r = j(o, e);
            if (n != r)
              l.push({ from: t.from, to: t.from + n.length, insert: r });
          }
      ...
      function at(t, e, n) {
        ...
        for (let o = i; o; o = o.next) {
          ...
          if (
            a &&
            (i.to < r.length - 50 || r.length == t.doc.length || !lt(i))
          ) {
            let r = a(i, t);
        ...
        update(t, e) {
          ...
          for (let n of e.effects) {
            if (n.is(ut) && !kt(t, n.value.from, n.value.to)) {
              ...
              let i = !r
                ? Ot
                : a.Decoration.replace({ widget: new Et(r(e.state, n.value)) });
              t = t.update({ add: [i.range(n.value.from, n.value.to)] });
            } else if (n.is(ct)) {
              t = t.update({
                filter: (t, e) => n.value.from != t || n.value.to != e,
      ...
      function wt(t, e) {
        return t.field(pt, false)
          ? e
          : e.concat(s.StateEffect.appendConfig.of(It()));
      }
      const vt = (t) => {
        for (let e of dt(t)) {
      ...
      function xt(t, e, n = true) {
        ...
        return a.EditorView.announce.of(
          ...
          class {
            ...
            buildMarkers(t) {
              ...
              for (let i of t.viewportLineBlocks) {
                let s = mt(t.state, i.from, i.to)
                  ? r
                  : ft(t.state, i.from, i.to)
                    ? n
                    : null;
        ...
        return [
          ...
          (0, a.gutter)({
            ...
            markers(t) {
              var e;
              return (
                ((e = t.plugin(i)) === null || e === void 0
                  ? void 0
                  : e.markers) || s.RangeSet.empty
              );
            },
            initialSpacer() {
      ...
      class Ft {
        constructor(t, e) {
          ...
          const i =
            typeof e.all == 'string' ? e.all : e.all ? r(e.all) : undefined;
          const s = e.scope;
          this.scope =
            s instanceof k
              ? (t) => t.prop(p) == s.data
          ...
          this.style = (0, f.tagHighlighter)(
            t.map((t) => ({
              tag: t.tag,
              class: t.class || r(Object.assign({}, t, { tag: null }))
            })),
            { all: i }
          ).style;
      ...
      function Ut(t, e) {
        ...
        if (e === null || e === void 0 ? void 0 : e.fallback) n.push(jt.of(t));
          ...
          n.push(
            Vt.computeN([a.EditorView.darkTheme], (e) =>
              e.facet(a.EditorView.darkTheme) == (r == 'dark') ? [t] : []
            )
          );
        else n.push(Vt.of(t));
        return n;
            ...
            (0, f.highlightTree)(
              ...
              (t, e, r) => {
                n.add(
                  ...
                  e,
                  this.markCache[r] ||
                    (this.markCache[r] = a.Decoration.mark({ class: r }))
                );
              },
              r,
              i
      ...
      const Ht = s.Prec.high(
        a.ViewPlugin.fromClass(zt, { decorations: (t) => t.decorations })
      );
      const Gt = Ft.define([
        ...
        {
          tag: [f.tags.regexp, f.tags.escape, f.tags.special(f.tags.string)],
          color: '#e40'
        },
        ...
        {
          tag: [f.tags.special(f.tags.variableName), f.tags.macroName],
          color: '#256'
        },
        ...
        update(t, e) {
          ...
          for (let i of e.state.selection.ranges) {
            ...
            let t =
              ...
              (r.afterCursor &&
                (se(e.state, i.head, 1, r) ||
                  (i.head < e.state.doc.length &&
                    se(e.state, i.head + 1, -1, r))));
      ...
      function se(t, e, n, r = {}) {
        ...
        for (let l = a; l; l = l.parent) {
          ...
          if (r && l.from < l.to) {
            ...
            if (
              i &&
              (n > 0 ? e >= i.from && e < i.to : e > i.from && e <= i.to)
            )
              return oe(t, e, n, l, i, r, s);
          }
        }
          ...
          do {
            if (n < 0 ? h.to <= r.from : h.from >= r.to) {
              if (f == 0 && s.indexOf(h.type.name) > -1 && h.from < h.to) {
                ...
                return {
                  start: l,
                  end: t ? { from: t.from, to: t.to } : undefined,
                  matched: true
                };
      ...
      function ae(t, e, n, r, i, s, o) {
        ...
        for (let c = 0; !h.next().done && c <= s; ) {
          ...
          let s = e + c * n;
          for (
            let e = n > 0 ? 0 : t.length - 1, a = n > 0 ? t.length : -1;
            e != a;
            e += n
          ) {
            let a = o.indexOf(t[e]);
      ...
      class de extends k {
        ...
        getIndent(t) {
          ...
          if (n) {
            e = ce.get(t.state);
            if (e != null && e < t.pos - 1e4) e = undefined;
          }
          let r = pe(
              this,
              t.node.tree,
          ...
          if (r) {
            ...
            s = this.streamParser.startState(t.unit);
            i = t.node.from;
          }
          if (t.pos - i > 1e4) return null;
          while (i < t.pos) {
            let e = t.state.doc.lineAt(i),
              r = Math.min(t.pos, e.to);
            if (e.length) {
              let i = n ? n(e.from) : -1;
              let o = new fe(
                e.text,
              ...
              while (o.pos < r - e.from) we(this.streamParser.token, o, s);
            } else {
              this.streamParser.blankLine(s, t.unit);
            }
            if (r == t.pos) break;
            i = e.to + 1;
          }
          let o = t.lineAt(t.pos);
          if (n && e == null) ce.set(t.state, o.from);
      ...
      function ge(t, e, n, i, s) {
        ...
        if (!s && n == 0 && e.type == t.topNode) s = true;
      ...
      function me(t, e, n, i, s) {
        for (let r of e) {
          let e = r.from + (r.openStart ? 25 : 0),
            s = r.to - (r.openEnd ? 25 : 0);
          let o = e <= n && s > n && pe(t, r.tree, 0 - r.offset, n, s),
            a;
          if (
            o &&
            o.pos <= i &&
            (a = ge(t, r.tree, n + r.offset, o.pos + r.offset, false))
          )
            return { state: o.state, tree: a };
        }
        return {
          state: t.streamParser.startState(s ? V(s) : 4),
          tree: r.Tree.empty
        };
      }
      class ke {
        constructor(t, e, n, r) {
          ...
          let i = C.get(),
            s = r[0].from;
          let { state: o, tree: a } = me(
            t,
            n,
            s,
            this.to,
            i === null || i === void 0 ? void 0 : i.state
          );
          this.state = o;
          ...
          if (
            ...
            r.some((t) => t.from <= i.viewport.from && t.to >= i.viewport.from)
          ) {
        ...
        emitToken(t, e, n, r) {
          ...
          if (this.ranges.length > 1) {
            r = this.skipGapsTo(e, r, 1);
            e += r;
            let t = this.chunk.length;
            r = this.skipGapsTo(n, r, -1);
            n += r;
            i += this.chunk.length - t;
          }
        ...
        finishChunk() {
          ...
          t = new r.Tree(t.type, t.children, t.positions, t.length, [
      ...
      function De(t, e) {
        ...
        let o = Se[s];
        if (o) return o.id;
        let a = (Se[s] = r.NodeType.define({
          id: be.length,
          name: i,
          props: [(0, f.styleTags)({ [i]: n })]
        }));
        be.push(a);
        return a.id;
      }
      function Ie(t, e) {
        let n = r.NodeType.define({
          id: be.length,
          name: 'Document',
          props: [p.add(() => t), z.add(() => (t) => e.getIndent(t))],
          top: true
        });
        be.push(n);
        return n;
      ...
      const Me = a.ViewPlugin.fromClass(
        class {
          constructor(t) {
            this.always =
              t.state.facet(Le) ||
              t.textDirection != a.Direction.LTR ||
              t.state.facet(a.EditorView.perLineTextDirection);
            this.hasRTL = !this.always && Oe(t.state.doc);
            this.tree = b(t.state);
            this.decorations =
              this.always || this.hasRTL
                ? Re(t, this.tree, this.always)
                : a.Decoration.none;
          }
          update(t) {
            let e =
              t.state.facet(Le) ||
              t.view.textDirection != a.Direction.LTR ||
              t.state.facet(a.EditorView.perLineTextDirection);
        ...
        },
        {
          provide: (t) => {
            function e(e) {
              var n, r;
              return (r =
                (n = e.plugin(t)) === null || n === void 0
                  ? void 0
                  : n.decorations) !== null && r !== void 0
                ? r
                : a.Decoration.none;
            }
            return [
              a.EditorView.outerDecorations.of(e),
              s.Prec.lowest(a.EditorView.bidiIsolatedRanges.of(e))
            ];
          }
        }
      );
      ...
      function Fe(t, e) {
        ...
        for (let { from: o, to: a } of t) {
          ...
          if (r + n.value.length < o) {
            n.next(o - (r + n.value.length));
            r = o;
          }
          for (;;) {
            let t = r,
      ...
      const Ve = {
        rtl: a.Decoration.mark({
          class: 'cm-iso',
          inclusive: true,
          attributes: { dir: 'rtl' },
          bidiIsolate: a.Direction.RTL
        }),
        ltr: a.Decoration.mark({
          class: 'cm-iso',
          inclusive: true,
          attributes: { dir: 'ltr' },
          bidiIsolate: a.Direction.LTR
        }),
        auto: a.Decoration.mark({
          class: 'cm-iso',
          inclusive: true,
          attributes: { dir: 'auto' },
          bidiIsolate: null
