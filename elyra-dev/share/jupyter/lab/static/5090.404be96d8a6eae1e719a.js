...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [5090],
  {
    67002: (t, n, e) => {
      e.d(n, { t: () => o });
      const o = { horizontal: 'horizontal', vertical: 'vertical' };
    },
    74291: (t, n, e) => {
      e.d(n, {
        Ac: () => Dt,
      ...
      const Tt = 'Backspace';
      const xt = 'Delete';
      const Mt = { ArrowDown: bt, ArrowLeft: yt, ArrowRight: St, ArrowUp: Pt };
    },
    30086: (t, n, e) => {
      e.d(n, { O: () => o });
      var o;
    ...
    49054: (t, n, e) => {
      ...
      var r = o.join(',');
      var a = typeof Element === 'undefined';
      var c = a
        ? function () {}
      ...
      var s = function t(n, e, o) {
        var a = Array.prototype.slice.apply(n.querySelectorAll(r));
        if (e && c.call(n, r)) {
          a.unshift(n);
        }
        a = a.filter(o);
      ...
      var u = function t(n, e, o) {
        ...
        while (i.length) {
          ...
          if (s.tagName === 'SLOT') {
            ...
            var l = u.length ? u : s.children;
            var d = t(l, true, o);
            if (o.flatten) {
              a.push.apply(a, d);
            } else {
              a.push({ scope: s, candidates: d });
            }
          } else {
            var f = c.call(s, r);
            if (f && o.filter(s) && (e || !n.includes(s))) {
              a.push(s);
            }
            var p =
              s.shadowRoot ||
              (typeof o.getShadowRoot === 'function' && o.getShadowRoot(s));
            var m = !o.shadowRootFilter || o.shadowRootFilter(s);
            if (p && m) {
              var h = t(p === true ? s.children : p.children, true, o);
              if (o.flatten) {
                a.push.apply(a, h);
              } else {
                a.push({ scope: s, candidates: h });
              }
            } else {
      ...
      var y = function t(n, e) {
        var o = e.displayCheck,
          r = e.getShadowRoot;
        if (getComputedStyle(n).visibility === 'hidden') {
          return true;
        }
        var a = c.call(n, 'details>summary:first-of-type');
        var s = a ? n.parentElement : n;
        if (c.call(s, 'details:not([open]) *')) {
          return true;
        }
        var u = i(n).host;
        var l =
          (u === null || u === void 0 ? void 0 : u.ownerDocument.contains(u)) ||
        ...
        if (!o || o === 'full') {
          if (typeof r === 'function') {
            ...
            while (n) {
              ...
              var p = i(n);
              if (f && !f.shadowRoot && r(f) === true) {
                return b(n);
              } else if (n.assignedSlot) {
                n = n.assignedSlot;
              } else if (!f && p !== n.ownerDocument) {
                n = p.host;
              } else {
                n = f;
              }
          ...
          while (e) {
            if (e.tagName === 'FIELDSET' && e.disabled) {
              for (var o = 0; o < e.children.length; o++) {
                var r = e.children.item(o);
                if (r.tagName === 'LEGEND') {
                  return c.call(e, 'fieldset[disabled] *')
                    ? true
                    : !r.contains(n);
                }
              }
      ...
      var P = function t(n, e) {
        if (e.disabled || p(e) || y(e, n) || m(e) || S(e)) {
          return false;
        }
        return true;
      };
      ...
      var R = function t(n) {
        ...
        n.forEach(function (n, r) {
          ...
          var c = a ? n.scope : n;
          var i = l(c, a);
          var s = a ? t(n.candidates) : c;
          if (i === 0) {
            a ? e.push.apply(e, s) : e.push(c);
          } else {
            o.push({
              documentOrder: r,
              tabIndex: i,
        ...
        return o
          .sort(d)
          .reduce(function (t, n) {
            n.isScope ? t.push.apply(t, n.content) : t.push(n.content);
            return t;
          }, [])
          .concat(e);
      };
      var A = function t(n, e) {
        ...
        if (e.getShadowRoot) {
          ...
          o = s(n, e.includeContainer, E.bind(null, e));
        }
        return R(o);
      };
      var D = function t(n, e) {
        ...
        if (e.getShadowRoot) {
          o = u([n], e.includeContainer, {
            filter: P.bind(null, e),
            flatten: true,
            getShadowRoot: e.getShadowRoot
          });
        } else {
          o = s(n, e.includeContainer, P.bind(null, e));
        }
        return o;
      };
