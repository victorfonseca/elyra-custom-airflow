(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [2641],
  {
    /***/ 8394: /***/ (module, exports, __webpack_require__) => {
    ...
    /***/ 90577: /***/ (
      ...
      (function (ProgressNotification) {
        ProgressNotification.type = new messages_1.NotificationType(
          '$/progress'
        );
      ...
      (function (SetTraceNotification) {
        SetTraceNotification.type = new messages_1.NotificationType(
          '$/setTrace'
        );
      })(
      ...
      (function (LogTraceNotification) {
        LogTraceNotification.type = new messages_1.NotificationType(
          '$/logTrace'
        );
      })(
      ...
      function createMessageConnection(
        ...
        function handleRequest(requestMessage) {
          ...
          function reply(resultOrError, method, startTime) {
            ...
            if (resultOrError instanceof messages_1.ResponseError) {
              ...
              message.result =
                resultOrError === undefined ? null : resultOrError;
            }
        ...
        const connection = {
          ...
          sendRequest: (type, ...args) => {
            ...
            if (
              typeof cancellationStrategy.sender.enableCancellation ===
              'function'
            ) {
    ...
    /***/ 34019: /***/ (__unused_webpack_module, exports) => {
      'use strict';
    ...
    /***/ 78585: /***/ (__unused_webpack_module, exports) => {
      'use strict';
    ...
    /***/ 93352: /***/ (__unused_webpack_module, exports) => {
      'use strict';
    ...
    /***/ 89244: /***/ (__unused_webpack_module, exports) => {
      'use strict';
    ...
    /***/ 59085: /***/ (
      ...
      const Is = __webpack_require__(78585);
      const events_1 = __webpack_require__(62676);
      const semaphore_1 = __webpack_require__(94323);
      var MessageReader;
    ...
    /***/ 69590: /***/ (__unused_webpack_module, exports) => {
      'use strict';
    ...
    /***/ 96092: /***/ (
      ...
      var main = __webpack_require__(76439);
      // EXTERNAL MODULE: ./node_modules/vscode-jsonrpc/lib/common/messages.js
      var messages = __webpack_require__(96177); // CONCATENATED MODULE: ./node_modules/vscode-ws-jsonrpc/lib/disposable.js
      /* --------------------------------------------------------------------------------------------
      ...
      var messageReader = __webpack_require__(59085); // CONCATENATED MODULE: ./node_modules/vscode-ws-jsonrpc/lib/socket/reader.js
      /* --------------------------------------------------------------------------------------------
       * Copyright (c) 2018-2022 TypeFox GmbH (http://www.typefox.io). All rights reserved.
       * Licensed under the MIT License. See License.txt in the project root for license information.
       * ------------------------------------------------------------------------------------------ */
      ...
      var messageWriter = __webpack_require__(23193); // CONCATENATED MODULE: ./node_modules/vscode-ws-jsonrpc/lib/socket/writer.js
      /* --------------------------------------------------------------------------------------------
       * Copyright (c) 2018-2022 TypeFox GmbH (http://www.typefox.io). All rights reserved.
       * Licensed under the MIT License. See License.txt in the project root for license information.
       * ------------------------------------------------------------------------------------------ */
      ...
      function createWebSocketConnection(socket, logger) {
        ...
        const connection = (0, main.createMessageConnection)(
          messageReader,
          messageWriter,
          logger
        );
...
//# sourceMappingURL=2641.97967aa591172197c596.js.map?v=97967aa591172197c596
