    ...
    91894: function (t, e, r) {
      ...
      e.SafeMethods = {
        filterURL: function (t, e) {
          ...
          var n = t.allow.URLs;
          return n === 'all' ||
            (n === 'safe' && (t.options.safeProtocols[r] || !r))
            ? e
            : null;
        },
        ...
        filterClass: function (t, e) {
          ...
          return r === 'all' ||
            (r === 'safe' && e.match(t.options.classPattern))
            ? e
            : null;
        },
        filterID: function (t, e) {
          var r = t.allow.cssIDs;
          return r === 'all' || (r === 'safe' && e.match(t.options.idPattern))
            ? e
            : null;
        },
        ...
        filterSizeMultiplier: function (t, e) {
          var r = i(
              t.options.scriptsizemultiplierRange || [-Infinity, Infinity],
              2
            ),
            n = r[0],
            a = r[1];
    ...
    23466: function (t, e, r) {
      ...
      var l = (function () {
        ...
        t.prototype.mmlAttribute = function (t, e) {
          ...
          return typeof i === 'number' || typeof i === 'boolean'
            ? String(i)
            : i;
        };
      ...
      function m(t) {
        ...
        try {
          for (var f = r(o), u = f.next(); !u.done; u = f.next()) {
            ...
            try {
              for (
                var h = ((i = void 0), r(Object.keys(t || {}))), v = h.next();
                !v.done;
                v = h.next()
              ) {
                var d = v.value;
