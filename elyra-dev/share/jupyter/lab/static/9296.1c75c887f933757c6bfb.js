  ...
  [9296],
  {
    49296: (t, e, i) => {
      ...
      i.d(e, {
        ...
        WidgetType: () => xt,
        __test: () => Br,
        closeHoverTooltips: () => Yn,
        crosshairCursor: () => Sn,
        drawSelection: () => Bo,
        dropCursor: () => qo,
        getDrawSelectionConfig: () => Lo,
        getPanel: () => jn,
        getTooltip: () => In,
        gutter: () => or,
        gutterLineClass: () => tr,
        gutterWidgetClass: () => er,
        gutters: () => rr,
        hasHoverTooltips: () => qn,
        highlightActiveLine: () => an,
        highlightActiveLineGutter: () => Cr,
        highlightSpecialChars: () => Jo,
        highlightTrailingWhitespace: () => Rr,
        highlightWhitespace: () => Tr,
        hoverTooltip: () => zn,
        keymap: () => po,
        layer: () => Eo,
        lineNumberMarkers: () => pr,
        lineNumberWidgetMarker: () => gr,
        lineNumbers: () => yr,
        logException: () => Se,
        panels: () => Gn,
        placeholder: () => dn,
        rectangularSelection: () => vn,
        repositionTooltips: () => _n,
        runScopeHandlers: () => wo,
        scrollPastEnd: () => ln,
        showPanel: () => Jn,
        showTooltip: () => Bn,
      ...
      function p(t) {
        var e =
          (f && (t.ctrlKey || t.altKey || t.metaKey)) ||
          (c && t.shiftKey && t.key && t.key.length == 1) ||
          t.key == 'Unidentified';
        var i =
          (!e && t.key) ||
          (t.shiftKey ? r : n)[t.keyCode] ||
          t.key ||
          'Unidentified';
        if (i == 'Esc') i = 'Escape';
        if (i == 'Del') i = 'Delete';
      ...
      function m(t, e) {
        return e
          ? t == e || t.contains(e.nodeType != 1 ? e.parentNode : e)
          : false;
      }
      function w(t, e) {
      ...
      function v(t) {
        if (t.nodeType == 3)
          return L(t, 0, t.nodeValue.length).getClientRects();
        ...
        for (let c = t, f = false; c && !f; ) {
          if (c.nodeType == 1) {
            ...
            if (o == 'nearest') {
              if (e.top < t.top) {
                m = e.top - (t.top + r);
                if (i > 0 && e.bottom > t.bottom + m)
                  m = e.bottom - t.bottom + r;
              } else if (e.bottom > t.bottom) {
                m = e.bottom - t.bottom + r;
                if (i < 0 && e.top - m < t.top) m = e.top - (t.top + r);
              }
            } else {
            ...
            if (s == 'nearest') {
              if (e.left < t.left) {
                g = e.left - (t.left + n);
                if (i > 0 && e.right > t.right + g) g = e.right - t.right + n;
              } else if (e.right > t.right) {
                g = e.right - t.right + n;
                if (i < 0 && e.left < t.left + g) g = e.left - (t.left + n);
              }
            } else {
              let i =
                s == 'center'
      ...
      function O(t) {
        let e = t.ownerDocument,
          i,
          s;
        for (let o = t.parentNode; o; ) {
          if (o == e.body || (i && s)) {
            break;
          } else if (o.nodeType == 1) {
            if (!s && o.scrollHeight > o.clientHeight) s = o;
            if (!i && o.scrollWidth > o.clientWidth) i = o;
      ...
      function W(t, e) {
        for (let i = t, s = e; ; ) {
          ...
          } else if (i.nodeType == 1 && s > 0) {
            if (i.contentEditable == 'false') return null;
            i = i.childNodes[s - 1];
            s = M(i);
          } else if (i.parentNode && !S(i)) {
            s = y(i);
            i = i.parentNode;
          } else {
            return null;
      ...
      function z(t, e) {
        for (let i = t, s = e; ; ) {
          if (i.nodeType == 3 && s < i.nodeValue.length) {
            return { node: i, offset: s };
          } else if (i.nodeType == 1 && s < i.childNodes.length) {
            if (i.contentEditable == 'false') return null;
            i = i.childNodes[s];
            s = 0;
          } else if (i.parentNode && !S(i)) {
      ...
      class I {
        ...
        static before(t, e) {
          return new I(t.parentNode, y(t), e);
        }
        static after(t, e) {
          return new I(t.parentNode, y(t) + 1, e);
        }
      }
      const q = [];
      class K {
        ...
        sync(t, e) {
          if (this.flags & 2) {
            ...
            for (let n of this.children) {
              ...
              if (e && !e.written && e.node == i && o != n.dom)
                e.written = true;
              if (n.dom.parentNode == i) {
                while (o && o != n.dom) o = Y(o);
              } else {
        ...
        replaceChildren(t, e, i = q) {
          this.markDirty();
          for (let s = t; s < e; s++) {
            let t = this.children[s];
            if (t.parent == this && i.indexOf(t) < 0) t.destroy();
          }
          if (i.length < 250) this.children.splice(t, e - t, ...i);
          else
        ...
        childCursor(t = this.length) {
          return new _(this.children, t, this.children.length);
        }
        childPos(t, e = 1) {
      ...
      function X(t, e, i, s, o, n, r, l, a) {
        ...
        if (
          ...
          !d &&
          n.length < 2 &&
          c.merge(i, o, n.length ? f : null, i == 0, l, a)
        )
          return;
        if (s < h.length) {
          let t = h[s];
          if (
            ...
            (o < t.length ||
              (t.breakAfter &&
                (f === null || f === void 0 ? void 0 : f.breakAfter)))
          ) {
            if (e == s) {
              t = t.split(o);
              o = 0;
            ...
            if (!d && f && t.merge(0, o, f, true, 0, a)) {
              ...
              if (o || (t.children.length && !t.children[0].length))
                t.merge(0, o, null, false, 0, a);
              n.push(t);
            }
        ...
        if (
          ...
          s < h.length &&
          !h[e - 1].breakAfter &&
          h[s].merge(0, 0, h[e - 1], false, l, a)
        )
          e--;
        if (e < s || n.length) t.replaceChildren(e, s, n);
      }
      function G(t, e, i, s, o, n) {
        let r = t.childCursor();
      ...
      const U = /Edge\/(\d+)/.exec(j.userAgent);
      const Q = /MSIE \d/.test(j.userAgent);
      const J = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(j.userAgent);
      const Z = !!(Q || J || U);
      const tt = !Z && /gecko\/(\d+)/i.test(j.userAgent);
      const et = !Z && /Chrome\/(\d+)/.exec(j.userAgent);
      const it = 'webkitFontSmoothing' in $.documentElement.style;
      const st = !Z && /Apple Computer/.test(j.vendor);
      const ot =
        st && (/Mobile\/\w+/.test(j.userAgent) || j.maxTouchPoints > 2);
      var nt = {
        mac: ot || /Mac/.test(j.platform),
        windows: /Win/.test(j.platform),
        linux: /Linux|X11/.test(j.platform),
        ie: Z,
        ie_version: Q ? $.documentMode || 6 : J ? +J[1] : U ? +U[1] : 0,
        gecko: tt,
        gecko_version: tt
          ? +(/Firefox\/(\d+)/.exec(j.userAgent) || [0, 0])[1]
          : 0,
        chrome: !!et,
        ...
        safari: st,
        webkit_version: it
          ? +(/\bAppleWebKit\/(\d+)/.exec(j.userAgent) || [0, 0])[1]
          : 0,
        tabSize:
          $.documentElement.style.tabSize != null ? 'tab-size' : '-moz-tab-size'
      };
      const rt = 256;
      class lt extends K {
        constructor(t) {
      ...
      class at extends K {
        ...
        merge(t, e, i, s, o, n) {
          if (
            i &&
            (!(i instanceof at && i.mark.eq(this.mark)) ||
              (t && o <= 0) ||
              (e < this.length && n <= 0))
          )
            return false;
          G(this, t, e, i ? i.children.slice() : [], o - 1, n - 1);
          this.markDirty();
          return true;
        }
        split(t) {
      ...
      function ht(t, e, i) {
        ...
        if (nt.safari && !r && a.width == 0)
          a = Array.prototype.find.call(l, (t) => t.width) || a;
        return r ? C(a, r < 0) : a || null;
      }
      class ct extends K {
        static create(t, e, i) {
          return new ct(t, e, i);
        ...
        domAtPos(t) {
          return (this.length ? t == 0 : this.side > 0)
            ? I.before(this.dom)
            : I.after(this.dom, t == this.length);
        }
        domBoundsAround() {
          return null;
        }
      ...
      class ft extends K {
        ...
        become(t) {
          return t instanceof ft && t.side == this.side;
        }
        split() {
          return new ft(this.side);
        }
        sync() {
          if (!this.dom) {
      ...
      lt.prototype.children = ct.prototype.children = ft.prototype.children = q;
      function dt(t, e) {
        let i = t.dom,
          { children: s } = t,
          o = 0;
      ...
      function ut(t, e, i) {
        ...
        if (
          ...
          e instanceof at &&
          o.length &&
          (s = o[o.length - 1]) instanceof at &&
          s.mark.eq(e.mark)
        ) {
          ut(s, e.children[0], i - 1);
        } else {
          o.push(e);
          e.setParent(t);
        }
      ...
      class Ct extends s.RangeValue {
        ...
        static widget(t) {
          ...
          return new Dt(t, e, e, i, t.widget || null, false);
        }
        static replace(t) {
          let e = !!t.block,
            i,
          ...
          if (t.isBlockGap) {
            ...
            let { start: o, end: n } = Ot(t, e);
            i = (o ? (e ? -3e8 : -1) : 5e8) - 1;
            s = (n ? (e ? 2e8 : 1) : -6e8) + 1;
          }
          return new Dt(t, i, s, e, t.widget || null, true);
        }
        static line(t) {
          return new At(t);
        }
      ...
      Ct.none = s.RangeSet.empty;
      class kt extends Ct {
        constructor(t) {
          let { start: e, end: i } = Ot(t);
      ...
      class At extends Ct {
        ...
        eq(t) {
          return (
            ...
            bt(this.spec.attributes, t.spec.attributes)
          );
        }
        range(t, e = t) {
          if (e != t)
      ...
      At.prototype.mapMode = s.MapMode.TrackBefore;
      ...
      class Dt extends Ct {
        constructor(t, e, i, o, n, r) {
          ...
          this.mapMode = !o
            ? s.MapMode.TrackDel
            : e <= 0
              ? s.MapMode.TrackBefore
              : s.MapMode.TrackAfter;
        }
        get type() {
      ...
      Dt.prototype.point = true;
      function Ot(t, e = false) {
        let { inclusiveStart: i, inclusiveEnd: s } = t;
        if (i == null) i = t.inclusive;
        if (s == null) s = t.inclusive;
        return {
          start: i !== null && i !== void 0 ? i : e,
          end: s !== null && s !== void 0 ? s : e
        };
      }
      function Tt(t, e) {
      ...
      class Rt extends K {
        ...
        merge(t, e, i, s, o, n) {
          ...
          G(this, t, e, i ? i.children.slice() : [], o, n);
          return true;
        }
        split(t) {
          let e = new Rt();
        ...
        addLineDeco(t) {
          let e = t.spec.attributes,
            i = t.spec.class;
          if (e) this.attrs = wt(e, this.attrs || {});
          if (i) this.attrs = wt({ class: i }, this.attrs || {});
        }
        domAtPos(t) {
          return dt(this, t);
        }
        ...
        sync(t, e) {
          ...
          if (this.prevAttrs !== undefined) {
            yt(this.dom, this.prevAttrs, this.attrs);
            this.dom.classList.add('cm-line');
            this.prevAttrs = undefined;
          }
          super.sync(t, e);
          let s = this.dom.lastChild;
          while (s && K.get(s) instanceof at) s = s.lastChild;
          if (
            !s ||
            !this.length ||
            (s.nodeName != 'BR' &&
              ((i = K.get(s)) === null || i === void 0
                ? void 0
                : i.isEditable) == false &&
              (!nt.ios || !this.children.some((t) => t instanceof lt)))
          ) {
      ...
      class Bt extends K {
        ...
        coordsAt(t, e) {
          let i = this.widget.coordsAt(this.dom, t, e);
          if (i) return i;
          if (this.widget instanceof Lt) return null;
          return C(
      ...
      class Pt {
        ...
        getLine() {
          if (!this.curLine) {
            this.content.push((this.curLine = new Rt()));
            this.atCursorPos = true;
          }
          return this.curLine;
        }
        flushBuffer(t = this.bufferMarks) {
          if (this.pendingBuffer) {
            this.curLine.append(Ht(new ft(-1), t), t.length);
            this.pendingBuffer = 0;
          }
        }
        addBlockWidget(t) {
        ...
        finish(t) {
          if (this.pendingBuffer && t <= this.bufferMarks.length)
            this.flushBuffer();
          ...
          if (
            ...
            !(
              t &&
              this.content.length &&
              this.content[this.content.length - 1] instanceof Bt
            )
          )
            this.getLine();
        }
        buildText(t, e, i) {
          while (t > 0) {
            ...
            this.getLine().append(
              Ht(new lt(this.text.slice(this.textOff, this.textOff + s)), e),
              i
            );
            this.atCursorPos = true;
            this.textOff += s;
        ...
        point(t, e, i, s, o, n) {
          if (this.disallowBlockEffectsFor[n] && i instanceof Dt) {
            if (i.block)
              throw new RangeError(
          ...
          if (i instanceof Dt) {
            if (i.block) {
              ...
              this.addBlockWidget(new Bt(i.widget || Nt.block, r, i));
            } else {
              let n = ct.create(i.widget || Nt.inline, r, r ? 0 : i.startSide);
              let l =
                this.atCursorPos &&
                !n.isEditable &&
                o <= s.length &&
              ...
              let h = this.getLine();
              if (this.pendingBuffer == 2 && !l && !n.isEditable)
                this.pendingBuffer = 0;
              this.flushBuffer(s);
              if (l) {
                h.append(Ht(new ft(1), s), o);
      ...
      function Ht(t, e) {
        for (let i of e) t = new at(i, [t], t.length);
        return t;
      }
      class Nt extends xt {
        constructor(t) {
      ...
      function Ut(t, e, i, s, o) {
        for (let n = 0; n <= s.length; n++) {
          ...
          for (let t = r, e = a, s = a; t < l; t++) {
            let o = $t[t];
            if (o == 128) {
              if (t < l - 1 && e == $t[t + 1] && e & 24) o = $t[t] = e;
              else $t[t] = 256;
            } else if (o == 64) {
              let o = t + 1;
              while (o < l && $t[o] == 64) o++;
              let n =
                (t && e == 8) || (o < i && $t[o] == 8) ? (s == 1 ? 1 : 8) : 256;
              for (let e = t; e < o; e++) $t[e] = n;
              t = o - 1;
            } else if (o == 8 && s == 1) {
              $t[t] = 1;
            }
            ...
            t: for (;;) {
              if (h < n.length && u == n[h].from) {
                ...
                if (f) {
                  ...
                  if (p.from > a) r.push(new Gt(a, p.from, d));
                  let e = (p.direction == Ft) != !(d % 2);
                  te(t, e ? s + 1 : s, o, p.inner, p.from, p.to, r);
                  a = p.to;
                }
                u = p.to;
              } else if (u == i || (e ? $t[u] != l : $t[u] == l)) {
                break;
              } else {
                u++;
              }
            }
            if (f) Zt(t, a, u, s + 1, o, f, r);
            else if (a < u) r.push(new Gt(a, u, d));
            a = u;
          }
        } else {
              ...
              if (h && u == n[h - 1].to) {
                ...
                if (!i)
                  for (let t = p.from, i = h; ; ) {
                    ...
                    else if ($t[t - 1] == l) break t;
                    else break;
                  }
                if (f) {
                  f.push(p);
                } else {
                  if (p.to < a) r.push(new Gt(p.to, a, d));
                  let e = (p.direction == Ft) != !(d % 2);
                  te(t, e ? s + 1 : s, o, p.inner, p.from, p.to, r);
                  a = p.from;
                }
                u = p.from;
              } else if (u == e || (i ? $t[u - 1] != l : $t[u - 1] == l)) {
                break;
              } else {
                u--;
              }
            }
            if (f) Zt(t, u, a, s + 1, o, f, r);
            else if (u < a) r.push(new Gt(u, a, d));
            a = u;
          }
        }
      }
      function te(t, e, i, s, o, n, r) {
        let l = e % 2 ? 2 : 1;
        Ut(t, o, n, s, l);
        Qt(t, o, n, s, l);
        Jt(o, n, s, l);
      ...
      function ee(t, e, i) {
        if (!t) return [new Gt(0, 0, e == Wt ? 1 : 0)];
        if (e == Ft && !i.length && !Xt.test(t)) return ie(t.length);
        if (i.length) while (t.length > $t.length) $t[$t.length] = 256;
        let s = [],
          o = e == Ft ? 0 : 1;
        te(t, o, o, i, 0, t.length, s);
        return s;
      }
      function ie(t) {
        return [new Gt(0, t, 0)];
      ...
      let se = '';
      function oe(t, e, i, o, n) {
        var r;
        let l = o.head - t.from;
        let a = Gt.find(
          e,
          l,
          (r = o.bidiLevel) !== null && r !== void 0 ? r : -1,
          o.assoc
        );
        let h = e[a],
          c = h.side(n, i);
        ...
        se = t.text.slice(Math.min(l, f), Math.max(l, f));
        let d = a == (n ? e.length - 1 : 0) ? null : e[a + (n ? 1 : -1)];
        if (d && f == c && d.level + (n ? 0 : 1) < h.level)
          return s.EditorSelection.cursor(
            d.side(!n, i) + t.from,
            d.forward(n, i) ? 1 : -1,
            d.level
          );
      ...
      function ne(t, e, i) {
        for (let s = e; s < i; s++) {
          let e = _t(t.charCodeAt(s));
          if (e == 1) return Ft;
          if (e == 2 || e == 4) return Wt;
        }
        return Ft;
      }
      ...
      const he = s.Facet.define();
      const ce = s.Facet.define();
      const fe = s.Facet.define();
      const de = s.Facet.define();
      const ue = s.Facet.define();
      const pe = s.Facet.define();
      const ge = s.Facet.define({ combine: (t) => t.some((t) => t) });
      const me = s.Facet.define({ combine: (t) => t.some((t) => t) });
      ...
      class ve {
        ...
        clip(t) {
          return this.range.to <= t.doc.length
            ? this
            : new ve(
                s.EditorSelection.cursor(t.doc.length),
                this.y,
                this.x,
                this.yMargin,
                this.xMargin,
      ...
      const be = s.StateEffect.define({ map: (t, e) => t.map(e) });
      const ye = s.StateEffect.define();
      function Se(t, e, i) {
        let s = t.facet(he);
        if (s.length) s[0](e);
        else if (window.onerror)
          window.onerror(String(e), i, undefined, undefined, e);
        else if (i) console.error(i + ':', e);
        else console.error(e);
      }
      const xe = s.Facet.define({ combine: (t) => (t.length ? t[0] : true) });
      let Me = 0;
      const Ce = s.Facet.define();
      class ke {
        ...
        static define(t, e) {
          ...
          return new ke(Me++, t, i, s, (t) => {
            let e = [Ce.of(t)];
            if (n)
              e.push(
                Te.of((e) => {
                  let i = e.plugin(t);
                  return i ? n(i) : Ct.none;
                })
              );
            if (o) e.push(o(t));
            return e;
          ...
          if (!this.value) {
            if (this.spec) {
              try {
                ...
                Se(t.state, e, 'CodeMirror plugin crashed');
                this.deactivate();
              }
            }
        ...
        destroy(t) {
          ...
          if ((e = this.value) === null || e === void 0 ? void 0 : e.destroy) {
            try {
              ...
              Se(t.state, i, 'CodeMirror plugin crashed');
            }
          }
        }
        deactivate() {
      ...
      const Te = s.Facet.define();
      const Ee = s.Facet.define();
      const Re = s.Facet.define();
      const Be = s.Facet.define();
      function Le(t, e) {
        let i = t.state.facet(Be);
        ...
        static extendWithRanges(t, e) {
          ...
          for (let s = 0, o = 0, n = 0, r = 0; ; s++) {
            ...
            while (o < e.length && e[o] < h) {
              ...
              let n = Math.max(r, t),
                l = Math.min(h, s);
              if (n <= l) new Ve(n + a, l + a, n, l).addToSet(i);
              if (s > h) break;
              else o += 2;
            }
            if (!l) return i;
            new Ve(l.fromA, l.toA, l.fromB, l.toB).addToSet(i);
            n = l.toA;
            r = l.toB;
          }
        }
      ...
      class We extends K {
        ...
        constructor(t) {
          ...
          this.editContextFormatting = Ct.none;
          ...
          this.children = [new Rt()];
          this.children[0].setParent(this);
          this.updateDeco();
          this.updateInner([new Ve(0, 0, 0, t.state.doc.length)], 0, null);
        }
        update(t) {
          var e;
          ...
          if (
            ...
            else if (!Ge(t.changes, this.hasComposition) && !t.selectionSet)
              s = t.state.selection.main.head;
          }
          let o = s > -1 ? qe(this.view, t.changes, s) : null;
          this.domChanged = null;
          if (this.hasComposition) {
            ...
            i = new Ve(
              ...
              t.changes.mapPos(s, 1)
            ).addToSet(i.slice());
          }
          this.hasComposition = o
            ? { from: o.range.fromB, to: o.range.toB }
            : null;
          if (
            (nt.ie || nt.chrome) &&
            !o &&
          ...
          let n = this.decorations,
            r = this.updateDeco();
          let l = _e(n, r, t.changes);
          i = Ve.extendWithRanges(i, l);
        ...
        updateInner(t, e, i) {
          ...
          s.ignore(() => {
            ...
            let t =
              nt.chrome || nt.ios
                ? { node: s.selectionRange.focusNode, written: false }
                : undefined;
            this.sync(this.view, t);
            this.flags &= ~7;
            if (t && (t.written || s.selectionRange.focusNode != t.node))
              this.forceSelection = true;
            this.dom.style.height = '';
          });
          ...
          if (
            ...
            for (let n of this.children)
              if (n instanceof Bt && n.widget instanceof Lt) o.push(n.dom);
          s.updateGaps(o);
        }
          ...
          for (let n = s.length - 1; ; n--) {
            ...
            if (i && i.range.fromB < a && i.range.toB > l) {
              ...
              if (e.breakAtStart) {
                ...
                e.content.length &&
                s.merge(s.length, s.length, e.content[0], false, e.openStart, 0)
              ) {
        ...
        updateEditContextFormatting(t) {
          ...
          for (let e of t.transactions)
            for (let t of e.effects)
              if (t.is(ye)) {
                this.editContextFormatting = t.value;
              }
        }
        compositionView(t) {
          let e = new lt(t.text.nodeValue);
          e.flags |= 8;
          for (let { deco: s } of t.marks) e = new at(s, [e], e.length);
          let i = new Rt();
          i.append(e, 0);
          return i;
        }
        ...
        updateSelection(t = false, e = false) {
          if (t || !this.view.observer.selectionRange.focusNode)
            this.view.observer.readSelectionRange();
          let i = this.view.root.activeElement,
            s = i == this.dom;
          let o =
            !s &&
            !(this.view.state.facet(xe) || this.dom.tabIndex > -1) &&
            w(this.dom, this.view.observer.selectionRange) &&
          ...
          if (nt.gecko && r.empty && !this.hasComposition && ze(l)) {
          ...
          if (
            n ||
            !h.focusNode ||
            ((!b(l.node, l.offset, h.anchorNode, h.anchorOffset) ||
              !b(a.node, a.offset, h.focusNode, h.focusOffset)) &&
            ...
            this.view.observer.ignore(() => {
              ...
              if (!t);
                ...
                if (nt.gecko) {
                  let t = Ke(l.node, l.offset);
                  if (t && t != (1 | 2)) {
                    let e = (t == 1 ? W : z)(l.node, l.offset);
                    if (e) l = new I(e.node, e.offset);
                  }
                }
                t.collapse(l.node, l.offset);
                if (r.bidiLevel != null && t.caretBidiLevel !== undefined)
                  t.caretBidiLevel = r.bidiLevel;
              } else if (t.extend) {
                t.collapse(l.node, l.offset);
                try {
          ...
          this.impreciseAnchor = l.precise
            ? null
            : new I(h.anchorNode, h.anchorOffset);
          this.impreciseHead = a.precise
            ? null
            : new I(h.focusNode, h.focusOffset);
        }
        suppressWidgetCursorChange(t, e) {
          return (
            this.hasComposition &&
            e.empty &&
            b(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset) &&
        ...
        enforceCursorAssoc() {
          ...
          if (t.docView.posFromDOM(c.anchorNode, c.anchorOffset) != e.from)
            i.collapse(s, o);
        }
        moveToLine(t) {
          let e = this.dom,
          ...
          for (let s = t.offset; !i && s < e.childNodes.length; s++) {
            ...
            if (t instanceof Rt) i = t.domAtPos(0);
          }
          for (let s = t.offset - 1; !i && s >= 0; s--) {
            let t = K.get(e.childNodes[s]);
            if (t instanceof Rt) i = t.domAtPos(t.length);
          }
          return i ? new I(i.node, i.offset, true) : t;
        }
        nearest(t) {
          for (let e = t; e; ) {
            let t = K.get(e);
        ...
        domAtPos(t) {
          ...
          for (; e < this.children.length - 1; ) {
            ...
            if (i < t.length || t instanceof Rt) break;
            e++;
            i = 0;
          }
        ...
        coordsAt(t, e) {
          ...
          for (let o = this.length, n = this.children.length - 1; n >= 0; n--) {
            ...
            if (
              ...
              (a < t || r.covers(-1)) &&
              (l > t || r.covers(1)) &&
              (!i || (r instanceof Rt && !(i instanceof Rt && e >= 0)))
            ) {
              i = r;
              s = a;
            } else if (
        ...
        coordsForChar(t) {
          let { i: e, off: i } = this.childPos(t, 1),
            o = this.children[e];
          if (!(o instanceof Rt)) return null;
          ...
          if (!(o instanceof lt)) return null;
          let n = (0, s.findClusterBreak)(o.text, i);
          if (n == i) return null;
          let r = L(o.dom, i, n).getClientRects();
          for (let s = 0; s < r.length; s++) {
            let t = r[s];
            if (s == r.length - 1 || (t.top < t.bottom && t.left < t.right))
              return t;
          }
          return null;
        }
        measureVisibleLineHeights(t) {
          ...
          let r = -1,
            l = this.view.textDirection == Vt.LTR;
        ...
        childCursor(t = this.length) {
          ...
          return new _(this.children, t, e);
        }
        computeBlockGapDeco() {
          let t = [],
        ...
        updateDeco() {
          ...
          while (t < this.decorations.length)
        ...
        scrollIntoView(t) {
          ...
          for (let h of this.view.state.facet(we)) {
            try {
              if (h(this.view, t.range, t)) return true;
            } catch (a) {
              Se(this.view.state, a, 'scroll handler');
            }
          }
          let { range: e } = t;
          let i = this.coordsAt(
          ...
          D(
            ...
            this.view.textDirection == Vt.LTR
          );
        }
      }
      function ze(t) {
      ...
      function Ie(t, e) {
        ...
        let s = W(i.focusNode, i.focusOffset);
        let o = z(i.focusNode, i.focusOffset);
        let n = s || o;
        if (o && s && o.node != s.node) {
          let e = K.get(o.node);
          if (!e || (e instanceof lt && e.text != o.node.nodeValue)) {
            n = o;
          } else if (t.docView.lastCompositionAfterCursor) {
            let t = K.get(s.node);
            if (!(!t || (t instanceof lt && t.text != s.node.nodeValue))) n = o;
          }
        }
        t.docView.lastCompositionAfterCursor = n != s;
        if (!n) return null;
        let r = e - n.offset;
      ...
      function qe(t, e, i) {
        ...
        let h = new Ve(a.mapPos(n), a.mapPos(r), n, r);
        let c = [];
        for (let f = o.parentNode; ; f = f.parentNode) {
          let e = K.get(f);
          if (e instanceof at) c.push({ node: f, deco: e.mark });
          else if (
            e instanceof Rt ||
            (f.nodeName == 'DIV' && f.parentNode == t.contentDOM)
          )
            return { range: h, text: o, marks: c, line: f };
          else if (f != t.contentDOM)
            c.push({
              node: f,
              deco: new kt({
                inclusive: true,
      ...
      function ti(t, e, i) {
        ...
        for (let p = t.firstChild; p; p = p.nextSibling) {
          ...
          for (let d = 0; d < t.length; d++) {
            let u = t[d];
            if (o && Qe(o, u)) u = Je(Ze(u, o.bottom), o.top);
            let g = $e(e, u),
              m = Ue(i, u);
            if (g == 0 && m == 0)
              return p.nodeType == 3 ? ei(p, e, i) : ti(p, e, i);
            if (!s || r > m || (r == m && n > g)) {
              s = p;
              o = u;
              n = g;
        ...
        if (s.nodeType == 3) return ei(s, d, i);
        if (l && s.contentEditable != 'false') return ti(s, d, i);
        let u =
          Array.prototype.indexOf.call(t.childNodes, s) +
          (e >= (o.left + o.right) / 2 ? 1 : 0);
      ...
      function ii(t, e, i, s = -1) {
        ...
        if (u < t.viewport.from)
          return t.viewport.from == 0 ? 0 : i ? null : si(t, r, a, c, f);
        if (u > t.viewport.to)
        ...
        if (
          m &&
          ((o = t.docView.nearest(m)) === null || o === void 0
            ? void 0
            : o.isEditable) != false
        ) {
          ...
          if (w) v = Math.min(M(w), v);
        }
        if (!w || !t.docView.dom.contains(w)) {
          let e = Rt.find(t.docView, u);
          if (!e) return d > a.top + a.height / 2 ? a.to : a.from;
          ({ node: w, offset: v } = ti(e.dom, c, f));
        }
        let b = t.docView.nearest(w);
        if (!b) return null;
        if (
          b.isWidget &&
          ((n = b.dom) === null || n === void 0 ? void 0 : n.nodeType) == 1
        ) {
      ...
      function oi(t, e, i) {
        ...
        for (let o = t.nextSibling; o; o = o.nextSibling)
          if (o.nodeType != 1 || o.nodeName != 'BR') return false;
      ...
      function ni(t, e, i) {
        ...
        let s =
          t.nodeType == 1
            ...
            : L(t, 0, Math.max(t.nodeValue.length, 1)).getBoundingClientRect();
        return i - s.left > 5;
      }
      function ri(t, e, i) {
      ...
      function li(t, e, i, o) {
        let n = ri(t, e.head, e.assoc || -1);
        let r =
          !o || n.type != Mt.Text || !(t.lineWrapping || n.widgetLineBreaks)
            ? null
            : t.coordsAtPos(
                e.assoc < 0 && e.head > n.from ? e.head - 1 : e.head
              );
        if (r) {
          let e = t.dom.getBoundingClientRect();
          let o = t.textDirectionAt(n.from);
          let l = t.posAtCoords({
            x: i == (o == Vt.LTR) ? e.right - 1 : e.left + 1,
            y: (r.top + r.bottom) / 2
          });
      ...
      function ci(t, e, i, o) {
        let n = e.head,
          r = i ? 1 : -1;
        if (n == (i ? t.state.doc.length : 0))
          return s.EditorSelection.cursor(n, e.assoc);
        let l = e.goalColumn,
          a;
      ...
      function di(t, e, i) {
        let o = fi(
          t.state.facet(Re).map((e) => e(t)),
          i.from,
          e.head > i.from ? -1 : 1
        );
        return o == i.from
          ? i
          : s.EditorSelection.cursor(o, o < i.from ? 1 : -1);
      }
      const ui = '￿';
      class pi {
        constructor(t, e) {
          ...
          for (let i = 0, s = this.lineSeparator ? null : /\r\n?|\n/g; ; ) {
            ...
            if (n > 1)
              for (let e of this.points)
                if (e.node == t && e.pos > this.text.length) e.pos -= n - 1;
            i = o + n;
          }
        }
        readNode(t) {
        ...
        findPointBefore(t, e) {
          for (let i of this.points)
            if (i.node == t && t.childNodes[i.offset] == e)
              i.pos = this.text.length;
        }
        findPointInside(t, e) {
          for (let i of this.points)
            if (t.nodeType == 3 ? i.node == t : t.contains(i.node))
              i.pos = this.text.length + (gi(t, i.node, i.offset) ? e : 0);
        }
      }
      function gi(t, e, i) {
        for (;;) {
        ...
        constructor(t, e, i, o) {
          ...
          if (t.state.readOnly && e > -1) {
            ...
            if (
              ...
              i != o &&
              (l.from > 0 || l.to < t.state.doc.length)
            ) {
              let e = Math.min(i, o),
                s = Math.max(i, o);
              let n = l.from - e,
      ...
      function vi(t, e) {
        ...
        if (e.bounds) {
          ...
          let a = n.from,
            h = null;
          if (r === 8 || (nt.android && e.text.length < l - o)) {
            a = n.to;
            h = 'end';
          }
          let c = Si(t.state.doc.sliceString(o, l, ui), e.text, a - o, h);
          if (c) {
            if (
              nt.chrome &&
              r == 13 &&
              c.toB == c.from + 2 &&
              e.text.slice(c.from, c.toB) == ui + ui
            )
              c.toB--;
            i = {
              from: o + c.from,
              to: o + c.toA,
              insert: s.Text.of(e.text.slice(c.from, c.toB).split(ui))
            };
          }
        } else if (o && ((!t.hasFocus && t.state.facet(xe)) || o.main.eq(n))) {
          o = null;
        }
        if (!i && !o) return false;
        if (!i && e.typeOver && !n.empty && o && o.main.empty) {
          ...
          if (o && i.insert.length == 2)
            o = s.EditorSelection.single(o.main.anchor - 1, o.main.head - 1);
          i = {
            from: i.from,
            to: i.to,
            insert: s.Text.of([i.insert.toString().replace('.', ' ')])
          };
        } else if (
          i &&
          i.from >= n.from &&
          ...
          i = {
            ...
            insert: t.state.doc
              .slice(n.from, i.from)
              .append(i.insert)
              .append(t.state.doc.slice(i.to, n.to))
          };
        } else if (
          nt.chrome &&
          i &&
      ...
      function bi(t, e, i, s = -1) {
        if (nt.ios && t.inputState.flushIOSKey(e)) return true;
        ...
        if (
          ...
          ((e.to == o.to &&
            (e.from == o.from ||
              (e.from == o.from - 1 &&
                t.state.sliceDoc(e.from, o.from) == ' ')) &&
            e.insert.length == 1 &&
            e.insert.lines == 2 &&
            P(t.contentDOM, 'Enter', 13)) ||
            (((e.from == o.from - 1 && e.to == o.to && e.insert.length == 0) ||
              (s == 8 && e.insert.length < e.to - e.from && e.to > o.head)) &&
        ...
        let r;
        let l = () => r || (r = yi(t, e, i));
        if (!t.state.facet(fe).some((i) => i(t, e.from, e.to, n, l)))
          t.dispatch(l());
        return true;
      }
      function yi(t, e, i) {
        ...
        if (
          ...
          o = n.replaceSelection(
            t.state.toText(
              i + e.insert.sliceString(0, undefined, t.state.lineBreak) + s
            )
          );
        } else {
          let l = n.changes(e);
          ...
          if (
            ...
            o = n.changeByRange((i) => {
              if (i.from == r.from && i.to == r.to)
                return { changes: l, range: a || i.map(l) };
              let o = i.to - d,
                f = o - h.length;
              if (
                i.to - i.from != u ||
                t.state.sliceDoc(f, o) != h ||
              ...
              return {
                ...
                range: !a
                  ? i.map(p)
                  : s.EditorSelection.range(
                      Math.max(0, a.anchor + g),
                      Math.max(0, a.head + g)
                    )
              };
            });
      ...
      class Ci {
        ...
        constructor(t) {
          ...
          if (nt.safari) t.contentDOM.addEventListener('input', () => null);
          if (nt.gecko) hs(t.contentDOM.ownerDocument);
        }
        handleEvent(t) {
          if (!Vi(this.view, t) || this.ignoreDuringComposition(t)) return;
          if (t.type == 'keydown' && this.keydown(t)) return;
          if (this.view.updateState != 0)
            Promise.resolve().then(() => this.runHandlers(t.type, t));
          else this.runHandlers(t.type, t);
        }
        runHandlers(t, e) {
        ...
        keydown(t) {
          ...
          if (
            ...
            !t.altKey &&
            !t.metaKey &&
            (((e = Di.find((e) => e.keyCode == t.keyCode)) && !t.ctrlKey) ||
              (Oi.indexOf(t.key) > -1 && t.ctrlKey && !t.shiftKey))
          ) {
        ...
        flushIOSKey(t) {
          ...
          return P(
            ...
            e.key,
            e.keyCode,
            e instanceof KeyboardEvent ? e : undefined
          );
        }
        ...
        update(t) {
          ...
          if (this.draggedContent && t.docChanged)
        ...
        for (let s of t) {
          ...
          if (t && t.domEventHandlers)
            for (let e in t.domEventHandlers) {
              ...
              if (o) i(e).handlers.push(ki(s.value, o));
            }
          if (t && t.domEventObservers)
            for (let e in t.domEventObservers) {
              let o = t.domEventObservers[e];
              if (o) i(e).observers.push(ki(s.value, o));
            }
        }
        for (let s in Fi) i(s).handlers.push(Fi[s]);
        for (let s in Wi) i(s).observers.push(Wi[s]);
        return e;
      }
      const Di = [
      ...
      const Oi = 'dthko';
      const Ti = [16, 17, 18, 20, 91, 92, 224, 225];
      const Ei = 6;
      function Ri(t) {
      ...
      class Li {
        constructor(t, e, i, o) {
          ...
          this.scrolling = -1;
          this.lastEvent = e;
          this.scrollParents = O(t.contentDOM);
          this.atoms = t.state.facet(Re).map((e) => e(t));
          ...
          this.multiple =
            t.state.facet(s.EditorState.allowMultipleSelections) && Pi(t, e);
          this.dragging = Ni(t, e) && Ji(e) == 1 ? null : false;
        }
        start(t) {
        ...
        move(t) {
          ...
          if (
            this.dragging ||
            (this.dragging == null && Bi(this.startEvent, t) < 10)
          )
            return;
          ...
          let s = 0,
            o = 0,
            n = this.view.win.innerWidth,
            r = this.view.win.innerHeight;
          ...
          let l = He(this.view);
          if (t.clientX - l.left <= s + Ei) e = -Ri(s - t.clientX);
          else if (t.clientX + l.right >= n - Ei) e = Ri(t.clientX - n);
          if (t.clientY - l.top <= o + Ei) i = -Ri(o - t.clientY);
          else if (t.clientY + l.bottom >= r - Ei) i = Ri(t.clientY - r);
        ...
        scroll() {
          ...
          if (t && this.scrollParents.x) {
            this.scrollParents.x.scrollLeft += t;
            t = 0;
          }
          if (e && this.scrollParents.y) {
            this.scrollParents.y.scrollTop += e;
            e = 0;
          }
          if (t || e) this.view.win.scrollBy(t, e);
        ...
        skipAtoms(t) {
          ...
          for (let i = 0; i < t.ranges.length; i++) {
            let o = t.ranges[i],
              n = null;
            if (o.empty) {
              let t = fi(this.atoms, o.from, 0);
              if (t != o.from) n = s.EditorSelection.cursor(t, -1);
            } else {
              let t = fi(this.atoms, o.from, -1);
              let e = fi(this.atoms, o.to, 1);
              if (t != o.from || e != o.to)
                n = s.EditorSelection.range(
                  o.from == o.anchor ? t : e,
                  o.from == o.head ? t : e
                );
            }
        ...
        select(t) {
          ...
          if (
            this.mustSelect ||
            !i.eq(e.state.selection, this.dragging === false)
          )
            this.view.dispatch({ selection: i, userEvent: 'select.pointer' });
          this.mustSelect = false;
        }
        update(t) {
          if (t.transactions.some((t) => t.isUserEvent('input.type')))
            this.destroy();
          else if (this.style.update(t))
            setTimeout(() => this.select(this.lastEvent), 20);
        }
      }
      function Pi(t, e) {
        let i = t.state.facet(re);
        return i.length ? i[0](e) : nt.mac ? e.metaKey : e.ctrlKey;
      }
      function Hi(t, e) {
        let i = t.state.facet(le);
        return i.length ? i[0](e) : nt.mac ? !e.altKey : !e.ctrlKey;
      }
      function Ni(t, e) {
      ...
      function Vi(t, e) {
        ...
        for (let i = e.target, s; i != t.contentDOM; i = i.parentNode)
          if (!i || i.nodeType == 11 || ((s = K.get(i)) && s.ignoreEvent(e)))
            return false;
        return true;
      }
      ...
      const zi =
        (nt.ie && nt.ie_version < 15) || (nt.ios && nt.webkit_version < 604);
      function Ii(t) {
        ...
        if (a) {
          ...
          o = i.changeByRange((o) => {
            ...
            return {
              ...
              range: s.EditorSelection.cursor(o.from + h.length)
            };
          });
        } else if (l) {
          o = i.changeByRange((t) => {
            ...
            return {
              ...
              range: s.EditorSelection.cursor(t.from + e.length)
            };
          });
        } else {
      ...
      Fi.keydown = (t, e) => {
        ...
        if (e.keyCode == 27 && t.inputState.tabFocusMode != 0)
      ...
      Fi.mousedown = (t, e) => {
        ...
        let i = null;
        for (let s of t.state.facet(ae)) {
          i = s(t, e);
          if (i) break;
        }
        if (!i && e.button == 0) i = Zi(t, e);
        if (i) {
          let s = !t.hasFocus;
          t.inputState.startMouseSelection(new Li(t, e, i, s));
          if (s)
            t.observer.ignore(() => {
              R(t.contentDOM);
              let e = t.root.activeElement;
              if (e && !e.contains(t.contentDOM)) e.blur();
            });
      ...
      function Yi(t, e, i, o) {
        if (o == 1) {
          ...
          return je(t.state, e, i);
        } else {
          let i = Rt.find(t.docView, e),
      ...
      function Xi(t, e, i, s) {
        let o = Rt.find(t.docView, e);
        if (!o) return 1;
        let n = e - o.posAtStart;
        if (n == 0) return 1;
        if (n == o.length) return -1;
        let r = o.coordsAt(n, -1);
        if (r && _i(i, s, r)) return -1;
        let l = o.coordsAt(n, 1);
        if (l && _i(i, s, l)) return 1;
        return r && r.bottom >= s ? -1 : 1;
      }
      function Gi(t, e) {
        let i = t.posAtCoords({ x: e.clientX, y: e.clientY }, false);
        return { pos: i, bias: Xi(t, i, e.clientX, e.clientY) };
      }
      const ji = nt.ie && nt.ie_version <= 11;
      let $i = null,
        Ui = 0,
        Qi = 0;
      function Ji(t) {
        if (!ji) return t.detail;
        let e = $i,
          i = Qi;
        $i = t;
        Qi = Date.now();
      ...
      function Zi(t, e) {
        ...
        return {
          ...
          get(e, r, l) {
            let a = Gi(t, e),
              h;
            let c = Yi(t, a.pos, a.bias, o);
            if (i.pos != a.pos && !r) {
              let e = Yi(t, i.pos, i.bias, o);
              let n = Math.min(e.from, c.from),
                r = Math.max(e.to, c.to);
              c =
                n < c.from
                  ? s.EditorSelection.range(n, r)
                  : s.EditorSelection.range(r, n);
            }
            if (r) return n.replaceRange(n.main.extend(c.from, c.to));
            else if (l && o == 1 && n.ranges.length > 1 && (h = ts(n, a.pos)))
              return h;
      ...
      Fi.dragstart = (t, e) => {
        ...
        if (e.dataTransfer) {
          e.dataTransfer.setData(
            'Text',
            qi(t.state, pe, t.state.sliceDoc(i.from, i.to))
          );
      ...
      function es(t, e, i, s) {
        ...
        let r = s && n && Hi(t, e) ? { from: n.from, to: n.to } : null;
        let l = { from: o, insert: i };
        let a = t.state.changes(r ? [r, l] : l);
        t.focus();
        t.dispatch({
          changes: a,
          selection: { anchor: a.mapPos(o, -1), head: a.mapPos(o, 1) },
          ...
          let n = () => {
            if (++o == i.length)
              es(
                t,
                e,
                s.filter((t) => t != null).join(t.state.lineBreak),
                false
              );
          };
      ...
      Fi.paste = (t, e) => {
        if (t.state.readOnly) return true;
        t.observer.flush();
        let i = zi ? null : e.clipboardData;
        if (i) {
          Ki(t, i.getData('text/plain') || i.getData('text/uri-list'));
          return true;
        } else {
          Ii(t);
          return false;
      ...
      function ss(t) {
        ...
        return { text: qi(t, pe, e.join(t.lineBreak)), ranges: i, linewise: s };
      }
      let os = null;
      Fi.copy = Fi.cut = (t, e) => {
        let { text: i, ranges: s, linewise: o } = ss(t.state);
        if (!i && !o) return false;
        os = o ? i : null;
        if (e.type == 'cut' && !t.state.readOnly)
          t.dispatch({
            changes: s,
            scrollIntoView: true,
            userEvent: 'delete.cut'
          });
        let n = zi ? null : e.clipboardData;
        if (n) {
          n.clearData();
      ...
      const ns = s.Annotation.define();
      function rs(t, e) {
        let i = [];
        for (let s of t.facet(de)) {
          let o = s(t, e);
          if (o) i.push(o);
        }
        return i.length
          ? t.update({ effects: i, annotations: ns.of(true) })
          : null;
      }
      function ls(t) {
        setTimeout(() => {
      ...
      Wi.compositionstart = Wi.compositionupdate = (t) => {
        if (t.observer.editContext) return;
        if (t.inputState.compositionFirstChange == null)
          t.inputState.compositionFirstChange = true;
      ...
      Fi.beforeinput = (t, e) => {
        ...
        if (e.inputType == 'insertReplacementText' && t.observer.editContext) {
          let s =
              (i = e.dataTransfer) === null || i === void 0
                ? void 0
                : i.getData('text/plain'),
            o = e.getTargetRanges();
          if (s && o.length) {
            let e = o[0];
            let i = t.posAtDOM(e.startContainer, e.startOffset),
              n = t.posAtDOM(e.endContainer, e.endOffset);
            bi(t, { from: i, to: n, insert: t.state.toText(s) }, null);
            return true;
          }
        }
        let o;
        if (
          nt.chrome &&
          nt.android &&
          (o = Di.find((t) => t.inputType == e.inputType))
        ) {
        ...
        if (nt.ios && e.inputType == 'deleteContentForward') {
          t.observer.flushSoon();
        }
        if (
          nt.safari &&
          ...
          setTimeout(() => Wi.compositionend(t, e), 20);
        }
        return false;
      };
      const as = new Set();
      ...
      const cs = ['pre-wrap', 'normal', 'pre-line', 'break-spaces'];
      let fs = false;
      function ds() {
        fs = false;
      }
      class us {
        ...
        mustRefreshForWrapping(t) {
          return cs.indexOf(t) > -1 != this.lineWrapping;
        }
      ...
      class vs {
        ...
        setHeight(t) {
          if (this.height != t) {
            if (Math.abs(this.height - t) > ws) fs = true;
            this.height = t;
          }
        }
        replace(t, e, i) {
        ...
        applyChanges(t, e, i, s) {
          ...
          for (let r = s.length - 1; r >= 0; r--) {
            ...
            let f = o.lineAt(l, ms.ByPosNoHeight, i.setDoc(e), 0, 0);
            let d = f.to >= a ? f : o.lineAt(a, ms.ByPosNoHeight, i, 0, 0);
            c += d.to - a;
            a = d.to;
            while (r > 0 && f.from <= s[r - 1].toA) {
              ...
              h = s[r - 1].fromB;
              r--;
              if (l < f.from) f = o.lineAt(l, ms.ByPosNoHeight, i, 0, 0);
            }
            h += f.from - l;
            l = f.from;
            let u = As.build(i.setDoc(n), t, h, c);
            o = bs(o, o.replace(l, a, u));
          }
        ...
        static of(t) {
          ...
          return new Ms(vs.of(t.slice(0, e)), n, vs.of(t.slice(i)));
        }
      }
      function bs(t, e) {
        if (t == e) return t;
        if (t.constructor != e.constructor) fs = true;
        return e;
      }
      vs.prototype.size = 1;
      class ys extends vs {
        ...
        blockAt(t, e, i, s) {
          return new gs(s, this.length, i, this.height, this.deco || 0);
        }
        lineAt(t, e, i, s, o) {
        ...
        updateHeight(t, e = 0, i = false, s) {
          if (s && s.from <= e && s.more) this.setHeight(s.heights[s.index++]);
          this.outdated = false;
          return this;
        }
        toString() {
      ...
      class Ss extends ys {
        ...
        blockAt(t, e, i, s) {
          return new gs(s, this.length, i, this.height, this.breaks);
        }
        replace(t, e, i) {
          let s = i[0];
          if (
            i.length == 1 &&
            (s instanceof Ss || (s instanceof xs && s.flags & 4)) &&
            Math.abs(this.length - s.length) < 10
          ) {
            if (s instanceof xs) s = new Ss(s.length, this.height);
      ...
      class xs extends vs {
        ...
        blockAt(t, e, i, s) {
          ...
          if (e.lineWrapping) {
            ...
            return new gs(n.from, n.length, h, a, 0);
          } else {
            let s = Math.max(0, Math.min(n - o, Math.floor((t - i) / r)));
            let { from: l, length: a } = e.doc.line(o + s);
            return new gs(l, a, i + r * s, r, 0);
          }
        }
        lineAt(t, e, i, s, o) {
          if (e == ms.ByHeight) return this.blockAt(t, i, s, o);
          if (e == ms.ByPosNoHeight) {
            let { from: e, to: s } = i.doc.lineAt(t);
            return new gs(e, s - e, 0, 0, 0);
          }
          let {
            firstLine: n,
            perLine: r,
          ...
          return new gs(
            a.from,
            a.length,
            Math.max(s, Math.min(f, s + this.height - h)),
            h,
            0
          );
        }
        forEachLine(t, e, i, s, o, n) {
          ...
          for (let h = t, c = s; h <= e; ) {
            ...
            let s = l + a * e.length;
            n(new gs(e.from, e.length, c, s, 0));
            c += s;
            h = e.to + 1;
          }
        }
        replace(t, e, i) {
          ...
          if (s > 0) {
            let t = i[i.length - 1];
            if (t instanceof xs) i[i.length - 1] = new xs(t.length + s);
            else i.push(null, new xs(s - 1));
          }
          if (t > 0) {
            let e = i[0];
            if (e instanceof xs) i[0] = new xs(t + e.length);
            else i.unshift(new xs(t - 1), null);
          }
          return vs.of(i);
        }
        decomposeLeft(t, e) {
          e.push(new xs(t - 1), null);
        }
        decomposeRight(t, e) {
          e.push(null, new xs(this.length - t - 1));
        }
        updateHeight(t, e = 0, i = false, s) {
          let o = e + this.length;
          if (s && s.from <= e + this.length && s.more) {
            let i = [],
              n = Math.max(e, s.from),
              r = -1;
            if (s.from > e) i.push(new xs(s.from - e - 1).updateHeight(t, e));
            while (n <= o && s.more) {
              let e = t.doc.lineAt(n).length;
              if (i.length) i.push(null);
              let o = s.heights[s.index++];
              if (r == -1) r = o;
              else if (Math.abs(o - r) >= ws) r = -2;
              let l = new Ss(e, o);
              l.outdated = false;
              i.push(l);
              n += e + 1;
            }
            if (n <= o) i.push(null, new xs(o - n).updateHeight(t, n));
            let l = vs.of(i);
            if (
              r < 0 ||
              Math.abs(l.height - this.height) >= ws ||
              Math.abs(r - this.heightMetrics(t, e).perLine) >= ws
            )
              fs = true;
            return bs(this, l);
          } else if (i || this.outdated) {
      ...
      class Ms extends vs {
        ...
        forEachLine(t, e, i, s, o, n) {
          ...
          if (this.break) {
            ...
            let a = this.lineAt(l, ms.ByPos, i, s, o);
        ...
        balanced(t, e) {
          if (t.size > 2 * e.size || e.size > 2 * t.size)
            return vs.of(this.break ? [t, null, e] : [t, e]);
          this.left = bs(this.left, t);
          this.right = bs(this.right, e);
        ...
        updateHeight(t, e = 0, i = false, s) {
          let { left: o, right: n } = this,
            ...
            l = null;
          if (s && s.from <= e + o.length && s.more)
            l = o = o.updateHeight(t, e, i, s);
          else o.updateHeight(t, e, i);
          if (s && s.from <= r + n.length && s.more)
      ...
      function Cs(t, e) {
        ...
        if (
          t[e] == null &&
          (i = t[e - 1]) instanceof xs &&
          (s = t[e + 1]) instanceof xs
        )
          t.splice(e - 1, 3, new xs(i.length + 1 + s.length));
      }
      const ks = 5;
      class As {
        constructor(t, e) {
        ...
        span(t, e) {
          if (this.lineStart > -1) {
            ...
            else if (t > this.pos || !this.isCovered)
              this.nodes.push(new Ss(t - this.pos, -1));
            this.writtenTo = t;
            if (e > t) {
        ...
        finish(t) {
          ...
          if (this.lineStart > -1 && !(e instanceof Ss) && !this.isCovered)
            this.nodes.push(new Ss(0, -1));
          else if (this.writtenTo < this.pos || e == null)
      ...
      class Os {
        ...
        comparePoint(t, e, i, s) {
          if (t < e || (i && i.heightRelevant) || (s && s.heightRelevant))
            Et(t, e, this.changes, 5);
        }
      }
      function Ts(t, e) {
        ...
        for (let h = t.parentNode; h && h != s.body; ) {
          if (h.nodeType == 1) {
            ...
            if (
              ...
              l = Math.max(l, i.top);
              a = Math.min(h == t.parentNode ? o.innerHeight : a, i.bottom);
            }
            h =
      ...
      class Bs {
        ...
        draw(t, e) {
          return Ct.replace({
            widget: new Ls(this.displaySize * (e ? t.scaleY : t.scaleX), e)
      ...
      class Ps {
        constructor(t) {
          ...
          this.defaultTextDirection = Vt.LTR;
          this.visibleRanges = [];
          this.mustEnforceCursorAssoc = false;
          let e = t
            .facet(Oe)
            .some(
              (t) => typeof t != 'function' && t.class == 'cm-lineWrapping'
            );
          this.heightOracle = new us(e);
          this.stateDeco = t.facet(Te).filter((t) => typeof t != 'function');
          this.heightMap = vs
            .empty()
            .applyChanges(
              this.stateDeco,
          ...
          this.lineGapDeco = Ct.set(
            this.lineGaps.map((t) => t.draw(this, false))
          );
        ...
        updateScaler() {
          ...
          this.scaler =
            this.heightMap.height <= 7e6
              ? zs
              : new Is(this.heightOracle, this.heightMap, this.viewports);
          return t.eq(this.scaler) ? 0 : 2;
        }
        updateViewportLines() {
          this.viewportLines = [];
          this.heightMap.forEachLine(
            ...
            0,
            (t) => {
              this.viewportLines.push(qs(t, this.scaler));
            }
          );
        }
        update(t, e = null) {
          ...
          let n = Ve.extendWithRanges(
            o,
            Ds(
              i,
              this.stateDeco,
              t ? t.changes : s.ChangeSet.empty(this.state.doc.length)
            )
          );
          let r = this.heightMap.height;
          let l = this.scrolledToBottom
            ? null
          ...
          if (h || !t.changes.empty || t.flags & 2) this.updateViewportLines();
          if (
        ...
        measure(t) {
          ...
          let p = (this.printing ? Rs : Ts)(e, this.paddingTop);
          ...
          if (!this.inView && !this.scrollTarget && !Es(t.dom)) return 0;
          let v = l.width;
          if (
          ...
          if (a) {
            ...
            if (
              r ||
              (o.lineWrapping &&
                Math.abs(v - this.contentDOMWidth) > o.charWidth)
            ) {
              let {
                lineHeight: i,
                charWidth: s,
                ...
                r
                  ? vs
                      ...
                      .applyChanges(
                        ...
                        s.Text.empty,
                        this.heightOracle,
                        [new Ve(0, 0, 0, t.state.doc.length)]
                      )
                  : this.heightMap
              ).updateHeight(o, 0, r, new ps(i.from, n));
            }
            if (fs) h |= 2;
          }
          let b =
        ...
        getViewport(t, e) {
          ...
          let l = new Hs(
            s.lineAt(n - i * 1e3, ms.ByHeight, o, 0, 0).from,
            s.lineAt(r + (1 - i) * 1e3, ms.ByHeight, o, 0, 0).to
          );
          if (e) {
            let { head: t } = e.range;
            if (t < l.from || t > l.to) {
              ...
              let n = s.lineAt(t, ms.ByPos, o, 0, 0),
                r;
              if (e.y == 'center') r = (n.top + n.bottom) / 2 - i / 2;
              else if (e.y == 'start' || (e.y == 'nearest' && t < l.from))
                r = n.top;
              else r = n.bottom - i;
              l = new Hs(
                s.lineAt(r - 1e3 / 2, ms.ByHeight, o, 0, 0).from,
                s.lineAt(r + i + 1e3 / 2, ms.ByHeight, o, 0, 0).to
              );
            }
          }
          return l;
        ...
        mapViewport(t, e) {
          let i = e.mapPos(t.from, -1),
            s = e.mapPos(t.to, 1);
          return new Hs(
            this.heightMap.lineAt(i, ms.ByPos, this.heightOracle, 0, 0).from,
            this.heightMap.lineAt(s, ms.ByPos, this.heightOracle, 0, 0).to
          );
        }
        viewportIsAppropriate({ from: t, to: e }, i = 0) {
          ...
          let { bottom: o } = this.heightMap.lineAt(
            e,
            ms.ByPos,
            this.heightOracle,
            0,
        ...
        mapLineGaps(t, e) {
          ...
          let i = [];
          for (let s of t)
            if (!e.touchesRange(s.from, s.to))
              i.push(
                new Bs(e.mapPos(s.from), e.mapPos(s.to), s.size, s.displaySize)
              );
          return i;
        }
        ensureLineGaps(t, e) {
          ...
          let o = i ? 1e4 : 2e3,
            n = o >> 1,
            r = o << 1;
          if (this.defaultTextDirection != Vt.LTR && !i) return [];
          let l = [];
          let a = (o, r, h, c) => {
            if (r - o < n) return;
            ...
            if (!u) {
              if (
                ...
                let t = e.moveToLineBoundary(
                  s.EditorSelection.cursor(r),
                  false,
                  true
                ).head;
                if (t > o) r = t;
              }
              let t = this.gapSize(h, o, r, c);
              let n = i || t < 2e6 ? t : 2e6;
              u = new Bs(o, r, t, n);
            }
            l.push(u);
          ...
          let h = (e) => {
            if (e.length < r || e.type != Mt.Text) return;
            let s = Ns(e.from, e.to, this.stateDeco);
            if (s.total < r) return;
            let n = this.scrollTarget ? this.scrollTarget.range.head : null;
            let l, h;
            if (i) {
              let t =
                (o / this.heightOracle.lineLength) *
                this.heightOracle.lineHeight;
              let i, r;
              if (n != null) {
                let o = Fs(s, n);
                let l =
                  ((this.visibleBottom - this.visibleTop) / 2 + t) / e.height;
                i = o - l;
                r = o + l;
              } else {
                i = (this.visibleTop - e.top - t) / e.height;
                r = (this.visibleBottom - e.top + t) / e.height;
              }
              l = Vs(s, i);
              h = Vs(s, r);
            } else {
              let i = s.total * this.heightOracle.charWidth;
              let r = o * this.heightOracle.charWidth;
              let a = 0;
              if (i > 2e6)
                for (let s of t) {
                  if (
                    ...
                    s.from * this.heightOracle.charWidth + a <
                      this.pixelViewport.left
                  )
                    a = s.size - s.displaySize;
                }
              let c = this.pixelViewport.left + a,
            ...
            if (l > e.from) a(e.from, l, e, s);
            if (h < e.to) a(h, e.to, e, s);
          };
          for (let s of this.viewportLines) {
            if (Array.isArray(s.type)) s.type.forEach(h);
            else h(s);
          }
          return l;
        }
        ...
        computeVisibleRanges(t) {
          ...
          if (this.lineGaps.length) e = e.concat(this.lineGapDeco);
          let i = [];
          s.RangeSet.spans(
            e,
            this.viewport.from,
            ...
            for (let e = 0; e < i.length && !(o & 8); e++) {
              ...
              if (s.from != n.from || s.to != n.to) {
                ...
                if (
                  !(
                    t &&
                    t.mapPos(s.from, -1) == n.from &&
                    t.mapPos(s.to, 1) == n.to
                  )
                )
                  o |= 8;
              }
        ...
        lineBlockAt(t) {
          return (
            ...
            qs(
              this.heightMap.lineAt(t, ms.ByPos, this.heightOracle, 0, 0),
              this.scaler
            )
          );
        }
      ...
      class Is {
        constructor(t, e, i) {
          ...
          this.viewports = i.map(({ from: i, to: o }) => {
            let n = e.lineAt(i, ms.ByPos, t, 0, 0).top;
            let r = e.lineAt(o, ms.ByPos, t, 0, 0).bottom;
            s += r - n;
            return {
              from: i,
              to: o,
        ...
        eq(t) {
          if (!(t instanceof Is)) return false;
          return (
            this.scale == t.scale &&
      ...
      function qs(t, e) {
        ...
        return new gs(
          ...
          Array.isArray(t._content)
            ? t._content.map((t) => qs(t, e))
            : t._content
        );
      }
      const Ks = s.Facet.define({ combine: (t) => t.join(' ') });
      const Ys = s.Facet.define({ combine: (t) => t.indexOf(true) > -1 });
      const _s = o.StyleModule.newName(),
        Xs = o.StyleModule.newName(),
        Gs = o.StyleModule.newName();
      const js = { '&light': '.' + Xs, '&dark': '.' + Gs };
      function $s(t, e, i) {
      ...
      const Js = nt.ie && nt.ie_version <= 11;
      class Zs {
        constructor(t) {
          this.view = t;
          this.active = false;
          this.editContext = null;
          this.selectionRange = new T();
          ...
          this.observer = new MutationObserver((e) => {
            ...
            if (
              ((nt.ie && nt.ie_version <= 11) || (nt.ios && t.composing)) &&
              e.some(
                (t) =>
          ...
          if (
            window.EditContext &&
            t.constructor.EDIT_CONTEXT !== false &&
            !(nt.chrome && nt.chrome_version < 126)
          ) {
            this.editContext = new so(t);
            if (t.state.facet(xe))
        ...
        onPrint(t) {
          if ((t.type == 'change' || !t.type) && !t.matches) return;
        ...
        onSelectionChange(t) {
          ...
          if (
            ((nt.ie && nt.ie_version <= 11) || (nt.android && nt.chrome)) &&
            !i.state.selection.main.empty &&
            s.focusNode &&
            b(s.focusNode, s.focusOffset, s.anchorNode, s.anchorOffset)
          )
            this.flushSoon();
        ...
        readSelectionRange() {
          ...
          if (s) this.selectionChanged = true;
          return true;
        }
        ...
        listenForScroll() {
          ...
          if (t < this.scrollTargets.length && !e)
          ...
          if (!this.delayedAndroidKey) {
            let t = () => {
              ...
              if (t) {
                ...
                let e = this.flush();
                if (!e && t.force) P(this.dom, t.key, t.keyCode);
              }
            };
        ...
        readChange() {
          ...
          let s = this.selectionChanged && w(this.dom, this.selectionRange);
          if (t < 0 && !s) return null;
          if (t > -1) this.lastChange = Date.now();
          this.view.inputState.lastFocusTime = 0;
          this.selectionChanged = false;
          let o = new wi(this.view, t, e, i);
        ...
        readMutation(t) {
          ...
          if (t.type == 'childList') {
            let i = to(e, t.previousSibling || t.target.previousSibling, -1);
            let s = to(e, t.nextSibling || t.target.nextSibling, 1);
            return {
        ...
        update(t) {
          if (this.editContext) {
            ...
            if (t.startState.facet(xe) != t.state.facet(xe))
              t.view.contentDOM.editContext = t.state.facet(xe)
        ...
        destroy() {
          var t, e, i;
          this.stop();
          (t = this.intersection) === null || t === void 0
            ? void 0
            : t.disconnect();
          (e = this.gapIntersection) === null || e === void 0
            ? void 0
            : e.disconnect();
          (i = this.resizeScroll) === null || i === void 0
            ? void 0
            : i.disconnect();
      ...
      function eo(t, e) {
        ...
        let o = e.endContainer,
          n = e.endOffset;
        let r = t.docView.domAtPos(t.state.selection.main.anchor);
        if (b(r.node, r.offset, o, n)) [i, s, o, n] = [o, n, i, s];
        return { anchorNode: i, anchorOffset: s, focusNode: o, focusOffset: n };
      }
      function io(t, e) {
        ...
        t.contentDOM.addEventListener('beforeinput', s, true);
        t.dom.ownerDocument.execCommand('indent');
        t.contentDOM.removeEventListener('beforeinput', s, true);
        return i ? eo(t, i) : null;
      }
      class so {
        constructor(t) {
          this.from = 0;
          ...
          this.handlers.textupdate = (e) => {
            let i = t.state.selection.main,
              { anchor: o, head: n } = i;
            let r = this.toEditorPos(e.updateRangeStart),
              l = this.toEditorPos(e.updateRangeEnd);
            if (t.inputState.composing >= 0 && !this.composing)
              this.composing = {
                contextBase: e.updateRangeStart,
                editorBase: r,
                drifted: false
              };
            let a = { from: r, to: l, insert: s.Text.of(e.text.split('\n')) };
            if (a.from == this.from && o < this.from) a.from = o;
            else if (a.to == this.to && o > this.to) a.to = o;
            if (a.from == a.to && !a.insert.length) {
              let o = s.EditorSelection.single(
                this.toEditorPos(e.selectionStart),
                this.toEditorPos(e.selectionEnd)
              );
              if (!o.main.eq(i))
                t.dispatch({ selection: o, userEvent: 'select' });
              return;
            }
            if (
              (nt.mac || nt.android) &&
              ...
              a = {
                from: r,
                to: l,
                insert: s.Text.of([e.text.replace('.', ' ')])
              };
          ...
          this.handlers.textformatupdate = (e) => {
            ...
            for (let t of e.getTextFormats()) {
              ...
              if (e != 'None' && s != 'None') {
                ...
                if (o < n) {
                  let t = `text-decoration: underline ${e == 'Dashed' ? 'dashed ' : e == 'Squiggle' ? 'wavy ' : ''}${s == 'Thin' ? 1 : 2}px`;
                  i.push(Ct.mark({ attributes: { style: t } }).range(o, n));
                }
              }
            }
            t.dispatch({ effects: ye.of(Ct.set(i)) });
          };
        ...
        applyEdits(t) {
          ...
          if (s && !i) this.revertPending(t.state);
          return !i;
        }
        update(t) {
          ...
          } else if (!this.applyEdits(t) || !this.rangeIsValid(t.state)) {
            this.pendingContextChange = null;
            this.reset(t.state);
          } else if (t.docChanged || t.selectionSet || e) {
            this.setSelection(t.state);
          }
          if (t.geometryChanged || t.docChanged || t.selectionSet)
        ...
        setSelection(t) {
          ...
          let i = this.toContextPos(
            Math.max(this.from, Math.min(this.to, e.anchor))
          );
          let s = this.toContextPos(e.head);
          if (
      ...
      class oo {
        ...
        constructor(t = {}) {
          ...
          this._root = t.root || H(t.parent) || document;
          this.viewState = new Ps(t.state || s.EditorState.create(t));
          if (t.scrollTo && t.scrollTo.is(be))
            this.viewState.scrollTarget = t.scrollTo.value.clip(
              this.viewState.state
            );
          this.plugins = this.state.facet(Ce).map((t) => new Ae(t));
          for (let s of this.plugins) s.update(this);
          this.observer = new Zs(this);
          this.inputState = new Ci(this);
          this.inputState.ensureHandlers(this.plugins);
          this.docView = new We(this);
          this.mountStyles();
          this.updateAttrs();
          this.updateState = 0;
          this.requestMeasure();
          if ((e = document.fonts) === null || e === void 0 ? void 0 : e.ready)
            document.fonts.ready.then(() => this.requestMeasure());
        }
        dispatch(...t) {
          let e =
            t.length == 1 && t[0] instanceof s.Transaction
              ? t
        ...
        update(t) {
          ...
          if (
            n.facet(s.EditorState.phrases) !=
            this.state.facet(s.EditorState.phrases)
          )
            return this.setState(n);
          o = Fe.create(this, n, t);
          o.flags |= l;
          ...
          try {
            ...
            for (let e of t) {
              ...
              for (let t of e.effects)
                if (t.is(be)) f = t.value.clip(this.state);
            }
            this.viewState.update(o, f);
            this.bidiCache = lo.update(this.bidiCache, o.changes);
            if (!o.empty) {
              this.updatePlugins(o);
              this.inputState.update(o);
            }
            e = this.docView.update(o);
            if (this.state.facet(Ne) != this.styleModules) this.mountStyles();
            i = this.updateAttrs();
          ...
          if (o.startState.facet(Ks) != o.state.facet(Ks))
          ...
          if (!o.empty)
            for (let s of this.state.facet(ce)) {
              try {
                s(o);
              } catch (d) {
          ...
          if (a || c)
            Promise.resolve().then(() => {
              ...
              if (c) {
                if (!vi(this, c) && h.force)
                  P(this.contentDOM, h.key, h.keyCode);
              }
            });
        }
        setState(t) {
          ...
          try {
            ...
            this.viewState = new Ps(t);
            this.plugins = t.facet(Ce).map((t) => new Ae(t));
          ...
          for (let e of this.plugins) {
            ...
            if (i && i.docViewUpdate) {
              try {
                ...
                Se(this.state, t, 'doc view update listener');
              }
            }
          }
        }
        measure(t = true) {
          ...
          try {
            for (let t = 0; ; t++) {
              ...
              let c = Fe.create(this, this.state, []),
                f = false;
              c.flags |= l;
              if (!e) e = c;
              else e.flags |= l;
          ...
          if (e && !e.empty) for (let l of this.state.facet(ce)) l(e);
        }
        get themeClasses() {
          return (
            _s +
            ' ' +
            (this.state.facet(Ys) ? Gs : Xs) +
            ' ' +
            this.state.facet(Ks)
          );
        }
        updateAttrs() {
          ...
          let e = {
            ...
            translate: 'no',
            contenteditable: !this.state.facet(xe) ? 'false' : 'true',
            class: 'cm-content',
          ...
          let i = this.observer.ignore(() => {
            let i = yt(this.contentDOM, this.contentAttrs, e);
            let s = yt(this.dom, this.editorAttrs, t);
            return i || s;
          });
          this.editorAttrs = t;
          this.contentAttrs = e;
        ...
        mountStyles() {
          this.styleModules = this.state.facet(Ne);
          let t = this.state.facet(oo.cspNonce);
          o.StyleModule.mount(
            this.root,
            this.styleModules.concat(Us).reverse(),
            t ? { nonce: t } : undefined
          );
        }
        readMeasured() {
        ...
        moveByChar(t, e, i) {
          return di(this, t, ai(this, t, e, i));
        }
        moveByGroup(t, e) {
          return di(
            this,
            t,
            ai(this, t, e, (e) => hi(this, t.head, e))
          );
        }
        visualLineSide(t, e) {
        ...
        moveToLineBoundary(t, e, i = true) {
          return li(this, t, e, i);
        }
        moveVertically(t, e, i) {
          return di(this, t, ci(this, t, e, i));
        }
        domAtPos(t) {
        ...
        coordsAtPos(t, e = 1) {
          ...
          let s = this.state.doc.lineAt(t),
            o = this.bidiSpans(s);
          let n = o[Gt.find(o, t - s.from, -1, e)];
          return C(i, (n.dir == Vt.LTR) == e > 0);
        }
        coordsForChar(t) {
          this.readMeasured();
        ...
        textDirectionAt(t) {
          let e = this.state.facet(ge);
          if (!e || t < this.viewport.from || t > this.viewport.to)
        ...
        bidiSpans(t) {
          if (t.length > no) return ie(t.length);
          ...
          for (let o of this.bidiCache) {
            if (
              o.from == t.from &&
              o.dir == e &&
              (o.fresh || jt(o.isolates, (i = Le(this, t))))
            )
              return o.order;
          }
          if (!i) i = Le(this, t);
          let s = ee(t.text, e, i);
          this.bidiCache.push(new lo(t.from, t.to, e, i, true, s));
          return s;
        }
        get hasFocus() {
          var t;
        ...
        static scrollIntoView(t, e = {}) {
          return be.of(
            new ve(
              typeof t == 'number' ? s.EditorSelection.cursor(t) : t,
              e.y,
              e.x,
              e.yMargin,
              e.xMargin
        ...
        scrollSnapshot() {
          ...
          return be.of(
            new ve(
              s.EditorSelection.cursor(i.from),
              'start',
              'start',
              i.top - t,
              e,
        ...
        static domEventHandlers(t) {
          return ke.define(() => ({}), { eventHandlers: t });
        }
        static domEventObservers(t) {
          return ke.define(() => ({}), { eventObservers: t });
        }
        static theme(t, e) {
          let i = o.StyleModule.newName();
          let s = [Ks.of(i), Ne.of($s(`.${i}`, t))];
          if (e && e.dark) s.push(Ys.of(true));
          return s;
        }
        static baseTheme(t) {
          return s.Prec.lowest(Ne.of($s('.' + _s, t, js)));
        }
        static findFromDOM(t) {
          ...
          return (
            ((e = s === null || s === void 0 ? void 0 : s.rootView) === null ||
            e === void 0
              ? void 0
              : e.view) || null
          );
      ...
      oo.styleModule = Ne;
      oo.inputHandler = fe;
      oo.clipboardInputFilter = ue;
      oo.clipboardOutputFilter = pe;
      oo.scrollHandler = we;
      oo.focusChangeEffect = de;
      oo.perLineTextDirection = ge;
      oo.exceptionSink = he;
      oo.updateListener = ce;
      oo.editable = xe;
      oo.mouseSelectionStyle = ae;
      oo.dragMovesSelection = le;
      oo.clickAddsSelectionRange = re;
      oo.decorations = Te;
      oo.outerDecorations = Ee;
      oo.atomicRanges = Re;
      oo.bidiIsolatedRanges = Be;
      oo.scrollMargins = Pe;
      oo.darkTheme = Ys;
      oo.cspNonce = s.Facet.define({ combine: (t) => (t.length ? t[0] : '') });
      oo.contentAttributes = Oe;
      oo.editorAttributes = De;
      oo.lineWrapping = oo.contentAttributes.of({ class: 'cm-lineWrapping' });
      oo.announce = s.StateEffect.define();
      const no = 4096;
      const ro = {};
      class lo {
        ...
        static update(t, e) {
          ...
          let i = [],
            s = t.length ? t[t.length - 1].dir : Vt.LTR;
      ...
      const uo = s.Prec.default(
        oo.domEventHandlers({
          keydown(t, e) {
            return xo(mo(e.state), t, e, 'editor');
          }
        })
      );
      const po = s.Facet.define({ enables: uo });
      const go = new WeakMap();
      function mo(t) {
        let e = t.facet(po);
        let i = go.get(e);
        if (!i) go.set(e, (i = yo(e.reduce((t, e) => t.concat(e), []))));
        return i;
      }
      function wo(t, e, i) {
        return xo(mo(t.state), e, t, i);
      }
      let vo = null;
      const bo = 4e3;
      function yo(t, e = ho) {
        ...
        let n = (t, s, n, r, l) => {
          ...
          for (let e = 1; e < f.length; e++) {
            ...
            if (!c[i])
              c[i] = {
                ...
                run: [
                  (e) => {
                    let s = (vo = { view: e, prefix: i, scope: t });
                    setTimeout(() => {
                      if (vo == s) vo = null;
                    }, bo);
                    return true;
          ...
          let u =
            ...
            (c[d] = {
              ...
              run:
                ((h =
                  (a = c._any) === null || a === void 0 ? void 0 : a.run) ===
                  null || h === void 0
                  ? void 0
                  : h.slice()) || []
            });
        ...
        for (let r of t) {
          ...
          if (r.any)
            for (let e of t) {
              ...
              let { any: s } = r;
              for (let e in t) t[e].run.push((t) => s(t, So));
            }
          let s = r[e] || r.key;
          if (!s) continue;
          for (let e of t) {
            ...
            if (r.shift)
              n(e, 'Shift-' + s, r.shift, r.preventDefault, r.stopPropagation);
          }
        }
        return i;
      }
      ...
      function xo(t, e, i, o) {
        ...
        let c = '',
          ...
          d = false,
          u = false;
        if (vo && vo.view == i && vo.scope == o) {
          c = vo.prefix + ' ';
          if (Ti.indexOf(e.keyCode) < 0) {
            d = true;
            vo = null;
          }
        }
        ...
        if (w) {
          if (m(w[c + fo(l, e, !h)])) {
            ...
            !(nt.windows && e.ctrlKey && e.altKey) &&
            (v = n[e.keyCode]) &&
            v != l
          ) {
            if (m(w[c + fo(v, e, true)])) {
              f = true;
            } else if (
              e.shiftKey &&
              (b = r[e.keyCode]) != l &&
          ...
          } else if (h && e.shiftKey && m(w[c + fo(l, e, true)])) {
            f = true;
          }
      ...
      class Mo {
        ...
        static forRange(t, e, i) {
          if (i.empty) {
            ...
            let o = Co(t);
            return [
              new Mo(e, s.left - o.left, s.top - o.top, null, s.bottom - s.top)
            ];
          } else {
            return Ao(t, e, i);
          }
      ...
      function Co(t) {
        ...
        let i =
          t.textDirection == Vt.LTR
            ? e.left
            : e.right - t.scrollDOM.clientWidth * t.scaleX;
        return {
          left: i - t.scrollDOM.scrollLeft * t.scaleX,
          top: e.top - t.scrollDOM.scrollTop * t.scaleY
        };
      }
      function ko(t, e, i, s) {
        let o = t.coordsAtPos(e, i * 2);
        if (!o) return s;
        let n = t.dom.getBoundingClientRect();
        let r = (o.top + o.bottom) / 2;
        let l = t.posAtCoords({ x: n.left + 1, y: r });
        let a = t.posAtCoords({ x: n.right - 1, y: r });
      ...
      function Ao(t, e, i) {
        ...
        let u = ri(t, s, 1),
          p = ri(t, o, -1);
        let g = u.type == Mt.Text ? u : null;
        let m = p.type == Mt.Text ? p : null;
        if (g && (t.lineWrapping || u.widgetLineBreaks)) g = ko(t, s, 1, g);
        if (m && (t.lineWrapping || p.widgetLineBreaks)) m = ko(t, o, -1, m);
        if (g && m && g.from == m.from && g.to == m.to) {
          ...
          let o = [];
          if (
            (g || u).to < (m || p).from - (g && m ? 1 : 0) ||
            (u.widgetLineBreaks > 1 &&
              e.bottom + t.defaultLineHeight / 2 < s.top)
          )
            o.push(w(f, e.bottom, d, s.top));
          else if (
            e.bottom < s.top &&
            t.elementAtHeight((e.bottom + s.top) / 2).type == Mt.Text
          )
            e.bottom = s.top = (e.bottom + s.top) / 2;
          return v(e).concat(o).concat(v(s));
        }
        function w(t, i, s, o) {
          return new Mo(e, t - a.left, i - a.top, s - t, o - i);
        }
        ...
        function b(e, i, s) {
          ...
          function a(e, i, a, h, c) {
            ...
            if (c == Vt.LTR) l.push(n && i ? f : u.left, n && h ? d : p.right);
      ...
      class Oo {
        ...
        update(t) {
          if (t.startState.facet(To) != t.state.facet(To))
            this.setOrder(t.state);
      ...
      const To = s.Facet.define();
      function Eo(t) {
        return [ke.define((e) => new Oo(e, t)), To.of(t)];
      }
      const Ro = s.Facet.define({
        combine(t) {
      ...
      function Bo(t = {}) {
        return [Ro.of(t), Ho, Vo, Fo, me.of(true)];
      }
      function Lo(t) {
        return t.facet(Ro);
      }
      function Po(t) {
        return t.startState.facet(Ro) != t.state.facet(Ro);
      }
      const Ho = Eo({
        above: true,
        markers(t) {
          ...
          for (let n of e.selection.ranges) {
            ...
            if (n.empty || i.drawRangeCursor) {
              let e = r
                ? 'cm-cursor cm-cursor-primary'
                : 'cm-cursor cm-cursor-secondary';
              let i = n.empty
                ? n
                : s.EditorSelection.cursor(n.head, n.head > n.anchor ? -1 : 1);
              for (let s of Mo.forRange(t, e, i)) o.push(s);
            }
          }
          return o;
        },
        update(t, e) {
          if (t.transactions.some((t) => t.selection))
      ...
      function No(t, e) {
        e.style.animationDuration = t.facet(Ro).cursorBlinkRate + 'ms';
      }
      const Vo = Eo({
        above: false,
        markers(t) {
          return t.state.selection.ranges
            .map((e) =>
              e.empty ? [] : Mo.forRange(t, 'cm-selectionBackground', e)
            )
            .reduce((t, e) => t.concat(e));
        },
        update(t, e) {
          return t.docChanged || t.selectionSet || t.viewportChanged || Po(t);
        },
        class: 'cm-selectionLayer'
      });
      const Fo = s.Prec.highest(
        oo.theme({
          '.cm-line': {
            '& ::selection, &::selection': {
      ...
      const Wo = s.StateEffect.define({
        map(t, e) {
          return t == null ? null : e.mapPos(t);
        }
      });
      const zo = s.StateField.define({
        create() {
          return null;
        },
        update(t, e) {
          if (t != null) t = e.changes.mapPos(t);
          return e.effects.reduce((t, e) => (e.is(Wo) ? e.value : t), t);
        }
      });
      const Io = ke.fromClass(
        class {
          constructor(t) {
            this.view = t;
            this.cursor = null;
          ...
          update(t) {
            var e;
            let i = t.state.field(zo);
            if (i == null) {
              if (this.cursor != null) {
                (e = this.cursor) === null || e === void 0
                  ? void 0
                  : e.remove();
                this.cursor = null;
              }
          ...
          setDropPos(t) {
            if (this.view.state.field(zo) != t)
              this.view.dispatch({ effects: Wo.of(t) });
          }
        },
        {
          eventObservers: {
      ...
      class _o {
        ...
        createDeco(t) {
          let e = new s.RangeSetBuilder(),
            i = e.add.bind(e);
          for (let { from: s, to: o } of Yo(t, this.maxLength))
            Ko(t.state.doc, this.regexp, s, o, (e, s) =>
        ...
        updateDeco(t, e) {
          ...
          if (t.viewportMoved || s - i > 1e3) return this.createDeco(t.view);
          ...
          for (let o of t.visibleRanges) {
            ...
            if (r > n) {
              ...
              if (i == s) {
                ...
                while ((c = this.regexp.exec(i.text)) && c.index < a - i.from)
                  this.addMatch(c, t, c.index + i.from, f);
              } else {
                Ko(t.state.doc, this.regexp, l, a, (e, i) =>
                  this.addMatch(i, t, e, f)
                );
              }
              e = e.update({
                filterFrom: l,
      ...
      function Uo() {
        var t;
        if ($o == null && typeof document != 'undefined' && document.body) {
          let e = document.body.style;
          $o =
            ((t = e.tabSize) !== null && t !== void 0 ? t : e.MozTabSize) !=
            null;
        }
        return $o || false;
      }
      const Qo = s.Facet.define({
        combine(t) {
          let e = (0, s.combineConfig)(t, {
            render: null,
            specialChars: Go,
            addSpecialChars: null
          });
          if ((e.replaceTabs = !Uo()))
            e.specialChars = new RegExp('\t|' + e.specialChars.source, Xo);
        ...
        return (
          ...
          (Zo = ke.fromClass(
            class {
              constructor(t) {
                this.view = t;
                this.decorations = Ct.none;
                this.decorationCache = Object.create(null);
                this.decorator = this.makeDecorator(t.state.facet(Qo));
                ...
                return new _o({
                  ...
                  decoration: (e, i, o) => {
                    ...
                    return (
                      ...
                      (this.decorationCache[r] = Ct.replace({
                        widget: new on(t, r)
                      }))
                    );
                  },
              ...
              update(t) {
                let e = t.state.facet(Qo);
                if (t.startState.facet(Qo) != e) {
      ...
      class on extends xt {
        ...
        toDOM(t) {
          ...
          let i =
            ...
            ' ' +
            (jo[this.code] || '0x' + this.code.toString(16));
      ...
      const rn = ke.fromClass(
        class {
          ...
          update(t) {
            let { view: e } = t;
            let i =
              e.viewState.editorHeight -
              e.defaultLineHeight -
              e.documentPadding.top -
              0.5;
      ...
      const hn = Ct.line({ class: 'cm-activeLine' });
      const cn = ke.fromClass(
        class {
          constructor(t) {
      ...
      class fn extends xt {
        ...
        coordsAt(t) {
          let e = t.firstChild ? v(t.firstChild) : [];
          if (!e.length) return null;
          let i = window.getComputedStyle(t.parentNode);
          let s = C(e[0], i.direction != 'rtl');
          let o = parseInt(i.lineHeight);
          if (s.bottom - s.top > o * 1.5)
            return {
              left: s.left,
              right: s.right,
              top: s.top,
        ...
        return ke.fromClass(
          class {
            constructor(e) {
              this.view = e;
              this.placeholder = t
                ? Ct.set([Ct.widget({ widget: new fn(t), side: 1 }).range(0)])
                : Ct.none;
            }
            get decorations() {
      ...
      function pn(t, e, i) {
        ...
        let r = [];
        if (e.off > un || i.off > un || e.col < 0 || i.col < 0) {
          let l = Math.min(e.off, i.off),
            a = Math.max(e.off, i.off);
          for (let e = o; e <= n; e++) {
            let i = t.doc.line(e);
            if (i.length <= a)
              r.push(s.EditorSelection.range(i.from + l, i.to + a));
          }
        } else {
      ...
      function mn(t, e) {
        ...
        let r =
          n > un
            ...
            : n == o.length
              ? gn(t, e.clientX)
              : (0, s.countColumn)(o.text, t.state.tabSize, i - o.from);
      ...
      function vn(t) {
        let e =
          (t === null || t === void 0 ? void 0 : t.eventFilter) ||
          ((t) => t.altKey && t.button == 0);
        return oo.mouseSelectionStyle.of((t, i) => (e(i) ? wn(t, i) : null));
      }
      const bn = {
        Alt: [18, (t) => !!t.altKey],
      ...
      const yn = { style: 'cursor: crosshair' };
      function Sn(t = {}) {
        let [e, i] = bn[t.key || 'Alt'];
        let s = ke.fromClass(
          class {
            constructor(t) {
              this.view = t;
        ...
        return [
          s,
          oo.contentAttributes.of((t) => {
            var e;
            return (
              (e = t.plugin(s)) === null || e === void 0 ? void 0 : e.isDown
            )
              ? yn
              : null;
          })
      ...
      const An = s.Facet.define({
        combine: (t) => {
          var e, i, s;
          return {
            position: nt.ios
              ? 'absolute'
              : ((e = t.find((t) => t.position)) === null || e === void 0
                  ? void 0
                  : e.position) || 'fixed',
            parent:
              ((i = t.find((t) => t.parent)) === null || i === void 0
                ? void 0
                : i.parent) || null,
            tooltipSpace:
              ((s = t.find((t) => t.tooltipSpace)) === null || s === void 0
                ? void 0
                : s.tooltipSpace) || kn
          };
        }
      ...
      const On = ke.fromClass(
        class {
          ...
          destroy() {
            ...
            if (this.parent) this.container.remove();
            (e = this.resizeObserver) === null || e === void 0
              ? void 0
              : e.disconnect();
            (i = this.intersectionObserver) === null || i === void 0
              ? void 0
              : i.disconnect();
          ...
          readMeasure() {
            ...
            if (this.position == 'fixed' && this.manager.tooltipViews.length) {
              ...
              } else if (t.style.top == xn && t.style.left == '0px') {
                let e = t.getBoundingClientRect();
            ...
            return {
              ...
              space: this.view.state.facet(An).tooltipSpace(this.view),
              scaleX: t,
              scaleY: e,
              makeAbsolute: i
            };
          ...
          writeMeasure(t) {
            ...
            for (let l = 0; l < this.manager.tooltips.length; l++) {
              ...
              let g = d.right - d.left,
                m =
                  (e = Dn.get(h)) !== null && e !== void 0
                    ? e
                    : d.bottom - d.top;
              let w = h.offset || Rn,
                v = this.view.textDirection == Vt.LTR;
              let b =
              ...
              if (h.overlap !== true)
                for (let t of r)
                  if (
                    ...
                    x = y ? t.top - m - 2 - p : t.bottom + p + 2;
              if (this.position == 'absolute') {
                c.style.top = (x - t.parent.top) / n + 'px';
                Tn(c, (b - t.parent.left) / o);
              } else {
                c.style.top = x / n + 'px';
                Tn(c, b / o);
              }
              ...
              if (h.overlap !== true)
                r.push({ left: b, top: x, right: M, bottom: x + m });
          ...
          maybeMeasure() {
            if (this.manager.tooltips.length) {
              ...
              if (this.inView != this.view.inView) {
                ...
                if (!this.inView)
                  for (let t of this.manager.tooltipViews) t.dom.style.top = xn;
              }
            }
          }
        },
      ...
      function Tn(t, e) {
        ...
        if (isNaN(i) || Math.abs(e - i) > 1) t.style.left = e + 'px';
      }
      const En = oo.baseTheme({
      ...
      const Rn = { x: 0, y: 0 };
      const Bn = s.Facet.define({ enables: [On, En] });
      const Ln = s.Facet.define({
      ...
      class Pn {
        ...
        destroy() {
          var t;
          for (let e of this.manager.tooltipViews)
            (t = e.destroy) === null || t === void 0 ? void 0 : t.call(e);
        }
        passProp(t) {
          let e = undefined;
      ...
      class Nn {
        ...
        get tooltip() {
          let t = this.view.plugin(On);
          let e = t
            ? t.manager.tooltips.findIndex((t) => t.create == Pn.create)
            : -1;
        ...
        mousemove(t) {
          ...
          if ((s.length && o && !Fn(o.dom, t)) || this.pending) {
            let { pos: o } = s[0] || this.pending,
              n =
                (i = (e = s[0]) === null || e === void 0 ? void 0 : e.end) !==
                  null && i !== void 0
                  ? i
                  : o;
            if (
              o == n
                ...
                : !Wn(this.view, o, n, t.clientX, t.clientY)
            ) {
        ...
        watchTooltipLeave(t) {
          let e = (i) => {
            ...
            if (this.active.length && !this.view.dom.contains(i.relatedTarget))
              this.view.dispatch({ effects: this.setHover.of([]) });
          };
      ...
      function Wn(t, e, i, s, o, n) {
        ...
        if (r.left > s || r.right < s || r.top > o || Math.min(r.bottom, l) < o)
          return false;
      ...
      function zn(t, e = {}) {
        ...
        return {
          ...
          extension: [
            o,
            ke.define((s) => new Nn(s, t, o, i, e.hoverTime || 300)),
            Hn
          ]
        };
      }
      ...
      function qn(t) {
        return t.facet(Ln).some((t) => t);
      }
      const Kn = s.StateEffect.define();
      const Yn = Kn.of(null);
      function _n(t) {
        let e = t.plugin(On);
        if (e) e.maybeMeasure();
      }
      const Xn = s.Facet.define({
        combine(t) {
          let e, i;
          for (let s of t) {
            e = e || s.topContainer;
      ...
      const $n = ke.fromClass(
        class {
          constructor(t) {
            this.input = t.state.facet(Jn);
            this.specs = this.input.filter((t) => t);
            this.panels = this.specs.map((e) => e(t));
            let e = t.state.facet(Xn);
            this.top = new Un(t, true, e.topContainer);
            this.bottom = new Un(t, false, e.bottomContainer);
          ...
          update(t) {
            ...
            if (this.bottom.container != e.bottomContainer) {
              this.bottom.sync([]);
              this.bottom = new Un(t.view, false, e.bottomContainer);
            }
            this.top.syncClasses();
            this.bottom.syncClasses();
            let i = t.state.facet(Jn);
            if (i != this.input) {
              let e = i.filter((t) => t);
              let s = [],
                o = [],
      ...
      class Un {
        ...
        sync(t) {
          for (let e of this.panels)
            if (e.destroy && t.indexOf(e) < 0) e.destroy();
          this.panels = t;
          this.syncDOM();
        }
        syncDOM() {
        ...
        syncClasses() {
          ...
          for (let t of this.classes.split(' '))
            if (t) this.container.classList.remove(t);
          for (let t of (this.classes = this.view.themeClasses).split(' '))
            if (t) this.container.classList.add(t);
        }
      }
      function Qn(t) {
        let e = t.nextSibling;
      ...
      const Jn = s.Facet.define({ enables: $n });
      class Zn extends s.RangeValue {
        compare(t) {
          return this == t || (this.constructor == t.constructor && this.eq(t));
        }
        eq(t) {
      ...
      Zn.prototype.elementClass = '';
      Zn.prototype.toDOM = undefined;
      Zn.prototype.mapMode = s.MapMode.TrackBefore;
      Zn.prototype.startSide = Zn.prototype.endSide = -1;
      Zn.prototype.point = true;
      const tr = s.Facet.define();
      const er = s.Facet.define();
      const ir = {
        class: '',
      ...
      function or(t) {
        return [rr(), sr.of(Object.assign(Object.assign({}, ir), t))];
      }
      const nr = s.Facet.define({ combine: (t) => t.some((t) => t) });
      function rr(t) {
        let e = [lr];
        if (t && t.fixed === false) e.push(nr.of(true));
        return e;
      }
      const lr = ke.fromClass(
        class {
          constructor(t) {
            this.view = t;
            ...
            this.gutters = t.state.facet(sr).map((e) => new fr(t, e));
            for (let e of this.gutters) this.dom.appendChild(e.dom);
            this.fixed = !t.state.facet(nr);
            if (this.fixed) {
          ...
          update(t) {
            ...
            if (this.view.state.facet(nr) != !this.fixed) {
          ...
          syncGutters(t) {
            ...
            let i = s.RangeSet.iter(
              this.view.state.facet(tr),
              this.view.viewport.from
            );
            let o = [];
            let n = this.gutters.map(
              (t) =>
                new cr(t, this.view.viewport, -this.view.documentPadding.top)
            );
      ...
      class cr {
        ...
        widget(t, e) {
          let i = this.gutter.config.widgetMarker(t, e.widget, e),
            s = i ? [i] : null;
          for (let o of t.state.facet(er)) {
            let i = o(t, e.widget, e);
            if (i) (s || (s = [])).push(i);
          }
          if (s) this.addElement(t, e, s);
        }
        finish() {
          let t = this.gutter;
      ...
      class fr {
        constructor(t, e) {
          ...
          this.markers = ar(e.markers(t));
          if (e.initialSpacer) {
            this.spacer = new dr(t, 0, 0, [e.initialSpacer(t)]);
      ...
      class dr {
        ...
        update(t, e, i, s) {
          ...
          if (!ur(this.markers, s)) this.setMarkers(t, s);
        }
        setMarkers(t, e) {
      ...
      function ur(t, e) {
        if (t.length != e.length) return false;
        for (let i = 0; i < t.length; i++)
          if (!t[i].compare(e[i])) return false;
        return true;
      }
      const pr = s.Facet.define();
      const gr = s.Facet.define();
      const mr = s.Facet.define({
        combine(t) {
          return (0, s.combineConfig)(
            t,
      ...
      const br = sr.compute([mr], (t) => ({
        class: 'cm-lineNumbers',
        renderEmptyElements: false,
        markers(t) {
          return t.state.facet(pr);
        },
        lineMarker(t, e, i) {
          if (i.some((t) => t.toDOM)) return null;
          return new wr(vr(t, t.state.doc.lineAt(e.from).number));
        },
        widgetMarker: (t, e, i) => {
          for (let s of t.state.facet(gr)) {
            let o = s(t, e, i);
            if (o) return o;
          }
          return null;
        },
        lineMarkerChange: (t) => t.startState.facet(mr) != t.state.facet(mr),
        initialSpacer(t) {
          return new wr(vr(t, Sr(t.state.doc.lines)));
        },
        updateSpacer(t, e) {
          let i = vr(e.view, Sr(e.view.state.doc.lines));
          return i == t.number ? t : new wr(i);
        },
        domEventHandlers: t.facet(mr).domEventHandlers
      }));
      function yr(t = {}) {
        return [mr.of(t), rr(), br];
      }
      function Sr(t) {
        let e = 9;
        while (e < t) e = e * 10 + 9;
      ...
      const xr = new (class extends Zn {
        constructor() {
          super(...arguments);
          this.elementClass = 'cm-activeLineGutter';
        }
      })();
      const Mr = tr.compute(['selection'], (t) => {
        let e = [],
          i = -1;
      ...
      const Ar = Ct.mark({ class: 'cm-highlightTab' });
      const Dr = Ct.mark({ class: 'cm-highlightSpace' });
      const Or = kr(
        new _o({
          regexp: /\t| /g,
          decoration: (t) => (t[0] == '\t' ? Ar : Dr),
          boundary: /\S/
        })
      );
      function Tr() {
      ...
      const Er = kr(
        new _o({
          regexp: /\s+$/g,
          decoration: Ct.mark({ class: 'cm-trailingSpace' }),
          boundary: /\S/
        })
      );
      function Rr() {
      ...
      const Br = {
        ...
        computeOrder: ee,
        moveVisually: oe,
        clearHeightChangeFlag: ds,
        getHeightChangeFlag: () => fs
      };
    }
  }
]);
