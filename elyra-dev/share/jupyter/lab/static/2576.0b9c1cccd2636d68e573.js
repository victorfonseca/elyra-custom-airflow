    ...
    /***/ 72576: /***/ (
      ...
      __webpack_require__.d(__webpack_exports__, {
        ...
        DirectionalStyleSheetBehavior: () =>
          /* reexport */ DirectionalStyleSheetBehavior,
        ...
        addJupyterLabThemeChangeListener: () =>
          /* reexport */ addJupyterLabThemeChangeListener,
        ...
        baseHorizontalSpacingMultiplier: () =>
          /* reexport */ baseHorizontalSpacingMultiplier,
        ...
        designSystemProviderStyles: () =>
          /* reexport */ designSystemProviderStyles,
        designSystemProviderTemplate: () =>
          /* reexport */ designSystemProviderTemplate,
        ...
        neutralFillLayerRestDelta: () =>
          /* reexport */ neutralFillLayerRestDelta,
        ...
        neutralFillStrongRestDelta: () =>
          /* reexport */ neutralFillStrongRestDelta,
        neutralForegroundHint: () =>
          /* reexport */ design_tokens_neutralForegroundHint,
        neutralForegroundHintRecipe: () =>
          /* reexport */ neutralForegroundHintRecipe,
        ...
        neutralLayerCardContainer: () =>
          /* reexport */ design_tokens_neutralLayerCardContainer,
        neutralLayerCardContainerRecipe: () =>
          /* reexport */ neutralLayerCardContainerRecipe,
        neutralLayerFloating: () =>
          /* reexport */ design_tokens_neutralLayerFloating,
        neutralLayerFloatingRecipe: () =>
          /* reexport */ neutralLayerFloatingRecipe,
        ...
        provideJupyterDesignSystem: () =>
          /* reexport */ provideJupyterDesignSystem,
        ...
        verticalSliderLabelStyles: () =>
          /* reexport */ verticalSliderLabelStyles
      ...
      function parseColorHexRGB(raw) {
        ...
        return new color_rgba_64_ColorRGBA64(
          math_utilities_normalize((rawInt & 0xff0000) >>> 16, 0, 255),
          math_utilities_normalize((rawInt & 0x00ff00) >>> 8, 0, 255),
          math_utilities_normalize(rawInt & 0x0000ff, 0, 255),
          1
        );
      }
      /**
      ...
      function parseColorHexARGB(raw) {
        ...
        // Note the use of >>> rather than >> as we want JS to manipulate these as unsigned numbers
        return new color_rgba_64_ColorRGBA64(
          math_utilities_normalize((rawInt & 0x00ff0000) >>> 16, 0, 255),
          math_utilities_normalize((rawInt & 0x0000ff00) >>> 8, 0, 255),
          math_utilities_normalize(rawInt & 0x000000ff, 0, 255),
          math_utilities_normalize((rawInt & 0xff000000) >>> 24, 0, 255)
        );
      }
      /**
       * Converts a hexadecimal color string to a {@link @microsoft/fast-colors#ColorRGBA64}.
      ...
      function parseColorWebRGB(raw) {
        ...
        return new color_rgba_64_ColorRGBA64(
          math_utilities_normalize(Number(split[0]), 0, 255),
          math_utilities_normalize(Number(split[1]), 0, 255),
          math_utilities_normalize(Number(split[2]), 0, 255),
          1
        );
      }
      /**
 ...
 */
      ...
      color_lab_ColorLAB.kappa = 24389 / 27; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-colors/dist/color-lch.js
       ...
       */
      ColorXYZ.whitePoint = new ColorXYZ(0.95047, 1.0, 1.08883); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-colors/dist/color-converters.js
      ...
      function calcRgbOverlay(rgbMatch, rgbBackground, rgbOverlay) {
        const rChannel = calcChannelOverlay(
          rgbMatch.r,
          rgbBackground.r,
          rgbOverlay.r
        );
        const gChannel = calcChannelOverlay(
          rgbMatch.g,
          rgbBackground.g,
          rgbOverlay.g
        );
        const bChannel = calcChannelOverlay(
          rgbMatch.b,
          rgbBackground.b,
          rgbOverlay.b
        );
      ...
      var index_js_ = __webpack_require__(63073);
      // EXTERNAL MODULE: ./node_modules/@microsoft/fast-web-utilities/dist/localization.js
      var localization = __webpack_require__(30086); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-colors/dist/color-blending.js
      /**
      ...
      function interpolateByColorSpace(position, space, left, right) {
        ...
        switch (space) {
          case ColorInterpolationSpace.HSL:
            return color_converters_hslToRGB(
              interpolateHSL(
                position,
                color_converters_rgbToHSL(left),
                color_converters_rgbToHSL(right)
              )
            );
          case ColorInterpolationSpace.HSV:
            return hsvToRGB(
              interpolateHSV(position, rgbToHSV(left), rgbToHSV(right))
            );
          case ColorInterpolationSpace.XYZ:
            return xyzToRGB(
              interpolateXYZ(position, rgbToXYZ(left), rgbToXYZ(right))
            );
          case ColorInterpolationSpace.LAB:
            return color_converters_labToRGB(
              interpolateLAB(
                position,
                color_converters_rgbToLAB(left),
                color_converters_rgbToLAB(right)
              )
            );
          case ColorInterpolationSpace.LCH:
            return lchToRGB(
              interpolateLCH(position, rgbToLCH(left), rgbToLCH(right))
            );
          default:
      ...
      class color_scale_ColorScale {
        ...
        trim(
          ...
          if (
            containedStops[containedStops.length - 1].position !== upperBound
          ) {
            containedStops.push({
       ...
       * @public
       */
      function generateOffCenterPalette(
        input,
        outputSteps,
        ...
        const greyscale = new ColorPalette(
          Object.assign(Object.assign({}, greyscaleConfig), {
            steps: outputSteps
          })
        );
       ...
       * @public
       */
      function generateScaledPalettes(
        input,
        shortPaletteLength = 11,
        config = defaultCenteredRescaleConfig
      ) {
        const shortPalette = generateOffCenterPalette(
          input,
          shortPaletteLength
        );
      ...
      class ComponentStateColorPalette {
        ...
        regenPalettes() {
          ...
          const r = new ColorPalette(
            Object.assign(
              Object.assign({}, ColorPalette.greyscalePaletteConfig),
              {
                baseColor: darkLumColor,
                baseScalePosition:
                  ((1 - darkLum) * 100) / stepsForLuminanceRamp,
                steps
              }
            )
          );
          ...
          const baseColorLum2 = color_converters_rgbToHSL(
            this.config.baseColor
          ).l;
          ...
          const darkRefIndex = this.matchRelativeLuminanceIndex(
            darkLum,
            referencePalette
          );
          ...
          const baseColorHSL = color_converters_rgbToHSL(this.config.baseColor);
          const darkBaseColor = color_converters_hslToRGB(
          ...
          const darkestBaseColor = color_converters_hslToRGB(
            color_hsl_ColorHSL.fromObject({
              h: baseColorHSL.h,
              s: baseColorHSL.s,
              l: darkestLum
       ...
       */
      /* eslint-disable-next-line @typescript-eslint/no-non-null-assertion */
      const errorBase = SwatchRGB.from(parseColorHexRGB('#D32F2F')); // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/color/recipes/foreground-on-accent.js
       ...
       * @internal
       */
      function neutralLayerCardContainer(
        palette,
        relativeLuminance,
        layerDelta
      ) {
      ...
      function neutralLayer2Index(
        ...
        return Math.max(
          palette.closestIndexOf(baseLayerLuminanceSwatch(luminance)) +
            layerDelta,
          fillRestDelta,
          fillHoverDelta,
          fillActiveDelta
      ...
      function neutralStrokeDivider(palette, reference, delta) {
        return palette.get(
          palette.closestIndexOf(reference) +
            directionByIsDark(reference) * delta
        );
      } // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/color/recipes/error-fill.js

      function errorFillAlgorithm(
        palette,
        neutralPalette,
        reference,
        hoverDelta,
       ...
       * @internal
       */
      function errorForegroundAlgorithm(
        palette,
        reference,
        contrastTarget,
        restDelta,
      ...
      function createNonCss(name) {
        return index_js_.DesignToken.create({
          name,
      ...
      // General tokens
      /** @public */
      const bodyFont = design_tokens_create('body-font').withDefault(
        'aktiv-grotesk, "Segoe UI", Arial, Helvetica, sans-serif'
      );
      /** @public */
      const baseHeightMultiplier = design_tokens_create(
        'base-height-multiplier'
      ).withDefault(10);
      /** @public */
      const baseHorizontalSpacingMultiplier = design_tokens_create(
        'base-horizontal-spacing-multiplier'
      ).withDefault(3);
      /** @public */
      const baseLayerLuminance = design_tokens_create(
        'base-layer-luminance'
      ).withDefault(StandardLuminance.DarkMode);
      /** @public */
      const controlCornerRadius = design_tokens_create(
      ...
      /** @public */
      const direction = design_tokens_create('direction').withDefault(
        localization /* Direction */.O.ltr
      );
      /** @public */
      const disabledOpacity =
        design_tokens_create('disabled-opacity').withDefault(0.4);
      /** @public */
      const strokeWidth = design_tokens_create('stroke-width').withDefault(1);
      /** @public */
      const focusStrokeWidth =
        design_tokens_create('focus-stroke-width').withDefault(2);
      // Typography values
      /** @public */
      const typeRampBaseFontSize = design_tokens_create(
        'type-ramp-base-font-size'
      ).withDefault('14px');
      /** @public */
      const typeRampBaseLineHeight = design_tokens_create(
        'type-ramp-base-line-height'
      ).withDefault('20px');
      /** @public */
      const typeRampMinus1FontSize = design_tokens_create(
        'type-ramp-minus-1-font-size'
      ).withDefault('12px');
      /** @public */
      const typeRampMinus1LineHeight = design_tokens_create(
        'type-ramp-minus-1-line-height'
      ).withDefault('16px');
      /** @public */
      const typeRampMinus2FontSize = design_tokens_create(
        'type-ramp-minus-2-font-size'
      ).withDefault('10px');
      /** @public */
      const typeRampMinus2LineHeight = design_tokens_create(
        'type-ramp-minus-2-line-height'
      ).withDefault('16px');
      /** @public */
      const typeRampPlus1FontSize = design_tokens_create(
        'type-ramp-plus-1-font-size'
      ).withDefault('16px');
      /** @public */
      const typeRampPlus1LineHeight = design_tokens_create(
        'type-ramp-plus-1-line-height'
      ).withDefault('24px');
      /** @public */
      const typeRampPlus2FontSize = design_tokens_create(
        'type-ramp-plus-2-font-size'
      ).withDefault('20px');
      /** @public */
      const typeRampPlus2LineHeight = design_tokens_create(
        'type-ramp-plus-2-line-height'
      ).withDefault('28px');
      /** @public */
      const typeRampPlus3FontSize = design_tokens_create(
        'type-ramp-plus-3-font-size'
      ).withDefault('28px');
      /** @public */
      const typeRampPlus3LineHeight = design_tokens_create(
        'type-ramp-plus-3-line-height'
      ).withDefault('36px');
      /** @public */
      const typeRampPlus4FontSize = design_tokens_create(
        'type-ramp-plus-4-font-size'
      ).withDefault('34px');
      /** @public */
      const typeRampPlus4LineHeight = design_tokens_create(
        'type-ramp-plus-4-line-height'
      ).withDefault('44px');
      /** @public */
      const typeRampPlus5FontSize = design_tokens_create(
        'type-ramp-plus-5-font-size'
      ).withDefault('46px');
      /** @public */
      const typeRampPlus5LineHeight = design_tokens_create(
        'type-ramp-plus-5-line-height'
      ).withDefault('56px');
      /** @public */
      const typeRampPlus6FontSize = design_tokens_create(
        'type-ramp-plus-6-font-size'
      ).withDefault('60px');
      /** @public */
      const typeRampPlus6LineHeight = design_tokens_create(
        'type-ramp-plus-6-line-height'
      ).withDefault('72px');
      // Color recipe values
      /** @public */
      const accentFillRestDelta = createNonCss(
        'accent-fill-rest-delta'
      ).withDefault(0);
      /** @public */
      const accentFillHoverDelta = createNonCss(
        'accent-fill-hover-delta'
      ).withDefault(4);
      /** @public */
      const accentFillActiveDelta = createNonCss(
        'accent-fill-active-delta'
      ).withDefault(-5);
      /** @public */
      const accentFillFocusDelta = createNonCss(
        'accent-fill-focus-delta'
      ).withDefault(0);
      /** @public */
      const accentForegroundRestDelta = createNonCss(
        'accent-foreground-rest-delta'
      ).withDefault(0);
      /** @public */
      const accentForegroundHoverDelta = createNonCss(
        'accent-foreground-hover-delta'
      ).withDefault(6);
      /** @public */
      const accentForegroundActiveDelta = createNonCss(
        'accent-foreground-active-delta'
      ).withDefault(-4);
      /** @public */
      const accentForegroundFocusDelta = createNonCss(
        'accent-foreground-focus-delta'
      ).withDefault(0);
      /** @public */
      const neutralFillRestDelta = createNonCss(
        'neutral-fill-rest-delta'
      ).withDefault(7);
      /** @public */
      const neutralFillHoverDelta = createNonCss(
        'neutral-fill-hover-delta'
      ).withDefault(10);
      /** @public */
      const neutralFillActiveDelta = createNonCss(
        'neutral-fill-active-delta'
      ).withDefault(5);
      /** @public */
      const neutralFillFocusDelta = createNonCss(
        'neutral-fill-focus-delta'
      ).withDefault(0);
      /** @public */
      const neutralFillInputRestDelta = createNonCss(
        'neutral-fill-input-rest-delta'
      ).withDefault(0);
      /** @public */
      const neutralFillInputHoverDelta = createNonCss(
        'neutral-fill-input-hover-delta'
      ).withDefault(0);
      /** @public */
      const neutralFillInputActiveDelta = createNonCss(
        'neutral-fill-input-active-delta'
      ).withDefault(0);
      /** @public */
      const neutralFillInputFocusDelta = createNonCss(
        'neutral-fill-input-focus-delta'
      ).withDefault(0);
      /** @public */
      const neutralFillStealthRestDelta = createNonCss(
        'neutral-fill-stealth-rest-delta'
      ).withDefault(0);
      /** @public */
      const neutralFillStealthHoverDelta = createNonCss(
        'neutral-fill-stealth-hover-delta'
      ).withDefault(5);
      /** @public */
      const neutralFillStealthActiveDelta = createNonCss(
        'neutral-fill-stealth-active-delta'
      ).withDefault(3);
      /** @public */
      const neutralFillStealthFocusDelta = createNonCss(
        'neutral-fill-stealth-focus-delta'
      ).withDefault(0);
      /** @public */
      const neutralFillStrongRestDelta = createNonCss(
        'neutral-fill-strong-rest-delta'
      ).withDefault(0);
      /** @public */
      const neutralFillStrongHoverDelta = createNonCss(
        'neutral-fill-strong-hover-delta'
      ).withDefault(8);
      /** @public */
      const neutralFillStrongActiveDelta = createNonCss(
        'neutral-fill-strong-active-delta'
      ).withDefault(-5);
      /** @public */
      const neutralFillStrongFocusDelta = createNonCss(
        'neutral-fill-strong-focus-delta'
      ).withDefault(0);
      /** @public */
      const neutralFillLayerRestDelta = createNonCss(
        'neutral-fill-layer-rest-delta'
      ).withDefault(3);
      /** @public */
      const neutralStrokeRestDelta = createNonCss(
        'neutral-stroke-rest-delta'
      ).withDefault(25);
      /** @public */
      const neutralStrokeHoverDelta = createNonCss(
        'neutral-stroke-hover-delta'
      ).withDefault(40);
      /** @public */
      const neutralStrokeActiveDelta = createNonCss(
        'neutral-stroke-active-delta'
      ).withDefault(16);
      /** @public */
      const neutralStrokeFocusDelta = createNonCss(
        'neutral-stroke-focus-delta'
      ).withDefault(25);
      /** @public */
      const neutralStrokeDividerRestDelta = createNonCss(
        'neutral-stroke-divider-rest-delta'
      ).withDefault(8);
      // Color recipes
      /** @public */
      const neutralColor =
        design_tokens_create('neutral-color').withDefault(middleGrey);
      /** @public */
      const neutralPalette = createNonCss('neutral-palette').withDefault(
        (element) => PaletteRGB.from(neutralColor.getValueFor(element))
      );
      /** @public */
      const accentColor =
        design_tokens_create('accent-color').withDefault(accentBase);
      /** @public */
      const accentPalette = createNonCss('accent-palette').withDefault(
        (element) => PaletteRGB.from(accentColor.getValueFor(element))
      );
      // Neutral Layer Card Container
      /** @public */
      const neutralLayerCardContainerRecipe = createNonCss(
      ...
      /** @public */
      const design_tokens_neutralLayerCardContainer = design_tokens_create(
        'neutral-layer-card-container'
      ).withDefault((element) =>
      ...
      /** @public */
      const neutralLayerFloatingRecipe = createNonCss(
      ...
      /** @public */
      const design_tokens_neutralLayerFloating = design_tokens_create(
        'neutral-layer-floating'
      ).withDefault((element) =>
      ...
      // Neutral Layer 1
      /** @public */
      const neutralLayer1Recipe = createNonCss(
      ...
      /** @public */
      const design_tokens_neutralLayer1 = design_tokens_create(
        'neutral-layer-1'
      ).withDefault((element) =>
      ...
      // Neutral Layer 2
      /** @public */
      const neutralLayer2Recipe = createNonCss(
      ...
      /** @public */
      const design_tokens_neutralLayer2 = design_tokens_create(
        'neutral-layer-2'
      ).withDefault((element) =>
      ...
      // Neutral Layer 3
      /** @public */
      const neutralLayer3Recipe = createNonCss(
      ...
      /** @public */
      const design_tokens_neutralLayer3 = design_tokens_create(
        'neutral-layer-3'
      ).withDefault((element) =>
      ...
      // Neutral Layer 4
      /** @public */
      const neutralLayer4Recipe = createNonCss(
      ...
      /** @public */
      const design_tokens_neutralLayer4 = design_tokens_create(
        'neutral-layer-4'
      ).withDefault((element) =>
        neutralLayer4Recipe.getValueFor(element).evaluate(element)
      );
      /** @public */
      const fillColor = design_tokens_create('fill-color').withDefault(
        (element) => design_tokens_neutralLayer1.getValueFor(element)
      );
      var ContrastTarget;
      ...
      /** @public */
      const foregroundOnAccentRecipe = createNonCss(
        'foreground-on-accent-recipe'
      ).withDefault({
        evaluate: (element, reference) =>
          foregroundOnAccentByContrast(ContrastTarget.normal)(
            element,
            reference
          )
      });
      /** @public */
      const foregroundOnAccentRest = design_tokens_create(
      ...
      /** @public */
      const foregroundOnAccentHover = design_tokens_create(
      ...
      /** @public */
      const foregroundOnAccentActive = design_tokens_create(
      ...
      /** @public */
      const foregroundOnAccentFocus = design_tokens_create(
      ...
      /** @public */
      const foregroundOnAccentLargeRecipe = createNonCss(
      ...
      /** @public */
      const foregroundOnAccentRestLarge = design_tokens_create(
      ...
      /** @public */
      const foregroundOnAccentHoverLarge = design_tokens_create(
      ...
      /** @public */
      const foregroundOnAccentActiveLarge = design_tokens_create(
      ...
      /** @public */
      const foregroundOnAccentFocusLarge = design_tokens_create(
      ...
      /** @public */
      const accentForegroundRest = design_tokens_create(
      ...
      /** @public */
      const accentForegroundHover = design_tokens_create(
      ...
      /** @public */
      const accentForegroundActive = design_tokens_create(
      ...
      /** @public */
      const accentForegroundFocus = design_tokens_create(
      ...
      /** @public */
      const neutralFillRest = design_tokens_create(
        'neutral-fill-rest'
      ).withDefault(
        (element) =>
      ...
      /** @public */
      const neutralFillHover = design_tokens_create(
        'neutral-fill-hover'
      ).withDefault(
        (element) =>
      ...
      /** @public */
      const neutralFillActive = design_tokens_create(
        'neutral-fill-active'
      ).withDefault(
        (element) =>
      ...
      /** @public */
      const neutralFillFocus = design_tokens_create(
        'neutral-fill-focus'
      ).withDefault(
        (element) =>
      ...
      /** @public */
      const neutralFillInputRest = design_tokens_create(
      ...
      /** @public */
      const neutralFillInputHover = design_tokens_create(
      ...
      /** @public */
      const neutralFillInputActive = design_tokens_create(
      ...
      /** @public */
      const neutralFillInputFocus = design_tokens_create(
      ...
      /** @public */
      const neutralFillStealthRest = design_tokens_create(
      ...
      /** @public */
      const neutralFillStealthHover = design_tokens_create(
      ...
      /** @public */
      const neutralFillStealthActive = design_tokens_create(
      ...
      /** @public */
      const neutralFillStealthFocus = design_tokens_create(
      ...
      /** @public */
      const neutralFillStrongRest = design_tokens_create(
      ...
      /** @public */
      const neutralFillStrongHover = design_tokens_create(
      ...
      /** @public */
      const neutralFillStrongActive = design_tokens_create(
      ...
      /** @public */
      const neutralFillStrongFocus = design_tokens_create(
      ...
      // Neutral Fill Layer
      /** @public */
      const neutralFillLayerRecipe = createNonCss(
      ...
      /** @public */
      const neutralFillLayerRest = design_tokens_create(
      ...
      // Focus Stroke Outer
      /** @public */
      const focusStrokeOuterRecipe = createNonCss(
      ...
      /** @public */
      const design_tokens_focusStrokeOuter = design_tokens_create(
        'focus-stroke-outer'
      ).withDefault((element) =>
      ...
      // Focus Stroke Inner
      /** @public */
      const focusStrokeInnerRecipe = createNonCss(
        ...
        evaluate: (element) =>
          focusStrokeInner(
            accentPalette.getValueFor(element),
            fillColor.getValueFor(element),
            design_tokens_focusStrokeOuter.getValueFor(element)
          )
      });
      /** @public */
      const design_tokens_focusStrokeInner = design_tokens_create(
        'focus-stroke-inner'
      ).withDefault((element) =>
      ...
      /** @public */
      const neutralForegroundHintRecipe = createNonCss(
      ...
      /** @public */
      const design_tokens_neutralForegroundHint = design_tokens_create(
        'neutral-foreground-hint'
      ).withDefault((element) =>
      ...
      // Neutral Foreground
      /** @public */
      const neutralForegroundRecipe = createNonCss(
      ...
      /** @public */
      const neutralForegroundRest = design_tokens_create(
      ...
      /** @public */
      const neutralStrokeRest = design_tokens_create(
        'neutral-stroke-rest'
      ).withDefault(
        (element) =>
      ...
      /** @public */
      const neutralStrokeHover = design_tokens_create(
      ...
      /** @public */
      const neutralStrokeActive = design_tokens_create(
      ...
      /** @public */
      const neutralStrokeFocus = design_tokens_create(
      ...
      /** @public */
      const neutralStrokeDividerRecipe = createNonCss(
      ...
      /** @public */
      const neutralStrokeDividerRest = design_tokens_create(
      ...
      /** @public */
      const errorColor =
        design_tokens_create('error-color').withDefault(errorBase);
      /**
       * Error palette
       * @public
       */
      const errorPalette = createNonCss('error-palette').withDefault(
        (element) => PaletteRGB.from(errorColor.getValueFor(element))
      );
      // Error Fill
      /** @public */
      ...
      /** @public */
      const foregroundOnErrorRest = design_tokens_create(
      ...
      /** @public */
      const foregroundOnErrorHover = design_tokens_create(
      ...
      /** @public */
      const foregroundOnErrorActive = design_tokens_create(
      ...
      /** @public */
      const foregroundOnErrorFocus = design_tokens_create(
      ...
      /** @public */
      const foregroundOnErrorRestLarge = design_tokens_create(
      ...
      /** @public */
      const foregroundOnErrorHoverLarge = design_tokens_create(
      ...
      /** @public */
      const foregroundOnErrorActiveLarge = design_tokens_create(
      ...
      /** @public */
      const foregroundOnErrorFocusLarge = design_tokens_create(
      ...
      // Error Foreground
      const errorForegroundByContrast = (contrast) => (element, reference) =>
      ...
      /** @public */
      const errorForegroundRest = design_tokens_create(
      ...
      /** @public */
      const errorForegroundHover = design_tokens_create(
      ...
      /** @public */
      const errorForegroundActive = design_tokens_create(
      ...
      /** @public */
      const errorForegroundFocus = design_tokens_create(
            ...
            if (parsedColor) {
              ...
              const correctedHSL = color_hsl_ColorHSL.fromObject({
                ...
                l:
                  hsl.l +
                  (direction *
                    accentFillHoverDelta.getValueFor(document.body)) /
                    94.0
              });
              const correctedRGB = color_converters_hslToRGB(correctedHSL);
              return SwatchRGB.create(
      ...
      function applyJupyterTheme() {
        ...
        if (themeMode) {
          ...
          const layoutColor = styles
            .getPropertyValue(BASE_LAYOUT_COLOR)
            .toString();
          if (layoutColor) {
            ...
            if (parsedColor) {
              ...
              console.debug(
                `Theme is ${isDark_ ? 'dark' : 'light'} based on '${BASE_LAYOUT_COLOR}' value: ${layoutColor}.`
              );
            }
          }
        }
        ...
        for (const jpTokenName in tokenMappings) {
          ...
          if (document.body && value !== '') {
            const parsedValue = (
              (_a = toolkitTokenName.converter) !== null && _a !== void 0
                ? _a
                : (v) => v
            )(value.trim(), isDark_);
            if (parsedValue !== null) {
      ...
      var esm_index_js_ = __webpack_require__(29690); // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/accordion/accordion.styles.js
      // Copyright (c) Jupyter Development Team.
      // Copyright (c) Microsoft Corporation.
      // Distributed under the terms of the Modified BSD License.
       ...
       * @public
       */
      const accordionStyles = (context, definition) => (0, esm_index_js_.css)`
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-web-utilities/dist/system-colors.js
      ...
      })(SystemColors || (SystemColors = {})); // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/styles/size.js
       ...
       */
      const heightNumber = (0,
      esm_index_js_.cssPartial)`(${baseHeightMultiplier} + ${density} + ${elementScale}) * ${designUnit}`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/accordion-item/accordion-item.styles.js
       ...
       * @public
       */
      const accordionItemStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    ${(0, index_js_.display)('flex')} :host {
      box-sizing: border-box;
      font-family: ${bodyFont};
  ...
  `.withBehaviors(
          (0, index_js_.forcedColorsStylesheetBehavior)((0, esm_index_js_.css)`
      /* prettier-ignore */
      .button:${index_js_.focusVisible}::before {
    ...
    `)
       ...
       */
      class JupyterAccordionItem extends index_js_.AccordionItem {}
      /**
      ...
      const jpAccordionItem = JupyterAccordionItem.compose({
        ...
        baseClass: index_js_.AccordionItem,
    ...
    `
       ...
       */
      class JupyterAccordion extends index_js_.Accordion {}
      /**
...
***************************************************************************** */
       ...
       * @internal
       */
      const BaseButtonStyles = (0, esm_index_js_.css)`
...
`.withBehaviors(
  ...
  `)
       ...
       * @internal
       */
      const AccentButtonStyles = (0, esm_index_js_.css)`
...
`.withBehaviors(
  ...
  `)
       ...
       * @internal
       */
      const ErrorButtonStyles = (0, esm_index_js_.css)`
...
`.withBehaviors(
  ...
  `)
       ...
       * @internal
       */
      const HypertextStyles = (0, esm_index_js_.css)`
...
`.withBehaviors(
  ...
  `)
       ...
       * @internal
       */
      const LightweightButtonStyles = (0, esm_index_js_.css)`
...
`.withBehaviors(
  ...
  `)
       ...
       * @internal
       */
      const OutlineButtonStyles = (0, esm_index_js_.css)`
...
`.withBehaviors(
  ...
  `)
       ...
       * @internal
       */
      const StealthButtonStyles = (0, esm_index_js_.css)`
   ...
   */
  :host([appearance='stealth'][slot="end"]) .control:${index_js_.focusVisible},
  :host([appearance='stealth'][slot="start"]) .control:${index_js_.focusVisible} {
    outline-offset: -2px;
  }
`.withBehaviors(
        (0, index_js_.forcedColorsStylesheetBehavior)((0, esm_index_js_.css)`
  ...
  `)
      ...
      function appearanceBehavior(value, styles) {
        return new index_js_.PropertyStyleSheetBehavior(
          'appearance',
          value,
          styles
        );
       ...
       * @public
       */
      const anchorStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    ${BaseButtonStyles}
  `.withBehaviors(
       ...
       * @tagname jp-anchor
       */
      class JupyterAnchor extends index_js_.Anchor {
       ...
       * @public
       */
      const anchoredRegionStyles = (context, definition) => (0,
      esm_index_js_.css)`
  :host {
    contain: layout;
    display: block;
...
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/anchored-region/index.js
       ...
       */
      class JupyterAnchoredRegion extends index_js_.AnchoredRegion {}
      /**
      ...
      const jpAnchoredRegion = JupyterAnchoredRegion.compose({
        ...
        baseClass: index_js_.AnchoredRegion,
      ...
      const rtl = (context, definition) => (0, esm_index_js_.css)`
  ::slotted(${context.tagFor(index_js_.Badge)}) {
    left: 0;
  }
`;
      const ltr = (context, definition) => (0, esm_index_js_.css)`
  ::slotted(${context.tagFor(index_js_.Badge)}) {
    right: 0;
  }
`;
       ...
       * @public
       */
      const avatarStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    ${(0, index_js_.display)('flex')} :host {
      position: relative;
  ...
  `.withBehaviors(
       ...
       * @tagname jp-avatar
       */
      class JupyterAvatar extends index_js_.Avatar {}
      __decorate(
        [(0, esm_index_js_.attr)({ attribute: 'src' })],
        JupyterAvatar.prototype,
        'imgSrc',
        void 0
      );
      __decorate([esm_index_js_.attr], JupyterAvatar.prototype, 'alt', void 0);
      /**
       * The Jupyter Avatar Template for Images
       *  @public
       *
       */
      const imgTemplate = (0, esm_index_js_.html)`
  ${(0, esm_index_js_.when)(
    (x) => x.imgSrc,
    (0, esm_index_js_.html)`
      <img
        src="${(x) => x.imgSrc}"
        alt="${(x) => x.alt}"
        slot="media"
...
`;
       ...
       * @public
       */
      const badgeStyles = (context, definition) => (0, esm_index_js_.css)`
...
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/badge/index.js
       ...
       * @tagname jp-badge
       */
      class JupyterBadge extends index_js_.Badge {}
      /**
       ...
       * @public
       */
      const breadcrumbStyles = (context, definition) => (0, esm_index_js_.css)`
  ${(0, index_js_.display)('inline-block')} :host {
    box-sizing: border-box;
    font-family: ${bodyFont};
    font-size: ${typeRampBaseFontSize};
...
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/breadcrumb/index.js
       ...
       */
      class JupyterBreadcrumb extends index_js_.Breadcrumb {}
      /**
      ...
      const jpBreadcrumb = JupyterBreadcrumb.compose({
        baseName: 'breadcrumb',
        baseClass: index_js_.Breadcrumb,
       ...
       * @public
       */
      const breadcrumbItemStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    ${(0, index_js_.display)('inline-flex')} :host {
        background: transparent;
        box-sizing: border-box;
...
`.withBehaviors(
    ...
    `)
       ...
       */
      class JupyterBreadcrumbItem extends index_js_.BreadcrumbItem {}
      /**
      ...
      const jpBreadcrumbItem = JupyterBreadcrumbItem.compose({
        ...
        baseClass: index_js_.BreadcrumbItem,
       ...
       * @public
       */
      const buttonStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    :host([disabled]),
    :host([disabled]:hover),
  ...
  `.withBehaviors(
    ...
    `),
        ...
        ${AccentButtonStyles}
      `.withBehaviors(
              (0, index_js_.forcedColorsStylesheetBehavior)((0,
              esm_index_js_.css)`
       ...
       * @tagname jp-button
       */
      class JupyterButton extends index_js_.Button {
        constructor() {
          super(...arguments);
          /**
       ...
       */
      const elevation = `box-shadow: ${ambientShadow}, ${directionalShadow};`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/card/card.styles.js
       ...
       * @public
       */
      const cardStyles = (context, definition) =>
        (0, esm_index_js_.css)`
  ...
  `.withBehaviors(
    ...
    `)
       ...
       * @tagname jp-card
       */
      class JupyterCard extends index_js_.Card {
        connectedCallback() {
          super.connectedCallback();
       ...
       * @public
       */
      const checkboxStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    ${(0, index_js_.display)('inline-flex')} :host {
      align-items: center;
      outline: none;
  ...
  `.withBehaviors(
    ...
    `)
       ...
       * @public
       */
      const checkboxTemplate = (context, definition) => (0, esm_index_js_.html)`
  <template
    role="checkbox"
...
`;
       ...
       * @tagname jp-checkbox
       */
      class JupyterCheckbox extends index_js_.Checkbox {
    ...
    `
      ...
      const listboxStyles = (context, definition) => {
        ...
        ${!hostContext ? (0,esm_index_js_.css) `
:host(:${index_js_.focusVisible}:not([disabled])) {
    ...
    `.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)((0,esm_index_js_.css) `
  ...
  ${selectContext ? (0,esm_index_js_.css) `
  ...
  `.withBehaviors((0,index_js_.forcedColorsStylesheetBehavior)((0,esm_index_js_.css) `
       ...
       * @public
       */
      const comboboxStyles = (context, definition) => (0, esm_index_js_.css)`
...
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/combobox/index.js
       ...
       */
      class JupyterCombobox extends index_js_.Combobox {
        /**
        ...
        updateComputedStylesheet() {
          ...
          this.computedStylesheet = (0, esm_index_js_.css)`
      :host {
    ...
    `
       ...
       * @public
       */
      const dataGridStyles = (context, definition) => (0, esm_index_js_.css)`
  :host {
    display: flex;
    position: relative;
    flex-direction: column;
...
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/data-grid/data-grid-row.styles.js
       ...
       * @public
       */
      const dataGridRowStyles = (context, definition) => (0, esm_index_js_.css)`
  :host {
    display: grid;
    padding: 1px 0;
    box-sizing: border-box;
...
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/data-grid/data-grid-cell.styles.js
       ...
       * @public
       */
      const dataGridCellStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    :host {
  ...
  `.withBehaviors(
    ...
    `)
       ...
       */
      class JupyterDataGridCell extends index_js_.DataGridCell {}
      /**
      ...
      const jpDataGridCell = JupyterDataGridCell.compose({
        ...
        baseClass: index_js_.DataGridCell,
       ...
       */
      class JupyterDataGridRow extends index_js_.DataGridRow {}
      /**
      ...
      const jpDataGridRow = JupyterDataGridRow.compose({
        ...
        baseClass: index_js_.DataGridRow,
       ...
       */
      class JupyterDataGrid extends index_js_.DataGrid {}
      /**
      ...
      const jpDataGrid = JupyterDataGrid.compose({
        baseName: 'data-grid',
        baseClass: index_js_.DataGrid,
        template: index_js_.dataGridTemplate,
        styles: dataGridStyles
      });

      // EXTERNAL MODULE: ./node_modules/@microsoft/fast-web-utilities/dist/key-codes.js
      var key_codes = __webpack_require__(74291); // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/date-field/date-field.form-associated.js
      // Copyright (c) Jupyter Development Team.
      // Distributed under the terms of the Modified BSD License.
       ...
       * @internal
       */
      class FormAssociatedDateField extends (0, index_js_.FormAssociated)(
        _DateField
      ) {
        constructor() {
          super(...arguments);
      ...
      class DateField extends FormAssociatedDateField {
        ...
        maxChanged(previous, next) {
          var _a;
          this.max =
            next < ((_a = this.min) !== null && _a !== void 0 ? _a : next)
              ? this.min
              : next;
        ...
        minChanged(previous, next) {
          var _a;
          this.min =
            next > ((_a = this.max) !== null && _a !== void 0 ? _a : next)
              ? this.max
              : next;
          this.value = this.getValidValue(this.value);
        }
        ...
        getValidValue(value) {
          ...
          if (validValue.toString() === INVALID_DATE) {
            ...
            validValue =
              validValue >
              ((_a = this.max) !== null && _a !== void 0 ? _a : validValue)
                ? this.max
                : validValue;
            validValue =
              validValue <
              ((_b = this.min) !== null && _b !== void 0 ? _b : validValue)
                ? this.min
                : validValue;
            validValue = `${validValue.getFullYear().toString().padStart(4, '0')}-${(
              ...
              .padStart(
                2,
                '0'
              )}-${validValue.getDate().toString().padStart(2, '0')}`;
          }
          return validValue;
        }
        /**
        ...
        handleKeyDown(e) {
          const key = e.key;
          switch (key) {
            case key_codes /* keyArrowUp */.I5:
              this.stepUp();
              return false;
            case key_codes /* keyArrowDown */.HX:
              this.stepDown();
              return false;
          }
          return true;
      ...
      __decorate([esm_index_js_.attr], DateField.prototype, 'list', void 0);
      __decorate(
        [
      ...
      (0, index_js_.applyMixins)(
        DateField,
        index_js_.StartEnd,
        index_js_.DelegatesARIATextbox
      ...
      const BaseFieldStyles = (0, esm_index_js_.css)`
  ${(0, index_js_.display)('inline-block')} :host {
    font-family: ${bodyFont};
    outline: none;
    user-select: none;
...
`.withBehaviors(
  ...
  `)
       ...
       * @public
       */
      const dateFieldStyles = (context, definition) => (0, esm_index_js_.css)`
  ${BaseFieldStyles}
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/date-field/date-field.template.js
       ...
       * @public
       */
      const dateFieldTemplate = (context, definition) => (0,
      esm_index_js_.html)`
...
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/date-field/index.js
      ...
      const backgroundStyles = (0, esm_index_js_.css)`
  :host {
  ...
  `)
      ...
      class DesignSystemProvider extends index_js_.FoundationElement {
        constructor() {
          ...
          esm_index_js_.Observable.getNotifier(this).subscribe(
            subscriber,
            'fillColor'
          );
          esm_index_js_.Observable.getNotifier(this).subscribe(
       ...
       * @public
       */
      const designSystemProviderTemplate = (context, definition) =>
        (0, esm_index_js_.html)` <slot></slot> `;
      /**
       * Styles for DesignSystemProvider.
       * @public
       */
      const designSystemProviderStyles = (context, definition) => (0,
      esm_index_js_.css)`
...
`;
       ...
       * @public
       */
      const dialogStyles = (context, definition) => (0, esm_index_js_.css)`
  :host([hidden]) {
    display: none;
  }
...
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/dialog/index.js
       ...
       * @tagname jp-dialog
       */
      class JupyterDialog extends index_js_.Dialog {}
      /**
       ...
       * @public
       */
      const disclosureStyles = (context, definition) => (0, esm_index_js_.css)`
  .disclosure {
...
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/disclosure/index.js
       ...
       */
      class JupyterDisclosure extends index_js_.Disclosure {
        constructor() {
          super(...arguments);
          /**
       ...
       * @public
       */
      const dividerStyles = (context, definition) => (0, esm_index_js_.css)`
  ${(0, index_js_.display)('block')} :host {
...
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/divider/index.js
       ...
       * @tagname jp-divider
       */
      class JupyterDivider extends index_js_.Divider {}
      /**
       ...
       * @fires change - Fires a custom 'change' event when the value has changed
       */
      class JupyterListbox extends index_js_.ListboxElement {
        /**
    ...
    `;
       ...
       * @public
       */
      const menuStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    ${(0, index_js_.display)('block')} :host {
      --elevation: 11;
      background: ${fillColor};
  ...
  `.withBehaviors(
    ...
    `)
       ...
       * @tagname jp-menu
       */
      class JupyterMenu extends index_js_.Menu {
        /**
         * @internal
         */
        connectedCallback() {
       ...
       * @public
       */
      const menuItemStyles = (context, definition) =>
        (0, esm_index_js_.css)`
  ...
  `.withBehaviors(
    ...
    `),
       ...
       */
      class JupyterMenuItem extends index_js_.MenuItem {}
      /**
    ...
    `
       ...
       * @public
       */
      const numberFieldStyles = (context, definition) => (0, esm_index_js_.css)`
  ${BaseFieldStyles}
...
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/number-field/index.js
       ...
       */
      class JupyterNumberField extends index_js_.NumberField {
        constructor() {
          super(...arguments);
          /**
    ...
    `
       ...
       * @public
       */
      const optionStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    ${(0, index_js_.display)('inline-flex')} :host {
      align-items: center;
      font-family: ${bodyFont};
  ...
  `.withBehaviors(
    ...
    `)
       ...
       * @tagname jp-option
       */
      class JupyterOption extends index_js_.ListboxOption {}
      /**
      ...
      const jpOption = JupyterOption.compose({
        baseName: 'option',
        baseClass: index_js_.ListboxOption,
       ...
       * @public
       */
      const progressStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    ${(0, index_js_.display)('flex')} :host {
      align-items: center;
      outline: none;
  ...
  `.withBehaviors(
    ...
    `)
       ...
       * @tagname jp-progress
       */
      class JupyterProgress extends index_js_.BaseProgress {}
      /**
      ...
      const jpProgress = JupyterProgress.compose({
        baseName: 'progress',
        baseClass: index_js_.BaseProgress,
    ...
    `
       ...
       * @public
       */
      const progressRingStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    ${(0, index_js_.display)('flex')} :host {
      align-items: center;
      outline: none;
  ...
  `.withBehaviors(
    ...
    `)
       ...
       */
      class JupyterProgressRing extends index_js_.BaseProgress {}
      /**
       * A function that returns a {@link @microsoft/fast-foundation#BaseProgress} registration for configuring the component with a DesignSystem.
    ...
    `
       ...
       * @public
       */
      const radioStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    ${(0, index_js_.display)('inline-flex')} :host {
  ...
  `.withBehaviors(
    ...
    `)
      ...
      const radioTemplate = (context, definition) => (0, esm_index_js_.html)`
  <template
    role="radio"
    aria-checked="${(x) => x.checked}"
    aria-required="${(x) => x.required}"
...
`;
       ...
       * @tagname jp-radio
       */
      class JupyterRadio extends index_js_.Radio {}
      /**
    ...
    `
       ...
       * @public
       */
      const radioGroupStyles = (context, definition) => (0, esm_index_js_.css)`
  ${(0, index_js_.display)('flex')} :host {
...
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/radio-group/index.js
       ...
       */
      class JupyterRadioGroup extends index_js_.RadioGroup {
        constructor() {
          super();
        ...
        ariaInvalidChanged() {
          if (this.slottedRadioButtons) {
            this.slottedRadioButtons.forEach((radio) => {
              ...
              radio.setAttribute(
                'aria-invalid',
                (_a = this.getAttribute('aria-invalid')) !== null &&
                  _a !== void 0
                  ? _a
                  : 'false'
              );
      ...
      const clearButtonHover = index_js_.DesignToken.create(
        'clear-button-hover'
      ).withDefault((target) => {
      ...
      const clearButtonActive = index_js_.DesignToken.create(
        'clear-button-active'
      ).withDefault((target) => {
        const buttonRecipe = neutralFillStealthRecipe.getValueFor(target);
        const inputRecipe = neutralFillRecipe.getValueFor(target);
      ...
      const searchStyles = (context, definition) => (0, esm_index_js_.css)`
  ${BaseFieldStyles}
...
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/search/index.js
       ...
       * @fires change - Fires a custom 'change' event when the value has changed
       */
      class JupyterSearch extends index_js_.Search {
        constructor() {
          super(...arguments);
          /**
           * The appearance of the element.
       ...
       * @tagname jp-select
       */
      class JupyterSelect extends index_js_.Select {
        constructor() {
          super(...arguments);
          /**
        ...
        connectedCallback() {
          ...
          if (this.listbox) {
            fillColor.setValueFor(
              this.listbox,
              design_tokens_neutralLayerFloating
            );
          }
        }
        /**
    ...
    `
       ...
       * @public
       */
      const skeletonStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    ${(0, index_js_.display)('block')} :host {
  ...
  `.withBehaviors(
    ...
    `)
       ...
       * @tagname jp-skeleton
       */
      class JupyterSkeleton extends index_js_.Skeleton {}
      /**
      ...
      const slider_styles_ltr = (0, esm_index_js_.css)`
  .track-start {
    left: 0;
  }
`;
      const slider_styles_rtl = (0, esm_index_js_.css)`
  .track-start {
    right: 0;
  }
`;
       ...
       * @public
       */
      const sliderStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    :host([hidden]) {
      display: none;
    }
  ...
  `.withBehaviors(
    ...
    `)
       ...
       * @tagname jp-slider
       */
      class JupyterSlider extends index_js_.Slider {}
      /**
    ...
    `
      ...
      var aria = __webpack_require__(67002); // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/slider-label/slider-label.styles.js
      // Copyright (c) Jupyter Development Team.
      // Copyright (c) Microsoft Corporation.
      // Distributed under the terms of the Modified BSD License.
       ...
       * @public
       */
      const horizontalSliderLabelStyles = (0, esm_index_js_.css)`
  :host {
    align-self: start;
    grid-row: 2;
    margin-top: -2px;
...
`;
       ...
       * @public
       */
      const verticalSliderLabelStyles = (0, esm_index_js_.css)`
  :host {
    justify-self: start;
    grid-column: 2;
    margin-left: 2px;
...
`;
       ...
       * @public
       */
      const sliderLabelStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    ${(0, index_js_.display)('block')} :host {
      font-family: ${bodyFont};
      color: ${neutralForegroundRest};
  ...
  `.withBehaviors(
    ...
    `)
       ...
       */
      class JupyterSliderLabel extends index_js_.SliderLabel {
        sliderOrientationChanged() {
          if (this.sliderOrientation === aria /* Orientation */.t.horizontal) {
       ...
       * @public
       */
      const switchStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    :host([hidden]) {
      display: none;
    }
  ...
  `.withBehaviors(
    ...
    `),
       ...
       * @tagname jp-switch
       */
      class JupyterSwitch extends index_js_.Switch {}
      /**
    ...
    `
       ...
       * @public
       */
      const tabPanelStyles = (context, definition) => (0, esm_index_js_.css)`
  ${(0, index_js_.display)('block')} :host {
    box-sizing: border-box;
    font-size: ${typeRampBaseFontSize};
    line-height: ${typeRampBaseLineHeight};
...
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/tab-panel/index.js
       ...
       */
      class JupyterTabPanel extends index_js_.TabPanel {}
      /**
       ...
       * @public
       */
      const tabStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    ${(0, index_js_.display)('inline-flex')} :host {
      box-sizing: border-box;
      font-family: ${bodyFont};
  ...
  `.withBehaviors(
    ...
    `)
       ...
       * @tagname jp-tab
       */
      class JupyterTab extends index_js_.Tab {}
      /**
       ...
       * @public
       */
      const tabsStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    ${(0, index_js_.display)('grid')} :host {
      box-sizing: border-box;
      font-family: ${bodyFont};
  ...
  `.withBehaviors(
    ...
    `)
       ...
       * @tagname jp-tabs
       */
      class JupyterTabs extends index_js_.Tabs {}
      /**
       ...
       * @public
       */
      const textAreaStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    ${(0, index_js_.display)('inline-block')} :host {
      font-family: ${bodyFont};
      outline: none;
  ...
  `.withBehaviors(
    ...
    `)
       ...
       */
      class JupyterTextArea extends index_js_.TextArea {
        constructor() {
          super(...arguments);
          /**
           * The appearance of the element.
       ...
       * @public
       */
      const textFieldStyles = (context, definition) => (0, esm_index_js_.css)`
  ${BaseFieldStyles}
...
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/text-field/index.js
       ...
       * @fires select - Emits a custom 'select' event when the textarea emits a select event
       */
      class JupyterTextField extends index_js_.TextField {
        constructor() {
          super(...arguments);
          /**
           * The appearance of the element.
      ...
      var numbers = __webpack_require__(83021);
      // EXTERNAL MODULE: ./node_modules/tabbable/dist/index.esm.js
      var index_esm = __webpack_require__(49054); // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/toolbar/toolbar.styles.js
      // Copyright (c) Jupyter Development Team.
      // Copyright (c) Microsoft Corporation.
      // Distributed under the terms of the Modified BSD License.
       ...
       * @public
       */
      const toolbarStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    ${(0, index_js_.display)('inline-flex')} :host {
  ...
  `.withBehaviors(
    ...
    `)
      ...
      const ToolbarArrowKeyMap = Object.freeze({
        [key_codes /* ArrowKeys */.Is.ArrowUp]: {
          [aria /* Orientation */.t.vertical]: -1
        },
        [key_codes /* ArrowKeys */.Is.ArrowDown]: {
          [aria /* Orientation */.t.vertical]: 1
        },
        [key_codes /* ArrowKeys */.Is.ArrowLeft]: {
          [aria /* Orientation */.t.horizontal]: {
            [localization /* Direction */.O.ltr]: -1,
            [localization /* Direction */.O.rtl]: 1
          }
        },
        [key_codes /* ArrowKeys */.Is.ArrowRight]: {
          [aria /* Orientation */.t.horizontal]: {
            [localization /* Direction */.O.ltr]: 1,
            [localization /* Direction */.O.rtl]: -1
          }
      ...
      class FoundationToolbar extends index_js_.FoundationElement {
        constructor() {
           ...
           * @internal
           */
          this.direction = localization /* Direction */.O.ltr;
          /**
           ...
           */
          this.orientation = aria /* Orientation */.t.horizontal;
        }
        /**
        ...
        set activeIndex(value) {
          if (this.$fastController.isConnected) {
            this._activeIndex = (0, numbers /* limit */.AB)(
              0,
        ...
        mouseDownHandler(e) {
          ...
          const activeIndex =
            (_a = this.focusableElements) === null || _a === void 0
              ? void 0
              : _a.findIndex((x) => x.contains(e.target));
        ...
        static reduceFocusableItems(elements, element) {
          ...
          const hasFocusableShadow = Array.from(
            (_d =
              ...
              ? _d
              : []
          ).some((x) => (0, index_esm /* isFocusable */.tp)(x));
          if (
            !element.hasAttribute('disabled') &&
            !element.hasAttribute('hidden') &&
            ((0, index_esm /* isFocusable */.tp)(element) ||
              isRoleRadio ||
      ...
      (0, index_js_.applyMixins)(
        DelegatesARIAToolbar,
        index_js_.ARIAGlobalStatesAndProperties
      );
      (0, index_js_.applyMixins)(
        FoundationToolbar,
        index_js_.StartEnd,
  ...
  `.withBehaviors(
    ...
    `)
       ...
       * @tagname jp-tooltip
       */
      class JupyterTooltip extends index_js_.Tooltip {}
      /**
       ...
       * @public
       */
      const expandCollapseButtonSize = (0,
      esm_index_js_.cssPartial)`(((${baseHeightMultiplier} + ${density}) * 0.5 + 2) * ${designUnit})`;
      const tree_item_styles_ltr = (0, esm_index_js_.css)`
  .expand-collapse-glyph {
    transform: rotate(0deg);
  }
...
`;
      const tree_item_styles_rtl = (0, esm_index_js_.css)`
  .expand-collapse-glyph {
    transform: rotate(180deg);
  }
  :host(.nested) .expand-collapse-button {
...
`;
      const expandCollapseHoverBehavior = index_js_.DesignToken.create(
      ...
      const selectedExpandCollapseHoverBehavior = index_js_.DesignToken.create(
       ...
       * @public
       */
      const treeItemStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    /**
  ...
  `.withBehaviors(
          new DirectionalStyleSheetBehavior(
            tree_item_styles_ltr,
            tree_item_styles_rtl
          ),
          (0, index_js_.forcedColorsStylesheetBehavior)((0, esm_index_js_.css)`
      :host {
        forced-color-adjust: none;
    ...
    `)
       ...
       */
      class JupyterTreeItem extends index_js_.TreeItem {}
      /**
    ...
    `
       ...
       * @public
       */
      const treeViewStyles = (context, definition) => (0, esm_index_js_.css)`
  ${(0, index_js_.display)('flex')} :host {
    flex-direction: column;
    align-items: stretch;
...
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/tree-view/index.js
       ...
       */
      class JupyterTreeView extends index_js_.TreeView {
        /**
        ...
        handleClick(e) {
          ...
          let item = e.target;
          while (item && !(0, index_js_.isTreeItemElement)(item)) {
       ...
       * @public
       */
      const pickerStyles = (context, definition) => (0, esm_index_js_.css)`
  .region {
    z-index: 1000;
    overflow: hidden;
    display: flex;
...
`; // CONCATENATED MODULE: ./node_modules/@jupyter/web-components/dist/esm/drafts/picker/picker-menu.styles.js
       ...
       * @public
       */
      const pickerMenuStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    :host {
      background: ${fillColor};
      --elevation: 11;
  ...
  `.withBehaviors(
    ...
    `)
       ...
       * @public
       */
      const pickerMenuOptionStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    :host {
      display: flex;
      align-items: center;
  ...
  `.withBehaviors(
    ...
    `)
       ...
       * @public
       */
      const pickerListStyles = (context, definition) =>
        (0, esm_index_js_.css)`
        :host {
            display: flex;
            flex-direction: row;
    ...
    `)
       ...
       * @public
       */
      const pickerListItemStyles = (context, definition) =>
        (0, esm_index_js_.css)`
    :host {
      display: flex;
      align-items: center;
  ...
  `.withBehaviors(
    ...
    `)
       ...
       */
      class JupyterPicker extends index_js_.Picker {}
      /**
       ...
       */
      class JupyterPickerMenu extends index_js_.PickerMenu {
        /**
         * @public
         */
        connectedCallback() {
       ...
       */
      class JupyterPickerMenuOption extends index_js_.PickerMenuOption {}
      /**
      ...
      const jpPickerMenuOption = JupyterPickerMenuOption.compose({
        ...
        baseClass: index_js_.PickerMenuOption,
       ...
       */
      class JupyterPickerList extends index_js_.PickerList {}
      /**
      ...
      const jpPickerList = JupyterPickerList.compose({
        ...
        baseClass: index_js_.PickerList,
       ...
       */
      class JupyterPickerListItem extends index_js_.PickerListItem {}
      /**
      ...
      const jpPickerListItem = JupyterPickerListItem.compose({
        ...
        baseClass: index_js_.PickerListItem,
...
//# sourceMappingURL=2576.0b9c1cccd2636d68e573.js.map?v=0b9c1cccd2636d68e573
