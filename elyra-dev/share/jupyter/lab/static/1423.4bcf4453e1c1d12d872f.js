(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [1423, 5606],
  {
    75128: (t, e, s) => {
      ...
      class h {
        ...
        addEventListener(t, e, s) {
          if (t == 'abort' && this.abortListeners) {
            this.abortListeners.push(e);
            if (s && s.onDocChange) this.abortOnDocChange = true;
          }
        }
      }
      function c(t) {
      ...
      function u(t) {
        ...
        let [s, i] = e.every((t) => /^\w+$/.test(t.label))
          ? [/\w*$/, /\w+$/]
          : f(e);
        return (t) => {
          let n = t.matchBefore(i);
          return n || t.explicit
            ? { from: n ? n.from : t.pos, options: e, validFor: s }
            : null;
        };
      }
      function p(t, e) {
        return (s) => {
          for (
            let i = syntaxTree(s.state).resolveInner(s.pos, -1);
            i;
            i = i.parent
          ) {
      ...
      function d(t, e) {
        return (s) => {
          for (
            let e = (0, l.syntaxTree)(s.state).resolveInner(s.pos, -1);
            e;
            e = e.parent
          ) {
      ...
      function k(t, e) {
        ...
        return new RegExp(
          `${n ? '^' : ''}(?:${i})${o ? '$' : ''}`,
          (s = t.flags) !== null && s !== void 0 ? s : t.ignoreCase ? 'i' : ''
        );
      }
          ...
          Object.assign(
            ...
            t.changeByRange((a) => {
              if (
                a != o &&
                s != n &&
                t.sliceDoc(a.from + r, a.from + l) != t.sliceDoc(s, n)
              )
                return { range: a };
              let h = t.toText(e);
              return {
                changes: {
                  from: a.from + r,
                  to: n == o.from ? a.to : a.from + l,
                  insert: h
                },
                range: i.EditorSelection.cursor(a.from + r + h.length)
              };
            })
          ),
      ...
      class C {
        constructor(t) {
          ...
          for (let e = 0; e < t.length; ) {
            ...
            let o = t.slice(e, e + n),
              r = o.toUpperCase();
            this.folded.push(
              (0, i.codePointAt)(r == o ? o.toLowerCase() : r, 0)
            );
            e += n;
          }
        ...
        match(t) {
          ...
          let g = /[a-z]/.test(t),
            k = true;
          for (
            let b = 0, x = Math.min(t.length, 200), v = 0;
            b < x && f < a;
          ...
          if (f == a && r[0] == 0 && k)
            return this.result(-100 + (u ? -200 : 0), r, t);
          if (p == a && d == 0)
            return this.ret(-200 - t.length + (m == t.length ? 0 : -100), [
              0,
              m
            ]);
          if (l > -1)
            return this.ret(-700 - t.length, [l, l + this.pattern.length]);
          if (p == a) return this.ret(-200 + -700 - t.length, [d, m]);
          if (f == a)
            return this.result(
              -100 + (u ? -200 : 0) + -700 + (k ? 0 : -1100),
              r,
              t
            );
          return e.length == 2
        ...
        result(t, e, s) {
          ...
          for (let r of e) {
            let t =
              r +
              (this.astral
                ? (0, i.codePointSize)((0, i.codePointAt)(s, r))
                : 1);
            ...
            render(t, e, s, i) {
              ...
              for (let l = 0; l < i.length; ) {
                let t = i[l++],
                  e = i[l++];
                if (t > r)
                  n.appendChild(document.createTextNode(o.slice(r, t)));
              ...
              if (r < o.length)
                n.appendChild(document.createTextNode(o.slice(r)));
              return n;
            },
            position: 50
          },
      ...
      class R {
        constructor(t, e, s) {
          ...
          this.optionContent = O(r);
          this.optionClass = r.optionClass;
          this.tooltipClass = r.tooltipClass;
          this.range = D(n.length, o, r.maxRenderedOptions);
        ...
        update(t) {
          ...
          if (s != i) {
            ...
            if (!i.open || i.open.options != n) {
              this.range = D(n.length, o, t.state.facet(T).maxRenderedOptions);
              this.showOptions(n, s.id);
            }
            this.updateSel();
            if (
              r != ((e = i.open) === null || e === void 0 ? void 0 : e.disabled)
            )
        ...
        updateTooltipClass(t) {
          ...
          if (e != this.currentClass) {
            for (let t of this.currentClass.split(' '))
              if (t) this.dom.classList.remove(t);
        ...
        updateSel() {
          ...
          if (
            ...
            this.range = D(
              e.options.length,
              e.selected,
              this.view.state.facet(T).maxRenderedOptions
            );
          ...
          if (this.updateSelectedOption(e.selected)) {
            ...
            if ('then' in n) {
              n.then((e) => {
                if (e && this.view.state.field(this.stateField, false) == t)
                  this.addInfoPane(e, s);
              }).catch((t) =>
                (0, o.logException)(this.view.state, t, 'completion info')
              );
            } else {
        ...
        updateSelectedOption(t) {
          let e = null;
          for (
            let s = this.list.firstChild, i = this.range.from;
            s;
            s = s.nextSibling, i++
          ) {
        ...
        measureInfo() {
          ...
          if (
            i.top > Math.min(n.bottom, e.bottom) - 10 ||
            i.bottom < Math.max(n.top, e.top) + 10
          )
            return null;
          return this.view.state
            .facet(T)
            .positionInfo(this.view, e, i, s, n, this.dom);
        }
        placeInfo(t) {
          if (this.info) {
            if (t) {
        ...
        createListBox(t, e, s) {
          ...
          i.addEventListener('mousedown', (t) => {
            if (t.target == i) t.preventDefault();
          });
          let n = null;
      ...
      function B(t, e) {
        ...
        let n = (t) => {
          ...
          if (e) {
            ...
            if (!i.some((e) => e.name == t))
              i.push(typeof e == 'string' ? { name: t } : e);
          }
        };
        let o = e.facet(T);
        for (let h of t)
        ...
        if (i) {
          ...
          let n = (t, e) => {
            var s, i;
            return (
              ((s = t.rank) !== null && s !== void 0 ? s : 1e9) -
                ((i = e.rank) !== null && i !== void 0 ? i : 1e9) ||
              (t.name < e.name ? -1 : 1)
            );
          };
        ...
        for (let h of s.sort(
          (t, e) => e.score - t.score || a(t.completion, e.completion)
        )) {
          let t = h.completion;
          if (
            !l ||
      ...
      class M {
        ...
        static build(t, e, s, i, n, o) {
          if (i && !o && t.some((t) => t.isPending)) return i.setDisabled();
          let r = B(t, e);
          if (!r.length)
            return i && t.some((t) => t.isPending) ? i.setDisabled() : null;
          let l = e.facet(T).selectOnOpen ? 0 : -1;
      ...
      class z {
        ...
        update(t) {
          ...
          let n = i.map((e) => {
            let i =
              ...
              new q(e, this.active.some((t) => t.state != 0) ? 1 : 0);
            return i.update(t, s);
          });
          if (
          ...
          if (
            ...
            o = M.build(n, e, this.id, o, s, r);
          else if (o && o.disabled && !n.some((t) => t.isPending)) o = null;
          if (
            !o &&
            n.every((t) => !t.isPending) &&
            n.some((t) => t.hasResult())
          )
            n = n.map((t) => (t.hasResult() ? new q(t.source, 0) : t));
          for (let l of t.effects)
            if (l.is(K)) o = o && o.setSelected(l.value, this.id);
        ...
        get attrs() {
          return this.open ? this.open.attrs : this.active.length ? $ : j;
        }
      }
      function F(t, e) {
        if (t == e) return true;
      ...
      function V(t, e) {
        if (t.isUserEvent('input.complete')) {
          let s = t.annotation(b);
          if (s && e.activateOnCompletion(s)) return 4 | 8;
        }
        let s = t.isUserEvent('input.type');
        return s && e.activateOnTyping
          ? 4 | 1
          : s
            ? 1
      ...
      class q {
        ...
        update(t, e) {
          let s = V(t, e),
            i = this;
          if (s & 8 || (s & 16 && this.touches(t))) i = new q(i.source, 0);
          if (s & 4 && i.state == 0) i = new q(this.source, 1);
          i = i.updateFor(t, s);
          for (let n of t.effects) {
            if (n.is(y)) i = new q(i.source, 1, n.value);
            else if (n.is(S)) i = new q(i.source, 0);
            else if (n.is(_))
              for (let t of n.value) if (t.source == i.source) i = t;
          }
          return i;
        }
        updateFor(t, e) {
        ...
        touches(t) {
          return t.changes.touchesRange(g(t.state));
        }
      }
      class H extends q {
        constructor(t, e, s, i, n, o) {
        ...
        updateFor(t, e) {
          ...
          let i = this.result;
          if (i.map && !t.changes.empty) i = i.map(i, t.changes);
          let n = t.changes.mapPos(this.from),
            o = t.changes.mapPos(this.to, 1);
          let r = g(t.state);
          if (
            r > o ||
            !i ||
            (e & 2 && (g(t.startState) == this.from || r < this.limit))
          )
            return new q(this.source, e & 4 ? 1 : 0);
          let l = t.changes.mapPos(this.limit);
          if (G(i.validFor, t.state, n, o))
            return new H(this.source, this.explicit, l, i, n, o);
          if (i.update && (i = i.update(i, n, o, new h(t.state, r, false))))
            return new H(
              this.source,
              this.explicit,
              l,
              i,
              i.from,
              (s = i.to) !== null && s !== void 0 ? s : g(t.state)
            );
          return new q(this.source, 1, this.explicit);
        }
        map(t) {
          if (t.empty) return this;
          let e = this.result.map
            ? this.result.map(this.result, t)
            : this.result;
          if (!e) return new q(this.source, 0);
          return new H(
            this.source,
            this.explicit,
            t.mapPos(this.limit),
      ...
      const _ = i.StateEffect.define({
        map(t, e) {
          return t.map((t) => t.map(e));
        }
      });
      const K = i.StateEffect.define();
      const Q = i.StateField.define({
        create() {
          return z.start();
        },
        update(t, e) {
      ...
      function X(t, e) {
        ...
        let i = t.state.field(Q).active.find((t) => t.source == e.source);
        if (!(i instanceof H)) return false;
        if (typeof s == 'string')
          t.dispatch(
            Object.assign(Object.assign({}, x(t.state, s, i.from, i.to)), {
              annotations: b.of(e.completion)
            })
          );
      ...
      function J(t, e = 'option') {
        return (s) => {
          let i = s.state.field(Q, false);
          if (
            !i ||
            !i.open ||
            i.open.disabled ||
            Date.now() - i.open.timestamp < s.state.facet(T).interactionDelay
          )
            return false;
          let n = 1,
            r;
      ...
      const Z = (t) => {
        ...
        if (
          ...
          return false;
        return X(t, e.open.options[e.open.selected]);
      };
      const tt = (t) => {
        let e = t.state.field(Q, false);
        if (!e) return false;
      ...
      const it = 50,
        nt = 1e3;
      const ot = o.ViewPlugin.fromClass(
        class {
          constructor(t) {
            this.view = t;
            ...
            this.composing = 0;
            for (let e of t.state.field(Q).active)
              if (e.isPending) this.startQuery(e);
          }
          update(t) {
            let e = t.state.field(Q);
            let s = t.state.facet(T);
            if (!t.selectionSet && !t.docChanged && t.startState.field(Q) == e)
              return;
            let i = t.transactions.some((t) => {
              let e = V(t, s);
              return e & 8 || ((t.selection || t.docChanged) && !(e & 3));
            });
            for (let l = 0; l < this.running.length; l++) {
              let e = this.running[l];
              if (
                i ||
                (e.context.abortOnDocChange && t.docChanged) ||
                (e.updates.length + t.transactions.length > it &&
                  Date.now() - e.time > nt)
              ) {
                for (let t of e.context.abortListeners) {
                  try {
                    ...
                    (0, o.logException)(this.view.state, r);
                  }
                }
                e.context.abortListeners = null;
                this.running.splice(l--, 1);
              } else {
                e.updates.push(...t.transactions);
              }
            }
            if (this.debounceUpdate > -1) clearTimeout(this.debounceUpdate);
            if (t.transactions.some((t) => t.effects.some((t) => t.is(y))))
              this.pendingStart = true;
            let n = this.pendingStart ? 50 : s.activateOnTypingDelay;
            this.debounceUpdate = e.active.some(
              (t) =>
                t.isPending &&
                !this.running.some((e) => e.active.source == t.source)
            )
              ? setTimeout(() => this.startUpdate(), n)
              : -1;
            if (this.composing != 0)
              for (let o of t.transactions) {
                if (o.isUserEvent('input.type')) this.composing = 2;
          ...
          startUpdate() {
            ...
            for (let s of e.active) {
              if (
                s.isPending &&
                !this.running.some((t) => t.active.source == s.source)
              )
                this.startQuery(s);
            }
            if (this.running.length && e.open && e.open.disabled)
              this.debounceAccept = setTimeout(
                () => this.accept(),
                this.view.state.facet(T).updateSyncTime
              );
          }
          startQuery(t) {
            let { state: e } = this.view,
              s = g(e);
            let i = new h(e, s, t.explicit, this.view);
            let n = new st(t, i);
            this.running.push(n);
          ...
          accept() {
            ...
            let s = this.view.state.facet(T),
              i = this.view.state.field(Q);
            for (let n = 0; n < this.running.length; n++) {
              let o = this.running[n];
              if (o.done === undefined) continue;
              this.running.splice(n--, 1);
              if (o.done) {
                let i = g(
                  o.updates.length ? o.updates[0].startState : this.view.state
                );
                let n = Math.min(i, o.done.from + (o.active.explicit ? 0 : 1));
                let r = new H(
                  o.active.source,
                  o.active.explicit,
                  n,
                  o.done,
                  o.done.from,
                  (t = o.done.to) !== null && t !== void 0 ? t : i
                );
                for (let t of o.updates) r = r.update(t, s);
                if (r.hasResult()) {
                  e.push(r);
                  continue;
                }
              }
              let r = i.active.find((t) => t.source == o.active.source);
              if (r && r.isPending) {
                if (o.done == null) {
                  let t = new q(o.active.source, 0);
                  for (let e of o.updates) t = t.update(e, s);
                  if (!t.isPending) e.push(t);
                } else {
                  this.startQuery(r);
                }
              }
        ...
        },
        {
          eventHandlers: {
            ...
            compositionend() {
              if (this.composing == 3) {
                setTimeout(
                  () => this.view.dispatch({ effects: y.of(false) }),
                  20
                );
              }
              this.composing = 0;
      ...
      const rt = typeof navigator == 'object' && /Win/.test(navigator.platform);
      const lt = i.Prec.highest(
        o.EditorView.domEventHandlers({
          keydown(t, e) {
            let s = e.state.field(Q, false);
            if (
              !s ||
              !s.open ||
              s.open.disabled ||
            ...
            if (o && o.indexOf(t.key) > -1) X(e, i);
            return false;
          }
        })
      );
      const at = o.EditorView.baseTheme({
      ...
      class ct {
        ...
        map(t) {
          ...
          return e == null || s == null ? null : new ct(this.field, e, s);
        }
      }
      class ft {
        constructor(t, e) {
        ...
        instantiate(t, e) {
          ...
          let r = this.fieldPositions.map(
            (t) => new ct(t.field, i[t.line] + t.from, i[t.line] + t.to)
          );
          ...
          for (let o of t.split(/\r\n?|\n/)) {
            while (
              ...
              let t = n[1] ? +n[1] : null,
                r = n[2] || n[3] || '',
                l = -1;
              let a = r.replace(/\\[{}]/g, (t) => t[1]);
              for (let s = 0; s < e.length; s++) {
                if (t != null ? e[s].seq == t : a ? e[s].name == a : false)
                  l = s;
              }
              if (l < 0) {
                let s = 0;
                while (
                  s < e.length &&
                  (t == null || (e[s].seq != null && e[s].seq < t))
                )
                  s++;
                e.splice(s, 0, { seq: t, name: a });
                l = s;
                for (let t of i) if (t.field >= l) t.field++;
              }
              i.push(new ht(l, s.length, n.index, n.index + a.length));
              o = o.slice(0, n.index) + r + o.slice(n.index + n[0].length);
            }
            o = o.replace(/\\([{}])/g, (t, e, n) => {
              for (let o of i)
                if (o.line == s.length && o.from > n) {
                  o.from--;
                  o.to--;
                }
              return e;
      ...
      let pt = o.Decoration.mark({ class: 'cm-snippetField' });
      class dt {
        constructor(t, e) {
          this.ranges = t;
          this.active = e;
          this.deco = o.Decoration.set(
            t.map((t) => (t.from == t.to ? ut : pt).range(t.from, t.to))
          );
        }
        map(t) {
          let e = [];
      ...
      const gt = i.StateEffect.define();
      const kt = i.StateField.define({
        create() {
          return null;
        },
        update(t, e) {
          for (let s of e.effects) {
            if (s.is(mt)) return s.value;
            if (s.is(gt) && t) return new dt(t.ranges, s.value);
          }
          if (t && e.docChanged) t = t.map(e.changes);
          if (t && e.selection && !t.selectionInsideField(e.selection))
            t = null;
          return t;
        },
        provide: (t) =>
      ...
      function xt(t) {
        ...
        return (t, s, n, o) => {
          ...
          let h = {
            ...
            scrollIntoView: true,
            annotations: s
              ? [b.of(s), i.Transaction.userEvent.of('input.complete')]
              : undefined
          };
          if (l.length) h.selection = bt(l, 0);
          if (l.some((t) => t.field > 0)) {
            let e = new dt(l, 0);
            let s = (h.effects = [mt.of(e)]);
            if (t.state.field(kt, false) === undefined)
              s.push(i.StateEffect.appendConfig.of([kt, It, Dt, at]));
          }
      ...
      function vt(t) {
        return ({ state: e, dispatch: s }) => {
          let i = e.field(kt, false);
          if (!i || (t < 0 && i.active == 0)) return false;
          let n = i.active + t,
            o = t > 0 && !i.ranges.some((e) => e.field == n + t);
          s(
            e.update({
              selection: bt(i.ranges, n),
              effects: mt.of(o ? null : new dt(i.ranges, n)),
              scrollIntoView: true
            })
          );
          return true;
      ...
      const wt = ({ state: t, dispatch: e }) => {
        let s = t.field(kt, false);
        if (!s) return false;
        e(t.update({ effects: mt.of(null) }));
        return true;
      };
      const yt = vt(1);
      const St = vt(-1);
      function Ct(t) {
        let e = t.field(kt, false);
      ...
      const Tt = [
        { key: 'Tab', run: yt, shift: St },
        { key: 'Escape', run: wt }
      ];
      const At = i.Facet.define({
        combine(t) {
          return t.length ? t[0] : Tt;
        }
      });
      const It = i.Prec.highest(o.keymap.compute([At], (t) => t.facet(At)));
      function Ot(t, e) {
        return Object.assign(Object.assign({}, e), { apply: xt(t) });
      }
      const Dt = o.EditorView.domEventHandlers({
        mousedown(t, e) {
          let s = e.state.field(kt, false),
            i;
          if (!s || (i = e.posAtCoords({ x: t.clientX, y: t.clientY })) == null)
            return false;
          let n = s.ranges.find((t) => t.from <= i && t.to >= i);
          if (!n || n.field == s.active) return false;
          e.dispatch({
            selection: bt(s.ranges, n.field),
            effects: mt.of(
              s.ranges.some((t) => t.field > n.field)
                ? new dt(s.ranges, n.field)
                : null
            ),
            scrollIntoView: true
          });
      ...
      const Nt = null && Object.create(null);
      function Lt(t) {
        return Nt[t] || (Nt[t] = new WeakMap());
      }
      ...
      const zt = (t) => {
        ...
        let o = Mt(t.state.doc, Lt(e), s, 5e4, n);
      ...
      const $t = i.StateEffect.define({
        map(t, e) {
          let s = e.mapPos(t, -1, i.MapMode.TrackAfter);
          return s == null ? undefined : s;
        }
      });
      const jt = new (class extends i.RangeValue {})();
      jt.startSide = 1;
      jt.endSide = -1;
      const Ut = i.StateField.define({
        create() {
        ...
        update(t, e) {
          ...
          for (let s of e.effects)
            if (s.is($t))
              t = t.update({ add: [jt.range(s.value, s.value + 1)] });
          return t;
        }
      });
      function Wt() {
      ...
      const Vt = '()[]{}<>«»»«［］｛｝';
      function qt(t) {
        for (let e = 0; e < Vt.length; e += 2)
          if (Vt.charCodeAt(e) == t) return Vt.charAt(e + 1);
        return (0, i.fromCodePoint)(t < 128 ? t : t + 1);
      }
      function Ht(t, e) {
        return t.languageDataAt('closeBrackets', e)[0] || Ft;
      }
      const Gt =
        typeof navigator == 'object' && /Android\b/.test(navigator.userAgent);
      const _t = o.EditorView.inputHandler.of((t, e, s, n) => {
        if ((Gt ? t.composing : t.compositionStarted) || t.state.readOnly)
          return false;
        let o = t.state.selection.main;
        if (
          n.length > 2 ||
          (n.length == 2 &&
            (0, i.codePointSize)((0, i.codePointAt)(n, 0)) == 1) ||
          e != o.from ||
          s != o.to
        )
          return false;
      ...
      const Kt = ({ state: t, dispatch: e }) => {
        ...
        let s = Ht(t, t.selection.main.head);
        let n = s.brackets || Ft.brackets;
        let o = null,
          r = t.changeByRange((e) => {
            if (e.empty) {
              let s = Zt(t.doc, e.head);
              for (let o of n) {
                if (o == s && Jt(t.doc, e.head) == qt((0, i.codePointAt)(o, 0)))
                  return {
                    changes: { from: e.head - o.length, to: e.head + o.length },
        ...
        if (!o)
          e(
            t.update(r, { scrollIntoView: true, userEvent: 'delete.backward' })
          );
        return !o;
      };
      const Qt = [{ key: 'Backspace', run: Kt }];
      function Xt(t, e) {
        let s = Ht(t, t.selection.main.head);
        let n = s.brackets || Ft.brackets;
        for (let o of n) {
          let r = qt((0, i.codePointAt)(o, 0));
          if (e == o)
            return r == o
              ? se(t, o, n.indexOf(o + o + o) > -1, s)
              : te(t, o, r, s.before || Ft.before);
          if (e == r && Yt(t, t.selection.main.from)) return ee(t, o, r);
        }
        return null;
      }
      function Yt(t, e) {
        let s = false;
        t.field(Ut).between(0, t.doc.length, (t) => {
          if (t == e) s = true;
        });
        return s;
      }
      ...
      function Zt(t, e) {
        ...
        return (0, i.codePointSize)((0, i.codePointAt)(s, 0)) == s.length
          ? s
          : s.slice(1);
      }
      function te(t, e, s, n) {
          ...
          r = t.changeByRange((r) => {
            if (!r.empty)
              return {
                ...
                effects: $t.of(r.to + e.length),
                range: i.EditorSelection.range(
                  r.anchor + e.length,
                  r.head + e.length
                )
              };
        ...
        return o
          ? null
          : t.update(r, { scrollIntoView: true, userEvent: 'input.type' });
      }
      function ee(t, e, s) {
        let n = null,
          o = t.changeByRange((e) => {
            if (e.empty && Jt(t.doc, e.head) == s)
              return {
                changes: { from: e.head, to: e.head + s.length, insert: s },
                range: i.EditorSelection.cursor(e.head + s.length)
              };
            return (n = { range: e });
          });
        return n
          ? null
          : t.update(o, { scrollIntoView: true, userEvent: 'input.type' });
      }
      function se(t, e, s, n) {
        let o = n.stringPrefixes || Ft.stringPrefixes;
        let r = null,
          l = t.changeByRange((n) => {
            if (!n.empty)
              return {
            ...
            if (a == e) {
              if (ie(t, l)) {
                return {
                  ...
                  effects: $t.of(l + e.length),
                  range: i.EditorSelection.cursor(l + e.length)
                };
              } else if (Yt(t, l)) {
                ...
                return {
                  ...
                  range: i.EditorSelection.cursor(l + o.length)
                };
              }
            } else if (
              s &&
              t.sliceDoc(l - 2 * e.length, l) == e + e &&
              (h = oe(t, l - 2 * e.length, o)) > -1 &&
              ie(t, h)
            ) {
              return {
        ...
        return r
          ? null
          : t.update(l, { scrollIntoView: true, userEvent: 'input.type' });
      }
      function ie(t, e) {
      ...
      function oe(t, e, s) {
        ...
        for (let o of s) {
          ...
          if (
            t.sliceDoc(s, e) == o &&
            n(t.sliceDoc(s - 1, s)) != i.CharCategory.Word
          )
            return s;
        }
        return -1;
      ...
      function re(t = {}) {
        return [lt, Q, T.of(t), ot, ae, at];
      }
      const le = [
        { key: 'Ctrl-Space', run: tt },
        { mac: 'Alt-`', run: tt },
        { key: 'Escape', run: et },
      ...
      const ae = i.Prec.highest(
        o.keymap.computeN([T], (t) => (t.facet(T).defaultKeymap ? [le] : []))
      );
      function he(t) {
        let e = t.field(Q, false);
        return e && e.active.some((t) => t.isPending)
          ? 'pending'
          : e && e.active.some((t) => t.state != 0)
            ? 'active'
            : null;
      }
      ...
      function fe(t) {
        var e;
        let s =
          (e = t.field(Q, false)) === null || e === void 0 ? void 0 : e.open;
        if (!s || s.disabled) return [];
        let i = ce.get(s.options);
        if (!i) ce.set(s.options, (i = s.options.map((t) => t.completion)));
        return i;
      }
      function ue(t) {
        var e;
        let s =
          (e = t.field(Q, false)) === null || e === void 0 ? void 0 : e.open;
        return s && !s.disabled && s.selected >= 0
          ? s.options[s.selected].completion
          : null;
      }
      function pe(t) {
        var e;
    ...
    27421: (t, e, s) => {
      ...
      class r {
        ...
        reduce(t) {
          ...
          if (s == 0) {
            ...
            if (i < n.minRepeatTerm)
              this.storeNode(i, this.reducePos, this.reducePos, 4, true);
          ...
          if (
            a >= 2e3 &&
            !((e = this.p.parser.nodeSet.types[i]) === null || e === void 0
              ? void 0
              : e.isAnonymous)
          ) {
        ...
        recoverByInsert(t) {
          ...
          if (e.length > 4 << 1 || this.stack.length >= 120) {
            ...
            for (let i = 0, n; i < e.length; i += 2) {
              if ((n = e[i + 1]) != this.state && this.p.parser.hasAction(n, t))
                s.push(e[i], n);
            }
        ...
        sameState(t) {
          ...
          for (let e = 0; e < this.stack.length; e += 3)
            if (this.stack[e] != t.stack[e]) return false;
          return true;
        }
        get parser() {
        ...
        emitContext() {
          ...
          if (t < 0 || this.buffer[t] != -3)
            this.buffer.push(this.curContext.hash, this.pos, this.pos, -3);
        }
        emitLookAhead() {
          let t = this.buffer.length - 1;
          if (t < 0 || this.buffer[t] != -4)
      ...
      class p {
        ...
        peek(t) {
          ...
          if (e >= 0 && e < this.chunk.length) {
            ...
            if (
              s >= this.chunk2Pos &&
              s < this.chunk2Pos + this.chunk2.length
            ) {
              ...
              if (s + this.chunk2.length > e.to)
                this.chunk2 = this.chunk2.slice(0, e.to - s);
        ...
        reset(t, e) {
          ...
          if (this.pos != t) {
            ...
            while (t < this.range.from)
              this.range = this.ranges[--this.rangeIndex];
            while (t >= this.range.to)
              this.range = this.ranges[++this.rangeIndex];
      ...
      d.prototype.contextual =
        d.prototype.fallback =
        d.prototype.extend =
          false;
      class m {
        constructor(t, e, s) {
        ...
        nextFragment() {
          ...
          if (t) {
            this.safeFrom = t.openStart
              ? y(t.tree, t.from + t.offset, 1) - t.offset
              : t.from;
            this.safeTo = t.openEnd
              ? y(t.tree, t.to + t.offset, -1) - t.offset
              : t.to;
            ...
            for (let t = o.stateSlot(n, l ? 2 : 1); ; t += 3) {
              if (r[t] == 65535) {
                if (r[t + 1] == 1) {
                  ...
                  if (i == 0 && r[t + 1] == 2)
                    i = this.putAction(R(r, t + 2), e, s, i);
                  break;
                }
              }
              if (r[t] == e) i = this.putAction(R(r, t + 1), e, s, i);
            }
          }
          return i;
        }
      ...
      class P {
        constructor(t, e, s, i) {
          ...
          this.fragments =
            s.length && this.stream.end - n > t.bufferLength * 4
              ? new S(s, t.nodeSet)
              : null;
        }
        get parsedPos() {
        ...
        advance() {
          ...
          for (let o = 1; o < s.length; o++)
            if (s[o].pos < this.minStackPos) this.minStackPos = s[o].pos;
          return null;
        }
        stopAt(t) {
            ...
            for (let l = this.fragments.nodeAt(n); l; ) {
              let n =
                this.parser.nodeSet.types[l.type.id] == l.type
                  ? o.getGoto(t.state, l.type.id)
                  : -1;
              if (
                n > -1 &&
                l.length &&
                (!e || (l.prop(i.NodeProp.contextHash) || 0) == s)
              ) {
                t.useNode(l, n);
                if (v)
                  console.log(
                    r +
                      this.stackID(t) +
                      ` (via reuse of ${o.getName(l.type.id)})`
                  );
                return true;
              }
              if (
          ...
          if (l > 0) {
            ...
            if (v)
              console.log(
                r +
                  this.stackID(t) +
                  ` (via always-reduce ${o.getName(l & 65535)})`
              );
            return true;
          }
      ...
      class D extends i.Parser {
        ...
        hasAction(t, e) {
          ...
          for (let i = 0; i < 2; i++) {
            for (let n = this.stateSlot(t, i ? 2 : 1), o; ; n += 3) {
              if ((o = s[n]) == 65535) {
                if (s[n + 1] == 1) o = s[(n = R(s, n + 2))];
                else if (s[n + 1] == 2) return R(s, n + 2);
                else break;
              }
              if (o == e || o == 0) return R(s, n + 1);
            }
          }
          return 0;
        }
        ...
        allActions(t, e) {
          ...
          for (let n = this.stateSlot(t, 1); i == null; n += 3) {
            if (this.data[n] == 65535) {
              if (this.data[n + 1] == 1) n = R(this.data, n + 2);
              else break;
            }
            i = e(R(this.data, n + 1));
          }
        ...
        nextStates(t) {
          ...
          for (let s = this.stateSlot(t, 1); ; s += 3) {
            if (this.data[s] == 65535) {
              if (this.data[s + 1] == 1) s = R(this.data, s + 2);
              else break;
            }
        ...
        configure(t) {
          let e = Object.assign(Object.create(D.prototype), this);
