    ...
    59137: (e, r, t) => {
      ...
      function i(e) {
        ...
        function w(e, r) {
          ...
          if (i == '@') {
            ...
            if (/[\d.]/.test(e.peek())) {
              ...
              e.eatWhile(/[\w\\\-]/);
              if (e.match(/^\s*:/, false))
                return y('def', 'variable-definition');
        ...
        function j(e, r, t, i) {
          e.context = new z(
            t,
            r.indentation() + (i === false ? 0 : r.indentUnit),
            e.context
          );
          return t;
        }
        ...
        O.restricted_atBlock = function (e, r, t) {
          ...
          if (e == 'word') {
            if (
              (t.stateArg == '@font-face' &&
                !c.hasOwnProperty(r.current().toLowerCase())) ||
              (t.stateArg == '@counter-style' &&
                !d.hasOwnProperty(r.current().toLowerCase()))
            )
              k = 'error';
            else k = 'property';
            return 'maybeprop';
        ...
        return {
          ...
          startState: function () {
            return {
              ...
              state: r ? 'block' : 'top',
              stateArg: null,
              context: new z(r ? 'block' : 'top', 0, null)
            };
          },
          token: function (e, r) {
          ...
          indent: function (e, r, t) {
            ...
            if (i.prev) {
              if (
                ...
                (i.type == 'block' ||
                  i.type == 'top' ||
                  i.type == 'interpolation' ||
                  i.type == 'restricted_atBlock')
              ) {
                i = i.prev;
                a = i.indent;
              } else if (
          ...
          languageData: {
            indentOnInput: /^\s*\}$/,
            commentTokens: { line: f, block: { open: '/*', close: '*/' } },
            autocomplete: P
          }
        };
      }
