  ...
  [8606],
  {
    ...
    14180: (t, n, e) => {
      ...
      function A(t, n, e, i) {
        return arguments.length === 1
          ? b(t)
          : new T(e, n, t, i == null ? 1 : i);
      }
      function M(t, n, e, i) {
        return arguments.length === 1
          ? b(t)
          : new T(t, n, e, i == null ? 1 : i);
      }
      function T(t, n, e, i) {
        this.h = +t;
        this.c = +n;
      ...
      s.prototype = r.prototype = {
        ...
        on: function (t, n) {
          ...
          if (arguments.length < 2) {
            while (++s < h)
              if ((r = (t = i[s]).type) && (r = o(e[r], t.name))) return r;
            return;
          }
        ...
        call: function (t, n) {
          if ((r = arguments.length - 2) > 0)
            for (var e = new Array(r), i = 0, r, s; i < r; ++i)
              e[i] = arguments[i + 2];
      ...
      function g(t) {
        var n =
            t.grouping === undefined || t.thousands === undefined
              ? _
              : r(p.call(t.grouping, Number), t.thousands + ''),
        ...
        function x(t) {
          ...
          function C(t) {
            ...
            if (w && p)
              (t = n($ + t, $.length ? x - a.length : Infinity)), ($ = '');
            switch (r) {
              case '<':
                t = e + t + a + $;
                break;
    ...
    86093: (t, n, e) => {
      ...
      function r(t, n) {
        return Math.max(
          0,
          Math.max(-8, Math.min(8, Math.floor((0, i.A)(n) / 3))) * 3 -
            (0, i.A)(Math.abs(t))
        );
      }
    },
    ...
    69450: (t, n, e) => {
      ...
      class h {
        ...
        bezierCurveTo(t, n, e, i, r, s) {
          this
            ._append`C${+t},${+n},${+e},${+i},${(this._x1 = +r)},${(this._y1 = +s)}`;
        }
        arcTo(t, n, e, r, a) {
          (t = +t), (n = +n), (e = +e), (r = +r), (a = +a);
          ...
          if (this._x1 === null) {
            ...
            this
              ._append`A${a},${a},0,0,${+(f * p > l * y)},${(this._x1 = t + b * h)},${(this._y1 = n + b * c)}`;
          }
        }
        arc(t, n, e, o, u, h) {
          (t = +t), (n = +n), (e = +e), (h = !!h);
          ...
          if (y > a) {
            this
              ._append`A${e},${e},0,1,${p},${t - c},${n - l}A${e},${e},0,1,${p},${(this._x1 = f)},${(this._y1 = _)}`;
          } else if (y > s) {
            this
              ._append`A${e},${e},0,${+(y >= i)},${p},${(this._x1 = t + e * Math.cos(u))},${(this._y1 = n + e * Math.sin(u))}`;
          }
        }
        rect(t, n, e, i) {
          this
      ...
      function h(t, n, e, h) {
        ...
        switch (h.type) {
          case 's': {
            ...
            if (h.precision == null && !isNaN((l = (0, s.A)(c, f))))
              h.precision = l;
            return (0, a.s)(h, f);
          }
          case '':
          ...
          case 'r': {
            if (
              h.precision == null &&
              !isNaN((l = (0, o.A)(c, Math.max(Math.abs(t), Math.abs(n)))))
            )
              h.precision = l - (h.type === 'e');
            break;
          }
          case 'f':
          case '%': {
            if (h.precision == null && !isNaN((l = (0, u.A)(c))))
              h.precision = l - (h.type === '%') * 2;
            break;
          }
        }
        return (0, a.GP)(h);
    ...
    74725: (t, n, e) => {
      ...
      function d(t, n, e, i, r, s, a, o, u, h) {
        ...
        c.nice = function (t) {
          ...
          if (!t || typeof t.range !== 'function')
            t = n(e[0], e[e.length - 1], t == null ? 10 : t);
      ...
      function v() {
        return _.C.apply(
          d(i.Cf, i.yE, r.he, s.Ui, a.YP, o.UA, u.Ag, h.wX, c.R, l.DC).domain([
            new Date(2e3, 0, 1),
            new Date(2e3, 0, 2)
          ]),
          arguments
      ...
      function _() {
        ...
        function x() {
          ...
          if (!(o > r.Ni)) d.moveTo(0, 0);
            ...
            var w = u,
              ...
              N =
                k > r.Ni &&
                (_ ? +_.apply(this, arguments) : (0, r.RZ)(a * a + o * o)),
            ...
            if (!(T > r.Ni)) d.moveTo(E, R);
              ...
              if (U < C)
                ...
                d.arc(
                  ...
                  0,
                  o,
                  (0, r.FP)(F.cy + F.y11, F.cx + F.x11),
                  (0, r.FP)(D.cy + D.y11, D.cx + D.x11),
                  !x
                );
                d.arc(
                  D.cx,
        ...
        x.centroid = function () {
          var e = (+t.apply(this, arguments) + +n.apply(this, arguments)) / 2,
            i =
              (+p.apply(this, arguments) + +y.apply(this, arguments)) / 2 -
              r.pi / 2;
          return [(0, r.gn)(i) * e, (0, r.F8)(i) * e];
        };
        x.innerRadius = function (n) {
          return arguments.length
            ? ((t = typeof n === 'function' ? n : (0, i.A)(+n)), x)
            : t;
        };
        x.outerRadius = function (t) {
          return arguments.length
            ? ((n = typeof t === 'function' ? t : (0, i.A)(+t)), x)
            : n;
        };
        x.cornerRadius = function (t) {
          return arguments.length
            ? ((e = typeof t === 'function' ? t : (0, i.A)(+t)), x)
            : e;
        };
        x.padRadius = function (t) {
          return arguments.length
            ? ((_ =
                t == null ? null : typeof t === 'function' ? t : (0, i.A)(+t)),
              x)
            : _;
        };
        x.startAngle = function (t) {
          return arguments.length
            ? ((p = typeof t === 'function' ? t : (0, i.A)(+t)), x)
            : p;
        };
        x.endAngle = function (t) {
          return arguments.length
            ? ((y = typeof t === 'function' ? t : (0, i.A)(+t)), x)
            : y;
        };
        x.padAngle = function (t) {
          return arguments.length
            ? ((g = typeof t === 'function' ? t : (0, i.A)(+t)), x)
            : g;
        };
        ...
        lineEnd: function () {
          ...
          if (e > 0) {
            ...
            while (++o <= e) {
              u = o / e;
              this._basis.point(
                this._beta * t[o] + (1 - this._beta) * (i + u * s),
                this._beta * n[o] + (1 - this._beta) * (r + u * a)
              );
            }
          }
    ...
    29944: (t, n, e) => {
      ...
      function r(t) {
        ...
        for (n = 1; n < e - 1; ++n)
          (r[n] = 1), (s[n] = 4), (a[n] = 4 * t[n] + 2 * t[n + 1]);
        (r[e - 1] = 2), (s[e - 1] = 7), (a[e - 1] = 8 * t[e - 1] + t[e]);
        for (n = 1; n < e; ++n)
          (i = r[n] / s[n - 1]), (s[n] -= i), (a[n] -= i * a[n - 1]);
        r[e - 1] = a[e - 1] / s[e - 1];
    ...
    58679: (t, n, e) => {
      ...
      function u(t, n) {
        ...
        f.x = function (n) {
          return arguments.length
            ? ((t = typeof n === 'function' ? n : (0, r.A)(+n)), f)
            : t;
        };
        f.y = function (t) {
          return arguments.length
            ? ((n = typeof t === 'function' ? t : (0, r.A)(+t)), f)
            : n;
        };
        f.defined = function (t) {
          return arguments.length
            ? ((e = typeof t === 'function' ? t : (0, r.A)(!!t)), f)
            : e;
        };
        f.curve = function (t) {
    ...
    77613: (t, n, e) => {
      ...
      function B(t, n) {
        t = Q(t);
        return p(
          i.Mo.count((0, s.he)(t), t) + ((0, s.he)(t).getDay() === 4),
          n,
          2
        );
      }
      ...
      function gt(t, n) {
        t = yt(t);
        return p(
          i.pT.count((0, s.Mb)(t), t) + ((0, s.Mb)(t).getUTCDay() === 4),
          n,
          2
        );
      }
    ...
    20293: (t, n, e) => {
      ...
      const s = (0, i.f)(
        ...
        (t, n) =>
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * r.rR) /
          r.Nm,
        (t) => t.getDate() - 1
      );
      const a = s.range;
    ...
    12834: (t, n, e) => {
      ...
      function s(t, n, e, a) {
        ...
        o.offset = (t, e) => (
          n((t = new Date(+t)), e == null ? 1 : Math.floor(e)), t
        );
        o.range = (e, i, r) => {
          const s = [];
          e = o.ceil(e);
    ...
    77849: (t, n, e) => {
      ...
      const r = (0, i.f)(
        ...
        (t, n) =>
          n.getMonth() -
          t.getMonth() +
          (n.getFullYear() - t.getFullYear()) * 12,
        (t) => t.getMonth()
      );
      const s = r.range;
      const a = (0, i.f)(
