...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [2681],
  {
    82681: (e, t, r) => {
      ...
      var u = new RegExp(i);
      var l = new RegExp(o);
      var c = new RegExp(o + '?_' + o);
      var s = new RegExp(o + '\\s*\\(');
      function f(e, t) {
        var r;
        r = e.next();
        if (r === '"') {
        ...
        if (n !== null && a.hasOwnProperty(n[1])) t.scopes.push('bodied');
        var i = m(t);
        if (i === 'bodied' && r === '[') t.scopes.pop();
      ...
      const h = {
        ...
        indent: function (e, t, r) {
          if (e.tokenize !== f && e.tokenize !== null) return null;
          var n = 0;
          if (t === ']' || t === '];' || t === '}' || t === '};' || t === ');')
            n = -1;
