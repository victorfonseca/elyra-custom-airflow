...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [9311],
  {
    79311: (e, t, n) => {
      n.r(t);
      n.d(t, {
        commonmarkLanguage: () => Je,
        deleteMarkupBackward: () => ut,
        insertNewlineContinueMarkup: () => lt,
        markdown: () => pt,
        markdownKeymap: () => ct,
        markdownLanguage: () => Ye
      });
      ...
      class h {
        ...
        addChild(e, t) {
          if (e.prop(o.NodeProp.contextHash) != this.hash)
            e = new o.Tree(
              e.type,
              e.children,
              e.positions,
        ...
        toTree(e, t = this.end) {
          ...
          return new o.Tree(
            ...
            makeTree: (e, t, n) =>
              new o.Tree(o.NodeType.none, e, t, n, this.hashProp)
          });
        }
      }
      var f;
      ...
      function d(e, t, n) {
        if (
          n.pos == n.text.length ||
          (e != t.block &&
            n.indent >= t.stack[n.depth + 1].value + n.baseIndent)
        )
          return true;
        ...
        return (
          r > 0 &&
          (e.type != f.BulletList || b(n, t, false) < 0) &&
          n.text.charCodeAt(n.pos + r - 1) == e.value
        );
      }
      const p = {
        [f.Blockquote](e, t, n) {
          ...
          n.markers.push(
            J(f.QuoteMark, t.lineStart + n.pos, t.lineStart + n.pos + 1)
          );
      ...
      function x(e) {
        ...
        if (e.next == 96)
          for (let n = t; n < e.text.length; n++)
            if (e.text.charCodeAt(n) == 96) return -1;
        return t;
      }
      function L(e) {
      ...
      function b(e, t, n) {
        ...
        if (n && e.next == 45 && T(e) > -1 && e.depth == t.stack.length)
          return -1;
        return r < 3 ? -1 : 1;
      }
      function w(e, t) {
        for (let n = e.stack.length - 1; n >= 0; n--)
          if (e.stack[n].type == t) return true;
        return false;
      }
      function S(e, t, n) {
      ...
      function M(e, t, n) {
        ...
        for (let s = 0, i = E.length - (n ? 1 : 0); s < i; s++)
          if (E[s][0].test(r)) return s;
        return -1;
      }
      function P(e, t) {
      ...
      const v = {
        ...
        IndentedCode(e, t) {
          ...
          e.addNode(
            e.buffer.writeElements(l, -s).finish(f.CodeBlock, i - s),
            s
          );
          return true;
        },
        FencedCode(e, t) {
          ...
          for (
            let h = true;
            e.nextLine() && t.depth >= e.stack.length;
            h = false
          ) {
            let n = t.pos;
            if (t.indent - t.baseIndent < 4)
              while (n < t.text.length && t.text.charCodeAt(n) == s) n++;
          ...
          e.addNode(
            e.buffer
              .writeElements(a, -r)
              .finish(f.FencedCode, e.prevLineEnd() - r),
            r
          );
          return true;
        },
        ...
        BulletList(e, t) {
          let n = S(t, e, false);
          if (n < 0) return false;
          if (e.block.type != f.BulletList)
            e.startContext(f.BulletList, t.basePos, t.next);
          let r = P(t, t.pos + 1);
        ...
        ATXHeading(e, t) {
          ...
          if (l == i || l == r || !g(t.text.charCodeAt(l - 1)))
            l = t.text.length;
          let o = e.buffer
            .write(f.HeaderMark, 0, n)
            .writeElements(
              e.parser.parseInline(t.text.slice(r + n + 1, l), s + n + 1),
              -s
            );
      ...
      class N {
        ...
        finish(e, t) {
          if (
            ...
            m(t.content, this.pos) == t.content.length
          )
            return this.complete(e, t, t.content.length);
          return false;
        }
        complete(e, t, n) {
          e.addLeafElement(
            t,
            J(f.LinkReference, this.start, this.start + n, this.elts)
          );
          return true;
        }
        nextStage(e) {
        ...
        advance(e) {
          for (;;) {
            if (this.stage == -1) {
              ...
              this.elts.push(
                J(f.LinkMark, this.pos + this.start, this.pos + this.start + 1)
              );
              this.pos++;
      ...
      class R {
        nextLine(e, t, n) {
          ...
          e.addLeafElement(
            n,
            J(
              s == 61 ? f.SetextHeading1 : f.SetextHeading2,
              n.start,
              e.prevLineEnd(),
              [...e.parser.parseInline(n.content, n.start), i]
            )
          );
          return true;
        }
      ...
      class $ {
        ...
        addNode(e, t, n) {
          if (typeof e == 'number')
            e = new o.Tree(
              ...
              Z,
              Z,
              (n !== null && n !== void 0 ? n : this.prevLineEnd()) - t
            );
        ...
        addLeafElement(e, t) {
          this.addNode(
            this.buffer
              .writeElements(ue(t.children, e.marks), -t.from)
        ...
        elt(e, t, n, r) {
          if (typeof e == 'string')
            return J(this.parser.getNodeType(e), t, n, r);
          return new K(e, t);
        }
        get buffer() {
          return new V(this.parser.nodeSet);
        }
      }
      function _(e, t, n, r, s) {
        ...
        return new o.Tree(
          ...
          a,
          n.to + r - h,
          n.tree ? n.tree.propValues : undefined
        );
      }
      class F extends o.Parser {
        ...
        configure(e) {
          ...
          return new F(n, s, i, l, c, r, h, u, d);
        }
        getNodeType(e) {
      ...
      for (let Lt = 1, bt; (bt = f[Lt]); Lt++) {
        Q[Lt] = o.NodeType.define({
          id: Lt,
          name: bt,
          props:
            Lt >= f.Escape
              ...
              : [
                  [
                    o.NodeProp.group,
                    Lt in p ? ['Block', 'BlockContext'] : ['Block', 'LeafBlock']
                  ]
                ],
          top: bt == 'Document'
        });
      ...
      const ie = {
        Escape(e, t, n) {
          ...
          for (let s = 0; s < re.length; s++)
            if (re.charCodeAt(s) == r) return e.append(J(f.Escape, n, n + 2));
          return -1;
        },
        Entity(e, t, n) {
          if (t != 38) return -1;
          ...
          for (; r < e.end; r++) {
            if (e.char(r) == 96) {
              ...
              if (i == s && e.char(r + 1) != 96)
                return e.append(
                  J(f.InlineCode, n, r + 1, [
                    J(f.CodeMark, n, n + s),
                    J(f.CodeMark, r + 1 - s, r + 1)
                  ])
                );
            } else {
              i = 0;
        ...
        HTMLTag(e, t, n) {
          ...
          let l = /^\?[^]*?\?>/.exec(r);
          if (l)
            return e.append(J(f.ProcessingInstruction, n, n + 1 + l[0].length));
          let o =
        ...
        Emphasis(e, t, n) {
          ...
          let d = u && (t == 42 || !f || o);
          return e.append(
            new ne(t == 95 ? W : Y, n, r, (c ? 1 : 0) | (d ? 2 : 0))
          );
        },
        HardBreak(e, t, n) {
          if (t == 92 && e.char(n + 1) == 10)
            return e.append(J(f.HardBreak, n, n + 2));
          if (t == 32) {
            let t = n + 1;
            while (e.char(t) == 32) t++;
            if (e.char(t) == 10 && t >= n + 2)
              return e.append(J(f.HardBreak, n, t + 1));
          }
          return -1;
        },
        Link(e, t, n) {
        ...
        Image(e, t, n) {
          return t == 33 && e.char(n + 1) == 91
            ? e.append(new ne(te, n, n + 2, 1))
            : -1;
        },
        LinkEnd(e, t, n) {
          if (t != 93) return -1;
          for (let r = e.parts.length - 1; r >= 0; r--) {
            ...
            if (t instanceof ne && (t.type == ee || t.type == te)) {
              if (
                !t.side ||
                (e.skipSpace(t.to) == n && !/[(\[]/.test(e.slice(n + 1, n + 2)))
              ) {
                e.parts[r] = null;
                return -1;
              }
      ...
      function he(e, t, n, r) {
        for (
          let s = false, i = t + 1, l = Math.min(e.length, i + 999);
          i < l;
          i++
        ) {
      ...
      class fe {
        ...
        get hasOpenLink() {
          for (let e = this.parts.length - 1; e >= 0; e--) {
            let t = this.parts[e];
            if (t instanceof ne && (t.type == ee || t.type == te)) return true;
          }
          return false;
        }
        addElement(e) {
        ...
        resolveMarkers(e) {
          for (let n = e; n < this.parts.length; n++) {
            ...
            for (let e = l + 1; e < n; e++) {
              if (this.parts[e] instanceof G) a.push(this.parts[e]);
              this.parts[e] = null;
            }
            if (t.type.mark) a.push(this.elt(t.type.mark, t.from, f));
            let u = this.elt(o, h, f, a);
            this.parts[l] =
              r && i.from != h ? new ne(i.type, i.from, h, i.side) : null;
            let c = (this.parts[n] =
              r && t.to != f ? new ne(t.type, f, t.to, t.side) : null);
      ...
      function ue(e, t) {
        ...
        for (let s of t) {
          ...
          if (r < n.length && n[r].from < s.from) {
            let e = n[r];
            if (e instanceof G)
              n[r] = new G(e.type, e.from, e.to, ue(e.children, [s]));
          } else {
            n.splice(r++, 0, s);
          }
        }
        ...
        takeNodes(e) {
          ...
          for (;;) {
            ...
            if (t.to - n <= e.ranges[e.rangeI].to) {
              ...
              let n = new o.Tree(
                e.parser.nodeSet.types[f.Paragraph],
                [],
                [],
                0,
                e.block.hashProp
      ...
      function xe(e) {
        ...
        let r = (0, o.parseMixed)((e, r) => {
          ...
          if (t && (s == f.CodeBlock || s == f.FencedCode)) {
            ...
            let i = t(n);
            if (i)
              return { parser: i, overlay: (e) => e.type.id == f.CodeText };
      ...
      const Le = { resolve: 'Strikethrough', mark: 'StrikethroughMark' };
      const be = {
        defineNodes: [
          {
            name: 'Strikethrough',
            style: { 'Strikethrough/...': a.tags.strikethrough }
          },
        ...
        let f = () => {
          r.push(
            e.elt(
              ...
              s + o,
              s + a,
              e.parser.parseInline(t.slice(o, a), s + o)
            )
          );
        };
      ...
      class ye {
        ...
        nextLine(e, t, n) {
          if (this.rows == null) {
            ...
            let r;
            if (
              (t.next == 45 || t.next == 58 || t.next == 124) &&
              Ce.test((r = t.text.slice(t.pos)))
            ) {
              let s = [],
        ...
        parseBlock: [
          {
            ...
            endLeaf(e, t, n) {
              if (
                n.parsers.some((e) => e instanceof ye) ||
                !Se(t.text, t.basePos)
              )
                return false;
              let r = e.scanLine(e.absoluteLineEnd + 1).text;
              return (
                Ce.test(r) && we(e, t.text, t.basePos) == we(e, r, t.basePos)
              );
            },
      ...
      function Ne(e, t) {
        ...
        for (;;) {
          ...
          if (
            ...
            n == ';' &&
            (s = /&(?:#\d+|#x[a-f\d]+|\w+);$/.exec(e.slice(t, r)))
          )
            r = t + s.index;
          else break;
        }
      ...
      function ze(e, t, n) {
        return (r, s, i) => {
          ...
          for (let o = i + 1; o < r.end; o++) {
            ...
            if (s == e)
              return r.addElement(
                r.elt(t, i, o + 1, l.concat(r.elt(n, o, o + 1)))
              );
        ...
        parseInline: [
          {
            ...
            parse(e, t, n) {
              ...
              if (
                t != 58 ||
                !(r = /^[a-zA-Z_0-9]+:/.exec(e.slice(n + 1, e.end)))
              )
                return -1;
      ...
      var Fe = n(91962);
      const je = (0, i.defineLanguageFacet)({
      ...
      const Ue = me.configure({
        props: [
          i.foldNodeProp.add((e) =>
            !e.is('Block') || e.is('Document') || Qe(e) != null || Ze(e)
              ? undefined
      ...
      const Ge = i.foldService.of((e, t, n) => {
        for (
          let r = (0, i.syntaxTree)(e).resolveInner(n, -1);
          r;
          r = r.parent
        ) {
          if (r.from < t) break;
      ...
      function Ke(e) {
        return new i.Language(je, e, [Ge], 'markdown');
      }
      const Je = Ke(Ue);
      const We = Ue.configure([
        Xe,
        $e,
        De,
        _e,
      ...
      function et(e, t) {
        return (n) => {
          if (n && e) {
            ...
            if (t instanceof i.LanguageDescription)
              return t.support
                ? t.support.language.parser
                : i.ParseContext.getSkippingParser(t.load());
      ...
      function nt(e, t) {
        ...
        for (let s = e; s; s = s.parent) {
          if (s.name == 'FencedCode') return r;
          if (s.name == 'ListItem' || s.name == 'Blockquote') n.push(s);
        }
        for (let s = n.length - 1; s >= 0; s--) {
          ...
          if (
            e.name == 'Blockquote' &&
            (i = /^ *>( ?)/.exec(l.text.slice(o)))
          ) {
            r.push(new tt(e, o, o + i[0].length, '', i[1], '>', null));
          } else if (
            e.name == 'ListItem' &&
            e.parent.name == 'OrderedList' &&
            (i = /^( *)\d+([.)])( *)/.exec(l.text.slice(o)))
          ) {
            let t = i[3],
              n = i[0].length;
            if (t.length >= 4) {
            ...
            r.push(new tt(e.parent, o, o + n, i[1], t, i[2], e));
          } else if (
            e.name == 'ListItem' &&
            e.parent.name == 'BulletList' &&
            (i = /^( *)([-+*])( {1,4}\[[ xX]\])?( +)/.exec(l.text.slice(o)))
          ) {
            let t = i[4],
              n = i[0].length;
            if (t.length > 4) {
            ...
            r.push(new tt(e.parent, o, o + n, i[1], t, s, e));
          }
        }
        return r;
      }
      ...
      const lt = ({ state: e, dispatch: t }) => {
        ...
        let l = null,
          o = e.changeByRange((t) => {
            if (!t.empty || !Ye.isActiveAt(e, t.from, 0))
              return (l = { range: t });
            let i = t.from,
              o = s.lineAt(i);
            let a = nt(n.resolveInner(i, -1), s);
            while (a.length && a[a.length - 1].from > i - o.from) a.pop();
            if (!a.length) return (l = { range: t });
            let h = a[a.length - 1];
            if (h.to - h.spaceAfter.length > i - o.from)
              return (l = { range: t });
            let f =
              i >= h.to - h.spaceAfter.length && !/\S/.test(o.text.slice(h.to));
            if (h.item && f) {
              ...
              if (
                t.to >= i ||
                (n && n.to < i) ||
                (o.from > 0 && !/[^\s>]/.test(s.lineAt(o.from - 1).text))
              ) {
                ...
                if (h.node.name == 'OrderedList') st(h.item, s, l, -2);
                if (e && e.node.name == 'OrderedList') st(e.item, s, l);
                return {
                  range: r.EditorSelection.cursor(t + n.length),
                  changes: l
                };
              } else {
                let t = ht(a, e, o);
                return {
                  range: r.EditorSelection.cursor(i + t.length + 1),
            ...
            let u = [];
            if (h.node.name == 'OrderedList') st(h.item, s, u);
              ...
              for (let e = 0, t = a.length - 1; e <= t; e++) {
                d +=
                  e == t && !c
                    ...
                    : a[e].blank(
                        e < t
                          ? (0, r.countColumn)(o.text, 4, a[e + 1].from) -
                              d.length
                          : null
                      );
              }
            ...
            d = it(d, e);
            if (at(h.node, e.doc)) d = ht(a, e, o) + e.lineBreak + d;
            u.push({ from: p, to: i, insert: e.lineBreak + d });
            return {
              range: r.EditorSelection.cursor(p + d.length + 1),
              changes: u
            };
          });
        if (l) return false;
          ...
          s += e[i].blank(
            i < l
              ? (0, r.countColumn)(
                  n.text,
                  4,
                  Math.min(n.text.length, e[i + 1].from)
                ) - s.length
              : null,
            i < l
          );
      ...
      const ut = ({ state: e, dispatch: t }) => {
        ...
        let s = null,
          l = e.changeByRange((t) => {
            let i = t.from,
              { doc: l } = e;
            if (t.empty && Ye.isActiveAt(e, t.from)) {
              let t = l.lineAt(i);
              let s = nt(ft(n, i), l);
              if (s.length) {
                let n = s[s.length - 1];
                ...
                if (i - t.from > l && !/\S/.test(t.text.slice(l, i - t.from)))
                  return {
                    range: r.EditorSelection.cursor(t.from + l),
                    changes: { from: t.from + l, to: i }
                  };
                if (
                  i - t.from == l &&
                  (!n.item ||
                  ...
                  if (
                    ...
                    let i = n.blank(
                      (0, r.countColumn)(t.text, 4, n.to) -
                        (0, r.countColumn)(t.text, 4, n.from)
                    );
                    if (s == t.from) i = it(i, e);
                    return {
                      range: r.EditorSelection.cursor(s + i.length),
                      changes: { from: s, to: t.from + n.to, insert: i }
                    };
                  }
                  if (s < i)
                    return {
      ...
      const ct = [
        { key: 'Enter', run: lt },
        { key: 'Backspace', run: ut }
      ];
      const dt = (0, Fe.html)({ matchClosingTags: false });
      function pt(e = {}) {
        let {
          codeLanguages: t,
          ...
          addKeymap: l = true,
          base: { parser: o } = Je,
          completeHTMLTags: a = true,
          htmlTagLanguage: h = dt
        } = e;
        if (!(o instanceof F))
          throw new RangeError(
            'Base parser provided to `markdown` should be a Markdown parser'
          );
        let f = e.extensions ? [e.extensions] : [];
        let u = [h.support],
          c;
        ...
        let d = t || c ? et(t, c) : undefined;
        f.push(xe({ codeParser: d, htmlParser: h.language.parser }));
        if (l) u.push(r.Prec.high(s.keymap.of(ct)));
        let p = Ke(o.configure(f));
        if (a) u.push(p.data.of({ autocomplete: gt }));
        return new i.LanguageSupport(p, u);
      }
      function gt(e) {
        let { state: t, pos: n } = e,
      ...
      function kt() {
        if (mt) return mt;
        let e = (0, Fe.htmlCompletionSource)(
          new l._5(r.EditorState.create({ extensions: dt }), 0, true)
        );
        return (mt = e ? e.options : []);
      }
    }
  }
]);
