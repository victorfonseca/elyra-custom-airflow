  ...
  [8855],
  {
    /***/ 88855: /***/ (
      ...
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        ...
        /* harmony export */ q7: () =>
          /* binding */ stateRenderer_v3_unified_default,
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        (parsedItem, defaultDir = DEFAULT_NESTED_DOC_DIR) => {
          if (!parsedItem.doc) {
            return defaultDir;
          }
          let dir = defaultDir;
        ...
        (
          ...
          if (itemId !== 'root') {
            ...
            if (parsedItem.description) {
              ...
              newNode.description =
                _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .common_default */.Y2.sanitizeTextOrArray(
                  newNode.description,
                  (0,
                  _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig2 */.D7)()
                );
      ...
      var StateDB = class {
            ...
            if (node.doc) {
              ...
              if (doc.length > 0 && currentDoc.length > 0) {
                const newNode = {
                  stmt: STMT_STATE,
                  id: (0,
                  _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .generateId */.$C)(),
                  type: 'divider',
        ...
        extract(_doc) {
          ...
          this.clear(true);
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .log */.Rm.info(
            'Extract initial document:',
            doc
          );
          doc.forEach((item) => {
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .log */.Rm.warn(
              'Statement',
              item.stmt
            );
            switch (item.stmt) {
        ...
        addState(
          ...
          if (styles) {
            ...
            stylesList.forEach((style) =>
              this.setStyle(trimmedId, style.trim())
            );
          }
          if (textStyles) {
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .log */.Rm.info(
            ...
            const textStylesList =
              typeof textStyles === 'string' ? [textStyles] : textStyles;
        ...
        getDirection() {
          return (
            this.getDirectionStatement()?.value ?? DEFAULT_DIAGRAM_DIRECTION
          );
        }
        setDirection(dir) {
...
//# sourceMappingURL=8855.849c17b933e77def27c9.js.map?v=849c17b933e77def27c9
