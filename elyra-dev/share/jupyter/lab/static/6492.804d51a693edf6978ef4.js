  ...
  [6492],
  {
    46492: (e, t, a) => {
      ...
      a.d(t, {
        ...
        SQLite: () => ze,
        StandardSQL: () => we,
        keywordCompletionSource: () => ye,
        schemaCompletionSource: () => ke,
        sql: () => Oe
      });
      var n = a(4452);
      var i = a.n(n);
      ...
      function j(e) {
        return (
          (e >= 65 && e <= 90) || (e >= 97 && e <= 122) || (e >= 48 && e <= 57)
        );
      }
      function B(e) {
        return (
        ...
        e: for (;;) {
          ...
          if (e.next == 36) {
            ...
            for (let a = 0; a < t.length; a++) {
              if (e.next != t.charCodeAt(a)) continue e;
              e.advance();
            }
            if (e.next == 36) {
              e.advance();
      ...
      function A(e, t) {
        for (let a = 0; a < t.length; a++)
          if (t.charCodeAt(a) == e) return true;
        return false;
      }
      const E = ' \t\r\n';
      function W(e, t, a) {
        ...
        n['true'] = n['false'] = f;
        n['null'] = n['unknown'] = g;
        for (let i of e.split(' ')) if (i) n[i] = P;
        for (let i of t.split(' ')) if (i) n[i] = T;
        for (let i of (a || '').split(' ')) if (i) n[i] = X;
        return n;
      }
      const G =
      ...
      function K(e, t, a, n) {
        let i = {};
        for (let r in Y) i[r] = (e.hasOwnProperty(r) ? e : Y)[r];
        if (t) i.words = W(t, a || '', n);
        return i;
      }
      function F(e) {
        return new o.Lu((t) => {
          ...
          if (A(n, E)) {
            ...
            D(t, false);
            t.acceptToken(p);
          } else if (A(n, e.operatorChars)) {
            while (A(t.next, e.operatorChars)) t.advance();
            t.acceptToken(w);
          } else if (A(n, e.specialVar)) {
            if (t.next == n) t.advance();
            N(t);
            t.acceptToken(C);
          } else if (A(n, e.identifierQuotes)) {
            I(t, n, false);
            t.acceptToken(q);
          } else if (n == 58 || n == 44) {
            t.acceptToken(Q);
          } else if (j(n)) {
            let i = Z(t, String.fromCharCode(n));
            t.acceptToken(
              t.next == 46 || t.peek(-i.length - 1) == 46
                ? S
                : (a = e.words[i.toLowerCase()]) !== null && a !== void 0
                  ? a
                  : S
            );
          }
      ...
      function re(e, t) {
        ...
        if (
          ...
          return {
            ...
            quoted:
              a.name == 'QuotedIdentifier'
                ? e.doc.sliceString(a.from, a.from + 1)
                : null,
            parents: ie(e.doc, ee(a)),
            aliases: i
          };
        }
        if (a.name == '.') {
          return { from: t, quoted: null, parents: ie(e.doc, a), aliases: i };
        } else {
          return {
            from: t,
            quoted: null,
      ...
      function oe(e, t) {
        let a;
        for (let i = t; !a; i = i.parent) {
          if (!i) return null;
          if (i.name == 'Statement') a = i;
        }
        let n = null;
        for (let i = a.firstChild, r = false, s = null; i; i = i.nextSibling) {
          let t =
            i.name == 'Keyword'
              ? e.sliceString(i.from, i.to).toLowerCase()
              : null;
          let a = null;
          if (!r) {
            r = t == 'from';
          } else if (t == 'as' && s && ae(i.nextSibling)) {
            a = te(e, i.nextSibling);
          } else if (t && se.has(t)) {
            break;
          } else if (s && ae(i)) {
            a = te(e, i);
          ...
          s = /Identifier$/.test(i.name) ? i : null;
        }
        return n;
      }
      function le(e, t) {
        ...
        return t.map((t) =>
          Object.assign(Object.assign({}, t), {
            label: t.label[0] == e ? t.label : e + t.label + e,
            apply: undefined
          })
        );
      }
      ...
      class me {
        ...
        child(e) {
          ...
          let a = t[e];
          if (a) return a;
          if (e && !this.list.some((t) => t.label == e))
            this.list.push(pe(e, 'type', this.idQuote, this.idCaseInsensitive));
          return (t[e] = new me(this.idQuote, this.idCaseInsensitive));
        }
        maybeChild(e) {
        ...
        addCompletions(e) {
          for (let t of e)
            this.addCompletion(
              typeof t == 'string'
                ? pe(t, 'property', this.idQuote, this.idCaseInsensitive)
                : t
            );
        }
        addNamespace(e) {
        ...
        addNamespaceObject(e) {
          for (let t of Object.keys(e)) {
            ...
            for (let e = 0; e < i.length; e++) {
              if (n && e == i.length - 1) r.addCompletion(n);
              r = r.child(i[e].replace(/\\\./g, '.'));
            }
            r.addNamespace(a);
          }
        }
      ...
      function pe(e, t, a, n) {
        if (new RegExp('^[a-z_][a-z_\\d]*$', n ? 'i' : '').test(e))
          return { label: e, type: t };
      ...
      function fe(e, t, a, n, i, r) {
        ...
        let o =
          ((s =
            r === null || r === void 0 ? void 0 : r.spec.identifierQuotes) ===
            null || s === void 0
            ? void 0
            : s[0]) || '"';
        let l = new me(
          ...
          !!(r === null || r === void 0
            ? void 0
            : r.spec.caseInsensitiveIdentifiers)
        );
        let c = i ? l.child(i) : null;
        l.addNamespace(e);
        ...
        return (e) => {
          ...
          let d = i && e.state.sliceDoc(e.pos, e.pos + 1) == i;
          let u = o.list;
          if (o == l && s)
            u = u.concat(
              Object.keys(s).map((e) => ({ label: e, type: 'constant' }))
            );
          return {
            from: a,
            to: d ? e.pos + 1 : undefined,
            options: le(i, u),
            validFor: i ? de : ce
          };
        };
      ...
      function ge(e) {
        return e == T ? 'type' : e == P ? 'keyword' : 'variable';
      }
      function he(e, t, a) {
        let n = Object.keys(e).map((n) => a(t ? n.toUpperCase() : n, ge(e[n])));
        return (0, l.Ar)(
          [
            'QuotedIdentifier',
            'SpecialVar',
      ...
      let be = J.configure({
        props: [
          ...
          (0, r.styleTags)({
            Keyword: r.tags.keyword,
            Type: r.tags.typeName,
            Builtin: r.tags.standard(r.tags.name),
            Bits: r.tags.number,
            Bytes: r.tags.string,
            Bool: r.tags.bool,
            Null: r.tags.null,
            Number: r.tags.number,
            String: r.tags.string,
            Identifier: r.tags.name,
            QuotedIdentifier: r.tags.special(r.tags.string),
            SpecialVar: r.tags.special(r.tags.name),
            LineComment: r.tags.lineComment,
            BlockComment: r.tags.blockComment,
            Operator: r.tags.operator,
            'Semi Punctuation': r.tags.punctuation,
            '( )': r.tags.paren,
            '{ }': r.tags.brace,
      ...
      class _e {
        ...
        static define(e) {
          ...
          let a = n.LRLanguage.define({
            name: 'sql',
            parser: be.configure({ tokenizers: [{ from: H, to: F(t) }] }),
            languageData: {
      ...
      function ye(e, t = false, a) {
        return he(e.dialect.words, t, a || ve);
      }
      function ke(e) {
        return e.schema
          ? fe(
      ...
      function xe(e) {
        return e.schema
          ? (e.dialect || we).language.data.of({ autocomplete: ke(e) })
          : [];
      }
      function Oe(e = {}) {
        let t = e.dialect || we;
        return new n.LanguageSupport(t.language, [
          xe(e),
          t.language.data.of({
            autocomplete: ye(t, e.upperCaseKeywords, e.keywordCompletion)
          })
        ]);
      }
      const we = _e.define({});
