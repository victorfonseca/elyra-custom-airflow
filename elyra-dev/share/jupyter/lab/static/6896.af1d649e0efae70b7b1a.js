  ...
  [6896],
  {
    ...
    68182: (e, t, r) => {
      ...
      const f = (e, t = { keywords: true }) => {
        ...
        const [r, o] =
          t.mode === 'fast' ? [a.fastFormats, s] : [a.fullFormats, i];
      ...
      function d(e, t, r, a) {
        var n;
        var i;
        (n = (i = e.opts.code).formats) !== null && n !== void 0
          ? n
          : (i.formats = o._`require("ajv-formats/dist/formats").${a}`);
        ...
        code(e) {
          ...
          function l() {
            ...
            e.fail$data(
              n.or(
                n._`typeof ${a} != "object"`,
                n._`${a} instanceof RegExp`,
                n._`typeof ${a}.compare != "function"`,
                h(a)
              )
            );
          }
          function m() {
            ...
            if (
              ...
              throw new Error(
                `"${s}": format "${r}" does not define "compare" function`
              );
            }
            const o = t.scopeValue('formats', {
              ...
              ref: a,
              code: d.code.formats
                ? n._`${d.code.formats}${n.getProperty(r)}`
                : undefined
            });
            e.fail$data(h(o));
          }
