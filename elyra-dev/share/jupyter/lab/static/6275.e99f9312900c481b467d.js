  ...
  [6275],
  {
    ...
    36528: function (t, e, r) {
      ...
      var s = (function (t) {
        ...
        e.defaults = o(o({}, i.AbstractMmlNode.defaults), {
          actiontype: 'toggle',
          selection: 1
        });
        return e;
    ...
    54453: function (t, e, r) {
      ...
      var a = (function (t) {
        ...
        e.prototype.setChildInheritedAttributes = function (e, r, n, o) {
          ...
          try {
            for (
              var l = i([this.open, this.close].concat(this.separators)),
                u = l.next();
              !u.done;
              u = l.next()
            ) {
        ...
        e.prototype.addFakeNodes = function () {
          ...
          if (a) {
            ...
            try {
              for (
                var u = i(this.childNodes.slice(1)), c = u.next();
                !c.done;
                c = u.next()
              ) {
                var f = c.value;
    ...
    74502: function (t, e, r) {
      ...
      var a = (function (t) {
        ...
        e.prototype.setTeXclass = function (t) {
          ...
          try {
            for (
              var n = i(this.childNodes), o = n.next();
              !o.done;
              o = n.next()
            ) {
              var s = o.value;
        ...
        e.defaults = o(o({}, s.AbstractMmlBaseNode.defaults), {
    ...
    64906: function (t, e, r) {
      ...
      var s = (function (t) {
        ...
        e.defaults = o(o({}, i.AbstractMmlTokenNode.defaults), {
          alt: '',
          src: '',
          index: '',
          width: 'auto',
      ...
      var a = (function (t) {
        ...
        Object.defineProperty(e.prototype, 'isSpacelike', {
          get: function () {
            ...
            try {
              for (
                var r = i(this.childNodes), n = r.next();
                !n.done;
                n = r.next()
              ) {
                var o = n.value;
        ...
        e.prototype.setTeXclass = function (t) {
          ...
          if (
            ...
            try {
              for (
                var a = i(this.childNodes), l = a.next();
                !l.done;
                l = a.next()
              ) {
                var u = l.value;
            ...
            try {
              for (
                var c = i(this.childNodes), f = c.next();
                !f.done;
                f = c.next()
              ) {
                var u = f.value;
    ...
    7840: function (t, e, r) {
      ...
      var l = (function (t) {
        ...
        e.prototype.setInheritedAttributes = function (e, r, n, o) {
          ...
          try {
            for (
              var u = i(s.indentAttributes), c = u.next();
              !c.done;
              c = u.next()
            ) {
              var f = c.value;
        ...
        e.prototype.setChildInheritedAttributes = function (t, e, r, n) {
          ...
          try {
            for (
              var y = i(this.childNodes), b = y.next();
              !b.done;
              b = y.next()
            ) {
              var p = b.value;
    ...
    79516: function (t, e, r) {
      ...
      var u = (function (t) {
        ...
        e.prototype.setChildInheritedAttributes = function (t, e, r, n) {
          ...
          try {
            for (
              var d = i(this.childNodes), y = d.next();
              !y.done;
              y = d.next()
            ) {
              var p = y.value;
      ...
      var n =
        ...
        function (t, e) {
          ...
          var n = r.call(t),
            ...
            s;
          try {
            while ((e === void 0 || e-- > 0) && !(o = n.next()).done)
              i.push(o.value);
          } catch (a) {
            s = { error: a };
          } finally {
