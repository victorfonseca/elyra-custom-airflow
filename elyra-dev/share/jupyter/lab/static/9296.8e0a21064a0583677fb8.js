    ...
    /***/ 49296: /***/ (
      ...
      __webpack_require__.d(__webpack_exports__, {
        ...
        highlightActiveLineGutter: () =>
          /* binding */ highlightActiveLineGutter,
        highlightSpecialChars: () => /* binding */ highlightSpecialChars,
        highlightTrailingWhitespace: () =>
          /* binding */ highlightTrailingWhitespace,
      ...
      var index_js_ = __webpack_require__(71674);
      // EXTERNAL MODULE: consume shared module (default) style-mod@^4.0.0 (strict) (fallback: ./node_modules/style-mod/src/style-mod.js)
      var style_mod_js_ = __webpack_require__(23546); // CONCATENATED MODULE: ./node_modules/w3c-keyname/index.es.js
      var base = {
        8: 'Backspace',
        9: 'Tab',
        10: 'Enter',
      ...
      function getRoot(node) {
        while (node) {
          if (
            node &&
            (node.nodeType == 9 || (node.nodeType == 11 && node.host))
          )
            return node;
      ...
      const dist_gecko =
        !dist_ie && /*@__PURE__*/ /gecko\/(\d+)/i.test(nav.userAgent);
      const dist_chrome =
        !dist_ie && /*@__PURE__*/ /Chrome\/(\d+)/.exec(nav.userAgent);
      const webkit = 'webkitFontSmoothing' in doc.documentElement.style;
      const safari =
        !dist_ie && /*@__PURE__*/ /Apple Computer/.test(nav.vendor);
      const ios =
        safari &&
      ...
      class MarkView extends ContentView {
        ...
        reuseDOM(node) {
          if (node.nodeName == this.mark.tagName.toUpperCase()) {
            this.setDOM(node);
            this.flags |=
              4 /* ViewFlag.AttrsDirty */ | 2 /* ViewFlag.NodeDirty */;
          }
        }
        sync(view, track) {
          if (!this.dom)
      ...
      class WidgetView extends ContentView {
        ...
        merge(from, to, source, hasStart, openStart, openEnd) {
          if (
            ...
            return false;
          this.length =
            from + (source ? source.length : 0) + (this.length - to);
          return true;
        }
        become(other) {
          if (
        ...
        get overrideDOMText() {
          if (this.length == 0) return index_js_.Text.empty;
          let top = this;
      ...
      function coordsInChildren(view, pos, side) {
        ...
        function scan(view, pos) {
          for (
            let i = 0, off = 0;
            i < view.children.length && off <= pos;
            i++
          ) {
...
*/
      ...
      class PointDecoration extends Decoration {
        constructor(spec, startSide, endSide, block, widget, isReplace) {
          ...
          this.mapMode = !block
            ? index_js_.MapMode.TrackDel
            : startSide <= 0
              ? index_js_.MapMode.TrackBefore
              : index_js_.MapMode.TrackAfter;
        }
      ...
      class ContentBuilder {
        ...
        static build(text, from, to, decorations, dynamicDecorationMap) {
          ...
          builder.openEnd = index_js_.RangeSet.spans(
            decorations,
            from,
            to,
            builder
...
*/
    ...
    */
      ...
      function moveVisually(line, order, dir, start, forward) {
        ...
        let nextIndex = (0, index_js_.findClusterBreak)(
          line.text,
          startIndex,
        ...
        if (
          ...
          return index_js_.EditorSelection.cursor(
      ...
      class ScrollTarget {
        ...
        clip(state) {
          return this.range.to <= state.doc.length
            ? this
            : new ScrollTarget(
                index_js_.EditorSelection.cursor(state.doc.length),
                this.y,
                this.x,
                this.yMargin,
                this.xMargin,
      ...
      const scrollIntoView = /*@__PURE__*/ index_js_.StateEffect.define({
        map: (t, ch) => t.map(ch)
      });
      const setEditContextFormatting =
        /*@__PURE__*/ index_js_.StateEffect.define();
      /**
...
*/
      ...
      const editable = /*@__PURE__*/ index_js_.Facet.define({
    ...
    */
      ...
      class PluginInstance {
        ...
        destroy(view) {
          var _a;
          if (
            (_a = this.value) === null || _a === void 0 ? void 0 : _a.destroy
          ) {
            try {
              this.value.destroy();
            } catch (e) {
...
*/
    ...
    */
        get geometryChanged() {
          return (
            this.docChanged ||
            (this.flags &
              (16 /* UpdateFlag.Geometry */ | 2)) /* UpdateFlag.Height */ >
              0
          );
        }
        /**
    ...
    */
          ...
          if (
            ...
            this.view.observer.ignore(() => {
              ...
              if (!rawSel);
                ...
                if (
                  main.bidiLevel != null &&
                  rawSel.caretBidiLevel !== undefined
                )
      ...
      function groupAt(state, pos, bias = 1) {
        ...
        if (line.length == 0) return index_js_.EditorSelection.cursor(pos);
        if (linePos == 0) bias = 1;
        ...
        else to = (0, index_js_.findClusterBreak)(line.text, linePos);
        ...
        return index_js_.EditorSelection.range(
          from + line.from,
          to + line.from
        );
      }
      ...
      function posAtCoordsImprecise(view, contentRect, block, x, y) {
        ...
        return (
          block.from +
          (0, index_js_.findColumn)(content, into, view.state.tabSize)
        );
      }
      ...
      function byGroup(view, pos, start) {
        ...
        return (next) => {
          ...
          if (cat == index_js_.CharCategory.Space) cat = nextCat;
          return cat == nextCat;
        };
      }
      ...
      function skipAtoms(view, oldPos, pos) {
        ...
        return newPos == pos.from
          ? pos
          : index_js_.EditorSelection.cursor(
              newPos,
              newPos < pos.from ? 1 : -1
            );
      }
      ...
      function applyDOMChange(view, domChange) {
        ...
        if (
          ...
          if (newSel && change.insert.length == 2)
            newSel = index_js_.EditorSelection.single(
            ...
            tr = startState.changeByRange((range) => {
              ...
              return {
                ...
                range: !mainSel
                  ...
                  : index_js_.EditorSelection.range(
      ...
      function selectionFromPoints(points, base) {
        ...
        return anchor > -1 && head > -1
          ? index_js_.EditorSelection.single(anchor + base, head + base)
          : null;
      }
      ...
      function computeHandlers(plugins) {
        ...
        function record(type) {
          return (
            result[type] || (result[type] = { observers: [], handlers: [] })
          );
        }
      ...
      class MouseSelection {
        constructor(view, startEvent, style, mustSelect) {
          ...
          this.multiple =
            view.state.facet(index_js_.EditorState.allowMultipleSelections) &&
        ...
        skipAtoms(sel) {
          ...
          for (let i = 0; i < sel.ranges.length; i++) {
            ...
            if (range.empty) {
              ...
              if (from != range.from || to != range.to)
                updated = index_js_.EditorSelection.range(
          ...
          return ranges
            ? index_js_.EditorSelection.create(ranges, sel.mainIndex)
            : sel;
        }
        select(event) {
          let { view } = this,
        ...
        if (linewise) {
          ...
          changes = state.changeByRange((range) => {
            ...
            return {
              ...
              range: index_js_.EditorSelection.cursor(
        ...
        return {
          ...
          get(event, extend, multiple) {
            ...
            if (start.pos != cur.pos && !extend) {
              ...
              range =
                from < range.from
                  ? index_js_.EditorSelection.range(from, to)
                  : index_js_.EditorSelection.range(to, from);
            }
            if (extend)
            ...
            else return index_js_.EditorSelection.create([range]);
          }
        };
      }
      function removeRangeAround(sel, pos) {
        for (let i = 0; i < sel.ranges.length; i++) {
          ...
          if (from <= pos && to >= pos)
            return index_js_.EditorSelection.create(
      ...
      class HeightOracle {
        ...
        mustRefreshForWrapping(whiteSpace) {
          return (
            wrappingWhiteSpace.indexOf(whiteSpace) > -1 != this.lineWrapping
          );
        }
    ...
    */
      ...
      class HeightMapGap extends HeightMap {
        ...
        lineAt(value, type, oracle, top, offset) {
          ...
          let { firstLine, perLine, perChar } = this.heightMetrics(
            oracle,
            offset
          );
      ...
      class ViewState {
        constructor(state) {
          ...
          let guessWrapping = state
            ...
            .some(
              (v) => typeof v != 'function' && v.class == 'cm-lineWrapping'
            );
        ...
        update(update, scrollTarget = null) {
          ...
          let heightChanges = ChangedRange.extendWithRanges(
            ...
            heightRelevantDecoChanges(
              ...
              update
                ? update.changes
                : index_js_.ChangeSet.empty(this.state.doc.length)
            )
          );
        ...
        measure(view) {
          ...
          let paddingBottom =
            (parseInt(style.paddingBottom) || 0) * this.scaleY;
          if (
        ...
        getViewport(bias, scrollTarget) {
          ...
          let marginTop =
            0.5 -
            Math.max(-0.5, Math.min(0.5, bias / 1000 /* VP.Margin */ / 2));
            ...
            if (!gap) {
              ...
              if (
                ...
                let lineStart = mayMeasure.moveToLineBoundary(
                  index_js_.EditorSelection.cursor(to),
                  false,
                  true
                ).head;
        ...
        computeVisibleRanges(changes) {
          ...
          if (ranges.length != this.visibleRanges.length) {
            changed =
              8 /* UpdateFlag.ViewportMoved */ | 4 /* UpdateFlag.Viewport */;
          } else {
            for (
              let i = 0;
              i < ranges.length &&
      ...
      const theme = /*@__PURE__*/ index_js_.Facet.define({
        combine: (strs) => strs.join(' ')
      });
      const darkTheme = /*@__PURE__*/ index_js_.Facet.define({
        combine: (values) => values.indexOf(true) > -1
      });
      const baseThemeID = /*@__PURE__*/ style_mod_js_.StyleModule.newName(),
        baseLightID = /*@__PURE__*/ style_mod_js_.StyleModule.newName(),
        baseDarkID = /*@__PURE__*/ style_mod_js_.StyleModule.newName();
      const lightDarkIDs = {
        '&light': '.' + baseLightID,
        '&dark': '.' + baseDarkID
      };
      ...
      class DOMObserver {
        ...
        delayAndroidKey(key, keyCode) {
          ...
          if (!this.delayedAndroidKey) {
            ...
            this.flushingAndroidKey =
              this.view.win.requestAnimationFrame(flush);
          }
        ...
        update(update) {
          if (this.editContext) {
            ...
            if (
              update.startState.facet(editable) != update.state.facet(editable)
            )
      ...
      class EditContextManager {
        constructor(view) {
          ...
          this.handlers.textupdate = (e) => {
            ...
            if (change.from == change.to && !change.insert.length) {
              let newSel = index_js_.EditorSelection.single(
            ...
            if (
              ...
              change = {
                from,
                to,
                insert: index_js_.Text.of([e.text.replace('.', ' ')])
              };
            ...
            if (!view.state.readOnly) {
              ...
              applyDOMChangeInner(
                view,
                change,
                index_js_.EditorSelection.single(
          ...
          update.changes.iterChanges((fromA, toA, _fromB, _toB, insert) => {
            ...
            if (toA <= this.from) {
              ...
              if (
                fromA < this.from ||
                toA > this.to ||
                this.to - this.from + insert.length > 30000 /* CxVp.MaxSize */
              ) {
                abort = true;
                return;
              }
        ...
        rangeIsValid(state) {
          let { head } = state.selection.main;
          return !(
            (this.from > 0 && head - this.from < 500) /* CxVp.MinMargin */ ||
            (this.to < state.doc.length &&
              this.to - head < 500) /* CxVp.MinMargin */ ||
...
*/
    ...
    */
        ...
        */
          ...
          this.viewState = new ViewState(
            config.state || index_js_.EditorState.create(config)
          );
          ...
          this.requestMeasure();
          if (
            (_a = document.fonts) === null || _a === void 0 ? void 0 : _a.ready
          )
            document.fonts.ready.then(() => this.requestMeasure());
        }
        dispatch(...input) {
          let trs =
            input.length == 1 && input[0] instanceof index_js_.Transaction
              ? input
    ...
    */
        update(transactions) {
          ...
          if (
            state.facet(index_js_.EditorState.phrases) !=
            this.state.facet(index_js_.EditorState.phrases)
          )
    ...
    */
        ...
        mountStyles() {
          ...
          style_mod_js_.StyleModule.mount(
            this.root,
    ...
    */
        static scrollIntoView(pos, options = {}) {
          return scrollIntoView.of(
            new ScrollTarget(
              typeof pos == 'number'
                ? index_js_.EditorSelection.cursor(pos)
                : pos,
              options.y,
              options.x,
              options.yMargin,
    ...
    */
        scrollSnapshot() {
          ...
          return scrollIntoView.of(
            new ScrollTarget(
              index_js_.EditorSelection.cursor(ref.from),
              'start',
              'start',
              ref.top - scrollTop,
              scrollLeft,
...
*/
      EditorView.cspNonce = /*@__PURE__*/ index_js_.Facet.define({
...
*/
      ...
      const handleKeyEvents = /*@__PURE__*/ index_js_.Prec.default(
...
*/
      const keymap = /*@__PURE__*/ index_js_.Facet.define({
...
*/
      ...
      function runHandlers(map, event, view, scope) {
        ...
        let charCode = (0, index_js_.codePointAt)(name, 0),
          isChar =
            (0, index_js_.codePointSize)(charCode) == name.length &&
            name != ' ';
        let prefix = '',
          handled = false,
          prevented = false,
...
*/
      ...
      const selectionConfig = /*@__PURE__*/ index_js_.Facet.define({
        combine(configs) {
          return (0, index_js_.combineConfig)(
            configs,
            {
...
*/
      ...
      const hideNativeSelection = /*@__PURE__*/ index_js_.Prec.highest(
        ...
        class {
          ...
          readPos() {
            ...
            return {
              ...
              top:
                rect.top - outer.top + view.scrollDOM.scrollTop * view.scaleY,
              height: rect.bottom - rect.top
            };
          }
          drawCursor(pos) {
...
*/
    ...
    */
        createDeco(view) {
          let build = new index_js_.RangeSetBuilder(),
            ...
            if (to > from) {
              ...
              if (fromLine == toLine) {
                ...
                iterMatches(
                  ...
                  (from, m) => this.addMatch(m, view, from, add)
                );
              }
              deco = deco.update({
                filterFrom: start,
...
*/
      ...
      const dist_plugin = /*@__PURE__*/ ViewPlugin.fromClass(
        class {
          constructor() {
            this.height = 1000;
...
*/
      ...
      function rectangleFor(state, a, b) {
        ...
        if (a.off > MaxOff || b.off > MaxOff || a.col < 0 || b.col < 0) {
          ...
          for (let i = startLine; i <= endLine; i++) {
            let line = state.doc.line(i);
            let start = (0, index_js_.findColumn)(
              line.text,
              startCol,
              state.tabSize,
              true
            ...
            if (start < 0) {
              ...
              let end = (0, index_js_.findColumn)(
                line.text,
                endCol,
                state.tabSize
              );
      ...
      function rectangleSelectionStyle(view, event) {
        ...
        return {
          ...
          get(event, _extend, multiple) {
            ...
            else return index_js_.EditorSelection.create(ranges);
          }
        };
      }
      /**
      ...
      class HoverPlugin {
        ...
        mouseleave(event) {
          ...
          if (active.length) {
            let { tooltip } = this;
            let inTooltip =
              tooltip && tooltip.dom.contains(event.relatedTarget);
            if (!inTooltip)
              this.view.dispatch({ effects: this.setHover.of([]) });
...
*/
      ...
      const gutterView = /*@__PURE__*/ ViewPlugin.fromClass(
        class {
          ...
          syncGutters(detach) {
            ...
            let lineClasses = index_js_.RangeSet.iter(
      ...
      class UpdateContext {
        ...
        widget(view, block) {
          let marker = this.gutter.config.widgetMarker(
              view,
              block.widget,
              block
            ),
      ...
      class SingleGutterView {
        ...
        update(update) {
          ...
          return (
            !index_js_.RangeSet.eq(this.markers, prevMarkers, vp.from, vp.to) ||
...
//# sourceMappingURL=9296.8e0a21064a0583677fb8.js.map?v=8e0a21064a0583677fb8
