    ...
    /***/ 62590: /***/ (
      ...
      __webpack_require__.d(__webpack_exports__, {
        ...
        AttachedBehaviorHTMLDirective: () =>
          /* reexport */ AttachedBehaviorHTMLDirective,
      ...
      class PropertyChangeNotifier {
        ...
        subscribe(subscriber, propertyToWatch) {
          ...
          if (propertyToWatch) {
            ...
            if (subscribers === void 0) {
              this.subscribers[propertyToWatch] = subscribers =
       ...
       * @public
       */
      const defaultExecutionContext = Object.seal(new ExecutionContext()); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-element/dist/esm/templating/html-directive.js
       ...
       */
      FASTElementDefinition.forType = fastRegistry.getByType; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-element/dist/esm/components/controller.js
      ...
      class Controller extends PropertyChangeNotifier {
        ...
        addStyles(styles) {
          const target =
            getShadowRoot(this.element) || this.element.getRootNode();
        ...
        addBehaviors(behaviors) {
          const targetBehaviors =
            this.behaviors || (this.behaviors = new Map());
        ...
        static forCustomElement(element) {
          ...
          return (element.$fastController = new Controller(
            element,
            definition
          ));
        }
      ...
      function collectStyles(strings, values) {
        ...
        for (let i = 0, ii = strings.length - 1; i < ii; ++i) {
          ...
          if (
            value instanceof ElementStyles ||
          ...
          if (intersectCount >= 0) {
            ...
            if (!splice.addedCount && !deleteCount) {
              ...
              if (splice.index < current.index) {
                ...
                const prepend = splice.removed.slice(
                  0,
       ...
       * @public
       */
      const isFunction = (object) => typeof object === 'function'; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-element/dist/esm/templating/when.js
          ...
          for (let i = 0, ii = splices.length; i < ii; ++i) {
            ...
            for (; addIndex < end; ++addIndex) {
              ...
              if (recycle && availableViews > 0) {
                if (
                  removeIndex <= totalAvailableViews &&
      ...
      class RepeatDirective extends HTMLDirective {
        ...
        constructor(itemsBinding, templateBinding, options) {
          ...
          this.isItemsBindingVolatile =
            Observable.isVolatileBinding(itemsBinding);
      ...
      function repeat(
        ...
        return new RepeatDirective(
          itemsBinding,
          templateBinding,
          Object.assign(Object.assign({}, defaultRepeatOptions), options)
        );
      ...
      class ChildrenBehavior extends NodeObservationBehavior {
        ...
        getNodes() {
          if ('subtree' in this.options) {
            return Array.from(
              this.target.querySelectorAll(this.options.selector)
            );
          }
