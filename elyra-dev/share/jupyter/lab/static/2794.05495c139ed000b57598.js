        ...
        return l().createElement(
          'jp-anchored-region',
          {
            ...
            'horizontal-positioning-mode':
              e.horizontalPositioningMode || e['horizontal-positioning-mode'],
            'horizontal-default-position':
              e.horizontalDefaultPosition || e['horizontal-default-position'],
            'horizontal-threshold':
              e.horizontalThreshold || e['horizontal-threshold'],
            'horizontal-scaling':
              e.horizontalScaling || e['horizontal-scaling'],
            'vertical-positioning-mode':
              e.verticalPositioningMode || e['vertical-positioning-mode'],
            'vertical-default-position':
              e.verticalDefaultPosition || e['vertical-default-position'],
            'vertical-threshold':
              e.verticalThreshold || e['vertical-threshold'],
            ...
            part: e.part,
            tabindex: e.tabIndex,
            'horizontal-viewport-lock': e.horizontalViewportLock
              ? ''
              : undefined,
        ...
        return l().createElement(
          'jp-data-grid-row',
          {
            ...
            'grid-template-columns':
              e.gridTemplateColumns || e['grid-template-columns'],
      ...
      const X = (0, n.forwardRef)((e, t) => {
        ...
        return l().createElement(
          'jp-draft-picker',
          {
            ...
            'no-suggestions-text':
              e.noSuggestionsText || e['no-suggestions-text'],
            'suggestions-available-text':
              e.suggestionsAvailableText || e['suggestions-available-text'],
