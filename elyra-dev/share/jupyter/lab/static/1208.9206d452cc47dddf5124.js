  ...
  [1208],
  {
    /***/ 91208: /***/ (
      ...
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ DefaultBufferLength: () =>
          /* binding */ DefaultBufferLength,
        ...
        function divide(children, positions, from, to, offset) {
          for (let i = from; i < to; ) {
            ...
            if (i == groupFrom + 1) {
              ...
              let length =
                positions[i - 1] + children[i - 1].length - groupStart;
              localChildren.push(
                balanceRange(
                  balanceType,
                  children,
...
*/
      ...
      function materialize(cursor) {
        ...
        for (let index of newStack) {
          ...
          cursor.yield(
            new TreeNode(tree, pos + cursor.from, index, cursor._tree)
          );
        }
      }
...
//# sourceMappingURL=1208.9206d452cc47dddf5124.js.map?v=9206d452cc47dddf5124
