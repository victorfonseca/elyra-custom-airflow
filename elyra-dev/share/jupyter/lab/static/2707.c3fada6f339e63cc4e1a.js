...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [2707],
  {
    /***/ 59171: /***/ function (__unused_webpack_module, exports) {
      var __values =
        (this && this.__values) ||
        function (o) {
      ...
      var AbstractFactory = (function () {
        function AbstractFactory(nodes) {
          ...
          try {
            for (
              var _b = __values(Object.keys(nodes)), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var kind = _c.value;
        ...
        AbstractFactory.prototype.create = function (kind) {
          ...
          return (this.node[kind] || this.node[this.defaultKind]).apply(
            void 0,
        ...
        AbstractFactory.prototype.setNodeClass = function (kind, nodeClass) {
          ...
          this.node[kind] = function () {
            ...
            return new (KIND.bind.apply(
              KIND,
              __spreadArray([void 0, THIS], __read(args), false)
            ))();
          };
        };
    ...
    /***/ 55361: /***/ function (
      ...
      var NodeFactory = (function () {
        ...
        NodeFactory.prototype.create = function (kind) {
          ...
          var node = func.apply(
            void 0,
            __spreadArray([this, rest[0]], __read(rest.slice(1)), false)
          );
          if (kind === 'node') {
      ...
      (function (ParseMethods) {
        function variable(parser, c) {
          ...
          if (env.multiLetterIdentifiers && env.font !== '') {
            c = parser.string
              .substr(parser.i - 1)
              .match(env.multiLetterIdentifiers)[0];
            parser.i += c.length - 1;
            if (
              def.mathvariant ===
        ...
        function environment(parser, env, func, args) {
          ...
          mml = func.apply(
            void 0,
            __spreadArray([parser, mml], __read(args.slice(1)), false)
          );
          parser.Push(mml);
        }
    ...
    /***/ 24404: /***/ function (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      var StackItemFactory_js_1 = __importDefault(__webpack_require__(37564));
      ...
      var ParseOptions = (function () {
        function ParseOptions(configuration, options) {
          ...
          this.itemFactory = new StackItemFactory_js_1.default(
            configuration.items
          );
          this.itemFactory.configuration = this;
          Options_js_1.defaultOptions.apply(
            void 0,
            __spreadArray([this.options], __read(options), false)
          );
        ...
        ParseOptions.prototype.addNode = function (property, node) {
          ...
          if (node.kind !== property) {
            var inlists =
              NodeUtil_js_1.default.getProperty(node, 'in-lists') || '';
            var lists = (inlists ? inlists.split(/,/) : [])
              .concat(property)
              .join(',');
    ...
    /***/ 37720: /***/ function (
      ...
      var MmlStack = (function () {
        ...
        MmlStack.prototype.create = function (kind) {
          ...
          return (_a = this.factory.configuration.nodeFactory).create.apply(
            _a,
            __spreadArray([kind], __read(rest), false)
          );
        };
        return MmlStack;
      })();
      ...
      var BaseItem = (function (_super) {
        ...
        BaseItem.prototype.clearEnv = function () {
          ...
          try {
            for (
              var _b = __values(Object.keys(this.env)), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var id = _c.value;
    ...
    /***/ 37564: /***/ function (
      ...
      var StackItemFactory = (function (_super) {
        ...
        StackItemFactory.DefaultStackItems =
          ((_a = {}), (_a[DummyItem.prototype.kind] = DummyItem), _a);
    ...
    /***/ 80469: /***/ (__unused_webpack_module, exports) => {
      Object.defineProperty(exports, '__esModule', { value: true });
    ...
    /***/ 11252: /***/ function (
      ...
      var MapHandler_js_1 = __webpack_require__(18437);
      var TexError_js_1 = __importDefault(__webpack_require__(98770));
      var NodeUtil_js_1 = __importDefault(__webpack_require__(72691));
      var SymbolMap_js_1 = __webpack_require__(80209);
      var bitem = __importStar(__webpack_require__(94650));
      var Tags_js_1 = __webpack_require__(17782);
      __webpack_require__(69447);
      var OperatorDictionary_js_1 = __webpack_require__(56893);
      ...
      function filterNonscript(_a) {
        ...
        try {
          for (
            var _c = __values(data.getList('nonscript')), _d = _c.next();
            !_d.done;
            _d = _c.next()
          ) {
            var mml = _d.value;
      ...
      exports.BaseConfiguration = Configuration_js_1.Configuration.create(
        'base',
        {
          handler: {
    ...
    /***/ 94650: /***/ function (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.EquationItem =
        exports.EqnArrayItem =
        exports.ArrayItem =
        exports.DotsItem =
      ...
      var PrimeItem = (function (_super) {
        ...
        PrimeItem.prototype.checkItem = function (item) {
          var _a = __read(this.Peek(2), 2),
            ...
            top1 = _a[1];
          if (
            !NodeUtil_js_1.default.isType(top0, 'msubsup') ||
            NodeUtil_js_1.default.isType(top0, 'msup')
          ) {
      ...
      var SubsupItem = (function (_super) {
        ...
        SubsupItem.errors = Object.assign(
          Object.create(StackItem_js_1.BaseItem.errors),
          {
            stop: [
              'MissingScript',
        ...
        OverItem.prototype.checkItem = function (item) {
          ...
          if (item.isClose) {
            ...
            if (this.getProperty('open') || this.getProperty('close')) {
              ...
              mml = ParseUtil_js_1.default.fixedFence(
        ...
        FnItem.prototype.checkItem = function (item) {
          ...
          if (top) {
            ...
            if (!item.isKind('fn')) {
              ...
              if (
                (NodeUtil_js_1.default.isType(mml, 'mstyle') &&
                  mml.childNodes.length &&
                  NodeUtil_js_1.default.isType(
                    mml.childNodes[0].childNodes[0],
                    'mspace'
                  )) ||
        ...
        NonscriptItem.prototype.checkItem = function (item) {
          if (item.isKind('mml') && item.Size() === 1) {
            ...
            if (mml.isKind('mstyle') && mml.notParent) {
              mml = NodeUtil_js_1.default.getChildren(
                NodeUtil_js_1.default.getChildren(mml)[0]
              )[0];
            }
      ...
      var DotsItem = (function (_super) {
        ...
        DotsItem.prototype.checkItem = function (item) {
          ...
          if (item.isKind('mml') && NodeUtil_js_1.default.isEmbellished(top)) {
            var tclass = NodeUtil_js_1.default.getTexClass(
              NodeUtil_js_1.default.getCoreMO(top)
            );
            if (
              tclass === MmlNode_js_1.TEXCLASS.BIN ||
              tclass === MmlNode_js_1.TEXCLASS.REL
            ) {
      ...
      var ArrayItem = (function (_super) {
          ...
          if (this.hfill.length) {
            ...
            if (this.hfill[this.hfill.length - 1] === this.Size()) {
              NodeUtil_js_1.default.setAttribute(
                mtd,
                'columnalign',
                NodeUtil_js_1.default.getAttribute(mtd, 'columnalign')
                  ? 'center'
                  : 'left'
              );
            }
        ...
        ArrayItem.prototype.addRowSpacing = function (spacing) {
          if (this.arraydef['rowspacing']) {
            ...
            rows[this.table.length - 1] = ParseUtil_js_1.default.Em(
              Math.max(0, rowspacing + ParseUtil_js_1.default.dimen2em(spacing))
            );
            this.arraydef['rowspacing'] = rows.join(' ');
          }
        };
        ...
        EqnArrayItem.prototype.extendArray = function (name, max) {
          ...
          if (columns.length > 1) {
            while (columns.length < max) {
              columns.push.apply(
                columns,
                __spreadArray([], __read(repeat), false)
              );
            }
    ...
    /***/ 69447: /***/ function (
      ...
      new sm.RegExpMap(
        'command',
        ParseMethods_js_1.default.controlSequence,
        /^\\/
      );
      new sm.MacroMap(
        'special',
      ...
      new sm.CharacterMap(
        ...
        ParseMethods_js_1.default.mathchar0mo,
        {
          ...
          coprod: [
            '\u2210',
            { texClass: MmlNode_js_1.TEXCLASS.OP, movesupsub: true }
          ],
          bigvee: [
            '\u22C1',
            { texClass: MmlNode_js_1.TEXCLASS.OP, movesupsub: true }
      ...
      new sm.CommandMap(
        'macros',
        {
          ...
          bmod: [
            'Macro',
            '\\mmlToken{mo}[lspace="thickmathspace"' +
    ...
    /***/ 38364: /***/ function (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      var sitem = __importStar(__webpack_require__(94650));
      var NodeUtil_js_1 = __importDefault(__webpack_require__(72691));
      var TexError_js_1 = __importDefault(__webpack_require__(98770));
      ...
      BaseMethods.Tilde = function (parser, _c) {
        parser.Push(
          parser.create('token', 'mtext', {}, Entities_js_1.entities.nbsp)
        );
      };
      ...
      BaseMethods.Superscript = function (parser, _c) {
        ...
        var position = NodeUtil_js_1.default.isType(base, 'msubsup')
          ...
          : base.over;
        if (
          (NodeUtil_js_1.default.isType(base, 'msubsup') &&
      ...
      BaseMethods.Limits = function (parser, _name, limits) {
        ...
        if (
          !op ||
          (NodeUtil_js_1.default.getTexClass(
            NodeUtil_js_1.default.getCoreMO(op)
      ...
      function parseRoot(parser, n) {
        ...
        env['inRoot'] = true;
        var newParser = new TexParser_js_1.default(
          n,
          env,
          parser.configuration
        );
      ...
      BaseMethods.Accent = function (parser, name, accent, stretchy) {
        ...
        var def = __assign(
          __assign({}, ParseUtil_js_1.default.getFontDef(parser)),
          { accent: true, mathaccent: true }
        );
        ...
        var mo = NodeUtil_js_1.default.isEmbellished(c)
          ? NodeUtil_js_1.default.getCoreMO(c)
          : c;
        if (
          NodeUtil_js_1.default.isType(mo, 'mo') ||
      ...
      BaseMethods.UnderOver = function (parser, name, c, stack) {
        ...
        parser.Push(
          ParseUtil_js_1.default.underOver(parser, base, mo, pos, stack)
        );
      };
      ...
      BaseMethods.TeXAtom = function (parser, name, mclass) {
        ...
        if (mclass === MmlNode_js_1.TEXCLASS.OP) {
          ...
          if (match) {
            ...
            parsed = new TexParser_js_1.default(
              arg,
              parser.stack.env,
              parser.configuration
            ).mml();
      ...
      BaseMethods.MmlToken = function (parser, name) {
        ...
        while (attr !== '') {
          ...
          if (
            !node.attributes.hasDefault(match[1]) &&
            !MmlTokenAllow[match[1]]
          ) {
            throw new TexError_js_1.default(
          ...
          var value = ParseUtil_js_1.default.MmlFilterAttribute(
            parser,
            match[1],
            match[2].replace(/^(['"])(.*)\1$/, '$2')
          );
      ...
      BaseMethods.Smash = function (parser, name) {
        var bt = ParseUtil_js_1.default.trimSpaces(
      ...
      BaseMethods.HBox = function (parser, name, style, font) {
        parser.PushAll(
          ParseUtil_js_1.default.internalMath(
            parser,
      ...
      BaseMethods.FBox = function (parser, name) {
        var internal = ParseUtil_js_1.default.internalMath(
          parser,
          parser.GetArgument(name)
        );
      ...
      BaseMethods.FrameBox = function (parser, name) {
        ...
        var mml = ParseUtil_js_1.default.internalMath(
          parser,
          parser.GetArgument(name)
        );
        if (width) {
          mml = [
            parser.create('node', 'mpadded', mml, {
              width: width,
              'data-align': (0, Options_js_1.lookup)(
                pos,
                { l: 'left', r: 'right' },
                'center'
              )
      ...
      BaseMethods.Dots = function (parser, _name) {
        ...
        var ldots = parser.create(
          'token',
          'mo',
          { stretchy: false },
          ldotsEntity
        );
        var cdots = parser.create(
          'token',
          'mo',
          { stretchy: false },
          cdotsEntity
      ...
      BaseMethods.Entry = function (parser, name) {
        ...
        if (
          ...
          var internal = ParseUtil_js_1.default.internalMath(
            parser,
            ParseUtil_js_1.default.trimSpaces(text),
            0
          );
      ...
      BaseMethods.EqnArray = function (
        ...
        align = align
          ...
          .replace(/r/g, 'right')
          .replace(/c/g, 'center');
        var newItem = parser.itemFactory.create(
          'eqnarray',
          begin.getName(),
          numbered,
          taggable,
      ...
      BaseMethods.HandleRef = function (parser, name, eqref) {
        ...
        var node = parser.create(
          'node',
          'mrow',
          ParseUtil_js_1.default.internalMath(parser, tag),
          {
...
//# sourceMappingURL=2707.c3fada6f339e63cc4e1a.js.map?v=c3fada6f339e63cc4e1a
