...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [6275],
  {
    /***/ 24971: /***/ (__unused_webpack_module, exports) => {
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.newState =
        exports.STATE =
        exports.AbstractMathItem =
        exports.protoItem =
          void 0;
      ...
      var AbstractMathItem = (function () {
        ...
        AbstractMathItem.prototype.setMetrics = function (
          em,
          ex,
          cwidth,
          lwidth,
        ...
        AbstractMathItem.prototype.state = function (state, restore) {
          ...
          if (state != null) {
            if (
              state < exports.STATE.INSERTED &&
              this._state >= exports.STATE.INSERTED
            ) {
              this.removeFromDocument(restore);
            }
            if (
              state < exports.STATE.TYPESET &&
              this._state >= exports.STATE.TYPESET
            ) {
              this.outputData = {};
            }
            if (
              state < exports.STATE.COMPILED &&
              this._state >= exports.STATE.COMPILED
            ) {
              this.inputData = {};
            }
            this._state = state;
    ...
    /***/ 36528: /***/ function (
      ...
      var MmlMaction = (function (_super) {
        ...
        MmlMaction.defaults = __assign(
          __assign({}, MmlNode_js_1.AbstractMmlNode.defaults),
          { actiontype: 'toggle', selection: 1 }
        );
        return MmlMaction;
    ...
    /***/ 31859: /***/ function (
      ...
      var MmlMath = (function (_super) {
        ...
        MmlMath.prototype.setChildInheritedAttributes = function (
          attributes,
          display,
          level,
          prime
          ...
          _super.prototype.setChildInheritedAttributes.call(
            this,
            attributes,
            display,
            level,
    ...
    /***/ 54453: /***/ function (
      ...
      var MmlMfenced = (function (_super) {
        ...
        MmlMfenced.prototype.setChildInheritedAttributes = function (
          attributes,
          display,
          level,
          prime
          ...
          try {
            for (
              var _b = __values(
                  [this.open, this.close].concat(this.separators)
                ),
                _c = _b.next();
              !_c.done;
              _c = _b.next()
    ...
    /***/ 74502: /***/ function (
      ...
      var MmlMfrac = (function (_super) {
        ...
        MmlMfrac.prototype.setChildInheritedAttributes = function (
          attributes,
          display,
          level,
          prime
        ...
        MmlMfrac.defaults = __assign(
          __assign({}, MmlNode_js_1.AbstractMmlBaseNode.defaults),
          {
    ...
    /***/ 64906: /***/ function (
      ...
      var MmlMglyph = (function (_super) {
        ...
        MmlMglyph.prototype.verifyAttributes = function (options) {
          var _a = this.attributes.getList('src', 'fontfamily', 'index'),
            src = _a.src,
        ...
        MmlMglyph.defaults = __assign(
          __assign({}, MmlNode_js_1.AbstractMmlTokenNode.defaults),
          {
            alt: '',
            src: '',
            index: '',
    ...
    /***/ 32175: /***/ function (
      ...
      var MmlMi = (function (_super) {
        ...
        MmlMi.prototype.setInheritedAttributes = function (
          attributes,
          display,
          level,
          prime
          ...
          _super.prototype.setInheritedAttributes.call(
            this,
            attributes,
            display,
            level,
    ...
    /***/ 10093: /***/ function (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.MmlNone =
        exports.MmlMprescripts =
        exports.MmlMmultiscripts =
          void 0;
      var MmlNode_js_1 = __webpack_require__(80747);
      var msubsup_js_1 = __webpack_require__(12560);
      var MmlMmultiscripts = (function (_super) {
        ...
        MmlMmultiscripts.prototype.setChildInheritedAttributes = function (
          attributes,
          display,
          level,
          prime
        ...
        MmlMmultiscripts.defaults = __assign(
          {},
      ...
      var MmlMprescripts = (function (_super) {
        ...
        MmlMprescripts.defaults = __assign(
          {},
    ...
    /***/ 96778: /***/ function (
      ...
      var MmlMroot = (function (_super) {
        ...
        MmlMroot.prototype.setChildInheritedAttributes = function (
          attributes,
          display,
          level,
          prime
      ...
      var MmlMrow = (function (_super) {
        ...
        MmlMrow.prototype.setTeXclass = function (prev) {
          ...
          if (
            ...
            try {
              for (
                var _e = __values(this.childNodes), _f = _e.next();
                !_f.done;
                _f = _e.next()
              ) {
                var child = _f.value;
      ...
      var MmlMspace = (function (_super) {
        ...
        Object.defineProperty(MmlMspace.prototype, 'hasNewline', {
          get: function () {
            ...
            return (
              attributes.getExplicit('width') == null &&
    ...
    /***/ 24208: /***/ function (
      ...
      var MmlMsqrt = (function (_super) {
        ...
        MmlMsqrt.prototype.setChildInheritedAttributes = function (
          attributes,
          display,
          level,
          _prime
    ...
    /***/ 12560: /***/ function (
      ...
      var MmlMsubsup = (function (_super) {
        ...
        MmlMsubsup.prototype.setChildInheritedAttributes = function (
          attributes,
          display,
          level,
          prime
    ...
    /***/ 7840: /***/ function (
      ...
      var MmlMtable = (function (_super) {
        ...
        MmlMtable.prototype.setInheritedAttributes = function (
          attributes,
          display,
          level,
          prime
          ...
          try {
            for (
              var indentAttributes_1 = __values(MmlNode_js_1.indentAttributes),
                indentAttributes_1_1 = indentAttributes_1.next();
              !indentAttributes_1_1.done;
              indentAttributes_1_1 = indentAttributes_1.next()
            ) {
            ...
            try {
              if (
                indentAttributes_1_1 &&
                !indentAttributes_1_1.done &&
                (_a = indentAttributes_1.return)
              )
                _a.call(indentAttributes_1);
            } finally {
              if (e_1) throw e_1.error;
            }
          }
        ...
        MmlMtable.prototype.setChildInheritedAttributes = function (
          attributes,
          display,
          level,
          _prime
        ...
        MmlMtable.prototype.verifyChildren = function (options) {
          ...
          for (var i = 0; i < this.childNodes.length; i++) {
            ...
            if (child.isKind('mtr')) {
              ...
              mtr.appendChild(
                isMtd ? child : factory.create('mtd', {}, [child])
              );
              if (!options['fixMtables']) {
                child.parent.removeChild(child);
                child.parent = this;
                isMtd && mtr.appendChild(factory.create('mtd'));
                var merror = child.mError(
    ...
    /***/ 94826: /***/ function (
      ...
      var MmlNode_js_1 = __webpack_require__(80747);
      var Attributes_js_1 = __webpack_require__(98128);
    ...
    /***/ 79516: /***/ function (
      ...
      var MmlMtr = (function (_super) {
        ...
        MmlMtr.prototype.setChildInheritedAttributes = function (
          attributes,
          display,
          level,
          prime
          ...
          var calign = (0, string_js_1.split)(
          ...
          try {
            for (
              ...
              var child = _f.value;
              attributes.columnalign[1] =
                calign.shift() || attributes.columnalign[1];
              child.setInheritedAttributes(attributes, display, level, prime);
            }
          } catch (e_2_1) {
            e_2 = { error: e_2_1 };
    ...
    /***/ 46072: /***/ function (
      ...
      var MmlMunderover = (function (_super) {
        ...
        MmlMunderover.prototype.setChildInheritedAttributes = function (
          attributes,
          display,
          level,
          prime
        ...
        MmlMunderover.prototype.getScriptlevel = function (
          accent,
          force,
          level
        ) {
        ...
        MmlMunderover.prototype.setInheritedAccent = function (
          n,
          accent,
          display,
          level,
          ...
          if (
            this.attributes.getExplicit(accent) == null &&
            node.isEmbellished
          ) {
        ...
        MmlMunderover.defaults = __assign(
          __assign({}, MmlNode_js_1.AbstractMmlBaseNode.defaults),
          { accent: false, accentunder: false, align: 'center' }
        );
    ...
    /***/ 75447: /***/ function (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.MmlAnnotation =
        exports.MmlAnnotationXML =
        exports.MmlSemantics =
          void 0;
      var MmlNode_js_1 = __webpack_require__(80747);
      var MmlSemantics = (function (_super) {
        ...
        MmlSemantics.defaults = __assign(
          __assign({}, MmlNode_js_1.AbstractMmlBaseNode.defaults),
      ...
      var MmlAnnotationXML = (function (_super) {
        ...
        MmlAnnotationXML.defaults = __assign(
          __assign({}, MmlNode_js_1.AbstractMmlNode.defaults),
          {
            definitionUrl: null,
            encoding: null,
...
//# sourceMappingURL=6275.940ac3611bab14bba2ef.js.map?v=940ac3611bab14bba2ef
