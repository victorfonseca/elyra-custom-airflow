    ...
    56441: function (t, e, r) {
      ...
      var h = (function () {
        ...
        t.prototype.addPackage = function (t) {
          ...
          r &&
            this.configurations.add(
              r,
              typeof t === 'string' ? r.priority : t[1]
            );
        };
        t.prototype.add = function (t, e, r) {
          ...
          try {
            for (
              var c = n(Object.keys(s.items)), f = c.next();
              !f.done;
              f = c.next()
            ) {
              var h = f.value;
      ...
      (function (t) {
        ...
        function S(t, e, r, n) {
          ...
          if (e.match(/\\?[${}\\]|\\\(|\\(eq)?ref\s*\{/)) {
            while (s < e.length) {
              ...
              if (f === '$') {
                if (p === '$' && d === 0) {
                  h = t.create('node', 'TeXAtom', [
                    new l.default(e.slice(c, s - 1), {}, t.configuration).mml()
                  ]);
                  a.push(h);
                  p = '';
                  c = s;
        ...
        function D(t, e, r) {
          ...
          if (e) {
            try {
              for (
                var s = i(Object.keys(a)), l = s.next();
                !l.done;
                l = s.next()
              ) {
                var c = l.value;
        ...
        t.prototype.Push = function () {
          ...
          try {
            for (var l = n(r), u = l.next(); !u.done; u = l.next()) {
              ...
              var h = i(
                  this.stack.length ? this.Top().checkItem(f) : [null, true],
                  2
                ),
                p = h[0],
                d = h[1];
    ...
    80209: function (t, e, r) {
      ...
      var p = (function (t) {
        ...
        function e(e, r, n) {
          ...
          try {
            for (
              var c = o(Object.keys(n)), f = c.next();
              !f.done;
              f = c.next()
            ) {
              var h = f.value;
      ...
      var v = (function (t) {
        ...
        function e(e, r, n) {
          ...
          try {
            for (
              var c = o(Object.keys(r)), f = c.next();
              !f.done;
              f = c.next()
            ) {
              var h = f.value;
