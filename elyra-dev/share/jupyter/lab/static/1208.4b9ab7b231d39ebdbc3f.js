    ...
    91208: (e, t, r) => {
        ...
        iterate(e) {
          ...
          for (let o = this.cursor(s | d.IncludeAnonymous); ; ) {
            ...
            if (
              o.from <= i &&
              o.to >= n &&
              ((!l && o.type.isAnonymous) || t(o) !== false)
            ) {
      ...
      class w extends y {
        ...
        nextChild(e, t, r, n, i = 0) {
          for (let s = this; ; ) {
            for (
              let { children: l, positions: f } = s._tree,
                h = t > 0 ? l.length : -1;
              e != h;
              e += t
            ) {
              ...
              if (h instanceof m) {
                ...
                i & d.IncludeAnonymous ||
                !h.type.isAnonymous ||
                B(h)
              ) {
                let l;
                if (!(i & d.IgnoreMounts) && (l = o.get(h)) && !l.overlay)
                  return new w(l.tree, u, e, s);
                let f = new w(h, u, e, s);
                return i & d.IncludeAnonymous || !f.type.isAnonymous
                  ? f
          ...
          if (!(r & d.IgnoreOverlays) && (n = o.get(this._tree)) && n.overlay) {
            ...
            for (let { from: e, to: i } of n.overlay) {
              if ((t > 0 ? e <= r : e < r) && (t < 0 ? i >= r : i > r))
                return new w(n.tree, n.overlay[0].from + this.from, -1, this);
            }
          }
      ...
      class A extends y {
        ...
        get nextSibling() {
          ...
          if (
            ...
            return new A(this.context, this._parent, t);
        ...
        for (let s = n instanceof w ? n : n.context.parent; s; s = s.parent) {
          if (s.index < 0) {
            ...
            if (
              ...
              e.overlay &&
              e.overlay[0].from <= t &&
              e.overlay[e.overlay.length - 1].to >= t
            ) {
      ...
      class I {
        ...
        atLastNode(e) {
          ...
          if (n) {
            if (e > 0) {
              ...
              for (let e = 0; e < this.index; e++)
                if (n.buffer.buffer[e + 3] < this.index) return false;
            }
            ({ index: t, parent: r } = n);
          } else {
          ...
          for (; r; { index: t, _parent: r } = r) {
            if (t > -1)
              for (
                let n = t + e, i = e < 0 ? -1 : r._tree.children.length;
                n != i;
                n += e
              ) {
        ...
        get node() {
          ...
          for (let n = r; n < this.stack.length; n++)
            t = new A(this.buffer, t, this.stack[n]);
      ...
      function B(e) {
        return e.children.some(
          (e) => e instanceof m || !e.type.isAnonymous || B(e)
        );
      }
      function T(e) {
        var t;
        let {
          ...
          maxBufferLength: s = n,
          reused: o = [],
          minRepeatType: f = i.types.length
        } = e;
              ...
              while (s && s.from < u) {
                ...
                if (o >= t.from || u <= t.to || f) {
                  ...
                  t =
                    e >= r
                      ? null
                      : new O(e, r, t.tree, t.offset + f, l > 0, !!h);
                }
                if (t) n.push(t);
                if (s.to > u) break;
      ...
      class J {
        ...
        startInner() {
          ...
          let r = null;
          let n = new I(
            new w(this.baseTree, this.ranges[0].from, 0, null),
            d.IncludeAnonymous | d.IgnoreMounts
          );
          e: for (let i, l; ; ) {
            let o = true,
              f;
            if (this.stoppedAt != null && n.from >= this.stoppedAt) {
              ...
              if (typeof i.overlay == 'function') {
                ...
                let e = K(
                  this.ranges,
                  i.overlay || (n.from < n.to ? [new s(n.from, n.to)] : [])
                );
                if (e.length) W(e);
                if (e.length || !i.overlay)
                  this.inner.push(
                    new R(
                      i.parser,
                      e.length
                        ? i.parser.startParse(this.input, X(l, e), e)
                        : i.parser.startParse(''),
                      i.overlay
                        ? i.overlay.map(
                            (e) => new s(e.from - n.from, e.to - n.from)
                          )
                        : null,
                      n.tree,
                  ...
                  if (e.length) {
                    ...
                    this.inner.splice(
                      ...
                      new R(
                        ...
                        t.ranges.map(
                          (e) => new s(e.from - t.start, e.to - t.start)
                        ),
                        t.target,
                        e[0].from
                      )
      ...
      function G(e) {
        ...
        function u(e, n, i, s, h, a) {
          ...
          f.push(d.length);
          let x = a
            ? u(p + 4, o[p + 3], l.set.types[o[p]], m, b - m, a - 1)
            : t.toTree();
          d.push(x);
          g.push(m - s);
          H(l, o[p + 3], n, d, g, s);
      ...
      class $ {
        ...
        moveTo(e) {
          ...
          while (!this.done && t.from < r) {
            if (
              t.to >= e &&
              t.enter(r, 1, d.IgnoreOverlays | d.ExcludeBuffers)
            );
      ...
      class q {
        constructor(e) {
          ...
          if (e.length) {
            ...
            this.curTo =
              (t = r.tree.prop(L)) !== null && t !== void 0 ? t : r.to;
        ...
        nextFrag() {
          ...
          if (this.fragI == this.fragments.length) {
            ...
            this.curTo =
              (e = t.tree.prop(L)) !== null && e !== void 0 ? e : t.to;
            ...
            for (let e = this.inner.cursor.node; e; e = e.parent) {
              ...
              if (i && i.parser == t) {
                for (let t = this.fragI; t < this.fragments.length; t++) {
                  ...
                  if (r.tree == this.curFrag.tree)
                    n.push({ frag: r, pos: e.from - r.offset, mount: i });
                }
              }
            }
          }
