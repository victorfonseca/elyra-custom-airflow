        ...
        (() => {
          ...
          var e = {
              6: (e, t) => {
                ...
                class r {
                  static computeLink(e, t, i, o) {
                    const s = new RegExp(t.source, (t.flags || '') + 'g'),
                      [a, l] = r._getWindowedLineStrings(e - 1, i),
                      c = a.join('');
                    let p;
                    const d = [];
                    for (; (p = s.exec(c)); ) {
                      const e = p[0];
                      if (!n(e)) continue;
                      const [t, s] = r._mapStrIdx(i, l, 0, p.index),
                        [a, c] = r._mapStrIdx(i, t, s, e.length);
                      if (-1 === t || -1 === s || -1 === a || -1 === c)
                        continue;
                      const h = {
                        start: { x: s + 1, y: t + 1 },
                      ...
                      d.push({ range: h, text: e, activate: o });
                    }
                    return d;
                  }
                  ...
                  static _mapStrIdx(e, t, n, r) {
                    ...
                    for (; r; ) {
                      ...
                      for (let n = s; n < e.length; ++n) {
                        ...
                        if (
                          o.getWidth() &&
                          ((r -= s.length || 1), n === e.length - 1 && '' === s)
                        ) {
                          const e = i.getLine(t + 1);
                          e &&
                            e.isWrapped &&
                            (e.getCell(0, o), 2 === o.getWidth() && (r += 1));
                        }
                        if (r < 0) return [t, n];
                      }
                      t++, (s = 0);
