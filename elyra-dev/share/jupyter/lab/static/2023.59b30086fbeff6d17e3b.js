    ...
    52023: (e, t, s) => {
      ...
      var A = class {
        ...
        setTooltip(e, t) {
          ...
          for (const s of e.split(',')) {
            this.tooltips.set(
              this.version === 'gen-1' ? this.lookUpDomId(s) : s,
              t
            );
          }
        }
        ...
        getData() {
          ...
          u.forEach((t, i) => {
            const { arrowTypeStart: r, arrowTypeEnd: n } =
              this.destructEdgeType(t.type);
            ...
            switch (n) {
              ...
              case 62:
                ...
                r.addVertex(
                  ...
                  void 0,
                  void 0,
                  Object.fromEntries([[a[o - 5], a[o - 3]]])
                );
                break;
              case 63:
                this.$ = a[o - 3];
      ...
      var _ = {
        ...
        init: (0, p.K2)((e) => {
          ...
          (0, p.XV)({
            flowchart: { arrowMarkerAbsolute: e.arrowMarkerAbsolute }
          });
        }, 'init')
      };
    }
