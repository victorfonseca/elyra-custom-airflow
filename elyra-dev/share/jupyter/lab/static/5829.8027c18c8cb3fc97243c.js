(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [5829, 5338, 2957, 100],
  {
    /***/ 67097: /***/ (
      ...
      var toPath = __webpack_require__(42072);
      ...
      var set_default = /*#__PURE__*/ __webpack_require__.n(set); // CONCATENATED MODULE: ./node_modules/nanoid/index.browser.js
      ...
      class ArrayField extends index_js_.Component {
        ...
        constructor(props) {
          ...
          this._getNewFormDataRow = () => {
            ...
            if (
              (0, lib_index_js_.isFixedItems)(schema) &&
              (0, lib_index_js_.allowAdditionalItems)(schema)
            ) {
        ...
        get itemTitle() {
          ...
          return get_default()(
            schema,
            [lib_index_js_.ITEMS_KEY, 'title'],
            get_default()(
              schema,
              [lib_index_js_.ITEMS_KEY, 'description'],
              translateString(lib_index_js_.TranslatableString.ArrayItemTitle)
            )
          );
        }
        ...
        canAddItem(formItems) {
          ...
          let { addable } = (0, lib_index_js_.getUiOptions)(
            uiSchema,
        ...
        render() {
          ...
          if (!(lib_index_js_.ITEMS_KEY in schema)) {
            ...
            const UnsupportedFieldTemplate = (0, lib_index_js_.getTemplate)(
              'UnsupportedFieldTemplate',
              registry,
              uiOptions
            );
            return (0, jsx_runtime.jsx)(UnsupportedFieldTemplate, {
              schema: schema,
              idSchema: idSchema,
              reason: translateString(
                lib_index_js_.TranslatableString.MissingItems
              ),
              registry: registry
            });
          }
        ...
        renderNormalArray() {
          ...
          const uiOptions = (0, lib_index_js_.getUiOptions)(uiSchema);
          const _schemaItems = isObject_default()(schema.items)
            ? schema.items
            : {};
          ...
          const Template = (0, lib_index_js_.getTemplate)(
            'ArrayFieldTemplate',
            registry,
            uiOptions
          );
        ...
        renderCustomWidget() {
          ...
          const {
            ...
            title: uiTitle,
            ...options
          } = (0, lib_index_js_.getUiOptions)(uiSchema, globalUiOptions);
          const Widget = (0, lib_index_js_.getWidget)(schema, widget, widgets);
          const label =
            (_a =
              uiTitle !== null && uiTitle !== void 0
                ? uiTitle
                : schema.title) !== null && _a !== void 0
              ? _a
              : name;
          ...
          return (0, jsx_runtime.jsx)(Widget, {
            id: idSchema.$id,
            name: name,
            multiple: true,
        ...
        renderFixedArray() {
          ...
          const arrayProps = {
            ...
            items: keyedFormData.map((keyedItem, index) => {
              ...
              const itemSchema =
                (additional && isObject_default()(schema.additionalItems)
        ...
        renderArrayFieldItem(props) {
          ...
          return {
            children: (0, jsx_runtime.jsx)(ItemSchemaField, {
              name: name,
              index: index,
              schema: itemSchema,
       ...
       */
      /* harmony default export */ const fields_ArrayField = ArrayField; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/fields/BooleanField.js
      ...
      function BooleanField(props) {
        ...
        let enumOptions;
        const label =
          (_a = uiTitle !== null && uiTitle !== void 0 ? uiTitle : title) !==
            null && _a !== void 0
            ? _a
            : name;
        if (Array.isArray(schema.oneOf)) {
          ...
          const enums =
            (_b = schema.enum) !== null && _b !== void 0 ? _b : [true, false];
          if (
      ...
      var omit_default = /*#__PURE__*/ __webpack_require__.n(omit); // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/fields/MultiSchemaField.js
      ...
      class AnyOfField extends index_js_.Component {
        ...
        componentDidUpdate(prevProps, prevState) {
          ...
          if (
            !(0, lib_index_js_.deepEquals)(formData, prevProps.formData) &&
        ...
        getMatchingOption(selectedOption, formData, options) {
          ...
          lib_index_js_.getDiscriminatorFieldFromSchema)(schema);
        ...
        render() {
          ...
          const Widget = (0, lib_index_js_.getWidget)(
            { type: 'number' },
            widget,
            widgets
          );
          const rawErrors = get_default()(
            errorSchema,
            lib_index_js_.ERRORS_KEY,
            []
          );
          const fieldErrorSchema = omit_default()(errorSchema, [
            lib_index_js_.ERRORS_KEY
          ]);
          const displayLabel = schemaUtils.getDisplayLabel(
            schema,
          ...
          if (option) {
            ...
            optionSchema = required
              ? (0, lib_index_js_.mergeSchemas)({ required }, option)
              : option;
          }
          ...
          return (0, jsx_runtime.jsxs)('div', {
            ...
            children: [
              (0, jsx_runtime.jsx)('div', {
                ...
                children: (0, jsx_runtime.jsx)(Widget, {
                  id: this.getFieldId(),
              ...
              option !== null &&
                (0, jsx_runtime.jsx)(_SchemaField, {
                  ...this.props,
                  schema: optionSchema
                })
            ]
      ...
      /* harmony default export */ const MultiSchemaField = AnyOfField; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/fields/NumberField.js
      ...
      function NumberField(props) {
         ...
         */
        const handleChange = (0, index_js_.useCallback)(
          (value) => {
        ...
        return (0, jsx_runtime.jsx)(StringField, {
          ...props,
          formData: value,
          onChange: handleChange
        });
      }
      /* harmony default export */ const fields_NumberField = NumberField; // CONCATENATED MODULE: ./node_modules/markdown-to-jsx/dist/index.modern.js
      ...
      function ve(e, t) {
        ...
        return {
          match(e, t, n) {
            const r = ae.exec(n);
            return r && (t.list || (!t.inline && !t.simple))
              ? i.exec((e = r[1] + e))
              : null;
          },
          order: 1,
        ...
        let a = e
          ...
          .reduce(
            (e, l) => (
              '|' === l.trim()
                ? e.push(
                    i ? { type: r.tableSeparator } : { type: r.text, text: l }
                  )
        ...
        return (
          a.forEach(function (e, t) {
            e.type === r.tableSeparator
              ...
              : (e.type !== r.text ||
                  (null != a[t + 1] && a[t + 1].type !== r.tableSeparator) ||
      ...
      function Ae(e, t, n) {
        ...
        return (
          (n.inline = !1),
          l.length
            ? { align: i, cells: l, header: a, type: r.table }
      ...
      const Fe = (e, t, n) => ({ children: je(t, e[1], n) });
      function Pe() {
        return {};
      }
      function _e() {
      ...
      function Ze(n = '', i = {}) {
        function d(e, n, ...r) {
          ...
          return i.createElement(
            ...
            t({}, n, l, {
              className:
                We(null == n ? void 0 : n.className, l.className) || void 0
            }),
            ...r
          );
        }
        function G(t) {
          ...
          let a;
          if (r.length > 1 || i.forceWrapper) a = r;
          else {
            if (1 === r.length)
              return (
                (a = r[0]),
                'string' == typeof a ? d('span', { key: 'outer' }, a) : a
              );
            a = null;
          }
          return index_js_.createElement(l, { key: 'outer' }, a);
        }
        function Z(t, n) {
          const r = n.match(c);
          return r
            ? r.reduce(function (n, r, a) {
                ...
                if (-1 !== o) {
                  ...
                  'string' == typeof u &&
                    (L.test(u) || B.test(u)) &&
                    (n[d] = index_js_.cloneElement(G(u.trim()), { key: a }));
        ...
        (i.overrides = i.overrides || {}),
          (i.sanitizer = i.sanitizer || Ue),
          (i.slugify = i.slugify || Ce),
          (i.namedCodesToUnicode = i.namedCodesToUnicode
            ? t({}, a, i.namedCodesToUnicode)
            : a),
          (i.createElement = i.createElement || index_js_.createElement);
        const q = [],
          Q = {},
          V = {
            [r.blockQuote]: {
              match: Me(u),
              order: 1,
              parse: (e, t, n) => ({ children: t(e[0].replace(p, ''), n) }),
              render: (e, t, n) =>
                d('blockquote', { key: n.key }, t(e.children, n))
            },
            [r.breakLine]: {
              match: Re(f),
              order: 1,
              parse: Pe,
              render: (e, t, n) => d('br', { key: n.key })
            },
            [r.breakThematic]: {
              match: Me(h),
              order: 1,
              parse: Pe,
              render: (e, t, n) => d('hr', { key: n.key })
            },
            [r.codeBlock]: {
              match: Me(g),
              order: 0,
            ...
            [r.codeInline]: {
              ...
              order: 3,
              parse: (e) => ({ text: e[2] }),
              render: (e, t, n) => d('code', { key: n.key }, e.text)
            },
            [r.footnote]: {
              match: Me(b),
              order: 0,
              parse: (e) => (q.push({ footnote: e[2], identifier: e[1] }), {}),
              render: _e
            },
            [r.footnoteReference]: {
              match: Oe(v),
              order: 1,
              parse: (e) => ({ target: `#${i.slugify(e[1], Ce)}`, text: e[1] }),
              render: (e, t, n) =>
                d(
                  'a',
                  { key: n.key, href: i.sanitizer(e.target, 'a', 'href') },
                  d('sup', { key: n.key }, e.text)
                )
            },
            [r.gfmTask]: {
              match: Oe($),
            ...
            [r.heading]: {
              ...
              render: (e, t, n) =>
                d(`h${e.level}`, { id: e.id, key: n.key }, t(e.children, n))
            },
            [r.headingSetext]: {
              match: Me(z),
              order: 0,
            ...
            [r.htmlBlock]: {
              ...
              parse(e, t, n) {
                ...
                const s = e[1].toLowerCase(),
                  d = -1 !== o.indexOf(s),
                  u = (d ? s : e[1]).trim(),
                  p = { attrs: Z(u, e[2]), noInnerParse: d, tag: u };
                return (
                  (n.inAnchor = n.inAnchor || 'a' === s),
                  d ? (p.text = e[3]) : (p.children = a(t, l, n)),
                  (n.inAnchor = !1),
                  p
                );
              },
              render: (e, n, r) =>
                d(e.tag, t({ key: r.key }, e.attrs), e.text || n(e.children, r))
            },
            [r.htmlSelfClosing]: {
              match: Re(B),
              order: 1,
              parse(e) {
                const t = e[1].trim();
                return { attrs: Z(t, e[2] || ''), tag: t };
              },
              render: (e, n, r) => d(e.tag, t({}, e.attrs, { key: r.key }))
            },
            [r.htmlComment]: {
              match: Re(T),
              order: 1,
            ...
            [r.image]: {
              match: Be(Ee),
              order: 1,
              parse: (e) => ({ alt: e[1], target: De(e[2]), title: e[3] }),
              render: (e, t, n) =>
                d('img', {
                  key: n.key,
                  alt: e.alt || void 0,
            ...
            [r.paragraph]: {
              ...
              order: 3,
              parse: Fe,
              render: (e, t, n) => d('p', { key: n.key }, t(e.children, n))
            },
            [r.ref]: {
              match: Oe(N),
              order: 0,
            ...
            [r.refLink]: {
              ...
              render: (e, t, n) =>
                Q[e.ref]
                  ...
                  : d('span', { key: n.key }, t(e.fallbackChildren, n))
            },
            [r.table]: {
              match: Me(j),
              order: 1,
                  ...
                  d(
                    ...
                    d(
                      ...
                      r.header.map(function (e, i) {
                        return d('th', { key: i, style: Te(r, i) }, t(e, n));
                      })
                    )
                  ),
                  d(
                    ...
                    r.cells.map(function (e, i) {
                      return d(
                        ...
                        { key: i },
                        e.map(function (e, i) {
                          return d('td', { key: i, style: Te(r, i) }, t(e, n));
                        })
                      );
                    })
                  )
            ...
            [r.textBolded]: {
              ...
              render: (e, t, n) => d('strong', { key: n.key }, t(e.children, n))
            },
            [r.textEmphasized]: {
              match: Be(J),
              order: 3,
              parse: (e, t, n) => ({ children: t(e[2], n) }),
              render: (e, t, n) => d('em', { key: n.key }, t(e.children, n))
            },
            [r.textEscaped]: {
              match: Be(ee),
              order: 1,
            ...
            [r.textMarked]: {
              ...
              order: 3,
              parse: Fe,
              render: (e, t, n) => d('mark', { key: n.key }, t(e.children, n))
            },
            [r.textStrikethroughed]: {
              match: Be(Y),
              order: 3,
              parse: Fe,
              render: (e, t, n) => d('del', { key: n.key }, t(e.children, n))
            }
          };
        !0 === i.disableParsingRawHTML &&
          (delete V[r.htmlBlock], delete V[r.htmlSelfClosing]);
        const ie = (function (e) {
            let t = Object.keys(e);
            function n(r, i) {
              let l = [],
            ...
            function e(t, n = {}) {
              if (Array.isArray(t)) {
                ...
                for (let r = 0; r < t.length; r++) {
                  ...
                  const a = e(t[r], n),
                    o = 'string' == typeof a;
                  o && l ? (i[i.length - 1] += a) : null !== a && i.push(a),
                    (l = o);
                }
                return (n.key = r), i;
              }
          ...
          ? d(
              ...
              d(
                ...
                q.map(function (e) {
                  return d(
                    'div',
                    { id: i.slugify(e.identifier, Ce), key: e.identifier },
                    e.identifier,
                    le(ie(e.footnote, { inline: !0 }))
                  );
                })
              )
            )
      ...
      /* harmony default export */ const index_modern = (t) => {
        ...
        return index_js_.cloneElement(Ze(r, i), l);
      };
      ...
      var unset_default = /*#__PURE__*/ __webpack_require__.n(unset); // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/fields/ObjectField.js
      ...
      class ObjectField extends index_js_.Component {
        constructor() {
          ...
          this.getAvailableKey = (preferredKey, formData) => {
            ...
            lib_index_js_.getUiOptions)(uiSchema, registry.globalUiOptions);
            let index = 0;
            ...
            if (isObject_default()(schema.additionalProperties)) {
              ...
              if (lib_index_js_.REF_KEY in apSchema) {
                ...
                apSchema = schemaUtils.retrieveSchema(
                  { $ref: apSchema[lib_index_js_.REF_KEY] },
                  formData
                );
                type = apSchema.type;
              }
              if (
                !type &&
                (lib_index_js_.ANY_OF_KEY in apSchema ||
                  lib_index_js_.ONE_OF_KEY in apSchema)
              ) {
                type = 'object';
              }
            }
          ...
          switch (type) {
            ...
            default:
              ...
              return translateString(
                lib_index_js_.TranslatableString.NewStringDefault
              );
          }
        }
        ...
        render() {
          ...
          const uiOptions = (0, lib_index_js_.getUiOptions)(
            uiSchema,
            globalUiOptions
          );
          ...
          const title =
            (_b =
              (_a = uiOptions.title) !== null && _a !== void 0
                ? _a
                : schema.title) !== null && _b !== void 0
              ? _b
              : name;
          const description =
            (_c = uiOptions.description) !== null && _c !== void 0
              ? _c
              : schema.description;
          let orderedProperties;
          try {
            const properties = Object.keys(schemaProperties);
            orderedProperties = (0, lib_index_js_.orderProperties)(
              properties,
              uiOptions.order
            );
          } catch (err) {
            return (0, jsx_runtime.jsxs)('div', {
              children: [
                (0, jsx_runtime.jsx)('p', {
                  ...
                  style: { color: 'red' },
                  children: (0, jsx_runtime.jsx)(index_modern, {
                    children: translateString(
                      lib_index_js_.TranslatableString.InvalidObjectField,
          ...
          const templateProps = {
            ...
            properties: orderedProperties.map((name) => {
              const addedByAdditionalProperties = has_default()(schema, [
                lib_index_js_.PROPERTIES_KEY,
                name,
                lib_index_js_.ADDITIONAL_PROPERTY_FLAG
              ]);
              const fieldUiSchema = addedByAdditionalProperties
                ? uiSchema.additionalProperties
                : uiSchema[name];
              const hidden =
                (0, lib_index_js_.getUiOptions)(fieldUiSchema).widget ===
                'hidden';
              ...
              return {
                content: (0, jsx_runtime.jsx)(
                  SchemaField,
                  {
                    ...
                    schema: get_default()(
                      schema,
                      [lib_index_js_.PROPERTIES_KEY, name],
                      {}
                    ),
                    uiSchema: fieldUiSchema,
                    errorSchema: get_default()(errorSchema, name),
                    idSchema: fieldIdSchema,
                    idPrefix: idPrefix,
                    idSeparator: idSeparator,
                    formData: get_default()(formData, name),
                    formContext: formContext,
          ...
          return (0, jsx_runtime.jsx)(Template, {
            ...templateProps,
            onAddClick: this.handleAddClick
          });
        }
      }
      /* harmony default export */ const fields_ObjectField = ObjectField; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/fields/SchemaField.js
        ...
        return componentName in fields
          ...
          : () => {
              ...
              return (0, jsx_runtime.jsx)(UnsupportedFieldTemplate, {
                ...
                idSchema: idSchema,
                reason: translateString(
                  lib_index_js_.TranslatableString.UnknownFieldType,
                  [String(schema.type)]
                ),
                registry: registry
              });
      ...
      function SchemaFieldRender(props) {
        ...
        const FieldTemplate = (0, lib_index_js_.getTemplate)(
          'FieldTemplate',
          registry,
          uiOptions
        );
        const DescriptionFieldTemplate = (0, lib_index_js_.getTemplate)(
          'DescriptionFieldTemplate',
          registry,
          uiOptions
        );
        const FieldHelpTemplate = (0, lib_index_js_.getTemplate)(
          'FieldHelpTemplate',
          registry,
          uiOptions
        );
        const FieldErrorTemplate = (0, lib_index_js_.getTemplate)(
          'FieldErrorTemplate',
          registry,
          uiOptions
        );
        ...
        const idSchema = (0, lib_index_js_.mergeObjects)(
         ...
         */
        const handleFieldComponentChange = (0, index_js_.useCallback)(
        ...
        const fieldUiSchema = omit_default()(uiSchema, [
          'ui:classNames',
          'classNames',
          'ui:style'
        ]);
        if (lib_index_js_.UI_OPTIONS_KEY in fieldUiSchema) {
          fieldUiSchema[lib_index_js_.UI_OPTIONS_KEY] = omit_default()(
            fieldUiSchema[lib_index_js_.UI_OPTIONS_KEY],
            ['classNames', 'style']
          );
        }
        const field = (0, jsx_runtime.jsx)(FieldComponent, {
          ...props,
        ...
        if (wasPropertyKeyModified) {
          ...
          label =
            lib_index_js_.ADDITIONAL_PROPERTY_FLAG in schema
              ? name
        ...
        const richDescription = uiOptions.enableMarkdownInDescription
          ? (0, jsx_runtime.jsx)(index_modern, { children: description })
          : description;
        ...
        const classNames = [
          'form-group',
          'field',
          `field-${(0, lib_index_js_.getSchemaType)(schema)}`
        ];
        ...
        const helpComponent = (0, jsx_runtime.jsx)(FieldHelpTemplate, {
          help: help,
          idSchema: idSchema,
          schema: schema,
          uiSchema: uiSchema,
        ...
        const errorsComponent =
          ...
          ((schema.anyOf || schema.oneOf) && !schemaUtils.isSelect(schema))
            ? undefined
            : (0, jsx_runtime.jsx)(FieldErrorTemplate, {
                errors: __errors,
        ...
        const fieldProps = {
          description: (0, jsx_runtime.jsx)(DescriptionFieldTemplate, {
            id: (0, lib_index_js_.descriptionId)(id),
        ...
        return (0, jsx_runtime.jsx)(FieldTemplate, {
          ...fieldProps,
                ...
                (0, jsx_runtime.jsx)(_AnyOfField, {
                  ...
                  options: schema.anyOf.map((_schema) =>
                    schemaUtils.retrieveSchema(
                      isObject_default()(_schema) ? _schema : {},
                      formData
                    )
                  ),
                  registry: registry,
      ...
      /* harmony default export */ const fields_SchemaField = SchemaField; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/fields/StringField.js
      ...
      function StringField(props) {
        ...
        const enumOptions = schemaUtils.isSelect(schema)
          ? (0, lib_index_js_.optionsList)(schema)
          : undefined;
        ...
        const {
          ...
          title: uiTitle,
          ...options
        } = (0, lib_index_js_.getUiOptions)(uiSchema);
        const displayLabel = schemaUtils.getDisplayLabel(
          schema,
          uiSchema,
          globalUiOptions
      ...
      /* harmony default export */ const fields_StringField = StringField; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/fields/NullField.js
      ...
      /* harmony default export */ const fields_NullField = NullField; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/fields/index.js
      ...
      /* harmony default export */ const components_fields = fields; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/templates/ArrayFieldDescriptionTemplate.js
      ...
      function ArrayFieldDescriptionTemplate(props) {
        ...
        const options = (0, lib_index_js_.getUiOptions)(
          uiSchema,
          registry.globalUiOptions
        );
        ...
        return (0, jsx_runtime.jsx)(DescriptionFieldTemplate, {
          id: (0, lib_index_js_.descriptionId)(idSchema),
                ...
                children: (0, jsx_runtime.jsxs)('div', {
                  ...
                  children: [
                    (hasMoveUp || hasMoveDown) &&
                      (0, jsx_runtime.jsx)(MoveUpButton, {
                        style: btnStyle,
                    ...
                    (hasMoveUp || hasMoveDown) &&
                      (0, jsx_runtime.jsx)(MoveDownButton, {
                        style: btnStyle,
                    ...
                    hasRemove &&
                      (0, jsx_runtime.jsx)(RemoveButton, {
                        style: btnStyle,
                        disabled: disabled || readonly,
      ...
      function ArrayFieldTemplate(props) {
        ...
        const uiOptions = (0, lib_index_js_.getUiOptions)(uiSchema);
        const ArrayFieldDescriptionTemplate = (0, lib_index_js_.getTemplate)(
          'ArrayFieldDescriptionTemplate',
          registry,
          uiOptions
        );
        const ArrayFieldItemTemplate = (0, lib_index_js_.getTemplate)(
          'ArrayFieldItemTemplate',
          registry,
          uiOptions
        );
        const ArrayFieldTitleTemplate = (0, lib_index_js_.getTemplate)(
        ...
        return (0, jsx_runtime.jsxs)('fieldset', {
          ...
          id: idSchema.$id,
          children: [
            (0, jsx_runtime.jsx)(ArrayFieldTitleTemplate, {
              idSchema: idSchema,
            ...
            (0, jsx_runtime.jsx)(ArrayFieldDescriptionTemplate, {
              idSchema: idSchema,
      ...
      function ArrayFieldTitleTemplate(props) {
        ...
        const TitleFieldTemplate = (0, lib_index_js_.getTemplate)(
          'TitleFieldTemplate',
          registry,
          options
        );
        return (0, jsx_runtime.jsx)(TitleFieldTemplate, {
          id: (0, lib_index_js_.titleId)(idSchema),
          title: title,
          required: required,
          schema: schema,
          uiSchema: uiSchema,
      ...
      function BaseInputTemplate(props) {
        ...
        const _onChange = (0, index_js_.useCallback)(
          ({ target: { value } }) =>
            onChange(value === '' ? options.emptyValue : value),
          [onChange, options]
        );
        const _onBlur = (0, index_js_.useCallback)(
          ({ target: { value } }) => onBlur(id, value),
          [onBlur, id]
        );
        const _onFocus = (0, index_js_.useCallback)(
          ...
          children: [
            (0, jsx_runtime.jsx)('input', {
              ...
              list: schema.examples
                ? (0, lib_index_js_.examplesId)(id)
                : undefined,
              onChange: onChangeOverride || _onChange,
              onBlur: _onBlur,
              onFocus: _onFocus,
              'aria-describedby': (0, lib_index_js_.ariaDescribedByIds)(
                id,
                !!schema.examples
              )
            }),
            Array.isArray(schema.examples) &&
              (0, jsx_runtime.jsx)(
                'datalist',
                {
                  id: (0, lib_index_js_.examplesId)(id),
      ...
      function SubmitButton({ uiSchema }) {
        ...
        } = (0, lib_index_js_.getSubmitButtonOptions)(uiSchema);
        if (norender) {
          return null;
        }
      ...
      function CopyButton(props) {
        ...
        return (0, jsx_runtime.jsx)(IconButton, {
          title: translateString(lib_index_js_.TranslatableString.CopyButton),
      ...
      function MoveDownButton(props) {
        ...
        return (0, jsx_runtime.jsx)(IconButton, {
          title: translateString(
            lib_index_js_.TranslatableString.MoveDownButton
          ),
      ...
      function MoveUpButton(props) {
        ...
        return (0, jsx_runtime.jsx)(IconButton, {
          title: translateString(lib_index_js_.TranslatableString.MoveUpButton),
      ...
      function RemoveButton(props) {
        ...
        return (0, jsx_runtime.jsx)(IconButton, {
          title: translateString(lib_index_js_.TranslatableString.RemoveButton),
      ...
      function AddButton({ className, onClick, disabled, registry }) {
        ...
        return (0, jsx_runtime.jsx)('div', {
          ...
          children: (0, jsx_runtime.jsx)('p', {
            ...
            children: (0, jsx_runtime.jsx)(IconButton, {
              iconType: 'info',
              icon: 'plus',
              className: 'btn-add col-xs-12',
              title: translateString(
                lib_index_js_.TranslatableString.AddButton
              ),
              onClick: onClick,
              disabled: disabled,
              registry: registry
      ...
      /* harmony default export */ const ButtonTemplates = buttonTemplates; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/templates/DescriptionField.js
      //# sourceMappingURL=index.js.map
          ...
          children: [
            (0, jsx_runtime.jsx)('div', {
              ...
              children: (0, jsx_runtime.jsx)('h3', {
                ...
                children: translateString(
                  lib_index_js_.TranslatableString.ErrorsLabel
                )
              })
            }),
      ...
      function FieldTemplate(props) {
        ...
        const uiOptions = (0, lib_index_js_.getUiOptions)(uiSchema);
        const WrapIfAdditionalTemplate = (0, lib_index_js_.getTemplate)(
        ...
        return (0, jsx_runtime.jsxs)(WrapIfAdditionalTemplate, {
          ...props,
          children: [
            displayLabel &&
      ...
      /* harmony default export */ const templates_FieldTemplate =
        FieldTemplate; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/templates/FieldErrorTemplate.js
      //# sourceMappingURL=index.js.map
      ...
      function ObjectFieldTemplate(props) {
        ...
        return (0, jsx_runtime.jsxs)('fieldset', {
          ...
          children: [
            title &&
              (0, jsx_runtime.jsx)(TitleFieldTemplate, {
                id: (0, lib_index_js_.titleId)(idSchema),
                title: title,
                required: required,
                schema: schema,
            ...
            description &&
              (0, jsx_runtime.jsx)(DescriptionFieldTemplate, {
                id: (0, lib_index_js_.descriptionId)(idSchema),
                description: description,
                schema: schema,
                uiSchema: uiSchema,
            ...
            (0, lib_index_js_.canExpand)(schema, uiSchema, formData) &&
              (0, jsx_runtime.jsx)(AddButton, {
      ...
      function TitleField(props) {
        ...
        return (0, jsx_runtime.jsxs)('legend', {
          id: id,
          children: [
            title,
            required &&
              (0, jsx_runtime.jsx)('span', {
                className: 'required',
                children: TitleField_REQUIRED_FIELD_SYMBOL
              })
          ]
        });
      ...
      function UnsupportedField(props) {
        ...
        if (idSchema && idSchema.$id) {
          translateEnum =
            lib_index_js_.TranslatableString.UnsupportedFieldWithId;
        ...
        if (reason) {
          translateEnum =
            translateEnum === lib_index_js_.TranslatableString.UnsupportedField
              ...
              : lib_index_js_.TranslatableString
      ...
      /* harmony default export */ const templates_UnsupportedField =
        UnsupportedField; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/templates/WrapIfAdditionalTemplate.js
      ...
      function WrapIfAdditionalTemplate(props) {
        ...
        const keyLabel = translateString(
          lib_index_js_.TranslatableString.KeyLabel,
          [label]
        );
        ...
        return (0, jsx_runtime.jsx)('div', {
          ...
          children: (0, jsx_runtime.jsxs)('div', {
            ...
            children: [
              ...
              (0, jsx_runtime.jsx)('div', {
                className: 'col-xs-2',
                children: (0, jsx_runtime.jsx)(RemoveButton, {
      ...
      /* harmony default export */ const components_templates = templates; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/widgets/AltDateWidget.js
      //# sourceMappingURL=index.js.map
      ...
      function DateElement({
        ...
        return (0, jsx_runtime.jsx)(SelectWidget, {
          schema: { type: 'integer' },
          id: id,
          name: name,
          className: 'form-control',
          ...
          registry: registry,
          label: '',
          'aria-describedby': (0, lib_index_js_.ariaDescribedByIds)(rootId)
        });
      }
      ...
      function AltDateWidget({
        ...
        const [state, setState] = (0, index_js_.useReducer)(
          (state, action) => {
            return { ...state, ...action };
          },
        ...
        const handleSetNow = (0, index_js_.useCallback)(
          (event) => {
            event.preventDefault();
            if (disabled || readonly) {
              return;
            }
            const nextState = (0, lib_index_js_.parseDateString)(
              new Date().toJSON(),
              time
            );
        ...
        const handleClear = (0, index_js_.useCallback)(
          (event) => {
            event.preventDefault();
            if (disabled || readonly) {
              return;
        ...
        return (0, jsx_runtime.jsxs)('ul', {
          className: 'list-inline',
          children: [
            dateElementProps(state, time, options.yearsRange).map(
              (elemProps, i) =>
                (0, jsx_runtime.jsx)(
                  'li',
                  {
                    className: 'list-inline-item',
                    children: (0, jsx_runtime.jsx)(DateElement, {
                      rootId: id,
                      name: name,
                      select: handleChange,
                      ...elemProps,
            ...
            (options.hideNowButton !== 'undefined'
              ...
              (0, jsx_runtime.jsx)('li', {
                ...
                children: (0, jsx_runtime.jsx)('a', {
                  ...
                  children: translateString(
                    lib_index_js_.TranslatableString.NowLabel
                  )
                })
              }),
            (options.hideClearButton !== 'undefined'
              ...
              (0, jsx_runtime.jsx)('li', {
                ...
                children: (0, jsx_runtime.jsx)('a', {
                  ...
                  onClick: handleClear,
                  children: translateString(
                    lib_index_js_.TranslatableString.ClearLabel
                  )
                })
              })
          ]
      ...
      /* harmony default export */ const widgets_AltDateWidget = AltDateWidget; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/widgets/AltDateTimeWidget.js
      ...
      /* harmony default export */ const widgets_AltDateTimeWidget =
        AltDateTimeWidget; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/widgets/CheckboxWidget.js
      ...
      function CheckboxWidget({
        ...
        const handleBlur = (0, index_js_.useCallback)(
          (event) => onBlur(id, event.target.checked),
          [onBlur, id]
        );
        const handleFocus = (0, index_js_.useCallback)(
            ...
            (0, jsx_runtime.jsxs)('label', {
              children: [
                (0, jsx_runtime.jsx)('input', {
                  ...
                  onBlur: handleBlur,
                  onFocus: handleFocus,
                  'aria-describedby': (0, lib_index_js_.ariaDescribedByIds)(id)
                }),
                (0, lib_index_js_.labelValue)(
      ...
      /* harmony default export */ const widgets_CheckboxWidget =
        CheckboxWidget; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/widgets/CheckboxesWidget.js
      ...
      function CheckboxesWidget({
        ...
        const handleBlur = (0, index_js_.useCallback)(
          ({ target: { value } }) =>
            onBlur(
              id,
              (0, lib_index_js_.enumOptionsValueForIndex)(
                value,
                enumOptions,
                emptyValue
              )
        ...
        return (0, jsx_runtime.jsx)('div', {
          ...
          children:
            ...
            enumOptions.map((option, index) => {
              const checked = (0, lib_index_js_.enumOptionsIsSelected)(
                option.value,
                checkboxesValues
              );
              const itemDisabled =
              ...
              const handleChange = (event) => {
                if (event.target.checked) {
                  onChange(
                    (0, lib_index_js_.enumOptionsSelectValue)(
                      index,
                      checkboxesValues,
                      enumOptions
                    )
                  ...
                  onChange(
                    (0, lib_index_js_.enumOptionsDeselectValue)(
                      index,
                      checkboxesValues,
                      enumOptions
                    )
              ...
              const checkbox = (0, jsx_runtime.jsxs)('span', {
                children: [
                  (0, jsx_runtime.jsx)('input', {
                    type: 'checkbox',
                    id: (0, lib_index_js_.optionId)(id, index),
                    name: id,
                    checked: checked,
                    value: String(index),
                  ...
                  (0, jsx_runtime.jsx)('span', { children: option.label })
                ]
              });
              return inline
                ? (0, jsx_runtime.jsx)(
      ...
      /* harmony default export */ const widgets_CheckboxesWidget =
        CheckboxesWidget; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/widgets/ColorWidget.js
      ...
      function ColorWidget(props) {
        ...
        const BaseInputTemplate = (0, lib_index_js_.getTemplate)(
          'BaseInputTemplate',
          registry,
          options
        );
        return (0, jsx_runtime.jsx)(BaseInputTemplate, {
          type: 'color',
          ...props,
          disabled: disabled || readonly
        });
      ...
      function DateTimeWidget(props) {
        ...
        return (0, jsx_runtime.jsx)(BaseInputTemplate, {
          type: 'datetime-local',
          ...props,
          value: (0, lib_index_js_.utcToLocal)(value),
          onChange: (value) => onChange((0, lib_index_js_.localToUTC)(value))
        });
      ...
      function processFile(file) {
        ...
        return new Promise((resolve, reject) => {
          ...
          reader.onload = (event) => {
            var _a;
            if (
              typeof ((_a = event.target) === null || _a === void 0
                ? void 0
                : _a.result) === 'string'
            ) {
              resolve({
        ...
        return (0, jsx_runtime.jsxs)(jsx_runtime.Fragment, {
          children: [
            ...
            (0, jsx_runtime.jsx)('a', {
              ...
              children: translateString(
                lib_index_js_.TranslatableString.PreviewLabel
              )
            })
          ]
        });
        ...
        return (0, jsx_runtime.jsx)('ul', {
          ...
          children: filesInfo.map((fileInfo, key) => {
            ...
            return (0, jsx_runtime.jsxs)(
              ...
              {
                children: [
                  (0, jsx_runtime.jsx)(index_modern, {
                    children: translateString(
                      lib_index_js_.TranslatableString.FilesInfo,
                      [name, type, String(size)]
                    )
                  }),
                  preview &&
                    (0, jsx_runtime.jsx)(FileInfoPreview, {
                      fileInfo: fileInfo,
                      registry: registry
                    })
                ]
      ...
      function FileWidget(props) {
        ...
        const [filesInfo, setFilesInfo] = (0, index_js_.useState)(
          Array.isArray(value)
        ...
        return (0, jsx_runtime.jsxs)('div', {
          children: [
            (0, jsx_runtime.jsx)(BaseInputTemplate, {
              ...props,
              disabled: disabled || readonly,
              type: 'file',
      ...
      /* harmony default export */ const widgets_FileWidget = FileWidget; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/widgets/HiddenWidget.js
      ...
      /* harmony default export */ const widgets_HiddenWidget = HiddenWidget; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/widgets/PasswordWidget.js
        ...
        return (0, jsx_runtime.jsx)('div', {
          ...
          children:
            ...
            enumOptions.map((option, i) => {
              ...
              const radio = (0, jsx_runtime.jsxs)('span', {
                children: [
                  (0, jsx_runtime.jsx)('input', {
                    type: 'radio',
                    id: (0, lib_index_js_.optionId)(id, i),
                    checked: checked,
                    name: id,
                    required: required,
                    value: String(i),
      ...
      /* harmony default export */ const widgets_RadioWidget = RadioWidget; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/widgets/RangeWidget.js
      ...
      function SelectWidget({
        ...
        const selectedIndexes = (0, lib_index_js_.enumOptionsIndexForValue)(
          value,
          enumOptions,
          multiple
        );
      ...
      /* harmony default export */ const widgets_SelectWidget = SelectWidget; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/widgets/TextareaWidget.js
      ...
      /* harmony default export */ const widgets_TextareaWidget =
        TextareaWidget; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/components/widgets/TextWidget.js
      ...
      /* harmony default export */ const components_widgets = widgets; // CONCATENATED MODULE: ./node_modules/@rjsf/core/lib/getDefaultRegistry.js
      //# sourceMappingURL=index.js.map
      ...
      class Form_Form extends index_js_.Component {
        ...
        constructor(props) {
            ...
            const getAllPaths = (_obj, acc = [], paths = [[]]) => {
              Object.keys(_obj).forEach((key) => {
                if (typeof _obj[key] === 'object') {
                  ...
                  if (
                    _obj[key][lib_index_js_.RJSF_ADDITONAL_PROPERTIES_FLAG] &&
                    _obj[key][lib_index_js_.NAME_KEY] !== ''
                  ) {
          ...
          this.onChange = (formData, newErrorSchema, id) => {
            ...
            if (
              (0, lib_index_js_.isObject)(formData) ||
            ...
            if (mustValidate) {
              ...
              if (extraErrors) {
                const merged = (0, lib_index_js_.validationDataMerge)(
                  schemaValidation,
                  extraErrors
                );
          ...
          this.onSubmit = (event) => {
            ...
            if (noValidate || this.validateForm()) {
              ...
              const errors = extraErrors
                ? (0, lib_index_js_.toErrorList)(extraErrors)
                : [];
              this.setState(
                {
                  formData: newFormData,
        ...
        getSnapshotBeforeUpdate(prevProps, prevState) {
          if (!(0, lib_index_js_.deepEquals)(this.props, prevProps)) {
            ...
            const shouldUpdate = !(0, lib_index_js_.deepEquals)(
              nextState,
              prevState
            );
        ...
        getStateFromProps(props, inputFormData, retrievedSchema) {
          ...
          if (
            ...
            schemaUtils = (0, lib_index_js_.createSchemaUtils)(
              props.validator,
              rootSchema,
              experimental_defaultFormStateBehavior
            );
          ...
          const _retrievedSchema =
            retrievedSchema !== null && retrievedSchema !== void 0
              ? retrievedSchema
        ...
        renderErrors(registry) {
          ...
          const options = (0, lib_index_js_.getUiOptions)(uiSchema);
          const ErrorListTemplate = (0, lib_index_js_.getTemplate)(
            'ErrorListTemplate',
            registry,
            options
          );
          if (errors && errors.length) {
            return (0, jsx_runtime.jsx)(ErrorListTemplate, {
              errors: errors,
              errorSchema: errorSchema || {},
              schema: schema,
              uiSchema: uiSchema,
          ...
          return {
            ...
            templates: {
              ...
              ButtonTemplates: {
                ...
                ...((_a = this.props.templates) === null || _a === void 0
                  ? void 0
                  : _a.ButtonTemplates)
              }
            },
        ...
        render() {
          ...
          let { [lib_index_js_.SUBMIT_BTN_OPTIONS_KEY]: submitOptions = {} } =
            (0, lib_index_js_.getUiOptions)(uiSchema);
          if (disabled) {
            submitOptions = {
              ...submitOptions,
          ...
          const submitUiSchema = {
            [lib_index_js_.UI_OPTIONS_KEY]: {
              [lib_index_js_.SUBMIT_BTN_OPTIONS_KEY]: submitOptions
            }
          };
          return (0, jsx_runtime.jsxs)(FormTag, {
            ...
            children: [
              ...
              children
                ? children
                : (0, jsx_runtime.jsx)(SubmitButton, {
            ...
            templates = {
              ...
              ButtonTemplates: {
                ...((_a =
                  themeProps === null || themeProps === void 0
                    ? void 0
                    : themeProps.templates) === null || _a === void 0
                  ? void 0
                  : _a.ButtonTemplates),
    ...
    /***/ 78510: /***/ (
      ...
      function stylize(selector, styles, rulesList, stylesList, parent) {
        const { style, nested, isUnique } = parseStyles(
          styles,
          selector !== ''
        );
        let pid = style;
        if (selector.charCodeAt(0) === 64 /* @ */) {
          ...
          for (const [name, value] of nested) {
            pid +=
              name + stylize(name, value, child.rules, child.styles, parent);
          }
        } else {
    ...
    /***/ 73357: /***/ (
      ...
      var baseUnset = __webpack_require__(19931);
    ...
    /***/ 5338: /***/ (
      ...
      var m = __webpack_require__(86672);
      if (true) {
    ...
    /***/ 21326: /***/ (
      ...
      var typestyle_1 = __webpack_require__(46379);
      __webpack_unused_export__ = typestyle_1.TypeStyle;
      /**
       * All the CSS types in the 'types' namespace
       */
      var types = __webpack_require__(12451);
      __webpack_unused_export__ = types;
      /**
       * Export certain utilities
       */
      var utilities_1 = __webpack_require__(14798);
    ...
    /***/ 64591: /***/ (__unused_webpack_module, exports) => {
      'use strict';
    ...
    /***/ 46379: /***/ (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      var FreeStyle = __webpack_require__(78510);
      var formatting_1 = __webpack_require__(64591);
      var utilities_1 = __webpack_require__(14798);
      /**
      ...
      var TypeStyle = /** @class */ (function () {
        function TypeStyle(_a) {
          ...
          this.cssRule = function (selector) {
            ...
            var styles = formatting_1.convertToStyles(
              utilities_1.extend.apply(void 0, objects)
            );
        ...
        TypeStyle.prototype.style = function () {
          var className = this._freeStyle.registerStyle(
            formatting_1.convertToStyles(
              utilities_1.extend.apply(undefined, arguments)
            )
          );
          this._styleUpdated();
          return className;
    ...
    /***/ 14798: /***/ (__unused_webpack_module, exports) => {
      'use strict';
      ...
      function extend() {
        ...
        for (var _a = 0, objects_1 = objects; _a < objects_1.length; _a++) {
          ...
          for (var key in object) {
            ...
            if (key === '$nest' && val) {
              result[key] = result['$nest']
                ? extend(result['$nest'], val)
                : val;
      ...
      exports.media = function (mediaQuery) {
        ...
        if (mediaQuery.orientation)
          mediaQuerySections.push(
            '(orientation: ' + mediaQuery.orientation + ')'
          );
        if (mediaQuery.minWidth)
          mediaQuerySections.push(
            '(min-width: ' + mediaLength(mediaQuery.minWidth) + ')'
          );
        if (mediaQuery.maxWidth)
          mediaQuerySections.push(
            '(max-width: ' + mediaLength(mediaQuery.maxWidth) + ')'
          );
        if (mediaQuery.minHeight)
          mediaQuerySections.push(
            '(min-height: ' + mediaLength(mediaQuery.minHeight) + ')'
          );
        if (mediaQuery.maxHeight)
          mediaQuerySections.push(
            '(max-height: ' + mediaLength(mediaQuery.maxHeight) + ')'
          );
        if (mediaQuery.prefersColorScheme)
          mediaQuerySections.push(
            '(prefers-color-scheme: ' + mediaQuery.prefersColorScheme + ')'
          );
    ...
    /***/ 12451: /***/ (__unused_webpack_module, exports) => {
      'use strict';
...
//# sourceMappingURL=5829.8027c18c8cb3fc97243c.js.map?v=8027c18c8cb3fc97243c
