...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [9400],
  {
    /***/ 42519: /***/ function (
      ...
      var DOMAdaptor_js_1 = __webpack_require__(21747);
      var HTMLAdaptor = (function (_super) {
        ...
        HTMLAdaptor.prototype.insertRules = function (node, rules) {
          ...
          try {
            for (
              var _b = __values(rules.reverse()), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var rule = _c.value;
    ...
    /***/ 59400: /***/ (
      ...
      var HTMLAdaptor_js_1 = __webpack_require__(42519);
    ...
    /***/ 21747: /***/ function (__unused_webpack_module, exports) {
      var __values =
        (this && this.__values) ||
        function (o) {
          var s = typeof Symbol === 'function' && Symbol.iterator,
      ...
      var AbstractDOMAdaptor = (function () {
        ...
        AbstractDOMAdaptor.prototype.setAttributes = function (node, def) {
          ...
          if (def.style && typeof def.style !== 'string') {
            try {
              for (
                var _d = __values(Object.keys(def.style)), _e = _d.next();
                !_e.done;
                _e = _d.next()
              ) {
                var key = _e.value;
                this.setStyle(
                  node,
                  key.replace(/-([a-z])/g, function (_m, c) {
          ...
          if (def.properties) {
            try {
              for (
                var _f = __values(Object.keys(def.properties)), _g = _f.next();
                !_g.done;
                _g = _f.next()
              ) {
                var key = _g.value;
          ...
          try {
            for (
              var _h = __values(Object.keys(def)), _j = _h.next();
              !_j.done;
              _j = _h.next()
            ) {
              var key = _j.value;
...
//# sourceMappingURL=9400.ccd08375fbf1cdc977df.js.map?v=ccd08375fbf1cdc977df
