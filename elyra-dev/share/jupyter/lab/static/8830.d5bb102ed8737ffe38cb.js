  ...
  [8830],
  {
    68830: (e, t, n) => {
      ...
      function s(e) {
        var t = 'error';
        var n =
          e.delimiters || e.singleDelimiters || /^[\(\)\[\]\{\}@,:`=;\.\\]/;
        var s = [
          e.singleOperators,
          e.doubleOperators,
          e.doubleDelimiters,
        ...
        function v(e, r, a) {
          ...
          for (var u = 0; u < s.length; u++)
            if (e.match(s[u])) return 'operator';
        ...
        function k(n, r) {
          while ('rubf'.indexOf(n.charAt(0).toLowerCase()) >= 0)
            n = n.substr(1);
          var i = n.length == 1;
          var a = 'string';
          function o(e) {
        ...
        function _(e, t) {
          ...
          t.scopes.push({
            offset: l(t).offset + e.indentUnit,
            type: 'py',
            align: null
          });
        }
        function w(e, t, n) {
          ...
          t.scopes.push({
            offset: t.indent + (u || e.indentUnit),
            type: n,
            align: r
          });
        }
        ...
        function F(e, n) {
          ...
          if (n.beginningOfLine && i == '@')
            return e.match(m, false) ? 'meta' : d ? 'operator' : t;
          if (/\S/.test(i)) n.beginningOfLine = false;
          if ((r == 'variable' || r == 'builtin') && n.lastToken == 'meta')
            r = 'meta';
          ...
          if (n.dedent && e.eol() && l(n).type == 'py' && n.scopes.length > 1)
            n.scopes.pop();
          return r;
        }
        return {
          ...
          token: function (e, n) {
            ...
            if (i && i != 'comment')
              n.lastToken =
                i == 'keyword' || i == 'punctuation' ? e.current() : i;
