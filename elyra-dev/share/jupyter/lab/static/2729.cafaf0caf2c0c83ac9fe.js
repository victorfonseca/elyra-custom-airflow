...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [2729],
  {
    22729: (O, e, t) => {
      ...
      function Q(O, e) {
        let t;
        if ((t = O.message.match(/at position (\d+)/)))
          return Math.min(+t[1], e.length);
        if ((t = O.message.match(/at line (\d+) column (\d+)/)))
          return Math.min(e.line(+t[1]).from + +t[2] - 1, e.length);
        return 0;
      }
      const i = o.LRLanguage.define({
        ...
        parser: s.configure({
          props: [
            o.indentNodeProp.add({
              Object: (0, o.continuedIndent)({ except: /^\s*\}/ }),
              Array: (0, o.continuedIndent)({ except: /^\s*\]/ })
            }),
