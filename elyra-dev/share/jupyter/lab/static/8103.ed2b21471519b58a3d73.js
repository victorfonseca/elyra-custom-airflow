  ...
  [8103],
  {
    88103: (O, Q, e) => {
      ...
      const f = new a.Lu(
        (O, Q) => {
          let { next: e } = O;
          if ((e == c || e == -1 || Q.context) && Q.canShift(S))
            O.acceptToken(S);
        },
      ...
      const h = new a.Lu(
        (O, Q) => {
          ...
          if (e != c && e != X && e != -1 && !Q.context && Q.canShift(t))
            O.acceptToken(t);
        },
        { contextual: true }
      );
      ...
      const W = (0, i.styleTags)({
        ...
        'CallExpression/VariableName TaggedTemplateExpression/VariableName':
          i.tags.function(i.tags.variableName),
        ...
        'CallExpression/MemberExpression/PropertyName': i.tags.function(
          i.tags.propertyName
        ),
        'FunctionDeclaration/VariableDefinition': i.tags.function(
          i.tags.definition(i.tags.variableName)
        ),
        'ClassDeclaration/VariableDefinition': i.tags.definition(
          i.tags.className
        ),
        PropertyDefinition: i.tags.definition(i.tags.propertyName),
        PrivatePropertyDefinition: i.tags.definition(
          i.tags.special(i.tags.propertyName)
        ),
      ...
      function A(O) {
        ...
        let e =
          Q.name == 'VariableName' ||
          (Q.to - Q.from < 20 && I.test(O.state.sliceDoc(Q.from, Q.to)));
      ...
      function J(O, Q, e) {
        ...
        for (;;) {
          let t = Q.firstChild,
            $;
          if (
            (t === null || t === void 0 ? void 0 : t.name) == 'VariableName'
          ) {
            i.push(O(t));
      ...
      function L(O) {
        ...
        if (e.name == 'PropertyName') {
          ...
          (e.name == '.' || e.name == '?.') &&
          e.parent.name == 'MemberExpression'
        ) {
          return J(Q, e.parent, '');
      ...
      function N(O, Q) {
        ...
        for (let t = 0; ; t++) {
          for (let r of (Object.getOwnPropertyNames || Object.keys)(O)) {
            if (!/^[a-zA-Z_$\xaa-\uffdc][\w$\xaa-\uffdc]*$/.test(r) || a.has(r))
              continue;
            a.add(r);
            let $;
            try {
        ...
        parser: x.configure({
          props: [
            d.indentNodeProp.add({
              ...
              TryStatement: (0, d.continuedIndent)({
      ...
      const M = B.configure({
        dialect: 'jsx',
        props: [d.sublanguageProp.add((O) => (O.isTop ? [H] : undefined))]
      });
      const F = B.configure(
        {
          dialect: 'jsx ts',
      ...
      const QO =
        'break case const continue default delete export extends false finally in instanceof let new return static super switch this throw true typeof var yield'
          ...
          .map(OO);
      const eO = QO.concat(
        ['declare', 'implements', 'private', 'protected', 'public'].map(OO)
      );
      function aO(O = {}) {
        let Q = O.jsx ? (O.typescript ? F : M) : O.typescript ? K : B;
        let e = O.typescript ? _.concat(eO) : k.concat(QO);
        return new d.LanguageSupport(Q, [
          B.data.of({ autocomplete: (0, v.Ar)(E, (0, v.et)(e)) }),
          B.data.of({ autocomplete: A }),
          O.jsx ? rO : []
        ]);
      }
      function iO(O) {
      ...
      function tO(O, Q, e = O.length) {
        for (
          let a = Q === null || Q === void 0 ? void 0 : Q.firstChild;
          a;
          a = a.nextSibling
        ) {
          if (
      ...
      const rO = w.EditorView.inputHandler.of((O, Q, e, a, i) => {
        if (
          ($O ? O.composing : O.compositionStarted) ||
          O.state.readOnly ||
          Q != e ||
          (a != '>' && a != '/') ||
          !B.isActiveAt(O.state, Q, -1)
        )
          return false;
        let t = i(),
          { state: $ } = t;
        let r = $.changeByRange((O) => {
          ...
          if (
            $.doc.sliceString(e - 1, e) != a ||
            (i.name == 'JSXAttributeValue' && i.to > e)
          );
            ...
            if (
              a &&
              O.from == e - 2 &&
              ((t = tO($.doc, a.firstChild, e)) ||
                ((Q = a.firstChild) === null || Q === void 0
                  ? void 0
                  : Q.name) == 'JSXFragmentTag')
            ) {
              let O = `${t}>`;
              return {
                range: j.EditorSelection.cursor(e + O.length, -1),
                changes: { from: e, insert: O }
              };
            }
          } else if (a == '>') {
            let Q = iO(i);
        ...
        O.dispatch([
          t,
          $.update(r, { userEvent: 'input.complete', scrollIntoView: true })
        ]);
        return true;
      });
      function SO(O, Q) {
        ...
        return (e) => {
          ...
          for (let { from: t, to: $ } of B.findRegions(a)) {
            ...
            for (let S of O.verify(a.sliceDoc(t, $), Q))
              i.push(PO(S, a.doc, r));
          }
          return i;
        };
      ...
      function PO(O, Q, e) {
        ...
        let i = {
          from: a,
          to:
            O.endLine != null && O.endColumn != 1
              ? nO(O.endLine, O.endColumn, Q, e)
              : a,
          message: O.message,
          ...
          i.actions = [
            {
              ...
              apply(O, Q) {
                O.dispatch({
                  changes: { from: Q + $, to: Q + r, insert: t },
                  scrollIntoView: true
                });
              }
            }
