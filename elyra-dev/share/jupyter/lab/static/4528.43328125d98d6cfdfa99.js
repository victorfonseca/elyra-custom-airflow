  ...
  [4528],
  {
    24528: (e, t, n) => {
      ...
      function a(e, t, n, a) {
        ...
        return (e.context = new r(i, t, n, a, null, e.context));
      }
      function i(e) {
      ...
      function o(e, t, n) {
        ...
        if (/\S(?:[^- ]>|[*\]])\s*$|\*$/.test(e.string.slice(0, n)))
          return true;
      ...
      function s(e) {
        var t = e.statementIndentUnit,
          ...
          m = e.atoms || {},
          h = e.hooks || {},
          y = e.multiLineStrings,
          g = e.indentStatements !== false,
          k = e.indentSwitch !== false,
          b = e.namespaceSeparator,
          w = e.isPunctuationChar || /[\[\]{}\(\),;\:\.]/,
          v = e.numberStart || /[\d\.]/,
          _ =
            e.number ||
            /^(?:0x[a-f\d]+|0b[01]+|(?:\d+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i,
          x = e.isOperatorChar || /[+\-*&%=<>!?|\/]/,
          S = e.isIdentifierChar || /[\w\$_\xa1-\uffff]/,
          T = e.isReservedIdentifier || false;
        var N, C;
        function I(e, t) {
          var n = e.next();
          if (h[n]) {
          ...
          if (x.test(n)) {
            while (!e.match(/^\/[\/*]/, false) && e.eat(x)) {}
            return 'operator';
          }
          e.eatWhile(S);
          if (b) while (e.match(b)) e.eatWhile(S);
          var a = e.current();
          if (u(s, a)) {
            if (u(d, a)) N = 'newstatement';
            if (u(p, a)) C = true;
            return 'keyword';
          }
          if (u(c, a)) return 'type';
          if (u(f, a) || (T && T(a))) {
            if (u(d, a)) N = 'newstatement';
            return 'builtin';
          }
          if (u(m, a)) return 'atom';
          return 'variable';
        }
        function D(e) {
          return function (t, n) {
        ...
        function L(t, n) {
          if (e.typeFirstDefinitions && t.eol() && l(n.context))
            n.typeAtEndOfLine = o(t, n, t.pos);
        }
        return {
          name: e.name,
          startState: function (e) {
            return {
              tokenize: null,
              context: new r(-e, 0, 'top', null, false),
              indented: 0,
              startOfLine: true,
              prevToken: null
            };
          ...
          token: function (t, n) {
            ...
            if (
              ...
              while (n.context.type == 'statement') i(n);
            else if (N == '{') a(n, t.column(), '}');
            else if (N == '[') a(n, t.column(), ']');
            else if (N == '(') a(n, t.column(), ')');
            else if (N == '}') {
              while (r.type == 'statement') r = i(n);
              if (r.type == '}') r = i(n);
              while (r.type == 'statement') r = i(n);
            } else if (N == r.type) i(n);
            else if (
              g &&
              (((r.type == '}' || r.type == 'top') && N != ';') ||
                (r.type == 'statement' && N == 'newstatement'))
            ) {
              a(n, t.column(), 'statement', t.current());
            }
            if (
              s == 'variable' &&
              (n.prevToken == 'def' ||
            ...
            if (s == 'def' && e.styleDefs === false) s = 'variable';
            n.startOfLine = false;
            n.prevToken = C ? 'def' : s || N;
            L(t, n);
            return s;
          },
          indent: function (r, a, i) {
            if (
              (r.tokenize != I && r.tokenize != null) ||
              (r.typeAtEndOfLine && l(r.context))
            )
              return null;
            var o = r.context,
              s = a && a.charAt(0);
            ...
            if (e.dontIndentStatements)
              while (
                o.type == 'statement' &&
                e.dontIndentStatements.test(o.info)
              )
                o = o.prev;
            if (h.indent) {
              var u = h.indent(r, o, a, i.unit);
              if (typeof u == 'number') return u;
            }
            var f = o.prev && o.prev.info == 'switch';
            if (e.allmanIndentation && /[{(]/.test(s)) {
              while (o.type != 'top' && o.type != '}') o = o.prev;
              return o.indented;
            }
            if (o.type == 'statement')
              return o.indented + (s == '{' ? 0 : t || i.unit);
            if (o.align && (!n || o.type != ')')) return o.column + (c ? 0 : 1);
            if (o.type == ')' && !c) return o.indented + (t || i.unit);
            return (
              o.indented +
              (c ? 0 : i.unit) +
              (!c && f && !/^(?:case|default)\b/.test(a) ? i.unit : 0)
            );
          },
          languageData: {
            indentOnInput: k
      ...
      var y = c('SEL instancetype id Class Protocol BOOL');
      function g(e) {
        return u(h, e) || /.+_t$/.test(e);
      }
      function k(e) {
        return g(e) || u(y, e);
      }
      var b = 'case do else for if switch while struct enum union';
      var w = 'struct enum union';
      function v(e, t) {
      ...
      const z = s({
        ...
        defKeywords: c(w + ' class namespace'),
        typeFirstDefinitions: true,
      ...
      function R(e) {
        return function (t, n) {
          ...
          while (!t.eol()) {
            ...
            a = t.next();
            if (!r && a == '$' && t.match('{')) t.skipTo('}');
            r = !r && a == '\\' && !e;
          }
          if (i || !e) n.tokenize = null;
          return 'string';
        };
      }
      const O = s({
          ...
          indent: function (e, t, n, r) {
            ...
            if (
              (e.prevToken == 'operator' &&
                n != '}' &&
                e.context.type != '}') ||
              (e.prevToken == 'variable' && a == '.') ||
              ((e.prevToken == '}' || e.prevToken == ')') && a == '.')
            )
      ...
      const U = s({
        ...
        builtin: c(m),
        blockKeywords: c(
          b + ' @synthesize @try @catch @finally @autoreleasepool @synchronized'
        ),
        defKeywords: c(w + ' @interface @implementation @protocol @class'),
      ...
      const V = s({
        ...
        hooks: {
          ...
          '"': function (e, t) {
            t.tokenize = q(e.match('""') ? 'triple' : 'single');
            return t.tokenize(e, t);
          },
          '`': function (e, t) {
            if (!K || !e.match('`')) return false;
            t.tokenize = K;
            K = null;
            return t.tokenize(e, t);
          },
          "'": function (e) {
            if (e.match(/^(\\[^'\s]+|[^\\'])'/)) return 'string.special';
            e.eatWhile(/[\w\$_\xa1-\uffff]/);
            return 'atom';
          },
          token: function (e, t, n) {
      ...
      const H = s({
        ...
        hooks: {
          ...
          token: function (e, t, n) {
            if (n == 'variable') {
              var r = RegExp('^[_$]*[A-Z][a-zA-Z0-9_$]*$', 'g');
              if (r.test(e.current())) {
                return 'type';
              }
            }
