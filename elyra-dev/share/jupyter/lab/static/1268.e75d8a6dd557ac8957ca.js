  ...
  [1268],
  {
    91268: (e, t, s) => {
      ...
      class v extends $ {
        ...
        toString() {
          return (
            this.id.name + (this.args.length ? `<${this.args.join()}>` : '')
          );
        }
        eq(e) {
      ...
      class S extends $ {
        ...
        eq(e) {
          return (
            this.type == e.type &&
            E.eqProps(this.props, e.props) &&
            D(this.token, e.token) &&
            D(this.content, e.content)
          );
        }
        walk(e) {
          ...
          return e(
            t == this.token && s == this.content
              ? this
              : new S(this.start, this.type, this.props, t, s)
          );
        }
      }
      class T extends $ {
        ...
        walk(e) {
          ...
          return e(
            s == t.expr
              ? this
              : new T(this.start, new u(t.start, t.id, t.props, [], s))
          );
        }
      }
      class O extends $ {
        ...
        walk(e) {
          ...
          return e(t == this.exprs ? this : new O(this.start, t));
        }
      }
      O.prototype.prec = 1;
      class R extends $ {
        ...
        toString() {
          return this.empty
            ? '()'
            : this.exprs.map((e) => _(e, this)).join(' ');
        }
        eq(e) {
          return (
        ...
        walk(e) {
          ...
          return e(
            t == this.exprs
              ? this
              : new R(this.start, t, this.markers, this.empty && !t.length)
          );
        }
      }
      R.prototype.prec = 2;
      ...
      class E extends a {
        ...
        eq(e) {
          return (
            ...
            this.value.every(
              (t, s) => t.value == e.value[s].value && t.name == e.value[s].name
            )
          );
        }
        toString() {
          ...
          if (this.value.length) {
            e += '=';
            for (let { name: t, value: s } of this.value)
              e += t ? `{${t}}` : /[^\w-]/.test(s) ? JSON.stringify(s) : s;
          }
          return e;
        }
        static eqProps(e, t) {
      ...
      class F {
        ...
        get nodeType() {
          return (
            this.top || this.nodeName != null || U(this.props) || this.repeated
          );
        }
        get terminal() {
        ...
        finish(e) {
          ...
          this.terms = this.terms.filter(
            (t) =>
              t.terminal ||
              t.preserve ||
              e.some((e) => e.name == t || e.parts.includes(t))
          );
          let t = {};
          let s = [this.error];
          this.error.id = 0;
      ...
      const K = [];
      class Y {
        constructor(e, t = K, s = 0) {
          this.precedence = e;
          this.ambigGroups = t;
          this.cut = s;
        }
        join(e) {
          if (this == Y.none || this == e) return e;
          if (e == Y.none) return this;
          return new Y(
            Math.max(this.precedence, e.precedence),
            Z(this.ambigGroups, e.ambigGroups),
            Math.max(this.cut, e.cut)
          );
        }
        cmp(e) {
          return (
            this.precedence - e.precedence ||
            W(this.ambigGroups, e.ambigGroups, (e, t) =>
              e < t ? -1 : e > t ? 1 : 0
            ) ||
            this.cut - e.cut
          );
      ...
      class Q {
        ...
        sameReduce(e) {
          return (
            this.name == e.name &&
            this.parts.length == e.parts.length &&
            this.isRepeatWrap == e.isRepeatWrap
          );
        }
      }
      const V = 65535;
      ...
      let re = class e {
        ...
        closure() {
          ...
          function s(i) {
            ...
            t[i.id] = true;
            if (
              i.edges.some((e) => e.from >= 0) ||
              (i.accepting.length > 0 &&
                !i.edges.some((e) => ue(i.accepting, e.target.accepting)))
            )
              e.push(i);
        ...
        findConflicts(e) {
          ...
          this.reachable((t, n) => {
            ...
            for (let e = 0; e < t.accepting.length; e++)
              for (let s = e + 1; s < t.accepting.length; s++)
                i(t.accepting[e], t.accepting[s], 0, n);
            t.reachable((r, l) => {
              if (r != t)
                for (let a of r.accepting) {
                  let r = s.includes(a);
                  for (let o of t.accepting)
                    if (a != o)
                      i(
                        a,
                        o,
                        r || s.includes(o) || !e(a, o) ? 0 : 1,
                        n,
                        n.concat(l)
                      );
                }
        ...
        toString() {
          let e = 'digraph {\n';
          this.reachable((t) => {
            if (t.accepting.length)
              e += `  ${t.id} [label=${JSON.stringify(t.accepting.join())}];\n`;
      ...
      function fe(e) {
        ...
        if (i.length) {
          let e = [];
          for (let t of i)
            for (let s of t.target.closure()) if (!e.includes(s)) e.push(s);
      ...
      class de {
        ...
        next() {
          ...
          if (t == '"') {
            ...
            if (!s)
              return this.raise('Unexpected character ' + JSON.stringify(t), e);
        ...
        unexpected() {
          return this.raise(
            `Unexpected token '${this.string.slice(this.start, this.end)}'`,
            this.start
          );
        }
        expect(e, t = null) {
      ...
      function ye(e) {
        let t = e.start;
        if (e.eat('(')) {
          if (e.eat(')')) return new R(t, pe, [pe, pe]);
          let s = Re(e);
          e.expect(')');
          return s;
          ...
          let s = e.value;
          e.next();
          if (s.length == 0) return new R(t, pe, [pe, pe]);
          return new N(t, s);
        } else if (e.eat('id', '_')) {
          return new z(t);
        } else if (e.type == 'set') {
          ...
          e.type == 'at' &&
          (e.value == 'specialize' || e.value == 'extend')
        ) {
          ...
          if (e.eat(',')) {
            ...
            e.raise(
              `@${s} requires two arguments when its first argument isn't a literal string`
            );
          }
          e.expect('>');
          ...
          if (s.params.length)
            e.raise(`Inline rules can't have parameters`, s.start);
          return new T(t, s);
        } else {
          let s = Pe(e);
          if (e.type == '[' || e.type == '{') {
            let i = ge(e, s);
            if (i.params.length)
              e.raise(`Inline rules can't have parameters`, i.start);
            return new T(t, i);
          } else {
      ...
      function ve(e, t, s, i) {
        if (!t.every(([e, t]) => t <= s || e >= i))
          e.raise('Overlapping character range', e.start);
        t.push([s, i]);
      }
      function Se(e) {
        let t = e.start;
      ...
      function Re(e) {
        ...
        let n = i.find((e) => e instanceof R && e.empty);
        if (n)
          e.raise(
      ...
      function Ce(e) {
        ...
        e.expect('{');
        let s = ye(e);
        if (!(s instanceof N || s instanceof v))
          e.raise(`Invalid expression in token conflict`, s.start);
        e.eat(',');
        let i = ye(e);
        if (!(i instanceof N || i instanceof v))
          e.raise(`Invalid expression in token conflict`, i.start);
        e.expect('}');
        return new c(t, s, i);
      }
      function Ie(e) {
      ...
      function Je(e) {
        let t =
          /\\(?:u\{([\da-f]+)\}|u([\da-f]{4})|x([\da-f]{2})|([ntbrf0])|(.))|[^]/giy;
        let s = '',
          i;
        while ((i = t.exec(e))) {
          let [e, t, n, r, l, a] = i;
      ...
      class Le {
        ...
        get next() {
          return this.pos < this.rule.parts.length
            ? this.rule.parts[this.pos]
            : null;
        }
        advance() {
          return new Le(
        ...
        cmp(e) {
          return (
            ...
            W(this.ambigAhead, e.ambigAhead, Ye)
          );
        }
        eqSimple(e) {
        ...
        eq(e) {
          return (
            ...
            (this.hash == e.hash &&
              ...
              Qe(this.ahead, e.ahead) &&
              Qe(this.ambigAhead, e.ambigAhead))
          );
        }
        trail(e = 60) {
          let t = [];
        ...
        conflicts(e = this.pos) {
          ...
          if (e == this.rule.parts.length && this.ambigAhead.length)
            t = t.join(new Y(0, this.ambigAhead));
          return t;
        }
      ...
      class Ve {
        ...
        eq(e) {
          return (
            e instanceof Ve &&
            this.term == e.term &&
            e.target.id == this.target.id
          );
        }
        cmp(e) {
          return e instanceof Xe
            ? -1
            : this.term.id - e.term.id || this.target.id - e.target.id;
        }
        matches(e, t) {
          return e instanceof Ve && t[e.target.id] == t[this.target.id];
        }
        toString() {
        ...
        map(e, t) {
          ...
          return s == this.target ? this : new Ve(this.term, s);
        }
      }
      class Xe {
        constructor(e, t) {
        ...
        eq(e) {
          return (
            e instanceof Xe &&
            this.term == e.term &&
            e.rule.sameReduce(this.rule)
          );
        }
        cmp(e) {
          return e instanceof Ve
            ? 1
            : this.term.id - e.term.id ||
                this.rule.name.id - e.rule.name.id ||
                this.rule.parts.length - e.rule.parts.length;
        }
        matches(e, t) {
      ...
      class st {
        ...
        toString() {
          let e =
            this.actions.map((e) => e.term + '=' + e).join(',') +
            (this.goto.length
              ? ' | ' + this.goto.map((e) => e.term + '=' + e).join(',')
              : '');
          return (
            this.id +
            ': ' +
        ...
        addActionInner(e, t) {
          e: for (let s = 0; s < this.actions.length; s++) {
            ...
            if (i.term == e.term) {
              ...
              let l = We(n),
                a = We(r);
              let o = Ke(n, r) || l.precedence - a.precedence;
              if (o > 0) {
        ...
        addAction(e, t, s) {
          ...
          if (i) {
            ...
            if (s.conflicts.some((e) => e.rules.some((e) => r.includes(e))))
              return;
            let l;
            if (i instanceof Ve)
              l = `shift/reduce conflict between\n  ${n}\nand\n  ${t[0].rule}`;
            else
              l = `reduce/reduce conflict between\n  ${n.rule}\nand\n  ${t[0].rule}`;
            l += `\nWith input:\n  ${t[0].trail(70)} · ${e.term} …`;
            if (i instanceof Ve) l += ut(t[0], i.term, s.first);
            l += ot(n, t[0]);
        ...
        finish() {
          if (this.actions.length) {
            ...
            if (e instanceof Xe) {
              ...
              if (
                this.actions.every(
                  (e) => e instanceof Xe && e.rule.sameReduce(t)
                )
              )
                this.defaultReduce = t;
            }
          }
        ...
        eq(e) {
          ...
          return (
            this.skip == e.skip &&
            this.tokenGroup == e.tokenGroup &&
            He(this.actions, e.actions) &&
            He(this.goto, e.goto)
          );
        }
      }
      function it(e, t) {
        ...
        function n(t, n, r, l, a) {
          for (let o of t.rules) {
            ...
            if (t.skipAhead != l)
              throw new B('Inconsistent skip sets after ' + a.trail());
            t.ambigAhead = Z(t.ambigAhead, r);
            for (let e of n)
        ...
        for (let l of e) {
          ...
          if (e && !e.terminal)
            n(
              e,
              Ze(l.rule, l.pos, l.ahead, t),
              l.conflicts(l.pos + 1).ambigGroups,
              l.pos == l.rule.parts.length - 1 ? l.skipAhead : l.rule.skip,
              l
            );
        }
        while (i.length) {
          ...
          n(
            e.rule.parts[0],
            Ze(e.rule, 0, e.ahead, t),
            Z(
              e.rule.conflicts[1].ambigGroups,
              e.rule.parts.length == 1 ? e.ambigAhead : xt
            ),
      ...
      function ut(e, t, s) {
        ...
        function l(i, a, o) {
          ...
          for (let e; (e = i.next); ) {
            ...
            if (u && (u.terminal ? u == t : s[u.name].includes(t)))
              h = i.advance();
      ...
      function ht(e, t, s) {
        ...
        function a(e, t) {
          ...
          for (let s of e) {
            if (!u) u = s.skip;
              ...
              throw new B('Inconsistent skip sets after ' + s.trail());
          }
          if (o)
            for (let s of o)
              if (He(e, s.set)) {
                if (s.state.skip != u)
                  throw new B(
                    'Inconsistent skip sets after ' + s.set[0].trail()
                  );
                return s.state;
              }
          let h = it(e, s);
          ...
          if (!p) {
            ...
            c.push(p);
            i.push(p);
            if (Me && i.length % 500 == 0)
              console.log(
                `${i.length} states after ${((Date.now() - l) / 1e3).toFixed(2)}s`
              );
          }
        ...
        for (let u = 0; u < i.length; u++) {
          ...
          for (let s = 0; s < t.length; s++) {
            ...
            if (i.terminal) {
              let t = ft(r);
              let l = a(t);
              if (l) e.addAction(new Ve(i, l), n[s], o);
            } else {
              let t = a(r);
              if (t) e.goto.push(new Ve(i, t));
            }
          }
          let l = false;
          for (let s of r)
          ...
          if (l)
            for (let i = 0; i < e.goto.length; i++) {
              ...
              if (
                !t.some((t) =>
                  e.actions.some((e) => e.term == t && e instanceof Ve)
                )
              )
                e.goto.splice(i--, 1);
            }
        ...
        if (o.conflicts.length)
          throw new B(o.conflicts.map((e) => e.error).join('\n\n'));
      ...
      function ct(e, t, s) {
        for (let n of e.goto)
          for (let e of t.goto) {
            if (n.term == e.term && s[n.target.id] != s[e.target.id])
              return false;
          }
        ...
        for (let n of e.actions) {
          ...
          if (t && t.some((e) => !e.matches(n, s))) {
            ...
            if (
              i.length != t.length ||
              i.some((e) => !t.some((t) => e.matches(t, s)))
            )
              return false;
          }
        }
      ...
      function mt(e, t) {
        ...
        for (let s = 0; s < e.length; s++)
          if (!e[s].eqSimple(t[s])) return false;
        return true;
      }
      function gt(e) {
        let t = [],
        ...
        function i(i, n) {
          ...
          for (let o = i + 1; o < s.length; o++) {
            ...
            if (
              s[o].origin == r.origin &&
              s[o].members.every((s) => ct(l, e[s], t))
            ) {
        ...
        for (let n = 1; ; n++) {
          ...
          if (Me)
            console.log(
              `Collapse pass ${n}${r ? `` : `, done`} (${((Date.now() - l) / 1e3).toFixed(2)}s)`
            );
          if (!r) return pt(e, t);
        }
      }
          ...
          for (let t = 0; t < e.length; t++) {
            ...
            if (l < 0) {
              ...
              let e = r[l],
                a = null;
              for (let t of n.set)
                if (!e.set.some((e) => e.eqSimple(t))) (a || (a = [])).push(t);
              if (a) e.set = a.concat(e.set).sort((e, t) => e.cmp(t));
            }
          }
          if (Me)
            console.log(
              `Merge identical pass ${t}${i ? '' : ', done'} (${((Date.now() - n) / 1e3).toFixed(2)}s)`
            );
          if (!i) return e;
          for (let e of r)
            if (!e.defaultReduce) {
      ...
      function yt(e, t = 65535) {
        if (e > t)
          throw new Error("Trying to encode a number that's too big: " + e);
      ...
      class St {
        ...
        withConflicts(e, t) {
          if (t == Y.none) return this;
          let s = this.conflicts
            ? this.conflicts.slice()
            : this.ensureConflicts();
          s[e] = s[e].join(t);
        ...
        ensureConflicts() {
          ...
          let e = [];
          for (let t = 0; t <= this.terms.length; t++) e.push(Y.none);
          return e;
        }
      }
      ...
      class Rt {
        constructor(e, t) {
          ...
          let s = i.NodeProp;
          for (let n in s) {
            if (s[n] instanceof i.NodeProp && !s[n].perNode)
              this.knownProps[n] = {
                prop: s[n],
                source: { name: n, from: null }
              };
          }
          for (let n of this.ast.externalProps) {
            this.knownProps[n.id.name] = {
              prop: this.options.externalProp
                ? this.options.externalProp(n.id.name)
                : new i.NodeProp(),
          ...
          this.externalTokens = this.ast.externalTokens.map(
            (e) => new ns(this, e)
          );
          ...
          Fe('Build rules', () => {
            ...
            let s = [],
              i = [];
            for (let n of this.ast.rules)
              this.astRules.push({ skip: t, rule: n });
            for (let n of this.ast.topRules) i.push({ skip: t, rule: n });
            for (let n of this.ast.scopedSkip) {
              let r = e,
                l = this.ast.scopedSkip.findIndex(
                  (e, t) => t < s.length && D(e.expr, n.expr)
                );
              if (l > -1) r = s[l];
            ...
            if (t != e)
              this.defineRule(t, this.normalizeExpr(this.ast.mainSkip));
            for (let n = 0; n < this.ast.scopedSkip.length; n++) {
              ...
              if (!this.skipRules.includes(t)) {
                ...
                if (t != e)
                  this.defineRule(
                    t,
                    this.normalizeExpr(this.ast.scopedSkip[n].expr)
                  );
              }
            }
            this.currentSkip.pop();
            for (let { rule: n, skip: r } of i.sort(
              (e, t) => e.rule.start - t.rule.start
            )) {
              this.unique(n.id);
              this.used(n.id.name);
              this.currentSkip.push(r);
              let { name: e, props: t } = this.nodeInfo(
                n.props,
                'a',
                n.id.name,
                vt,
            ...
            for (let { skip: n, rule: r } of this.astRules) {
              if (this.ruleNames[r.id.name] && ps(r) && !r.params.length) {
                ...
                if (r.expr instanceof R && r.expr.exprs.length == 0)
                  this.used(r.id.name);
              }
            }
          });
          ...
          for (let { name: i, group: n, rule: r } of this.definedGroups)
            this.defineGroup(i, n, r);
          this.checkGroups();
        }
        unique(e) {
          if (e.name in this.ruleNames)
            this.raise(`Duplicate definition of rule '${e.name}'`, e.start);
        ...
        newName(e, t = null, s = {}) {
          for (let i = t ? 0 : 1; ; i++) {
            let n = i ? `${e}-${i}` : e;
            if (!this.terms.names[n])
              return this.terms.makeNonTerminal(n, t === true ? null : t, s);
          }
        }
        prepareParser() {
          let e = Fe('Simplify rules', () =>
            os(this.rules, [...this.skipRules, ...this.terms.tops])
          );
          let {
            nodeTypes: t,
            names: s,
          ...
          for (let R in this.namedTerms)
            this.termTable[R] = this.namedTerms[R].id;
          ...
          let a = this.skipRules.map((e, t) => {
            ...
            for (let r of e.rules) {
              ...
              let e = r.parts[0];
              for (let t of e.terminal ? [e] : l[e.name] || [])
                if (t && !i.includes(t)) i.push(t);
              if (
                e.terminal &&
                r.parts.length == 1 &&
                !n.some((t) => t != r && t.parts[0] == e)
              )
                s.push(e);
              else n.push(r);
            }
          ...
          let {
            ...
            tokenPrec: f,
            tokenData: c
          } = Fe('Build token groups', () =>
            this.tokens.buildTokenGroups(o, a, u.length)
          );
          let p = Fe('Finish automaton', () => bt(o));
          let d = It(p, this.terms.tops);
          if (/\blr\b/.test(Ue)) console.log(p.join('\n'));
          let m = [];
          for (let R of this.externalSpecializers) m.push(R);
          for (let R in this.specialized)
            m.push({
              token: this.terms.names[R],
              table: At(this.specialized[R])
            });
          let g = (e) => {
          ...
          for (let R = 0; R < this.dialects.length; R++)
            y[this.dialects[R]] = x.storeArray(
              (this.tokens.byDialect[R] || vt).map((e) => e.id).concat(65535)
            );
          let $ = null;
          if (this.dynamicRulePrecedences.length) {
            $ = Object.create(null);
            for (let { rule: e, prec: t } of this.dynamicRulePrecedences)
              $[e.id] = t;
          }
          let v = Object.create(null);
          for (let R of this.terms.tops)
            v[R.nodeName] = [p.find((e) => e.startRule == R).id, R.id];
          let S = x.storeArray(f.concat(65535));
          let { nodeProps: T, skippedTypes: O } = this.gatherNodeProps(t);
          return {
            states: w,
            stateData: x.finish(),
            goto: Dt(p),
        ...
        getParser() {
          ...
          let k = d.map((e) => {
            if (e instanceof rs) {
              let t = this.options.externalSpecializer(
                e.ast.id.name,
                this.termTable
              );
              return {
          ...
          return r.U1.deserialize({
            ...
            maxTerm: a,
            repeatNodeCount: o,
            nodeProps: n.map(({ prop: e, terms: t }) => [
              this.knownProps[e].prop,
              ...t
            ]),
            propSources: !this.options.externalPropSource
              ? undefined
              : this.ast.externalPropSources.map((e) =>
                  this.options.externalPropSource(e.id.name)
                ),
            skippedNodes: l,
            tokenData: h,
        ...
        getParserFile() {
          ...
          let O = o.map((e) => e.createSource(S));
          let R = this.ast.context
            ? S(this.ast.context.id.name, this.ast.context.source)
            : null;
          ...
          function j(e) {
            return (
              ...
              Object.keys(e)
                .map(
                  (t) =>
                    `${/^(\d+|[a-zA-Z_]\w*)$/.test(t) ? t : JSON.stringify(t)}:${e[t]}`
                )
                .join(', ') +
              '}'
            );
          ...
          let z = this.ast.externalPropSources.map((e) =>
            S(e.id.name, e.source)
          );
          for (let G in b) {
          ...
          for (let G = 0; G < this.dialects.length; G++)
            D.push(
              `Dialect_${this.dialects[G]}${g == 'cjs' ? ':' : ' ='} ${G}`
            );
          return {
            parser:
              x +
        ...
        gatherNodeProps(e) {
          ...
          for (let n of e) {
            ...
            for (let e in n.props) {
              ...
              if (
                t.source.from == null &&
                (t.source.name == 'repeated' || t.source.name == 'error')
              )
                continue;
        ...
        computeForceReductions(e, t) {
          ...
          for (let a of e) {
            ...
            i[a.id] = a.set
              .filter((e) => e.pos > 0 && !e.rule.name.top)
              .sort(
                (e, t) =>
                  t.pos - e.pos || e.rule.parts.length - t.rule.parts.length
              );
          }
          ...
          for (let a of e) {
            if (a.defaultReduce && a.defaultReduce.parts.length > 0) {
              ...
              if (a.defaultReduce.parts.length == 1)
                r[a.id] = a.defaultReduce.name.id;
            }
          }
          for (let a = 1; ; a++) {
            let n = true;
        ...
        substituteArgs(e, t, s) {
          ...
          return e.walk((e) => {
            ...
            if (
              e instanceof v &&
              (i = s.findIndex((t) => t.name == e.id.name)) > -1
            ) {
              let s = t[i];
              if (e.args.length) {
                if (s instanceof v && !s.args.length)
                  return new v(e.start, s.id, e.args);
                this.raise(
              ...
              return n == i.props
                ? e
                : new T(e.start, new u(i.start, i.id, n, i.params, i.expr));
            } else if (e instanceof S) {
              let i = this.substituteArgsInProps(e.props, t, s);
              return i == e.props
                ? e
                : new S(e.start, e.type, i, e.token, e.content);
            }
            return e;
          });
        }
        substituteArgsInProps(e, t, s) {
          let i = (e) => {
            ...
            for (let n = 0; n < e.length; n++) {
              ...
              if (i == e) i = e.slice();
              let a = t[l];
              if (a instanceof v && !a.args.length)
                i[n] = new J(r.start, a.id.name, null);
              else if (a instanceof N) i[n] = new J(r.start, a.value, null);
              else
                this.raise(
                  `Trying to interpolate expression '${a}' into a prop`,
                  r.start
                );
            }
            return i;
        ...
        conflictsFor(e) {
          ...
          for (let i of e) {
            if (i.type == 'ambig') {
              t = t.join(new Y(0, [i.id.name]));
            } else {
              let e = this.ast.precedences;
              let n = e ? e.items.findIndex((e) => e.id.name == i.id.name) : -1;
              if (n < 0)
                this.raise(
                  `Reference to unknown precedence: '${i.id.name}'`,
                  i.id.start
                );
              let r = e.items[n],
                l = e.items.length - n;
              if (r.type == 'cut') {
                t = t.join(new Y(0, vt, l));
              } else {
                t = t.join(new Y(l << 2));
                s = s.join(
                  new Y(
                    (l << 2) +
                      (r.type == 'left' ? 1 : r.type == 'right' ? -1 : 0)
                  )
                );
              }
            }
        ...
        defineRule(e, t) {
          ...
          for (let i of t)
            this.rules.push(new Q(e, i.terms, i.ensureConflicts(), s));
        }
        resolve(e) {
          ...
          if (!s)
            return this.raise(
              `Reference to undefined rule '${e.id.name}'`,
              e.start
            );
          if (s.rule.params.length != e.args.length)
            this.raise(`Wrong number or arguments for '${e.id.name}'`, e.start);
        ...
        normalizeRepeat(e) {
          ...
          this.built.push(new Ot('+', [e.expr], i));
        ...
        normalizeSequence(e) {
          ...
          function i(n, r, l) {
            ...
            if (r == t.length)
              return [n.withConflicts(n.terms.length, a.join(l))];
            let u = [];
            for (let e of t[r]) {
              for (let t of i(
                n.concat(e).withConflicts(n.terms.length, a),
                r + 1,
                l.join(o)
              ))
                u.push(t);
        ...
        normalizeExpr(e) {
          if (e instanceof j && e.kind == '?') {
            ...
            return e.exprs.reduce(
              (e, t) => e.concat(this.normalizeExpr(t)),
              []
            );
            ...
            return [
              Tt(
                this.buildRule(
                  e.rule,
                  vt,
                  this.currentSkip[this.currentSkip.length - 1],
                  true
                )
              )
            ];
            ...
            return this.raise(
              `This type of expression ('${e}') may not occur in non-token rules`,
              e.start
            );
          }
        }
        buildRule(e, t, s, i = false) {
          ...
          if (h && e.params.length)
            this.warn(`Can't export parameterized rules`, e.start);
          if (h && i) this.warn(`Can't export inline rule`, e.start);
          let f = this.newName(
            e.id.name + (t.length ? '<' + t.join(',') + '>' : ''),
            r || true,
            l
          );
          if (o) f.inline = true;
          ...
          if (!i) this.built.push(new Ot(e.id.name, t, f));
          this.currentSkip.push(s);
          let c = this.normalizeExpr(n);
          if (c.length > 100 * (n instanceof O ? n.exprs.length : 1))
            this.warn(
          ...
          if (/\brulesize\b/.test(Ue) && c.length > 10)
            console.log(`Rule ${e.id.name}: ${c.length} variants`);
          this.defineRule(f, c);
          this.currentSkip.pop();
        ...
        nodeInfo(e, t, s = null, i = vt, n = vt, r, l) {
          let a = {};
          let o =
            s && (t.indexOf('a') > -1 || !cs(s)) && !/ /.test(s) ? s : null;
          let u = null,
            h = 0,
            f = false,
            c = null,
          ...
          for (let d of e) {
            if (!d.at) {
              ...
              if (/ /.test(o))
                this.raise(`Node names cannot have spaces ('${o}')`, d.start);
            } else if (d.name == 'dialect') {
              if (t.indexOf('d') < 0)
                this.raise(
                  "Can't specify a dialect on non-token rules",
                  e[0].start
                );
              if (d.value.length != 1 && !d.value[0].value)
                this.raise(
              ...
              if (s < 0)
                this.raise(
                  `Unknown dialect '${d.value[0].value}'`,
                  d.value[0].start
                );
              u = s;
              ...
              if (d.value.length)
                this.raise("'@inline' doesn't take a value", d.value[0].start);
              if (t.indexOf('i') < 0)
        ...
        finishProp(e, t, s) {
          return e.value
            .map((e) => {
              ...
              if (i < 0)
                this.raise(
                  `Property refers to '${e.name}', but no parameter by that name is in scope`,
                  e.start
                );
              let n = t[i];
              ...
              return this.raise(
                `Expression '${n}' can not be used as part of a property value`,
                e.start
              );
            })
            .join('');
        ...
        resolveSpecialization(e) {
          ...
          let {
            ...
            dialect: n,
            exported: r
          } = this.nodeInfo(e.props, 'd');
          let l = this.normalizeExpr(e.token);
          if (
            l.length != 1 ||
            l[0].terms.length != 1 ||
            !l[0].terms[0].terminal
          )
            this.raise(
              `The first argument to '${t}' must resolve to a token`,
              e.token.start
            );
          let a;
          if (e.content instanceof N) a = [e.content.value];
          else if (
            e.content instanceof O &&
            e.content.exprs.every((e) => e instanceof N)
          )
            a = e.content.exprs.map((e) => e.value);
          else
            return this.raise(
              `The second argument to '${e.type}' must be a literal or choice of literals`,
              e.content.start
            );
          let o = l[0].terms[0],
            u = null;
          ...
          for (let f of a) {
            ...
            if (l == null) {
              if (!u) {
                ...
                if (n != null)
                  (
                    this.tokens.byDialect[n] || (this.tokens.byDialect[n] = [])
                  ).push(u);
              }
              ...
              if (l.type != t)
                this.raise(
                  `Conflicting specialization types for ${JSON.stringify(f)} of ${o.name} (${t} vs ${l.type})`,
                  e.start
                );
              if (l.dialect != n)
                this.raise(
                  `Conflicting dialects for specialization ${JSON.stringify(f)} of ${o.name}`,
                  e.start
                );
              if (l.name != s)
                this.raise(
                  `Conflicting names for specialization ${JSON.stringify(f)} of ${o.name}`,
                  e.start
                );
              if (u && l.term != u)
                this.raise(
                  `Conflicting specialization tokens for ${JSON.stringify(f)} of ${o.name}`,
                  e.start
                );
              u = l.term;
            }
        ...
        findDelimiters(e) {
          if (!(e instanceof R) || e.exprs.length < 2) return null;
          let t = (e) => {
            if (e instanceof N)
              return { term: this.tokens.getLiteral(e), str: e.value };
            if (e instanceof v && e.args.length == 0) {
              ...
              if (i && i.expr instanceof N)
                return { term: this.tokens.getToken(e), str: i.expr.value };
            }
            return null;
          };
          ...
          const i = ['()', '[]', '{}', '<>'];
          let n = i.find(
            (e) => s.str.indexOf(e[1]) > -1 && s.str.indexOf(e[0]) < 0
          );
          if (!n) return null;
          let r = t(e.exprs[0]);
          if (
        ...
        defineGroup(e, t, s) {
          ...
          let r = (e) => {
            ...
            if (n.includes(e))
              this.raise(
                `Rule '${s.id.name}' cannot define a group because it contains a non-named recursive rule ('${e.name}')`,
                s.start
              );
            let t = [];
            n.push(e);
            for (let i of this.rules)
              if (i.name == e) {
                ...
                if (e.length > 1)
                  this.raise(
                    `Rule '${s.id.name}' cannot define a group because some choices produce multiple named nodes`,
                    s.start
                  );
        ...
        checkGroups() {
          ...
          for (let i = 0; i < s.length; i++) {
            ...
            if (t[n])
              this.warn(
                `Group name '${n}' conflicts with a node of the same name`
              );
            for (let t = i + 1; t < s.length; t++) {
              let i = e[s[t]];
              if (
                r.some((e) => i.includes(e)) &&
                (r.length > i.length
                  ? i.some((e) => !r.includes(e))
                  : r.some((e) => !i.includes(e)))
              )
                this.warn(
                  `Groups '${n}' and '${s[t]}' overlap without one being a superset of the other`
                );
            }
          }
        }
      ...
      class jt {
        ...
        findSharedActions(e) {
          ...
          for (let r of this.sharedActions) {
            if (
              (!t || r.actions.length > t.actions.length) &&
              r.actions.every((t) => e.actions.some((e) => e.eq(t)))
            )
              t = r;
          }
          if (t) return t;
          ...
          for (let r = e.id + 1; r < this.states.length; r++) {
            ...
            for (let s of e.actions)
              for (let e of t.actions) if (s.eq(e)) i[n++] = s;
          ...
          if (a == 0) {
            if (t)
              for (const t of e.actions)
                if (t instanceof Xe && t.term.eof)
                  u = zt(t.rule, this.skipInfo);
            if (u < 0) h = this.findSharedActions(e);
          }
          if (
            e.set.some((e) => e.rule.name.top && e.pos == e.rule.parts.length)
          )
            o |= 2;
          let f = [];
      ...
      function zt(e, t, s = e.parts.length) {
        return (
          e.name.id |
          65536 |
          (e.isRepeatWrap && s == e.parts.length ? 131072 : 0) |
          (t.some((t) => t.rule == e.name) ? 262144 : 0) |
          (s << 19)
        );
      }
      function Ct(e, t) {
      ...
      function It(e, t) {
        ...
        for (let r = 0; r < i.length; r++) {
          for (let e of i[r].actions) if (e instanceof Ve) n(e.target);
      ...
      class Ut {
        ...
        getToken(e) {
          ...
          let {
            ...
            t,
            e.args,
            s.params.length != e.args.length ? vt : s.params
          );
          let a = this.b.makeTerminal(e.toString(), i, n);
          if (r != null)
            (this.byDialect[r] || (this.byDialect[r] = [])).push(a);
          ...
          this.built.push(new Ot(t, e.args, a));
          return a;
        }
        buildRule(e, t, s, i, n = vt) {
          let r = t.id.name;
          if (e.params.length != t.args.length)
            this.b.raise(
              `Incorrect number of arguments for token '${r}'`,
              t.start
            );
        ...
        build(e, t, s, i) {
          if (e instanceof v) {
            ...
            if (!l)
              return this.b.raise(
                `Reference to token rule '${e.id.name}', which isn't found`,
                e.start
              );
            ...
            if (n)
              this.b.raise('Conflict marker in token expression', n[0].start);
            ...
            for (let [i, n] of e.inverted ? Wt(e.ranges) : e.ranges)
              Xt(t, s, i, n);
          } else if (e instanceof N) {
            ...
            return this.b.raise(
              `Unrecognized expression type in token`,
              e.start
            );
          }
        }
              ...
              for (let i of t.items) {
                ...
                if (i instanceof v) {
                  for (let e of this.built)
                    if (i.args.length ? e.matches(i) : e.id == i.id.name)
                      t.push(e.term);
                } else {
                ...
                if (!t.length)
                  this.b.warn(
                    `Precedence specified for unknown token ${i}`,
                    i.start
                  );
        ...
        buildPrecTable(e) {
          ...
          for (let { a: i, b: n, soft: r } of e)
            if (r) {
              if (!s.some((e) => e.term == i) || !s.some((e) => e.term == n))
                continue;
              if (r < 0) [i, n] = [n, i];
              is(s, n, [i]);
              is(s, i, []);
          ...
          e: while (s.length) {
            ...
            this.b.raise(
              `Cyclic token precedence relation between ${s.map((e) => e.term).join(', ')}`
            );
          }
          return t;
        }
      ...
      class Mt extends Ut {
        ...
        getLiteral(e) {
          ...
          let s = null,
            ...
            r = null;
          let l = this.ast
            ? this.ast.literals.find((t) => t.literal == e.value)
            : null;
          if (l)
            ({
              name: s,
              ...
              dialect: n,
              exported: r
            } = this.b.nodeInfo(l.props, 'da', e.value));
          let a = this.b.makeTerminal(t, s, i);
          if (n != null)
            (this.byDialect[n] || (this.byDialect[n] = [])).push(a);
          if (r) this.b.namedTerms[r] = a;
          this.build(e, this.startState, new re([a]), vt);
          this.built.push(new Ot(t, vt, a));
          return a;
        }
        takeConflicts() {
          var e;
          ...
          for (let s of ((e = this.ast) === null || e === void 0
            ? void 0
            : e.conflicts) || []) {
            let e = t(s.a),
              i = t(s.b);
        ...
        buildTokenGroups(e, t, s) {
          ...
          let n = i
            .findConflicts(Lt(e, this.b, t))
            .filter(
              ({ a: e, b: t }) =>
                !this.precededBy(e, t) && !this.precededBy(t, e)
            );
          for (let { a: h, b: f } of this.explicitConflicts) {
            if (!n.some((e) => e.a == h && e.b == f))
              n.push(new le(h, f, 0, '', ''));
          }
          ...
          for (let h of e) {
            ...
            for (let t of n)
              if (h.actions.some((e) => e.term == t))
                this.b.raise(`Use of token ${t.name} conflicts with skip rule`);
            let r = [];
            for (let t = 0; t < h.actions.length + (n ? n.length : 0); t++) {
              let e =
                t < h.actions.length
                  ? h.actions[t].term
                  : n[t - h.actions.length];
            ...
            for (let t of r) {
              for (let s of l) {
                ...
                if (r.includes(n) && !a.some((e) => e.conflict == s)) {
                  let e = s.exampleA
                    ? ` (example: ${JSON.stringify(s.exampleA)}${s.exampleB ? ` vs ${JSON.stringify(s.exampleB)}` : ''})`
                    : '';
                  a.push({
                    error:
                      `Overlapping tokens ${t.name} and ${n.name} used in same context${e}\n` +
                      `After: ${h.set[0].trail()}`,
                    conflict: s
                  });
                }
          ...
          if (o.length + s > 16)
            this.b.raise(
              `Too many different token groups (${o.length}) to represent them as a 16-bit bitfield`
            );
          let u = this.buildPrecTable(r);
          return {
            tokenGroups: o,
            tokenPrec: u,
            tokenData: i.toArray(Jt(o), u)
          };
        }
      }
      class Ft extends Ut {
        ...
        getToken(e) {
          ...
          if (this.ast.fallback && this.ast.fallback.id.name == e.id.name) {
            if (e.args.length)
              this.b.raise(
                `Incorrect number of arguments for ${e.id.name}`,
                e.start
              );
            if (!this.fallback) {
              let {
          ...
          if (t && !this.b.tokenOrigins[t.name])
            this.b.tokenOrigins[t.name] = { group: this };
          return t;
        }
        buildLocalGroup(e, t, s) {
          ...
          for (let { a: r, b: u, exampleA: h } of i.findConflicts(() => true)) {
            if (!this.precededBy(r, u) && !this.precededBy(u, r))
              this.b.raise(
                `Overlapping tokens ${r.name} and ${u.name} in local token group${h ? ` (example: ${JSON.stringify(h)})` : ''}`
              );
          }
          for (let r of e) {
            ...
            for (let { term: t } of r.actions) {
              ...
              if ((s === null || s === void 0 ? void 0 : s.group) == this)
                e = t;
              else i = t;
            }
            if (e) {
              if (i)
                this.b.raise(
                  `Tokens from a local token group used together with other tokens (${e.name} with ${i.name})`
                );
              r.tokenGroup = s;
            }
          }
          ...
          return {
            groupID: s,
            create: () =>
              new r.uC(o, a, this.fallback ? this.fallback.id : undefined),
            createSource: (e) =>
              `new ${e('LocalTokenGroup', '@lezer/lr')}(${$t(o)}, ${a}${this.fallback ? `, ${this.fallback.id}` : ''})`
          };
        }
      }
      function Lt(e, t, s) {
        ...
        function n(e, i) {
          return (
            e.actions.some((e) => e.term == i) ||
            s[t.skipRules.indexOf(e.skip)].startTokens.includes(i)
          );
        }
        return (t, s) => {
      ...
      function Xt(e, t, s, i) {
        if (s < Kt) {
          if (s < Yt) e.edge(s, Math.min(i, Yt), t);
          if (i > Zt) e.edge(Math.max(s, Zt), Math.min(i, V + 1), t);
          s = Kt;
        }
        if (i <= Kt) return;
      ...
      function es(e) {
        return e instanceof R && e.exprs.length == 0;
      }
      function ts(e, t) {
        let s = Object.create(null);
        for (let i of t) {
          ...
          let {
            ...
            props: n,
            dialect: r
          } = e.nodeInfo(i.props, 'd', i.id.name);
          let l = e.makeTerminal(i.id.name, t, n);
          if (r != null)
            (e.tokens.byDialect[r] || (e.tokens.byDialect[r] = [])).push(l);
      ...
      function ss(e, t, s) {
        ...
        if (!i) return null;
        if (s.args.length)
          e.raise('External tokens cannot take arguments', s.args[0].start);
        e.used(s.id.name);
        return i;
      }
      function is(e, t, s) {
      ...
      class ns {
        constructor(e, t) {
          ...
          for (let s in this.tokens)
            this.b.tokenOrigins[this.tokens[s].name] = { external: this };
        }
        getToken(e) {
          return ss(this.b, this.tokens, e);
        }
        create() {
          return this.b.options.externalTokenizer(
            this.ast.id.name,
            this.b.termTable
          );
        }
      ...
      class rs {
        ...
        finish() {
          ...
          for (let t in this.tokens)
            this.b.tokenOrigins[this.tokens[t].name] = {
              spec: this.term,
              external: this
            };
        }
        ...
        for (let s = 0; ; s++) {
          ...
          for (let o = 0; o < e.length; o++) {
            ...
            if (
              ...
              (u.parts.length == 1 ||
                e.every(
                  (e) => e.skip == u.skip || !e.parts.includes(u.name)
                )) &&
          ...
          for (let h of e) {
            ...
            function f(e, t, s) {
              if (e == h.parts.length) {
                r.push(new Q(h.name, s, t, h.skip));
                return;
              }
              let n = h.parts[e],
                l = i[n.name];
              ...
              for (let i of l)
                f(
                  ...
                  t
                    ...
                    .concat(
                      h.conflicts[e + 1].join(
                        i.conflicts[i.conflicts.length - 1]
                      )
                    ),
                  s.concat(i.parts)
                );
      ...
      function fs(e, t = {}) {
        return new Rt(e, t).getParserFile();
      }
      function cs(e) {
        let t = e[0];
