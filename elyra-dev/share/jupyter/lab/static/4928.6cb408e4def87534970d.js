    ...
    4928: function (t, e, r) {
      ...
      var m = (function (t) {
        ...
        function e(r) {
          ...
          var y = (i._parseOptions = new h.default(d, [
            i.options,
            v.TagsFactory.OPTIONS
          ]));
    ...
    73525: function (t, e, r) {
      ...
      (function (t) {
        t.cleanStretchy = function (t) {
          ...
          try {
            for (
              var o = i(n.getList('fixStretchy')), s = o.next();
              !s.done;
              s = o.next()
            ) {
              var u = s.value;
        ...
        t.cleanAttributes = function (t) {
          ...
          e.walkTree(function (t, e) {
            ...
            try {
              for (
                var s = i(o.getExplicitNames()), u = s.next();
                !u.done;
                u = s.next()
              ) {
                var l = u.value;
        ...
        t.combineRelations = function (t) {
          ...
          try {
            for (
              var c = i(t.data.getList('mo')), p = c.next();
              !p.done;
              p = c.next()
            ) {
              var d = p.value;
              ...
              while (
                m < y.length &&
                (v = y[m]) &&
                a.default.isType(v, 'mo') &&
                a.default.getTexClass(v) === o.TEXCLASS.REL
              ) {
                if (b === a.default.getProperty(v, 'variantForm') && r(d, v)) {
                  ...
                  try {
                    for (
                      var g = ((u = void 0), i(v.getPropertyNames())),
                        E = g.next();
                      !E.done;
                      E = g.next()
                    ) {
        ...
        var n = function (t, e, r) {
          ...
          try {
            for (
              var u = i(t.getList('m' + e + r)), l = u.next();
              !l.done;
              l = u.next()
            ) {
              var f = l.value;
    ...
    12787: function (t, e, r) {
      ...
      var u = (function (t) {
        ...
        e.prototype.findEnd = function (t, e, r, i) {
          ...
          while ((c = l.exec(t))) {
            if ((c[1] || c[0]) === a && p === 0) {
              return (0, s.protoItem)(
                r[0],
                t.substr(f, c.index - f),
                c[0],
                e,
                r.index,
                c.index + c[0].length,
        ...
        e.prototype.findMathInString = function (t, e, r) {
          ...
          while ((i = this.start.exec(r))) {
            if (i[this.env] !== undefined && this.env) {
              var o =
                '\\\\end\\s*(\\{' + (0, a.quotePattern)(i[this.env]) + '\\})';
              n = this.findEnd(r, e, i, [
                '{' + i[this.env] + '}',
                true,
