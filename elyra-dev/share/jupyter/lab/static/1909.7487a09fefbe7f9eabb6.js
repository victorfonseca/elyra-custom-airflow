  ...
  [1909],
  {
    ...
    48600: function (e, t, r) {
      ...
      t.AmsConfiguration = o.Configuration.create('ams', {
        ...
        items:
          ((n = {}),
          (n[i.MultlineItem.prototype.kind] = i.MultlineItem),
          (n[i.FlalignItem.prototype.kind] = i.FlalignItem),
          n),
        tags: { ams: c },
        init: f,
        config: function (e, t) {
          if (t.parseOptions.options.multlineWidth) {
            t.parseOptions.options.ams.multlineWidth =
              t.parseOptions.options.multlineWidth;
          }
          ...
          if (this.table.length) {
            ...
            if (a) {
              ...
              var o = this.create(
                'node',
                'mlabeledtr',
                [a].concat(l.default.getChildren(n))
              );
      ...
      new l.EnvironmentMap(
        ...
        c.default.environment,
        {
          ...
          'eqnarray*': [
            ...
            true,
            'rcl',
            f.default.cols(0, p.MATHSPACE.thickmathspace),
            '.5em'
          ],
    ...
    98840: function (e, t, r) {
      ...
      var n =
        ...
        function (e, t) {
          ...
          var a = r.call(e),
            ...
            i;
          try {
            while ((t === void 0 || t-- > 0) && !(n = a.next()).done)
              o.push(n.value);
          } catch (s) {
            i = { error: s };
          } finally {
      ...
      t.AmsMethods.HandleDeclareOp = function (e, r) {
        ...
        e.configuration.handlers
          ...
          .add(
            n,
            new d.Macro(n, t.AmsMethods.Macro, [
              '\\operatorname'.concat(a, '{').concat(o, '}')
            ])
          );
      };
      ...
      t.AmsMethods.SideSet = function (e, t) {
        ...
        if (a) {
          if (o) {
            a.replaceChild(
              e.create('node', 'mphantom', [
                e.create('node', 'mpadded', [i.default.copyNode(f, e)], {
                  width: 0
                })
              ]),
      ...
      function h(e) {
        if (!e || (e.isInferred && e.childNodes.length === 0))
          return [null, null];
      ...
      t.AmsMethods.xArrow = function (e, t, r, a, n) {
        var o = {
          width: '+' + i.default.Em((a + n) / 18),
          lspace: i.default.Em(a / 18)
        };
        ...
        var d = e.create(
          'token',
          'mo',
          { stretchy: true, texClass: m.TEXCLASS.REL },
    ...
    55828: function (e, t, r) {
      ...
      l.CD = function (e, t) {
        ...
        r.setProperties({
          minw: e.stack.env.CD_minw || a.harrowsize,
          minh: e.stack.env.CD_minh || a.varrowsize
        });
        r.arraydef = {
          columnalign: 'center',
      ...
      l.cell = function (e, t) {
        ...
        e.Push(
          e.itemFactory.create('cell').setProperties({ isEntry: true, name: t })
        );
      };
    ...
    79224: function (e, t, r) {
      ...
      function d(e) {
        ...
        try {
          for (
            var n = a(e.data.getList('fixBold')), o = n.next();
            !o.done;
            o = n.next()
          ) {
            var l = o.value;
    ...
    85046: function (e, t, r) {
      ...
      var l = (function (e) {
        ...
        t.prototype.toMml = function () {
          ...
          var u = this.create('node', 'mrow', [o, t, l], {
            open: r,
            close: a,
      ...
      s.Bar = function (e, t) {
        ...
        if (
          ...
          var n = e.create(
            'token',
            'mo',
            { texClass: o.TEXCLASS.ORD, stretchy: false },
            r
          );
          e.Push(n);
          return;
    ...
    86158: function (e, t, r) {
      ...
      p.Prooftree = function (e, t) {
        e.Push(t);
        var r = e.itemFactory.create('proofTree').setProperties({
          name: t.getName(),
          line: 'solid',
          currentLine: 'solid',
          rootAtTop: false
      ...
      function h(e, t, r, a, n, o, i) {
        ...
        var u = e.create('node', 'mtable', i ? [l, s] : [s, l], {
          align: 'top 2',
          rowlines: o,
          framespacing: '0 0'
        });
    ...
    86366: function (e, t, r) {
      ...
      var p = function (e, t) {
        return e.childNodes[t === 'up' ? 1 : 0].childNodes[0].childNodes[0]
      ...
      var g = function (e, t) {
        return e.childNodes[t === 'up' ? 0 : 1].childNodes[0].childNodes[0]
          .childNodes[0];
      };
      var y = function (e) {
      ...
      var A = function (e, r, a, n) {
        ...
        if (s.default.isType(u, 'mspace')) {
          s.default.setAttribute(
            ...
            'width',
            l.default.Em(
              l.default.dimen2em(s.default.getAttribute(u, 'width')) + a
            )
          );
          return;
        }
      ...
      var P = function (e) {
        ...
        for (var a = r.length - 1, n = void 0; (n = r[a]); a--) {
          ...
          while ((0, t.getProperty)(i, 'inference') === 1) {
            ...
            var l = (0, t.getProperty)(s, 'inferenceRule')
              ? g(s, (0, t.getProperty)(s, 'inferenceRule'))
              : s;
      ...
      var q = function (e) {
        ...
        try {
          for (var s = n(i), l = s.next(); !l.done; l = s.next()) {
            ...
            var I = b(E);
            if (I) {
              var D = o.nodeFactory.create('node', 'mspace', [], {
                width: O - q + 'em'
              });
              I.appendChild(D);
            ...
            O = (0, t.getProperty)(N, 'maxAdjust')
              ? Math.max((0, t.getProperty)(N, 'maxAdjust'), O)
              : O;
    ...
    2362: function (e, t, r) {
      ...
      t.CancelMethods.CancelTo = function (e, t) {
        ...
        e.Push(
          e.create('node', 'msup', [e.create('node', 'menclose', [n], i), a])
        );
      };
      new i.CommandMap(
        'cancel',
      ...
      t.CasesMethods = {
        ...
        Entry: function (e, t) {
          ...
          e.Push(
            e.itemFactory
              .create('cell')
              .setProperties({ isEntry: true, name: t })
          );
          var r = e.string;
          var a = 0,
            n = e.i,
    ...
    50228: function (e, t, r) {
      ...
      function c(e) {
        ...
        try {
          for (
            var o = a(n.getList('centerOver')), i = o.next();
            !i.done;
            i = o.next()
          ) {
            var l = i.value;
    ...
    45320: function (e, t, r) {
      ...
      t.ConfigMacrosConfiguration = i.Configuration.create('configmacros', {
        ...
        config: v,
        items:
          ((o = {}), (o[d.BeginEnvItem.prototype.kind] = d.BeginEnvItem), o),
        options: {
      ...
      t.EmpheqMethods = {
        Empheq: function (e, t) {
          if (e.stack.env.closing === t.getName()) {
            ...
            if (a) {
              t.setProperties(
                d.EmpheqUtil.splitOptions(a, { left: 1, right: 1 })
              );
            }
        ...
        EmpheqDelim: function (e, t) {
          ...
          e.Push(
            e.create('token', 'mo', { stretchy: true, symmetric: true }, r)
          );
        }
      };
      new l.EnvironmentMap(
    ...
    99118: function (e, t, r) {
      ...
      t.EmpheqUtil = {
        ...
        cellBlock: function (e, t, r, a) {
          ...
          try {
            for (
              var f = o(c.isInferred ? c.childNodes : [c]), d = f.next();
              !d.done;
              d = f.next()
            ) {
              var p = d.value;
          ...
          s.appendChild(
            r.create('node', 'mphantom', [
              r.create('node', 'mpadded', [t], { width: 0 })
            ])
          );
          return s;
        },
        topRowTable: function (e, t) {
          ...
          return e.factory.create('mphantom', {}, [
            t.create('node', 'mpadded', [r], { width: 0 })
          ]);
        },
        rowspanCell: function (e, t, r, a, n) {
          e.appendChild(
            a.create(
              ...
              'mpadded',
              [
                this.cellBlock(t, s.default.copyNode(r, a), a, n),
                this.topRowTable(r, a)
              ],
        ...
        left: function (e, t, r, a, n) {
          ...
          try {
            for (
              var u = o(e.childNodes.slice(0).reverse()), c = u.next();
              !c.done;
              c = u.next()
            ) {
              var f = c.value;
        ...
        right: function (e, r, a, n, o) {
          ...
          while (s.childNodes.length < i)
            s.appendChild(n.create('node', 'mtd'));
    ...
    15472: function (e, t, r) {
      ...
      t.ExtpfeilMethods.NewExtArrow = function (e, r) {
        ...
        a = a.substr(1);
        var i = n.split(',');
        s.default.addMacro(e, a, t.ExtpfeilMethods.xArrow, [
          parseInt(o),
          parseInt(i[0]),
          parseInt(i[1])
        ]);
    ...
    95120: (e, t, r) => {
      ...
      new o.CharacterMap('gensymb-symbols', i, {
        ohm: 'Ω',
        degree: '°',
        celsius: '℃',
        perthousand: '‰',
      ...
      t.GensymbConfiguration = a.Configuration.create('gensymb', {
    ...
    98452: function (e, t, r) {
      ...
      t.HtmlConfiguration = n.Configuration.create('html', {
    ...
    7932: function (e, t, r) {
      ...
      function h(e) {
        ...
        try {
          for (
            var c = a(u.getList('mmultiscripts')), f = c.next();
            !f.done;
            f = c.next()
          ) {
            var d = f.value;
            ...
            try {
              for (
                var y = ((i = void 0), a([4, 5])), b = y.next();
                !b.done;
                b = y.next()
              ) {
                var g = b.value;
                if (
                  l.default.isType(p[g], 'mrow') &&
                  l.default.getChildren(p[g]).length === 0
                ) {
                  l.default.setChild(
                    d,
                    g,
      ...
      t.MathtoolsConfiguration = i.Configuration.create('mathtools', {
        ...
        items:
          ((o = {}), (o[d.MultlinedItem.prototype.kind] = d.MultlinedItem), o),
        init: p,
        config: m,
        postprocessors: [[h, -6]],
        options: {
    ...
    75316: function (e, t, r) {
      ...
      t.MathtoolsMethods = {
        ...
        MtSmallMatrix: function (e, r, a, n, o) {
          if (!o) {
            o = e.GetBrackets(
              ...
              e.options.mathtools['smallmatrix-align']
            );
          }
          return t.MathtoolsMethods.Array(
            e,
            r,
            a,
            n,
        ...
        SpreadLines: function (e, t) {
          ...
          if (e.stack.env.closing === t.getName()) {
            ...
            if (i.isInferred) {
              try {
                for (
                  var l = o(d.default.getChildren(i)), u = l.next();
                  !u.done;
                  u = l.next()
                ) {
                  var c = u.value;
        ...
        Cases: function (e, t, r, a, n) {
          var o = e.itemFactory
            .create('array')
            .setProperty('casesEnv', t.getName());
          o.arraydef = {
            rowspacing: '.2em',
            columnspacing: '1em',
            columnalign: 'left'
        ...
        UnderOverBracket: function (e, t) {
          ...
          var g = e.create(
            'node',
            'mpadded',
            [e.create('node', 'mphantom', [v])],
            {
              style: 'border: '
                .concat(p, ' solid; border-')
                .concat(f, ': none'),
              height: a,
              depth: 0
            }
        ...
        PairedDelimiters: function (e, t, r, a, o, i, l, u) {
          ...
          e.string = [l, p, r, o, m, a, u, e.string.substr(e.i)].reduce(
            function (t, r) {
        ...
        DeclarePairedDelimiterXPP: function (e, t) {
          ...
          y.MathtoolsUtil.addPairedDelims(e.configuration, r, [
            o,
            i,
            l,
            a,
            ...
            e.create(
              ...
              [
                e.create(
                  ...
                  [
                    e.create('node', 'mphantom', [
                      e.create('token', 'mo', { stretchy: false }, '(')
                    ])
                  ],
                  { width: 0, height: a + 'height', depth: r + 'depth' }
                )
              ],
        ...
        SetOptions: function (e, t) {
          ...
          try {
            for (
              var c = o(Object.keys(u)), d = c.next();
              !d.done;
              d = c.next()
            ) {
              var p = d.value;
          ...
          r.prototype.formatTag = function (t) {
            if (this.mtCurrent) {
              var r = o(this.mtCurrent, 3),
                ...
                i = r[2];
              return i
                ? ''.concat(a).concat(i, '{').concat(t, '}').concat(n)
    ...
    75802: function (e, t, r) {
      ...
      t.MhchemConfiguration = n.Configuration.create('mhchem', {
    ...
    36912: function (e, t, r) {
      ...
      t.NewcommandConfiguration = l.Configuration.create('newcommand', {
        ...
        items:
          ((s = {}), (s[u.BeginEnvItem.prototype.kind] = u.BeginEnvItem), s),
    ...
    91200: function (e, t, r) {
      ...
      d.MacroDef = function (e, t) {
        ...
        var n = e.GetArgument(t);
        !(a instanceof Array)
          ? f.default.addMacro(e, r, d.Macro, [n, a])
          : f.default.addMacro(e, r, d.MacroWithTemplate, [n].concat(a));
      };
      d.Let = function (e, t) {
        var r = f.default.GetCSname(e, t);
        var a = e.GetNext();
    ...
    21018: (e, t, r) => {
      ...
      function n(e, t, r, a) {
        ...
        var o = e.create('node', 'merror', [n], {
          'data-mjx-error': t,
          title: t
        });
        return o;
      }
      t.NoErrorsConfiguration = a.Configuration.create('noerrors', {
        nodes: { error: n }
      });
    },
    68916: function (e, t, r) {
      ...
      function o(e, t) {
        ...
        try {
          for (
            var l = a(['color', 'background', 'size']), u = l.next();
            !u.done;
            u = l.next()
          ) {
            var c = u.value;
    ...
    34834: function (e, t, r) {
      ...
      var u = (function (e) {
        ...
        t.errors = Object.assign(Object.create(o.BaseItem.errors), {
          stop: [
    ...
    66052: function (e, t, r) {
      ...
      d.Quantity = function (e, t, r, a, n, o, f) {
        ...
        e.Push(
          e.itemFactory
            .create('auto open')
            .setProperties({ open: h, close: b, big: g })
        );
      };
      d.Eval = function (e, t) {
        var r = e.GetStar();
        ...
        if (a === '(' || a === '[') {
          e.i++;
          e.Push(
            e.itemFactory.create('auto open').setProperties({
              open: a,
              close: '|',
              smash: r,
              right: '\\vphantom{\\int}'
      ...
      var w = function (e, t, r, a, n) {
        ...
        e.i++;
        e.Push(
          e.itemFactory.create('auto open').setProperties({ open: s, close: l })
        );
      };
      ...
      d.Derivative = function (e, t, r, a) {
        ...
        if (e.GetNext() === '(') {
          ...
          e.Push(
            e.itemFactory
              .create('auto open')
              .setProperties({ open: '(', close: ')', ignore: u })
          );
        }
      };
      d.Bra = function (e, t) {
        ...
        if (o) {
          ...
          f =
            r || s
              ? '\\langle{'.concat(a, '}\\vert')
              : '\\left\\langle{'.concat(a, '}\\right\\vert{').concat(n, '}');
        }
        e.Push(new i.default(f, e.stack.env, e.configuration).mml());
      };
      d.Ket = function (e, t) {
        ...
        var a = e.GetArgument(t);
        var n = r
          ? '\\vert{'.concat(a, '}\\rangle')
          : '\\left\\vert{'.concat(a, '}\\right\\rangle');
      ...
      d.KetBra = function (e, t) {
        ...
        if (n == null) {
          o = r
            ...
            : '\\left\\vert{'
                .concat(a, '}\\middle\\rangle\\!\\middle\\langle{')
                .concat(a, '}\\right\\vert');
        } else {
          o = r
      ...
      d.Vnabla = function (e, t) {
        var r = e.options.physics.arrowdel
          ? '\\vec{\\gradientnabla}'
          : '{\\gradientnabla}';
    ...
    91610: function (e, t, r) {
      ...
      t.SetOptionsUtil = {
        ...
        filterOption: function (e, t, r) {
          ...
          if (
            !((a = t === 'tex' ? e.options : e.options[t]) === null ||
            a === void 0
              ? void 0
              : a.hasOwnProperty(r))
          ) {
      ...
      var d = new i.CommandMap(
        ...
        { setOptions: 'SetOptions' },
        {
          SetOptions: function (e, t) {
            ...
            try {
              for (
                var u = a(Object.keys(i)), c = u.next();
                !c.done;
                c = u.next()
              ) {
                var f = c.value;
                if (s.filterOption(e, o, f)) {
                  (o === 'tex' ? e.options : e.options[o])[f] = s.filterValue(
                    e,
                    o,
                    f,
                    i[f]
      ...
      function p(e, t) {
        ...
        if (r) {
          ...
          d.add(
            'require',
            new u.Macro('require', c.default.Macro, [
    ...
    46370: (e, t, r) => {
      ...
      var a = r(56441);
      r(47173);
      t.TextcompConfiguration = a.Configuration.create('textcomp', {
      ...
      t.TextMacrosConfiguration = o.Configuration.create('textmacros', {
        config: function (e, t) {
          var r = new o.ParserConfiguration(
            t.parseOptions.options.textmacros.packages,
            ['tex', 'text']
          );
          r.init();
    ...
    56774: function (e, t, r) {
      ...
      t.TextMacrosMethods = {
        ...
        Emph: function (e, t) {
          var r =
            e.stack.env.mathvariant === '-tex-mathit'
              ? 'normal'
              : '-tex-mathit';
    ...
    53880: function (e, t, r) {
      ...
      var m = (function (e) {
        ...
        t.prototype.PushMath = function (e) {
          ...
          try {
            for (
              var o = n(['mathsize', 'mathcolor']), i = o.next();
              !i.done;
              i = o.next()
            ) {
              var s = i.value;
        ...
        t.prototype.addAttributes = function (e) {
          ...
          try {
            for (
              var o = n(['mathsize', 'mathcolor', 'mathvariant']), i = o.next();
              !i.done;
              i = o.next()
            ) {
              var s = i.value;
    ...
    82736: (e, t, r) => {
      ...
      t.UpgreekConfiguration = a.Configuration.create('upgreek', {
              ...
              if (f) {
                ...
                for (var p = 0; p < d.action_.length; p++) {
                  ...
                  if (l.actions[d.action_[p].type_]) {
                    m = l.actions[d.action_[p].type_](
                      a,
                      f.match_,
                      d.action_[p].option
                    );
                  } else if (n.actions[d.action_[p].type_]) {
                    m = n.actions[d.action_[p].type_](
                      a,
                      f.match_,
                      d.action_[p].option
                    );
        ...
        patterns: {
          patterns: {
            ...
            'state of aggregation $': function (e) {
              var t = n.patterns.findObserveGroups(
                e,
                '',
                /^\([a-z]{1,3}(?=[\),])/,
                ')',
            ...
            '${(...)}$__$(...)$': function (e) {
              return (
                n.patterns.findObserveGroups(e, '${', '', '', '}$') ||
                n.patterns.findObserveGroups(e, '$', '', '', '$')
              );
            },
            '=<>': /^[=<>]/,
          ...
          ce: {
            ...
            actions: {
              ...
              '- after o/d': function (e, t, r) {
                ...
                var o = n.patterns.match_(
                  'one lowercase greek letter $',
                  e.o || ''
                );
                var i = n.patterns.match_(
                  'one lowercase latin letter $',
                  e.o || ''
                );
                var s = n.patterns.match_(
                  '$one lowercase latin letter$ $',
                  e.o || ''
                );
                  ...
                  if (!e.a && !e.b && !e.p && !e.o && !e.q && !e.d && !r) {
                    ...
                    if (!e.o && !e.q && !e.d && !e.b && !e.p && r !== 2) {
                      ...
                      if (
                        e.o &&
                        e.dType === 'kv' &&
                        n.patterns.match_('d-oxidation$', e.d || '')
                      ) {
                        e.dType = 'oxidation';
                    ...
                    a.push({
                      ...
                      d: n.go(
                        e.d,
                        e.dType === 'oxidation' ? 'oxidation' : 'bd'
                      ),
                      dType: e.dType
                    });
                  }
      ...
      var o = {
        ...
        _go2: function (e) {
          ...
          switch (e.type_) {
            ...
            case 'pu-frac':
              var n =
                '\\frac{' + o._goInner(e.p1) + '}{' + o._goInner(e.p2) + '}';
              t =
                '\\mathchoice{\\textstyle' +
                n +
                '}{' +
            ...
            case 'overset':
              t =
                '\\overset{' + o._goInner(e.p1) + '}{' + o._goInner(e.p2) + '}';
              break;
            case 'underset':
              t =
                '\\underset{' +
