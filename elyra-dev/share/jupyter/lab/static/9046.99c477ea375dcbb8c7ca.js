  ...
  [9046, 5606],
  {
    ...
    53110: (t, e, n) => {
      ...
      const h = (t, e) =>
        ...
        (t != null &&
          ...
          ((t instanceof Array && array.equalFlat(t, e)) ||
            (typeof t === 'object' && object.equalFlat(t, e))));
      const a = (t, e) => {
        if (t == null || e == null) {
          return l(t, e);
        }
    ...
    70641: (t, e, n) => {
      ...
      const f = (t, e) =>
        t === e ||
        (l(t) === l(e) &&
          u(t, (t, n) => (t !== undefined || d(e, n)) && e[n] === t));
    },
    5739: (t, e, n) => {
      'use strict';
      n.d(e, { c: () => o });
      ...
      class o {
        constructor() {
          this._observers = s.vt();
        }
        on(t, e) {
          s._4(this._observers, t, r.vt).add(e);
        }
        once(t, e) {
          const n = (...s) => {
            this.off(t, n);
        ...
        emit(t, e) {
          return i
            .HT((this._observers.get(t) || s.vt()).values())
            .forEach((t) => t(...e));
        }
        destroy() {
          this._observers = s.vt();
    ...
    89046: (t, e, n) => {
      ...
      n.d(e, {
        ...
        readUpdate: () => Di,
        readUpdateV2: () => Ci,
        relativePositionToJSON: () => Qi,
        snapshot: () => bo,
        transact: () => Jo,
        tryGc: () => Fo,
        typeListToArraySnapshot: () => Mc,
        typeMapGetSnapshot: () => Wc
      });
      var s = n(5739);
      var r = n(32421);
      var i = n(63616);
      ...
      const T = v;
      const x = (t) => A || addEventListener('storage', t);
      var I = n(53110);
      var M = n(65606);
      const U =
        typeof M !== 'undefined' &&
        M.release &&
        /node|io\.js/.test(M.release.name);
      const O =
        typeof window !== 'undefined' && typeof document !== 'undefined' && !U;
      const L =
      ...
      const P = (t) => V().has(t);
      const j = (t, e) => V().get(t) || e;
      const B = (t) => (U ? C(M.env[t.toUpperCase()]) : C(T.getItem(t)));
      const F = (t) => V().get('--' + t) || B(t);
      const z = (t) => P('--' + t) || B(t) !== null;
      const J = z('production');
      const $ = U && I.EK(M.env.FORCE_COLOR, ['true', '1', '2']);
      const H =
        !P('no-colors') &&
        (!U || M.stdout.isTTY || $) &&
        (!U ||
          ...
          $ ||
          B('COLORTERM') !== null ||
          (B('TERM') || '').includes('color'));
      const W = (t) => new Uint8Array(t);
      const K = (t, e, n) => new Uint8Array(t, e, n);
      const q = (t) => new Uint8Array(t);
      const Y = (t) => {
        let e = '';
      ...
      const be =
        Number.isInteger ||
        ((t) => typeof t === 'number' && isFinite(t) && i.RI(t) === t);
      ...
      const De = (t) => {
        ...
        e.set(K(t.cbuf.buffer, 0, t.cpos), n);
        return e;
      };
      const ve = (t, e) => {
        const n = t.cbuf.length;
        if (n - t.cpos < e) {
          t.bufs.push(K(t.cbuf.buffer, 0, t.cpos));
          t.cbuf = new Uint8Array(i.T9(n, e) * 2);
          t.cpos = 0;
        }
      };
      const Ae = (t, e) => {
      ...
      const Me = (t, e) => {
        Ae(t, e & binary.BITS8);
        Ae(t, (e >>> 8) & binary.BITS8);
      };
      const Ue = (t, e, n) => {
        Te(t, e, n & binary.BITS8);
        Te(t, e + 1, (n >>> 8) & binary.BITS8);
      };
      const Oe = (t, e) => {
        for (let n = 0; n < 4; n++) {
          Ae(t, e & binary.BITS8);
      ...
      const Le = (t, e) => {
        for (let n = 3; n >= 0; n--) {
          Ae(t, (e >>> (8 * n)) & binary.BITS8);
        }
      };
      const Ne = (t, e, n) => {
        for (let s = 0; s < 4; s++) {
          Te(t, e + s, n & binary.BITS8);
          n >>>= 8;
        }
      };
      const Re = (t, e) => {
      ...
      const Pe = new Uint8Array(3e4);
      const je = Pe.length / 3;
      const Be = (t, e) => {
        if (e.length < je) {
          const n = w.encodeInto(e, Pe).written || 0;
          Re(t, n);
          for (let e = 0; e < n; e++) {
            Ae(t, Pe[e]);
          }
      ...
      const Fe = (t, e) => {
        ...
        Re(t, s);
        for (let r = 0; r < s; r++) {
          Ae(t, n.codePointAt(r));
        }
      };
      const ze = w && w.encodeInto ? Be : Fe;
      const Je = (t, e) => $e(t, De(e));
      const $e = (t, e) => {
        const n = t.cbuf.length;
        const s = t.cpos;
        const r = i.jk(n - s, e.length);
        const o = e.length - r;
        t.cbuf.set(e.subarray(0, r), s);
        t.cpos += r;
        if (o > 0) {
          t.bufs.push(t.cbuf);
          t.cbuf = new Uint8Array(i.T9(n * 2, o));
      ...
      const Ke = (t, e) => We(t, 4).setFloat32(0, e, false);
      const qe = (t, e) => We(t, 8).setFloat64(0, e, false);
      const Ye = (t, e) => We(t, 8).setBigInt64(0, e, false);
      const Xe = (t, e) => We(t, 8).setBigUint64(0, e, false);
      const Ge = new DataView(new ArrayBuffer(4));
      const Qe = (t) => {
        Ge.setFloat32(0, t);
        return Ge.getFloat32(0) === t;
      };
      const Ze = (t, e) => {
        switch (typeof e) {
          case 'string':
      ...
      const sn = (t) => {
        if (t.count > 0) {
          Ve(t.encoder, t.count === 1 ? t.s : -t.s);
          if (t.count > 1) {
      ...
      const bn = (t, e) => {
        const n = K(t.arr.buffer, t.pos + t.arr.byteOffset, e);
        t.pos += e;
        return n;
      };
      const kn = (t) => bn(t, In(t));
      ...
      const An = (t) => t.arr[t.pos];
      const Tn = (t) => t.arr[t.pos] + (t.arr[t.pos + 1] << 8);
      const xn = (t) =>
        (t.arr[t.pos] +
          (t.arr[t.pos + 1] << 8) +
          (t.arr[t.pos + 2] << 16) +
      ...
      const jn = (t) => Pn(t, 4).getFloat32(0, false);
      const Bn = (t) => Pn(t, 8).getFloat64(0, false);
      const Fn = (t) => Pn(t, 8).getBigInt64(0, false);
      const zn = (t) => Pn(t, 8).getBigUint64(0, false);
      const Jn = [
        (t) => undefined,
        (t) => null,
        Mn,
      ...
      const Qn =
        typeof window === 'undefined'
          ...
          : (typeof window.performance !== 'undefined' && window.performance) ||
            null;
      const Zn = typeof crypto === 'undefined' ? null : crypto;
      const ts =
        Zn !== null
          ? (t) => {
              const e = new ArrayBuffer(t);
              const n = new Uint8Array(e);
              Zn.getRandomValues(n);
              return e;
            }
          : (t) => {
              const e = new ArrayBuffer(t);
      ...
      const ps = (t) =>
        t instanceof Promise || (t && t.then && t.catch && t.finally);
      var ws = n(25404);
      const ms = Symbol;
      ...
      const vs = () => Cs.createDocumentFragment();
      const As = (t) => Cs.createTextNode(t);
      const Ts = typeof DOMParser !== 'undefined' ? new DOMParser() : null;
      const xs = (t, e, n) => t.dispatchEvent(new CustomEvent(e, n));
      const Is = (t, e) => {
        pair.forEach(e, (e, n) => {
          if (n === false) {
            t.removeAttribute(e);
      ...
      const Fs = null && As;
      const zs = (t) => `${t.left}:${t.right};`;
      const Js = (t) => t.map(zs).join('');
      const $s = (t) => o.Tj(t, (t, e) => `${e}:${t};`).join('');
      const Hs = (t, e) => t.querySelector(e);
      const Ws = (t, e) => t.querySelectorAll(e);
      const Ks = (t) => Cs.getElementById(t);
      const qs = (t) =>
        Ts.parseFromString(`<html><body>${t}</body></html>`, 'text/html').body;
      const Ys = (t) => Us(qs(t).childNodes);
      const Xs = (t) => qs(t).firstElementChild;
      const Gs = (t, e) => t.replaceWith(e);
      const Qs = (t, e, n) => t.insertBefore(e, n);
      const Zs = (t, e) => t.appendChild(e);
      ...
      const xr = (t, e) => Tr(`data:image/gif;base64,${t}`, e);
      const Ir = (...t) => {
        console.group(...Cr(t));
      ...
      class Pr {
        ...
        group(t, e = false) {
          eventloop.enqueue(() => {
            ...
            const r = dom.element(
              'div',
              [pair.create('style', `${Vr};padding-left:${this.depth * 10}px`)],
              [n, s, dom.text(' ')].concat(Rr(t))
            );
            ...
            dom.append(this.ccontainer, [
              dom.element(
                ...
                [
                  pair.create(
                    'style',
                    `${Vr};padding-left:${this.depth * 10}px`
                  )
                ],
                Rr(t)
              )
      ...
      const Jr = (t) => {
        ...
        const s =
          n !== null &&
          (n === '*' || n === 'true' || new RegExp(n, 'gi').test(t));
        Fr = (Fr + 1) % Br.length;
        t += ': ';
        return !s
          ? func.nop
      ...
      const ti = (t, e) => {
        ...
        return n !== undefined && Zr(n, e.clock) !== null;
      };
      const ei = (t) => {
        t.clients.forEach((t) => {
          ...
          for (e = 1, n = 1; e < t.length; e++) {
            ...
            if (s.clock + s.len >= r.clock) {
              s.len = i.T9(s.len, r.clock + r.len - s.clock);
            } else {
              if (n < e) {
                t[n] = r;
              }
      ...
      const si = (t, e, n, s) => {
        o._4(t.clients, e, () => []).push(new Xr(n, s));
      };
      const ri = () => new Gr();
      const ii = (t) => {
        const e = ri();
      ...
      const ci = (t) => {
        const e = new Gr();
        const n = In(t.restDecoder);
        for (let s = 0; s < n; s++) {
          t.resetDsCurVal();
          const n = In(t.restDecoder);
          const s = In(t.restDecoder);
          if (s > 0) {
            const r = o._4(e.clients, n, () => []);
            for (let e = 0; e < s; e++) {
              r.push(new Xr(t.readDsClock(), t.readDsLen()));
            }
          }
        }
        return e;
      ...
      const li = (t, e, n) => {
        const s = new Gr();
        const r = In(t.restDecoder);
        for (let i = 0; i < r; i++) {
          t.resetDsCurVal();
          const r = In(t.restDecoder);
          const i = In(t.restDecoder);
      ...
      class ai extends s.c {
        ...
        getSubdocGuids() {
          return new Set(r.HT(this.subdocs).map((t) => t.guid));
        }
        transact(t, e = null) {
          Jo(this, t, e);
        }
        get(t, e = Tc) {
          const n = o._4(this.share, t, () => {
            const t = new e();
        ...
        destroy() {
          r.HT(this.subdocs).forEach((t) => t.destroy());
          const t = this._item;
          if (t !== null) {
            this._item = null;
            const e = t.content;
      ...
      class di extends ui {
        readLeftID() {
          return $i(In(this.restDecoder), In(this.restDecoder));
        }
        readRightID() {
          return $i(In(this.restDecoder), In(this.restDecoder));
        }
      ...
      class fi {
        ...
        readDsClock() {
          this.dsCurrVal += In(this.restDecoder);
          return this.dsCurrVal;
        }
        readDsLen() {
          const t = In(this.restDecoder) + 1;
          this.dsCurrVal += t;
          return t;
        }
      }
      class gi extends fi {
        constructor(t) {
          ...
          this.keys = [];
          In(t);
          this.keyClockDecoder = new Xn(kn(t));
          this.clientDecoder = new qn(kn(t));
          this.leftClockDecoder = new Xn(kn(t));
          this.rightClockDecoder = new Xn(kn(t));
          this.infoDecoder = new Hn(kn(t), En);
          this.stringDecoder = new Gn(kn(t));
          this.parentInfoDecoder = new Hn(kn(t), En);
          this.typeRefDecoder = new qn(kn(t));
          this.lenDecoder = new qn(kn(t));
        }
        readLeftID() {
          return new zi(
      ...
      class wi extends pi {
        ...
        writeJSON(t) {
          ze(this.restEncoder, JSON.stringify(t));
        }
        writeKey(t) {
          ze(this.restEncoder, t);
        }
      ...
      class yi extends mi {
        constructor() {
          ...
          this.infoEncoder = new tn(xe);
          this.stringEncoder = new hn();
          this.parentInfoEncoder = new tn(xe);
        ...
        toUint8Array() {
          const t = Ee();
          Re(t, 0);
          He(t, this.keyClockEncoder.toUint8Array());
          He(t, this.clientEncoder.toUint8Array());
          He(t, this.leftClockEncoder.toUint8Array());
          He(t, this.rightClockEncoder.toUint8Array());
          He(t, De(this.infoEncoder));
          He(t, this.stringEncoder.toUint8Array());
          He(t, De(this.parentInfoEncoder));
          He(t, this.typeRefEncoder.toUint8Array());
          He(t, this.lenEncoder.toUint8Array());
          $e(t, De(this.restEncoder));
          return De(t);
        }
        writeLeftID(t) {
      ...
      const Si = (t, e, n) => {
        const s = [];
        let i = r.HT(n.keys()).sort((t, e) => t - e);
        if (i.length === 0) {
          return null;
        }
        const c = () => {
        ...
        while (true) {
          if (d.constructor !== uh) {
            const r = o._4(f, d.id.client, () => Do(e, d.id.client));
      ...
      const Ai = (t, e, n) => vi(t, e, n, di);
      const Ti = (t, e, n = new Map()) => {
        ki(t, e.store, n);
        oi(t, ii(e.store));
      };
      const xi = (t, e = new Uint8Array([0]), n = new yi()) => {
        const s = Ui(e);
        Ti(n, t, s);
      ...
      const Ji = (t, e) =>
        ...
        (t !== null &&
          ...
          t.client === e.client &&
          t.clock === e.clock);
      const $i = (t, e) => new zi(t, e);
      const Hi = (t, e) => {
        Re(t, e.client);
        Re(t, e.clock);
      };
      const Wi = (t) => $i(In(t), In(t));
      const Ki = (t) => {
              ...
              t.changes.added.forEach((t) => {
                t.content.getContent().forEach((t) => {
                  if (t instanceof Uint8Array) {
                    this.dss.set(
                      e,
                      ni([this.dss.get(e) || ri(), ci(new ui(wn(t)))])
                    );
                  }
                });
              });
      ...
      const Zi = (t) =>
        new Gi(
          t.type == null ? null : $i(t.type.client, t.type.clock),
          t.tname || null,
          t.item == null ? null : $i(t.item.client, t.item.clock),
      ...
      const no = (t, e, n) => {
        ...
        if (t._item === null) {
          ...
          s = $i(t._item.id.client, t._item.id.clock);
        }
        return new Gi(s, r, e, n);
      };
      const so = (t, e, n = 0) => {
        let s = t._start;
        if (n < 0) {
        ...
        while (s !== null) {
          if (!s.deleted && s.countable) {
            if (s.length > e) {
              return no(t, $i(s.id.client, s.id.clock + e), n);
            }
            e -= s.length;
          }
          if (s.right === null && n < 0) {
      ...
      const po = (t, e = new fi(wn(t))) => new ao(ci(e), Mi(e));
      ...
      const Mo = (t, e) => {
        ...
        return n[Io(t, n, e.clock)];
      };
      const Uo = (t, e, n) => {
        const s = e.clients.get(n.client);
        const r = Ao(s, n.clock);
        const i = s[r];
        if (n.clock !== i.id.clock + i.length - 1 && i.constructor !== xl) {
      ...
      const Ro = (t, e) => {
        if (
          ...
          !o.bz(e.afterState, (t, n) => e.beforeState.get(n) !== t)
        ) {
          return false;
        }
        ei(e.deleteSet);
      ...
      const Bo = (t, e) => {
        t.clients.forEach((t, n) => {
          ...
          for (let e = t.length - 1; e >= 0; e--) {
            const n = t[e];
            const r = i.jk(s.length - 1, 1 + Ao(s, n.clock + n.len - 1));
            for (
              let t = r, e = s[t];
      ...
      const Ho = (t, e, n) => {
        Qr(t, n.deletions, (t) => {
          if (t instanceof ch && e.scope.some((e) => qi(e, t))) {
            rh(t, false);
          }
        });
      };
        ...
        Jo(
          ...
          (n) => {
            while (e.length > 0 && s === null) {
              ...
              Qr(n, c.insertions, (t) => {
                if (t instanceof ch) {
                  if (t.redone !== null) {
                    ...
                    if (s > 0) {
                      e = Mo(n, $i(e.id.client, e.id.clock + s));
                    }
                    t = e;
                  }
                  if (!t.deleted && o.some((e) => qi(e, t))) {
                    h.push(t);
                  }
                }
              });
              ...
              l.forEach((e) => {
                a =
                  oh(n, e, l, c.insertions, t.ignoreRemoteMapChanges) !==
                    null || a;
              });
      ...
      class Ko extends s.c {
        constructor(
          ...
          this.afterTransactionHandler = (t) => {
            ...
            Qr(t, t.deleteSet, (t) => {
              if (t instanceof ch && this.scope.some((e) => qi(e, t))) {
                rh(t, true);
              }
            });
            const c = [
              {
                stackItem: s[s.length - 1],
                origin: t.origin,
                type: e ? 'redo' : 'undo',
        ...
        clear(t = true, e = true) {
          if ((t && this.canUndo()) || (e && this.canRedo())) {
            this.doc.transact((n) => {
              if (t) {
                this.undoStack.forEach((t) => Ho(n, this, t));
                this.undoStack = [];
              }
              if (e) {
                this.redoStack.forEach((t) => Ho(n, this, t));
                this.redoStack = [];
              }
      ...
      function* qo(t) {
        ...
        for (let n = 0; n < e; n++) {
          ...
          let s = In(t.restDecoder);
          for (let r = 0; r < e; r++) {
            const e = t.readInfo();
            if (e === 10) {
              const e = In(t.restDecoder);
              yield new uh($i(n, s), e);
              s += e;
            } else if ((Ft & e) !== 0) {
              const r = (e & (at | ut)) === 0;
              const i = new ch(
      ...
      const nc = (t, e = mi, n = gi) => {
        const s = new e();
        const r = new Yo(new n(wn(t)), false);
        let i = r.curr;
        if (i !== null) {
          let t = 0;
          let e = i.id.client;
      ...
      const rc = (t, e = gi) => {
        const n = new Map();
        const s = new Map();
        const r = new Yo(new e(wn(t)), false);
        let i = r.curr;
        if (i !== null) {
          let t = i.id.client;
          let e = i.id.clock;
      ...
      const oc = (t, e) => {
        if (t.constructor === xl) {
          ...
          return new xl($i(n, s + e), t.length - e);
        } else if (t.constructor === uh) {
          const { client: n, clock: s } = t.id;
          return new uh($i(n, s + e), t.length - e);
        } else {
          const n = t;
            ...
            if (e !== i.struct.id.client) {
              ...
              if (i.struct.id.clock + i.struct.length < n.id.clock) {
                if (i.struct.constructor === uh) {
                  ...
                  const s = new uh(
                    $i(e, i.struct.id.clock + i.struct.length),
                    t
                  );
                  i = { struct: s, offset: 0 };
                }
        ...
        while (h.curr) {
          ...
          if (t.id.clock + t.length > n) {
            ...
            while (
              h.curr &&
              h.curr.id.client === e &&
              h.curr.id.clock + h.curr.length <= n
            ) {
              h.next();
            }
          }
      ...
      const ac = (t) => {
        if (t.written > 0) {
          t.clientStructs.push({
            written: t.written,
            restEncoder: De(t.encoder.restEncoder)
          });
      ...
      const Cc = (t, e) => {
        ...
        const n =
          t._searchMarker.length === 0
            ...
            : t._searchMarker.reduce((t, n) =>
                i.tn(e - t.index) < i.tn(e - n.index) ? t : n
              );
        let s = t._start;
        let r = 0;
        if (n !== null) {
        ...
        if (n !== null && i.tn(n.index - r) < s.parent.length / yc) {
          Sc(n, s, r);
          return n;
        } else {
      ...
      const jc = (t, e, n) => {
        const s = (e._searchMarker || []).reduce(
      ...
      const Bc = (t, e, n, s) => {
        ...
        for (; c !== null && n > 0; c = c.right) {
          if (!c.deleted && c.countable) {
            if (n < c.length) {
              Mo(t, $i(c.id.client, c.id.clock + n));
            }
            n -= c.length;
          }
        }
        while (s > 0 && c !== null) {
          if (!c.deleted) {
            if (s < c.length) {
              Mo(t, $i(c.id.client, c.id.clock + s));
            }
            c.delete(t);
            s -= c.length;
          }
      ...
      const Wc = (t, e, n) => {
        ...
        return s !== null && ko(s, n)
          ? s.content.getContent()[s.length - 1]
          : undefined;
      };
      const Kc = (t) => Wr(t.entries(), (t) => !t[1].deleted);
      class qc extends wc {
        constructor(t, e) {
          super(t, e);
          this._transaction = e;
      ...
      class Yc extends Tc {
        ...
        clone() {
          ...
          t.insert(
            0,
            this.toArray().map((t) => (t instanceof Tc ? t.clone() : t))
          );
          return t;
        }
        get length() {
        ...
        toJSON() {
          return this.map((t) => (t instanceof Tc ? t.toJSON() : t));
        }
        map(t) {
          return Oc(this, t);
        }
      ...
      class Qc extends Tc {
        ...
        clone() {
          const t = new Qc();
          this.forEach((e, n) => {
            t.set(n, e instanceof Tc ? e.clone() : e);
          });
          return t;
        }
        _callObserver(t, e) {
          Ac(this, t, new Gc(this, t, e));
        }
        toJSON() {
          const t = {};
          this._map.forEach((e, n) => {
            if (!e.deleted) {
              ...
              t[n] = s instanceof Tc ? s.toJSON() : s;
            }
          });
          return t;
        }
        get size() {
          return [...Kc(this._map)].length;
        }
        keys() {
          return Kr(Kc(this._map), (t) => t[0]);
        }
        values() {
          return Kr(
            Kc(this._map),
        ...
        while (e.right !== null && n > 0) {
          switch (e.right.content.constructor) {
            ...
            default:
              if (!e.right.deleted) {
                if (n < e.right.length) {
                  Mo(t, $i(e.right.id.client, e.right.id.clock + n));
                }
      ...
      const rl = (t, e, n, s) => {
        while (
          ...
          (n.right.deleted === true ||
            (n.right.content.constructor === jl &&
              tl(s.get(n.right.content.key), n.right.content.value)))
        ) {
          if (!n.right.deleted) {
      ...
      const ol = (t, e) => {
        while (true) {
          if (t.right === null) {
            ...
            t.right.deleted ||
            (t.right.content.constructor === jl &&
              tl(e[t.right.content.key] || null, t.right.content.value))
          );
          else {
            break;
          }
      ...
      const hl = (t, e, n, s, r) => {
        ...
        t: while (
          ...
          (s > 0 ||
            (c.size > 0 &&
              (n.right.deleted || n.right.content.constructor === jl)))
        ) {
          if (!n.right.deleted) {
            switch (n.right.content.constructor) {
              ...
              default:
                if (s < n.right.length) {
                  Mo(t, $i(n.right.id.client, n.right.id.clock + s));
                }
                s -= n.right.length;
                break;
            }
      ...
      const al = (t, e, n, s, r) => {
        ...
        while (i && (!i.countable || i.deleted)) {
          if (!i.deleted && i.content.constructor === jl) {
            const t = i.content;
            c.set(t.key, t);
          }
          i = i.right;
      ...
      const ul = (t, e) => {
        ...
        const n = new Set();
        while (e && (e.deleted || !e.countable)) {
          if (!e.deleted && e.content.constructor === jl) {
      ...
      const fl = (t, e, n) => {
        const s = n;
        const r = o.C(e.currentAttributes);
        const i = e.right;
      ...
      class pl extends Tc {
          ...
          if (!t.local) {
            ...
            for (const [n, r] of t.afterState.entries()) {
              ...
              Lo(t, s.store.clients.get(n), i, r, (t) => {
                if (!t.deleted && t.content.constructor === jl) {
                  e = true;
                }
              });
              if (e) {
            ...
            if (!e) {
              Qr(t, t.deleteSet, (t) => {
                if (t instanceof xl || e) {
                  return;
                }
                if (t.parent === this && t.content.constructor === jl) {
                  e = true;
                }
              });
            }
        ...
        toString() {
          ...
          let e = this._start;
          while (e !== null) {
            if (!e.deleted && e.countable && e.content.constructor === Hl) {
              t += e.content.str;
            }
            e = e.right;
          }
        ...
        next() {
          ...
          if (
            ...
            do {
              ...
              if (
                !t.deleted &&
                (e.constructor === kl || e.constructor === yl) &&
                e._start !== null
              ) {
                t = e._start;
              } else {
      ...
      class yl extends Tc {
        ...
        querySelectorAll(t) {
          t = t.toUpperCase();
          return r.HT(
            new ml(this, (e) => e.nodeName && e.nodeName.toUpperCase() === t)
          );
        }
        _callObserver(t, e) {
          Ac(this, t, new Sl(this, e, t));
        }
        toString() {
        ...
        insertAfter(t, e) {
          if (this.doc !== null) {
            Jo(this.doc, (n) => {
              const s = t && t instanceof Tc ? t._item : t;
              Rc(n, this, s, e);
            });
          } else {
      ...
      class Ul {
        ...
        copy() {
          return new Ul(this.len);
        }
        splice(t) {
          const e = new Ul(this.len - t);
          this.len = t;
          return e;
        }
        mergeWith(t) {
      ...
      class jl {
        ...
        copy() {
          return new jl(this.key, this.value);
        }
        splice(t) {
          throw un();
        }
      ...
      const Bl = (t) => new jl(t.readKey(), t.readJSON());
      class Fl {
        constructor(t) {
          this.arr = t;
        }
        ...
        splice(t) {
          const e = new Fl(this.arr.slice(t));
      ...
      class Hl {
        ...
        splice(t) {
          const e = new Hl(this.str.slice(t));
      ...
      const Wl = (t) => new Hl(t.readString());
      const Kl = [Xc, Zc, wl, _l, bl, Cl, vl];
      const ql = 0;
      const Yl = 1;
      const Xl = 2;
      const Gl = 3;
      ...
      const nh = (t) => new eh(Kl[t.readTypeRef()](t));
      const sh = (t, e) => {
        let n = e;
        let s = 0;
        let r;
      ...
      const ih = (t, e, n) => {
        ...
        if (e.redone !== null) {
          i.redone = $i(e.redone.client, e.redone.clock + n);
        }
        e.right = i;
        if (i.right !== null) {
          i.right.left = i;
        ...
        if (e.parentSub === null) {
          ...
          while (a !== null) {
            ...
            while (e !== null && e.parent._item !== h) {
              e = e.redone === null ? null : Mo(t, e.redone);
            }
      ...
      class ch extends Al {
        ...
        getMissing(t, e) {
          if (
            ...
            this.origin.clock >= Do(e, this.origin.client)
          ) {
          ...
          if (
            ...
            this.rightOrigin.clock >= Do(e, this.rightOrigin.client)
          ) {
            return this.rightOrigin.client;
          }
          if (
            this.parent &&
            this.parent.constructor === zi &&
          ...
          if (this.origin) {
            this.left = Uo(t, e, this.origin);
            this.origin = this.left.lastId;
          }
          if (this.rightOrigin) {
            this.right = Mo(t, this.rightOrigin);
            this.rightOrigin = this.right.id;
          }
          if (
            (this.left && this.left.constructor === xl) ||
            (this.right && this.right.constructor === xl)
          ) {
            this.parent = null;
          }
          if (!this.parent) {
          ...
          } else if (this.parent.constructor === zi) {
            const t = xo(e, this.parent);
            if (t.constructor === xl) {
              this.parent = null;
            } else {
        ...
        integrate(t, e) {
          if (e > 0) {
            ...
            this.left = Uo(
              t,
              t.doc.store,
              $i(this.id.client, this.id.clock - 1)
            );
            this.origin = this.left.lastId;
          ...
          if (this.parent) {
            if (
              ...
              while (n !== null && n !== this.right) {
                ...
                if (Ji(this.origin, n.origin)) {
                  ...
                  n.origin !== null &&
                  r.has(xo(t.doc.store, n.origin))
                ) {
                  if (!s.has(xo(t.doc.store, n.origin))) {
                    e = n;
                    s.clear();
                  }
                } else {
            ...
            Vo(t, this.parent, this.parentSub);
            if (
            ...
            new xl(this.id, this.length).integrate(t, 0);
          }
        }
        get next() {
          let t = this.right;
        ...
        get lastId() {
          return this.length === 1
            ? this.id
            : $i(this.id.client, this.id.clock + this.length - 1);
        }
        mergeWith(t) {
          if (
        ...
        gc(t, e) {
          ...
          this.content.gc(t);
          if (e) {
            Oo(t, this, new xl(this.id, this.length));
          } else {
            this.content = new Ul(this.length);
          }
        }
        write(t, e) {
          const n =
            e > 0 ? $i(this.id.client, this.id.clock + e - 1) : this.origin;
          const s = this.rightOrigin;
          const r = this.parentSub;
          const i =
            (this.content.getRef() & Ft) |
            (n === null ? 0 : ut) |
            (s === null ? 0 : at) |
            (r === null ? 0 : ht);
          t.writeInfo(i);
