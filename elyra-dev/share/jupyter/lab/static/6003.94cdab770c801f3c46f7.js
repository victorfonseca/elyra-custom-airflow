    ...
    56003: (t, e, n) => {
      ...
      function h(t) {
        for (let e = 0; e < i.length; e++) {
          if (s[e] > t) return i[e] <= t;
        }
        return false;
      }
      const o = 8205;
      function a(t, e, n = true, i = true) {
        return (n ? f : c)(t, e, i);
      }
      function f(t, e, n) {
        if (e == t.length) return e;
        if (e && d(t.charCodeAt(e)) && g(t.charCodeAt(e - 1))) e--;
        let i = u(t, e);
        e += p(i);
        while (e < t.length) {
          let s = u(t, e);
      ...
      class m {
        ...
        replace(t, e, n) {
          ...
          return x.from(i, this.length - (e - t) + n.length);
        }
        append(t) {
        ...
        static of(t) {
          ...
          if (t.length == 1 && !t[0]) return m.empty;
          return t.length <= 32 ? new w(t) : x.from(w.split(t, []));
        }
      }
      class w extends m {
        constructor(t, e = v(t)) {
        ...
        lineInner(t, e, n, i) {
          for (let s = 0; ; s++) {
            let r = this.text[s],
              l = i + r.length;
            if ((e ? n : l) >= t) return new P(i, l, n, r);
            i = l + 1;
            n++;
          }
        }
        decompose(t, e, n, i) {
          ...
          if (i & 1) {
            let t = n.pop();
            let e = k(s.text, t.text.slice(), 0, s.length);
            if (e.length <= 32) {
              n.push(new w(e, t.length + s.length));
            } else {
              let t = e.length >> 1;
              n.push(new w(e.slice(0, t)), new w(e.slice(t)));
            }
          } else {
            n.push(s);
          }
        ...
        replace(t, e, n) {
          if (!(n instanceof w)) return super.replace(t, e, n);
          [t, e] = E(this, t, e);
          let i = k(this.text, k(n.text, y(this.text, 0, t)), e);
          let s = this.length + n.length - (e - t);
          if (i.length <= 32) return new w(i, s);
          return x.from(w.split(i, []), s);
        }
      ...
      class x extends m {
          ...
          if (n.lines < this.lines)
            for (let i = 0, s = 0; i < this.children.length; i++) {
              let r = this.children[i],
                l = s + r.length;
              if (t >= s && e <= l) {
                let h = r.replace(t - s, e - s, n);
                let o = this.lines - r.lines + h.lines;
                if (h.lines < o >> (5 - 1) && h.lines > o >> (5 + 1)) {
                  let s = this.children.slice();
                  s[i] = h;
                  return new x(s, this.length - (e - t) + n.length);
                }
                return super.replace(s, l, h);
              }
              s = l + 1;
            }
        ...
        static from(t, e = t.reduce((t, e) => t + e.length + 1, -1)) {
          ...
          function f(t) {
            let e;
            if (t.lines > s && t instanceof x) {
              for (let e of t.children) f(e);
            } else if (t.lines > r && (h > r || !h)) {
              c();
              l.push(t);
            } else if (
              t instanceof w &&
              h &&
              (e = a[a.length - 1]) instanceof w &&
              t.lines + e.lines <= 32
            ) {
              h += t.lines;
              o += t.length + 1;
          ...
          function c() {
            if (h == 0) return;
            l.push(a.length == 1 ? a[0] : x.from(a, o));
            o = -1;
            h = a.length = 0;
          }
          for (let u of t) f(u);
          c();
          return l.length == 1 ? l[0] : new x(l, e);
        }
      }
      m.empty = new w([''], 0);
      function v(t) {
      ...
      class S {
        constructor(t, e = 1) {
          ...
          this.offsets = [
            e > 0
              ? 1
              : (t instanceof w ? t.text.length : t.children.length) << 1
          ];
        }
        nextInner(t, e) {
          ...
          for (;;) {
            ...
            let i = this.nodes[n],
              s = this.offsets[n],
              r = s >> 1;
            let l = i instanceof w ? i.text.length : i.children.length;
            if (r == (e > 0 ? l : 0)) {
              if (n == 0) {
                this.done = true;
                this.value = '';
              ...
              if (s.length > Math.max(0, t)) {
                this.value =
                  t == 0 ? s : e > 0 ? s.slice(t) : s.slice(0, s.length - t);
                return this;
              }
              t -= s.length;
            } else {
              ...
              if (t > s.length) {
                ...
                this.offsets.push(
                  e > 0
                    ? 1
                    : (s instanceof w ? s.text.length : s.children.length) << 1
                );
              }
            }
          }
      ...
      if (typeof Symbol != 'undefined') {
        ...
        S.prototype[Symbol.iterator] =
          b.prototype[Symbol.iterator] =
          I.prototype[Symbol.iterator] =
            function () {
              return this;
            };
      }
      ...
      class N {
        ...
        composeDesc(t) {
          return this.empty ? t : t.empty ? this : $(this, t);
        }
        mapDesc(t, e = false) {
          return t.empty ? this : q(this, t, e);
        }
        mapPos(t, e = -1, n = B.Simple) {
          let i = 0,
            s = 0;
          for (let r = 0; r < this.sections.length; ) {
            ...
            if (h < 0) {
              ...
              if (
                n != B.Simple &&
                o >= t &&
                ((n == B.TrackDel && i < t && o > t) ||
                  (n == B.TrackBefore && i < t) ||
                  (n == B.TrackAfter && o > t))
              )
                return null;
              if (o > t || (o == t && e < 0 && !l))
                return t == i || e < 0 ? s : s + h;
              s += h;
            }
            i = o;
          }
      ...
      class D extends N {
        ...
        apply(t) {
          ...
          j(this, (e, n, i, s, r) => (t = t.replace(i, i + (n - e), r)), false);
          return t;
        }
        mapDesc(t, e = false) {
          return q(this, t, e, true);
        }
        invert(t) {
          ...
          for (let i = 0, s = 0; i < e.length; i += 2) {
            ...
            if (l >= 0) {
              ...
              e[i + 1] = r;
              let h = i >> 1;
              while (n.length < h) n.push(m.empty);
              n.push(r ? t.slice(s, s + r) : m.empty);
            }
            s += r;
          }
          return new D(e, n);
        ...
        compose(t) {
          return this.empty ? t : t.empty ? this : $(this, t, true);
        }
        map(t, e = false) {
          return t.empty ? this : q(this, t, e, true);
        }
        iterChanges(t, e = false) {
          j(this, t, e);
        }
        get desc() {
          return N.create(this.sections);
        }
        filter(t) {
          let e = [],
            n = [],
          ...
          t: for (let r = 0, l = 0; ; ) {
            ...
            while (l < o) {
              ...
              J(e, t, -1);
              J(i, t, s.ins == -1 ? -1 : s.off == 0 ? s.ins : 0);
              s.forward(t);
              l += t;
            }
          }
          return { changes: new D(e, n), filtered: N.create(i) };
        }
        toJSON() {
          let t = [];
          for (let e = 0; e < this.sections.length; e += 2) {
        ...
        static of(t, e, n) {
          ...
          function o(t) {
            if (Array.isArray(t)) {
              ...
              h();
              l = l ? l.compose(t.map(l)) : t;
            } else {
              let { from: l, to: o = l, insert: a } = t;
              if (l > o || l < 0 || o > e)
                throw new RangeError(
                  `Invalid change range ${l} to ${o} (in doc of length ${e})`
                );
              let f = !a
                ? m.empty
                : typeof a == 'string'
        ...
        static fromJSON(t) {
          ...
          for (let i = 0; i < t.length; i++) {
            ...
            if (typeof s == 'number') {
              ...
              !Array.isArray(s) ||
              typeof s[0] != 'number' ||
              s.some((t, e) => e && typeof t != 'string')
            ) {
              throw new RangeError('Invalid JSON representation of ChangeSet');
            } else if (s.length == 1) {
              e.push(s[0], 0);
            } else {
              while (n.length < i) n.push(m.empty);
              n[i] = m.of(s.slice(1));
              e.push(s[0], n[i].length);
            }
          }
          return new D(e, n);
        }
      ...
      function J(t, e, n, i = false) {
        if (e == 0 && n <= 0) return;
        let s = t.length - 2;
        if (s >= 0 && n <= 0 && n == t[s + 1]) t[s] += e;
        else if (s >= 0 && e == 0 && t[s] == 0) t[s + 1] += n;
        else if (i) {
          t[s] += e;
          t[s + 1] += n;
        } else t.push(e, n);
      ...
      function L(t, e, n) {
        ...
        if (i < t.length) {
          ...
          while (t.length < i) t.push(m.empty);
          t.push(n);
        }
      }
      function j(t, e, n) {
        ...
        for (let s = 0, r = 0, l = 0; l < t.sections.length; ) {
          ...
          if (o < 0) {
            ...
            for (;;) {
              a += h;
              f += o;
              if (o && i) c = c.append(i[(l - 2) >> 1]);
              if (n || l == t.sections.length || t.sections[l + 1] < 0) break;
              h = t.sections[l++];
              o = t.sections[l++];
            }
            e(s, a, r, f, c);
      ...
      function q(t, e, n, i = false) {
        let s = [],
          r = i ? [] : null;
        let l = new _(t),
          h = new _(e);
        for (let o = -1; ; ) {
          if ((l.done && h.len) || (h.done && l.len)) {
            throw new Error('Mismatched change set lengths');
          } else if (l.ins == -1 && h.ins == -1) {
            ...
            (l.ins < 0 ||
              o == l.i ||
              (l.off == 0 && (h.len < l.len || (h.len == l.len && !n))))
          ) {
            let t = h.len;
            J(s, h.ins, -1);
            while (t) {
            ...
            J(s, t, o < l.i ? l.ins : 0);
            if (r && o < l.i) L(r, s, l.text);
            o = l.i;
            l.forward(l.len - e);
          } else if (l.done && h.done) {
            return r ? D.createSet(s, r) : N.create(s);
          } else {
            throw new Error('Mismatched change set lengths');
          }
        }
      ...
      function $(t, e, n = false) {
        ...
        for (let h = false; ; ) {
          if (r.done && l.done) {
            return s ? D.createSet(i, s) : N.create(i);
          } else if (r.ins == 0) {
            J(i, r.len, 0, h);
            r.next();
            ...
            if (r.ins == -1) {
              ...
              J(i, r.off ? 0 : r.len, t, h);
              if (s) L(s, i, r.textBit(t));
            } else {
              J(i, r.off ? 0 : r.len, l.off ? 0 : l.ins, h);
              if (s && !l.off) L(s, i, l.text);
            }
      ...
      class _ {
        ...
        textBit(t) {
          ...
          return n >= e.length && !t
            ? m.empty
            : e[n].slice(this.off, t == null ? undefined : this.off + t);
        }
        forward(t) {
      ...
      class V {
        ...
        eq(t, e = false) {
          ...
          for (let n = 0; n < this.ranges.length; n++)
            if (!this.ranges[n].eq(t.ranges[n], e)) return false;
          return true;
        }
        get main() {
        ...
        replaceRange(t, e = this.mainIndex) {
          ...
          n[e] = t;
          return V.create(n, this.mainIndex);
        }
        toJSON() {
          return {
        ...
        static cursor(t, e = 0, n, i) {
          return z.create(
            ...
            (e == 0 ? 0 : e < 0 ? 8 : 16) |
              ...
              ((i !== null && i !== void 0 ? i : 16777215) << 6)
          );
        }
        static range(t, e, n, i) {
          let s =
            ((n !== null && n !== void 0 ? n : 16777215) << 6) |
            (i == null ? 7 : Math.min(6, i));
          return e < t
            ? z.create(e, t, 32 | 16 | s)
            : z.create(t, e, (e > t ? 8 : 0) | s);
        }
          ...
          for (let i = 1; i < t.length; i++) {
            ...
            if (n.empty ? n.from <= s.to : n.from < s.to) {
              ...
              t.splice(
                --i,
                2,
                n.anchor > n.head ? V.range(l, r) : V.range(r, l)
              );
            }
          }
          return new V(t, e);
      ...
      class G {
        ...
        static define(t = {}) {
          return new G(
            ...
            t.compare || (!t.combine ? H : (t, e) => t === e),
            !!t.static,
            t.enables
          );
        }
        of(t) {
          return new K([], this, 0, t);
        }
        compute(t, e) {
          if (this.isStatic) throw new Error("Can't compute a static facet");
          return new K(t, this, 1, e);
        }
        computeN(t, e) {
          if (this.isStatic) throw new Error("Can't compute a static facet");
          return new K(t, this, 2, e);
        }
        from(t, e) {
          if (!e) e = (t) => t;
        ...
        dynamicSlot(t) {
          ...
          return {
            ...
            update(t, e) {
              if (
                (h && e.docChanged) ||
                (o && (e.docChanged || e.selection)) ||
                X(t, a)
              ) {
                let e = n(t);
                if (l ? !Q(e, t.values[r], i) : !i(e, t.values[r])) {
                  t.values[r] = e;
                  return 1;
                }
              }
                ...
                if (
                  this.dependencies.every((n) =>
                    n instanceof G
                      ? e.facet(n) === t.facet(n)
                      : n instanceof tt
                        ? e.field(n, false) == t.field(n, false)
                        : true
                  ) ||
                  (l ? Q((h = n(t)), s, i) : i((h = n(t)), s))
                ) {
                  t.values[r] = s;
                  return 0;
                }
      ...
      function X(t, e) {
        let n = false;
        for (let i of e) if (at(t, i) & 1) n = true;
        return n;
      }
      function Y(t, e, n) {
      ...
      class tt {
        ...
        create(t) {
          let e = t.facet(Z).find((t) => t.field == this);
          return (
            (e === null || e === void 0 ? void 0 : e.create) || this.createF
          )(t);
        }
        slot(t) {
          let e = t[this.id] >> 1;
          return {
            ...
            reconfigure: (t, n) => {
              let i = t.facet(Z),
                ...
                r;
              if (
                (r = i.find((t) => t.field == this)) &&
                r != s.find((t) => t.field == this)
              ) {
                t.values[e] = r.create(t);
                return 1;
              }
        ...
        init(t) {
          return [this, Z.of({ field: this, create: t })];
        }
        get extension() {
          return this;
        }
      ...
      const it = {
        highest: nt(et.highest),
        high: nt(et.high),
        default: nt(et.default),
        low: nt(et.low),
        lowest: nt(et.lowest)
      };
      class st {
      ...
      class rt {
        ...
        reconfigure(t) {
          return rt.reconfigure.of({ compartment: this, extension: t });
        }
        get(t) {
      ...
      class ht {
        constructor(t, e, n, i, s, r) {
          ...
          this.facets = r;
          this.statusTemplate = [];
          while (this.statusTemplate.length < n.length)
        ...
        static resolve(t, e, n) {
          ...
          let r = new Map();
          for (let c of ot(t, e, r)) {
            if (c instanceof tt) i.push(c);
      ...
      function ot(t, e, n) {
        ...
        function r(t, l) {
          ...
          if (h != null) {
            ...
            if (t instanceof lt) n.delete(t.compartment);
          }
          s.set(t, l);
          if (Array.isArray(t)) {
            for (let e of t) r(e, l);
          } else if (t instanceof lt) {
            if (n.has(t.compartment))
              throw new RangeError(
            ...
            i[l].push(t);
            if (t.facet.extensions) r(t.facet.extensions, et.default);
          } else {
            let e = t.extension;
            if (!e)
              throw new Error(
      ...
      const ct = G.define();
      const ut = G.define({ combine: (t) => t.some((t) => t), static: true });
      const dt = G.define({
        combine: (t) => (t.length ? t[0] : undefined),
        static: true
      });
      const gt = G.define();
      const pt = G.define();
      const mt = G.define();
      const wt = G.define({ combine: (t) => (t.length ? t[0] : false) });
      class xt {
        constructor(t, e) {
          this.type = t;
          this.value = e;
      ...
      yt.reconfigure = yt.define();
      yt.appendConfig = yt.define();
      class St {
        constructor(t, e, n, i, s, r) {
          this.startState = t;
          this.changes = e;
          ...
          this._doc = null;
          this._state = null;
          if (n) W(n, e.newLength);
          if (!s.some((t) => t.type == St.time))
            this.annotations = s.concat(St.time.of(Date.now()));
        }
        static create(t, e, n, i, s, r) {
          return new St(t, e, n, i, s, r);
        }
        get newDoc() {
          return (
        ...
        isUserEvent(t) {
          let e = this.annotation(St.userEvent);
          return !!(
            e &&
            (e == t ||
              (e.length > t.length &&
      ...
      St.time = xt.define();
      St.userEvent = xt.define();
      St.addToHistory = xt.define();
      St.remote = xt.define();
      function bt(t, e) {
        let n = [];
        for (let i = 0, s = 0; ; ) {
      ...
      function It(t, e, n) {
        ...
        return {
          ...
          effects: yt
            ...
            .concat(yt.mapEffects(e.effects, r)),
      ...
      function Pt(t, e, n) {
        let i = e.selection,
          s = Rt(e.annotations);
        if (e.userEvent) s = s.concat(St.userEvent.of(e.userEvent));
        return {
          changes:
            e.changes instanceof D
              ? e.changes
              : D.of(e.changes || [], n, t.facet(dt)),
      ...
      function Et(t, e, n) {
        let i = Pt(t, e.length ? e[0] : {}, t.doc.length);
        if (e.length && e[0].filter === false) n = false;
        for (let r = 1; r < e.length; r++) {
          if (e[r].filter === false) n = false;
          let s = !!e[r].sequential;
          i = It(i, Pt(t, e[r], s ? i.changes.newLength : t.doc.length), s);
        }
        let s = St.create(
          t,
          i.changes,
      ...
      function Mt(t) {
        let e = t.startState;
        let n = true;
        for (let s of e.facet(gt)) {
          let e = s(t);
          if (e === false) {
            n = false;
            break;
          }
          if (Array.isArray(e)) n = n === true ? e : bt(n, e);
        }
        if (n !== true) {
          let i, s;
          if (n === false) {
            s = t.changes.invertedDesc;
            i = D.empty(e.doc.length);
          } else {
        ...
        for (let s = i.length - 1; s >= 0; s--) {
          let n = i[s](t);
          if (n instanceof St) t = n;
          else if (Array.isArray(n) && n.length == 1 && n[0] instanceof St)
            t = n[0];
          else t = Et(e, Rt(n), false);
        }
        return t;
      }
      function At(t) {
        ...
        for (let s = n.length - 1; s >= 0; s--) {
          ...
          if (r && Object.keys(r).length)
            i = It(i, Pt(e, r, t.changes.newLength), true);
        }
        return i == t
          ? t
          : St.create(
      ...
      const Ct = [];
      function Rt(t) {
        return t == null ? Ct : Array.isArray(t) ? t : [t];
      }
      var Ot = (function (t) {
        t[(t['Word'] = 0)] = 'Word';
        t[(t['Space'] = 1)] = 'Space';
      ...
      let Ft;
      try {
        Ft = new RegExp('[\\p{Alphabetic}\\p{Number}_]', 'u');
      } catch (ie) {}
      function Bt(t) {
        if (Ft) return Ft.test(t);
      ...
      function Nt(t) {
        return (e) => {
          if (!/\S/.test(e)) return Ot.Space;
          if (Bt(e)) return Ot.Word;
          for (let n = 0; n < t.length; n++)
            if (e.indexOf(t[n]) > -1) return Ot.Word;
          return Ot.Other;
        };
      }
      class Dt {
        ...
        applyTransaction(t) {
          ...
          for (let l of t.effects) {
            ...
            } else if (l.is(yt.reconfigure)) {
              e = null;
              n = l.value;
            } else if (l.is(yt.appendConfig)) {
              e = null;
              n = Rt(n).concat(l.value);
            }
          }
          let s;
          if (!e) {
            e = ht.resolve(n, i, this);
            let t = new Dt(
              e,
              this.doc,
              this.selection,
          ...
          let r = t.startState.facet(ut)
            ? t.newSelection
            : t.newSelection.asSingle();
          new Dt(e, t.newDoc, r, s, (e, n) => n.update(e, t), t);
        }
        replaceSelection(t) {
          if (typeof t == 'string') t = this.toText(t);
          return this.changeByRange((e) => ({
        ...
        changeByRange(t) {
          ...
          for (let l = 1; l < e.ranges.length; l++) {
            ...
            i = i.compose(o);
            r = yt.mapEffects(r, o).concat(yt.mapEffects(Rt(n.effects), a));
          }
          return {
            changes: i,
        ...
        changes(t = []) {
          ...
          return D.of(t, this.doc.length, this.facet(Dt.lineSeparator));
        }
        toText(t) {
          return m.of(t.split(this.facet(Dt.lineSeparator) || F));
        }
        ...
        toJSON(t) {
          ...
          if (t)
            for (let n in t) {
              let i = t[n];
              if (i instanceof tt && this.config.address[i.id] != null)
        ...
        static create(t = {}) {
          let e = ht.resolve(t.extensions || [], new Map());
          let n =
            t.doc instanceof m
              ? t.doc
              : m.of((t.doc || '').split(e.staticFacet(Dt.lineSeparator) || F));
          let i = !t.selection
            ? V.single(0)
          ...
          W(i, n.length);
          if (!e.staticFacet(ut)) i = i.asSingle();
          return new Dt(
            e,
            n,
            i,
        ...
        get readOnly() {
          return this.facet(wt);
        }
        phrase(t, ...e) {
          for (let n of this.facet(Dt.phrases))
        ...
        charCategorizer(t) {
          return Nt(this.languageDataAt('wordChars', t).join(''));
        }
        wordAt(t) {
          ...
          while (r > 0) {
            let t = M(e, r, false);
            if (s(e.slice(t, r)) != Ot.Word) break;
            r = t;
          }
          while (l < i) {
            let t = M(e, l);
            if (s(e.slice(l, t)) != Ot.Word) break;
            l = t;
          }
          return r == l ? null : V.range(r + n, l + n);
        }
      }
      Dt.allowMultipleSelections = ut;
      Dt.tabSize = G.define({ combine: (t) => (t.length ? t[0] : 4) });
      Dt.lineSeparator = dt;
      Dt.readOnly = wt;
      Dt.phrases = G.define({
        compare(t, e) {
      ...
      Dt.languageData = ct;
      Dt.changeFilter = gt;
      Dt.transactionFilter = pt;
      Dt.transactionExtender = mt;
      rt.reconfigure = yt.define();
      function Jt(t, e, n = {}) {
        let i = {};
        for (let s of t)
      ...
      class Lt {
        ...
        range(t, e = t) {
          return jt.create(t, e, this);
        }
      }
      Lt.prototype.startSide = Lt.prototype.endSide = 0;
      Lt.prototype.point = false;
      Lt.prototype.mapMode = B.TrackDel;
      class jt {
        constructor(t, e, n) {
          this.from = t;
          this.to = e;
      ...
      class $t {
        ...
        between(t, e, n, i) {
          for (
            let s = this.findIndex(e, -1e9, true),
              r = this.findIndex(n, 1e9, false, s);
            s < r;
            s++
          )
            if (i(this.from[s] + t, this.to[s] + t, this.value[s]) === false)
              return false;
        }
        map(t, e) {
          let n = [],
          ...
          for (let h = 0; h < this.value.length; h++) {
            ...
            if (a == f) {
              ...
              if (c > u || (c == u && o.startSide > 0 && o.endSide <= 0))
                continue;
            }
          ...
          return { mapped: n.length ? new $t(i, s, n, l) : null, pos: r };
        }
      }
      class _t {
        constructor(t, e, n, i) {
        ...
        update(t) {
          ...
          if (n) e = e.slice().sort(qt);
          if (this.isEmpty) return e.length ? _t.of(e) : this;
          let l = new Ut(this, null, -1).goto(0),
            h = 0,
            o = [];
          let a = new Vt();
          while (l.value || h < e.length) {
            if (
              h < e.length &&
              (l.from - e[h].from || l.startSide - e[h].value.startSide) >= 0
            ) {
              let t = e[h++];
              ...
              if (!r || i > l.to || s < l.from || r(l.from, l.to, l.value)) {
                if (!a.addInner(l.from, l.to, l.value))
                  o.push(jt.create(l.from, l.to, l.value));
              }
              l.next();
            }
          }
        ...
        map(t) {
          ...
          return e.length == 0 ? s : new _t(n, e, s || _t.empty, i);
        }
        between(t, e, n) {
        ...
        iter(t = 0) {
          return Gt.from([this]).goto(t);
        }
        get isEmpty() {
          return this.nextLayer == this;
        }
        static iter(t, e = 0) {
          return Gt.from(t).goto(e);
        }
        static compare(t, e, n, i, s = -1) {
          ...
          let o = new Kt(r, h, s);
          let a = new Kt(l, h, s);
          n.iterGaps((t, e, n) => Qt(o, t, a, e, n, i));
          if (n.empty && n.length == 0) Qt(o, 0, a, 0, 0, i);
        }
        static eq(t, e, n = 0, i) {
          if (i == null) i = 1e9 - 1;
          ...
          let l = Wt(s, r);
          let h = new Kt(s, l, 0).goto(n),
            o = new Kt(r, l, 0).goto(n);
          for (;;) {
            if (
              h.to != o.to ||
              !Xt(h.active, o.active) ||
              (h.point && (!o.point || !h.point.eq(o.point)))
            )
              return false;
        ...
        static of(t, e = false) {
          let n = new Vt();
          for (let i of t instanceof jt ? [t] : e ? zt(t) : t)
            n.add(i.from, i.to, i.value);
          return n.finish();
        }
        static join(t) {
          if (!t.length) return _t.empty;
          let e = t[t.length - 1];
          for (let n = t.length - 2; n >= 0; n--) {
            for (let i = t[n]; i != _t.empty; i = i.nextLayer)
              e = new _t(
                i.chunkPos,
                i.chunk,
                e,
      ...
      function zt(t) {
        if (t.length > 1)
          for (let e = t[0], n = 1; n < t.length; n++) {
            let i = t[n];
            if (qt(e, i) > 0) return t.slice().sort(qt);
            e = i;
          }
        return t;
      }
      ...
      class Vt {
        ...
        add(t, e, n) {
          if (!this.addInner(t, e, n))
            (this.nextLayer || (this.nextLayer = new Vt())).add(t, e, n);
        }
        addInner(t, e, n) {
          let i = t - this.lastTo || n.startSide - this.last.endSide;
          if (
            i <= 0 &&
            (t - this.lastFrom || n.startSide - this.last.startSide) < 0
          )
            throw new Error(
      ...
      function Wt(t, e, n) {
        ...
        for (let r of t)
          for (let t = 0; t < r.chunk.length; t++)
            if (r.chunk[t].maxPoint <= 0) i.set(r.chunk[t], r.chunkPos[t]);
        let s = new Set();
        for (let r of e)
          for (let t = 0; t < r.chunk.length; t++) {
            ...
            if (
              ...
              !(n === null || n === void 0
                ? void 0
                : n.touchesRange(e, e + r.chunk[t].length))
            )
              s.add(r.chunk[t]);
          }
        return s;
      ...
      class Gt {
        ...
        static from(t, e = null, n = -1) {
          ...
          for (let s = 0; s < t.length; s++) {
            for (let r = t[s]; !r.isEmpty; r = r.nextLayer) {
              if (r.maxPoint >= n) i.push(new Ut(r, e, n, s));
            }
          }
          return i.length == 1 ? i[0] : new Gt(i);
        }
        get startSide() {
          return this.value ? this.value.startSide : 0;
        }
        goto(t, e = -1e9) {
          ...
          for (let n = this.heap.length >> 1; n >= 0; n--) Ht(this.heap, n);
          this.next();
          return this;
        }
        forward(t, e) {
      ...
      class Kt {
        ...
        removeActive(t) {
          ...
          this.minActive = te(this.active, this.activeTo);
        }
        addActive(t) {
          let e = 0,
          ...
          while (
            ...
            e++;
          Zt(this.active, e, n);
          Zt(this.activeTo, e, i);
          Zt(this.activeRank, e, s);
          if (t) Zt(t, e, this.cursor.from);
          this.minActive = te(this.active, this.activeTo);
        }
        next() {
          let t = this.to,
          ...
          if (n) {
            this.openStart = 0;
            for (let e = n.length - 1; e >= 0 && n[e] < t; e--)
              this.openStart++;
          }
        }
        activeForPoint(t) {
      ...
      function Qt(t, e, n, i, s, r) {
        ...
        for (;;) {
          let e = t.to + o - n.to,
            i = e || t.endSide - n.endSide;
          let s = i < 0 ? t.to + o : n.to,
            a = Math.min(s, l);
          if (t.point || n.point) {
            if (
              !(
                ...
                Xt(t.activeForPoint(t.to), n.activeForPoint(n.to))
              )
            )
              r.comparePoint(h, a, t.point, n.point);
          } else {
            if (a > h && !Xt(t.active, n.active))
              r.compareRange(h, a, t.active, n.active);
          }
          if (s > l) break;
          if ((e || t.openEnd != n.openEnd) && r.boundChange) r.boundChange(s);
          h = s;
          if (i <= 0) t.next();
          if (i >= 0) n.next();
        }
      ...
      function Xt(t, e) {
        if (t.length != e.length) return false;
        for (let n = 0; n < t.length; n++)
          if (t[n] != e[n] && !t[n].eq(e[n])) return false;
        return true;
      }
      function Yt(t, e) {
