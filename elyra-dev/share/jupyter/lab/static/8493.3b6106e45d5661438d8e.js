...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [8493],
  {
    40874: (e, t, n) => {
      ...
      function c(e, t) {
        var n = e.match(/^(\.|[\w\$_]+)/);
        if (!n || !e.match(n[0] == '.' ? /^[\w$_]/ : /^\./)) t.tokenize.pop();
        if (!n) return t.tokenize[t.tokenize.length - 1](e, t);
      ...
      const v = {
        ...
        token: function (e, t) {
          ...
          if ((s == ';' || s == ':') && n.type == 'statement') y(t);
            ...
            n.type == '}' ||
            n.type == 'top' ||
            (n.type == 'statement' && s == 'newstatement')
          )
            d(t, e.column(), 'statement');
          t.startOfLine = false;
          t.lastToken = s || r;
          return r;
        },
