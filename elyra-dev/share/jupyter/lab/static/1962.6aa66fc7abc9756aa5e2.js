...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [1962],
  {
    /***/ 91962: /***/ (
      ...
      var dist_index_js_ = __webpack_require__(66575); // CONCATENATED MODULE: ./node_modules/@lezer/html/dist/index.es.js
      ...
      const tagStart = new dist /* ExternalTokenizer */.Lu(
        (input, stack) => {
      ...
      const scriptTokens = contentTokenizer(
        'script',
        scriptText,
        StartCloseScriptTag
      );

      const styleTokens = contentTokenizer(
        'style',
        styleText,
        StartCloseStyleTag
      );

      const textareaTokens = contentTokenizer(
        'textarea',
        textareaText,
      ...
      function getAttrs(openTag, input) {
        ...
        for (let att of openTag.getChildren(Attribute)) {
          let name = att.getChild(AttributeName),
            value =
              att.getChild(AttributeValue) ||
              att.getChild(UnquotedAttributeValue);
          if (name)
      ...
      function maybeNest(node, input, tags) {
        ...
        for (let tag of tags) {
          if (
            !tag.attrs ||
            tag.attrs(
              attrs || (attrs = getAttrs(node.node.parent.firstChild, input))
            )
          )
            ...
            if ((nameNode = n.firstChild)) {
              ...
              if (matches)
                for (let attr of matches) {
                  if (
                    attr.tagName &&
                    attr.tagName != findTagName(n.parent, input)
                  )
                    continue;
      ...
      var lang_css_dist = __webpack_require__(37425);
      // EXTERNAL MODULE: ./node_modules/@codemirror/lang-javascript/dist/index.js + 1 modules
      var lang_javascript_dist = __webpack_require__(88103);
      ...
      var language_dist_index_js_ = __webpack_require__(4452); // CONCATENATED MODULE: ./node_modules/@codemirror/lang-html/dist/index.js
      ...
      const eventAttributes = /*@__PURE__*/ (
      ...
      function htmlCompletionFor(schema, context) {
        let { state, pos } = context,
          tree = (0, language_dist_index_js_.syntaxTree)(state).resolveInner(
            pos,
            -1
          ),
...
*/
      ...
      const jsonParser =
        /*@__PURE__*/ lang_javascript_dist.javascriptLanguage.parser.configure({
      ...
      const defaultNesting = [
        ...
        },
        {
          tag: 'script',
          attrs: (attrs) =>
            attrs.type == 'text/babel' || attrs.type == 'text/jsx',
...
*/
      ...
      const dist_selfClosers = /*@__PURE__*/ new Set(
        ...
        /*@__PURE__*/ view_dist_index_js_.EditorView.inputHandler.of(
          (view, from, to, text, insertTransaction) => {
            ...
            let closeTags = state.changeByRange((range) => {
              var _a, _b, _c;
              let didType =
                state.doc.sliceString(range.from - 1, range.to) == text;
              let { head } = range,
                after = (0, language_dist_index_js_.syntaxTree)(
                  state
                ).resolveInner(head, -1),
                name;
              if (didType && text == '>' && after.name == 'EndTag') {
                ...
                didType &&
                text == '/' &&
                after.name == 'IncompleteCloseTag'
              ) {
                let tag = after.parent;
                if (
                  after.from == head - 2 &&
                  ((_c = tag.lastChild) === null || _c === void 0
                    ? void 0
                    : _c.name) != 'CloseTag' &&
...
//# sourceMappingURL=1962.6aa66fc7abc9756aa5e2.js.map?v=6aa66fc7abc9756aa5e2
