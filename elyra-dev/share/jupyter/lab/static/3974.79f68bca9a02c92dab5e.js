  ...
  [3974],
  {
    93974: (e, t, n) => {
      ...
      function h(e, t) {
        ...
        if (e.match(p)) return [null, 'number'];
        if (e.match(f)) return [null, 'string.special'];
        if (e.eat(/^"/)) return (t.tokenize = b)(e, t);
        ...
        if (r === 'comment' && t.lastToken === '(')
          return (t.tokenize = y)(e, t);
        if (k(r, i) || r.charAt(0) === ':') return ['symbol', 'atom'];
        if (k(r, c) || k(r, d)) return ['symbol', 'keyword'];
      ...
      const g = {
        ...
        token: function (e, t) {
          ...
          var s = e.current();
          if (r !== 'space') {
            if (t.lastToken === '(' && t.ctx.indentTo === null) {
              if (r === 'symbol' && k(s, l))
          ...
          else if (r === 'close') t.ctx = t.ctx.prev || t.ctx;
          return a;
        },
        indent: function (e) {
