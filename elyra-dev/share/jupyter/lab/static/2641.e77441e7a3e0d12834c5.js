  ...
  [2641],
  {
    8394: (e, t, r) => {
      ...
      I[c] =
        ...
        I[k] =
          false;
      var B = typeof r.g == 'object' && r.g && r.g.Object === Object && r.g;
      var W = typeof self == 'object' && self && self.Object === Object && self;
      var U = B || W || Function('return this')();
      var F = true && t && !t.nodeType && t;
      var J = F && 'object' == 'object' && e && !e.nodeType && e;
      var V = J && J.exports === F;
      var H = V && B.process;
      var G = (function () {
        try {
      ...
      function Pe(e) {
        var t = this.__data__;
        return ke ? t[e] !== undefined : oe.call(t, e);
      }
      function Ne(e, t) {
        var r = this.__data__;
        this.size += this.has(e) ? 0 : 1;
        r[e] = ke && t === undefined ? s : t;
        return this;
      }
      Re.prototype.clear = Me;
      ...
      Je.prototype.clear = Ve;
      Je.prototype['delete'] = He;
      Je.prototype.get = Ge;
      Je.prototype.has = Ke;
      Je.prototype.set = Qe;
      function Xe(e, t) {
      ...
      function ot(e) {
        return Ft(e) && Wt(e.length) && !!I[nt(e)];
      }
      function at(e) {
        if (!Ut(e)) {
          return Mt(e);
      ...
      function Tt(e) {
        return typeof e.constructor == 'function' && !Rt(e) ? Ce(ge(e)) : {};
      }
      function Et(e, t) {
        var r = typeof e;
        t = t == null ? a : t;
      ...
      function St(e, t, r) {
        ...
        var n = typeof t;
        if (
          n == 'number' ? Dt(r) && Et(t, r.length) : n == 'string' && t in r
        ) {
          return qt(r[t], e);
        }
        return false;
      ...
      var At = st(
        ...
        ? st
        : function (e) {
            return Ft(e) && oe.call(e, 'callee') && !ye.call(e, 'callee');
          };
      var $t = Array.isArray;
      function Dt(e) {
        return e != null && Wt(e.length) && !Bt(e);
      }
      function zt(e) {
        return Ft(e) && Dt(e);
      }
    ...
    54615: (e, t, r) => {
      ...
      class i {
        ...
        onEnd(e) {
          ...
          return n.Disposable.create(() =>
            this.socket.removeEventListener('end', e)
          );
        }
        onData(e) {
          return this._onData.event(e);
      ...
      (function (e) {
        ...
        function t(t) {
          ...
          return (
            ...
            (r === e.None ||
              r === e.Cancelled ||
              (s.boolean(r.isCancellationRequested) &&
    ...
    90577: (e, t, r) => {
      ...
      })(y || (t.SetTraceNotification = y = {}));
      var b;
      (function (e) {
        e.type = new i.NotificationType('$/logTrace');
      })(b || (t.LogTraceNotification = b = {}));
      var v;
      (function (e) {
        e[(e['Closed'] = 1)] = 'Closed';
      ...
      (function (e) {
        ...
        e.is = t;
      })(T || (t.IdCancellationReceiverStrategy = T = {}));
      var E;
      (function (e) {
        function t(e) {
          const t = e;
        ...
        e.is = t;
      })(E || (t.RequestCancellationReceiverStrategy = E = {}));
      var S;
      (function (e) {
        ...
        e.is = t;
      })(S || (t.CancellationReceiverStrategy = S = {}));
      var k;
      (function (e) {
        e.Message = Object.freeze({
      ...
      var C;
      (function (e) {
        e.Message = Object.freeze({ receiver: S.Message, sender: k.Message });
        function t(e) {
          const t = e;
          return t && S.is(t.receiver) && k.is(t.sender);
        }
        e.is = t;
      })(C || (t.CancellationStrategy = C = {}));
      var R;
      (function (e) {
        function t(e) {
          const t = e;
        ...
        function t(e) {
          ...
          return (
            ...
            (C.is(t.cancellationStrategy) ||
              w.is(t.connectionStrategy) ||
              R.is(t.messageStrategy))
          );
        }
        e.is = t;
      })(M || (t.ConnectionOptions = M = {}));
      var j;
      (function (e) {
        e[(e['New'] = 1)] = 'New';
      ...
      function O(e, r, d, g) {
            ...
            if (i.Message.isNotification(e) && e.method === u.type.method) {
              ...
              if (i.Message.isRequest(s)) {
                ...
                if (o && (o.error !== undefined || o.result !== undefined)) {
                  ...
                  r.write(o).catch(() =>
                    w.error(`Sending response for canceled message failed.`)
                  );
                  return;
                }
              }
        ...
        function le(e) {
          ...
          if (u || O) {
            ...
            const a = T.is(K.receiver)
              ? K.receiver.createCancellationTokenSource(r)
              : K.receiver.createCancellationTokenSource(e);
            ...
            try {
              ...
              if (u) {
                if (e.params === undefined) {
                  ...
                  if (
                    c !== undefined &&
                    c.parameterStructures === i.ParameterStructures.byName
                  ) {
                    n(
                      new i.ResponseError(
                        i.ErrorCodes.InvalidParams,
                  ...
                  if (
                    c !== undefined &&
                    c.parameterStructures === i.ParameterStructures.byPosition
                  ) {
                    n(
                      new i.ResponseError(
                        i.ErrorCodes.InvalidParams,
              ...
              if (l instanceof i.ResponseError) {
                ...
                n(
                  new i.ResponseError(
                    i.ErrorCodes.InternalError,
                    `Request ${e.method} failed with message: ${l.message}`
                  ),
                  e.method,
                  f
                );
          ...
          if (e.id === null) {
            ...
            if (n !== undefined) {
              ...
              try {
                ...
                if (t.message) {
                  w.error(
                    `Response handler '${n.method}' failed with message: ${t.message}`
                  );
                } else {
                  w.error(
        ...
        function he(e) {
          ...
          if (r || N) {
            try {
              ...
              if (r) {
                if (e.params === undefined) {
                  if (t !== undefined) {
                    if (
                      t.numberOfParams !== 0 &&
                      t.parameterStructures !== i.ParameterStructures.byName
                    ) {
                      w.error(
                  ...
                  if (
                    ...
                    if (t !== undefined) {
                      ...
                      if (t.numberOfParams !== e.params.length) {
                        w.error(
                          `Notification ${e.method} defines ${t.numberOfParams} params but received ${n.length} arguments`
                        );
                      }
                    }
                    r(...n);
                  ...
                  if (
                    t !== undefined &&
                    t.parameterStructures === i.ParameterStructures.byPosition
                  ) {
                    w.error(
              ...
              if (n.message) {
                w.error(
                  `Notification handler '${e.method}' failed with message: ${n.message}`
                );
              } else {
                w.error(
        ...
        function me(e) {
          ...
          if (B === m.Text) {
            ...
            W.log(`Sending request '${e.method} - (${e.id})'.`, t);
          } else {
            Te('send-request', e);
          }
        }
        function ye(e) {
          ...
          if (B === m.Text) {
            ...
            W.log(`Sending notification '${e.method}'.`, t);
          } else {
        ...
        function ve(e) {
          ...
          if (B === m.Text) {
            ...
            W.log(`Received request '${e.method} - (${e.id})'.`, t);
          } else {
            Te('receive-request', e);
          }
        }
        function _e(e) {
          if (I === p.Off || !W || e.method === b.type.method) {
            return;
          }
          if (B === m.Text) {
            let t = undefined;
            ...
            W.log(`Received notification '${e.method}'.`, t);
          } else {
        ...
        const Pe = {
              ...
              switch (u) {
                ...
                default:
                  if (a === i.ParameterStructures.byName) {
                    throw new Error(
                      `Received ${u} parameters for 'by Name' notification parameter structure.`
                    );
                  }
                  o = t.slice(s, c).map((e) => Ce(e));
                  break;
              }
            } else {
              const r = t;
          ...
          sendProgress: (e, t, r) =>
            Pe.sendNotification(l.type, { token: t, value: r }),
          ...
          sendRequest: (e, ...t) => {
              ...
              switch (d) {
                ...
                default:
                  if (f === i.ParameterStructures.byName) {
                    throw new Error(
                      `Received ${d} parameters for 'by Name' request parameter structure.`
                    );
                  }
                  o = t.slice(u, l).map((e) => Ce(e));
                  break;
              }
            } else {
              const r = t;
            ...
            if (a) {
              f = a.onCancellationRequested(() => {
                ...
                if (e === undefined) {
                  w.log(
                    `Received no promise from cancellation strategy when cancelling id ${u}`
                  );
                  return Promise.resolve();
                } else {
                  return e.catch(() => {
          ...
          dispose: () => {
            ...
            U = j.Disposed;
            G.fire(undefined);
            const t = new i.ResponseError(
              i.ErrorCodes.PendingResponseRejected,
        ...
        Pe.onNotification(b.type, (e) => {
          ...
          W.log(e.message, t ? e.verbose : undefined);
        });
    ...
    89244: (e, t) => {
      ...
      class i {
        ...
        append(e) {
          const t =
            typeof e === 'string' ? this.fromString(e, this._encoding) : e;
          this._chunks.push(t);
    ...
    59085: (e, t, r) => {
      ...
      class c {
        ...
        asError(e) {
          if (e instanceof Error) {
            ...
            return new Error(
              `Reader received error. Reason: ${s.string(e.message) ? e.message : 'unknown'}`
            );
          }
        }
      }
      ...
      class f extends c {
        constructor(e, t) {
          ...
          this.buffer = (0, n.default)().messageBuffer.create(
          ...
          try {
            ...
            while (true) {
              if (this.nextMessageLength === -1) {
                ...
                if (isNaN(r)) {
                  this.fireError(
                    new Error(`Content-Length value must be a number. Got ${t}`)
                  );
                  return;
                }
                ...
                .lock(async () => {
                  const t =
                    this.options.contentDecoder !== undefined
                      ...
                      : e;
                  const r = await this.options.contentTypeDecoder.decode(
                    t,
                    this.options
                  );
                  this.callback(r);
      ...
      class f {
        ...
        asError(e) {
          if (e instanceof Error) {
            ...
            return new Error(
              `Writer received error. Reason: ${s.string(e.message) ? e.message : 'unknown'}`
            );
          }
        }
      }
        ...
        function t(e) {
          if (e === undefined || typeof e === 'string') {
            ...
            return {
              ...
              contentTypeEncoder:
                e.contentTypeEncoder ?? (0, n.default)().applicationJson.encoder
            };
          }
        }
        e.fromOptions = t;
      ...
      class d extends f {
        ...
        async write(e) {
          return this.writeSemaphore.lock(async () => {
            const t = this.options.contentTypeEncoder
