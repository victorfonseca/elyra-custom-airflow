...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [1495],
  {
    /***/ 21495: /***/ (
      ...
      var index_js_ = __webpack_require__(45145); // CONCATENATED MODULE: ./node_modules/@lezer/xml/dist/index.es.js
      ...
      const startTag = new dist /* ExternalTokenizer */.Lu(
        (input, stack) => {
      ...
      var view_dist_index_js_ = __webpack_require__(22819); // CONCATENATED MODULE: ./node_modules/@codemirror/lang-xml/dist/index.js
      ...
      function findLocation(state, pos) {
        var _a;
        let at = (0, dist_index_js_.syntaxTree)(state).resolveInner(pos, -1),
          inTag = null;
        ...
        while (
          at.parent &&
          at.to == pos &&
          !((_a = at.lastChild) === null || _a === void 0
            ? void 0
            : _a.type.isError)
        )
          at = at.parent;
          ...
          if (type == 'openTag') {
            ...
            return parentName
              ? {
                  ...
                  to:
                    cx.pos +
                    (doc.sliceString(cx.pos, cx.pos + 1) == '>' ? 1 : 0),
                  options: [
            ...
            if (!attr) return null;
            let parent = byName[tagName(doc, context)];
            let values = ((parent === null || parent === void 0
              ? void 0
              : parent.attrValues) || attrValues)[attr];
            ...
            let options = closing.concat(
              (
                (parent === null || parent === void 0
                  ? void 0
                  : parent.children) || (context ? allElements : topElements)
        ...
        /*@__PURE__*/ view_dist_index_js_.EditorView.inputHandler.of(
          (view, from, to, text, insertTransaction) => {
            ...
            let closeTags = state.changeByRange((range) => {
              ...
              let after = (0, dist_index_js_.syntaxTree)(state).resolveInner(
                  head,
                  -1
                ),
                name;
...
//# sourceMappingURL=1495.0dc09733308431a8a99f.js.map?v=0dc09733308431a8a99f
