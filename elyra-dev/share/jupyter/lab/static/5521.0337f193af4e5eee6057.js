  ...
  [5521],
  {
    65521: (t, e, s) => {
          ...
          this._checkInterval = setInterval(
            () => {
              ...
              if (
                ...
                h / 2 <= t - this.meta.get(this.clientID).lastUpdated
              ) {
      ...
      class b {
        constructor(t) {
          ...
          this._ydoc =
            (e = t === null || t === void 0 ? void 0 : t.ydoc) !== null &&
            e !== void 0
              ? e
              : new u.Doc();
          this._ystate = this._ydoc.getMap('state');
          this._undoManager = new u.UndoManager([], {
      ...
      const M = (t, e) => {
        ...
        switch (t.cell_type) {
          ...
          case 'code': {
            ...
            const o = t;
            d.execution_count =
              (n = o.execution_count) !== null && n !== void 0 ? n : null;
            if (o.outputs) {
        ...
        if (t.source != null) {
          d.setSource(
            typeof t.source === 'string' ? t.source : t.source.join('')
          );
        }
        return d;
      };
      ...
      class k {
        ...
        constructor(t, e, s = {}, n) {
          ...
          this._ysource = e;
          this._ymetadata =
            n !== null && n !== void 0 ? n : this.ymodel.get('metadata');
          ...
          if (s.notebook) {
            ...
            if (this._notebook.disableDocumentWideUndoRedo) {
              this._undoManager = new u.UndoManager([this.ymodel], {
                trackedOrigins: new Set([this]),
        ...
        get awareness() {
          var t, e, s;
          return (s =
            (t = this._awareness) !== null && t !== void 0
              ? t
              : (e = this.notebook) === null || e === void 0
                ? void 0
                : e.awareness) !== null && s !== void 0
            ? s
            : null;
        }
        get cell_type() {
        ...
        get undoManager() {
          ...
          return (
            (t = this.notebook) === null || t === void 0
              ? void 0
              : t.disableDocumentWideUndoRedo
          )
            ? this._undoManager
        ...
        setMetadata(t, e) {
          ...
          if (typeof t === 'string') {
            if (typeof e === 'undefined') {
              throw new TypeError(
                `Metadata value for ${t} cannot be 'undefined'; use deleteMetadata.`
              );
            }
            const n = t;
            if (
              o.JSONExt.deepEqual(
                (s = this.getMetadata(n)) !== null && s !== void 0 ? s : null,
                e
              )
            ) {
              return;
            ...
            this.transact(() => {
              ...
              if (n === 'collapsed') {
                const s =
                  (t = this.getMetadata('jupyter')) !== null && t !== void 0
                    ? t
                    : {};
            ...
            if (e.collapsed != null) {
              ...
              ((n = e === null || e === void 0 ? void 0 : e.jupyter) === null ||
              n === void 0
                ? void 0
                : n.outputs_hidden) != null
            ) {
              ...
              switch (t.action) {
                case 'add':
                  this._metadataChanged.emit({
                    key: e,
                    newValue: this._ymetadata.get(e),
                    type: 'add'
                  });
                  break;
                case 'delete':
      ...
      class C extends k {
        ...
        get executionState() {
          var t;
          return (t = this.ymodel.get('execution_state')) !== null &&
            t !== void 0
            ? t
            : 'idle';
        }
        ...
        updateOutputs(t, e, s = [], n = null) {
          const a =
            e < this._youtputs.length ? e - t : this._youtputs.length - t;
          this.transact(
            () => {
      ...
      class D extends b {
        constructor(t = {}) {
          ...
          this._onMetaChanged = (t) => {
            ...
            if (s.keysChanged.has('metadata')) {
              ...
              if (
                (t === null || t === void 0 ? void 0 : t.action) === 'add' &&
                !t.oldValue
              ) {
                const t = new Map();
            ...
            if (s.keysChanged.has('nbformat')) {
              ...
              const e = {
                key: 'nbformat',
                oldValue: (t === null || t === void 0 ? void 0 : t.oldValue)
                  ? t.oldValue
                  : undefined,
          ...
          this._disableDocumentWideUndoRedo =
            (e = t.disableDocumentWideUndoRedo) !== null && e !== void 0
              ? e
              : false;
        ...
        static create(t = {}) {
          ...
          const u = {
            cells:
              (n = (s = t.data) === null || s === void 0 ? void 0 : s.cells) !==
                null && n !== void 0
                ? n
                : [],
            nbformat:
              (o =
                (a = t.data) === null || a === void 0 ? void 0 : a.nbformat) !==
                null && o !== void 0
                ? o
                : 4,
            nbformat_minor:
              (r =
                (i = t.data) === null || i === void 0
                  ? void 0
                  : i.nbformat_minor) !== null && r !== void 0
                ? r
                : 5,
            metadata:
              (c =
                (d = t.data) === null || d === void 0 ? void 0 : d.metadata) !==
                null && c !== void 0
                ? c
                : {}
          };
        ...
        moveCells(t, e, s = 1) {
          const n = new Array(s)
            .fill(true)
            .map((e, s) => this.getCell(t + s).toJSON());
          this.transact(() => {
        ...
        setMetadata(t, e) {
          ...
          if (typeof t === 'string') {
            ...
            if (
              o.JSONExt.deepEqual(
                (s = this.getMetadata(t)) !== null && s !== void 0 ? s : null,
                e
              )
            ) {
              return;
    ...
    70641: (t, e, s) => {
      ...
      const g = (t, e) =>
        t === e ||
        (d(t) === d(e) &&
          u(t, (t, s) => (t !== undefined || h(e, s)) && e[s] === t));
    },
    5739: (t, e, s) => {
      s.d(e, { c: () => i });
      var n = s(61662);
      ...
      class i {
        ...
        emit(t, e) {
          return o
            .HT((this._observers.get(t) || n.vt()).values())
            .forEach((t) => t(...e));
        }
        destroy() {
          this._observers = n.vt();
