...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [4090],
  {
    /***/ 63380: /***/ (
      ...
      var FunctionList_js_1 = __webpack_require__(43899);
      var AbstractOutputJax = (function () {
        ...
        AbstractOutputJax.prototype.executeFilters = function (
          filters,
          math,
          document,
          data
    ...
    /***/ 55734: /***/ (__unused_webpack_module, exports) => {
      Object.defineProperty(exports, '__esModule', { value: true });
    ...
    /***/ 49294: /***/ function (
      ...
      var Factory_js_1 = __webpack_require__(59171);
      var AbstractWrapperFactory = (function (_super) {
        ...
        AbstractWrapperFactory.prototype.wrap = function (node) {
          ...
          return this.create.apply(
            this,
            __spreadArray([node.kind, node], __read(args), false)
          );
        };
    ...
    /***/ 24090: /***/ function (
      ...
      var OutputJax_js_1 = __webpack_require__(12222);
      var StyleList_js_1 = __webpack_require__(14454);
      var WrapperFactory_js_1 = __webpack_require__(59550);
      var Usage_js_1 = __webpack_require__(60854);
      var tex_js_1 = __webpack_require__(1673);
      var LENGTHS = __importStar(__webpack_require__(86810));
      var string_js_1 = __webpack_require__(41278);
      var CHTML = (function (_super) {
        ...
        function CHTML(options) {
          ...
          var _this =
            _super.call(
              this,
              options,
              WrapperFactory_js_1.CHTMLWrapperFactory,
              tex_js_1.TeXFont
            ) || this;
        ...
        CHTML.prototype.styleSheet = function (html) {
          ...
          var sheet = (this.chtmlStyles = _super.prototype.styleSheet.call(
            this,
            html
          ));
        ...
        CHTML.prototype.addWrapperStyles = function (styles) {
          ...
          try {
            for (
              var _b = __values(this.wrapperUsage.update()), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var kind = _c.value;
        ...
        CHTML.prototype.unknownText = function (text, variant, width) {
          ...
          if (width !== null) {
            ...
            styles.width =
              Math.round(width * metrics.em * metrics.scale) + 'px';
          }
        ...
        CHTML.prototype.measureTextNode = function (textNode) {
          ...
          var w =
            adaptor.nodeSize(text, this.math.metrics.em)[0] /
        ...
        CHTML.NAME = 'CHTML';
        CHTML.OPTIONS = __assign(
          __assign({}, OutputJax_js_1.CommonOutputJax.OPTIONS),
          { adaptiveCSS: true, matchFontHeight: true }
        );
        CHTML.commonStyles = {
    ...
    /***/ 85475: /***/ function (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.Arrow =
        exports.DiagonalArrow =
        exports.DiagonalStrike =
        exports.Border2 =
        exports.Border =
        exports.RenderElement =
          void 0;
      var Notation = __importStar(__webpack_require__(37626));
      __exportStar(__webpack_require__(37626), exports);
          ...
          if (offset) {
            ...
            if (node.thickness !== Notation.THICKNESS || d) {
              var transform = 'translate'
                .concat(offset, '(')
                .concat(node.em(node.thickness / 2 - d), ')');
    ...
    /***/ 44614: /***/ function (
      ...
      var LENGTHS = __importStar(__webpack_require__(86810));
      var Wrapper_js_1 = __webpack_require__(85677);
      var BBox_js_1 = __webpack_require__(58340);
      exports.FONTSIZE = {
        '70.7%': 's',
        '70%': 's',
        '50%': 'ss',
      ...
      var CHTMLWrapper = (function (_super) {
        ...
        CHTMLWrapper.prototype.toCHTML = function (parent) {
          ...
          try {
            for (
              var _b = __values(this.childNodes), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var child = _c.value;
        ...
        CHTMLWrapper.prototype.handleAttributes = function () {
          ...
          try {
            for (
              var _c = __values(attributes.getExplicitNames()), _d = _c.next();
              !_d.done;
              _d = _c.next()
            ) {
              var name_2 = _d.value;
          ...
          if (attributes.get('class')) {
            ...
            try {
              for (
                var names_1 = __values(names), names_1_1 = names_1.next();
                !names_1_1.done;
              ...
              try {
                if (names_1_1 && !names_1_1.done && (_b = names_1.return))
                  _b.call(names_1);
              } finally {
    ...
    /***/ 59550: /***/ function (
      ...
      var WrapperFactory_js_1 = __webpack_require__(36483);
      var Wrappers_js_1 = __webpack_require__(3917);
    ...
    /***/ 3917: /***/ (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var math_js_1 = __webpack_require__(64474);
      var mi_js_1 = __webpack_require__(2742);
      var mo_js_1 = __webpack_require__(20480);
      var mn_js_1 = __webpack_require__(19255);
      var ms_js_1 = __webpack_require__(3428);
      var mtext_js_1 = __webpack_require__(79150);
      var mspace_js_1 = __webpack_require__(91007);
      var mpadded_js_1 = __webpack_require__(38655);
      var menclose_js_1 = __webpack_require__(2696);
      var mrow_js_1 = __webpack_require__(34021);
      var mfenced_js_1 = __webpack_require__(91122);
      var mfrac_js_1 = __webpack_require__(79901);
      var msqrt_js_1 = __webpack_require__(55715);
      var mroot_js_1 = __webpack_require__(55501);
      var msubsup_js_1 = __webpack_require__(21279);
      var munderover_js_1 = __webpack_require__(49821);
      var mmultiscripts_js_1 = __webpack_require__(84642);
      var mtable_js_1 = __webpack_require__(46605);
      var mtr_js_1 = __webpack_require__(42731);
      var mtd_js_1 = __webpack_require__(71937);
      var maction_js_1 = __webpack_require__(1835);
      var mglyph_js_1 = __webpack_require__(96672);
      var semantics_js_1 = __webpack_require__(29107);
      var TeXAtom_js_1 = __webpack_require__(61118);
      var TextNode_js_1 = __webpack_require__(13219);
      exports.CHTMLWrappers =
        ...
        (_a[munderover_js_1.CHTMLmunderover.kind] =
          munderover_js_1.CHTMLmunderover),
        (_a[mmultiscripts_js_1.CHTMLmmultiscripts.kind] =
          mmultiscripts_js_1.CHTMLmmultiscripts),
        ...
        (_a[semantics_js_1.CHTMLsemantics.kind] =
          semantics_js_1.CHTMLsemantics),
        (_a[semantics_js_1.CHTMLannotation.kind] =
          semantics_js_1.CHTMLannotation),
        (_a[semantics_js_1.CHTMLannotationXML.kind] =
          semantics_js_1.CHTMLannotationXML),
    ...
    /***/ 61118: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var TeXAtom_js_1 = __webpack_require__(65735);
      var TeXAtom_js_2 = __webpack_require__(54517);
      ...
      var CHTMLTeXAtom = (function (_super) {
        ...
        CHTMLTeXAtom.prototype.toCHTML = function (parent) {
          ...
          this.adaptor.setAttribute(
            this.chtml,
            'texclass',
            MmlNode_js_1.TEXCLASSNAMES[this.node.texClass]
          );
    ...
    /***/ 13219: /***/ function (
      ...
      var MmlNode_js_1 = __webpack_require__(80747);
      var Wrapper_js_1 = __webpack_require__(44614);
      var TextNode_js_1 = __webpack_require__(87120);
      var CHTMLTextNode = (function (_super) {
        ...
        CHTMLTextNode.prototype.toCHTML = function (parent) {
          ...
          if (variant === '-explicitFont') {
            adaptor.append(
              parent,
              this.jax.unknownText(text, variant, this.getBBox().w)
            );
          } else {
    ...
    /***/ 1835: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var maction_js_1 = __webpack_require__(55210);
      var maction_js_2 = __webpack_require__(55210);
      var maction_js_3 = __webpack_require__(36528);
            ...
            [
              function (node, _data) {
                node.adaptor.setAttribute(
                  node.chtml,
                  'toggle',
                  node.node.attributes.get('selection')
                );
                ...
                if (tip.node.isKind('mtext')) {
                  ...
                  node.setEventHandler('mouseover', function (event) {
                    if (data.status === null) {
                      ...
                      data.status = adaptor_2.append(
                        body,
                        node.html('mjx-status', {}, [node.text(text_1)])
                      );
                    }
                    event.stopPropagation();
                  });
    ...
    /***/ 64474: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var math_js_1 = __webpack_require__(67493);
      var math_js_2 = __webpack_require__(31859);
      var BBox_js_1 = __webpack_require__(58340);
      var CHTMLmath = (function (_super) {
        ...
        CHTMLmath.prototype.handleDisplay = function (parent) {
          ...
          if (this.bbox.pwidth === BBox_js_1.BBox.fullWidth) {
            ...
            if (this.jax.table) {
              var _b = this.jax.table.getOuterBBox(),
                L = _b.L,
                w = _b.w,
                R = _b.R;
              if (align === 'right') {
        ...
        CHTMLmath.prototype.setChildPWidths = function (recompute, w, clear) {
          ...
          return this.parent
            ? _super.prototype.setChildPWidths.call(this, recompute, w, clear)
            : false;
        };
    ...
    /***/ 2696: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var menclose_js_1 = __webpack_require__(9503);
      var Notation = __importStar(__webpack_require__(85475));
      var menclose_js_2 = __webpack_require__(38085);
      ...
      var CHTMLmenclose = (function (_super) {
        ...
        CHTMLmenclose.prototype.toCHTML = function (parent) {
          ...
          try {
            for (
              var _c = __values(Object.keys(this.notations)), _d = _c.next();
              !_d.done;
              _d = _c.next()
            ) {
              var name_1 = _d.value;
          ...
          try {
            for (
              var _e = __values(Notation.sideNames), _f = _e.next();
              !_f.done;
              _f = _e.next()
            ) {
              var name_2 = _f.value;
        ...
        CHTMLmenclose.prototype.adjustArrow = function (arrow, double) {
          ...
          if (
            ...
            return;
          var _a = __read(
              [t * head.x, t * head.y].map(function (x) {
                return _this.em(x);
              }),
              2
            ),
        ...
        CHTMLmenclose.styles = {
          ...
          'mjx-menclose > mjx-hstrike': {
            ...
            bottom: '50%',
            transform:
              'translateY(' + (0, lengths_js_1.em)(Notation.THICKNESS / 2) + ')'
          },
          'mjx-menclose > mjx-vstrike': {
            ...
            right: '50%',
            transform:
              'translateX(' + (0, lengths_js_1.em)(Notation.THICKNESS / 2) + ')'
          },
          'mjx-menclose > mjx-rbox': {
            ...
            'border-radius': (0, lengths_js_1.em)(
              Notation.THICKNESS + Notation.PADDING
            )
          },
          ...
          'mjx-menclose > mjx-arrow > *': {
            ...
            'border-left':
              (0, lengths_js_1.em)(Notation.THICKNESS * Notation.ARROWX) +
              ' solid',
            'border-right': 0,
          ...
          'mjx-menclose > mjx-arrow > mjx-aline': {
            ...
            right: (0, lengths_js_1.em)(
              Notation.THICKNESS * (Notation.ARROWX - 1)
            ),
            height: 0,
          ...
          'mjx-menclose > mjx-arrow > mjx-rthead': {
            ...
            'border-top':
              (0, lengths_js_1.em)(Notation.THICKNESS * Notation.ARROWY) +
              ' solid transparent'
          },
          ...
          'mjx-menclose > dbox': {
            ...
            'clip-path':
              'inset(0 0 0 ' +
              (0, lengths_js_1.em)(1.5 * Notation.PADDING) +
              ')',
            'box-sizing': 'border-box'
          }
        };
    ...
    /***/ 91122: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var mfenced_js_1 = __webpack_require__(36639);
      var mfenced_js_2 = __webpack_require__(54453);
    ...
    /***/ 79901: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var mfrac_js_1 = __webpack_require__(36536);
      var mfrac_js_2 = __webpack_require__(74502);
      var CHTMLmfrac = (function (_super) {
        ...
        CHTMLmfrac.prototype.makeFraction = function (display, t) {
          ...
          var fattr = withDelims
            ? __assign(__assign({}, attr), { delims: 'true' })
            : __assign({}, attr);
    ...
    /***/ 96672: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var mglyph_js_1 = __webpack_require__(28656);
      var mglyph_js_2 = __webpack_require__(64906);
    ...
    /***/ 2742: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var mi_js_1 = __webpack_require__(54073);
      var mi_js_2 = __webpack_require__(32175);
    ...
    /***/ 84642: /***/ function (
      ...
      var msubsup_js_1 = __webpack_require__(21279);
      var mmultiscripts_js_1 = __webpack_require__(86539);
      var mmultiscripts_js_2 = __webpack_require__(10093);
      var string_js_1 = __webpack_require__(41278);
      var CHTMLmmultiscripts = (function (_super) {
        ...
        CHTMLmmultiscripts.prototype.toCHTML = function (parent) {
          ...
          var scriptalign =
            this.node.getProperty('scriptalign') || 'right left';
          var _a = __read(
              (0, string_js_1.split)(scriptalign + ' ' + scriptalign),
              2
            ),
            preAlign = _a[0],
            postAlign = _a[1];
        ...
        CHTMLmmultiscripts.prototype.addScripts = function (
          u,
          v,
          isPre,
          sub,
        ...
        CHTMLmmultiscripts.kind =
          mmultiscripts_js_2.MmlMmultiscripts.prototype.kind;
        ...
        (0, mmultiscripts_js_1.CommonMmultiscriptsMixin)(
          msubsup_js_1.CHTMLmsubsup
        )
      );
    ...
    /***/ 19255: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var mn_js_1 = __webpack_require__(53228);
      var mn_js_2 = __webpack_require__(94318);
    ...
    /***/ 20480: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var mo_js_1 = __webpack_require__(61331);
      var mo_js_2 = __webpack_require__(38669);
    ...
    /***/ 38655: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var mpadded_js_1 = __webpack_require__(95522);
      var mpadded_js_2 = __webpack_require__(10900);
      var CHTMLmpadded = (function (_super) {
        ...
        CHTMLmpadded.prototype.toCHTML = function (parent) {
          ...
          chtml = this.adaptor.append(
            chtml,
            this.html('mjx-block', { style: style }, content)
          );
          try {
            for (
              var _c = __values(this.childNodes), _d = _c.next();
              !_d.done;
              _d = _c.next()
            ) {
              var child = _d.value;
    ...
    /***/ 55501: /***/ function (
      ...
      var msqrt_js_1 = __webpack_require__(55715);
      var mroot_js_1 = __webpack_require__(23692);
      var mroot_js_2 = __webpack_require__(96778);
    ...
    /***/ 34021: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var mrow_js_1 = __webpack_require__(54114);
      var mrow_js_2 = __webpack_require__(54114);
      var mrow_js_3 = __webpack_require__(81364);
      var CHTMLmrow = (function (_super) {
        ...
        CHTMLmrow.prototype.toCHTML = function (parent) {
          var e_1, _a;
          var chtml = this.node.isInferred
            ? (this.chtml = parent)
            : this.standardCHTMLnode(parent);
    ...
    /***/ 3428: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var ms_js_1 = __webpack_require__(95151);
      var ms_js_2 = __webpack_require__(68313);
    ...
    /***/ 91007: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var mspace_js_1 = __webpack_require__(9572);
      var mspace_js_2 = __webpack_require__(74394);
    ...
    /***/ 55715: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var msqrt_js_1 = __webpack_require__(33206);
      var msqrt_js_2 = __webpack_require__(24208);
      var CHTMLmsqrt = (function (_super) {
        ...
        CHTMLmsqrt.prototype.toCHTML = function (parent) {
          ...
          var SQRT = this.adaptor.append(
            CHTML,
            this.html('mjx-sqrt', {}, [
              (SURD = this.html('mjx-surd')),
              (BASE = this.html('mjx-box', {
                style: { paddingTop: this.em(q) }
              }))
            ])
          );
    ...
    /***/ 21279: /***/ function (
      ...
      var scriptbase_js_1 = __webpack_require__(98526);
      var msubsup_js_1 = __webpack_require__(64418);
      var msubsup_js_2 = __webpack_require__(64418);
      var msubsup_js_3 = __webpack_require__(64418);
      var msubsup_js_4 = __webpack_require__(12560);
      ...
      var CHTMLmsubsup = (function (_super) {
        ...
        CHTMLmsubsup.prototype.toCHTML = function (parent) {
          ...
          base.toCHTML(chtml);
          var stack = adaptor.append(
            chtml,
            this.html('mjx-script', { style: style })
          );
          sup.toCHTML(stack);
          adaptor.append(
            stack,
    ...
    /***/ 46605: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var mtable_js_1 = __webpack_require__(70078);
      var mtable_js_2 = __webpack_require__(7840);
      var string_js_1 = __webpack_require__(41278);
      var CHTMLmtable = (function (_super) {
        ...
        CHTMLmtable.prototype.padRows = function () {
          ...
          try {
            for (
              var _b = __values(adaptor.childNodes(this.itable)),
                _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
        ...
        CHTMLmtable.prototype.handleColumnSpacing = function () {
          ...
          var scale = this.childNodes[0]
            ...
            : 1;
          var spacing = this.getEmHalfSpacing(
            this.fSpace[0],
            this.cSpace,
            scale
          );
          ...
          try {
            for (
              var _c = __values(this.tableRows), _d = _c.next();
              !_d.done;
              _d = _c.next()
            ) {
              var row = _d.value;
              ...
              try {
                for (
                  var _e = ((e_4 = void 0), __values(row.tableCells)),
                    _f = _e.next();
                  !_f.done;
                  _f = _e.next()
                ) {
            ...
            for (
              ...
              try {
                for (
                  var _e =
                      ((e_6 = void 0),
                      __values(this.adaptor.childNodes(row.chtml).slice(1))),
                    _f = _e.next();
                  !_f.done;
                  _f = _e.next()
                ) {
            ...
            for (
              ...
              try {
                for (
                  var _e =
                      ((e_8 = void 0),
                      __values(this.adaptor.childNodes(row.chtml))),
                    _f = _e.next();
                  !_f.done;
                  _f = _e.next()
                ) {
        ...
        CHTMLmtable.prototype.handleRowSpacing = function () {
          ...
          try {
            for (
              ...
              try {
                for (
                  var _e = ((e_10 = void 0), __values(row.childNodes)),
                    _f = _e.next();
                  !_f.done;
                  _f = _e.next()
                ) {
        ...
        CHTMLmtable.prototype.handleRowLines = function () {
          ...
          try {
            for (
              var _c = __values(this.childNodes.slice(1)), _d = _c.next();
              !_d.done;
              _d = _c.next()
            ) {
              var row = _d.value;
        ...
        CHTMLmtable.prototype.handleEqualRows = function () {
          ...
          for (var i = 0; i < this.numRows; i++) {
            ...
            this.setRowHeight(
              row,
              HD + space[i] + space[i + 1] + this.rLines[i]
            );
            if (HD !== NH[i] + ND[i]) {
        ...
        CHTMLmtable.prototype.setRowBaseline = function (row, HD, D) {
          ...
          try {
            for (
              var _b = __values(row.childNodes), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var cell = _c.value;
    ...
    /***/ 71937: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var mtd_js_1 = __webpack_require__(8256);
      var mtd_js_2 = __webpack_require__(94826);
    ...
    /***/ 79150: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var mtext_js_1 = __webpack_require__(58267);
      var mtext_js_2 = __webpack_require__(48765);
    ...
    /***/ 42731: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var mtr_js_1 = __webpack_require__(8518);
      var mtr_js_2 = __webpack_require__(8518);
      var mtr_js_3 = __webpack_require__(79516);
    ...
    /***/ 49821: /***/ function (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.CHTMLmunderover =
        exports.CHTMLmover =
        exports.CHTMLmunder =
          void 0;
      var msubsup_js_1 = __webpack_require__(21279);
      var munderover_js_1 = __webpack_require__(62358);
      var munderover_js_2 = __webpack_require__(62358);
      var munderover_js_3 = __webpack_require__(62358);
      var munderover_js_4 = __webpack_require__(46072);
      var CHTMLmunder = (function (_super) {
        ...
        CHTMLmunder.prototype.toCHTML = function (parent) {
          ...
          var base = this.adaptor.append(
            this.adaptor.append(this.chtml, this.html('mjx-row')),
            this.html('mjx-base')
          );
          var under = this.adaptor.append(
            this.adaptor.append(this.chtml, this.html('mjx-row')),
            this.html('mjx-under')
          );
    ...
    /***/ 98526: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(44614);
      var scriptbase_js_1 = __webpack_require__(82197);
      var CHTMLscriptbase = (function (_super) {
        ...
        CHTMLscriptbase.prototype.adjustUnderDepth = function (
          under,
          underbox
        ) {
          var e_1, _a;
          ...
          try {
            for (
              var _b = __values(adaptor.childNodes(adaptor.firstChild(under))),
                _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
    ...
    /***/ 29107: /***/ function (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.CHTMLxml =
        exports.CHTMLannotationXML =
        exports.CHTMLannotation =
        exports.CHTMLsemantics =
          void 0;
      var Wrapper_js_1 = __webpack_require__(44614);
      var semantics_js_1 = __webpack_require__(32482);
      var semantics_js_2 = __webpack_require__(75447);
      var MmlNode_js_1 = __webpack_require__(80747);
      ...
      var CHTMLannotationXML = (function (_super) {
        ...
        CHTMLannotationXML.kind =
          semantics_js_2.MmlAnnotationXML.prototype.kind;
    ...
    /***/ 37626: /***/ function (__unused_webpack_module, exports) {
      var __read =
        (this && this.__read) ||
        function (o, n) {
          var m = typeof Symbol === 'function' && o[Symbol.iterator];
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.CommonArrow =
        exports.CommonDiagonalArrow =
        exports.CommonDiagonalStrike =
        exports.CommonBorder2 =
        exports.CommonBorder =
        exports.arrowBBox =
      ...
      var arrowBBoxW = function (node, TRBL) {
        if (node.childNodes[0]) {
          ...
          TRBL[1] = TRBL[3] = Math.max(
            0,
            node.thickness * node.arrowhead.y - w / 2
          );
        }
        return TRBL;
      };
            ...
            name + 'arrow',
            {
              ...
              bbox: function (node) {
                var _a = node.arrowData(),
                  ...
                  y = _a.y;
                var _b = __read(
                    [node.arrowhead.x, node.arrowhead.y, node.arrowhead.dx],
                    3
                  ),
                  ax = _b[0],
                  ay = _b[1],
                ...
                var _c = __read(node.getArgMod(ax + adx, ay), 2),
                  ...
                  ar = _c[1];
                var dy =
                  y + (b > a ? node.thickness * ar * Math.sin(b - a) : 0);
                var dx =
                  x +
                  (b > Math.PI / 2 - a
    ...
    /***/ 12222: /***/ function (
      ...
      var OutputJax_js_1 = __webpack_require__(63380);
      var MathItem_js_1 = __webpack_require__(24971);
      var Options_js_1 = __webpack_require__(34981);
      var lengths_js_1 = __webpack_require__(86810);
      var Styles_js_1 = __webpack_require__(24161);
      var StyleList_js_1 = __webpack_require__(14454);
      var CommonOutputJax = (function (_super) {
        ...
        function CommonOutputJax(options, defaultFactory, defaultFont) {
          ...
          var _this = this;
          var _a = __read(
              (0, Options_js_1.separateOptions)(options, defaultFont.OPTIONS),
              2
            ),
            jaxOptions = _a[0],
            fontOptions = _a[1];
          ...
          _this.cssStyles =
            _this.options.cssStyles || new StyleList_js_1.CssStyles();
        ...
        CommonOutputJax.prototype.getMetrics = function (html) {
          ...
          try {
            for (
              var _b = __values(html.math), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var math = _c.value;
        ...
        CommonOutputJax.prototype.getMetricMaps = function (html) {
          ...
          try {
            for (
              var _f = __values(html.math), _g = _f.next();
              !_g.done;
              _g = _f.next()
            ) {
              var math = _g.value;
          ...
          try {
            for (
              var _h = __values(maps.keys()), _j = _h.next();
              !_j.done;
              _j = _h.next()
            ) {
              var i = _j.value;
              try {
                for (
                  var _k = ((e_4 = void 0), __values(domMaps[i].keys())),
                    _l = _k.next();
                  !_l.done;
                  _l = _k.next()
                ) {
                  ...
                  maps[i].set(
                    node,
                    this.measureMetrics(domMaps[i].get(node), getFamily)
                  );
                }
              } catch (e_4_1) {
                e_4 = { error: e_4_1 };
          ...
          try {
            for (
              var _m = __values(maps.keys()), _o = _m.next();
              !_o.done;
              _o = _m.next()
            ) {
              var i = _o.value;
              try {
                for (
                  var _p = ((e_6 = void 0), __values(domMaps[i].values())),
                    _q = _p.next();
                  !_q.done;
                  _q = _p.next()
                ) {
        ...
        CommonOutputJax.prototype.getTestElement = function (node, display) {
          ...
          if (!this.testInline) {
            ...
            adaptor.setStyle(
              adaptor.firstChild(this.testDisplay),
              'display',
              'none'
            );
          ...
          return adaptor.append(
            node,
            adaptor.clone(display ? this.testDisplay : this.testInline)
          );
        };
        ...
        CommonOutputJax.prototype.styleSheet = function (html) {
          ...
          if ('getStyles' in html) {
            try {
              for (
                var _b = __values(html.getStyles()), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
                var styles = _c.value;
        ...
        CommonOutputJax.prototype.addWrapperStyles = function (styles) {
          ...
          try {
            for (
              var _b = __values(this.factory.getKinds()), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var kind = _c.value;
        ...
        CommonOutputJax.prototype.measureTextNodeWithCache = function (
          text,
          chars,
          variant,
          font
        ...
        CommonOutputJax.prototype.measureXMLnode = function (xml) {
          ...
          var node = this.html('mjx-measure-xml', { style: style }, [
            base,
            content
          ]);
          adaptor.append(adaptor.parent(this.math.start.node), this.container);
        ...
        CommonOutputJax.OPTIONS = __assign(
          __assign({}, OutputJax_js_1.AbstractOutputJax.OPTIONS),
          {
            scale: 1,
            minScale: 0.5,
    ...
    /***/ 85677: /***/ function (
      ...
      var Wrapper_js_1 = __webpack_require__(55734);
      var MmlNode_js_1 = __webpack_require__(80747);
      var string_js_1 = __webpack_require__(41278);
      var LENGTHS = __importStar(__webpack_require__(86810));
      var Styles_js_1 = __webpack_require__(24161);
      ...
      var CommonWrapper = (function (_super) {
        ...
        function CommonWrapper(factory, node, parent) {
          ...
          _this.childNodes = node.childNodes.map(function (child) {
            ...
            if (
              wrapped.bbox.pwidth &&
              (node.notParent || node.isKind('math'))
            ) {
        ...
        CommonWrapper.prototype.getOuterBBox = function (save) {
          ...
          try {
            for (
              var _b = __values(BBox_js_1.BBox.StyleAdjust), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
        ...
        CommonWrapper.prototype.setChildPWidths = function (
          recompute,
          w,
          clear
        ) {
          ...
          if (!attributes.getExplicit('mathvariant')) {
            ...
            if (values.family) {
              ...
              if (this.node.getProperty('variantForm'))
                variant = '-tex-variant';
              variant =
                (CommonWrapper.BOLDVARIANTS[values.weight] || {})[variant] ||
                variant;
              variant =
        ...
        CommonWrapper.prototype.explicitVariant = function (
          fontFamily,
          fontWeight,
          fontStyle
        ) {
        ...
        CommonWrapper.prototype.getScale = function () {
          ...
          if (scriptlevel !== 0) {
            scale = Math.pow(
              attributes.get('scriptsizemultiplier'),
              scriptlevel
            );
            var scriptminsize = this.length2em(
          ...
          if (isTop || hasSpacing) {
            ...
            if (attributes.isSet('lspace')) {
              this.bbox.L = Math.max(
                0,
                this.length2em(attributes.get('lspace'))
              );
            }
            if (attributes.isSet('rspace')) {
              this.bbox.R = Math.max(
                0,
                this.length2em(attributes.get('rspace'))
              );
            }
          }
        };
        ...
        CommonWrapper.prototype.getText = function () {
          ...
          if (this.node.isToken) {
            try {
              for (
                var _b = __values(this.node.childNodes), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
                var child = _c.value;
        ...
        CommonWrapper.prototype.getAlignShift = function () {
          var _a;
          var _b = (_a = this.node.attributes).getList.apply(
              _a,
              __spreadArray([], __read(MmlNode_js_1.indentAttributes), false)
            ),
        ...
        CommonWrapper.prototype.mmlNode = function (
          kind,
          properties,
          children
        ) {
    ...
    /***/ 36483: /***/ function (
      ...
      var WrapperFactory_js_1 = __webpack_require__(49294);
    ...
    /***/ 87120: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
      ...
      function CommonMactionMixin(Base) {
        return (function (_super) {
          ...
          function class_1() {
            ...
            var _this =
              _super.apply(this, __spreadArray([], __read(args), false)) ||
              this;
            var actions = _this.constructor.actions;
            var action = _this.node.attributes.get('actiontype');
            var _a = __read(
                actions.get(action) || [function (_node, _data) {}, {}],
                2
              ),
              handler = _a[0],
              data = _a[1];
          ...
          Object.defineProperty(class_1.prototype, 'selected', {
            get: function () {
              ...
              var i =
                Math.max(1, Math.min(this.childNodes.length, selection)) - 1;
    ...
    /***/ 67493: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
        ...
        return (function (_super) {
          ...
          class_1.prototype.getNotations = function () {
            ...
            try {
              for (
                var _c = __values(
                    (0, string_js_1.split)(this.node.attributes.get('notation'))
                  ),
                  _d = _c.next();
                !_d.done;
                _d = _c.next()
          ...
          class_1.prototype.removeRedundantNotations = function () {
            ...
            try {
              for (
                var _d = __values(Object.keys(this.notations)), _e = _d.next();
                !_e.done;
                _e = _d.next()
              ) {
                var name_2 = _e.value;
                if (this.notations[name_2]) {
                  ...
                  try {
                    for (
                      var _f = ((e_3 = void 0), __values(remove.split(/ /))),
                        _g = _f.next();
                      !_g.done;
                      _g = _f.next()
                    ) {
    ...
    /***/ 36639: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
      ...
      function CommonMfencedMixin(Base) {
        return (function (_super) {
          ...
          class_1.prototype.addMrowChildren = function () {
            ...
            try {
              for (
                var _b = __values(this.childNodes.slice(1)), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
                var child = _c.value;
    ...
    /***/ 36536: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
        ...
        return (function (_super) {
          ...
          function class_1() {
            ...
            var _this =
              ...
              this;
            _this.bevel = null;
            _this.pad = _this.node.getProperty('withDelims')
              ? 0
              : _this.font.params.nulldelimiterspace;
          ...
          class_1.prototype.getUVQ = function (display) {
            ...
            var tex = this.font.params;
            var _a = __read(
                display ? [tex.num1, tex.denom1] : [tex.num3, tex.denom2],
                2
              ),
              u = _a[0],
              v = _a[1];
          ...
          class_1.prototype.isDisplay = function () {
            var _a = this.node.attributes.getList(
                'displaystyle',
                'scriptlevel'
              ),
    ...
    /***/ 28656: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
          ...
          class_1.prototype.getParameters = function () {
            ...
            if (src) {
              ...
              this.charWrapper = this.wrap(
                mmlFactory.create('text').setText(text)
              );
    ...
    /***/ 54073: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
    ...
    /***/ 86539: /***/ function (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.CommonMmultiscriptsMixin =
        exports.ScriptNames =
        exports.NextScript =
          void 0;
      var BBox_js_1 = __webpack_require__(58340);
      ...
      function CommonMmultiscriptsMixin(Base) {
        return (function (_super) {
          ...
          class_1.prototype.getScriptBBoxLists = function () {
            ...
            this.firstPrescript =
              lists.subList.length + lists.supList.length + 2;
          ...
          class_1.prototype.combineBBoxLists = function (
            bbox1,
            bbox2,
            list1,
            list2
          ...
          class_1.prototype.getUVQ = function (subbox, supbox) {
            ...
            if (!this.UVQ) {
              ...
              if (subbox.h === 0 && subbox.d === 0) {
                ...
                (_a = __read(
                  _super.prototype.getUVQ.call(this, subbox, supbox),
                  3
                )),
                  (u = _a[0]),
                  (v = _a[1]),
    ...
    /***/ 53228: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
      ...
      function CommonMoMixin(Base) {
        return (function (_super) {
          ...
          class_1.prototype.getCenterOffset = function (bbox) {
            ...
            return (
              (bbox.h + bbox.d) / 2 + this.font.params.axis_height - bbox.h
            );
          };
          class_1.prototype.getVariant = function () {
          ...
          class_1.prototype.canStretch = function (direction) {
            ...
            this.stretch =
              delim && delim.dir === direction
                ? delim
                : FontData_js_1.NOSTRETCH;
            return this.stretch.dir !== 0;
          };
          class_1.prototype.getStretchedVariant = function (WH, exact) {
            ...
            if (this.stretch.dir !== 0) {
              ...
              if (delim.sizes) {
                try {
                  for (
                    var _b = __values(delim.sizes), _c = _b.next();
                    !_c.done;
                    _c = _b.next()
                  ) {
                    var d = _c.value;
              ...
              if (delim.stretch) {
                ...
                this.getStretchBBox(
                  WH,
                  this.checkExtendedHeight(D, delim),
                  delim
                );
              } else {
          ...
          class_1.prototype.getStretchBBox = function (WHD, D, C) {
            ...
            if (this.stretch.dir === 1) {
              (_a = __read(this.getBaseline(WHD, D, C), 2)),
                (h = _a[0]),
                (d = _a[1]);
            } else {
              w = D;
          ...
          class_1.prototype.getBaseline = function (WHD, HD, C) {
            ...
            if (symmetric) {
              ...
              var _c = __read(C.HDW || [0.75, 0.25], 2),
                ch = _c[0],
                cd = _c[1];
              d = cd * (h / (ch + cd));
            }
    ...
    /***/ 95522: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
      ...
      function CommonMpaddedMixin(Base) {
        return (function (_super) {
          ...
          class_1.prototype.getDimens = function () {
            var values = this.node.attributes.getList(
              'width',
              'height',
              'depth',
              'lspace',
    ...
    /***/ 23692: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
      ...
      function CommonMrowMixin(Base) {
        return (function (_super) {
          ...
          function class_1() {
            ...
            try {
              for (
                var _b = __values(_this.childNodes), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
                var child = _c.value;
          ...
          class_1.prototype.stretchChildren = function () {
            ...
            try {
              for (
                var _d = __values(this.childNodes), _e = _d.next();
                !_e.done;
                _e = _d.next()
              ) {
                var child = _e.value;
            ...
            if (count && nodeCount > 1) {
              ...
              try {
                for (
                  var _f = __values(this.childNodes), _g = _f.next();
                  !_g.done;
                  _g = _f.next()
                ) {
                  var child = _g.value;
              ...
              try {
                for (
                  var stretchy_1 = __values(stretchy),
                    stretchy_1_1 = stretchy_1.next();
                  !stretchy_1_1.done;
                  stretchy_1_1 = stretchy_1.next()
                ) {
    ...
    /***/ 95151: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
    ...
    /***/ 9572: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
      ...
      function CommonMsqrtMixin(Base) {
        return (function (_super) {
          ...
          function class_1() {
            ...
            var p = _this.node.attributes.get('displaystyle')
              ? _this.font.params.x_height
              : t;
          ...
          class_1.prototype.computeBBox = function (bbox, recompute) {
            ...
            var basebox = new BBox_js_1.BBox(
              this.childNodes[this.base].getOuterBBox()
            );
    ...
    /***/ 64418: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.CommonMsubsupMixin =
        exports.CommonMsupMixin =
        exports.CommonMsubMixin =
          void 0;
        ...
        return (
          (_a = (function (_super) {
            ...
            class_3.prototype.computeBBox = function (bbox, recompute) {
              ...
              var basebox = this.baseChild.getOuterBBox();
              var _a = __read(
                  [this.subChild.getOuterBBox(), this.supChild.getOuterBBox()],
                  2
                ),
                subbox = _a[0],
                supbox = _a[1];
            ...
            class_3.prototype.getUVQ = function (subbox, supbox) {
              ...
              var subscriptshift = this.length2em(
                this.node.attributes.get('subscriptshift'),
                tex.sub2
              );
              var drop = this.baseCharZero(
                basebox.d * this.baseScale + tex.sub_drop * subbox.rscale
              );
              var _a = __read([this.getU(), Math.max(drop, subscriptshift)], 2),
                u = _a[0],
                v = _a[1];
              var q =
                u - supbox.d * supbox.rscale - (subbox.h * subbox.rscale - v);
              if (q < t) {
                v += t - q;
    ...
    /***/ 70078: /***/ function (
      ...
      var BBox_js_1 = __webpack_require__(58340);
      var string_js_1 = __webpack_require__(41278);
      var numeric_js_1 = __webpack_require__(19468);
      function CommonMtableMixin(Base) {
        return (function (_super) {
          ...
          function class_1() {
            ...
            _this.pwidthCells = [];
            _this.pWidth = 0;
            _this.numCols = (0, numeric_js_1.max)(
              _this.tableRows.map(function (row) {
                return row.numCells;
              })
            );
            ...
            _this.fSpace = _this.frame
              ? _this.convertLengths(_this.getAttributeArray('framespacing'))
              : [0, 0];
            _this.cSpace = _this.convertLengths(
              _this.getColumnAttributes('columnspacing')
            );
            _this.rSpace = _this.convertLengths(
              _this.getRowAttributes('rowspacing')
            );
            _this.cLines = _this
          ...
          class_1.prototype.findContainer = function () {
            ...
            while (
              parent &&
              (parent.node.notParent || parent.node.isKind('mrow'))
            ) {
              node = parent;
          ...
          class_1.prototype.stretchRows = function () {
            var equal = this.node.attributes.get('equalrows');
            var HD = equal ? this.getEqualRowHeight() : 0;
            var _a = equal ? this.getTableData() : { H: [0], D: [0] },
              H = _a.H,
              D = _a.D;
          ...
          class_1.prototype.stretchColumns = function () {
            for (var i = 0; i < this.numCols; i++) {
              var width =
                typeof this.cWidths[i] === 'number' ? this.cWidths[i] : null;
          ...
          class_1.prototype.stretchColumn = function (i, W) {
            ...
            try {
              for (
                var _d = __values(this.tableRows), _e = _d.next();
                !_e.done;
                _e = _d.next()
              ) {
                var row = _e.value;
            ...
            if (count && nodeCount > 1) {
              if (W === null) {
                ...
                try {
                  for (
                    var _f = __values(this.tableRows), _g = _f.next();
                    !_g.done;
                    _g = _f.next()
                  ) {
                    var row = _g.value;
          ...
          class_1.prototype.updateHDW = function (
            cell,
            i,
            j,
            align,
          ...
          class_1.prototype.computeBBox = function (bbox, _recompute) {
            ...
            if (this.node.attributes.get('equalrows')) {
              var HD = this.getEqualRowHeight();
              height =
                (0, numeric_js_1.sum)([].concat(this.rLines, this.rSpace)) +
                HD * this.numRows;
            } else {
              height = (0, numeric_js_1.sum)(
                H.concat(D, this.rLines, this.rSpace)
              );
            }
            height += 2 * (this.fLine + this.fSpace[1]);
            var CW = this.getComputedWidths();
            width =
              (0, numeric_js_1.sum)(CW.concat(this.cLines, this.cSpace)) +
          ...
          class_1.prototype.setChildPWidths = function (
            _recompute,
            cwidth,
            _clear
          ) {
            ...
            var _a = this.bbox,
              ...
              L = _a.L,
              R = _a.R;
            var labelInWidth = this.node.attributes.get(
          ...
          class_1.prototype.setColumnPWidths = function () {
            ...
            try {
              for (
                var _b = __values(this.pwidthCells), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
                var _d = __read(_c.value, 2),
          ...
          class_1.prototype.getPadAlignShift = function (side) {
            ...
            var sep = this.length2em(
              this.node.attributes.get('minlabelspacing')
            );
            var pad = L + sep;
            var _a = __read(
                this.styles == null
          ...
          class_1.prototype.getColumnWidthsFixed = function (swidths, width) {
            ...
            indices.forEach(function (i) {
              var x = swidths[i];
              dw -=
                x === 'fit' || x === 'auto' ? W[i] : _this.length2em(x, cwidth);
            });
          ...
          class_1.prototype.getAlignmentRow = function () {
            var _a = __read(
                (0, string_js_1.split)(this.node.attributes.get('align')),
                2
              ),
              align = _a[0],
              row = _a[1];
    ...
    /***/ 8256: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
    ...
    /***/ 58267: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
          ...
          (_a = (function (_super) {
            ...
            class_1.prototype.getVariant = function () {
              ...
              if (!!data.mtextFamily || !!options.mtextFont || merror) {
                ...
                var font =
                  this.constructor.INHERITFONTS[variant] ||
      ...
      function CommonMtrMixin(Base) {
        return (function (_super) {
          ...
          class_1.prototype.stretchChildren = function (HD) {
            ...
            var stretchy = [];
            var children = this.labeled
              ? this.childNodes.slice(1)
              : this.childNodes;
            try {
              for (
                var children_1 = __values(children),
            ...
            if (count && nodeCount > 1) {
              if (HD === null) {
                ...
                try {
                  for (
                    var children_2 = __values(children),
    ...
    /***/ 62358: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.CommonMunderoverMixin =
        exports.CommonMoverMixin =
        exports.CommonMunderMixin =
          void 0;
        ...
        return (function (_super) {
          ...
          class_2.prototype.computeBBox = function (bbox) {
            ...
            if (this.node.attributes.get('accent')) {
              basebox.h = Math.max(
                basebox.h,
                this.font.params.x_height * basebox.scale
              );
            }
          ...
          (_a = (function (_super) {
            ...
            function class_1() {
              ...
              _this.isMathAccent =
                _this.baseIsChar &&
                _this.scriptChild &&
                !!_this.scriptChild.coreMO().node.getProperty('mathaccent');
                ...
                ((core.childNodes.length === 1 &&
                  (core.node.isKind('mrow') ||
                    (core.node.isKind('TeXAtom') &&
                      core.node.texClass !== MmlNode_js_1.TEXCLASS.VCENTER) ||
              ...
              if (core.node.isKind('munderover')) {
                ...
                if (this.baseHasAccentUnder === null) {
                  this.baseHasAccentUnder =
                    !!core.node.attributes.get('accentunder');
                }
              }
            };
            class_1.prototype.getSemanticBase = function () {
              var fence = this.node.attributes.getExplicit(
            ...
            class_1.prototype.getBaseFence = function (fence, id) {
              ...
              if (
                fence.node.attributes.getExplicit('data-semantic-id') === id
              ) {
                return fence;
              }
              try {
                for (
                  var _b = __values(fence.childNodes), _c = _b.next();
                  !_c.done;
                  _c = _b.next()
                ) {
                  var child = _c.value;
            ...
            class_1.prototype.isCharBase = function () {
              ...
              return (
                ((base.node.isKind('mo') && base.size === null) ||
                  base.node.isKind('mi') ||
                  base.node.isKind('mn')) &&
                base.bbox.rscale === 1 &&
            ...
            class_1.prototype.getV = function () {
              ...
              return Math.max(
                this.baseCharZero(
                  bbox.d * this.baseScale + tex.sub_drop * sbox.rscale
                ),
                subscriptshift,
            ...
            class_1.prototype.getU = function () {
              ...
              var sbox = this.scriptChild.getOuterBBox();
              var tex = this.font.params;
              var attr = this.node.attributes.getList(
                'displaystyle',
                'superscriptshift'
              );
              ...
              return Math.max(
                this.baseCharZero(
                  bbox.h * this.baseScale - tex.sup_drop * sbox.rscale
                ),
                superscriptshift,
            ...
            class_1.prototype.getDeltaW = function (boxes, delta) {
              ...
              var w = Math.max.apply(
                Math,
                __spreadArray([], __read(widths), false)
              );
              var dw = [];
              var m = 0;
              try {
                for (
                  var _c = __values(widths.keys()), _d = _c.next();
                  !_d.done;
                  _d = _c.next()
                ) {
                  var i = _d.value;
              ...
              if (m) {
                try {
                  for (
                    var _e = __values(dw.keys()), _f = _e.next();
                    !_f.done;
                    _f = _e.next()
                  ) {
                    var i = _f.value;
    ...
    /***/ 32482: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
    ...
    /***/ 43899: /***/ function (
      ...
      var PrioritizedList_js_1 = __webpack_require__(82776);
        ...
        FunctionList.prototype.execute = function () {
          ...
          try {
            for (
              ...
              var item = _c.value;
              var result = item.item.apply(
                item,
                __spreadArray([], __read(data), false)
              );
              if (result === false) {
                return false;
              }
          ...
          return new Promise(function (ok, fail) {
            (function execute() {
              ...
              while (++i < items.length) {
                var result = (_a = items[i]).item.apply(
                  _a,
                  __spreadArray([], __read(data), false)
                );
    ...
    /***/ 82776: /***/ (__unused_webpack_module, exports) => {
      Object.defineProperty(exports, '__esModule', { value: true });
    ...
    /***/ 14454: /***/ function (__unused_webpack_module, exports) {
      var __values =
        (this && this.__values) ||
        function (o) {
          var s = typeof Symbol === 'function' && Symbol.iterator,
      ...
      var CssStyles = (function () {
        ...
        CssStyles.prototype.addStyles = function (styles) {
          ...
          try {
            for (
              var _b = __values(Object.keys(styles)), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var style = _c.value;
    ...
    /***/ 24161: /***/ function (__unused_webpack_module, exports) {
      var __values =
        (this && this.__values) ||
        function (o) {
          var s = typeof Symbol === 'function' && Symbol.iterator,
      ...
      function splitTRBL(name) {
        ...
        try {
          for (
            var _b = __values(Styles.connect[name].children), _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
            var child = _c.value;
      ...
      function combineSame(name) {
        ...
        var children = __spreadArray(
          [],
          __read(Styles.connect[name].children),
          false
        );
      ...
      function splitWSC(name) {
        ...
        try {
          for (
            var _c = __values(splitSpaces(this.styles[name])), _d = _c.next();
            !_d.done;
            _d = _c.next()
          ) {
            var part = _d.value;
        ...
        try {
          for (
            var _e = __values(Styles.connect[name].children), _f = _e.next();
            !_f.done;
            _f = _e.next()
          ) {
            var child = _f.value;
      ...
      function splitFont(name) {
        ...
        try {
          for (
            var parts_1 = __values(parts), parts_1_1 = parts_1.next();
            !parts_1_1.done;
            ...
            try {
              for (
                var _c = ((e_9 = void 0), __values(Object.keys(FONT))),
                  _d = _c.next();
                !_d.done;
                _d = _c.next()
              ) {
                var name_1 = _d.value;
                if (
                  (Array.isArray(value[name_1]) || value[name_1] === '') &&
      ...
      var Styles = (function () {
        ...
        Object.defineProperty(Styles.prototype, 'cssText', {
          get: function () {
            ...
            try {
              for (
                var _b = __values(Object.keys(this.styles)), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
                var name_2 = _c.value;
    ...
    /***/ 19468: /***/ (__unused_webpack_module, exports) => {
      Object.defineProperty(exports, '__esModule', { value: true });
...
//# sourceMappingURL=4090.5e64082f1e98afe19b97.js.map?v=5e64082f1e98afe19b97
