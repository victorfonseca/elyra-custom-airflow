      ...
      var n =
        ...
        function (t, e) {
          ...
          var i = r.call(t),
            ...
            a;
          try {
            while ((e === void 0 || e-- > 0) && !(o = i.next()).done)
              n.push(o.value);
          } catch (s) {
            a = { error: s };
          } finally {
    ...
    14347: function (t, e, r) {
      ...
      var c = (function (t) {
        ...
        r.prototype.visitDefault = function (t, e) {
          var r = t.kind;
          var i = n(
              t.isToken || t.childNodes.length === 0 ? ['', ''] : ['\n', e],
              2
            ),
            o = i[0],
            a = i[1];
        ...
        r.prototype.getAttributes = function (t) {
          ...
          try {
            for (
              var l = o(Object.keys(a)), u = l.next();
              !u.done;
              u = l.next()
            ) {
              var c = u.value;
          ...
          if (n !== undefined) {
            ...
            a &&
              this.setDataAttribute(
                e,
                'texclass',
                n < 0 ? 'NONE' : s.TEXCLASSNAMES[n]
              );
          }
          t.getProperty('scriptlevel') &&
            t.getProperty('useHeight') === false &&
