    ...
    34981: function (r, e) {
      ...
      function i(r) {
        return (
          typeof r === 'object' &&
          r !== null &&
          (r.constructor === a || r.constructor === l)
        );
      }
      e.isObject = i;
      e.APPEND = '[+]';
        ...
        var p = function (t) {
          if (f && r[t] === undefined && r.constructor !== l) {
            ...
            e.OPTIONS.optionError(
              'Invalid option "'.concat(t, '" (no default value).'),
              t
            );
            return 'continue';
          }
            ...
            if (
              ...
              ((p.length === 1 &&
                ...
                (p.length === 2 &&
                  ...
                  Array.isArray(u[e.APPEND]) &&
                  Array.isArray(u[e.REMOVE])))
            ) {
              if (u[e.REMOVE]) {
      ...
      function h(r) {
        ...
        try {
          for (var u = t(i), c = u.next(); !c.done; c = u.next()) {
            ...
            try {
              for (
                var p = ((o = void 0), t(Object.keys(r || {}))), O = p.next();
                !O.done;
                O = p.next()
              ) {
                var d = O.value;
