  ...
  [5489],
  {
    25489: (e, t, r) => {
      ...
      var d = function e(t) {
        var r = p(t);
        return (
          r.type === 'mathord' || r.type === 'textord' || r.type === 'atom'
        );
      };
      var f = function e(t) {
        if (!t) {
      ...
      var Bt = function e(t, r, a) {
        var i = At([t], [], r);
        i.height = Math.max(
          a || r.fontMetrics().defaultRuleThickness,
          r.minRuleThickness
        );
      ...
      var ar = function e(t, r, a, i) {
        ...
        ir(
          ...
          (e, t) => {
            ...
            var a = or(e);
            var i =
              r && a ? (e.hasClass('mtight') ? Yt[r][a] : Ut[r][a]) : null;
            if (i) {
      ...
      var nr = function e(t) {
        if (
          t instanceof ee ||
          t instanceof Se ||
          (t instanceof ke && t.hasClass('enclosing'))
        ) {
          return t;
        }
        return null;
      ...
      function mr(e, t) {
        ...
        for (var o = 0; o < a.length; o++) {
          ...
          if (
            a[o].hasClass('mbin') ||
            a[o].hasClass('mrel') ||
            a[o].hasClass('allowbreak')
          ) {
            var l = false;
            while (
              o < a.length - 1 &&
              a[o + 1].hasClass('mspace') &&
              !a[o + 1].hasClass('newline')
            ) {
              o++;
              s.push(a[o]);
      ...
      class pr {
        ...
        toNode() {
          ...
          for (var r = 0; r < this.children.length; r++) {
            if (
              this.children[r] instanceof dr &&
              this.children[r + 1] instanceof dr
            ) {
      ...
      function Mr(e, t, r, a, i) {
        ...
        if (
          n.length === 1 &&
          n[0] instanceof pr &&
          g.contains(['mrow', 'mtable'], n[0].type)
        ) {
          s = n[0];
        } else {
      ...
      var zr = function e(t) {
        return new me({
          style: t.displayMode ? L.DISPLAY : L.TEXT,
          maxSize: t.maxSize,
      ...
      var Nr = function e(t) {
        var r = new vr.MathNode('mo', [
          new vr.TextNode(Cr[t.replace(/^\\/, '')])
        ]);
      ...
      var Vr = (e, t) => {
        ...
        var m = u
          ? n.height + n.depth
          : Math.min(n.height, t.fontMetrics().xHeight);
        var c;
        if (!a.isStretchy) {
          var p;
          var d;
      ...
      var Pr = (e, t) => {
        var r = e.isStretchy
          ? Or.mathMLnode(e.label)
          : new vr.MathNode('mo', [gr(e.label, e.mode)]);
      ...
      jt({
        ...
        htmlBuilder(e, t) {
          ...
          if (s) {
            var m =
              -t.fontMetrics().axisHeight + s.height + 0.5 * o.height + 0.111;
            u = Vt.makeVList(
              {
      ...
      jt({
        ...
        handler(e, t) {
          ...
          return {
            ...
            mclass: 'm' + a.slice(5),
            body: Kt(i),
            isCharacterBox: g.isCharacterBox(i)
          };
        },
        htmlBuilder: Yr,
        mathmlBuilder: Xr
      ...
      jt({
        ...
        handler(e, t) {
          ...
          return {
            ...
            mclass: Wr(t[0]),
            body: Kt(t[1]),
            isCharacterBox: g.isCharacterBox(t[1])
          };
        }
      });
      jt({
        ...
        handler(e, t) {
          ...
          return {
            ...
            mclass: s,
            body: [l],
            isCharacterBox: g.isCharacterBox(l)
          };
        },
        htmlBuilder: Yr,
        mathmlBuilder: Xr
      ...
      jt({
        ...
        handler(e, t, r) {
          var { parser: a } = e;
          var i =
            a.gullet.future().text === '[' ? a.parseSizeGroup(true) : null;
          var n =
      ...
      var na = function e(t, r, a) {
        ...
        if (!n) {
          throw new Error(
            'Unsupported symbol ' + t + ' and font size ' + r + '.'
          );
        }
        return n;
      };
      ...
      var ua = function e(t, r, a, i, n, s) {
        var o = ha(t, r, n, i);
        var l = sa(
          Vt.makeSpan(['delimsizing', 'size' + r], [o], i),
          L.TEXT,
          i,
          s
        );
      ...
      var ma = function e(t, r, a) {
        ...
        var n = Vt.makeSpan(
          ['delimsizinginner', i],
          [Vt.makeSpan([], [Vt.makeSymbol(t, r, a)])]
        );
        return { type: 'elem', elem: n };
      };
      var ca = function e(t, r, a) {
        var i = te['Size4-Regular'][t.charCodeAt(0)]
          ? te['Size4-Regular'][t.charCodeAt(0)][4]
          : te['Size1-Regular'][t.charCodeAt(0)][4];
      ...
      var wa = function e(t, r) {
        ...
        var s = Math.max(
          0,
          r.minRuleThickness - r.fontMetrics().sqrtRuleThickness
        );
        var o;
        var l = 0;
        var h = 0;
        ...
        return {
          span: o,
          advanceWidth: m,
          ruleWidth: (r.fontMetrics().sqrtRuleThickness + s) * n
        };
      };
      var ka = [
        '(',
      ...
      jt({
        ...
        handler: (e, t) => {
          ...
          return {
            type: 'delimsizing',
            mode: e.parser.mode,
            size: Oa[e.funcName].size,
            mclass: Oa[e.funcName].mclass,
            delim: r.text
          };
        },
        htmlBuilder: (e, t) => {
      ...
      jt({
        ...
        handler(e, t) {
          ...
          if (a === '\\begin') {
            ...
            var l = ei[s];
            var { args: h, optArgs: u } = r.parseArguments(
              '\\begin{' + s + '}',
              l
            );
            ...
            if (d.name !== s) {
              throw new n(
                'Mismatch: \\begin{' + s + '} matched by \\end{' + d.name + '}',
                p
              );
            }
            return c;
      ...
      var hi = (e, t) => {
        ...
        if (e.type === 'supsub') {
          a = e.sup
            ? hr(e.sup, t.havingStyle(r.sup()), t)
            : hr(e.sub, t.havingStyle(r.sub()), t);
      ...
      var ui = (e, t) => {
        var r = Or.mathMLnode(e.label);
        return new vr.MathNode(e.isOver ? 'mover' : 'munder', [
          Sr(e.base, t),
          r
        ]);
      };
        ...
        if (t) {
          ...
          h = {
            ...
            kern: Math.max(
              ...
              a.fontMetrics().bigOpSpacing3 - u.depth
            )
          };
        }
        if (r) {
          ...
          l = {
            ...
            kern: Math.max(
              ...
              a.fontMetrics().bigOpSpacing4 - m.height
            )
          };
        }
        var c;
      ...
      var fi = (e, t) => {
        ...
        if (n.symbol) {
          ...
          l = Vt.makeSymbol(n.name, h, 'math', t, [
            'mop',
            'op-symbol',
            o ? 'large-op' : 'small-op'
          ]);
        ...
        var b = 0;
        if (
          (l instanceof Ae || n.name === '\\oiint' || n.name === '\\oiiint') &&
          !n.suppressBaseShift
        ) {
      ...
      jt({
        ...
        mathmlBuilder(e, t) {
          ...
          return a
            ? new vr.MathNode('mroot', [Sr(r, t), Sr(a, t)])
            : new vr.MathNode('msqrt', [Sr(r, t)]);
        }
      });
      var Mi = {
        display: L.DISPLAY,
      ...
      var zi = function e(t, r) {
        ...
        if (!a) {
          ...
          var i =
            a.limits &&
            (r.style.size === L.DISPLAY.size || a.alwaysHandleSupSub);
          return i ? fi : null;
        } else if (a.type === 'operatorname') {
          var n =
            a.alwaysHandleSupSub &&
            (r.style.size === L.DISPLAY.size || a.limits);
          return n ? yi : null;
        ...
        htmlBuilder(e, t) {
          ...
          if (n) {
            ...
            if (!c) {
              m =
                s.depth +
                (d.fontMetrics().subDrop * d.sizeMultiplier) / t.sizeMultiplier;
            }
          }
          var f;
            ...
            w = Vt.makeVList(
              {
                positionType: 'shift',
                positionData: -u,
                children: [{ type: 'elem', elem: o, marginRight: b }]
              },
              t
            );
          } else {
        ...
        mathmlBuilder(e, t) {
          ...
          if (r) {
            ...
            if (
              ...
              o.type === 'op' &&
              o.limits &&
              (t.style === L.DISPLAY || o.alwaysHandleSupSub)
            ) {
              s = 'mover';
            } else if (
              o &&
            ...
            if (
              ...
              l.type === 'op' &&
              l.limits &&
              (t.style === L.DISPLAY || l.alwaysHandleSupSub)
            ) {
              s = 'munder';
            } else if (
              l &&
      ...
      $t({
        ...
        mathmlBuilder(e, t) {
          var r = new vr.MathNode('mtable', [
            new vr.MathNode('mtr', [
              Ci(),
              new vr.MathNode('mtd', [kr(e.body, t)]),
              Ci(),
              new vr.MathNode('mtd', [kr(e.tag, t)])
            ])
          ]);
      ...
      jt({
        ...
        htmlBuilder(e, t) {
          ...
          for (var n = 0; n < r.length; n++) {
            ...
            a.push(
              Vt.makeSymbol(s, 'Typewriter-Regular', e.mode, i, [
                'mord',
                'texttt'
              ])
            );
      ...
      var Ki = ve(
        te['Main-Regular']['T'.charCodeAt(0)][1] -
          0.7 * te['Main-Regular']['A'.charCodeAt(0)][1]
      );
      Ya(
        '\\LaTeX',
        '\\textrm{\\html@mathml{' +
          ('L\\kern-.36em\\raisebox{' + Ki + '}{\\scriptstyle A}') +
          '\\kern-.15em\\TeX}{LaTeX}}'
      );
      Ya(
        '\\KaTeX',
        '\\textrm{\\html@mathml{' +
          ('K\\kern-.17em\\raisebox{' + Ki + '}{\\scriptstyle A}') +
          '\\kern-.15em\\TeX}{KaTeX}}'
      );
        ...
        isExpandable(e) {
          ...
          return t != null
            ? typeof t === 'string' ||
                typeof t === 'function' ||
                !t.unexpandable
            : Oi.hasOwnProperty(e) && !Oi[e].primitive;
        }
      }
        ...
        parseGroup(e, t) {
          ...
          if (i === '{' || i === '\\begingroup') {
            ...
            s = {
              ...
              loc: a.range(r, h),
              body: l,
              semisimple: i === '\\begingroup' || undefined
            };
          } else {
