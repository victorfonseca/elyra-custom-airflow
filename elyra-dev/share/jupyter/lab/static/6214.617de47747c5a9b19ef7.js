    ...
    26214: (t, e, n) => {
      ...
      var c = (function () {
        ...
        var h = {
          ...
          performAction: (0, i.K2)(function t(e, n, i, r, s, a, o) {
            var c = a.length - 1;
            switch (s) {
              case 1:
                return a[c - 1];
              ...
              case 7:
                ...
                break;
              case 8:
                r.getCommonDb().setDiagramTitle(a[c].substr(6));
                this.$ = a[c].substr(6);
                break;
              case 9:
                this.$ = a[c].trim();
                r.getCommonDb().setAccTitle(this.$);
                break;
              case 10:
              case 11:
                this.$ = a[c].trim();
            ...
            while (true) {
              ...
              switch ($[0]) {
                ...
                case 2:
                  ...
                  r.push(this.productions_[$[1]][0]);
                  a.push(I.$);
                  o.push(I._$);
                  L = c[r[r.length - 2]][r[r.length - 1]];
                  r.push(L);
                  break;
                case 3:
                  return true;
      ...
      var f = [];
      var y = [];
      var g = (0, i.K2)(() => i.Wt, 'getCommonDb');
      var m = (0, i.K2)(function () {
        p.length = 0;
        f.length = 0;
        d = '';
        y.length = 0;
      ...
      var _ = (0, i.K2)(function (t) {
        const e = y.find((t) => t.id === u - 1);
        e.events.push(t);
      }, 'addEvent');
      var w = (0, i.K2)(function (t) {
      ...
      var C = (0, i.K2)(function (t, e, n) {
        ...
        r.append('line')
          ...
          .attr('stroke', '#666');
        T(r, { cx: i, cy: 300 + (5 - e.score) * 30, score: e.score });
        const a = H();
        a.x = e.x;
        a.y = e.y;
        a.fill = e.fill;
      ...
      (0, i.K2)(D, 'wrap');
      var z = (0, i.K2)(function (t, e, n, i) {
        const r = (n % $) - 1;
        const s = t.append('g');
        e.section = r;
        s.attr(
          'class',
          (e.class ? e.class + ' ' : '') + 'timeline-node ' + ('section-' + r)
        );
        const a = s.append('g');
        const o = s.append('g');
        const c = o
      ...
      var W = (0, i.K2)(function (t, e, n) {
        ...
        const a = n.fontSize?.replace
          ? n.fontSize.replace('px', '')
          : n.fontSize;
        i.remove();
        return s.height + a * 1.1 * 0.5 + e.padding;
      }, 'getVirtualNodeHeight');
      var B = (0, i.K2)(function (t, e, n) {
        const i = 5;
        t.append('path')
          .attr('id', 'node-' + e.id)
          ...
          .attr(
            'd',
            `M0 ${e.height - i} v${-e.height + 2 * i} q0,-5 5,-5 h${e.width - 2 * i} q5,0 5,5 v${e.height - i} H0 Z`
          );
        t.append('line')
      ...
      var V = (0, i.K2)(function (t, e, n, s) {
        const a = (0, i.D7)();
        const o = a.leftMargin ?? 50;
        i.Rm.debug('timeline', s.db);
        ...
        const h =
          c === 'sandbox'
            ? (0, r.Ltv)(l.nodes()[0].contentDocument.body)
            : (0, r.Ltv)('body');
        const d = h.select('#' + e);
        d.append('g');
        const u = s.db.getTasks();
        const p = s.db.getCommonDb().getDiagramTitle();
        i.Rm.debug('task', u);
        F.initGraphics(d);
        const f = s.db.getSections();
        i.Rm.debug('sections', f);
        let y = 0;
        let g = 0;
        let m = 0;
        let x = 0;
        ...
        f.forEach(function (t) {
          ...
          const n = F.getVirtualNodeHeight(d, e, a);
          i.Rm.debug('sectionHeight before draw', n);
          y = Math.max(y, n + 20);
        });
        let w = 0;
        let K = 0;
        i.Rm.debug('tasks.length', u.length);
        for (const [r, E] of u.entries()) {
          const t = {
            number: r,
            descr: E,
            section: E.section,
          ...
          const e = F.getVirtualNodeHeight(d, t, a);
          i.Rm.debug('taskHeight before draw', e);
          g = Math.max(g, e + 20);
          w = Math.max(w, E.events.length);
          let n = 0;
          for (const i of E.events) {
            ...
            n += F.getVirtualNodeHeight(d, t, a);
          }
          K = Math.max(K, n);
        }
        i.Rm.debug('maxSectionHeight before draw', y);
        i.Rm.debug('maxTaskHeight before draw', g);
        if (f && f.length > 0) {
          f.forEach((t) => {
            ...
            const r = d.append('g');
            const s = F.drawNode(r, n, v, a);
            i.Rm.debug('sectionNode output', s);
            r.attr('transform', `translate(${b}, ${x})`);
            k += y + 50;
            if (e.length > 0) {
              G(d, e, v, b, k, g, a, w, K, y, false);
            }
        ...
        m = _ ? y + g + 150 : g + 100;
        const $ = d.append('g').attr('class', 'lineWrapper');
        $.append('line')
          .attr('x1', o)
          .attr('y1', m)
          .attr('x2', S.width + 3 * o)
        ...
        (0, i.ot)(
          void 0,
          d,
          a.timeline?.padding ?? 50,
          a.timeline?.useMaxWidth ?? false
        );
      }, 'draw');
      var G = (0, i.K2)(function (t, e, n, r, s, a, o, c, l, h, d) {
        for (const u of e) {
          const e = {
            descr: u.task,
            section: n,
          ...
          const p = F.drawNode(c, e, n, o);
          const f = p.height;
          i.Rm.debug('taskHeight after draw', f);
          c.attr('transform', `translate(${r}, ${s})`);
          a = Math.max(a, f);
          if (u.events) {
            const e = t.append('g').attr('class', 'lineWrapper');
            let i = a;
            s += 100;
            i = i + U(t, u.events, n, r, s, o);
            s -= 100;
            e.append('line')
              .attr('x1', r + 190 / 2)
              .attr('y1', s + a)
              .attr('x2', r + 190 / 2)
              .attr('y2', s + a + (d ? a : h) + l + 120)
              .attr('stroke-width', 2)
              .attr('stroke', 'black')
              .attr('marker-end', 'url(#arrowhead)')
          ...
          r = r + 200;
          if (d && !o.timeline?.disableMulticolor) {
            n++;
          }
        }
        s = s - 10;
      }, 'drawTasks');
      var U = (0, i.K2)(function (t, e, n, r, s, a) {
        let o = 0;
        const c = s;
        s = s + 100;
        for (const l of e) {
      ...
      var Z = Y;
      var X = { db: h, renderer: q, parser: l, styles: Z };
    }
  }
]);
