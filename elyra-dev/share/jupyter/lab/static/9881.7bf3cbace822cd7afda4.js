    ...
    /***/ 79881: /***/ (
      ...
      var TextDimensionCalculatorWithFont = class {
        ...
        getMaxDimension(texts, fontSize) {
          if (!this.parentGroup) {
            return {
              width:
                texts.reduce((acc, cur) => Math.max(cur.length, acc), 0) *
                fontSize,
              height: fontSize
            };
          }
          ...
          for (const t of texts) {
            const bbox = (0,
            _chunk_C3MQ5ANM_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .computeDimensionOfText */.W6)(
              elem,
              1,
              t
            );
      ...
      var BandAxis = class extends BaseAxis {
        ...
        constructor(
          ...
          this.scale = (0,
          d3__WEBPACK_IMPORTED_MODULE_4__ /* .scaleBand */.WH)()
      ...
      var LinearAxis = class extends BaseAxis {
        ...
        constructor(
          ...
          this.domain = domain;
          this.scale = (0,
          d3__WEBPACK_IMPORTED_MODULE_4__ /* .scaleLinear */.m4Y)()
            .domain(this.domain)
            .range(this.getRange());
        }
        getTickValues() {
          ...
          return [
            {
              ...
              data: finalData.map((data) => ({
                ...
                width: barWidth,
                height:
                  this.boundingRect.y + this.boundingRect.height - data[1],
                fill: this.barData.fill,
                strokeWidth: 0,
                strokeFill: this.barData.fill
              }))
      ...
      function getChartDefaultThemeConfig() {
        ...
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getThemeVariables */.P$)();
        const config = (0,
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getConfig */.zj)();
        return (0,
        _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_1__ /* .cleanAndMerge */.$t)(
          defaultThemeVariables.xyChart,
          config.themeVariables.xyChart
        );
      }
      (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
        getChartDefaultThemeConfig,
        'getChartDefaultThemeConfig'
      );
              ...
              case 'text':
                shapeGroup
                  ...
                  .attr('text-anchor', (data) =>
                    getTextAnchor(data.horizontalPos)
                  )
...
//# sourceMappingURL=9881.7bf3cbace822cd7afda4.js.map?v=7bf3cbace822cd7afda4
