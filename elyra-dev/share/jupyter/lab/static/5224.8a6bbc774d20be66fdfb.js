  ...
  [5224],
  {
    15224: (e, n, t) => {
      ...
      function r(e) {
        var n = {},
          t = e.split(' ');
        for (var r = 0; r < t.length; ++r) n[t[r]] = true;
        return n;
      }
      var i = r('if elsif else stop require');
      var u = r('true false not');
      function a(e, n) {
        var t = e.next();
        if (t == '/' && e.eat('*')) {
          n.tokenize = o;
        ...
        if (u.propertyIsEnumerable(r)) return 'atom';
        return null;
      }
      function l(e, n) {
        n._multiLineString = true;
        if (!e.sol()) {
          e.eatSpace();
          if (e.peek() == '#') {
            e.skipToEnd();
