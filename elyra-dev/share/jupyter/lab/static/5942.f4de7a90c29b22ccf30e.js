...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [5942],
  {
    /***/ 35942: /***/ (
      ...
      var index_js_ = __webpack_require__(45145); // CONCATENATED MODULE: ./node_modules/@lezer/php/dist/index.es.js
      ...
      const interpolated = new dist /* ExternalTokenizer */.Lu(
        (input, stack) => {
          let content = false;
          for (; ; content = true) {
            if (
              ...
              input.next < 0 ||
              (input.next == 36 /* '$' */ &&
                (isIdentifierStart(input.peek(1)) ||
                  input.peek(1) == 123)) /* '{' */ ||
      ...
      const phpHighlighting = (0, index_js_.styleTags)({
        ...
        'CallExpression/Name': index_js_.tags.function(
          index_js_.tags.variableName
        ),
        'LabelStatement/Name': index_js_.tags.labelName,
        'MemberExpression/Name': index_js_.tags.propertyName,
        'MemberExpression/VariableName': index_js_.tags.special(
          index_js_.tags.propertyName
        ),
        'ScopedExpression/ClassMemberName/Name': index_js_.tags.propertyName,
        'ScopedExpression/ClassMemberName/VariableName': index_js_.tags.special(
          index_js_.tags.propertyName
        ),
        'CallExpression/MemberExpression/Name': index_js_.tags.function(
          index_js_.tags.propertyName
        ),
        'CallExpression/ScopedExpression/ClassMemberName/Name':
          index_js_.tags.function(index_js_.tags.propertyName),
        'MethodDeclaration/Name': index_js_.tags.function(
          index_js_.tags.definition(index_js_.tags.variableName)
        ),
        'FunctionDefinition/Name': index_js_.tags.function(
          index_js_.tags.definition(index_js_.tags.variableName)
        ),
        'ClassDeclaration/Name': index_js_.tags.definition(
      ...
      var dist_index_js_ = __webpack_require__(66575);
      // EXTERNAL MODULE: ./node_modules/@codemirror/lang-html/dist/index.js + 1 modules
      var lang_html_dist = __webpack_require__(91962);
      ...
      var language_dist_index_js_ = __webpack_require__(4452); // CONCATENATED MODULE: ./node_modules/@codemirror/lang-php/dist/index.js
      /**
...
*/
      const phpLanguage =
        /*@__PURE__*/ language_dist_index_js_.LRLanguage.define({
          name: 'php',
          parser: /*@__PURE__*/ parser.configure({
            props: [
              /*@__PURE__*/ language_dist_index_js_.indentNodeProp.add({
                IfStatement: /*@__PURE__*/ (0,
                language_dist_index_js_.continuedIndent)({
                ...
                'Block EnumBody DeclarationList': /*@__PURE__*/ (0,
                language_dist_index_js_.delimitedIndent)({ closing: '}' }),
              ...
              /*@__PURE__*/ language_dist_index_js_.foldNodeProp.add({
                'Block EnumBody DeclarationList SwitchBody ArrayExpression ValueList':
                  language_dist_index_js_.foldInside,
                ColonBlock(tree) {
...
*/
      function php(config = {}) {
        ...
        if (config.baseLanguage === null);
          ...
          let htmlSupport = (0, lang_html_dist.html)({
            matchClosingTags: false
          });
          support.push(htmlSupport.support);
          base = htmlSupport.language;
        }
        return new language_dist_index_js_.LanguageSupport(
          phpLanguage.configure({
            wrap:
              base &&
              (0, dist_index_js_.parseMixed)((node) => {
...
//# sourceMappingURL=5942.f4de7a90c29b22ccf30e.js.map?v=f4de7a90c29b22ccf30e
