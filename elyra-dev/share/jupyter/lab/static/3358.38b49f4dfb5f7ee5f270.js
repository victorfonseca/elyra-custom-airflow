...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [3358],
  {
    /***/ 33358: /***/ (
      ...
      var src = __webpack_require__(24982); // CONCATENATED MODULE: ./node_modules/d3-sankey/node_modules/d3-array/src/min.js
      ...
      /* harmony default export */ const src_path = path; // CONCATENATED MODULE: ./node_modules/d3-sankey/node_modules/d3-shape/src/array.js

      var slice = Array.prototype.slice; // CONCATENATED MODULE: ./node_modules/d3-sankey/node_modules/d3-shape/src/constant.js
      ...
      function link_link(curve) {
        ...
        link.x = function (_) {
          return arguments.length
            ? ((x = typeof _ === 'function' ? _ : src_constant(+_)), link)
            : x;
        };

        link.y = function (_) {
          return arguments.length
            ? ((y = typeof _ === 'function' ? _ : src_constant(+_)), link)
            : y;
        };
      ...
      var parser = (function () {
        var o = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(function (
            k,
            v,
            o2,
            l
          ...
          $V2 = [1, 5, 10, 12];
        var parser2 = {
          trace: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
            function trace() {},
            'trace'
          ),
          yy: {},
          ...
          performAction: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
          ...
          parseError: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
        ...
        var lexer = /* @__PURE__ */ (function () {
          var lexer2 = {
            ...
            setInput: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
              function (input, yy) {
                this.yy = yy || this.yy || {};
                this._input = input;
            ...
            input: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
              function () {
            ...
            unput: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
              function (ch) {
                var len = ch.length;
                var lines = ch.split(/(?:\r\n?|\n)/g);
            ...
            more: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
              function () {
                this._more = true;
                return this;
              },
            ...
            reject: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
              function () {
            ...
            less: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(function (
              n
            ) {
              this.unput(this.match.slice(n));
            }, 'less'),
            // displays already matched input, i.e. for error messages
            pastInput: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
              function () {
            ...
            upcomingInput: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
              function () {
                var next = this.match;
                if (next.length < 20) {
            ...
            showPosition: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
              function () {
            ...
            test_match: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
            ...
            next: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
              function () {
                if (this.done) {
                  return this.EOF;
                }
            ...
            lex: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
              function lex() {
                var r = this.next();
                if (r) {
                  return r;
            ...
            begin: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
            ...
            popState: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
              function popState() {
            ...
            _currentRules: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
            ...
            topState: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
              function topState(n) {
            ...
            pushState: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
            ...
            stateStackSize: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
      ...
      var addLink = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
        (source, target, value) => {
      ...
      chunk_YTJNT7DU /* __name */.K2)((ID) => {
        ID = chunk_YTJNT7DU /* common_default */.Y2.sanitizeText(
          ID,
      ...
      var getNodes = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
        () => nodes,
        'getNodes'
      );
      var getLinks = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
        () => links,
        'getLinks'
      );
      ...
      var sankeyDB_default = {
        nodesMap,
        getConfig: /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
          () => (0, chunk_YTJNT7DU /* getConfig2 */.D7)().sankey,
          'getConfig'
        ),
        getNodes,
        getLinks,
      ...
      var draw = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(function (
        text,
        id,
        _version,
        diagObj
        ...
        chunk_YTJNT7DU /* getConfig2 */.D7)();
        const defaultSankeyConfig =
          chunk_YTJNT7DU /* defaultConfig2 */.ME.sankey;
        let sandboxElement;
        ...
        const root =
          securityLevel === 'sandbox'
            ...
            : (0, src /* select */.Ltv)('body');
        const svg =
          securityLevel === 'sandbox'
            ? root.select(`[id="${id}"]`)
            : (0, src /* select */.Ltv)(`[id="${id}"]`);
        const width = conf?.width ?? defaultSankeyConfig.width;
        const height = conf?.height ?? defaultSankeyConfig.width;
        const useMaxWidth =
          conf?.useMaxWidth ?? defaultSankeyConfig.useMaxWidth;
        const nodeAlignment =
          conf?.nodeAlignment ?? defaultSankeyConfig.nodeAlignment;
        ...
        sankey(graph);
        const colorScheme = (0, src /* scaleOrdinal */.UMr)(
          src /* schemeTableau10 */.zt
        );
        svg
          .append('g')
          .attr('class', 'nodes')
        ...
        const getText = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
          ({ id: id2, value }) => {
            if (!showValues) {
              return id2;
            }
...
${prefix}${Math.round(value * 100) / 100}${suffix}`;
        ...
        switch (linkColor) {
          case 'gradient':
            coloring = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
              (d) => d.uid,
              'coloring'
            );
            break;
          case 'source':
            coloring = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
              (d) => colorScheme(d.source.id),
              'coloring'
            );
            break;
          case 'target':
            coloring = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
              (d) => colorScheme(d.target.id),
              'coloring'
            );
            break;
          default:
        ...
        (0, chunk_YTJNT7DU /* setupGraphViewbox */.ot)(
          void 0,
          svg,
          0,
          useMaxWidth
      ...
      var getStyles = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
        (options) => `.label {
      ...
      sankey_default.parse = (text) =>
        originalParse(prepareTextForParsing(text));
      var diagram = {
...
//# sourceMappingURL=3358.38b49f4dfb5f7ee5f270.js.map?v=38b49f4dfb5f7ee5f270
