...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [8779],
  {
    88779: (O, Q, P) => {
      P.r(Q);
      P.d(Q, { java: () => t, javaLanguage: () => X });
      var $ = P(27421);
      var a = P(45145);
      const i = (0, a.styleTags)({
        null: a.tags.null,
        instanceof: a.tags.operatorKeyword,
        this: a.tags.self,
        'new super assert open to with void': a.tags.keyword,
        'class interface extends implements enum var': a.tags.definitionKeyword,
        'module package import': a.tags.moduleKeyword,
        'switch while for if else case default do break continue return try catch finally throw':
          a.tags.controlKeyword,
        ...
        'strictfp synchronized native transient volatile throws']:
          a.tags.modifier,
        IntegerLiteral: a.tags.integer,
        FloatingPointLiteral: a.tags.float,
        'StringLiteral TextBlock': a.tags.string,
        CharacterLiteral: a.tags.character,
        LineComment: a.tags.lineComment,
        BlockComment: a.tags.blockComment,
        BooleanLiteral: a.tags.bool,
        PrimitiveType: a.tags.standard(a.tags.typeName),
        TypeName: a.tags.typeName,
        Identifier: a.tags.variableName,
        'MethodName/Identifier': a.tags.function(a.tags.variableName),
        Definition: a.tags.definition(a.tags.variableName),
        ArithOp: a.tags.arithmeticOperator,
        LogicOp: a.tags.logicOperator,
        BitOp: a.tags.bitwiseOperator,
        CompareOp: a.tags.compareOperator,
        AssignOp: a.tags.definitionOperator,
        UpdateOp: a.tags.updateOperator,
        Asterisk: a.tags.punctuation,
        Label: a.tags.labelName,
        '( )': a.tags.paren,
        '[ ]': a.tags.squareBracket,
        '{ }': a.tags.brace,
        '.': a.tags.derefOperator,
        ', ;': a.tags.separator
      });
      const r = {
        __proto__: null,
      ...
      const e = $.U1.deserialize({
        ...
        specialized: [{ term: 229, get: (O) => r[O] || -1 }],
        tokenPrec: 7067
      });
      var s = P(4452);
      const X = s.LRLanguage.define({
        ...
        parser: e.configure({
          props: [
            s.indentNodeProp.add({
              IfStatement: (0, s.continuedIndent)({ except: /^\s*({|else\b)/ }),
              TryStatement: (0, s.continuedIndent)({
                except: /^\s*({|catch|finally)\b/
              }),
              LabeledStatement: s.flatIndent,
              SwitchBlock: (O) => {
                let Q = O.textAfter,
                  P = /^\s*\}/.test(Q),
                  $ = /^\s*(case|default)\b/.test(Q);
                return O.baseIndent + (P ? 0 : $ ? 1 : 2) * O.unit;
              },
              Block: (0, s.delimitedIndent)({ closing: '}' }),
              BlockComment: () => null,
              Statement: (0, s.continuedIndent)({ except: /^{/ })
            }),
            s.foldNodeProp.add({
              ['Block SwitchBlock ClassBody ElementValueArrayInitializer ModuleBody EnumBody ' +
              'ConstructorBody InterfaceBody ArrayInitializer']: s.foldInside,
              BlockComment(O) {
      ...
      function t() {
        return new s.LanguageSupport(X);
      }
    }
  }
]);
