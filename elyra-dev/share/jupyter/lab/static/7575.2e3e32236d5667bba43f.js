  ...
  [7575],
  {
    47575: (e, t, r) => {
      ...
      function n(e, t, r) {
        ...
        return new RegExp('^' + r + '((' + e.join(')|(') + '))' + t);
      }
      var a = '\\\\[0-7]{1,3}';
      var i = '\\\\x[A-Fa-f0-9]{1,2}';
      var u = '\\\\[abefnrtv0%?\'"\\\\]';
      var s =
        '([^\\u0027\\u005C\\uD800-\\uDFFF]|[\\uD800-\\uDFFF][\\uDC00-\\uDFFF])';
      var o = [
      ...
      var h = ['end', 'else', 'elseif', 'catch', 'finally'];
      var d = [
        'if',
        'else',
        'elseif',
      ...
      var v = ['true', 'false', 'nothing', 'NaN', 'Inf'];
      var F = n(p);
      var k = n(h);
      var b = n(d);
      var g = n(v);
      ...
      function T(e, t) {
        ...
        if (e.match(x)) {
          t.tokenize = B(e.current());
          return t.tokenize(e, t);
        }
        if (e.match(y) || e.match(A)) {
          return 'meta';
        }
        if (e.match(c)) {
          return null;
      ...
      function P(e, t) {
        ...
        if (e.match('=#')) {
          t.nestedComments--;
          if (t.nestedComments == 0) t.tokenize = T;
        }
        return 'comment';
      }
      function j(e, t) {
      ...
      const $ = {
        ...
        indent: function (e, t, r) {
          ...
          return (e.scopes.length + n) * r.unit;
        },
        languageData: {
          indentOnInput: /^\s*(end|else|catch|finally)\b$/,
          commentTokens: { line: '#', block: { open: '#=', close: '=#' } },
          closeBrackets: { brackets: ['(', '[', '{', '"'] },
          autocomplete: d.concat(v)
        }
      };
    }
  }
