...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [4311],
  {
    /***/ 4311: /***/ (
      ...
      var defaultThemeVariables = (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .getThemeVariables */.P$)();
      var QuadrantBuilder = class {
        ...
        getDefaultConfig() {
          return {
            ...
            showTitle: true,
            chartHeight:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.chartWidth || 500,
            chartWidth:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.chartHeight || 500,
            titlePadding:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.titlePadding || 10,
            titleFontSize:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.titleFontSize || 20,
            quadrantPadding:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.quadrantPadding || 5,
            xAxisLabelPadding:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.xAxisLabelPadding || 5,
            yAxisLabelPadding:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.yAxisLabelPadding || 5,
            xAxisLabelFontSize:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.xAxisLabelFontSize || 16,
            yAxisLabelFontSize:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.yAxisLabelFontSize || 16,
            quadrantLabelFontSize:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.quadrantLabelFontSize || 16,
            quadrantTextTopPadding:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.quadrantTextTopPadding || 5,
            pointTextPadding:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.pointTextPadding || 5,
            pointLabelFontSize:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.pointLabelFontSize || 12,
            pointRadius:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.pointRadius || 5,
            xAxisPosition:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.xAxisPosition || 'top',
            yAxisPosition:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.yAxisPosition || 'left',
            quadrantInternalBorderStrokeWidth:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
            quadrantExternalBorderStrokeWidth:
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .defaultConfig_default */
                .UI.quadrantChart?.quadrantExternalBorderStrokeWidth || 2
          };
        }
        ...
        clear() {
          ...
          this.data = this.getDefaultData();
          this.classes = /* @__PURE__ */ new Map();
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .log */.Rm.info(
            'clear called'
          );
        }
        setData(data) {
        ...
        setConfig(config2) {
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .log */.Rm.trace(
        ...
        calculateSpace(xAxisPosition, showXAxis, showYAxis, showTitle) {
          ...
          const xAxisSpace = {
            top:
              xAxisPosition === 'top' && showXAxis ? xAxisSpaceCalculation : 0,
            bottom:
              xAxisPosition === 'bottom' && showXAxis
                ? xAxisSpaceCalculation
                : 0
          };
        ...
        getQuadrantPoints(spaceData) {
          ...
          const { quadrantHeight, quadrantLeft, quadrantTop, quadrantWidth } =
            quadrantSpace;
          const xAxis = (0,
          d3__WEBPACK_IMPORTED_MODULE_1__ /* .scaleLinear */.m4Y)()
            .domain([0, 1])
          ...
          const points = this.data.points.map((point) => {
            ...
            const props = {
              ...
              strokeColor:
                point.strokeColor ?? this.themeConfig.quadrantPointFill,
      ...
      var config = (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .getConfig2 */.D7)();
      function textSanitizer(text) {
        return (0,
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .sanitizeText */.jZ)(
          text.trim(),
          config
        );
      }
      ...
      function getQuadrantData() {
        ...
        quadrantBuilder.setData({
          titleText: (0,
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .getDiagramTitle */.ab)()
        });
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__name */.K2)(
        function () {
          ...
          (0,
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .clear */.IU)();
        },
        'clear'
      );
      var quadrantDb_default = {
        ...
        clear: clear2,
        setAccTitle:
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .setAccTitle */.SV,
        getAccTitle:
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .getAccTitle */.iN,
        setDiagramTitle:
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .setDiagramTitle */.ke,
        getDiagramTitle:
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .getDiagramTitle */.ab,
        getAccDescription:
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .getAccDescription */.m7,
        setAccDescription:
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .setAccDescription */.EI
      };
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__name */.K2)(
        (txt, id, _version, diagObj) => {
          ...
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .configureSvgSize */.a$)(
            ...
            height,
            width,
            conf.quadrantChart?.useMaxWidth ?? true
          );
          ...
          if (quadrantData.title) {
            titleGroup
              ...
              .attr(
                'text-anchor',
                getTextAnchor(quadrantData.title.verticalPos)
              )
...
//# sourceMappingURL=4311.f6565221a0c2c80382aa.js.map?v=f6565221a0c2c80382aa
