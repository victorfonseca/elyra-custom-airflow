...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [4982],
  {
    /***/ 4982: /***/ (
      ...
      /* harmony import */ var _chunk_HRU6DDCH_mjs__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(20778);
      /* harmony import */ var _chunk_K557N5IZ_mjs__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(57590);
      /* harmony import */ var _chunk_H2D2JQ3I_mjs__WEBPACK_IMPORTED_MODULE_3__ =
        __webpack_require__(68232);
      /* harmony import */ var _chunk_C3MQ5ANM_mjs__WEBPACK_IMPORTED_MODULE_4__ =
        __webpack_require__(76261);
      /* harmony import */ var _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_5__ =
        __webpack_require__(96049);
      /* harmony import */ var _chunk_7B677QYD_mjs__WEBPACK_IMPORTED_MODULE_6__ =
        __webpack_require__(93113);
      /* harmony import */ var _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ =
      ...
      /* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_10__ =
        __webpack_require__(48750);

      // src/diagrams/kanban/parser/kanban.jison
      var parser = (function () {
        var o = /* @__PURE__ */ (0,
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ /* .__name */.K2)(
            function (k, v, o2, l) {
        ...
        (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ /* .__name */.K2)(
          Parser,
          'Parser'
        );
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ /* .__name */.K2)(
        function () {
          ...
          const conf = (0,
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ /* .getConfig2 */.D7)();
          for (const section of sections2) {
            const node = {
              id: section.id,
              label: (0,
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ /* .sanitizeText */.jZ)(
                section.label ?? '',
                conf
              ),
              isGroup: true,
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ /* .__name */.K2)(
        (level, id, descr, type, shapeData) => {
          const conf = (0,
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ /* .getConfig2 */.D7)();
          let padding =
            conf.mindmap?.padding ??
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ /* .defaultConfig_default */
              .UI.mindmap.padding;
          switch (type) {
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ /* .__name */.K2)(
        (startStr, endStr) => {
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ /* .log */.Rm.debug(
            'In get type',
            startStr,
            endStr
          );
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ /* .__name */.K2)(
        () => _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ /* .log */.Rm,
        'getLogger'
      );
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ /* .__name */.K2)(
        async (text, id, _version, diagObj) => {
          ...
          const svg = (0,
          _chunk_7B677QYD_mjs__WEBPACK_IMPORTED_MODULE_6__ /* .selectSvgElement */.D)(
            id
          );
          ...
          for (const section of sections2) {
            ...
            const sectionObj = await (0,
            _chunk_HRU6DDCH_mjs__WEBPACK_IMPORTED_MODULE_1__ /* .insertCluster */.U)(
              sectionsElem,
              section
            );
            maxLabelHeight = Math.max(
              maxLabelHeight,
              sectionObj?.labelBBox?.height
            );
          ...
          for (const section of sections2) {
            ...
            for (const item of sectionItems) {
              ...
              const nodeEl = await (0,
              _chunk_HRU6DDCH_mjs__WEBPACK_IMPORTED_MODULE_1__ /* .insertNode */.on)(
                nodesElem,
                item,
                { config: conf }
              );
              ...
              await (0,
              _chunk_HRU6DDCH_mjs__WEBPACK_IMPORTED_MODULE_1__ /* .positionNode */.U_)(
                item
              );
            ...
            const height =
              Math.max(y - top + 3 * padding, 50) + (maxLabelHeight - 25);
            rect.attr('height', height);
          }
          (0,
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ /* .setupGraphViewbox */.ot)(
            void 0,
            svg,
            conf.mindmap?.padding ??
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ /* .defaultConfig_default */
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ /* .__name */.K2)(
        (options) => {
          ...
          for (let i = 0; i < options.THEME_COLOR_LIMIT; i++) {
            ...
            if (
              (0, khroma__WEBPACK_IMPORTED_MODULE_8__ /* ["default"] */.A)(
                options['lineColor' + i]
              )
            ) {
              ...
              options['lineColor' + i] = (0,
              khroma__WEBPACK_IMPORTED_MODULE_10__ /* ["default"] */.A)(
                options['lineColor' + i],
                20
              );
            }
          }
          const adjuster = /* @__PURE__ */ (0,
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_7__ /* .__name */.K2)(
            (color, level) =>
              options.darkMode
                ? (0, khroma__WEBPACK_IMPORTED_MODULE_10__ /* ["default"] */.A)(
                    color,
                    level
                  )
                : (0, khroma__WEBPACK_IMPORTED_MODULE_9__ /* ["default"] */.A)(
                    color,
                    level
                  ),
            'adjuster'
...
//# sourceMappingURL=4982.c373c4db1f1865f9f923.js.map?v=c373c4db1f1865f9f923
