  ...
  [9652, 5606],
  {
    ...
    61160: (e, t, r) => {
      ...
      function b(e, t, r) {
        ...
        e = a.rest;
        if (
          (a.protocol === 'file:' && (a.slashesCount !== 2 || u.test(e))) ||
          (!a.slashes && (a.protocol || a.slashesCount < 2 || !v(A.protocol)))
        ) {
          w[3] = [/(.*)/, 'pathname'];
        }
        for (; k < w.length; k++) {
        ...
        A.origin =
          A.protocol !== 'file:' && v(A.protocol) && A.host
            ? A.protocol + '//' + A.host
            : 'null';
        A.href = A.toString();
      }
      function y(e, t, r) {
        ...
        i.origin =
          i.protocol !== 'file:' && v(i.protocol) && i.host
            ? i.protocol + '//' + i.host
            : 'null';
        i.href = i.toString();
        return i;
