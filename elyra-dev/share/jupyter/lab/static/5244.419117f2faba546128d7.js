...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [5244, 4981],
  {
    /***/ 75244: /***/ function (
      ...
      var safe_js_1 = __webpack_require__(23466);
          ...
          (_a = (function (_super) {
            ...
            function class_1() {
              ...
              var _this =
                ...
                this;
              _this.safe = new _this.options.SafeClass(
                _this,
                _this.options.safeOptions
              );
              ...
              try {
                for (
                  var _b = __values(_this.inputJax), _c = _b.next();
                  !_c.done;
                  _c = _b.next()
                ) {
                  var jax = _c.value;
                  if (jax.name.match(/MathML/)) {
                    jax.mathml.filterAttribute = _this.safe.mmlAttribute.bind(
                      _this.safe
                    );
                    jax.mathml.filterClassList = _this.safe.mmlClassList.bind(
                      _this.safe
                    );
    ...
    /***/ 91894: /***/ function (
      ...
      exports.SafeMethods = {
        filterURL: function (safe, url) {
          var protocol = (url.match(/^\s*([a-z]+):/i) || [
            null,
            ''
          ])[1].toLowerCase();
          ...
          return allow === 'all' ||
            (allow === 'safe' &&
              (safe.options.safeProtocols[protocol] || !protocol))
            ? url
            : null;
        },
        ...
        filterStyles: function (safe, styles) {
          ...
          try {
            ...
            try {
              for (
                var _c = __values(Object.keys(options.safeStyles)),
                  _d = _c.next();
                !_d.done;
                _d = _c.next()
              ) {
                ...
                if (options.styleParts[style]) {
                  try {
                    for (
                      var _e =
                          ((e_2 = void 0),
                          __values(['Top', 'Right', 'Bottom', 'Left'])),
                        _f = _e.next();
                      !_f.done;
                      _f = _e.next()
                    ) {
        ...
        filterStyle: function (safe, style, div) {
          ...
          if (
            ...
            value === '' ||
            value.match(/^\s*calc/) ||
            (value.match(/javascript:/) &&
              !safe.options.safeProtocols.javascript) ||
          ...
          if (
            !safe.options.safeStyles[style] &&
            !safe.options.safeStyles[name]
          ) {
            return null;
          }
        ...
        filterStyleValue: function (safe, style, value, div) {
          ...
          var length = this.filterStyleLength(
            safe,
            name,
        ...
        filterSizeMultiplier: function (safe, size) {
          var _a = __read(
              safe.options.scriptsizemultiplierRange || [-Infinity, Infinity],
              2
            ),
            m = _a[0],
            M = _a[1];
        ...
        filterScriptLevel: function (safe, level) {
          var _a = __read(
              safe.options.scriptlevelRange || [-Infinity, Infinity],
              2
            ),
            m = _a[0],
            M = _a[1];
    ...
    /***/ 23466: /***/ function (
      ...
      var SafeMethods_js_1 = __webpack_require__(91894);
      var Safe = (function () {
...
//# sourceMappingURL=5244.419117f2faba546128d7.js.map?v=419117f2faba546128d7
