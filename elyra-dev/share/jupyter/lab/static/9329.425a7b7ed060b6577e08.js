...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [9329],
  {
    /***/ 9329: /***/ (
      ...
      var index_js_ = __webpack_require__(45145); // CONCATENATED MODULE: ./node_modules/@lezer/python/dist/index.js
      ...
      const newlines = new dist /* ExternalTokenizer */.Lu(
        (input, stack) => {
          let prev;
          if (input.next < 0) {
      ...
      const indentation = new dist /* ExternalTokenizer */.Lu(
        (input, stack) => {
      ...
      const trackIndent = new dist /* ContextTracker */.Aj({
        ...
        reduce(context, term, _, input) {
          if (
            ...
            ((term == String$1 || term == FormatString) &&
      ...
      const pythonHighlighting = (0, index_js_.styleTags)({
        ...
        'CallExpression/VariableName': index_js_.tags.function(
          index_js_.tags.variableName
        ),
        'FunctionDefinition/VariableName': index_js_.tags.function(
          index_js_.tags.definition(index_js_.tags.variableName)
        ),
        'ClassDefinition/VariableName': index_js_.tags.definition(
      ...
      const parser = dist /* LRParser */.U1.deserialize({
        ...
        topRules: { Script: [0, 5] },
        specialized: [
          { term: 221, get: (value) => spec_identifier[value] || -1 }
        ],
        tokenPrec: 7652
      });
      ...
      var autocomplete_dist = __webpack_require__(75128); // CONCATENATED MODULE: ./node_modules/@codemirror/lang-python/dist/index.js
        ...
        ImportStatement(_node, def) {
          ...
          for (let ch = node.getChild('import'); ch; ch = ch.nextSibling) {
            if (
              ...
              ((_b = ch.nextSibling) === null || _b === void 0
                ? void 0
                : _b.name) != 'as'
            )
...
*/
      const globalCompletion = /*@__PURE__*/ (0,
      autocomplete_dist /* ifNotIn */.Ar)(
        dontComplete,
        /*@__PURE__*/ (0, autocomplete_dist /* completeFromList */.et)(
          /*@__PURE__*/ globals.concat(snippets)
        )
      );
          ...
          props: [
            /*@__PURE__*/ dist_index_js_.indentNodeProp.add({
              Body: (context) => {
                ...
                return (_a = indentBody(context, inner || context.node)) !==
                  null && _a !== void 0
                  ? _a
                  : context.continue();
              },
              ...
              'TupleExpression ComprehensionExpression ParamList ArgList ParenthesizedExpression':
                /*@__PURE__*/ (0, dist_index_js_.delimitedIndent)({
                  closing: ')'
                }),
              ...
              'ArrayExpression ArrayComprehensionExpression': /*@__PURE__*/ (0,
              dist_index_js_.delimitedIndent)({ closing: ']' }),
