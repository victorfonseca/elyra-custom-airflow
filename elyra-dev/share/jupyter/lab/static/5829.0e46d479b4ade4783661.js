(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [5829, 5338, 2957, 100],
  {
    67097: (e, t, r) => {
      ...
      var S = r(63560);
      var x = r.n(S);
      let v = (e) => crypto.getRandomValues(new Uint8Array(e));
      let b = (e, t, r) => {
      ...
      class O extends s.Component {
        constructor(e) {
          ...
          this.onCopyIndexClick = (e) => (t) => {
            ...
            this.setState(
              { keyedFormData: o, updatedKeyedFormData: true },
              () => r(T(o), i)
            );
          };
          this.onDropIndexClick = (e) => (t) => {
            ...
            this.setState(
              { keyedFormData: a, updatedKeyedFormData: true },
              () => r(T(a), i)
            );
          };
          this.onReorderClick = (e, t) => (r) => {
            ...
            const l = o();
            this.setState({ keyedFormData: l }, () => n(T(l), i));
          };
        ...
        get itemTitle() {
          ...
          return o()(
            ...
            o()(
              e,
              [i.ITEMS_KEY, 'description'],
              r(i.TranslatableString.ArrayItemTitle)
            )
          );
        }
        isItemRequired(e) {
        ...
        _handleAddClick(e, t) {
          ...
          this.setState({ keyedFormData: o, updatedKeyedFormData: true }, () =>
            r(T(o), i)
          );
        }
        render() {
          ...
          if (!(i.ITEMS_KEY in e)) {
            ...
            return (0, n.jsx)(l, {
              schema: e,
              idSchema: r,
              reason: o(i.TranslatableString.MissingItems),
              registry: s
            });
          }
        ...
        renderNormalArray() {
          ...
          const { keyedFormData: S } = this.state;
          const x = e.title === undefined ? a : e.title;
          const { schemaUtils: v, formContext: b } = u;
          const C = (0, i.getUiOptions)(t);
          const k = y()(e.items) ? e.items : {};
          const F = v.retrieveSchema(k);
          const j = T(this.state.keyedFormData);
          const O = this.canAddItem(j);
          const w = {
            canAdd: O,
            items: S.map((e, n) => {
              const { key: i, item: o } = e;
              const l = o;
              const d = v.retrieveSchema(k, l);
              const u = r ? r[n] : undefined;
              const y = s.$id + f + n;
              const x = v.toIdSchema(d, y, l, p, f);
          ...
          const D = (0, i.getTemplate)('ArrayFieldTemplate', u, C);
          return (0, n.jsx)(D, { ...w });
        }
        renderCustomWidget() {
          var e;
          ...
          const { widget: C, title: k, ...F } = (0, i.getUiOptions)(s, v);
          const j = (0, i.getWidget)(t, C, S);
          const T =
            (e = k !== null && k !== void 0 ? k : t.title) !== null &&
            e !== void 0
              ? e
              : y;
          const O = b.getDisplayLabel(t, s, v);
          return (0, n.jsx)(j, {
            id: r.$id,
            name: y,
            multiple: true,
        ...
        renderMultiSelect() {
          ...
          const {
            ...
            title: F,
            ...j
          } = (0, i.getUiOptions)(s, v);
          const T = (0, i.getWidget)(t, k, y);
          const O =
            (e = F !== null && F !== void 0 ? F : t.title) !== null &&
            e !== void 0
              ? e
              : g;
          const w = S.getDisplayLabel(t, s, v);
          return (0, n.jsx)(T, {
            id: r.$id,
            name: g,
            multiple: true,
        ...
        renderFiles() {
          ...
          const {
            ...
            title: b,
            ...C
          } = (0, i.getUiOptions)(r, S);
          const k = (0, i.getWidget)(t, v, g);
          const F =
            (e = b !== null && b !== void 0 ? b : t.title) !== null &&
            e !== void 0
              ? e
              : a;
          const j = x.getDisplayLabel(t, r, S);
          return (0, n.jsx)(k, {
            options: C,
            id: s.$id,
            name: a,
        ...
        renderFixedArray() {
          ...
          const { keyedFormData: x } = this.state;
          let { formData: v = [] } = this.props;
          const b = e.title || c;
          const C = (0, i.getUiOptions)(t);
          const { schemaUtils: k, formContext: F } = p;
          const j = y()(e.items) ? e.items : [];
          const T = j.map((e, t) => k.retrieveSchema(e, r[t]));
          const O = y()(e.additionalItems)
            ? k.retrieveSchema(e.additionalItems, r)
            : null;
          if (!v || v.length < T.length) {
            v = v || [];
            v = v.concat(new Array(T.length - v.length));
          }
          const w = this.canAddItem(v) && !!O;
          const D = {
            canAdd: w,
            ...
            items: x.map((r, n) => {
              ...
              const m = n >= T.length;
              const p =
                (m && y()(e.additionalItems)
                  ? k.retrieveSchema(e.additionalItems, u)
                  : T[n]) || {};
              const b = l.$id + o + n;
              ...
              return this.renderArrayFieldItem({
                ...
                canAdd: w,
                canRemove: m,
                canMoveUp: n >= T.length + 1,
                canMoveDown: m && n < v.length - 1,
                itemSchema: p,
                itemData: u,
                itemUiSchema: F,
                itemIdSchema: C,
          ...
          const E = (0, i.getTemplate)('ArrayFieldTemplate', p, C);
          return (0, n.jsx)(E, { ...D });
        }
        renderArrayFieldItem(e) {
          ...
          const {
            fields: { ArraySchemaField: w, SchemaField: D },
            globalUiOptions: E
          } = T;
          const I = w || D;
          const {
          ...
          U.toolbar = Object.keys(U).some((e) => U[e]);
          return {
            children: (0, n.jsx)(I, {
              name: s,
              index: r,
            ...
            canAdd: a,
            hasCopy: U.copy,
            hasToolbar: U.toolbar,
            hasMoveUp: U.moveUp,
            hasMoveDown: U.moveDown,
            hasRemove: U.remove,
            index: r,
            totalItems: x,
            key: t,
      ...
      function D(e) {
        ...
        const {
          ...
          label: w = true,
          ...D
        } = (0, i.getUiOptions)(o, j);
        const E = (0, i.getWidget)(s, T, C);
        const I = F(i.TranslatableString.YesLabel);
        const A = F(i.TranslatableString.NoLabel);
        let _;
        const N =
          (t = O !== null && O !== void 0 ? O : b) !== null && t !== void 0
            ? t
            : a;
        if (Array.isArray(s.oneOf)) {
          _ = (0, i.optionsList)({
            oneOf: s.oneOf
              .map((e) => {
                if (y()(e)) {
                  return { ...e, title: e.title || (e.const === true ? I : A) };
                }
                return undefined;
              })
              .filter((e) => e)
          ...
          if (
            !e.enumNames &&
            t.length === 2 &&
            t.every((e) => typeof e === 'boolean')
          ) {
            _ = [
              { value: t[0], label: t[0] ? I : A },
              { value: t[1], label: t[1] ? I : A }
            ];
          } else {
            _ = (0, i.optionsList)({ enum: t, enumNames: e.enumNames });
          }
        }
        return (0, n.jsx)(E, {
          options: { ...D, enumOptions: _ },
          schema: s,
          uiSchema: o,
          id: l.$id,
          name: a,
      ...
      class _ extends s.Component {
        constructor(e) {
          ...
          this.state = {
            retrievedOptions: s,
            selectedOption: this.getMatchingOption(0, t, s)
          };
        }
        ...
        render() {
          ...
          const { selectedOption: x, retrievedOptions: v } = this.state;
          const {
            widget: b = 'select',
            placeholder: C,
            autofocus: k,
            ...
            title: j = u.title,
            ...T
          } = (0, i.getUiOptions)(h, g);
          const O = (0, i.getWidget)({ type: 'number' }, b, m);
          const w = o()(r, i.ERRORS_KEY, []);
          const D = A()(r, [i.ERRORS_KEY]);
          const E = y.getDisplayLabel(u, h, g);
          const I = x >= 0 ? v[x] || null : null;
          let _;
          if (I) {
            const { required: e } = u;
            _ = e ? (0, i.mergeSchemas)({ required: e }, I) : I;
          }
          const N = j
            ? i.TranslatableString.TitleOptionPrefix
            : i.TranslatableString.OptionPrefix;
          const U = j ? [j] : [];
          const B = v.map((e, t) => ({
            label: e.title || f(N, U.concat(String(t + 1))),
            value: t
          }));
          return (0, n.jsxs)('div', {
            ...
            children: [
              (0, n.jsx)('div', {
                ...
                children: (0, n.jsx)(O, {
                  ...
                  rawErrors: w,
                  errorSchema: D,
                  value: x >= 0 ? x : undefined,
                  options: { enumOptions: B, ...T },
                  registry: d,
                  formContext: s,
                  placeholder: C,
                  autocomplete: F,
              ...
              I !== null && (0, n.jsx)(S, { ...this.props, schema: _ })
            ]
          });
        }
      }
      ...
      function $(e) {
        ...
        const h = (0, s.useCallback)(
          (e) => {
            ...
            const t =
              typeof e === 'string' && e.match(U)
                ? (0, i.asNumber)(e.replace(B, ''))
                : (0, i.asNumber)(e);
            r(t);
          },
          [r]
      ...
      const V = [
        ...
        me = /&([a-z0-9]+|#[0-9]{1,6}|#x[0-9a-fA-F]{1,6});/gi,
        pe = /^<!--[\s\S]*?(?:-->)/,
        fe = /^(data|aria|x)-[a-z_][a-z\d_.-]*$/,
        ge =
          /^ *<([a-z][a-z0-9:]*)(?:\s+((?:<.*?>|[^>])*))?\/?>(?!<\/\1>)(\s*\n)?/i,
        ye = /^\{.*\}$/,
        Se = /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/,
        ...
        _e =
          '((?:\\[.*?\\][([].*?[)\\]]|<.*?>(?:.*?<.*?>)?|`.*?`|~~.*?~~|==.*?==|.|\\n)*?)',
        Ne = new RegExp(`^([*_])\\1${_e}\\1\\1(?!\\1)`),
        Ue = new RegExp(`^([*_])${_e}\\1(?!\\1|\\w)`),
        Be = new RegExp(`^==${_e}==`),
        $e = new RegExp(`^~~${_e}~~`),
        Re = /^\\([^0-9A-Za-z\s])/,
        Pe =
      ...
      function it(e, t) {
        ...
        return {
          match(e, t, r) {
            const s = Ke.exec(r);
            return s && (t.list || (!t.inline && !t.simple))
              ? n.exec((e = s[1] + e))
              : null;
          },
          order: 1,
          parse(e, t, n) {
            ...
            return {
              items: o.map(function (e, r) {
                ...
                (n.list = !0),
                  u
                    ? ((n.inline = !1), (p = c.replace(Ve, '\n\n')))
                    : ((n.inline = !0), (p = c.replace(Ve, '')));
                const f = t(p, n);
                return (n.inline = h), (n.list = m), f;
              }),
              ordered: r,
              start: a
            };
          ...
          render: (t, r, n) =>
            e(
              ...
              {
                key: n.key,
                start: t.type === L.orderedList ? t.start : void 0
              },
              t.items.map(function (t, s) {
      ...
      const at = new RegExp(
        ...
        ot = /^!\[(.*?)\]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/,
        lt = [G, X, ee, ce, ue, de, pe, Ce, et, nt, tt, st],
        ct = [...lt, /^[^\n]+(?:  \n|\n{2,})/, he, ge];
      function dt(e) {
        return e
      ...
      function ht(e, t, r, n) {
        ...
        let i = e
          ...
          .reduce(
            (e, s) => (
              '|' === s.trim()
                ? e.push(
                    n ? { type: L.tableSeparator } : { type: L.text, text: s }
                  )
                : '' !== s && e.push.apply(e, t(s, r)),
              e
            ),
            []
          );
        ...
        return (
          i.forEach(function (e, t) {
            e.type === L.tableSeparator
              ? 0 !== t && t !== i.length - 1 && a.push([])
              : (e.type !== L.text ||
                  (null != i[t + 1] && i[t + 1].type !== L.tableSeparator) ||
      ...
      function mt(e, t, r) {
        r.inline = !0;
        const n = e[2] ? e[2].replace(De, '').split('|').map(ut) : [],
          s = e[3]
            ? (function (e, t, r) {
                return e
                  .trim()
            ...
            : [],
          i = ht(e[1], t, r, !!s.length);
        return (
          (r.inline = !1),
          s.length
            ? { align: n, cells: s, header: i, type: L.table }
            : { children: i, type: L.paragraph }
        );
      }
      function pt(e, t) {
      ...
      function Ct(e, t, r) {
        ...
        const i = e(t, r);
        return (r.inline = n), (r.simple = s), i;
      }
      function kt(e, t, r) {
        const n = r.inline || !1,
          s = r.simple || !1;
      ...
      const jt = (e, t, r) => ({ children: Ct(t, e[1], r) });
      function Tt() {
        return {};
      }
      function Ot() {
      ...
      function Et(e = '', t = {}) {
        function r(e, r, ...n) {
          const s = Dt(t.overrides, `${e}.props`, {});
          return t.createElement(
            ...
            P({}, r, s, {
              className:
                wt(null == r ? void 0 : r.className, s.className) || void 0
            }),
            ...n
          );
        }
        function n(e) {
          e = e.replace(oe, '');
          let n = !1;
          t.forceInline ? (n = !0) : t.forceBlock || (n = !1 === Oe.test(e));
          const i = d(
            c(n ? e : `${e.trimEnd().replace(qe, '')}\n\n`, { inline: n })
          );
          for (
            ;
          ...
          if (i.length > 1 || t.forceWrapper) o = i;
            ...
            if (1 === i.length)
              return (
                (o = i[0]),
                'string' == typeof o ? r('span', { key: 'outer' }, o) : o
              );
            o = null;
          }
            ...
            ? i.reduce(function (r, i, a) {
                ...
                if (-1 !== o) {
                  const l = (function (e) {
                    ...
                    d = V[l] || l,
                    u = (r[d] = (function (e, t, r, n) {
                      return 'style' === t
                        ? r.split(/;\s?/).reduce(function (e, t) {
                        ...
                        : 'href' === t || 'src' === t
                          ? n(r, e, t)
                          : (r.match(ye) && (r = r.slice(1, r.length - 1)),
                            'true' === r || ('false' !== r && r));
                    })(e, l, c, t.sanitizer));
                  'string' == typeof u &&
                    (he.test(u) || ge.test(u)) &&
                    (r[d] = s.cloneElement(n(u.trim()), { key: a }));
                } else 'style' !== i && (r[V[i] || i] = !0);
                return r;
              }, {})
            : null;
        }
        (t.overrides = t.overrides || {}),
          (t.sanitizer = t.sanitizer || vt),
          (t.slugify = t.slugify || dt),
          (t.namedCodesToUnicode = t.namedCodesToUnicode
            ? P({}, K, t.namedCodesToUnicode)
            : K),
          (t.createElement = t.createElement || s.createElement);
        const a = [],
          o = {},
          l = {
            [L.blockQuote]: {
              match: yt(G),
              order: 1,
              parse: (e, t, r) => ({ children: t(e[0].replace(J, ''), r) }),
              render: (e, t, n) =>
                r('blockquote', { key: n.key }, t(e.children, n))
            },
            [L.breakLine]: {
              match: St(Z),
              order: 1,
              parse: Tt,
              render: (e, t, n) => r('br', { key: n.key })
            },
            [L.breakThematic]: {
              match: yt(Q),
              order: 1,
              parse: Tt,
              render: (e, t, n) => r('hr', { key: n.key })
            },
            [L.codeBlock]: {
              match: yt(ee),
              order: 0,
            ...
            [L.codeInline]: {
              ...
              order: 3,
              parse: (e) => ({ text: e[2] }),
              render: (e, t, n) => r('code', { key: n.key }, e.text)
            },
            [L.footnote]: {
              match: yt(se),
              order: 0,
            ...
            [L.footnoteReference]: {
              match: ft(ie),
              order: 1,
              parse: (e) => ({ target: `#${t.slugify(e[1], dt)}`, text: e[1] }),
              render: (e, n, s) =>
                r(
                  'a',
                  { key: s.key, href: t.sanitizer(e.target, 'a', 'href') },
                  r('sup', { key: s.key }, e.text)
                )
            },
            [L.gfmTask]: {
              match: ft(le),
            ...
            [L.heading]: {
              match: yt(t.enforceAtxHeadings ? de : ce),
              order: 1,
              parse: (e, r, n) => ({
                children: Ct(r, e[2], n),
                id: t.slugify(e[2], dt),
              ...
              render: (e, t, n) =>
                r(`h${e.level}`, { id: e.id, key: n.key }, t(e.children, n))
            },
            [L.headingSetext]: {
              match: yt(ue),
              order: 0,
            ...
            [L.htmlBlock]: {
              ...
              order: 1,
              parse(e, t, r) {
                const [, n] = e[3].match(Le),
                  s = new RegExp(`^${n}`, 'gm'),
                  a = e[3].replace(s, ''),
                  o = ((l = a), ct.some((e) => e.test(l)) ? Ft : Ct);
                var l;
                const c = e[1].toLowerCase(),
                  d = -1 !== W.indexOf(c),
                  u = (d ? c : e[1]).trim(),
                  h = { attrs: i(u, e[2]), noInnerParse: d, tag: u };
                return (
                  (r.inAnchor = r.inAnchor || 'a' === c),
                  d ? (h.text = e[3]) : (h.children = o(t, a, r)),
                  (r.inAnchor = !1),
                  h
                );
              },
              render: (e, t, n) =>
                r(e.tag, P({ key: n.key }, e.attrs), e.text || t(e.children, n))
            },
            [L.htmlSelfClosing]: {
              match: St(ge),
              order: 1,
              ...
              render: (e, t, n) => r(e.tag, P({}, e.attrs, { key: n.key }))
            },
            [L.htmlComment]: {
              match: St(pe),
              order: 1,
            ...
            [L.image]: {
              match: gt(ot),
              order: 1,
              parse: (e) => ({ alt: e[1], target: bt(e[2]), title: e[3] }),
              render: (e, n, s) =>
                r('img', {
                  key: s.key,
                  alt: e.alt || void 0,
            ...
            [L.linkAngleBraceStyleDetector]: {
              ...
              order: 0,
              parse: (e) => ({
                children: [{ text: e[1], type: L.text }],
                target: e[1],
                type: L.link
              })
            },
            [L.linkBareUrlDetector]: {
              match: (e, t) => (t.inAnchor ? null : ft(Se)(e, t)),
              order: 0,
              parse: (e) => ({
                children: [{ text: e[1], type: L.text }],
                target: e[1],
            ...
            [L.linkMailtoDetector]: {
              ...
              parse(e) {
                ...
                return (
                  ...
                  {
                    children: [
                      { text: t.replace('mailto:', ''), type: L.text }
                    ],
                    target: r,
                    type: L.link
                  }
            ...
            [L.orderedList]: it(r, 1),
            [L.unorderedList]: it(r, 2),
            [L.newlineCoalescer]: {
              match: yt(re),
              order: 3,
              parse: Tt,
            ...
            [L.paragraph]: {
              ...
              order: 3,
              parse: jt,
              render: (e, t, n) => r('p', { key: n.key }, t(e.children, n))
            },
            [L.ref]: {
              match: ft(ke),
              order: 0,
            ...
            [L.refLink]: {
              ...
              parse: (e, t, r) => ({
                children: t(e[1], r),
                fallbackChildren: t(e[0].replace(Te, '\\$1'), r),
                ref: e[2]
              }),
              render: (e, n, s) =>
                o[e.ref]
                  ...
                  : r('span', { key: s.key }, n(e.fallbackChildren, s))
            },
            [L.table]: {
              match: yt(Ce),
              order: 1,
                ...
                return r(
                  ...
                  r(
                    ...
                    r(
                      'tr',
                      null,
                      s.header.map(function (e, i) {
                        return r('th', { key: i, style: pt(s, i) }, t(e, n));
                      })
                    )
                  ),
                  r(
                    'tbody',
                    null,
                    s.cells.map(function (e, i) {
                      return r(
                        'tr',
                        { key: i },
                        e.map(function (e, i) {
                          return r('td', { key: i, style: pt(s, i) }, t(e, n));
                        })
                      );
                    })
                  )
            ...
            [L.textBolded]: {
              ...
              render: (e, t, n) => r('strong', { key: n.key }, t(e.children, n))
            },
            [L.textEmphasized]: {
              match: gt(Ue),
              order: 3,
              parse: (e, t, r) => ({ children: t(e[2], r) }),
              render: (e, t, n) => r('em', { key: n.key }, t(e.children, n))
            },
            [L.textEscaped]: {
              match: gt(Re),
              order: 1,
              parse: (e) => ({ text: e[1], type: L.text })
            },
            [L.textMarked]: {
              match: gt(Be),
              order: 3,
              parse: jt,
              render: (e, t, n) => r('mark', { key: n.key }, t(e.children, n))
            },
            [L.textStrikethroughed]: {
              match: gt($e),
              order: 3,
              parse: jt,
              render: (e, t, n) => r('del', { key: n.key }, t(e.children, n))
            }
          };
        !0 === t.disableParsingRawHTML &&
          (delete l[L.htmlBlock], delete l[L.htmlSelfClosing]);
        const c = (function (e) {
            let t = Object.keys(e);
            function r(n, s) {
              let i = [],
          ...
          d =
            ((u = (function (e, t) {
              return function (r, n, s) {
                const i = e[r.type].render;
                return t ? t(() => i(r, n, s), r, n, s) : i(r, n, s);
              };
            })(l, t.renderRule)),
            function e(t, r = {}) {
              if (Array.isArray(t)) {
                ...
                for (let a = 0; a < t.length; a++) {
                  ...
                  const n = e(t[a], r),
                    o = 'string' == typeof n;
                  o && i ? (s[s.length - 1] += n) : null !== n && s.push(n),
                    (i = o);
                }
                return (r.key = n), s;
              }
          ...
          ? r(
              ...
              r(
                ...
                a.map(function (e) {
                  return r(
                    'div',
                    { id: t.slugify(e.identifier, dt), key: e.identifier },
                    e.identifier,
                    d(c(e.footnote, { inline: !0 }))
                  );
                })
              )
            )
      ...
      const It = (e) => {
        ...
        return s.cloneElement(Et(t, r), n);
      };
      var At = r(61448);
      var _t = r.n(At);
      var Nt = r(73357);
      ...
      class Bt extends s.Component {
        constructor() {
          ...
          this.getAvailableKey = (e, t) => {
            ...
            const { duplicateKeySuffixSeparator: s = '-' } = (0,
            i.getUiOptions)(r, n.globalUiOptions);
            let a = 0;
            let o = e;
            while (_t()(t, o)) {
              o = `${e}${s}${++a}`;
        ...
        render() {
          ...
          const { SchemaField: T } = b;
          const O = k.retrieveSchema(s, l);
          const w = (0, i.getUiOptions)(a, j);
          const { properties: D = {} } = O;
          const E =
            (t = (e = w.title) !== null && e !== void 0 ? e : O.title) !==
              null && t !== void 0
              ? t
              : u;
          const I =
            (r = w.description) !== null && r !== void 0 ? r : O.description;
          let A;
          try {
            const e = Object.keys(D);
            A = (0, i.orderProperties)(e, w.order);
          } catch (U) {
            return (0, n.jsxs)('div', {
              children: [
                (0, n.jsx)('p', {
                  ...
                  style: { color: 'red' },
                  children: (0, n.jsx)(It, {
                    children: F(i.TranslatableString.InvalidObjectField, [
                      u || 'root',
                      U.message
                    ])
                  })
                }),
                (0, n.jsx)('pre', { children: JSON.stringify(O) })
              ]
            });
          }
          const _ = (0, i.getTemplate)('ObjectFieldTemplate', v, w);
          const N = {
            title: w.label === false ? '' : E,
            description: w.label === false ? undefined : I,
            properties: A.map((e) => {
              const t = _t()(O, [
                i.PROPERTIES_KEY,
                e,
                i.ADDITIONAL_PROPERTY_FLAG
              ]);
          ...
          return (0, n.jsx)(_, { ...N, onAddClick: this.handleAddClick });
        }
      }
      const $t = Bt;
      const Rt = {
        ...
        return h in o
          ...
          : () => {
              ...
              return (0, n.jsx)(a, {
                schema: e,
                idSchema: r,
                reason: l(i.TranslatableString.UnknownFieldType, [
                  String(e.type)
                ]),
                registry: s
              });
      ...
      function qt(e) {
        ...
        const { formContext: x, schemaUtils: v, globalUiOptions: b } = g;
        ...
        const T = (0, i.getTemplate)('FieldErrorTemplate', g, C);
        const O = v.retrieveSchema(t, o);
        const w = r[i.ID_KEY];
        const D = (0, i.mergeObjects)(v.toIdSchema(O, w, o, c, d), r);
        ...
        const I = Pt(O, C, D, g);
        const _ = Boolean(e.disabled || C.disabled);
        const N = Boolean(
          e.readonly || C.readonly || e.schema.readOnly || O.readOnly
        );
        const U = C.hideError;
        const B = U === undefined ? e.hideError : Boolean(U);
        const $ = Boolean(e.autofocus || C.autofocus);
        if (Object.keys(O).length === 0) {
          return null;
        }
        const R = v.getDisplayLabel(O, a, b);
        const { __errors: P, ...q } = l || {};
        const L = A()(a, ['ui:classNames', 'classNames', 'ui:style']);
        if (i.UI_OPTIONS_KEY in L) {
          L[i.UI_OPTIONS_KEY] = A()(L[i.UI_OPTIONS_KEY], [
            'classNames',
            'style'
          ]);
        }
        ...
        if (S) {
          ...
          K =
            i.ADDITIONAL_PROPERTY_FLAG in O
              ? u
              : C.title || e.schema.title || O.title || u;
        }
        const W = C.description || e.schema.description || O.description || '';
        const z = C.enableMarkdownInDescription
          ? (0, n.jsx)(It, { children: W })
          : W;
        const Y = C.help;
        const H = C.widget === 'hidden';
        const G = ['form-group', 'field', `field-${(0, i.getSchemaType)(O)}`];
        if (!B && P && P.length > 0) {
          G.push('field-error has-error has-danger');
        }
        ...
        const J = (0, n.jsx)(j, {
          ...
          schema: O,
          uiSchema: a,
          hasErrors: !B && P && P.length > 0,
          registry: g
        });
        const Z =
          B || ((O.anyOf || O.oneOf) && !v.isSelect(O))
            ? undefined
            : (0, n.jsx)(T, {
                errors: P,
                errorSchema: l,
        ...
        const Q = {
          description: (0, n.jsx)(F, {
            id: (0, i.descriptionId)(V),
            description: z,
            schema: O,
            uiSchema: a,
            registry: g
          ...
          rawDescription: W,
          help: J,
          rawHelp: typeof Y === 'string' ? Y : undefined,
          errors: Z,
          rawErrors: B ? undefined : P,
          id: V,
          label: K,
          hidden: H,
          onChange: h,
        ...
        const X = g.fields.AnyOfField;
        const ee = g.fields.OneOfField;
        const te =
          (a === null || a === void 0 ? void 0 : a['ui:field']) &&
          (a === null || a === void 0
            ? void 0
            : a['ui:fieldReplacesAnyOrOneOf']) === true;
        return (0, n.jsx)(k, {
          ...Q,
            ...
            children: [
              ...
              O.anyOf &&
                ...
                (0, n.jsx)(X, {
                  ...
                  onChange: e.onChange,
                  onFocus: e.onFocus,
                  options: O.anyOf.map((e) =>
                    v.retrieveSchema(y()(e) ? e : {}, o)
                  ),
                  registry: g,
                  schema: O,
                  uiSchema: a
      ...
      function Vt(e) {
        ...
        const I = k.getDisplayLabel(r, a, F);
        const A =
          (t = D !== null && D !== void 0 ? D : x) !== null && t !== void 0
            ? t
            : s;
        const _ = (0, i.getWidget)(r, O, b);
        return (0, n.jsx)(_, {
          options: { ...E, enumOptions: j },
          schema: r,
          uiSchema: a,
          id: o.$id,
          name: s,
      ...
      function Jt(e) {
        ...
        return (0, n.jsxs)('div', {
          ...
          children: [
            (0, n.jsx)('div', {
              className: i ? 'col-xs-9' : 'col-xs-12',
              children: t
            }),
            i &&
              (0, n.jsx)('div', {
      ...
      function Xt(e) {
        ...
        const F = { ...k, ...(0, i.getInputProps)(f, v, p) };
        let j;
        ...
        const T = (0, s.useCallback)(
          ({ target: { value: e } }) => h(e === '' ? p.emptyValue : e),
          [h, p]
        );
        const O = (0, s.useCallback)(
          ({ target: { value: e } }) => d(t, e),
          [d, t]
        );
        const w = (0, s.useCallback)(
          ({ target: { value: e } }) => u(t, e),
          [u, t]
        );
            ...
            Array.isArray(f.examples) &&
              (0, n.jsx)(
                'datalist',
                {
                  ...
                  children: f.examples
                    .concat(
                      f.default && !f.examples.includes(f.default)
                        ? [f.default]
                        : []
                    )
      ...
      function er({ uiSchema: e }) {
        const {
          submitText: t,
          norender: r,
          props: s = {}
        } = (0, i.getSubmitButtonOptions)(e);
        if (r) {
          return null;
        }
        return (0, n.jsx)('div', {
          children: (0, n.jsx)('button', {
            type: 'submit',
            ...s,
            className: `btn btn-info ${s.className || ''}`,
            children: t
          })
        });
      }
      ...
      function rr(e) {
        ...
        return (0, n.jsx)(tr, {
          title: t(i.TranslatableString.CopyButton),
      ...
      function nr(e) {
        ...
        return (0, n.jsx)(tr, {
          title: t(i.TranslatableString.MoveDownButton),
      ...
      function sr(e) {
        ...
        return (0, n.jsx)(tr, {
          title: t(i.TranslatableString.MoveUpButton),
      ...
      function ar({ className: e, onClick: t, disabled: r, registry: s }) {
      ...
      function dr({ errors: e, registry: t }) {
        const { translateString: r } = t;
        return (0, n.jsxs)('div', {
          ...
          children: [
            (0, n.jsx)('div', {
              ...
              children: (0, n.jsx)('h3', {
                ...
                children: r(i.TranslatableString.ErrorsLabel)
              })
            }),
            (0, n.jsx)('ul', {
      ...
      function hr(e) {
        ...
        return (0, n.jsxs)('label', {
          ...
          children: [
            t,
            r && (0, n.jsx)('span', { className: 'required', children: ur })
          ]
        });
      }
      function mr(e) {
        ...
        return (0, n.jsxs)(f, {
          ...e,
          children: [
            u && (0, n.jsx)(hr, { label: r, required: d, id: t }),
            u && l ? l : null,
            s,
            a,
            o
        ...
        return (0, n.jsx)('div', {
          children: (0, n.jsx)('ul', {
            ...
            children: t
              .filter((e) => !!e)
              .map((e, t) =>
                (0, n.jsx)('li', { className: 'text-danger', children: e }, t)
              )
          })
        });
      }
      ...
      function xr(e) {
        ...
        return (0, n.jsxs)('legend', {
          id: t,
          children: [
            r,
            s && (0, n.jsx)('span', { className: 'required', children: Sr })
          ]
        });
      }
      function vr(e) {
        ...
        return (0, n.jsxs)('div', {
          ...
          children: [
            (0, n.jsx)('p', {
              children: (0, n.jsx)(It, { children: o(l, c) })
            }),
      ...
      function Cr(e) {
        ...
        const x = y(i.TranslatableString.KeyLabel, [o]);
        const v = i.ADDITIONAL_PROPERTY_FLAG in h;
        if (!v) {
            ...
            children: [
              (0, n.jsx)('div', {
                ...
                children: (0, n.jsxs)('div', {
                  className: 'form-group',
                  children: [
                    (0, n.jsx)(hr, { label: x, required: u, id: `${t}-key` }),
                    (0, n.jsx)('input', {
                      className: 'form-control',
                      type: 'text',
                      id: `${t}-key`,
      ...
      function kr() {
        return {
          ArrayFieldDescriptionTemplate: Gt,
          ArrayFieldItemTemplate: Jt,
          ArrayFieldTemplate: Zt,
          ArrayFieldTitleTemplate: Qt,
          ButtonTemplates: lr(),
          BaseInputTemplate: Xt,
          DescriptionFieldTemplate: cr,
          ErrorListTemplate: dr,
          FieldTemplate: pr,
          FieldErrorTemplate: fr,
          FieldHelpTemplate: gr,
          ObjectFieldTemplate: yr,
          TitleFieldTemplate: xr,
          UnsupportedFieldTemplate: br,
          WrapIfAdditionalTemplate: Cr
        };
      }
      const Fr = kr;
      function jr(e, t) {
      ...
      function wr({
        ...
        return (0, n.jsx)(f, {
          ...
          name: o,
          className: 'form-control',
          options: { enumOptions: jr(t[0], t[1]) },
          placeholder: e,
          value: r,
          disabled: l,
          readonly: c,
      ...
      function Dr({
        ...
        const [S, x] = (0, s.useReducer)(
          (e, t) => ({ ...e, ...t }),
          (0, i.parseDateString)(p, e)
        );
        (0, s.useEffect)(() => {
          ...
          if (Tr(S) && t !== p) {
            ...
            y(p);
            x((0, i.parseDateString)(p, e));
          }
        }, [e, p, m, S, g]);
        const v = (0, s.useCallback)((e, t) => {
          x({ [e]: t });
        }, []);
            ...
            (o.hideNowButton !== 'undefined' ? !o.hideNowButton : true) &&
              (0, n.jsx)('li', {
                ...
                children: (0, n.jsx)('a', {
                  ...
                  onClick: b,
                  children: f(i.TranslatableString.NowLabel)
                })
              }),
      ...
      function _r({
        ...
        const x = (0, i.schemaRequiresTrueValue)(e);
        const v = (0, s.useCallback)((e) => f(e.target.checked), [f]);
        const b = (0, s.useCallback)((e) => m(a, e.target.checked), [m, a]);
        const C = (0, s.useCallback)((e) => p(a, e.target.checked), [p, a]);
        const k =
          (y = r.description) !== null && y !== void 0 ? y : e.description;
        return (0, n.jsxs)('div', {
      ...
      function Ur({
        ...
        const g = (0, s.useCallback)(
          ({ target: { value: t } }) =>
            m(e, (0, i.enumOptionsValueForIndex)(t, a, l)),
          [m, e]
        );
        const y = (0, s.useCallback)(
          ({ target: { value: t } }) =>
            p(e, (0, i.enumOptionsValueForIndex)(t, a, l)),
          [p, e]
        );
        return (0, n.jsx)('div', {
          ...
          children:
            ...
            a.map((s, l) => {
              ...
              return r
                ? (0, n.jsx)(
                    'label',
                    { className: `checkbox-inline ${p}`, children: x },
                    l
                  )
                : (0, n.jsx)(
                    'div',
                    {
                      ...
                      children: (0, n.jsx)('label', { children: x })
                    },
                    l
                  );
            })
      ...
      function Pr(e) {
        ...
        return (0, n.jsx)(o, {
          type: 'datetime-local',
          ...e,
          value: (0, i.utcToLocal)(r),
          onChange: (e) => t((0, i.localToUTC)(e))
        });
      }
      function qr(e) {
      ...
      function Mr(e) {
        ...
        return new Promise((s, i) => {
          ...
          a.onload = (e) => {
            var i;
            if (
              typeof ((i = e.target) === null || i === void 0
                ? void 0
                : i.result) === 'string'
            ) {
      ...
      function Kr({ fileInfo: e, registry: t }) {
        const { translateString: r } = t;
        ...
        return (0, n.jsxs)(n.Fragment, {
          children: [
            ...
            (0, n.jsx)('a', {
              ...
              children: r(i.TranslatableString.PreviewLabel)
            })
          ]
        });
      }
      function Wr({ filesInfo: e, registry: t, preview: r }) {
        if (e.length === 0) {
          return null;
        }
          ...
          children: e.map((e, a) => {
            ...
            return (0, n.jsxs)(
              'li',
              {
                children: [
                  (0, n.jsx)(It, {
                    children: s(i.TranslatableString.FilesInfo, [
                      o,
                      c,
                      String(l)
                    ])
                  }),
                  r && (0, n.jsx)(Kr, { fileInfo: e, registry: t })
                ]
              },
              a
            );
      ...
      function Yr(e) {
        ...
        const [m, p] = (0, s.useState)(Array.isArray(c) ? zr(c) : zr([c]));
        const f = (0, s.useCallback)(
          (e) => {
            if (!e.target.files) {
              return;
            }
            Vr(e.target.files).then((e) => {
        ...
        return (0, n.jsxs)('div', {
          children: [
            ...
            (0, n.jsx)(Wr, {
              filesInfo: m,
              registry: u,
              preview: d.filePreview
            })
          ]
        });
      }
      const Hr = Yr;
      function Gr({ id: e, value: t }) {
      ...
      function Qr({
        ...
        const y = (0, s.useCallback)(
          ({ target: { value: e } }) =>
            c(h, (0, i.enumOptionsValueForIndex)(e, m, g)),
          [c, h]
        );
        const S = (0, s.useCallback)(
          ({ target: { value: e } }) =>
            d(h, (0, i.enumOptionsValueForIndex)(e, m, g)),
          [d, h]
        );
        return (0, n.jsx)('div', {
          ...
          children:
            ...
            m.map((e, s) => {
              ...
              return f
                ? (0, n.jsx)(
                    'label',
                    { className: `radio-inline ${m}`, children: x },
                    s
                  )
                : (0, n.jsx)(
                    'div',
      ...
      function en(e) {
        ...
        return (0, n.jsxs)('div', {
          ...
          children: [
            (0, n.jsx)(r, { type: 'range', ...e }),
            (0, n.jsx)('span', { className: 'range-view', children: t })
          ]
        });
      }
      function tn(e, t) {
      ...
      function rn({
        ...
        return (0, n.jsxs)('select', {
          ...
          children: [
            !d &&
              e.default === undefined &&
              (0, n.jsx)('option', { value: '', children: f }),
            Array.isArray(g) &&
              g.map(({ value: e, label: t }, r) => {
                const s = y && y.indexOf(e) !== -1;
                return (0, n.jsx)(
                  'option',
                  { value: String(r), disabled: s, children: t },
                  r
                );
              })
          ]
      ...
      function sn({
        ...
        const p = (0, s.useCallback)(
          ({ target: { value: e } }) => u(e === '' ? t.emptyValue : e),
          [u, t.emptyValue]
        );
        const f = (0, s.useCallback)(
          ({ target: { value: t } }) => h(e, t),
          [h, e]
        );
        const g = (0, s.useCallback)(
          ({ target: { value: t } }) => m(e, t),
          [e, m]
        );
      ...
      sn.defaultProps = { autofocus: false, options: {} };
      const an = sn;
      function on(e) {
        const { options: t, registry: r } = e;
        const s = (0, i.getTemplate)('BaseInputTemplate', r, t);
      ...
      function mn() {
        return {
          ...
          rootSchema: {},
          formContext: {},
          translateString: i.englishStringTranslator
        };
      }
      class pn extends s.Component {
        constructor(e) {
            ...
            const r = (e, n = [], s = [[]]) => {
              Object.keys(e).forEach((a) => {
                if (typeof e[a] === 'object') {
                  const t = s.map((e) => [...e, a]);
                  if (
                    e[a][i.RJSF_ADDITONAL_PROPERTIES_FLAG] &&
                    e[a][i.NAME_KEY] !== ''
                  ) {
          ...
          if (
            this.props.onChange &&
            !(0, i.deepEquals)(this.state.formData, this.props.formData)
          ) {
        ...
        componentDidUpdate(e, t, r) {
          if (r.shouldUpdate) {
            const { nextState: e } = r;
            if (
              !(0, i.deepEquals)(e.formData, this.props.formData) &&
              !(0, i.deepEquals)(e.formData, t.formData) &&
              this.props.onChange
            ) {
        ...
        getStateFromProps(e, t, r) {
          ...
          const l =
            'liveValidate' in e ? e.liveValidate : this.props.liveValidate;
          const c = o && !e.noValidate && l;
          const d = s;
          const u =
            'experimental_defaultFormStateBehavior' in e
              ? e.experimental_defaultFormStateBehavior
          ...
          let x = n.schemaValidationErrorSchema;
          if (c) {
          ...
          if (e.extraErrors) {
            const t = (0, i.validationDataMerge)(
              { errorSchema: y, errors: g },
              e.extraErrors
            );
            y = t.errorSchema;
            g = t.errors;
          }
          const v = h.toIdSchema(
            p,
            a['ui:rootFieldId'],
            m,
            e.idPrefix,
        ...
        getRegistry() {
          ...
          return {
            ...
            templates: {
              ...
              ButtonTemplates: {
                ...a.ButtonTemplates,
                ...((e = this.props.templates) === null || e === void 0
                  ? void 0
                  : e.ButtonTemplates)
              }
            },
        ...
        render() {
          ...
          const { SchemaField: O } = T.fields;
          const { SubmitButton: w } = T.templates.ButtonTemplates;
          const D = v ? o : undefined;
          const E = v || o || 'form';
          let { [i.SUBMIT_BTN_OPTIONS_KEY]: I = {} } = (0, i.getUiOptions)(C);
          if (g) {
            I = { ...I, props: { ...I.props, disabled: true } };
          }
          const A = { [i.UI_OPTIONS_KEY]: { [i.SUBMIT_BTN_OPTIONS_KEY]: I } };
          return (0, n.jsxs)(E, {
            className: a ? a : 'rjsf',
            id: t,
            name: l,
            ...
            children: [
              ...
              e ? e : (0, n.jsx)(w, { uiSchema: A, registry: T }),
              x === 'bottom' && this.renderErrors(T)
            ]
          });
        }
      }
      function fn(e) {
        return forwardRef(
          ({ fields: t, widgets: r, templates: n, ...s }, i) => {
            var a;
            ...
            n = {
              ...
              ...n,
              ButtonTemplates: {
                ...((a = e === null || e === void 0 ? void 0 : e.templates) ===
                  null || a === void 0
                  ? void 0
                  : a.ButtonTemplates),
    ...
    78510: (e, t, r) => {
      ...
      class v extends S {
        ...
        clone() {
          return new v(this.style, this.id).merge(this);
        }
      }
      class b extends S {
        constructor(e, t, r) {
    ...
    14798: (e, t) => {
      ...
      t.media = function (e) {
        ...
        if (e.prefersColorScheme)
          a.push('(prefers-color-scheme: ' + e.prefersColorScheme + ')');
