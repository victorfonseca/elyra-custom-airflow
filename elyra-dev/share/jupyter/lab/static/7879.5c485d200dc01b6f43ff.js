    ...
    37879: (t, e, n) => {
      ...
      function O(t, e, n) {
        ...
        if (arguments.length > 1) i = T(t, e, n);
          ...
          for (r = 0, i = new Array((s = t.arcs.length)); r < s; ++r) i[r] = r;
      ...
      function St(t, e, n, i) {
        const r =
          n <= 1
            ? t
            : i
              ? (e, r) => i + n * Math.floor((t(e, r) - i) / n)
              : (e, i) => n * Math.floor(t(e, i) / n);
      ...
      function tn(t) {
        return typeof Buffer === 'function' && (0, p.Tn)(Buffer.isBuffer)
          ? Buffer.isBuffer(t)
          : false;
      }
      function en(t, e) {
      ...
      function sn(t, e) {
        ...
        i = (i = t.objects[r])
          ? n(t, i, s)
          : (0, p.z3)('Invalid TopoJSON object: ' + r);
      ...
      async function jn(t, e) {
        ...
        try {
          r = await n
            .loader()
            .load(t, { context: 'dataflow', response: un(e && e.type) });
          try {
            r = n.parse(r, e);
          } catch (s) {
            i = -2;
      ...
      ci.prototype = {
        ...
        changed(t) {
          const e = t || si;
          return (
            (e & ti && this.add.length) ||
            (e & ei && this.rem.length) ||
            (e & ni && this.mod.length)
          );
        },
        reflow(t) {
      ...
      function Ui(t, e, n = 0, i = Infinity, r) {
        ...
        while (i > n) {
          if (i - n > 600) {
            ...
            const l =
              0.5 * Math.sqrt((o * u * (s - u)) / s) * (a - s / 2 < 0 ? -1 : 1);
      ...
      function Lr(t, e, n) {
        ...
        return {
          coef: [Math.exp(m - g * s), g],
          predict: y,
          rSquared: Or(t, e, n, a, y)
        };
      }
      function Pr(t, e, n) {
        let i = 0,
      ...
      const os = {
        ...
        sum: {
          init: (t) => (t.sum = 0),
          value: (t) => (t.valid ? t.sum : undefined),
          add: (t, e) => (t.sum += +e),
          rem: (t, e) => (t.sum -= e)
        },
        product: {
        ...
        variancep: {
          value: (t) => (t.valid > 1 ? t.dev / t.valid : undefined),
          req: ['variance'],
          idx: 2
        },
        stdev: {
          value: (t) =>
            t.valid > 1 ? Math.sqrt(t.dev / (t.valid - 1)) : undefined,
          req: ['variance'],
          idx: 2
        },
        stdevp: {
          value: (t) => (t.valid > 1 ? Math.sqrt(t.dev / t.valid) : undefined),
          req: ['variance'],
          idx: 2
        },
        stderr: {
          value: (t) =>
            t.valid > 1
              ? Math.sqrt(t.dev / (t.valid * (t.valid - 1)))
              : undefined,
          req: ['variance'],
          idx: 2
        },
        ...
        exponential: {
          ...
          value: (t) =>
            t.valid
              ? (t.exp * (1 - t.exp_r)) / (1 - t.exp_r ** t.valid)
              : undefined,
          add: (t, e) => (t.exp = t.exp_r * t.exp + e),
          rem: (t, e) =>
            (t.exp = (t.exp - e / t.exp_r ** (t.valid - 1)) / t.exp_r)
        },
        exponentialb: {
          value: (t) => (t.valid ? t.exp * (1 - t.exp_r) : undefined),
          req: ['exponential'],
          idx: 1
        }
      };
      ...
      function ls(t, e) {
        return (n, i) =>
          (0, p.X$)({ name: t, aggregate_param: i, out: n || t }, as, e);
      }
      ...
      function hs() {
        ...
        this.missing = 0;
        this._ops.forEach((t) =>
          t.aggregate_param == null
            ? t.init(this)
            : t.init(this, t.aggregate_param)
        );
      }
      function ps(t, e) {
        if (t == null || t === '') {
          ...
          const u = function (t) {
            ...
            return n == null
              ...
              : n < r
                ...
                : n > s
                  ? +Infinity
                  : ((n = Math.max(r, Math.min(n, s - i))),
                    r + i * Math.floor(_s + (n - r) / i));
          };
          u.start = r;
          u.stop = n.stop;
          u.step = i;
          return (this.value = (0, p.sY)(
            u,
            (0, p.nS)(e),
            t.name || 'bin_' + (0, p.N6)(e)
          ));
        }
      });
      function As(t, e, n) {
      ...
      (0, p.B)(ks, zi, {
        transform(t, e) {
          const n = e.fork(e.ALL),
            ...
            s =
              e.changed() ||
              (r && (t.modified('sort') || e.modified(r.fields)));
      ...
      function Ws(t) {
        ...
        return this.value && !t.modified('expr')
          ? this.value
          : (0, p.sY)((n) => e(n, t), (0, p.nS)(e), (0, p.N6)(e));
      }
      function Xs(t) {
        ...
        transform(t, e) {
          const n = t.expr,
            ...
            s = t.initonly
              ...
              : r
                ? e.SOURCE
                : e.modified(n.fields) || e.modified(i)
                  ? e.ADD_MOD
                  : e.ADD;
          if (r) {
      ...
      function pa(t) {
        return (
          t.modified('async') &&
          !(t.modified('values') || t.modified('url') || t.modified('format'))
        );
      }
      function ma(t, e, n) {
        n.forEach(bn);
        ...
        _floor(t, e) {
          ...
          const { units: i, step: r } = t.units
            ...
            : ce({
                extent:
                  t.extent ||
                  (0, p.Xx)(e.materialize(e.SOURCE).source, t.field),
                maxbins: t.maxbins
              });
          const s = dt(i),
            a = this.value || {},
      ...
      (0, p.B)(Pa, zi, {
        transform(t, e) {
          ...
          if (n) {
            this.value = (
              t.sort ? e.source.slice().sort(An(t.sort)) : e.source
            ).map(t.field);
          }
        }
      });
      ...
      function bo(t, e, n) {
        var i = null,
          ...
          u = (0, yo.i)(l);
        t =
          typeof t === 'function' ? t : t === undefined ? vo.x : (0, mo.A)(+t);
        e =
          typeof e === 'function'
            ? e
            : e === undefined
              ...
              : (0, mo.A)(+e);
        n =
          typeof n === 'function' ? n : n === undefined ? vo.y : (0, mo.A)(+n);
        function l(l) {
          var c,
            f,
            d,
        ...
        l.x = function (e) {
          return arguments.length
            ? ((t = typeof e === 'function' ? e : (0, mo.A)(+e)), (i = null), l)
            : t;
        };
        l.x0 = function (e) {
          return arguments.length
            ? ((t = typeof e === 'function' ? e : (0, mo.A)(+e)), l)
            : t;
        };
        l.x1 = function (t) {
          return arguments.length
            ? ((i =
                t == null ? null : typeof t === 'function' ? t : (0, mo.A)(+t)),
              l)
            : i;
        };
        l.y = function (t) {
          return arguments.length
            ? ((e = typeof t === 'function' ? t : (0, mo.A)(+t)), (n = null), l)
            : e;
        };
        l.y0 = function (t) {
          return arguments.length
            ? ((e = typeof t === 'function' ? t : (0, mo.A)(+t)), l)
            : e;
        };
        l.y1 = function (t) {
          return arguments.length
        ...
        l.defined = function (t) {
          return arguments.length
            ? ((r = typeof t === 'function' ? t : (0, mo.A)(!!t)), l)
            : r;
        };
        l.curve = function (t) {
      ...
      function Vo(t, e) {
        ...
        r.type = function (e) {
          return arguments.length
            ? ((t = typeof e === 'function' ? e : (0, mo.A)(e)), r)
            : t;
        };
        r.size = function (t) {
          return arguments.length
            ? ((e = typeof t === 'function' ? t : (0, mo.A)(+t)), r)
            : e;
        };
      ...
      function pu(t) {
        ...
        e.nice = () =>
          n(
            (0, iu.A)(n(), {
              floor: (t) => s(Math.floor(r(t))),
              ceil: (t) => s(Math.ceil(r(t)))
            })
          );
        return e;
      }
        ...
        function l(t) {
          return t == null || isNaN((t = +t))
            ...
            : a(
                r === 0
                  ? 0.5
                  : ((t = (s(t) - n) * r), o ? Math.max(0, Math.min(1, t)) : t)
              );
        }
        l.domain = function (a) {
          return arguments.length
      ...
      function Yu() {
        ...
        s.invertExtent = function (i) {
          ...
          return r < 0
            ? [NaN, NaN]
            : [r > 0 ? n[r - 1] : t[0], r < n.length ? n[r] : t[t.length - 1]];
        };
        s.domain = function (e) {
      ...
      function Xu() {
        ...
        r.domain = function (n) {
          return arguments.length
            ? ((t = Array.from(n)), (i = Math.min(t.length, e.length - 1)), r)
            : t.slice();
        };
        r.range = function (n) {
          return arguments.length
            ? ((e = Array.from(n)), (i = Math.min(t.length, e.length - 1)), r)
            : e.slice();
        };
      ...
      function zl(t) {
        return function (e) {
          ...
          return [
            i[0] === undefined ? i[1] : i[0],
            r[1] === undefined ? r[0] : r[1]
          ];
        };
      }
      function $l() {
      ...
      function ld(t, e) {
        ...
        return (n.orient === 'horizontal' ? nd : ed)
          .curve(Qc(i, n.orient, n.tension))
          .context(t)(e);
      }
      function cd(t, e) {
        const n = e[0],
      ...
      function yh(t, e) {
        return function (n, i, r, s) {
          ...
          return t(n, i)
            ? false
            : (o && n.isPointInPath(r, s)) || (u && n.isPointInStroke(r, s));
        };
      }
      function vh(t) {
        return gh(yh(t));
      ...
      function kh(t) {
        return (
          bh(t.x || 0, t.y || 0) +
          (t.angle ? ' ' + xh(t.angle) : '') +
          (t.scaleX || t.scaleY ? ' ' + _h(t.scaleX || 1, t.scaleY || 1) : '')
        );
      }
      function Eh(t, e, n) {
        function i(t, n) {
      ...
      function Xh(t, e, n) {
        return (
          (t.interactive !== false || t.marktype === 'group') &&
          t.bounds &&
      ...
      function zp(t) {
        return Bp(
          t.lineBreak && t.text && !(0, p.cy)(t.text)
      ...
      function Xp(t, e) {
        const n = Gp(Ip, t, 2);
        return (
          th(e, n[0], n[1], n[2], n[3]) ||
          th(e, n[0], n[1], n[4], n[5]) ||
          th(e, n[4], n[5], n[6], n[7]) ||
          th(e, n[2], n[3], n[6], n[7])
        );
      }
      var Hp = {
        type: 'text',
      ...
      class jm extends hm {
        constructor(t, e) {
          ...
          (this.dragover = Hm([_m], [bm], [xm])),
            (this.pointerout = Vm([Em, Sm]));
      ...
      class Zm extends mm {
        ...
        resize(t, e, n, i) {
          ...
          if (this._canvas) {
            ...
            if (!t)
              (0, p.z3)('CanvasRenderer is missing a valid canvas or context');
        ...
        _render(t, e) {
          ...
          const u =
            this._redraw || a.empty()
              ? ((this._redraw = false), o.expand(1))
              : tg(n, o.intersect(a), i);
      ...
      const fg = {
        ...
        'title-text': {
          desc: 'title',
          caption: (t) => `Title text '${yg(t)}'`
        },
        'title-subtitle': {
          desc: 'subtitle',
          caption: (t) => `Subtitle text '${yg(t)}'`
        }
      };
      ...
      function mg(t) {
        ...
        const n =
          e === 'group' ||
          e === 'text' ||
          t.items.some((t) => t.description != null && t.aria !== false);
      ...
      class Qg extends mm {
        ...
        mark(t, e) {
          ...
          t.open(
            'g',
            { class: cm(e), 'clip-path': e.clip ? yd(this, e, e.group) : null },
            pg(e),
            {
              'pointer-events':
                i !== 'g' && e.interactive === false ? 'none' : null
            }
          );
          const s = (s) => {
            const a = this.href(s);
      ...
      function cy(t, e, n) {
        ...
        return s
          ...
          : s === 'group'
            ? hy(t, r, n, i)
            : (0, p.z3)('Intersect scene must be mark node or group item.');
      }
      function fy(t, e, n, i) {
        if (dy(t, e, n)) {
          const r = t.items,
      ...
      function dy(t, e, n) {
        return (
          ...
          (t.marktype === 'group' || (t.interactive !== false && (!n || n(t))))
        );
      }
      function hy(t, e, n, i) {
      ...
      const hv = {
        ...
        greedy: (t, e) => {
          let n;
          return t.filter((t, i) =>
            !i || !pv(n.bounds, t.bounds, e) ? ((n = t), 1) : (t.opacity = 0)
          );
        }
      };
      const pv = (t, e, n) =>
      ...
      function Lv(t, e, n, i, r, s, a, o, u, l, c, f, d, h) {
        ...
        for (y = c, v = 0, x = e.length; v < x; ++v, y += f) {
          ...
          if (o) {
            k =
              h == null ? A.x : Math.round(A.bounds.x1 + h * A.bounds.width());
            E = m;
          } else {
            k = m;
            E =
              h == null ? A.y : Math.round(A.bounds.y1 + h * A.bounds.height());
          }
      ...
      function Pv(t, e, n, i, r, s) {
        ...
        var a = n,
          o = n;
        i
          ? (a = Math.round(r.x1 + s * r.width()))
          : (o = Math.round(r.y1 + s * r.height()));
      ...
      (0, p.B)(eb, zi, {
        transform(t, e) {
          ...
          var n = e.dataflow.locale(),
            ...
            u =
              t.format ||
              kc(n, s, o, t.formatSpecifier, t.formatType, !!t.values),
            l = t.values ? wc(s, t.values, o) : Ac(s, o);
          if (r) i.rem = r;
          r = l.map((t, e) =>
            bn({ index: e / (l.length - 1 || 1), value: t, label: u(t) })
          );
          if (t.extra && r.length) {
      ...
      (0, p.B)(ab, zi, {
        transform(t, e) {
          ...
          if (s === mc) {
            ...
            r = f.map((t, e) =>
              bn({ index: e, label: c(t, e, f), value: t, perc: h(t) })
            );
          } else {
            m = f.length - 1;
            h = Pc(a);
      ...
      const hb = (t, e, n, i) =>
        db(e * Math.cos(t), e * Math.sin(t), i * Math.cos(n), i * Math.sin(n));
      const pb = (t, e, n, i) => {
        var r = n - t,
          s = i - e,
          a = Math.hypot(r, s) / 2,
      ...
      const mb = (t, e, n, i) =>
        pb(e * Math.cos(t), e * Math.sin(t), i * Math.cos(n), i * Math.sin(n));
      const gb = (t, e, n, i) => {
        const r = n - t,
          s = i - e,
          a = 0.2 * (r + s),
      ...
      const yb = (t, e, n, i) =>
        gb(e * Math.cos(t), e * Math.sin(t), i * Math.cos(n), i * Math.sin(n));
        ...
        transform(t, e) {
          ...
          for (r in t)
            if (!Fb[r]) {
              ...
              (0, p.Tn)(i[r])
                ? i[r](t[r])
                : n.warn('Unsupported scale property: ' + r);
            }
      ...
      function Bb(t) {
        ...
        if (zb(t)) {
          i = t.rawDomain
            ? t.rawDomain.length
            : t.domain
              ? t.domain.length + +(t.domainMid != null)
              : 0;
          n = i === 2 ? yl + '-' : i === 3 ? vl + '-' : '';
        }
      ...
      function zb(t) {
        ...
        return (
          ...
          e !== ml &&
          e !== gl &&
          (t.scheme || (t.range && t.range.length && t.range.every(p.Kg)))
        );
      }
      function $b(t, e, n) {
        ...
        if (
          ...
          if (e.domainMid != null) {
            ...
            if (t !== o)
              n.warn('Scale domainMid exceeds domain min or max.', u);
            r.splice(t, 0, u);
          }
        }
      ...
      function Tb(t, e, n) {
        if (Kl(t)) {
          var i = Math.abs(
            e.reduce((t, e) => t + (e < 0 ? -1 : e > 0 ? 1 : 0), 0)
          );
          if (i !== e.length) {
      ...
      function Lb(t, e, n) {
        ...
        if (e.rangeStep != null) {
          ...
          if ((0, p.Tn)(s)) {
            if (t.interpolator) {
              ...
              (0, p.z3)(
                `Scale type ${i} does not support interpolating color schemes.`
              );
            }
          }
        }
        if (s && Jl(i)) {
          return t.interpolator(
            ic(Ub(s, e.reverse), e.interpolate, e.interpolateGamma)
          );
        }
      ...
      function Pb(t, e, n) {
        ...
        var i = (e.paddingOuter != null ? e.paddingOuter : e.padding) || 0,
          r =
            t === Al
              ? 1
              : (e.paddingInner != null ? e.paddingInner : e.padding) || 0;
        ...
        function a(t) {
          if (t) {
            if (typeof i === 'function')
              s.pointRadius(+i.apply(this, arguments));
            sx(t, r(s));
          }
          return s.result();
        }
      ...
      function ow(t, e) {
        return (
          ((t = t.x)[0] < 0 ? t[1] - dx - lx : dx - t[1]) -
          ((e = e.x)[0] < 0 ? e[1] - dx - lx : dx - e[1])
        );
      }
      const uw = sw(
        function () {
      ...
      function cw(t, e, n, i) {
        ...
        return yx(a) > lx
          ? vx(
              (Dx(e) * (s = xx(i)) * Dx(n) - Dx(i) * (r = xx(e)) * Dx(t)) /
                (r * s * a)
            )
          : (e + i) / 2;
      }
      ...
      function pw() {
        ...
        o.center = function (e) {
          return arguments.length
            ? ((t = typeof e === 'function' ? e : constant([+e[0], +e[1]])), o)
            : t;
        };
        o.radius = function (t) {
          return arguments.length
            ? ((e = typeof t === 'function' ? t : constant(+t)), o)
            : e;
        };
        o.precision = function (t) {
          return arguments.length
            ? ((n = typeof t === 'function' ? t : constant(+t)), o)
            : n;
        };
        return o;
      }
          ...
          function C(s, a) {
            ...
            if (b) {
              ...
              if (o && v) u.point(s, a);
                ...
                var l = [
                    (g = Math.max(vw, Math.min(yw, g))),
                    (y = Math.max(vw, Math.min(yw, y)))
                  ],
                  c = [
                    (s = Math.max(vw, Math.min(yw, s))),
                    (a = Math.max(vw, Math.min(yw, a)))
                  ];
                if (gw(l, c, t, e, n, i)) {
                  if (!v) {
                    u.lineStart();
      ...
      function Zw() {
        ...
        function c(t) {
          ...
          return (
            (u = null),
            (i.point(e, n), u) || (s.point(e, n), u) || (o.point(e, n), u)
          );
        }
        c.invert = function (t) {
          var e = n.scale(),
            ...
            o = (t[1] - i[1]) / e;
          return (
            o >= 0.12 && o < 0.234 && s >= -0.425 && s < -0.214
              ? r
              : o >= 0.166 && o < 0.234 && s >= -0.214 && s < -0.115
                ? a
                : n
          ).invert(t);
        };
        c.stream = function (i) {
          return t && e === i
            ? t
            : (t = Kw([n.stream((e = i)), r.stream(i), a.stream(i)]));
        };
      ...
      function _A(t, e) {
        var n = zx(bA * Dx(e)),
          ...
          r = i * i * i;
        return [
          (t * xx(n)) / (bA * (mA + 3 * gA * i + r * (7 * yA + 9 * vA * i))),
          n * (mA + gA * i + r * (yA + vA * i))
        ];
      }
      _A.invert = function (t, e) {
        ...
        return [
          (bA * t * (mA + 3 * gA * i + r * (7 * yA + 9 * vA * i))) / xx(n),
          zx(Dx(n) / bA)
        ];
      };
      function wA() {
      ...
      function MA(t, e) {
        ...
        return [
          t *
            (0.8707 -
              0.131979 * n +
              i * (-0.013791 + i * (0.003971 * n - 0.001529 * i))),
          e *
            (1.007226 +
              n * (0.015085 + i * (-0.044475 + 0.028874 * n - 0.005916 * i)))
        ];
      }
        ...
        do {
          ...
          n -= r =
            (n *
              (1.007226 +
                s *
                  (0.015085 + a * (-0.044475 + 0.028874 * s - 0.005916 * a))) -
              e) /
            (1.007226 +
              s *
                (0.015085 * 3 +
                  a * (-0.044475 * 7 + 0.028874 * 9 * s - 0.005916 * 11 * a)));
        } while (yx(r) > lx && --i > 0);
        return [
          t /
            (0.8707 +
              (s = n * n) *
                (-0.131979 +
                  s * (-0.013791 + s * s * s * (0.003971 - 0.001529 * s)))),
          n
        ];
      };
      function DA() {
      ...
      function gk(t, e, n) {
        ...
        i.invert = function (i, r) {
          return (
            (r = ok(r / e)), [i / (t * LA(r)), ok((2 * r + XA(2 * r)) / n)]
          );
        };
        return i;
      }
      ...
      (0, p.B)(qk, zi, {
        transform(t, e) {
          ...
          i.forEach((e) => {
            const n = r(e);
            const i = s.size([n.width, n.height])(
              n.values,
              (0, p.cy)(a) ? a : a(n.values)
            );
            Uk(i, n, e, t);
            i.forEach((t) => {
      ...
      function Ik(t, e, n) {
        ...
        return n.resolve !== 'shared'
          ? i
          : i(t.map((t) => (0, Ni.A)(e(t).values)));
      }
      function Uk(t, e, n, i) {
      ...
      (0, p.B)(iE, zi, {
        transform(t, e) {
          ...
          l =
            ...
            e.changed(e.REM) ||
            e.modified((0, p.nS)(o)) ||
            (s && e.modified((0, p.nS)(s))) ||
            (a && e.modified((0, p.nS)(a)));
          if (!this.value || l) {
            u = e.SOURCE;
            this._features = n = [];
            this._points = i = [];
        ...
        transform(t, e) {
          ...
          var n = e.materialize(e.SOURCE).source,
            ...
            u = {
              ...
              $y: 0,
              $value: 0,
              $max: i ? (0, Ni.A)(n.map((t) => (0, Ni.A)(r(t).values))) : 0
            };
          n.forEach((t) => {
            const e = r(t);
            const n = (0, p.X$)({}, t, u);
      ...
      function bE(t) {
        ...
        return t.length === 1
          ? t[0]
          : { type: eE, features: t.reduce((t, e) => t.concat(xE(e)), []) };
      }
      function xE(t) {
        return t.type === eE
          ? t.features
      ...
      function AE(t, e, n, i) {
        ...
        if (e === h && n === p)
          return (a.next = s), r ? (r[y] = a) : (t._root = a), t;
        do {
      ...
      function RE(t) {
        ...
        while ((n = e.pop())) {
          if (
            !t((i = n.node), (s = n.x0), (a = n.y0), (o = n.x1), (u = n.y1)) &&
            i.length
          ) {
            var l = (s + o) / 2,
              c = (a + u) / 2;
      ...
      function OE(t) {
        var e = [],
          ...
          i;
        if (this._root)
          e.push(new CE(this._root, this._x0, this._y0, this._x1, this._y1));
        while ((i = e.pop())) {
          var r = i.node;
          if (r.length) {
            var s,
      ...
      jE.copy = function () {
        ...
        while ((e = n.pop())) {
          for (var r = 0; r < 4; ++r) {
            if ((i = e.source[r])) {
              if (i.length)
                n.push({ source: i, target: (e.target[r] = new Array(4)) });
      ...
      function HE(t) {
        ...
        a.radius = function (e) {
          return arguments.length
            ? ((t = typeof e === 'function' ? e : GE(+e)), u(), a)
            : t;
        };
        return a;
      }
        ...
        return (e = {
          ...
          force: function (t, n) {
            return arguments.length > 1
              ? (n == null ? o.delete(t) : o.set(t, p(n)), e)
              : o.get(t);
          },
          find: function (e, n, i) {
            var r = 0,
      ...
      function aM() {
        ...
        l.strength = function (t) {
          return arguments.length
            ? ((r = typeof t === 'function' ? t : GE(+t)), c(), l)
            : r;
        };
      ...
      function lM(t) {
        ...
        function h() {
          ...
          for (n = 0, u = new Array(l); n < l; ++n) {
            (f = t[n]),
              (u[n] =
                o[f.source.index] / (o[f.source.index] + o[f.target.index]));
          }
          (i = new Array(l)), p();
          (s = new Array(l)), m();
        }
        ...
        d.strength = function (t) {
          return arguments.length
            ? ((n = typeof t === 'function' ? t : GE(+t)), p(), d)
            : n;
        };
        d.distance = function (t) {
          return arguments.length
            ? ((r = typeof t === 'function' ? t : GE(+t)), m(), d)
            : r;
        };
        return d;
      }
      function cM(t) {
        ...
        s.strength = function (t) {
          return arguments.length
            ? ((e = typeof t === 'function' ? t : GE(+t)), a(), s)
            : e;
        };
        s.x = function (e) {
          return arguments.length
            ? ((t = typeof e === 'function' ? e : GE(+e)), a(), s)
            : t;
        };
        return s;
      }
      ...
      (0, p.B)(yM, zi, {
        transform(t, e) {
          ...
          if (r || i || t.modified(mM) || (e.changed() && t.restart)) {
            n.alpha(Math.max(n.alpha(), t.alpha || 1)).alphaDecay(
              1 - Math.pow(n.alphaMin(), 1 / s)
            );
            if (t.static) {
      ...
      const rC = (function t(e) {
        function n(t, n, i, r, s) {
          if ((a = t._squarify) && a.ratio === e) {
            ...
            while (++c < d) {
              (o = a[c]), (u = o.children);
              for (l = o.value = 0, f = u.length; l < f; ++l)
                o.value += u[l].value;
              if (o.dice)
                kD(o, n, i, r, h ? (i += ((s - i) * o.value) / h) : s);
      ...
      function sC() {
        ...
        c.paddingTop = function (t) {
          return arguments.length
            ? ((a = typeof t === 'function' ? t : VM(+t)), c)
            : a;
        };
        c.paddingRight = function (t) {
          return arguments.length
            ? ((o = typeof t === 'function' ? t : VM(+t)), c)
            : o;
        };
        c.paddingBottom = function (t) {
          return arguments.length
            ? ((u = typeof t === 'function' ? t : VM(+t)), c)
            : u;
        };
        c.paddingLeft = function (t) {
          return arguments.length
            ? ((l = typeof t === 'function' ? t : VM(+t)), c)
            : l;
        };
        return c;
      }
      ...
      (0, p.B)(vC, zi, {
        transform(t, e) {
          ...
          if (s) {
            n = r.source.length
              ? aC(BD().id(t.key).parentId(t.parentKey)(r.source), t.key, p.vN)
              : aC(BD()([{}]), t.key, t.key);
          }
      ...
      function IC(t, e, n, i, r, s, a, o) {
        const u = (r * s) / (i * 2),
          ...
          d = t(n + s);
        return (
          a.outOfBounds(l, f, c, d) ||
          a.getRange(l, f, c, d) ||
          (o && o.getRange(l, f, c, d))
        );
      }
      function UC(t, e, n, i) {
        const r = t.width,
      ...
      function VC(t, e, n, i, r, s, a, o, u, l, c, f) {
        return !(
          r.outOfBounds(t, n, e, i) || ((f && s) || r).getRange(t, n, e, i)
        );
      }
      const QC = 0,
        KC = 4,
        ...
        transform(t, e) {
          ...
          if (!this.value || e.changed() || t.modified()) {
            ...
            r.forEach((n) => {
              ...
              if (t.params) {
                f.push(
                  bn({ keys: n.dims, coef: r.coef, rSquared: r.rSquared })
                );
                return;
              }
      ...
      function uS(t, e, n, i, r, s, a, o, u, l, c, f, d) {
        ...
        UF[3] = N;
        h = sum(
          sum(scale(4, qF, G, JF), JF, scale(4, IF, Y, tS), tS, eS),
          eS,
          scale(4, UF, W, JF),
          JF,
          iS
      ...
      function lS(t, e, n, i, r, s, a, o, u, l, c, f) {
        ...
        const C =
          (Math.abs(_) + Math.abs(w)) * Math.abs(v) +
          (Math.abs(A) + Math.abs(k)) * Math.abs(b) +
          (Math.abs(E) + Math.abs(M)) * Math.abs(x);
        const F = NF * C;
        if (D > F || -D > F) {
          return D;
        }
      ...
      function YS(t, e, n, i, r, s, a, o, u) {
        ...
        l = sum(
          sum(
            sum(
              scale(scale(4, pS, G, RS), RS, G, OS),
              OS,
              scale(scale(4, pS, X, RS), RS, X, TS),
              TS,
              LS
            ),
            LS,
            sum(
              scale(scale(4, mS, Y, RS), RS, Y, OS),
              OS,
              scale(scale(4, mS, H, RS), RS, H, TS),
              TS,
              PS
            ),
            PS,
          ...
          IS,
          sum(
            scale(scale(4, gS, W, RS), RS, W, OS),
            OS,
            scale(scale(4, gS, V, RS), RS, V, TS),
            TS,
            LS
          ),
          LS,
        ...
        Q +=
          ...
          2 * (G * c + X * h) * (Y * V - H * W) +
          ((Y * Y + H * H) * (W * h + X * d - (V * c + G * m)) +
            2 * (Y * f + H * p) * (W * X - V * G)) +
          ((W * W + V * V) * (G * p + H * c - (X * f + Y * h)) +
            2 * (W * d + V * m) * (G * H - X * Y));
        if (Q >= K || -Q >= K) {
          return Q;
        }
        ...
        if (c !== 0) {
          ...
          l = GS(
            ...
            sum_three(
              scale(g, wS, 2 * G, OS),
              OS,
              scale(scale(4, bS, c, RS), RS, H, TS),
              TS,
              scale(scale(4, vS, c, RS), RS, -V, NS),
              NS,
              LS,
              qS
            ),
        ...
        if (h !== 0) {
          ...
          l = GS(
            ...
            sum_three(
              scale(y, AS, 2 * X, OS),
              OS,
              scale(scale(4, vS, h, RS), RS, W, TS),
              TS,
              scale(scale(4, bS, h, RS), RS, -Y, NS),
              NS,
              LS,
              qS
            ),
        ...
        if (f !== 0) {
          ...
          l = GS(
            ...
            sum_three(
              scale(v, kS, 2 * Y, OS),
              OS,
              scale(scale(4, yS, f, RS), RS, V, TS),
              TS,
              scale(scale(4, bS, f, RS), RS, -X, NS),
              NS,
              LS,
              qS
            ),
        ...
        if (p !== 0) {
          ...
          l = GS(
            ...
            sum_three(
              scale(b, ES, 2 * H, OS),
              OS,
              scale(scale(4, bS, p, RS), RS, G, TS),
              TS,
              scale(scale(4, yS, p, RS), RS, -W, NS),
              NS,
              LS,
              qS
            ),
        ...
        if (d !== 0) {
          ...
          l = GS(
            ...
            sum_three(
              scale(x, MS, 2 * W, OS),
              OS,
              scale(scale(4, vS, d, RS), RS, X, TS),
              TS,
              scale(scale(4, yS, d, RS), RS, -H, NS),
              NS,
              LS,
              qS
            ),
        ...
        if (m !== 0) {
          ...
          l = GS(
            ...
            sum_three(
              scale(_, DS, 2 * V, OS),
              OS,
              scale(scale(4, yS, m, RS), RS, Y, TS),
              TS,
              scale(scale(4, vS, m, RS), RS, -G, NS),
              NS,
              LS,
              qS
            ),
        ...
        if (c !== 0 || h !== 0) {
          ...
          if (c !== 0) {
            ...
            l = GS(
              l,
              sum(scale(g, wS, c, OS), OS, scale(t, NS, 2 * G, LS), LS, qS),
              qS
            );
          ...
          if (h !== 0) {
            ...
            l = GS(
              l,
              sum(scale(y, AS, h, OS), OS, scale(t, NS, 2 * X, LS), LS, qS),
              qS
            );
        ...
        if (f !== 0 || p !== 0) {
          ...
          if (f !== 0) {
            ...
            l = GS(
              l,
              sum(scale(v, kS, f, OS), OS, scale(t, NS, 2 * Y, LS), LS, qS),
              qS
            );
          ...
          if (p !== 0) {
            ...
            l = GS(
              l,
              sum(scale(b, ES, p, OS), OS, scale(t, NS, 2 * H, LS), LS, qS),
              qS
            );
        ...
        if (d !== 0 || m !== 0) {
          ...
          if (d !== 0) {
            ...
            l = GS(
              l,
              sum(scale(x, MS, d, OS), OS, scale(t, NS, 2 * W, LS), LS, qS),
              qS
            );
          ...
          if (m !== 0) {
            ...
            l = GS(
              l,
              sum(scale(_, DS, m, OS), OS, scale(t, NS, 2 * V, LS), LS, qS),
              qS
            );
      ...
      function WS(t, e, n, i, r, s, a, o) {
        ...
        const k =
          (Math.abs(p) + Math.abs(m)) * g +
          (Math.abs(y) + Math.abs(v)) * b +
          (Math.abs(x) + Math.abs(_)) * w;
        const E = fS * k;
        if (A > E || -A > E) {
          return A;
        }
      ...
      function XB(t, e, n, i, r, s, a, o, u, l, c, f, d, h, p, m) {
        ...
        const st = sum(
          sum(
            negate(WB(ZS, JS, iB, rt, nt, -it, X, K, et, yB), yB),
            yB,
            WB(JS, sB, nB, et, it, rt, H, Z, nt, vB),
            vB,
            wB
          ),
          wB,
          sum(
            negate(WB(sB, KS, iB, nt, rt, et, V, J, it, bB), bB),
            bB,
            WB(KS, ZS, nB, it, et, -nt, Q, tt, rt, xB),
            xB,
            AB
          ),
          AB,
        ...
        at +=
          (H * H + Z * Z + nt * nt) *
            (it * ft + rt * dt + et * ct + (z * b + $ * x + S * v)) +
          (Q * Q + tt * tt + rt * rt) *
            (et * lt - nt * dt + it * ut + (S * y - B * x + z * g)) -
          ((X * X + K * K + et * et) *
            (nt * ct - it * ht + rt * lt + (B * v - z * _ + $ * y)) +
            (V * V + J * J + it * it) *
              (rt * ut + et * ht + nt * ft + ($ * g + S * _ + B * b))) +
          2 *
            ((H * A + Z * D + nt * B) * (it * b + rt * x + et * v) +
              (Q * E + tt * F + rt * $) * (et * y - nt * x + it * g) -
              ((X * w + K * M + et * S) * (nt * v - it * _ + rt * y) +
                (V * k + J * C + it * z) * (rt * g + et * _ + nt * b)));
        if (at >= ot || -at >= ot) {
          return at;
        }
      ...
      class ZB {
        ...
        update() {
          ...
          for (let E = 0, M, D; E < this._ids.length; E++) {
            ...
            const a = t[2 * s];
            const o = t[2 * s + 1];
            if (E > 0 && Math.abs(a - M) <= QB && Math.abs(o - D) <= QB)
              continue;
            M = a;
            D = o;
            ...
            while (
              ((c = n[l]),
              OF(a, o, t[2 * l], t[2 * l + 1], t[2 * c], t[2 * c + 1]) >= 0)
            ) {
              l = c;
              if (l === u) {
                l = -1;
            ...
            while (
              ((c = n[d]),
              OF(a, o, t[2 * d], t[2 * d + 1], t[2 * c], t[2 * c + 1]) < 0)
            ) {
            ...
            if (l === u) {
              while (
                ((c = e[l]),
                OF(a, o, t[2 * c], t[2 * c + 1], t[2 * l], t[2 * l + 1]) < 0)
              ) {
        ...
        _hashKey(t, e) {
          return (
            Math.floor(JB(t - this._cx, e - this._cy) * this._hashSize) %
            this._hashSize
          );
        }
        _legalize(t) {
      ...
      function ez(t, e, n, i, r, s, a, o) {
        ...
        const g = d * d + h * h;
        return (
          u * (f * g - m * h) - l * (c * g - m * d) + p * (c * h - f * d) < 0
        );
      }
      ...
      class lz {
        ...
        arc(t, e, n) {
          ...
          else if (Math.abs(this._x1 - i) > uz || Math.abs(this._y1 - r) > uz)
            this._ += 'L' + i + ',' + r;
          if (!n) return;
        ...
        *neighbors(t) {
        ...
        _clip(t) {
          ...
          return this._simplify(
            n[i] || n[i + 1]
              ? this._clipInfinite(t, e, n[i], n[i + 1], n[i + 2], n[i + 3])
        ...
        _clipFinite(t, e) {
          ...
          for (let d = 0; d < n; d += 2) {
            ...
            if (u === 0 && l === 0) {
              ...
              let e, n, d, h, p;
              if (u === 0) {
                if ((e = this._clipSegment(r, s, a, o, u, l)) === null)
                  continue;
                [n, d, h, p] = e;
              } else {
                if ((e = this._clipSegment(a, o, r, s, l, u)) === null)
                  continue;
                [h, p, n, d] = e;
        ...
        _clipSegment(t, e, n, i, r, s) {
          ...
          while (true) {
            ...
            let o,
              ...
              l = r || s;
            if (l & 8)
              (o = t + ((n - t) * (this.ymax - e)) / (i - e)), (u = this.ymax);
            else if (l & 4)
              (o = t + ((n - t) * (this.ymin - e)) / (i - e)), (u = this.ymin);
            else if (l & 2)
              (u = e + ((i - e) * (this.xmax - t)) / (n - t)), (o = this.xmax);
            else
              (u = e + ((i - e) * (this.xmin - t)) / (n - t)), (o = this.xmin);
        ...
        _clipInfinite(t, e, n, i, r, s) {
          ...
          if ((o = this._project(a[a.length - 2], a[a.length - 1], r, s)))
            a.push(o[0], o[1]);
        ...
        _project(t, e, n, i) {
          ...
          if (i < 0) {
            ...
            if ((s = (this.ymin - e) / i) < r)
              (o = this.ymin), (a = t + (r = s) * n);
          } else if (i > 0) {
            if (e >= this.ymax) return null;
            if ((s = (this.ymax - e) / i) < r)
              (o = this.ymax), (a = t + (r = s) * n);
          }
          if (n > 0) {
            if (t >= this.xmax) return null;
            if ((s = (this.xmax - t) / n) < r)
              (a = this.xmax), (o = e + (r = s) * i);
          } else if (n < 0) {
            if (t <= this.xmin) return null;
            if ((s = (this.xmin - t) / n) < r)
              (a = this.xmin), (o = e + (r = s) * i);
          }
          return [a, o];
        }
        _edgecode(t, e) {
      ...
      class vz {
        static from(t, e = pz, n = mz, i) {
          return new vz(
            'length' in t ? bz(t, e, n, i) : Float64Array.from(xz(t, e, n, i))
          );
        }
        constructor(t) {
        ...
        *neighbors(t) {
        ...
        renderPoints(t, e) {
          if (e === undefined && (!t || typeof t.moveTo !== 'function'))
            (e = t), (t = null);
          e = e == undefined ? 2 : +e;
      ...
      function Sz(t, e, n) {
        ...
        for (var f = 0; f < u; f++) {
          c = 0;
          for (var d = 0; d <= r; d++) {
            if (((c << o) | (d < r ? (c = i[f * r + d]) >>> a : 0)) & e[l + d])
              return true;
          }
          l += n;
        }
      ...
      (0, p.B)(Zz, zi, {
        transform(t, e) {
          if (!this._dims) {
            ...
            var n =
              t.modified('fields') ||
              t.fields.some((t) => e.modified(t.fields));
      ...
      function sR(t) {
        return (
          ...
          (t >= 97 && t <= 122) ||
          t === 92 ||
          (t >= 128 && K$.test(String.fromCharCode(t)))
        );
      }
      function aR(t) {
        return (
      ...
      function uO(t) {
        ...
        return {
          ...
          clamp: function (e) {
            ...
            if (e.length > 3)
              (0, p.z3)('Too many arguments to clamp function.');
            const n = e.map(t);
            return (
      ...
      function NO(t, e) {
        ...
        if (BO) {
          ...
          if (c ^ (o * CO < u && u < o * t)) {
            ...
            ((u = ((u + 360) % 360) - 180), c ^ (o * CO < u && u < o * t))
          ) {
            l = -s[1] * mx;
            if (l < EO) EO = l;
          } else {
      ...
      function WO(t) {
        ...
        if ((n = $O.length)) {
          ...
          for (
            a = -Infinity, n = s.length - 1, e = 0, i = s[n];
            e <= n;
            i = r, ++e
          ) {
            r = s[e];
      ...
      function tN(t, e) {
        return t.map((t) =>
          (0, p.X$)(
            e.fields
              ? { values: e.fields.map((e) => DT(e)(t.datum)) }
              : { [RT]: OT(t.datum) },
            e
          )
        );
        ...
        for (; _ < x; ++_) {
          ...
          if (c && f) {
            ...
            if (n) {
              y = o[d] || (o[d] = []);
              y.push(
                (0, p.YO)(f).reduce((t, e, n) => ((t[c[n].field] = e), t), {})
              );
            }
          } else {
            h = RT;
      ...
      function MN(t, e, n, i) {
        if (e[0].type !== e$) {
          (0, p.z3)(
            'First argument to data functions must be a string literal.'
          );
        }
        const r = e[0].value,
          s = wN + r;
      ...
      function DN(t, e, n, i) {
        if (e[0].type !== e$)
          (0, p.z3)('First argument to indata must be a string literal.');
        if (e[1].type !== e$)
          (0, p.z3)('Second argument to indata must be a string literal.');
        const r = e[0].value,
          s = e[1].value,
          a = AN + s;
        if (!(0, p.mQ)(a, i)) {
      ...
      function oL(t, e, n) {
        ...
        if (!(0, p.Kg)(e) && !(0, p.gd)(e))
          (0, p.z3)('Please pass a string or RegExp argument to replace.');
      ...
      function pL(t, e, n) {
        ...
        return !i
          ? undefined
          : (0, p.cy)(e)
            ? (i.invertRange || i.invert)(e)
            : (i.invert || i.invertExtent)(e);
      }
      function mL(t, e) {
        const n = SN(t, (e || this).context);
      ...
      function yL(t, e, n, i, r) {
        ...
        if (!(u - o)) {
          t = (
            t.interpolator
              ? Yl('sequential')().interpolator(t.interpolator())
              : Yl('linear')().interpolate(t.interpolate()).range(t.range())
          ).domain([(o = 0), (u = 1)]);
        } else {
          l = ac(t, o, u);
        }
      ...
      function SL(t, e, n) {
        ...
        return r === undefined || Math.hypot(r[0] - e, r[1] - n) > i
          ? [...t, [e, n]]
          : t;
      }
      function BL(t) {
      ...
      function jL(t, e) {
        ...
        return {
          $expr: (0, p.X$)({ code: r.code }, e.options.ast ? { ast: i } : null),
          $fields: r.fields,
          $params: n
        };
      }
      ...
      function aP(t, e, n) {
        ...
        return (
          e.fn[i] ||
          (e.fn[i] = (0, p.sY)(e.parameterExpression(t.$expr), t.$fields))
        );
      }
      function oP(t, e) {
        const n = 'k:' + t.$key + '_' + !!t.$flat;
        return (
          e.fn[n] || (e.fn[n] = (0, p.Eb)(t.$key, t.$flat, e.expr.codegen))
        );
      }
      function uP(t, e) {
        ...
        return (
          e.fn[n] || (e.fn[n] = (0, p.ZZ)(t.$field, t.$name, e.expr.codegen))
        );
      }
      function lP(t, e) {
      ...
      function mP(t) {
        ...
        r =
          t.target && t.target.$expr
            ? e.eventExpression(t.target.$expr)
            : e.get(t.target);
        if (s && s.$expr) {
          if (s.$params) {
      ...
      function DP(t) {
        const e =
          t._signals.cursor ||
          (t._signals.cursor = t.add({ user: MP, item: null }));
      ...
      function SP(t, e) {
        return arguments.length < 2
          ? FP(this, t).values.value
          : BP.call(this, t, En().remove(p.vN).insert(e));
      }
      function BP(t, e) {
        if (!kn(e)) {
      ...
      function pq(t, e, n, i, r, s) {
        e = e || new i(t.loader());
        return e
          .initialize(n, RP(t), OP(t), TP(t), r, s)
      ...
      function gq(t, e, n, i) {
        const r = new i(t.loader(), mq(t, t.tooltip()))
      ...
      function yq(t, e) {
        ...
        if (t && r !== 'none') {
          e = e
            ? (n._elBind = vq(n, e, true))
            : t.appendChild(tq('form', { class: 'vega-bindings' }));
          n._bind.forEach((t) => {
      ...
      function Nq(t) {
        return this._runtime.getState(
          t || { data: Lq, signals: Pq, recurse: true }
        );
      }
      function Lq(t, e) {
        return (
          e.modified && (0, p.cy)(e.input.value) && !t.startsWith('_:vega:_')
        );
      }
      function Pq(t, e) {
      ...
      function Vq(t, e) {
        return (0, p.mQ)(t._signals, e)
          ? t._signals[e]
          : (0, p.z3)('Unrecognized signal name: ' + (0, p.r$)(e));
      }
      function Qq(t, e) {
      ...
      (0, p.B)(Hq, Si, {
        ...
        padding(t) {
          return arguments.length
            ? this.signal('padding', _q(t))
            : _q(this.signal('padding'));
        },
        autosize(t) {
          return arguments.length
      ...
      const rI = (t) =>
        (0, p.Gv)(t) && !(0, p.cy)(t) ? (0, p.X$)({}, t) : { value: t };
      function sI(t, e, n, i) {
        if (n != null) {
          const r =
            ((0, p.Gv)(n) && !(0, p.cy)(n)) ||
            ((0, p.cy)(n) && n.length && (0, p.Gv)(n[0]));
          if (r) {
            t.update[e] = n;
          } else {
            t[i || 'enter'][e] = { value: n };
      ...
      const SI = (t) =>
        (0, p.Kg)(t) ? (0, p.r$)(t) : t.signal ? `(${t.signal})` : TI(t);
      function BI(t) {
        if (t.gradient != null) {
          return RI(t);
        }
      ...
      function pU(t, e) {
        const n = t.merge
          ...
          : t.stream
            ...
            : t.type
              ? vU
              : (0, p.z3)('Invalid stream specification: ' + (0, p.r$)(t));
        return n(t, e);
      }
      function mU(t) {
        return t === aU ? oU : t || oU;
      ...
      function bU(t, e, n) {
        ...
        if (i) {
          if (i.length !== 2) {
            (0, p.z3)(
              'Stream "between" parameter must have 2 entries: ' + (0, p.r$)(e)
            );
          }
      ...
      function sj(t, e) {
        return !(0, p.Gv)(t)
          ...
          : t.signal
            ? e.signalRef(t.signal)
            : (0, p.z3)('Unsupported object: ' + (0, p.r$)(t));
      }
      function aj(t, e) {
      ...
      function uj(t, e, n) {
        ...
        return t.signal
          ...
          : ((0, p.cy)(t) ? lj : t.fields ? fj : cj)(t, e, n);
      }
      function lj(t, e, n) {
      ...
      function cj(t, e, n) {
        ...
        if (!i) oj(t.data);
        return Vl(e.type)
          ? i.valuesRef(n, t.field, pj(t.sort, false))
          : tc(e.type)
            ? i.domainRef(n, t.field)
            : i.extentRef(n, t.field);
      }
      function fj(t, e, n) {
        const i = t.data,
      ...
      function pj(t, e) {
        if (t) {
          if (!t.field && !t.op) {
            ...
            if (t.op && !nj[t.op]) {
              (0, p.z3)(
                'Multiple domain scales can not be sorted using ' + t.op
              );
            }
          }
        }
      ...
      function vj(t, e) {
        return t.signal
          ? e.signalRef(t.signal)
          : (0, p.Gv)(t)
            ? { interval: sj(t.interval), step: sj(t.step) }
            : sj(t);
      }
      function bj(t, e) {
      ...
      function uG(t, e) {
        ...
        n.gradientLength = () =>
          fU(t.gradientLength, e.gradientLength || e.gradientWidth);
        n.gradientThickness = () =>
          fU(t.gradientThickness, e.gradientThickness || e.gradientHeight);
        n.entryColumns = () =>
          fU(t.columns, fU(e.columns, +n.isVertical(true)));
        return n;
      }
      function lG(t, e) {
      ...
      function pG(t, e) {
        return !e
          ...
          : !t
            ...
            : !(0, p.Gv)(t)
              ? { value: t, offset: e }
              : Object.assign({}, t, { offset: pG(t.offset, e) });
      }
      function mG(t, e) {
        if (e) {
          t.name = e.name;
      ...
      function yG(t, e, n, i, r) {
        ...
        let l,
          ...
          h = '';
        a
          ? ((l = 'y'), (f = 'y2'), (c = 'x'), (d = 'width'), (h = '1-'))
          : ((l = 'x'), (f = 'x2'), (c = 'y'), (d = 'height'));
      ...
      function xG(t, e, n, i) {
        ...
        const p = {
          enter: (l = { opacity: tG }),
          update: (c = { opacity: eG, text: { field: $j } }),
          exit: { opacity: tG }
        };
        aI(p, {
          fill: r('labelColor'),
      ...
      function _G(t, e, n, i, r) {
        ...
        const E = mG(
          { type: aG, role: wI, style: Lj, key: Nj, from: f, encode: g },
          n.labels
        );
        g = {
          enter: {
      ...
      function GG(t, e, n) {
        ...
        if (t.array) {
          if (!(0, p.cy)(i)) {
            (0, p.z3)(
              'Expected an array of sub-parameters. Instead: ' + (0, p.r$)(i)
            );
          }
        ...
        if (!t) {
          ...
          if (i.field != null) {
            ...
            if (!t.data) {
              s = PG(
                (0, p.X$)(
                  { type: 'aggregate', groupby: (0, p.YO)(i.groupby) },
                  i.aggregate
                ),
                n
              );
      ...
      function iY(t, e, n, i, r, s, a) {
        ...
        if (!c) {
          const n = s
            ? { field: JI, pulse: e.countsRef(t, r, s) }
            : { field: t.fieldRef(r), pulse: KI(e.output) };
      ...
      function aY(t, e, n) {
        ...
        const l =
          ...
          n +
          '",' +
          [r, i, s, a, o].map((t) => (t == null ? 'null' : t)).join(',') +
          '),0)';
        const c = jL(l, e);
        u.update = c.$expr;
        u.params = c.$params;
      ...
      function oY(t, e) {
        ...
        u = e.add(
          zU({
            key: g.key || (t.key ? ZI(t.key) : undefined),
            pulse: g.pulse,
            clean: !i
          })
        );
        ...
        const v = KI(u);
        u = c = e.add(
          $U(qI(t.encode, t.type, n, t.style, e, { mod: false, pulse: v }))
        );
      ...
      function uY(t, e, n) {
        const i = t.method,
          ...
          s = t.separation;
        const a = {
          separation: uU(s) ? n.signalRef(s.signal) : s,
          method: uU(i) ? n.signalRef(i.signal) : i,
          pulse: e
        };
        if (t.order) {
      ...
      function lY(t, e) {
        ...
        if (m === jj) {
          ...
          d.count =
            d.count ||
            e.signalRef(`max(2,2*floor((${dU(r.gradientLength())})/100))`);
        } else if (m === Gj) {
      ...
      function vY(t) {
        ...
        return (
          (e && e.title) ||
          (0, p.X$)(
            { name: t.name, interactive: t.interactive, style: t.style },
            e
          )
        );
      }
      ...
      const DY = (t, e, n) =>
        uU(t) ? RY(t.signal, e, n) : t === kj || t === Aj ? e : n;
      const CY = (t, e, n) => (uU(t) ? zY(t.signal, e, n) : MY(t) ? e : n);
      const FY = (t, e, n) => (uU(t) ? $Y(t.signal, e, n) : MY(t) ? n : e);
      const SY = (t, e, n) =>
        uU(t) ? OY(t.signal, e, n) : t === Aj ? { value: e } : { value: n };
      const BY = (t, e, n) =>
        uU(t) ? TY(t.signal, e, n) : t === Ej ? { value: e } : { value: n };
        ...
        if (uU(a)) {
          ...
          for (l of e) {
            u[l] = qY(
              a.signal,
              GY(l, n.axisTop, r, i),
              GY(l, n.axisBottom, r, i),
              GY(l, n.axisLeft, r, i),
              GY(l, n.axisRight, r, i)
            );
          }
        } else {
      ...
      function VY(t, e, n, i, r) {
        ...
        const y = o
          ? { scale: o, range: 0, mult: u, offset: l }
          : { value: 0, offset: l };
        const v = o
          ? { scale: o, range: 1, mult: u, offset: l }
          : (0, p.X$)(g, { mult: u, offset: l });
        c.x = d.x = CY(a, m, y);
        c.y = d.y = FY(a, m, y);
        c.x2 = d.x2 = FY(a, v);
        c.y2 = d.y2 = CY(a, v);
      ...
      function JY(t, e, n, i, r, s) {
        ...
        const y = {
          ...
          field: Nj,
          band: 0.5,
          offset: pG(s.offset, a('labelOffset'))
        };
        const v = CY(
          o,
          p ? ZY(u, c, '"left"', '"right"', '"center"') : { value: 'center' },
          BY(o, 'left', 'right')
        );
        const b = CY(
          o,
          SY(o, 'bottom', 'top'),
          p ? ZY(u, c, '"top"', '"bottom"', '"middle"') : { value: 'middle' }
        );
        ...
        k =
          k || A
            ? {
                ...
                method: k,
                order: 'datum.index',
                bound: A ? { scale: u, orient: o, tolerance: A } : null
              }
            : undefined;
        if (m.align !== v) {
      ...
      function eW(t, e, n, i) {
        const r = (t, e) =>
          t != null
            ? ((n.update[e] = jY(rI(t), n.update[e])), false)
            : !uI(e, i)
              ? true
              : false;
      ...
      function aW(t, e) {
        ...
        const s = e.add(SU());
        const a = e.add(
          $U(qI(sW(t.encode), nG, cI, t.style, e, { pulse: KI(s) }))
        );
        const o = e.add(
          JU({
            layout: e.objectProperty(t.layout),
      ...
      lW.prototype = cW.prototype = {
        ...
        compareRef(t) {
          ...
          const n = (t) =>
            uU(t)
              ? ((e = true), this.signalRef(t.signal))
              : lU(t)
                ? ((e = true), this.exprRef(t.expr))
                : t;
        ...
        sortRef(t) {
          ...
          const e = sU(t.op, t.field),
            n = t.order || nU;
          return n.signal
            ? KI(this.add(BU({ fields: e, orders: this.signalRef(n.signal) })))
            : tU(e, n);
        },
        event(t, e) {
          const n = t + ':' + e;
      ...
      function dW(t) {
        ...
        for (let i = 0; i < e; ++i) {
          ...
          n +=
            (i > 0 ? ',' : '') +
            ((0, p.Gv)(e) ? e.signal || fW(e) : (0, p.r$)(e));
        }
        return n + ']';
      }
      function hW(t) {
        ...
        for (i in t) {
          ...
          e +=
            ...
            (0, p.r$)(i) +
            ':' +
            ((0, p.Gv)(r) ? r.signal || fW(r) : (0, p.r$)(r));
        }
        return e + '}';
      }
      function pW() {
