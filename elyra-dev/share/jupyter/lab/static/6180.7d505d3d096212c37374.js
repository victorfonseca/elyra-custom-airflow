    ...
    15136: (e, t, r) => {
      ...
      async function D() {
        ...
        const j = o.PageConfig.Extension.disabled.map((e) => {
          if (x[e]) {
            console.warn(
              `Plugin ${e} has been renamed to ${x[e]}. Consider updating your config to use the new name.`
            );
            return x[e];
          }
          return e;
        ...
        const m = o.PageConfig.Extension.deferred.map((e) => {
          if (x[e]) {
            console.warn(
              `Plugin id ${e} has been renamed to ${x[e]}. Consider updating your config to use the new name.`
            );
            return x[e];
          }
          return e;
        ...
        var $ =
          (o.PageConfig.getOption('exposeAppInBrowser') || '').toLowerCase() ===
          'true';
        var J =
          (o.PageConfig.getOption('devMode') || '').toLowerCase() === 'true';
        if ($ || J) {
          window.jupyterapp = N;
        }
        if (e.toLowerCase() === 'true') {
