...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [4076],
  {
    24076: (e, n, t) => {
      ...
      a['otherDefinition'] = a['unnamedDefinition']
        .concat(a['namedDefinition'])
        .concat(a['otherParameterizedDefinition']);
      a['definition'] = a['typeParameterizedDefinition'].concat(
        a['otherDefinition']
      );
      a['parameterizedDefinition'] = a['typeParameterizedDefinition'].concat(
        a['otherParameterizedDefinition']
      );
      a['simpleDefinition'] = a['constantSimpleDefinition']
        .concat(a['variableSimpleDefinition'])
        .concat(a['otherSimpleDefinition']);
