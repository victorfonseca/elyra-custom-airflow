...
*/
              ...
              return {
                ...
                range:
                  _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.EditorSelection.cursor(
                    range.from + fromOff + lines.length
                  )
              };
            })
          ),
      ...
      const startCompletionEffect =
        /*@__PURE__*/ _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.StateEffect.define();
      ...
      class FuzzyMatcher {
        constructor(pattern) {
          ...
          for (let p = 0; p < pattern.length; ) {
            let char = (0,
              _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointAt)(
                pattern,
                p
              ),
              size = (0,
              _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointSize)(
                char
              );
            ...
            this.folded.push(
              (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointAt)(
        ...
        match(word) {
          ...
          if (chars.length == 1) {
            ...
            let score =
              firstSize == word.length ? 0 : -100; /* Penalty.NotFull */
            if (first == chars[0]);
          ...
          if (direct == 0)
            return this.ret(
              word.length == this.pattern.length
                ? 0
                : -100 /* Penalty.NotFull */,
          ...
          for (
                ...
                next < 0xff
                  ? (next >= 48 && next <= 57) || (next >= 97 && next <= 122)
                    ...
                    : next >= 65 && next <= 90
                      ...
                      : 0 /* Tp.NonWord */
                  : (ch = (0,
                      _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.fromCodePoint)(
                        next
                      )) != ch.toLowerCase()
                    ? 1 /* Tp.Upper */
                    : ch != ch.toUpperCase()
            ...
            prevType = type;
            i += (0,
            _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointSize)(next);
          }
      ...
      function defaultPositionInfo(view, list, option, info, space, tooltip) {
        let rtl =
            view.textDirection ==
            _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.Direction.RTL,
          left = rtl,
          narrow = false;
        let side = 'top',
          offset,
        ...
        if (infoWidth <= (left ? spaceLeft : spaceRight)) {
          offset =
            Math.max(
              space.top,
              Math.min(option.top, space.bottom - infoHeight)
            ) - list.top;
          maxWidth = Math.min(
            400 /* Info.Width */,
        ...
        content.push(
          {
            render(completion, _s, _v, match) {
              ...
              for (let j = 0; j < match.length; ) {
                ...
                span.appendChild(
                  document.createTextNode(label.slice(from, to))
                );
          ...
          if (this.updateSelectedOption(open.selected)) {
            ...
            if ('then' in infoResult) {
              infoResult
                ...
                .catch((e) =>
                  (0,
                  _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.logException)(
                    this.view.state,
                    e,
                    'completion info'
                  )
      ...
      function getUpdateType(tr, conf) {
        ...
        return typing && conf.activateOnTyping
          ? 4 /* UpdateType.Activate */ | 1 /* UpdateType.Typing */
          : typing
            ? 1 /* UpdateType.Typing */
            : tr.isUserEvent('delete.backward')
              ? 2 /* UpdateType.Backspacing */
              : tr.selection
                ? 8 /* UpdateType.Reset */
                : tr.docChanged
                  ? 16 /* UpdateType.ResetIfTouching */
                  : 0 /* UpdateType.None */;
      }
      class ActiveSource {
        ...
        update(tr, conf) {
          let type = getUpdateType(tr, conf),
            value = this;
          if (
            type & 8 /* UpdateType.Reset */ ||
            (type & 16 /* UpdateType.ResetIfTouching */ && this.touches(tr))
          )
            value = new ActiveSource(value.source, 0 /* State.Inactive */);
          if (
            type & 4 /* UpdateType.Activate */ &&
            value.state == 0 /* State.Inactive */
          )
        ...
        /*@__PURE__*/ _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.StateField.define(
          {
            ...
            provide: (f) => [
              _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.showTooltip.from(
                f,
                (val) => val.tooltip
              ),
              _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.EditorView.contentAttributes.from(
                f,
                (state) => state.attrs
              )
            ]
      ...
      function moveCompletionSelection(forward, by = 'option') {
        return (view) => {
          ...
          if (
            by == 'page' &&
            (tooltip = (0,
            _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.getTooltip)(
              view,
              cState.open.tooltip
            ))
          )
...
*/
      ...
      const completionPlugin =
        /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.ViewPlugin.fromClass(
          class {
            constructor(view) {
              this.view = view;
              ...
              let doesReset = update.transactions.some((tr) => {
                ...
                return (
                  ...
                  ((tr.selection || tr.docChanged) &&
                    !((type & 3) /* UpdateType.SimpleInteraction */))
                );
              });
              ...
              for (let i = 0; i < this.running.length; i++) {
                ...
                if (query.done) {
                  ...
                  let active = new ActiveResult(
                    ...
                    query.done,
                    query.done.from,
                    (_a = query.done.to) !== null && _a !== void 0 ? _a : pos
                  );
      ...
      const windows =
        ...
        /*@__PURE__*/ /Win/.test(navigator.platform);
      const commitCharacters =
        /*@__PURE__*/ _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.Prec.highest(
          /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.EditorView.domEventHandlers(
            {
              keydown(event, view) {
                ...
                let commitChars =
                  option.completion.commitCharacters ||
                  result.result.commitCharacters;
      ...
      const baseTheme =
        /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.EditorView.baseTheme(
          {
      ...
      class FieldRange {
        ...
        map(changes) {
          let from = changes.mapPos(
            this.from,
            -1,
            _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.MapMode.TrackDel
          );
          let to = changes.mapPos(
            this.to,
            1,
            _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.MapMode.TrackDel
          );
            ...
            while (
              ...
              if (found < 0) {
                ...
                while (
                  i < fields.length &&
                  (seq == null ||
                    (fields[i].seq != null && fields[i].seq < seq))
                )
                  i++;
      ...
      let fieldMarker =
        /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.Decoration.widget(
          {
            widget:
              /*@__PURE__*/ new (class extends _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.WidgetType {
                toDOM() {
      ...
      let fieldRange =
        /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.Decoration.mark(
      ...
      class ActiveSnippet {
        constructor(ranges, active) {
          ...
          this.active = active;
          this.deco =
            _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.Decoration.set(
              ranges.map((r) =>
        ...
        /*@__PURE__*/ _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.StateField.define(
          {
            ...
            provide: (f) =>
              _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.EditorView.decorations.from(
                f,
                (val) =>
                  val
                    ? val.deco
                    : _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.Decoration
                        .none
              )
          }
        );
        ...
        return (editor, completion, from, to) => {
          ...
          let spec = {
            changes: {
              ...
              insert:
                _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.Text.of(text)
            },
            scrollIntoView: true,
            annotations: completion
              ? [
                  pickedCompletion.of(completion),
                  _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.Transaction.userEvent.of(
                    'input.complete'
                  )
                ]
              : undefined
          ...
          if (ranges.some((r) => r.field > 0)) {
            ...
            if (editor.state.field(snippetState, false) === undefined)
              effects.push(
                _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.StateEffect.appendConfig.of(
                  [
                    snippetState,
                    addSnippetKeymap,
...
*/
      ...
      const addSnippetKeymap =
        /*@__PURE__*/ _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.Prec.highest(
          /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.keymap.compute(
            [snippetKeymap],
...
*/
        ...
        /*@__PURE__*/ _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.StateEffect.define(
          {
            map(value, mapping) {
              let mapped = mapping.mapPos(
                value,
                -1,
                _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.MapMode
                  .TrackAfter
              );
      ...
      const closedBracket =
        /*@__PURE__*/ new (class extends _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.RangeValue {})();
      ...
      const bracketState =
        /*@__PURE__*/ _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.StateField.define(
          {
            create() {
              return _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.RangeSet
                .empty;
            },
            update(value, tr) {
...
*/
      ...
      const inputHandler =
        /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.EditorView.inputHandler.of(
          (view, from, to, insert) => {
            if (
...
*/
      ...
      function nextChar(doc, pos) {
        ...
        return next.slice(
          0,
          (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointSize)(
            (0, _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.codePointAt)(
              next,
              0
            )
      ...
      function canStartStringAt(state, pos, prefixes) {
        ...
        if (
          charCat(state.sliceDoc(pos - 1, pos)) !=
          _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.CharCategory.Word
        )
          return pos;
        for (let prefix of prefixes) {
          ...
          if (
            ...
            charCat(state.sliceDoc(start - 1, start)) !=
              _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.CharCategory.Word
          )
            return start;
        }
...
*/
      ...
      const completionKeymapExt =
        /*@__PURE__*/ _codemirror_state__WEBPACK_IMPORTED_MODULE_0__.Prec.highest(
          /*@__PURE__*/ _codemirror_view__WEBPACK_IMPORTED_MODULE_1__.keymap.computeN(
            [completionConfig],
            (state) =>
          ...
          let explore = (state, depth) => {
            ...
            return parser.allActions(state, (action) => {
              if (
                ...
                let rDepth =
                  (action >> 19) /* Action.ReduceDepthShift */ - depth;
                if (rDepth > 1) {
    ...
    */
      ...
      function cutAt(tree, pos, side) {
        let cursor = tree.cursor(
          _lezer_common__WEBPACK_IMPORTED_MODULE_0__.IterMode.IncludeAnonymous
        );
        cursor.moveTo(pos);
        for (;;) {
      ...
      class FragmentCursor {
        ...
        nodeAt(pos) {
          ...
          for (;;) {
            ...
            if (
              next instanceof _lezer_common__WEBPACK_IMPORTED_MODULE_0__.Tree
            ) {
              if (start == pos) {
                if (start < this.safeFrom) return null;
                let end = start + next.length;
                if (end <= this.safeTo) {
                  let lookAhead = next.prop(
      ...
      class TokenCache {
        ...
        getMainToken(stack) {
          ...
          main.value =
            pos == p.stream.end ? p.parser.eofTerm : 0 /* Term.Err */;
          return main;
        }
          ...
          if (this.fragments) {
            ...
            for (let cached = this.fragments.nodeAt(start); cached; ) {
              ...
              if (
                !(
                  cached instanceof
                  _lezer_common__WEBPACK_IMPORTED_MODULE_0__.Tree
                ) ||
...
*/
    ...
    */
        ...
        */
          ...
          if (spec.nodeProps)
            for (let propSpec of spec.nodeProps) {
              ...
              if (typeof prop == 'string')
                prop =
                  _lezer_common__WEBPACK_IMPORTED_MODULE_0__.NodeProp[prop];
          ...
          this.nodeSet = new _lezer_common__WEBPACK_IMPORTED_MODULE_0__.NodeSet(
          ...
          this.strict = false;
          this.bufferLength =
            _lezer_common__WEBPACK_IMPORTED_MODULE_0__.DefaultBufferLength;
    ...
    */
        nextStates(state) {
          ...
          for (
            ...
            if (
              (this.data[i + 2] & (65536 /* Action.ReduceFlag */ >> 16)) ==
              0
            ) {
...
//# sourceMappingURL=1423.06e97d15a2a85a2507b2.js.map?v=06e97d15a2a85a2507b2
