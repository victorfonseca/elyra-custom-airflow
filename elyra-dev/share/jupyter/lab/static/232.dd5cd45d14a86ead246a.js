    ...
    /***/ 50232: /***/ (
      ...
      __webpack_require__.d(__webpack_exports__, {
        ARIAGlobalStatesAndProperties: () =>
          /* reexport */ ARIAGlobalStatesAndProperties,
        ...
        DefaultComponentPresentation: () =>
          /* reexport */ DefaultComponentPresentation,
        ...
        DelegatesARIAListboxOption: () =>
          /* reexport */ DelegatesARIAListboxOption,
        ...
        FoundationElementRegistry: () =>
          /* reexport */ FoundationElementRegistry,
        ...
        MatchMediaStyleSheetBehavior: () =>
          /* reexport */ MatchMediaStyleSheetBehavior,
        Menu: () => /* reexport */ Menu,
        ...
        PropertyStyleSheetBehavior: () =>
          /* reexport */ PropertyStyleSheetBehavior,
        ...
        darkModeStylesheetBehavior: () =>
          /* reexport */ darkModeStylesheetBehavior,
        ...
        forcedColorsStylesheetBehavior: () =>
          /* reexport */ forcedColorsStylesheetBehavior,
        ...
        noninteractiveCalendarTemplate: () =>
          /* reexport */ noninteractiveCalendarTemplate,
      ...
      var index_js_ = __webpack_require__(29690); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/patterns/start-end.js
      /**
       ...
       * @public
       */
      const endSlotTemplate = (context, definition) => (0, index_js_.html)`
    <span
        part="end"
...
`;
       ...
       * @public
       */
      const startSlotTemplate = (context, definition) => (0, index_js_.html)`
    <span
        part="start"
...
`;
       ...
       */
      const endTemplate = (0, index_js_.html)`
...
`;
       ...
       */
      const startTemplate = (0, index_js_.html)`
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/accordion-item/accordion-item.template.js
       ...
       * @public
       */
      const accordionItemTemplate = (context, definition) => (0,
      index_js_.html)`
...
***************************************************************************** */
            ...
            if (inject === void 0) {
              ...
              if (designParamtypes === void 0) {
                if (annotationParamtypes === void 0) {
                  ...
                  dependencies =
                    cloneArrayWithPossibleProps(annotationParamtypes);
                }
          ...
          Reflect.defineProperty(target, propertyName, {
            get: function () {
              ...
              if (value === void 0) {
                ...
                if (
                  respectConnection &&
                  this instanceof index_js_.FASTElement
                ) {
        ...
        createInterface(nameConfigOrCallback, configuror) {
          ...
          const respectConnection =
            typeof nameConfigOrCallback === 'string'
              ? false
              : nameConfigOrCallback &&
                  'respectConnection' in nameConfigOrCallback
       ...
       * @public
       */
      const di_all = createAllResolver(
        (key, handler, requestor, searchAncestors) =>
        ...
        getFactory(container) {
          ...
          switch (this.strategy) {
            ...
            case 5 /* alias */:
              return (_c =
                (_b =
                  (_a = container.getResolver(this.state)) === null ||
                  _a === void 0
                    ? void 0
      ...
      class ContainerImpl {
        ...
        registerResolver(key, resolver) {
          ...
          if (result == null) {
            ...
            resolvers.set(
              key,
              new ResolverImpl(key, 4 /* array */, [result, resolver])
            );
          }
          return resolver;
        }
          ...
          case 'string': {
            ...
            for (let i = 0; i < length; ++i) {
              ...
              if (
                (i === 0 &&
                  ch === 0x30 &&
                  length > 1) /* must not start with 0 */ ||
                ch < 0x30 /* 0 */ ||
                ch > 0x39 /* 9 */
              ) {
                return (isNumericLookup[value] = false);
      ...
      class FoundationElement extends index_js_.FASTElement {
        ...
        get $presentation() {
          if (this._presentation === void 0) {
            this._presentation = ComponentPresentation.forTag(
              this.tagName,
              this
            );
          }
      ...
      function applyMixins(derivedCtor, ...baseCtors) {
        const derivedAttributes =
          index_js_.AttributeConfiguration.locate(derivedCtor);
        baseCtors.forEach((baseCtor) => {
          ...
          const baseAttributes =
            index_js_.AttributeConfiguration.locate(baseCtor);
      ...
      __decorate([index_js_.attr], AccordionItem.prototype, 'id', void 0);
      applyMixins(AccordionItem, StartEnd); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/accordion-item/index.js
      ...
      const accordionTemplate = (
        context,
        definition
      ) => /* TODO: deprecate slot name `item` to only support default slot https://github.com/microsoft/fast/issues/5515 */ (0,
      index_js_.html)`
    <template>
...
`;
      ...
      var key_codes = __webpack_require__(74291);
      // EXTERNAL MODULE: ./node_modules/@microsoft/fast-web-utilities/dist/numbers.js
      var numbers = __webpack_require__(83021); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/accordion/accordion.js
      /**
      ...
      class Accordion extends FoundationElement {
        constructor() {
          ...
          this.setItems = () => {
            ...
            if (this.isSingleExpandMode()) {
              const expandedItem =
                (_a = this.findExpandedItem()) !== null && _a !== void 0
                  ? _a
          ...
          this.handleItemKeyDown = (event) => {
            ...
            switch (event.key) {
              ...
              case key_codes /* keyArrowDown */.HX:
                ...
                this.adjust(1);
                break;
              case key_codes /* keyHome */.Tg:
                this.activeItemIndex = 0;
                this.focusItem();
                break;
              case key_codes /* keyEnd */.FM:
        ...
        adjust(adjustment) {
          this.activeItemIndex = (0, numbers /* wrapInBounds */.Vf)(
            0,
       ...
       * @public
       */
      const anchorTemplate = (context, definition) => (0, index_js_.html)`
    <a
        class="control"
        part="control"
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/patterns/aria-global.js
        ...
        constructor() {
          ...
          this.handleUnsupportedDelegatesFocus = () => {
            ...
            if (
              ...
              this.focus = () => {
                var _a;
                (_a = this.control) === null || _a === void 0
                  ? void 0
                  : _a.focus();
              };
            }
      ...
      __decorate([index_js_.attr], Anchor.prototype, 'download', void 0);
      __decorate([index_js_.attr], Anchor.prototype, 'href', void 0);
      __decorate([index_js_.attr], Anchor.prototype, 'hreflang', void 0);
      __decorate([index_js_.attr], Anchor.prototype, 'ping', void 0);
      __decorate([index_js_.attr], Anchor.prototype, 'referrerpolicy', void 0);
      __decorate([index_js_.attr], Anchor.prototype, 'rel', void 0);
      __decorate([index_js_.attr], Anchor.prototype, 'target', void 0);
      __decorate([index_js_.attr], Anchor.prototype, 'type', void 0);
      __decorate(
        [index_js_.observable],
        Anchor.prototype,
      ...
      applyMixins(Anchor, StartEnd, DelegatesARIALink); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/anchor/index.js
       ...
       * @public
       */
      const anchoredRegionTemplate = (context, definition) => (0,
      index_js_.html)`
...
`;
      ...
      var localization = __webpack_require__(30086); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-web-utilities/dist/events.js
      /**
      ...
      const eventWheel = 'wheel'; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/utilities/direction.js
        ...
        constructor() {
          ...
          this.handleIntersection = (entries) => {
            ...
            entries.forEach((entry) => {
              ...
              const thisElementCallbacks = this.observedElements.get(
                entry.target
              );
      ...
      class AnchoredRegion extends FoundationElement {
        constructor() {
          ...
          this.currentDirection = localization /* Direction */.O.ltr;
          ...
          this.applyIntersectionEntries = (entries) => {
            ...
            const viewportEntry = entries.find(
          ...
          this.updateLayout = () => {
            ...
            if (this.horizontalPositioningMode !== 'uncontrolled') {
              const horizontalOptions = this.getPositioningOptions(
              ...
              if (this.horizontalDefaultPosition === 'center') {
                ...
                let dirCorrectedHorizontalDefaultPosition =
            ...
            if (this.verticalPositioningMode !== 'uncontrolled') {
              const verticalOptions = this.getPositioningOptions(
                this.verticalInset
              );
      ...
      __decorate([index_js_.attr], AnchoredRegion.prototype, 'anchor', void 0);
      __decorate(
        [index_js_.attr],
       ...
       * @public
       */
      const FlyoutPosTop = Object.assign(
        Object.assign({}, horizontalAnchorOverlay),
        {
       ...
       * @public
       */
      const FlyoutPosBottom = Object.assign(
        Object.assign({}, horizontalAnchorOverlay),
        {
       ...
       * @public
       */
      const FlyoutPosTallest = Object.assign(
        Object.assign({}, horizontalAnchorOverlay),
        {
       ...
       * @public
       */
      const FlyoutPosBottomFill = Object.assign(
        Object.assign({}, FlyoutPosBottom),
        { verticalScaling: 'fill' }
      );
      /**
       * A region that places itself above or below the anchor
       ...
       * @public
       */
      const FlyoutPosTallestFill = Object.assign(
        Object.assign({}, FlyoutPosTallest),
        { verticalScaling: 'fill' }
       ...
       * @public
       */
      const avatarTemplate = (context, definition) => (0, index_js_.html)`
    <div
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/avatar/avatar.js
      ...
      __decorate([index_js_.attr], Avatar.prototype, 'fill', void 0);
      __decorate([index_js_.attr], Avatar.prototype, 'color', void 0);
      __decorate([index_js_.attr], Avatar.prototype, 'link', void 0);
      __decorate([index_js_.attr], Avatar.prototype, 'shape', void 0); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/avatar/index.js
       ...
       * @public
       */
      const badgeTemplate = (context, definition) => (0, index_js_.html)`
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/badge/badge.js
       ...
       * @public
       */
      const breadcrumbItemTemplate = (context, definition) => (0,
      index_js_.html)`
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/breadcrumb-item/breadcrumb-item.js
      ...
      applyMixins(BreadcrumbItem, StartEnd, DelegatesARIALink); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/breadcrumb-item/index.js
       ...
       * @public
       */
      const breadcrumbTemplate = (context, definition) => (0, index_js_.html)`
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/breadcrumb/breadcrumb.js
       ...
       * @public
       */
      const buttonTemplate = (context, definition) => (0, index_js_.html)`
    <button
        class="control"
        part="control"
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/form-associated/form-associated.js
      ...
      function FormAssociated(BaseCtor) {
        ...
        (0, index_js_.attr)({ mode: 'fromView', attribute: 'value' })(
          C.prototype,
          'initialValue'
        );
        (0, index_js_.attr)({ attribute: 'current-value' })(
          C.prototype,
          'currentValue'
        );
      ...
      function CheckableFormAssociated(BaseCtor) {
        ...
        (0, index_js_.attr)({ attribute: 'checked', mode: 'boolean' })(
          D.prototype,
          'checkedAttribute'
        );
        (0, index_js_.attr)({
          attribute: 'current-checked',
          converter: index_js_.booleanConverter
      ...
      __decorate([index_js_.attr], Button.prototype, 'formaction', void 0);
      __decorate([index_js_.attr], Button.prototype, 'formenctype', void 0);
      __decorate([index_js_.attr], Button.prototype, 'formmethod', void 0);
      __decorate(
        [(0, index_js_.attr)({ mode: 'boolean' })],
        Button.prototype,
        'formnovalidate',
      ...
      __decorate([index_js_.attr], Button.prototype, 'formtarget', void 0);
      __decorate([index_js_.attr], Button.prototype, 'type', void 0);
      __decorate(
        [index_js_.observable],
        Button.prototype,
        'defaultSlottedContent',
      ...
      applyMixins(Button, StartEnd, DelegatesARIAButton); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/button/index.js
      ...
      class DateFormatter {
        ...
        getDate(
          ...
          return new Intl.DateTimeFormat(locale, optionsWithTimeZone).format(
            dateObj
          );
        }
        /**
      ...
      class Calendar extends FoundationElement {
         ...
         */
        getWeekdayText() {
          const weekdayText = this.dateFormatter
            .getWeekdays()
            .map((text) => ({ text }));
        ...
        handleKeydown(event, date) {
          if (event.key === key_codes /* keyEnter */.Mm) {
      ...
      __decorate([index_js_.attr], Calendar.prototype, 'locale', void 0);
      __decorate(
      ...
      const defaultCellContentsTemplate = (0, index_js_.html)`
    <template>
        ${(x) =>
          x.rowData === null ||
...
`;
      const defaultHeaderCellContentsTemplate = (0, index_js_.html)`
    <template>
        ${(x) =>
          x.columnDefinition === null
            ? null
...
`;
      ...
      class DataGridCell extends FoundationElement {
        ...
        handleKeydown(e) {
          ...
          switch (e.key) {
            case key_codes /* keyEnter */.Mm:
            case key_codes /* keyFunction2 */.Ac:
              if (
                this.contains(document.activeElement) &&
          ...
          switch (this.cellType) {
            ...
            case DataGridCellTypes.default:
              if (this.columnDefinition.cellTemplate !== undefined) {
                ...
                this.customCellView = defaultCellContentsTemplate.render(
                  this,
                  this
                );
              }
      ...
      class DataGridRow extends FoundationElement {
        ...
        connectedCallback() {
          ...
          if (this.cellsRepeatBehavior === null) {
            ...
            this.updateItemTemplate();
            this.cellsRepeatBehavior = new index_js_.RepeatDirective(
        ...
        handleKeydown(e) {
          ...
          switch (e.key) {
            case key_codes /* keyArrowLeft */.kT:
              // focus left one cell
              newFocusColumnIndex = Math.max(0, this.focusColumnIndex - 1);
              this.cellElements[newFocusColumnIndex].focus();
              e.preventDefault();
              break;
            case key_codes /* keyArrowRight */.bb:
      ...
      class DataGrid extends FoundationElement {
        ...
        connectedCallback() {
          ...
          this.toggleGeneratedHeader();
          this.rowsRepeatBehavior = new index_js_.RepeatDirective(
            (x) => x.rowsData,
            (x) => x.rowItemTemplate,
            { positioning: true }
          ...
          switch (e.key) {
            ...
            case key_codes /* keyPageDown */.f_:
              ...
              for (
                ...
                const thisRow = this.rowElements[newFocusRowIndex];
                if (
                  thisRow.offsetTop + thisRow.offsetHeight >
                  currentGridBottom
                ) {
       ...
       * @public
       */
      const CalendarTitleTemplate = (0, index_js_.html)`
    <div
        class="title"
        part="title"
        aria-label="${(x) =>
...
`;
        ...
        <template>
            ...
            ${
              definition.title instanceof Function
                ...
                : (_a = definition.title) !== null && _a !== void 0
                  ? _a
                  : ''
            }
            <slot></slot>
    ...
    `;
       ...
       * @public
       */
      const cardTemplate = (context, definition) => (0, index_js_.html)`
    <slot></slot>
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/card/card.js
       ...
       * @public
       */
      class Card extends FoundationElement {} // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/card/index.js
       ...
       * @public
       */
      const checkboxTemplate = (context, definition) => (0, index_js_.html)`
    <template
        role="checkbox"
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/checkbox/checkbox.form-associated.js
       ...
       */
      const canUsedForcedColors =
        /* unused pure expression or super */ null && canUseForcedColors; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/listbox-option/listbox-option.js
      ...
      class ListboxOption extends FoundationElement {
        ...
        get text() {
          var _a, _b;
          return (_b =
            (_a = this.textContent) === null || _a === void 0
              ? void 0
              : _a.replace(/\s+/g, ' ').trim()) !== null && _b !== void 0
            ? _b
            : '';
        }
        set value(next) {
      ...
      __decorate(
        [index_js_.observable],
        DelegatesARIAListboxOption.prototype,
        'ariaChecked',
        void 0
      );
      __decorate(
      ...
      applyMixins(ListboxOption, StartEnd, DelegatesARIAListboxOption); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/listbox/listbox.js
      ...
      class Listbox extends FoundationElement {
        ...
        get firstSelectedOption() {
          var _a;
          return (_a = this.selectedOptions[0]) !== null && _a !== void 0
            ? _a
            : null;
        }
        /**
          ...
          if (!this.disabled) {
            this.selectedIndex =
              (_b =
                (_a = this.options) === null || _a === void 0
                  ? void 0
                  : _a.findIndex((o) => !o.disabled)) !== null && _b !== void 0
                ? _b
                : -1;
          }
        }
        ...
        setDefaultSelectedOption() {
          ...
          this.selectedIndex =
            (_b =
              (_a = this.options) === null || _a === void 0
                ? void 0
                : _a.findIndex((el) => el.defaultSelected)) !== null &&
            _b !== void 0
              ? _b
              : -1;
        }
        ...
        setSelectedOptions() {
          var _a, _b, _c;
          if (
            (_a = this.options) === null || _a === void 0 ? void 0 : _a.length
          ) {
            this.selectedOptions = [this.options[this.selectedIndex]];
            this.ariaActiveDescendant =
              (_c =
                (_b = this.firstSelectedOption) === null || _b === void 0
                  ? void 0
      ...
      __decorate(
        [index_js_.observable],
        DelegatesARIAListbox.prototype,
      ...
      applyMixins(Listbox, DelegatesARIAListbox); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/select/select.options.js
      ...
      __decorate([index_js_.attr], Combobox.prototype, 'placeholder', void 0);
      __decorate(
      ...
      applyMixins(Combobox, StartEnd, DelegatesARIACombobox); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/combobox/combobox.template.js

      /**
       * The template for the {@link @microsoft/fast-foundation#(Combobox:class)} component.
       * @public
       */
      const comboboxTemplate = (context, definition) => (0, index_js_.html)`
    <template
        aria-disabled="${(x) => x.ariaDisabled}"
    ...
    `;
      ...
      class ConstructableStyleSheetTarget extends QueuedStyleSheetTarget {
        constructor(source) {
          ...
          source.$fastController.addStyles(
            index_js_.ElementStyles.create([sheet])
          );
        }
      }
      ...
      class StyleElementStyleSheetTarget {
        constructor(target) {
          ...
          index_js_.Observable.getNotifier(controller).subscribe(
            this,
            'isConnected'
          );
      ...
      class DesignTokenImpl extends index_js_.CSSDirective {
        ...
        notify(element) {
          ...
          if (this.subscribers.has(this)) {
            this.subscribers
              .get(this)
              .forEach((sub) => sub.handleChange(record));
          }
        ...
        handleChange() {
          this.node.store.set(
            ...
            this.observer.observe(
              this.node.target,
              index_js_.defaultExecutionContext
            )
          );
        }
      }
      ...
      class DesignTokenNode {
        constructor(target) {
          ...
          index_js_.Observable.getNotifier(this.store).subscribe(
            this.tokenValueChangeHandler
          );
      ...
      const DesignSystem = Object.freeze({
        ...
        getOrCreate(node) {
          if (!node) {
            if (rootDesignSystem === null) {
              rootDesignSystem =
                DI.getOrCreateDOMContainer().get(designSystemKey);
            }
            return rootDesignSystem;
          }
      ...
      class ElementDefinitionEntry {
        ...
        defineElement(definition) {
          this.definition = new index_js_.FASTElementDefinition(
            this.type,
       ...
       * @public
       */
      const dialogTemplate = (context, definition) => (0, index_js_.html)`
...
`;
      ...
      var index_esm = __webpack_require__(49054); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/dialog/dialog.js
      /**
      ...
      class Dialog extends FoundationElement {
        ...
        static reduceTabbableItems(elements, element) {
          ...
          if (
            (0, index_esm /* isTabbable */.AO)(element) ||
            (Dialog.isFocusableFastElement(element) &&
              Dialog.hasTabbableShadow(element))
          ) {
        ...
        static hasTabbableShadow(element) {
          ...
          return Array.from(
            ...
            return (0, index_esm /* isTabbable */.AO)(x);
          });
        }
      }
      __decorate(
      ...
      class ReflectAttrBehavior {
        ...
        bind(source) {
          AttributeReflectionSubscriptionSet.getOrCreateFor(source).subscribe(
            this
          );
        ...
        unbind(source) {
          AttributeReflectionSubscriptionSet.getOrCreateFor(source).unsubscribe(
            this
          );
        }
        handleChange(source, arg) {
          ...
          if (this.attributes.includes(arg)) {
            index_js_.DOM.setAttribute(
              this.target,
              arg,
              source.getAttribute(arg)
            );
          }
        }
      }
      ...
      function reflectAttributes(...attributes) {
        return new index_js_.AttachedBehaviorHTMLDirective(
          'fast-reflect-attr',
          ReflectAttrBehavior,
          attributes
        );
       ...
       * @public
       */
      const disclosureTemplate = (context, definition) => (0, index_js_.html)`
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/disclosure/disclosure.js
      ...
      __decorate([index_js_.attr], Disclosure.prototype, 'title', void 0); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/disclosure/index.js
       ...
       * @public
       */
      const dividerTemplate = (context, definition) => (0, index_js_.html)`
...
`;
      ...
      var aria = __webpack_require__(67002); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/divider/divider.options.js
      /**
       * Divider roles
       * @public
       */
      ...
      __decorate([index_js_.attr], Divider.prototype, 'role', void 0);
      __decorate([index_js_.attr], Divider.prototype, 'orientation', void 0); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/divider/index.js
       ...
       * @public
       */
      const flipperTemplate = (context, definition) => (0, index_js_.html)`
    <template
        role="button"
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/flipper/flipper.js
      ...
      __decorate([index_js_.attr], Flipper.prototype, 'direction', void 0); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/flipper/index.js
       ...
       * @public
       */
      const listboxOptionTemplate = (context, definition) => (0,
      index_js_.html)`
    <template
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/listbox-option/index.js
      ...
      class ListboxElement extends Listbox {
        ...
        activeIndexChanged(prev, next) {
          ...
          this.ariaActiveDescendant =
            (_b =
              (_a = this.options[next]) === null || _a === void 0
                ? void 0
        ...
        checkFirstOption(preserveChecked = false) {
          if (preserveChecked) {
            ...
            this.options.forEach((o, i) => {
              o.checked = (0, numbers /* inRange */.r4)(
                i,
        ...
        sizeChanged(prev, next) {
          ...
          const size = Math.max(
            ...
            parseInt(
              (_a =
                next === null || next === void 0 ? void 0 : next.toFixed()) !==
                null && _a !== void 0
                ? _a
                : '',
              10
       ...
       * @public
       */
      const listboxTemplate = (context, definition) => (0, index_js_.html)`
    <template
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/listbox/index.js
      ...
      const defaultContentsTemplate = (0, index_js_.html)`
    <template>
        ${(x) => x.value}
    </template>
`;
      ...
      class PickerMenuOption extends FoundationElement {
        ...
        updateView() {
          ...
          this.customView =
            (_b =
              (_a = this.contentsTemplate) === null || _a === void 0
                ? void 0
                : _a.render(this, this)) !== null && _b !== void 0
              ? _b
       ...
       * @alpha
       */
      class PickerList extends FoundationElement {} // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/picker/picker-list-item.js

      const picker_list_item_defaultContentsTemplate = (0, index_js_.html)`
    <template>
        ${(x) => x.value}
    </template>
`;
      ...
      class PickerListItem extends FoundationElement {
        ...
        handleKeyDown(e) {
          ...
          if (e.key === key_codes /* keyEnter */.Mm) {
            this.handleInvoke();
            return false;
          }
          return true;
          ...
          this.customView =
            (_b =
              (_a = this.contentsTemplate) === null || _a === void 0
                ...
                : _a.render(this, this)) !== null && _b !== void 0
              ? _b
              : picker_list_item_defaultContentsTemplate.render(this, this);
        }
        disconnectView() {
          var _a;
          (_a = this.customView) === null || _a === void 0
    ...
    `;
      ...
      const pickerTemplate = (context, definition) => {
        ...
        const defaultMenuOptionTemplate =
          createDefaultMenuOptionTemplate(context);
        return (0, index_js_.html)`
        <template
    ...
    `;
      ...
      const pickerInputTemplate = (0, index_js_.html)`
    <input
        slot="input-region"
        role="combobox"
        type="text"
...
`;
      ...
      class Picker extends FormAssociatedPicker {
        ...
        connectedCallback() {
          ...
          this.inputElementView = pickerInputTemplate.render(
            this,
            this.listElement
          );
        ...
        initialize() {
          this.updateListItemTemplate();
          this.updateOptionTemplate();
          this.itemsRepeatBehavior = new index_js_.RepeatDirective(
            (x) => x.selectedItems,
          ...
          this.optionsRepeatBehavior = new index_js_.RepeatDirective(
        ...
        handleKeyDown(e) {
          ...
          switch (e.key) {
            ...
            case key_codes /* keyDelete */.De:
            case key_codes /* keyBackspace */.R9: {
              ...
              const currentFocusedItemIndex = selectedItems.indexOf(
        ...
        checkMaxItems() {
          ...
          if (
            ...
            if (document.activeElement === this.inputElement) {
              const selectedItemInstances = Array.from(
        ...
        incrementFocusedItem(increment) {
          ...
          const selectedItemsAsElements = Array.from(
            this.listElement.querySelectorAll("[role='listitem']")
          );
          if (document.activeElement !== null) {
            let currentFocusedItemIndex = selectedItemsAsElements.indexOf(
              document.activeElement
            );
            if (currentFocusedItemIndex === -1) {
        ...
        disableMenu() {
          ...
          (_a = this.inputElement) === null || _a === void 0
            ? void 0
            : _a.removeAttribute('aria-activedescendant');
          (_b = this.inputElement) === null || _b === void 0
            ? void 0
            : _b.removeAttribute('aria-owns');
          (_c = this.inputElement) === null || _c === void 0
            ? void 0
            : _c.removeAttribute('aria-expanded');
        }
        /**
        ...
        setFocusedOption(optionIndex) {
          ...
          const focusedOption =
            this.menuElement.optionElements[this.menuFocusIndex];
        ...
        updateListItemTemplate() {
          ...
          this.activeListItemTemplate =
            (_a = this.listItemTemplate) !== null && _a !== void 0
              ? _a
        ...
        updateOptionTemplate() {
          ...
          this.activeMenuOptionTemplate =
            (_a = this.menuOptionTemplate) !== null && _a !== void 0
              ? _a
      ...
      __decorate([index_js_.observable], Picker.prototype, 'query', void 0);
      __decorate(
        [index_js_.observable],
        Picker.prototype,
        'filteredOptionsList',
      ...
      __decorate([index_js_.observable], Picker.prototype, 'menuId', void 0);
      __decorate(
        [index_js_.observable],
        Picker.prototype,
        'selectedListTag',
      ...
      __decorate([index_js_.observable], Picker.prototype, 'menuTag', void 0);
      __decorate(
        [index_js_.observable],
        Picker.prototype,
        'menuFocusIndex',
    ...
    `;
       ...
       * @public
       */
      const menuItemTemplate = (context, definition) => (0, index_js_.html)`
    <template
        role="${(x) => x.role}"
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/menu-item/menu-item.js
      ...
      __decorate([index_js_.attr], MenuItem.prototype, 'role', void 0);
      __decorate(
        [(0, index_js_.attr)({ mode: 'boolean' })],
        MenuItem.prototype,
        'checked',
      ...
      __decorate([index_js_.observable], MenuItem.prototype, 'submenu', void 0);
      applyMixins(MenuItem, StartEnd); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/menu-item/index.js
       ...
       * @public
       */
      const menuTemplate = (context, definition) => (0, index_js_.html)`
    <template
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/menu/menu.js
      ...
      __decorate([index_js_.observable], Menu.prototype, 'items', void 0); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/menu/index.js
       ...
       * @public
       */
      const numberFieldTemplate = (context, definition) => (0, index_js_.html)`
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/text-field/text-field.form-associated.js
      ...
      __decorate([index_js_.attr], TextField.prototype, 'placeholder', void 0);
      __decorate([index_js_.attr], TextField.prototype, 'type', void 0);
      __decorate([index_js_.attr], TextField.prototype, 'list', void 0);
      __decorate(
        [(0, index_js_.attr)({ converter: index_js_.nullableNumberConverter })],
        TextField.prototype,
        'maxlength',
      ...
      __decorate([index_js_.attr], TextField.prototype, 'pattern', void 0);
      __decorate(
        [(0, index_js_.attr)({ converter: index_js_.nullableNumberConverter })],
        TextField.prototype,
        'size',
      ...
      applyMixins(TextField, StartEnd, DelegatesARIATextbox); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/number-field/number-field.form-associated.js
      ...
      class NumberField extends FormAssociatedNumberField {
        ...
        maxChanged(previous, next) {
          ...
          this.max = Math.max(
            next,
            (_a = this.min) !== null && _a !== void 0 ? _a : next
          );
        ...
        minChanged(previous, next) {
          ...
          this.min = Math.min(
            next,
            (_a = this.max) !== null && _a !== void 0 ? _a : next
          );
      ...
      __decorate([index_js_.attr], NumberField.prototype, 'list', void 0);
      __decorate(
        [(0, index_js_.attr)({ converter: index_js_.nullableNumberConverter })],
        NumberField.prototype,
        'maxlength',
      ...
      applyMixins(NumberField, StartEnd, DelegatesARIATextbox); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/number-field/index.js
       ...
       * @public
       */
      const progressRingTemplate = (context, definition) => (0, index_js_.html)`
    <template
        role="progressbar"
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/progress-ring/index.js
       ...
       * @public
       */
      const progressTemplate = (context, defintion) => (0, index_js_.html)`
    <template
        role="progressbar"
        aria-valuenow="${(x) => x.value}"
        aria-valuemin="${(x) => x.min}"
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/progress/index.js
       ...
       * @public
       */
      const radioGroupTemplate = (context, definition) => (0, index_js_.html)`
    <template
        role="radiogroup"
        aria-disabled="${(x) => x.disabled}"
        aria-readonly="${(x) => x.readOnly}"
    ...
    >
        ...
        <div
            class="positioning-region ${(x) => (x.orientation === aria /* Orientation */.t.horizontal ? 'horizontal' : 'vertical')}"
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/radio-group/radio-group.js
      ...
      class RadioGroup extends FoundationElement {
        constructor() {
          ...
          this.shouldMoveOffGroupToTheRight = (index, group, key) => {
            return (
              ...
              key === key_codes /* keyArrowRight */.bb
            );
          };
          ...
          this.keydownHandler = (e) => {
            ...
            switch (key) {
              ...
              case key_codes /* keyArrowRight */.bb:
              case key_codes /* keyArrowDown */.HX: {
                if (this.direction === localization /* Direction */.O.ltr) {
                  this.moveRight(e);
                } else {
                  this.moveLeft(e);
                }
        ...
        setupRadioButtons() {
          ...
          const numberOfCheckedRadios = checkedRadios
      ...
      __decorate([index_js_.attr], RadioGroup.prototype, 'name', void 0);
      __decorate([index_js_.attr], RadioGroup.prototype, 'value', void 0);
      __decorate([index_js_.attr], RadioGroup.prototype, 'orientation', void 0);
      __decorate(
        [index_js_.observable],
        RadioGroup.prototype,
        'childItems',
       ...
       * @public
       */
      const radioTemplate = (context, definition) => (0, index_js_.html)`
    <template
        role="radio"
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/radio/radio.form-associated.js
        ...
        defaultCheckedChanged() {
          ...
          if (this.$fastController.isConnected && !this.dirtyChecked) {
            ...
            if (!this.isInsideRadioGroup()) {
              this.checked =
                (_a = this.defaultChecked) !== null && _a !== void 0
                  ? _a
                  : false;
              this.dirtyChecked = false;
            }
        ...
        connectedCallback() {
          ...
          if (this.checkedAttribute) {
            if (!this.dirtyChecked) {
              ...
              if (!this.isInsideRadioGroup()) {
                this.checked =
                  (_b = this.defaultChecked) !== null && _b !== void 0
                    ? _b
                    : false;
                this.dirtyChecked = false;
              }
      ...
      __decorate([index_js_.observable], Radio.prototype, 'name', void 0);
      __decorate(
        [index_js_.observable],
        Radio.prototype,
        'defaultSlottedNodes',
      ...
      class HorizontalScroll extends FoundationElement {
        ...
        updateScrollStops() {
          ...
          const updatedItems = this.scrollItems.reduce(
        ...
        setFlippers() {
          ...
          (_a = this.previousFlipperContainer) === null || _a === void 0
            ? void 0
            : _a.classList.toggle('disabled', position === 0);
          if (this.scrollStops) {
            const lastStop = Math.abs(
              this.scrollStops[this.scrollStops.length - 1]
            );
            (_b = this.nextFlipperContainer) === null || _b === void 0
              ? void 0
              : _b.classList.toggle(
                  'disabled',
                  this.validateStops(false) &&
        ...
        scrollInView(item, padding = 0, rightPadding) {
          ...
          if (typeof item !== 'number' && item) {
            item = this.scrollItems.findIndex(
              (scrollItem) => scrollItem === item || scrollItem.contains(item)
            );
          }
          if (item !== undefined) {
            rightPadding =
              rightPadding !== null && rightPadding !== void 0
                ? rightPadding
                : padding;
            const {
            ...
            if (
              isBefore ||
              scrollLeft + containerWidth - rightPadding < itemEnd
            ) {
              const stops = [...scrollStops].sort((a, b) =>
                isBefore ? b - a : a - b
              );
              const scrollTo =
                (_a = stops.find((position) =>
                  isBefore
        ...
        scrollToPosition(
          ...
          this.scrolling = true;
          const seconds =
            (_a = this.duration) !== null && _a !== void 0
              ? _a
              : `${Math.abs(newPosition - position) / this.speed}s`;
          ...
          let transitionStop =
            ...
            Math.min(newPosition, maxScrollValue);
          if (this.isRtl) {
            transitionStop =
              this.scrollContainer.scrollLeft +
                            ...
                            <slot name="next-flipper">
                                ${
                                  definition.nextFlipper instanceof Function
                                    ...
                                    : (_b = definition.nextFlipper) !== null &&
                                        _b !== void 0
                                      ? _b
                                      : ''
                                }
...
`;
       ...
       * @public
       */
      const searchTemplate = (context, definition) => (0, index_js_.html)`
    <template
        class="
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/search/search.form-associated.js
      ...
      __decorate([index_js_.attr], Search.prototype, 'placeholder', void 0);
      __decorate([index_js_.attr], Search.prototype, 'list', void 0);
      __decorate(
        [(0, index_js_.attr)({ converter: index_js_.nullableNumberConverter })],
        Search.prototype,
        'maxlength',
      ...
      __decorate([index_js_.attr], Search.prototype, 'pattern', void 0);
      __decorate(
        [(0, index_js_.attr)({ converter: index_js_.nullableNumberConverter })],
        Search.prototype,
        'size',
      ...
      applyMixins(Search, StartEnd, DelegatesARIASearch); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/search/index.js
      ...
      class Select extends FormAssociatedSelect {
        ...
        set value(next) {
          ...
          const prev = `${this._value}`;
          if (
            (_a = this._options) === null || _a === void 0 ? void 0 : _a.length
          ) {
            ...
            const prevSelectedValue =
              (_c =
                (_b = this._options[this.selectedIndex]) === null ||
                _b === void 0
                  ? void 0
            ...
            const nextSelectedValue =
              (_e =
                (_d = this._options[selectedIndex]) === null || _d === void 0
                  ? void 0
            ...
            next =
              (_g =
                (_f = this.firstSelectedOption) === null || _f === void 0
                  ? void 0
        ...
        mousedownHandler(e) {
          ...
          if (
            e.offsetX >= 0 &&
            e.offsetX <=
              ((_a = this.listbox) === null || _a === void 0
                ? void 0
                : _a.scrollWidth)
          ) {
            return super.mousedownHandler(e);
        ...
        setDefaultSelectedOption() {
          ...
          const options =
            (_a = this.options) !== null && _a !== void 0
              ? _a
              : Array.from(this.children).filter(Listbox.slottedOptionFilter);
          const selectedIndex =
        ...
        keydownHandler(e) {
          ...
          return !(
            key === key_codes /* keyArrowDown */.HX ||
            key === key_codes /* keyArrowUp */.I5
          );
        }
        connectedCallback() {
          super.connectedCallback();
      ...
      __decorate([index_js_.volatile], Select.prototype, 'collapsible', null);
      __decorate([index_js_.observable], Select.prototype, 'control', void 0);
      __decorate(
        [(0, index_js_.attr)({ attribute: 'position' })],
        Select.prototype,
        'positionAttribute',
      ...
      __decorate([index_js_.observable], Select.prototype, 'position', void 0);
      __decorate([index_js_.observable], Select.prototype, 'maxHeight', void 0);
      /**
      ...
      applyMixins(Select, StartEnd, DelegatesARIASelect); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/select/select.template.js

      /**
       * The template for the {@link @microsoft/fast-foundation#(Select:class)} component.
       * @public
       */
      const selectTemplate = (context, definition) => (0, index_js_.html)`
    <template
        class="${(x) =>
          [
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/select/index.js
       ...
       * @public
       */
      const skeletonTemplate = (context, definition) => (0, index_js_.html)`
    <template
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/skeleton/skeleton.js
      ...
      __decorate([index_js_.attr], Skeleton.prototype, 'fill', void 0);
      __decorate([index_js_.attr], Skeleton.prototype, 'shape', void 0);
      __decorate([index_js_.attr], Skeleton.prototype, 'pattern', void 0);
      __decorate(
        [(0, index_js_.attr)({ mode: 'boolean' })],
        Skeleton.prototype,
        'shimmer',
       ...
       * @public
       */
      const sliderLabelTemplate = (context, definition) => (0, index_js_.html)`
    <template
        aria-disabled="${(x) => x.disabled}"
        class="${(x) => x.sliderOrientation || aria /* Orientation */.t.horizontal}
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/slider/slider-utilities.js
      ...
      function convertPixelToPercent(
        ...
        let pct = (0, numbers /* limit */.AB)(
          0,
          1,
          (pixelPos - minPosition) / (maxPosition - minPosition)
        );
        if (direction === localization /* Direction */.O.rtl) {
          pct = 1 - pct;
        }
        return pct;
      ...
      const defaultConfig = {
        min: 0,
        max: 0,
        direction: localization /* Direction */.O.ltr,
        orientation: aria /* Orientation */.t.horizontal,
        disabled: false
      };
      /**
      ...
      class SliderLabel extends FoundationElement {
        constructor() {
           ...
           * @internal
           */
          this.sliderDirection = localization /* Direction */.O.ltr;
          this.getSliderConfiguration = () => {
            if (!this.isSliderConfig(this.parentNode)) {
              this.sliderDirection =
                defaultConfig.direction || localization /* Direction */.O.ltr;
              ...
              const { min, max, direction, orientation, disabled } =
                parentSlider;
          ...
          this.positionAsStyle = () => {
            ...
            if (
              this.sliderOrientation === aria /* Orientation */.t.horizontal
            ) {
              return direction === localization /* Direction */.O.rtl
      ...
      __decorate([index_js_.attr], SliderLabel.prototype, 'position', void 0);
      __decorate(
       ...
       * @public
       */
      const sliderTemplate = (context, definition) => (0, index_js_.html)`
    <template
        role="slider"
        class="${(x) => (x.readOnly ? 'readonly' : '')}
        ${(x) => x.orientation || aria /* Orientation */.t.horizontal}"
        tabindex="${(x) => (x.disabled ? null : 0)}"
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/slider/slider.form-associated.js
      ...
      class Slider extends FormAssociatedSlider {
        constructor() {
          ...
          this.keypressHandler = (e) => {
            ...
            if (e.key === key_codes /* keyHome */.Tg) {
              e.preventDefault();
              this.value = `${this.min}`;
            } else if (e.key === key_codes /* keyEnd */.FM) {
              e.preventDefault();
              this.value = `${this.max}`;
            } else if (!e.shiftKey) {
              switch (e.key) {
          ...
          this.convertToConstrainedValue = (value) => {
            ...
            const roundedConstrainedValue = Math.round(
              constrainedValue / this.step
            );
        ...
        increment() {
          const newVal =
            this.direction !== localization /* Direction */.O.rtl &&
            this.orientation !== aria /* Orientation */.t.vertical
              ? Number(this.value) + Number(this.step)
              : Number(this.value) - Number(this.step);
          const incrementedVal = this.convertToConstrainedValue(newVal);
          const incrementedValString =
            incrementedVal < Number(this.max)
              ? `${incrementedVal}`
              : `${this.max}`;
        ...
        decrement() {
          ...
          const decrementedValString =
            decrementedVal > Number(this.min)
              ? `${decrementedVal}`
              : `${this.min}`;
        ...
        setThumbPositionForOrientation(direction) {
          ...
          if (this.orientation === aria /* Orientation */.t.horizontal) {
      ...
      __decorate([index_js_.observable], Slider.prototype, 'direction', void 0);
      __decorate(
        [index_js_.observable],
        Slider.prototype,
        'isDragging',
      ...
      __decorate([index_js_.observable], Slider.prototype, 'position', void 0);
      __decorate(
        [index_js_.observable],
        Slider.prototype,
        'trackWidth',
      ...
      __decorate([index_js_.observable], Slider.prototype, 'trackLeft', void 0);
      __decorate(
        [index_js_.observable],
        Slider.prototype,
        'trackMinHeight',
      ...
      __decorate([index_js_.attr], Slider.prototype, 'orientation', void 0);
      __decorate([index_js_.attr], Slider.prototype, 'mode', void 0); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/slider/index.js
       ...
       * @public
       */
      const switchTemplate = (context, definition) => (0, index_js_.html)`
    <template
        role="switch"
        aria-checked="${(x) => x.checked}"
        aria-disabled="${(x) => x.disabled}"
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/switch/switch.form-associated.js
       ...
       * @public
       */
      const tabPanelTemplate = (context, definition) => (0, index_js_.html)`
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/tab-panel/tab-panel.js
       ...
       * @public
       */
      class TabPanel extends FoundationElement {} // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/tab-panel/index.js
       ...
       * @public
       */
      const tabTemplate = (context, definition) => (0, index_js_.html)`
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/tab/tab.js
       ...
       * @public
       */
      const tabsTemplate = (context, definition) => (0, index_js_.html)`
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/tabs/tabs.js
      ...
      class Tabs extends FoundationElement {
          ...
          this.adjustForward = (e) => {
            ...
            while (index < group.length && group.length > 1) {
              if (this.isFocusableElement(group[index])) {
                ...
                this.activetab &&
                index === group.indexOf(this.activetab)
              ) {
                break;
              } else if (index + 1 >= group.length) {
                index = 0;
        ...
        getTabIds() {
          return this.tabs.map((tab) => {
            var _a;
            return (_a = tab.getAttribute('id')) !== null && _a !== void 0
              ? _a
              : `tab-${uniqueId()}`;
          });
        }
        getTabPanelIds() {
          return this.tabpanels.map((tabPanel) => {
            var _a;
            return (_a = tabPanel.getAttribute('id')) !== null && _a !== void 0
              ? _a
              : `panel-${uniqueId()}`;
          });
        }
        ...
        animateActiveIndicator() {
          ...
          const translateProperty = this.isHorizontal()
            ? 'translateX'
            : 'translateY';
          const offsetProperty = this.isHorizontal()
            ? 'offsetLeft'
            : 'offsetTop';
        ...
        adjust(adjustment) {
          ...
          const nextTabIndex = (0, numbers /* limit */.AB)(
            0,
      ...
      __decorate([index_js_.attr], Tabs.prototype, 'orientation', void 0);
      __decorate([index_js_.attr], Tabs.prototype, 'activeid', void 0);
      __decorate([index_js_.observable], Tabs.prototype, 'tabs', void 0);
      __decorate([index_js_.observable], Tabs.prototype, 'tabpanels', void 0);
      __decorate(
        [(0, index_js_.attr)({ mode: 'boolean' })],
        Tabs.prototype,
        'activeindicator',
      ...
      applyMixins(Tabs, StartEnd); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/tabs/index.js
       ...
       * @public
       */
      const textAreaTemplate = (context, definition) => (0, index_js_.html)`
    <template
        class="
            ${(x) => (x.readOnly ? 'readonly' : '')}
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/text-area/text-area.form-associated.js
      ...
      __decorate([index_js_.attr], TextArea.prototype, 'resize', void 0);
      __decorate(
        [(0, index_js_.attr)({ mode: 'boolean' })],
        TextArea.prototype,
        'autofocus',
      ...
      __decorate([index_js_.attr], TextArea.prototype, 'list', void 0);
      __decorate(
        [(0, index_js_.attr)({ converter: index_js_.nullableNumberConverter })],
        TextArea.prototype,
        'maxlength',
      ...
      __decorate([index_js_.attr], TextArea.prototype, 'name', void 0);
      __decorate([index_js_.attr], TextArea.prototype, 'placeholder', void 0);
      __decorate(
        [
          (0, index_js_.attr)({
            converter: index_js_.nullableNumberConverter,
      ...
      applyMixins(TextArea, DelegatesARIATextbox); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/text-area/index.js
       ...
       * @public
       */
      const textFieldTemplate = (context, definition) => (0, index_js_.html)`
    <template
        class="
            ${(x) => (x.readOnly ? 'readonly' : '')}
        "
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/text-field/index.js
       ...
       * @public
       */
      const toolbarTemplate = (context, definition) => (0, index_js_.html)`
    <template
        aria-label="${(x) => x.ariaLabel}"
        aria-labelledby="${(x) => x.ariaLabelledby}"
        aria-orientation="${(x) => x.orientation}"
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/toolbar/toolbar.js
      ...
      class Toolbar extends FoundationElement {
        ...
        setFocusedElement(activeIndex = this.activeIndex) {
          ...
          this.activeIndex = activeIndex;
          this.setFocusableElements();
          (_a = this.focusableElements[this.activeIndex]) === null ||
          _a === void 0
            ? void 0
            : _a.focus();
        }
      ...
      __decorate([index_js_.attr], Toolbar.prototype, 'orientation', void 0);
      __decorate(
        [index_js_.observable],
        Toolbar.prototype,
        'slottedItems',
      ...
      applyMixins(Toolbar, StartEnd, DelegatesARIAToolbar); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/toolbar/index.js
    ...
    `;
      ...
      __decorate([index_js_.attr], Tooltip.prototype, 'anchor', void 0);
      __decorate([index_js_.attr], Tooltip.prototype, 'delay', void 0);
      __decorate([index_js_.attr], Tooltip.prototype, 'position', void 0);
      __decorate(
        [(0, index_js_.attr)({ attribute: 'auto-update-mode' })],
        Tooltip.prototype,
        'autoUpdateMode',
       ...
       * @public
       */
      const treeItemTemplate = (context, definition) => (0, index_js_.html)`
    <template
        role="treeitem"
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/tree-item/tree-item.js
      ...
      __decorate([index_js_.observable], TreeItem.prototype, 'items', void 0);
      __decorate([index_js_.observable], TreeItem.prototype, 'nested', void 0);
      __decorate(
        [index_js_.observable],
        TreeItem.prototype,
      ...
      applyMixins(TreeItem, StartEnd); // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/tree-item/index.js
       ...
       * @public
       */
      const treeViewTemplate = (context, definition) => (0, index_js_.html)`
    <template
        role="tree"
...
`; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/tree-view/tree-view.js
      ...
      class TreeView extends FoundationElement {
        ...
        checkForNestedItems() {
          return this.slottedTreeItems.some((node) => {
            return (
              isTreeItemElement(node) && node.querySelector("[role='treeitem']")
            );
          });
        }
        getVisibleNodes() {
       ...
       * @public
       */
      const lightModeStylesheetBehavior = MatchMediaStyleSheetBehavior.with(
      ...
      class PropertyStyleSheetBehavior {
        ...
        bind(elementInstance) {
          index_js_.Observable.getNotifier(elementInstance).subscribe(
            this,
            this.propertyName
          );
         ...
         */
        unbind(source) {
          index_js_.Observable.getNotifier(source).unsubscribe(
            this,
            this.propertyName
          );
          source.$fastController.removeStyles(this.styles);
       ...
       * @public
       */
      const disabledCursor = 'not-allowed'; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/utilities/style/display.js
       ...
       * @public
       */
      const focusVisible = canUseFocusVisible() ? 'focus-visible' : 'focus'; // CONCATENATED MODULE: ./node_modules/@microsoft/fast-foundation/dist/esm/utilities/style/index.js
...
//# sourceMappingURL=232.dd5cd45d14a86ead246a.js.map?v=dd5cd45d14a86ead246a
