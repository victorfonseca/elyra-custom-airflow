    ...
    85987: (e, t, r) => {
      ...
      function n(e) {
        ...
        function T(t) {
          ...
          if (e.globalVars && !L(t, r.globalVars))
            r.globalVars = new I(t, r.globalVars);
        }
        function N(e, t) {
          if (!t) {
            return null;
        ...
        function q(e, t) {
          ...
          if (e == 'if') {
            if (
              ...
              j.state.cc[j.state.cc.length - 1] == D
            )
              j.state.cc.pop()();
          ...
          if (e == 'switch')
            return A($('form'), B, F('{'), $('}', 'switch'), C, se, D, D, _);
        ...
        function ne(e, t) {
          if (e == 'async') {
            ...
            if (
              ...
              (n = j.stream.match(/^\s*:\s*/, false))
            )
              j.state.fatArrowAt = j.stream.pos + n[0].length;
            return A(ae);
        ...
        function we(e, t) {
          if (
            (e == 'variable' && j.stream.match(/^\s*[?:]/, false)) ||
            t == '?'
          )
            return A(we);
          if (e == ':') return A(de);
        ...
        function Pe(e, t) {
          if (
            e == 'async' ||
            (e == 'variable' &&
              (t == 'static' || t == 'get' || t == 'set' || (i && V(t))) &&
              j.stream.match(/^\s+#?[\w$\xa1-\uffff]/, false))
          ) {
            j.marked = 'keyword';
            return A(Pe);
          }
        ...
        return {
          ...
          indent: function (r, n, i) {
            ...
            if (l == 'vardef')
              return (
                u.indented +
                (r.lastType == 'operator' || r.lastType == ','
                  ? u.info.length + 1
                  : 0)
              );
              ...
              return u.indented + (Ye(r, n) ? t || i.unit : 0);
        ...
        if (t.isAttrs) {
          ...
          if (t.inAttributeName && e.match(/^[^=,\)!]+/)) {
            if (e.peek() === '=' || e.peek() === '!') {
              ...
              if (
                t.lastTag === 'script' &&
                e.current().trim().toLowerCase() === 'type'
              ) {
          ...
          var r = n.javascript.token(e, t.jsState);
          if (
            t.attrsNest.length === 0 &&
            (r === 'string' || r === 'variable' || r === 'keyword')
          ) {
            try {
              Function(
                '',
