  ...
  [6492],
  {
    /***/ 46492: /***/ (
      ...
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        ...
        /* harmony export */ keywordCompletionSource: () =>
          /* binding */ keywordCompletionSource,
        /* harmony export */ schemaCompletionSource: () =>
          /* binding */ schemaCompletionSource,
        /* harmony export */ sql: () => /* binding */ sql
        /* harmony export */
      });
      /* harmony import */ var _codemirror_language__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(4452);
      /* harmony import */ var _codemirror_language__WEBPACK_IMPORTED_MODULE_0___default =
        /*#__PURE__*/ __webpack_require__.n(
          _codemirror_language__WEBPACK_IMPORTED_MODULE_0__
        );
      /* harmony import */ var _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(45145);
      /* harmony import */ var _lezer_highlight__WEBPACK_IMPORTED_MODULE_1___default =
        /*#__PURE__*/ __webpack_require__.n(
          _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__
        );
      /* harmony import */ var _lezer_lr__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(27421);
      /* harmony import */ var _codemirror_autocomplete__WEBPACK_IMPORTED_MODULE_3__ =
        __webpack_require__(75128);
      ...
      function readLiteral(input, endQuote, backslashEscapes) {
        for (let escaped = false; ; ) {
          ...
          escaped =
            backslashEscapes && !escaped && input.next == 92 /* Ch.Backslash */;
          input.advance();
        }
      }
      ...
      function readPLSQLQuotedLiteral(input, openDelim) {
        ...
        for (;;) {
          if (input.next < 0) return;
          if (
            input.next == closeDelim &&
            input.peek(1) == 39 /* Ch.SingleQuote */
          ) {
            input.advance(2);
            return;
          }
      ...
      function inString(ch, str) {
        for (let i = 0; i < str.length; i++)
          if (str.charCodeAt(i) == ch) return true;
        return false;
      }
      const Space = ' \t\r\n';
      ...
      function tokensFor(d) {
        return new _lezer_lr__WEBPACK_IMPORTED_MODULE_2__ /* .ExternalTokenizer */.Lu(
          (input) => {
            var _a;
            let { next } = input;
            input.advance();
      ...
      // This file was generated by lezer-generator. You probably shouldn't edit it.
      const parser$1 =
        /*@__PURE__*/ _lezer_lr__WEBPACK_IMPORTED_MODULE_2__ /* .LRParser */.U1.deserialize(
          {
            version: 14,
            states:
      ...
      function sourceContext(state, startPos) {
        let pos = (0,
        _codemirror_language__WEBPACK_IMPORTED_MODULE_0__.syntaxTree)(
          state
        ).resolveInner(startPos, -1);
      ...
      function nameCompletion(label, type, idQuote, idCaseInsensitive) {
        if (
          new RegExp('^[a-z_][a-z_\\d]*$', idCaseInsensitive ? 'i' : '').test(
            label
          )
        )
          return { label, type };
      ...
      function completeFromSchema(
        ...
        let defaultSchema = defaultSchemaName
          ? top.child(defaultSchemaName)
          : null;
        ...
        if (defaultTableName)
          top.addCompletions(
            (defaultSchema || top).child(defaultTableName).list
          );
        return (context) => {
      ...
      function completeKeywords(keywords, upperCase, build) {
        ...
        return (0,
        _codemirror_autocomplete__WEBPACK_IMPORTED_MODULE_3__ /* .ifNotIn */.Ar)(
          [
            'QuotedIdentifier',
            'SpecialVar',
            'String',
          ...
          (0,
          _codemirror_autocomplete__WEBPACK_IMPORTED_MODULE_3__ /* .completeFromList */.et)(
            completions
          )
        );
      }
      ...
      let parser = /*@__PURE__*/ parser$1.configure({
        props: [
          /*@__PURE__*/ _codemirror_language__WEBPACK_IMPORTED_MODULE_0__.indentNodeProp.add(
            {
              Statement: /*@__PURE__*/ (0,
              _codemirror_language__WEBPACK_IMPORTED_MODULE_0__.continuedIndent)()
            }
          ),
          ...
          /*@__PURE__*/ (0,
          _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.styleTags)({
            ...
            Builtin:
              /*@__PURE__*/ _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.standard(
                _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.name
              ),
            ...
            QuotedIdentifier:
              /*@__PURE__*/ _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.special(
            ...
            LineComment:
              _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.lineComment,
            BlockComment:
              _lezer_highlight__WEBPACK_IMPORTED_MODULE_1__.tags.blockComment,
            Operator:
...
*/
    ...
    */
        static define(spec) {
          ...
          let language =
            _codemirror_language__WEBPACK_IMPORTED_MODULE_0__.LRLanguage.define(
              {
                name: 'sql',
...
*/
      function sql(config = {}) {
        ...
        return new _codemirror_language__WEBPACK_IMPORTED_MODULE_0__.LanguageSupport(
          lang.language,
          [
...
//# sourceMappingURL=6492.80d572c70731df4ff119.js.map?v=80d572c70731df4ff119
