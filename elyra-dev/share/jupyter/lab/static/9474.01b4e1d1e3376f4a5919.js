    ...
    59474: (e, t, n) => {
      ...
      function c(e, t) {
        ...
        if (n == '<' && !e.match(/^[\s\u00a0=]/, false)) {
          ...
          var i = e.current();
          if (l.test(i)) return null;
          else if (a.test(i)) return 'meta';
      ...
      const p = {
        ...
        indent: function (e, t, n) {
          ...
          else if (i.align) return i.col + (l ? 0 : 1);
          else return i.indent + (l ? 0 : n.unit);
        },
