      ...
      e.exports = (function (e) {
        ...
        function (e, r, t) {
          ...
          p.propTypes = {
            ...
            highlightClassName: s['default'].oneOfType([
              s['default'].object,
              s['default'].string
            ]),
            ...
            searchWords: s['default'].arrayOf(
              s['default'].oneOfType([
                s['default'].string,
                s['default'].instanceOf(RegExp)
              ])
            ).isRequired,
                ...
                function t(r, t, n, a, i) {
                  ...
                  return new h(
                    'Invalid ' +
                      ...
                      u +
                      '` ' +
                      ('supplied to `' + n + '`, expected one of ' + s + '.')
                  );
                }
                return y(t);
              }
