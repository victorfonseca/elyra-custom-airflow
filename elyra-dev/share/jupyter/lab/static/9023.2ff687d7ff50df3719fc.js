    ...
    99023: (e, t, n) => {
      ...
      var a = function (e) {
        ...
        if (/[{}\(\),\.;\[\]]/.test(t)) {
          ...
          var n = e.current();
          if (l.test(n)) return 'builtin';
          if (c.test(n)) return 'def';
          if (u.test(n) || p.test(n)) return 'keyword';
          return 'variable';
        }
      };
      ...
      const f = {
        ...
        token: function (e, t) {
          ...
          if (o === '(') {
            ...
            if (t.context && o === t.context.type) {
              s(t);
            }
          } else if (o === '.' && t.context && t.context.type === 'pattern') {
            s(t);
        ...
        indent: function (e, t, n) {
          ...
          var a = e.context;
          if (/[\]\}]/.test(r)) {
            while (a && a.type === 'pattern') {
              a = a.prev;
            }
          }
          var i = a && r === a.type;
          if (!a) return 0;
          if (a.type === 'keywords') return null;
          if (a.align) return a.col + (i ? 0 : 1);
          return a.indent + (i ? 0 : n.unit);
        }
      };
    }
  }
