...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [2633, 1039],
  {
    /***/ 71471: /***/ (__unused_webpack_module, exports) => {
    ...
    /***/ 56441: /***/ function (
      ...
      var Configuration = (function () {
        ...
        Configuration._create = function (name, config) {
          ...
          var priority =
            config.priority ||
            PrioritizedList_js_1.PrioritizedList.DEFAULTPRIORITY;
          var init = config.init
            ? this.makeProcessor(config.init, priority)
            : null;
          ...
          var postprocessors = (config.postprocessors || []).map(
            function (post) {
      ...
      (function (ConfigurationHandler) {
        ...
        (ConfigurationHandler =
          exports.ConfigurationHandler || (exports.ConfigurationHandler = {}))
      );
      var ParserConfiguration = (function () {
        function ParserConfiguration(packages, parsers) {
          ...
          try {
            for (
              var _c = __values(packages.slice().reverse()), _d = _c.next();
              !_d.done;
              _d = _c.next()
            ) {
              var pkg = _d.value;
          ...
          try {
            for (
              var _e = __values(this.configurations), _f = _e.next();
              !_f.done;
              _f = _e.next()
            ) {
              var _g = _f.value,
        ...
        ParserConfiguration.prototype.config = function (jax) {
          ...
          try {
            for (
              var _b = __values(this.configurations), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var config = _c.value;
        ...
        ParserConfiguration.prototype.add = function (name, jax, options) {
          ...
          try {
            for (
              var _b = __values(Object.keys(config.items)), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var kind = _c.value;
        ...
        ParserConfiguration.prototype.getPackage = function (name) {
          ...
          if (config && this.parsers.indexOf(config.parser) < 0) {
            throw Error(
              'Package '.concat(name, " doesn't target the proper parser")
            );
          }
          return config;
        };
        ParserConfiguration.prototype.append = function (config, priority) {
          ...
          if (config.configMethod) {
            this.configMethod.add(
              config.configMethod[0],
              config.configMethod[1]
            );
          }
        ...
        ParserConfiguration.prototype.addFilters = function (jax, config) {
          ...
          try {
            for (
              var _c = __values(config.preprocessors), _d = _c.next();
              !_d.done;
              _d = _c.next()
            ) {
          ...
          try {
            for (
              var _f = __values(config.postprocessors), _g = _f.next();
              !_g.done;
              _g = _f.next()
            ) {
    ...
    /***/ 18437: /***/ function (
      ...
      var SubHandler = (function () {
        ...
        SubHandler.prototype.add = function (maps, fallback, priority) {
          ...
          try {
            for (
              var _b = __values(maps.slice().reverse()), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var name_1 = _c.value;
        ...
        SubHandler.prototype.parse = function (input) {
          ...
          try {
            for (
              var _b = __values(this._configuration), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
      ...
      var SubHandlers = (function () {
        ...
        SubHandlers.prototype.add = function (handlers, fallbacks, priority) {
          ...
          try {
            for (
              var _b = __values(Object.keys(handlers)), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var key = _c.value;
        ...
        SubHandlers.prototype.retrieve = function (name) {
          ...
          try {
            for (
              var _b = __values(this.map.values()), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
    ...
    /***/ 72691: /***/ function (
      ...
      var mo_js_1 = __webpack_require__(38669);
      var NodeUtil;
      (function (NodeUtil) {
        var attrs = new Map([
          ['autoOP', true],
        ...
        function setProperties(node, properties) {
          ...
          try {
            for (
              var _b = __values(Object.keys(properties)), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var name_1 = _c.value;
        ...
        function removeProperties(node) {
          ...
          node.removeProperty.apply(
            node,
            __spreadArray([], __read(properties), false)
          );
        }
        ...
        function isNode(item) {
          return (
            item instanceof MmlNode_js_1.AbstractMmlNode ||
            item instanceof MmlNode_js_1.AbstractMmlEmptyNode
          );
        }
        ...
        function getForm(node) {
          ...
          try {
            for (
              var forms_1 = __values(forms), forms_1_1 = forms_1.next();
              !forms_1_1.done;
      ...
      (function (ParseUtil) {
        ...
        function fixedFence(configuration, open, mml, close) {
          ...
          if (NodeUtil_js_1.default.isType(mml, 'mrow')) {
            NodeUtil_js_1.default.appendChildren(
              mrow,
              NodeUtil_js_1.default.getChildren(mml)
            );
          } else {
            ...
            if (
              ...
              (!NodeUtil_js_1.default.isType(child, 'TeXAtom') ||
                (NodeUtil_js_1.default.getChildren(child)[0] &&
                  NodeUtil_js_1.default.getChildren(
                    NodeUtil_js_1.default.getChildren(child)[0]
                  ).length))
            ) {
              if (
                NodeUtil_js_1.default.isEmbellished(child) ||
                (NodeUtil_js_1.default.isType(child, 'TeXAtom') &&
                  NodeUtil_js_1.default.getTexClass(child) ===
          ...
          if (text.match(/\\?[${}\\]|\\\(|\\(eq)?ref\s*\{/)) {
            while (i < text.length) {
              ...
              if (c === '$') {
                ...
                if (match === '}' && braces === 0) {
                  var atom = new TexParser_js_1.default(
                    text.slice(k, i),
                    {},
                    parser.configuration
                  ).mml();
        ...
        function internalText(parser, text, def) {
          text = text
            .replace(/^\s+/, Entities_js_1.entities.nbsp)
            .replace(/\s+$/, Entities_js_1.entities.nbsp);
        ...
        function underOver(parser, base, script, pos, stack) {
          ...
          if (
            ...
            NodeUtil_js_1.default.isEmbellished(base)
          ) {
            NodeUtil_js_1.default.setProperties(
              NodeUtil_js_1.default.getCoreMO(base),
              { lspace: 0, rspace: 0 }
            );
        ...
        function checkMovableLimits(base) {
          var symbol = NodeUtil_js_1.default.isType(base, 'mo')
            ? NodeUtil_js_1.default.getForm(base)
            : null;
          if (
        ...
        function addArgs(parser, s1, s2) {
          ...
          if (
            s1.length + s2.length >
            parser.configuration.options['maxBuffer']
          ) {
            throw new TexError_js_1.default(
              'MaxBufferSize',
        ...
        function copyNode(node, parser) {
          ...
          tree.walkTree(function (n) {
            ...
            try {
              for (
                var lists_1 = __values(lists), lists_1_1 = lists_1.next();
                !lists_1_1.done;
                lists_1_1 = lists_1.next()
              ) {
        ...
        function keyvalOptions(attrib, allowed, error) {
          ...
          if (allowed) {
            try {
              for (
                var _b = __values(Object.keys(def)), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
                var key = _c.value;
        ...
        function readKeyval(text) {
          ...
          var end, key, val;
          while (rest) {
            (_a = __read(readValue(rest, ['=', ',']), 3)),
              (key = _a[0]),
              (end = _a[1]),
              (rest = _a[2]);
            if (end === '=') {
              (_b = __read(readValue(rest, [',']), 3)),
                (val = _b[0]),
                (end = _b[1]),
                (rest = _b[2]);
    ...
    /***/ 27151: /***/ (__unused_webpack_module, exports) => {
      Object.defineProperty(exports, '__esModule', { value: true });
    ...
    /***/ 80209: /***/ function (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.EnvironmentMap =
        exports.CommandMap =
        exports.MacroMap =
        exports.DelimiterMap =
        exports.CharacterMap =
        exports.AbstractParseMap =
        exports.RegExpMap =
      ...
      var CharacterMap = (function (_super) {
        ...
        function CharacterMap(name, parser, json) {
          ...
          try {
            for (
              var _b = __values(Object.keys(json)), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var key = _c.value;
      ...
      var MacroMap = (function (_super) {
          ...
          try {
            for (
              ...
              var _d = __read(typeof value === 'string' ? [value] : value),
                func = _d[0],
                attrs = _d.slice(1);
              var character = new Symbol_js_1.Macro(
                key,
                functionMap[func],
                attrs
              );
        ...
        MacroMap.prototype.parse = function (_a) {
          ...
          return parseResult(
            parser.apply(
              void 0,
              __spreadArray([env, macro.symbol], __read(macro.args), false)
            )
          );
        };
        return MacroMap;
    ...
    /***/ 17782: /***/ function (
      ...
      var NoTags = (function (_super) {
        ...
        NoTags.prototype.getTag = function () {
          return !this.currentTag.tag
            ? null
            : _super.prototype.getTag.call(this);
        };
        return NoTags;
      })(AbstractTags);
      ...
      (function (TagsFactory) {
        ...
        TagsFactory.addTags = function (tags) {
          ...
          try {
            for (
              var _b = __values(Object.keys(tags)), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var key = _c.value;
    ...
    /***/ 98770: /***/ (__unused_webpack_module, exports) => {
      Object.defineProperty(exports, '__esModule', { value: true });
          ...
          for (var i = 1, m = parts.length; i < m; i += 2) {
            ...
            if (c >= '0' && c <= '9') {
              ...
              if (c >= '0' && c <= '9') {
                parts[i] =
                  args[
                    parseInt(parts[i].substr(1, parts[i].length - 2), 10) - 1
                  ];
                if (typeof parts[i] === 'number') {
                  parts[i] = parts[i].toString();
                }
      ...
      var TexParser = (function () {
        function TexParser(_string, env, configuration) {
          ...
          if (env) {
            ...
            try {
              for (
                var _b = __values(Object.keys(env)), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
                var id = _c.value;
          ...
          this.stack = new Stack_js_1.default(
            this.itemFactory,
            ENV,
            inner ? isInner : true
          );
        ...
        TexParser.prototype.toString = function () {
          ...
          try {
            for (
              var _b = __values(Array.from(this.configuration.handlers.keys())),
                _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
        ...
        TexParser.prototype.create = function (kind) {
          ...
          return (_a = this.configuration.nodeFactory).create.apply(
            _a,
    ...
    /***/ 81039: /***/ (
      ...
      var version_js_1 = __webpack_require__(71471);
      var HandlerList_js_1 = __webpack_require__(29796);
    ...
    /***/ 92787: /***/ (
      ...
      var mathjax_js_1 = __webpack_require__(81039);
      function asyncLoad(name) {
        if (!mathjax_js_1.mathjax.asyncLoad) {
          return Promise.reject(
            "Can't load '".concat(name, "': No asyncLoad method specified")
          );
        }
    ...
    /***/ 38316: /***/ (
      ...
      exports.numeric =
        ...
        exports.options =
          void 0;
      var Retries_js_1 = __webpack_require__(9841);
      var AsyncLoad_js_1 = __webpack_require__(92787);
      exports.options = {
      ...
      function replace(match, entity) {
        ...
        if (exports.options['loadMissingEntities']) {
          var file = entity.match(/^[a-zA-Z](fr|scr|opf)$/)
            ? RegExp.$1
            : entity.charAt(0).toLowerCase();
          if (!loaded[file]) {
            loaded[file] = true;
            (0, Retries_js_1.retryAfter)(
              (0, AsyncLoad_js_1.asyncLoad)('./util/entities/' + file + '.js')
            );
          }
        }
        return match;
...
//# sourceMappingURL=2633.00dd0d006c4724a28d7b.js.map?v=00dd0d006c4724a28d7b
