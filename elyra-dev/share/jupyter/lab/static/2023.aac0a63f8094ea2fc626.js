...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [2023],
  {
    ...
    /***/ 52023: /***/ (
      ...
      /* harmony import */ var _chunk_6JRP7KZX_mjs__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(97366);
      /* harmony import */ var _chunk_RZ5BOZE2_mjs__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(15051);
      /* harmony import */ var _chunk_TYCBKAJE_mjs__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(94065);
      /* harmony import */ var _chunk_IIMUDSI4_mjs__WEBPACK_IMPORTED_MODULE_3__ =
        __webpack_require__(33416);
      /* harmony import */ var _chunk_VV3M67IP_mjs__WEBPACK_IMPORTED_MODULE_4__ =
        __webpack_require__(94746);
      /* harmony import */ var _chunk_HRU6DDCH_mjs__WEBPACK_IMPORTED_MODULE_5__ =
        __webpack_require__(20778);
      /* harmony import */ var _chunk_K557N5IZ_mjs__WEBPACK_IMPORTED_MODULE_6__ =
        __webpack_require__(57590);
      /* harmony import */ var _chunk_H2D2JQ3I_mjs__WEBPACK_IMPORTED_MODULE_7__ =
        __webpack_require__(68232);
      /* harmony import */ var _chunk_C3MQ5ANM_mjs__WEBPACK_IMPORTED_MODULE_8__ =
        __webpack_require__(76261);
      /* harmony import */ var _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_9__ =
        __webpack_require__(96049);
      /* harmony import */ var _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ =
        __webpack_require__(75905);
      /* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_11__ =
        __webpack_require__(24982);
      /* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_12__ =
        __webpack_require__(27574);
      /* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_13__ =
      ...
      var FlowDB = class {
        ...
        constructor() {
          ...
          this.config = (0,
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.D7)();
          ...
          this.funs = [];
          this.setAccTitle =
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .setAccTitle */.SV;
          this.setAccDescription =
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .setAccDescription */.EI;
          this.setDiagramTitle =
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .setDiagramTitle */.ke;
          this.getAccTitle =
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getAccTitle */.iN;
          this.getAccDescription =
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getAccDescription */.m7;
          this.getDiagramTitle =
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getDiagramTitle */.ab;
        ...
        static {
          (0,
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .__name */.K2)(
            this,
            'FlowDB'
          );
        }
        sanitizeText(txt) {
          return _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .common_default */.Y2.sanitizeText(
            txt,
            this.config
          );
        }
        ...
        addVertex(
          ...
          if (metadata !== void 0) {
            ...
            doc = (0,
            _chunk_6JRP7KZX_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .load */.H)(
              yamlData,
              {
                schema:
                  _chunk_6JRP7KZX_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .JSON_SCHEMA */.r
              }
            );
          }
          ...
          if (doc !== void 0) {
            if (doc.shape) {
              if (
                ...
                !(0,
                _chunk_HRU6DDCH_mjs__WEBPACK_IMPORTED_MODULE_5__ /* .isValidShape */.aP)(
                  doc.shape
                )
              ) {
        ...
        addSingleLink(_start, _end, type, id) {
          ...
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .log */.Rm.info(
            'abc78 Got edge...',
            edge
          );
          ...
          if (id && !this.edges.some((e) => e.id === id)) {
            ...
            if (existingLinks.length === 0) {
              edge.id = (0,
              _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_9__ /* .getEdgeId */.rY)(
                edge.start,
                edge.end,
                { counter: 0, prefix: 'L' }
              );
...
You have to call mermaid.initialize.`
            ...
            this.funs.push(() => {
              ...
              if (elem !== null) {
                elem.addEventListener(
                  'click',
                  () => {
                    _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_9__ /* .utils_default */._K
        ...
        setupToolTips(element) {
          let tooltipElem = (0,
          d3__WEBPACK_IMPORTED_MODULE_11__ /* .select */.Ltv)(
            '.mermaidTooltip'
          );
          if ((tooltipElem._groups || tooltipElem)[0][0] === null) {
            tooltipElem = (0,
            d3__WEBPACK_IMPORTED_MODULE_11__ /* .select */.Ltv)('body')
              .append('div')
              .attr('class', 'mermaidTooltip')
              .style('opacity', 0);
          }
          const svg = (0, d3__WEBPACK_IMPORTED_MODULE_11__ /* .select */.Ltv)(
            element
          ).select('svg');
          ...
          nodes
            .on('mouseover', (e) => {
              ...
              tooltipElem.html(
                tooltipElem.html().replace(/&lt;br\/&gt;/g, '<br/>')
              );
        ...
        clear(ver = 'gen-2') {
          ...
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .getConfig2 */.D7)();
          (0,
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .clear */.IU)();
        }
        setGen(ver) {
        ...
        defaultConfig() {
          return _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .defaultConfig2 */
            .ME.flowchart;
        }
      };
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .__name */.K2)(
        async function (text, id, _version, diag) {
          ...
          if (securityLevel === 'sandbox') {
            sandboxElement = (0,
            d3__WEBPACK_IMPORTED_MODULE_11__ /* .select */.Ltv)('#i' + id);
          }
          const doc =
            securityLevel === 'sandbox'
              ? sandboxElement.nodes()[0].contentDocument
              : document;
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .log */.Rm.debug(
            'Before getData: '
          );
          ...
          const svg = (0,
          _chunk_RZ5BOZE2_mjs__WEBPACK_IMPORTED_MODULE_1__ /* .getDiagramElement */.A)(
            id,
            securityLevel
          );
          ...
          _chunk_TYCBKAJE_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .getRegisteredLayoutAlgorithm */.q7)(
            layout
          );
          ...
          await (0,
          _chunk_TYCBKAJE_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .render */.XX)(
            data4Layout,
            svg
          );
          ...
          (0,
          _chunk_RZ5BOZE2_mjs__WEBPACK_IMPORTED_MODULE_1__ /* .setupViewPortForSVG */.P)(
            svg,
            padding,
            'flowchart',
            conf?.useMaxWidth || false
          );
      ...
      var parser = (function () {
        ...
        (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .__name */.K2)(
          Parser,
          'Parser'
        );
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .__name */.K2)(
        (color, opacity) => {
          const channel2 =
            khroma__WEBPACK_IMPORTED_MODULE_12__ /* ["default"] */.A;
          const r = channel2(color, 'r');
          const g = channel2(color, 'g');
          const b = channel2(color, 'b');
          return khroma__WEBPACK_IMPORTED_MODULE_13__ /* ["default"] */
            .A(r, g, b, opacity);
        },
        'fade'
      );
      ...
      var diagram = {
        ...
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .__name */.K2)(
          (cnf) => {
            ...
            if (cnf.layout) {
              (0,
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .setConfig2 */.XV)(
                { layout: cnf.layout }
              );
            }
            ...
            (0,
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_10__ /* .setConfig2 */.XV)(
              { flowchart: { arrowMarkerAbsolute: cnf.arrowMarkerAbsolute } }
            );
          },
          'init'
        )
...
//# sourceMappingURL=2023.aac0a63f8094ea2fc626.js.map?v=aac0a63f8094ea2fc626
