...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [8816],
  {
    /***/ 58496: /***/ function (
      ...
      exports.MathJax =
        exports.combineWithMathJax =
        exports.combineDefaults =
        exports.combineConfig =
        exports.isObject =
          void 0;
      ...
      function combineConfig(dst, src) {
        ...
        try {
          for (
            var _b = __values(Object.keys(src)), _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
            var id = _c.value;
    ...
    /***/ 59228: /***/ function (
      ...
      exports.CONFIG =
        ...
        exports.Loader =
        exports.PathFilters =
        exports.PackageError =
        exports.Package =
          void 0;
      var global_js_1 = __webpack_require__(58496);
      var package_js_1 = __webpack_require__(6875);
      var package_js_2 = __webpack_require__(6875);
      ...
      exports.PathFilters = {
        ...
        prefix: function (data) {
          ...
          while ((match = data.name.match(/^\[([^\]]*)\]/))) {
            ...
            data.name =
              exports.CONFIG.paths[match[1]] +
              data.name.substr(match[0].length);
          }
          return true;
        }
      };
      ...
      (function (Loader) {
        ...
        function ready() {
          ...
          try {
            for (
              ...
              var extension =
                package_js_1.Package.packages.get(name_1) ||
                new package_js_1.Package(name_1, true);
        ...
        function load() {
          ...
          var _loop_1 = function (name_2) {
            ...
            promises.push(
              extension.promise.then(function () {
                if (!exports.CONFIG.versionWarnings) return;
                if (
                  extension.isLoaded &&
                  !Loader.versions.has(package_js_1.Package.resolvePath(name_2))
                ) {
                  console.warn(
          ...
          try {
            for (
              var names_2 = __values(names), names_2_1 = names_2.next();
              !names_2_1.done;
        ...
        function preLoad() {
          ...
          try {
            for (
              var names_3 = __values(names), names_3_1 = names_3.next();
              !names_3_1.done;
              names_3_1 = names_3.next()
            ) {
        ...
        function checkVersion(name, version, _type) {
          ...
          if (exports.CONFIG.versionWarnings && version !== VERSION) {
            console.warn(
              'Component '
                .concat(name, ' uses ')
                .concat(version, ' of MathJax; version in use is ')
                .concat(VERSION)
            );
            return true;
          }
      ...
      if (typeof exports.MathJax.loader === 'undefined') {
        ...
        try {
          for (
            var _b = __values(exports.MathJax.config.loader.pathFilters),
              _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
    ...
    /***/ 6875: /***/ function (
      ...
      var loader_js_1 = __webpack_require__(59228);
      ...
      var Package = (function () {
        ...
        Package.loadAll = function () {
          ...
          try {
            for (
              var _b = __values(this.packages.values()), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
        ...
        Package.prototype.makeDependencies = function () {
          ...
          if (loader_js_1.CONFIG.dependencies.hasOwnProperty(name)) {
            dependencies.push.apply(
              ...
              __spreadArray(
                [],
                __read(loader_js_1.CONFIG.dependencies[name]),
                false
              )
            );
          } else if (name !== 'core') {
          ...
          try {
            for (
              var dependencies_1 = __values(dependencies),
                dependencies_1_1 = dependencies_1.next();
              !dependencies_1_1.done;
              dependencies_1_1 = dependencies_1.next()
            ) {
              var dependent = dependencies_1_1.value;
              var extension =
                map.get(dependent) || new Package(dependent, noLoad);
        ...
        Package.prototype.loaded = function () {
          ...
          try {
            for (
              var _c = __values(this.dependents), _d = _c.next();
              !_d.done;
              _d = _c.next()
            ) {
          ...
          try {
            for (
              var _e = __values(this.provided), _f = _e.next();
              !_f.done;
              _f = _e.next()
            ) {
        ...
        Package.prototype.checkNoLoad = function () {
          ...
          if (this.noLoad) {
            ...
            try {
              for (
                var _b = __values(this.dependencies), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
    ...
    /***/ 58816: /***/ function (
      ...
      function RegisterExtension(jax, name) {
        ...
        if (required.indexOf(extension) < 0) {
          ...
          if (handler) {
            ...
            var configured =
              jax.parseOptions.packageData.get('require').configured;
      ...
      function RequireLoad(parser, name) {
        ...
        var extension =
          (name.substr(0, 1) === '[' ? '' : options.prefix) + name;
        var allowed = allow.hasOwnProperty(extension)
          ? allow[extension]
      ...
      exports.RequireConfiguration = Configuration_js_1.Configuration.create(
        'require',
        {
...
//# sourceMappingURL=8816.ac92e7e6e432b5938e29.js.map?v=ac92e7e6e432b5938e29
