...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [2353, 4981],
  {
    /***/ 98128: /***/ function (__unused_webpack_module, exports) {
      var __values =
        (this && this.__values) ||
        function (o) {
    ...
    /***/ 80747: /***/ function (
      ...
      exports.XMLNode =
        exports.TextNode =
        exports.AbstractMmlEmptyNode =
        exports.AbstractMmlBaseNode =
        exports.AbstractMmlLayoutNode =
        exports.AbstractMmlTokenNode =
        exports.AbstractMmlNode =
        exports.indentAttributes =
        exports.TEXCLASSNAMES =
        exports.TEXCLASS =
          void 0;
      var Attributes_js_1 = __webpack_require__(98128);
      var Node_js_1 = __webpack_require__(84465);
      exports.TEXCLASS = {
        ORD: 0,
        OP: 1,
        BIN: 2,
      ...
      var AbstractMmlNode = (function (_super) {
        ...
        function AbstractMmlNode(factory, attributes, children) {
          ...
          _this.attributes = new Attributes_js_1.Attributes(
            factory.getNodeClass(_this.kind).defaults,
        ...
        AbstractMmlNode.prototype.copy = function (keepIds) {
          ...
          if (this.attributes) {
            ...
            try {
              for (
                var _c = __values(Object.keys(attributes)), _d = _c.next();
                !_d.done;
                _d = _c.next()
              ) {
                var name_1 = _d.value;
        ...
        AbstractMmlNode.prototype.appendChild = function (child) {
          ...
          if (child.isInferred) {
            ...
            try {
              for (
                var _b = __values(original.getPropertyNames()), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
                var name_2 = _c.value;
        ...
        AbstractMmlNode.prototype.childPosition = function () {
          ...
          if (parent) {
            ...
            try {
              for (
                var _b = __values(parent.childNodes), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
                var node = _c.value;
        ...
        AbstractMmlNode.prototype.texSpacing = function () {
          var prevClass =
            this.prevClass != null ? this.prevClass : exports.TEXCLASS.NONE;
          var texClass = this.texClass || exports.TEXCLASS.ORD;
          if (
            prevClass === exports.TEXCLASS.NONE ||
            texClass === exports.TEXCLASS.NONE
          ) {
            return '';
          }
          ...
          if (
            (this.prevLevel > 0 || this.attributes.get('scriptlevel') > 0) &&
            space >= 0
          ) {
            return '';
          }
        ...
        AbstractMmlNode.prototype.setInheritedAttributes = function (
          attributes,
          display,
          level,
          prime
            ...
            for (
              ...
              if (
                ...
                var _d = __read(attributes[key], 2),
                  ...
                  value = _d[1];
                var noinherit =
                  (AbstractMmlNode.noInherit[node] || {})[this.kind] || {};
                if (!noinherit[key]) {
        ...
        AbstractMmlNode.prototype.setChildInheritedAttributes = function (
          attributes,
          display,
          level,
          prime
        ...
        AbstractMmlNode.prototype.addInheritedAttributes = function (
          current,
          attributes
        ) {
          var e_7, _a;
        ...
        AbstractMmlNode.prototype.verifyAttributes = function (options) {
          ...
          if (options['checkAttributes']) {
            ...
            try {
              for (
                var _b = __values(attributes.getExplicitNames()),
                  _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
      ...
      var AbstractMmlTokenNode = (function (_super) {
        ...
        AbstractMmlTokenNode.prototype.setChildInheritedAttributes = function (
          attributes,
          display,
          level,
          prime
        ...
        AbstractMmlTokenNode.defaults = __assign(
          __assign({}, AbstractMmlNode.defaults),
          { mathvariant: 'normal', mathsize: Attributes_js_1.INHERIT }
        );
      ...
      var AbstractMmlLayoutNode = (function (_super) {
        ...
        Object.defineProperty(
          AbstractMmlLayoutNode.prototype,
          'isEmbellished',
          {
            get: function () {
      ...
      var AbstractMmlEmptyNode = (function (_super) {
        ...
        Object.defineProperty(
          AbstractMmlEmptyNode.prototype,
          'linebreakContainer',
          {
            get: function () {
              return false;
        ...
        AbstractMmlEmptyNode.prototype.setInheritedAttributes = function (
          _attributes,
          _display,
          _level,
          _prime
        ) {};
        AbstractMmlEmptyNode.prototype.inheritAttributesFrom = function (
          _node
        ) {};
        AbstractMmlEmptyNode.prototype.verifyTree = function (_options) {};
        AbstractMmlEmptyNode.prototype.mError = function (
          _message,
          _options,
          _short
        ) {
    ...
    /***/ 38669: /***/ function (
      ...
      var MmlMo = (function (_super) {
          ...
          while (
            (((parent.isKind('mrow') ||
              (parent.isKind('TeXAtom') &&
                parent.texClass !== MmlNode_js_1.TEXCLASS.VCENTER) ||
        ...
        MmlMo.prototype.adjustTeXclass = function (prev) {
          ...
          if (prev) {
            ...
            prevClass = this.prevClass =
              prev.texClass || MmlNode_js_1.TEXCLASS.ORD;
        ...
        MmlMo.prototype.setInheritedAttributes = function (
          attributes,
          display,
          level,
          prime
        ...
        MmlMo.prototype.checkOperatorTable = function (mo) {
          ...
          var def =
            OPTABLE[form1][mo] || OPTABLE[form2][mo] || OPTABLE[form3][mo];
          if (def) {
            ...
            try {
              for (
                var _c = __values(Object.keys(def[3] || {})), _d = _c.next();
                !_d.done;
                _d = _c.next()
              ) {
                var name_1 = _d.value;
        ...
        MmlMo.prototype.checkPrimes = function (mo) {
          ...
          var primes = (0, string_js_1.unicodeString)(
            (0, string_js_1.unicodeChars)(mo).map(function (c) {
              return REMAP[c];
            })
          );
    ...
    /***/ 56893: /***/ function (
      ...
      function getRange(text) {
        ...
        try {
          for (
            var RANGES_1 = __values(exports.RANGES),
    ...
    /***/ 84465: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
      ...
      var AbstractEmptyNode = (function (_super) {
        ...
        AbstractEmptyNode.prototype.replaceChild = function (
          _newChild,
          oldChild
        ) {
          return oldChild;
    ...
    /***/ 34981: /***/ function (__unused_webpack_module, exports) {
      var __values =
        (this && this.__values) ||
        function (o) {
          var s = typeof Symbol === 'function' && Symbol.iterator,
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.lookup =
        exports.separateOptions =
        exports.selectOptionsFromKeys =
      ...
      function copy(def) {
        ...
        try {
          for (
            var _b = __values(keys(def)), _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
            var key = _c.value;
      ...
      function insert(dst, src, warn) {
        ...
        var _loop_1 = function (key) {
          if (
            warn &&
            dst[key] === undefined &&
            dst.constructor !== Expandable
          ) {
            if (typeof key === 'symbol') {
              key = key.toString();
            }
            exports.OPTIONS.optionError(
              'Invalid option "'.concat(key, '" (no default value).'),
              key
            );
            return 'continue';
          }
          ...
          if (
            ...
            if (
              Array.isArray(dval) &&
              ((ids.length === 1 &&
                (ids[0] === exports.APPEND || ids[0] === exports.REMOVE) &&
                Array.isArray(sval[ids[0]])) ||
                (ids.length === 2 &&
                  ids.sort().join(',') ===
                    exports.APPEND + ',' + exports.REMOVE &&
                  Array.isArray(sval[exports.APPEND]) &&
                  Array.isArray(sval[exports.REMOVE])))
            ) {
              ...
              if (sval[exports.APPEND]) {
                dst[key] = __spreadArray(
                  __spreadArray([], __read(dval), false),
                  __read(sval[exports.APPEND]),
                  false
                );
              }
            } else {
        ...
        try {
          for (
            var _b = __values(keys(src)), _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
            var key = _c.value;
      ...
      function selectOptionsFromKeys(options, object) {
        return selectOptions.apply(
          void 0,
          __spreadArray([options], __read(Object.keys(object)), false)
        );
      }
      ...
      function separateOptions(options) {
        ...
        try {
          for (
            ...
            try {
              for (
                var _c = ((e_5 = void 0), __values(Object.keys(options || {}))),
                  _d = _c.next();
                !_d.done;
                _d = _c.next()
              ) {
                var key = _d.value;
                (object[key] === undefined ? missing : exists)[key] =
                  options[key];
              }
            } catch (e_5_1) {
              e_5 = { error: e_5_1 };
    ...
    /***/ 41278: /***/ function (__unused_webpack_module, exports) {
      var __read =
        (this && this.__read) ||
        function (o, n) {
          var m = typeof Symbol === 'function' && o[Symbol.iterator];
      ...
      exports.split =
        ...
        exports.unicodeChars =
        exports.quotePattern =
        exports.sortLength =
          void 0;
...
//# sourceMappingURL=2353.38ff41748ce32b0d49c6.js.map?v=38ff41748ce32b0d49c6
