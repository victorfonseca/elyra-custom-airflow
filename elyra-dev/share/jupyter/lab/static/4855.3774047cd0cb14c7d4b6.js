...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [4855],
  {
    /***/ 34855: /***/ function (
      ...
      exports.AssistiveMmlHandler =
        exports.AssistiveMmlMathDocumentMixin =
        exports.AssistiveMmlMathItemMixin =
        exports.LimitedMmlVisitor =
          void 0;
      var MathItem_js_1 = __webpack_require__(24971);
      var SerializedMmlVisitor_js_1 = __webpack_require__(14347);
      ...
      var LimitedMmlVisitor = (function (_super) {
        ...
        LimitedMmlVisitor.prototype.getAttributes = function (node) {
          return _super.prototype.getAttributes
            .call(this, node)
            .replace(/ ?id=".*?"/, '');
        };
      ...
      function AssistiveMmlMathItemMixin(BaseMathItem) {
        return (function (_super) {
          ...
          class_1.prototype.assistiveMml = function (document, force) {
            ...
            if (
              !this.isEscaped &&
              (document.options.enableAssistiveMml || force)
            ) {
              ...
              var mml = document
                ...
                .replace(/\n */g, '')
                .replace(/<!--.*?-->/g, '');
              var mmlNodes = adaptor.firstChild(
                adaptor.body(adaptor.parse(mml, 'text/html'))
              );
              var node = adaptor.node(
                'mjx-assistive-mml',
                {
                  unselectable: 'on',
              ...
              adaptor.setAttribute(
                adaptor.firstChild(this.typesetRoot),
                'aria-hidden',
                'true'
              );
        ...
        return (
          (_a = (function (_super) {
            ...
            function BaseClass() {
              ...
              _this.options.MathItem = AssistiveMmlMathItemMixin(
          ...
          (_a.OPTIONS = __assign(__assign({}, BaseDocument.OPTIONS), {
            enableAssistiveMml: true,
            renderActions: (0, Options_js_1.expandable)(
              __assign(__assign({}, BaseDocument.OPTIONS.renderActions), {
    ...
    /***/ 76677: /***/ function (
      ...
      var Visitor_js_1 = __webpack_require__(34167);
    ...
    /***/ 14347: /***/ function (
      ...
      exports.SerializedMmlVisitor =
        ...
        exports.DATAMJX =
          void 0;
      var MmlVisitor_js_1 = __webpack_require__(76677);
      ...
      var SerializedMmlVisitor = (function (_super) {
        ...
        SerializedMmlVisitor.prototype.visitInferredMrowNode = function (
          node,
          space
        ) {
          var e_1, _a;
          ...
          try {
            for (
              var _b = __values(node.childNodes), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var child = _c.value;
        ...
        SerializedMmlVisitor.prototype.visitTeXAtomNode = function (
          node,
          space
        ) {
        ...
        SerializedMmlVisitor.prototype.visitAnnotationNode = function (
          node,
          space
        ) {
          return (
        ...
        SerializedMmlVisitor.prototype.childNodeMml = function (
          node,
          space,
          nl
        ) {
        ...
        SerializedMmlVisitor.prototype.getAttributes = function (node) {
          ...
          if (
            ...
            variants.hasOwnProperty(attributes.mathvariant)
          ) {
        ...
        SerializedMmlVisitor.prototype.getDataAttributes = function (node) {
          ...
          if (texclass !== undefined) {
            ...
            if (texclass === MmlNode_js_1.TEXCLASS.OP && node.isKind('mi')) {
              ...
              setclass = !(
                name_2.length > 1 && name_2.match(mi_js_1.MmlMi.operatorName)
              );
            }
            setclass &&
              this.setDataAttribute(
                data,
                'texclass',
                texclass < 0 ? 'NONE' : MmlNode_js_1.TEXCLASSNAMES[texclass]
              );
          }
        ...
        SerializedMmlVisitor.prototype.setDataAttribute = function (
          data,
          name,
          value
        ) {
    ...
    /***/ 34167: /***/ function (
      ...
      var AbstractVisitor = (function () {
        function AbstractVisitor(factory) {
          ...
          try {
            for (
              var _b = __values(factory.getKinds()), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var kind = _c.value;
        ...
        AbstractVisitor.prototype.visitTree = function (tree) {
          ...
          return this.visitNode.apply(
            this,
            __spreadArray([tree], __read(args), false)
          );
        };
        AbstractVisitor.prototype.visitNode = function (node) {
          ...
          return handler.call.apply(
            handler,
            __spreadArray([this, node], __read(args), false)
          );
        };
            ...
            try {
              for (
                ...
                this.visitNode.apply(
                  this,
                  __spreadArray([child], __read(args), false)
                );
              }
            } catch (e_2_1) {
              e_2 = { error: e_2_1 };
...
//# sourceMappingURL=4855.3774047cd0cb14c7d4b6.js.map?v=3774047cd0cb14c7d4b6
