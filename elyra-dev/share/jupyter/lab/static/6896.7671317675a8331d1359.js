(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [6896],
  {
    /***/ 6896: /***/ (
      ...
      __webpack_require__.d(__webpack_exports__, {
        createPrecompiledValidator: () =>
          /* reexport */ createPrecompiledValidator,
      ...
      var isObject_default = /*#__PURE__*/ __webpack_require__.n(isObject); // CONCATENATED MODULE: ./node_modules/@rjsf/validator-ajv8/lib/createAjvInstance.js
      const AJV_CONFIG = {
        allErrors: true,
      ...
      var get_default = /*#__PURE__*/ __webpack_require__.n(get); // CONCATENATED MODULE: ./node_modules/@rjsf/validator-ajv8/lib/processRawValidationErrors.js
      ...
      function transformRJSFValidationErrors(errors = [], uiSchema) {
        return errors.map((e) => {
          ...
          if ('missingProperty' in params) {
            ...
            const uiSchemaTitle = (0, index_js_.getUiOptions)(
              get_default()(uiSchema, `${property.replace(/^\./, '')}`)
            ).title;
            if (uiSchemaTitle) {
              message = message.replace(currentProperty, uiSchemaTitle);
            } else {
              const parentSchemaTitle = get_default()(parentSchema, [
                index_js_.PROPERTIES_KEY,
                currentProperty,
                'title'
              ]);
      ...
      function processRawValidationErrors(
        ...
        const newFormData = (0, index_js_.getDefaultFormState)(
          validator,
          schema,
          formData,
          schema,
        ...
        const errorHandler = customValidate(
          newFormData,
          (0, index_js_.createErrorHandler)(newFormData),
          uiSchema
        );
        const userErrorSchema = (0, index_js_.unwrapErrorHandler)(errorHandler);
        return (0, index_js_.validationDataMerge)(
          { errors, errorSchema },
          userErrorSchema
        );
      ...
      class AJV8Validator {
        ...
        isValid(schema, formData, rootSchema) {
          var _a, _b;
          const rootSchemaId =
            (_a = rootSchema[index_js_.ID_KEY]) !== null && _a !== void 0
              ? _a
              : index_js_.ROOT_SCHEMA_PREFIX;
          try {
            ...
            // }
            const schemaWithIdRefPrefix = (0, index_js_.withIdRefPrefix)(
              schema
            );
            const schemaId =
              (_b = schemaWithIdRefPrefix[index_js_.ID_KEY]) !== null &&
              _b !== void 0
                ? _b
                : (0, index_js_.hashForSchema)(schemaWithIdRefPrefix);
            let compiledValidator;
      ...
      var isEqual_default = /*#__PURE__*/ __webpack_require__.n(isEqual); // CONCATENATED MODULE: ./node_modules/@rjsf/validator-ajv8/lib/precompiledValidator.js
      ...
      class AJV8PrecompiledValidator {
        ...
        getValidator(schema) {
          const key =
            get_default()(schema, index_js_.ID_KEY) ||
            (0, index_js_.hashForSchema)(schema);
        ...
        ensureSameRootSchema(schema, formData) {
          if (!isEqual_default()(schema, this.rootSchema)) {
            ...
            const resolvedRootSchema = (0, index_js_.retrieveSchema)(
              this,
              this.rootSchema,
              this.rootSchema,
              formData
        ...
        isValid(schema, formData, rootSchema) {
          ...
          if (
            get_default()(schema, index_js_.ID_KEY) === index_js_.JUNK_OPTION_ID
          ) {
            return false;
          }
    ...
    /***/ 14018: /***/ (__unused_webpack_module, exports) => {
      'use strict';
    ...
    /***/ 68182: /***/ (module, exports, __webpack_require__) => {
      'use strict';
...
//# sourceMappingURL=6896.7671317675a8331d1359.js.map?v=7671317675a8331d1359
