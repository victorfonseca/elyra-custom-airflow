  ...
  [7990, 5606, 6372, 3991],
  {
    ...
    7990: (e, t, r) => {
      ...
      function m(e, t) {
        ...
        for (var n in t) {
          var i =
            typeof t[n] === 'object' ? JSON.stringify(t[n], null, 2) : t[n];
      ...
      var y = (function (e) {
        ...
        function t(t, r, n, i, a) {
          ...
          var s =
            e.call(this, m(t, { name: r, index: n, operation: i, tree: a })) ||
            this;
          s.name = r;
          s.index = n;
          s.operation = i;
        ...
        if (t.path === '') {
          ...
          while (true) {
            ...
            if (
              i &&
              (g == '__proto__' ||
                (g == 'prototype' && h > 0 && l[h - 1] == 'constructor'))
            ) {
              throw new TypeError(
        ...
        for (var p = o.length - 1; p >= 0; p--) {
          ...
          if (
            ...
            if (
              ...
              typeof g == 'object' &&
              g != null &&
              Array.isArray(v) === Array.isArray(g)
            ) {
              z(v, g, r, n + '/' + h(d), i);
            } else {
              if (v !== g) {
      ...
      const Q = (e, t, r, n, i, a, o) =>
        new Date(e, t || 0, r != null ? r : 1, n || 0, i || 0, a || 0, o || 0);
      var Z = {
        isNaN: Number.isNaN,
      ...
      const te = {
        ...
        MemberExpression: (e, t) => {
          ...
          if (ee.has(n[i])) {
            console.error(
              `Prevented interpretation of member "${i}" which could lead to insecure code execution`
            );
            return;
          }
          return n[i];
        ...
        ObjectExpression: (e, t) =>
          t.properties.reduce((t, r) => {
            ...
            if (ee.has(e(r.value))) {
              console.error(
                `Prevented interpretation of property "${n}" which could lead to insecure code execution`
              );
            } else {
              t[n] = e(r.value);
            }
      ...
      const qe = {
        ...
        range: {
          category: Je['category-6'],
          diverging: Je['fireandice-6'],
          heatmap: Je['fire-7'],
          ordinal: Je['fire-7'],
          ramp: Je['fire-7']
        }
      ...
      const vt = {
        ...
        style: {
          'guide-label': { font: dt, fontSize: 12 },
          'guide-title': { font: dt, fontSize: 12 },
          'group-title': { font: dt, fontSize: 12 }
        },
        title: {
          font: dt,
          fontSize: 14,
      ...
      const Mt = {
        ...
        range: {
          category: [Nt, St, Lt, Tt, Rt, Dt, kt, Ct],
          diverging: Pt,
          heatmap: Pt,
          ordinal: _t
        }
      ...
      class mr {
        ...
        tooltipHandler(e, t, r, n) {
          ...
          if (!this.el) {
            ...
            const e =
              (i = document.fullscreenElement) !== null && i !== void 0
                ? i
                : document.body;
      ...
      function Jr(e) {
        ...
        return t
          ? t === Ur || (t.displayName || t.name) === 'GeneratorFunction'
          : false;
      }
      function qr(e) {
      ...
      var Yn = {
        ...
        MAX_LENGTH: $n,
        MAX_SAFE_INTEGER: Wn,
        MAX_SAFE_COMPONENT_LENGTH: Hn
      };
      var Jn =
        typeof Er === 'object' &&
        Er.env &&
        Er.env.NODE_DEBUG &&
        /\bsemver\b/i.test(Er.env.NODE_DEBUG)
          ? function () {
              for (
      ...
      (function (e, t) {
        ...
        l(
          'XRANGELOOSE',
          '^'.concat(a[o.GTLT], '\\s*').concat(a[o.XRANGEPLAINLOOSE], '$')
        );
        l(
          'COERCE',
      ...
      let li = class e {
        constructor(t, r) {
          ...
          if (t.length > ri) {
            throw new TypeError(
              'version is longer than '.concat(ri, ' characters')
            );
          }
          ti('SemVer', t, r);
          this.options = r;
        ...
        compareMain(t) {
          ...
          return (
            si(this.major, t.major) ||
            si(this.minor, t.minor) ||
            si(this.patch, t.patch)
          );
        }
        comparePre(t) {
          if (!(t instanceof e)) {
      ...
      function Hi() {
            ...
            return this.set.some(
              (e) =>
                ...
                t.set.some(
                  (t) =>
                    d(t, r) &&
                    e.every((e) => t.every((t) => e.intersects(t, r)))
                )
            );
          }
          test(e) {
        ...
        var A = (e, t) => {
          ...
          return e
            .trim()
            .replace(s[t.includePrerelease ? l.GTE0PRE : l.GTE0], '');
        };
      ...
      var Pa = {
        vega: Ra.version,
        'vega-lite': Da ? Da.version : 'not available'
      };
      var _a = {
        vega: (e) => e,
        'vega-lite': (e, t) => Da.compile(e, { config: t }).spec
      };
      var Ma =
      ...
      function $a(e) {
        ...
        var n =
          (t =
            (r = e.usermeta) === null || r === void 0
              ? void 0
              : r.embedOptions) !== null && t !== void 0
            ? t
            : {};
      ...
      function qa(e) {
        ...
        return r instanceof ShadowRoot
          ...
          : {
              root: document,
              rootContainer:
                (t = document.head) !== null && t !== void 0 ? t : document.body
            };
      }
      function Qa(e, t) {
                  ...
                  switch ((se.prev = se.next)) {
                    case 0:
                      ...
                      p = f.theme
                        ? (0, X.mergeConfig)(
                            a[f.theme],
                            (n = f.config) !== null && n !== void 0 ? n : {}
                          )
                        : f.config;
                      d = (0, X.isBoolean)(f.actions)
                        ? f.actions
                        : Ki(
                            {},
                            Ca,
                            (i = f.actions) !== null && i !== void 0 ? i : {}
                          );
                      v = La(La({}, Fa), f.i18n);
                      g =
                        (o = f.renderer) !== null && o !== void 0
                          ? o
                          : 'canvas';
                      m =
                        (s = f.logLevel) !== null && s !== void 0 ? s : Ra.Warn;
                      y =
                        (l = f.downloadFileName) !== null && l !== void 0
                          ? l
                          : 'visualization';
                    ...
                    case 12:
                          ...
                          if (!qi(Pa.vega, '^'.concat(L.version.slice(1)))) {
                            console.warn(
                              'The compiled spec uses Vega '
                                .concat(L.version, ', but current version is v')
                                .concat(Pa.vega, '.')
                            );
                          }
                        }
                        ...
                        La(
                          ...
                          F
                            ? {
                                expr:
                                  (c =
                                    (u = Ra.expressionInterpreter) !== null &&
                                    u !== void 0
                                      ? u
                                      : f.expr) !== null && c !== void 0
                                    ? c
                                    : ne
                              }
                            : {}
                      ...
                      if (f.tooltip !== false) {
                        _ = Ba(f.tooltip)
                          ? f.tooltip
                          : new mr(f.tooltip === true ? {} : f.tooltip).call;
                        P.tooltip(_);
                      }
                      M = f.hover;
                      if (M === undefined) {
                    ...
                    case 60:
                      if (d === true || d.source !== false) {
                        ...
                        Z.addEventListener('click', function (e) {
                          ...
                          Ga(
                            V()(r),
                            (t = f.sourceHeader) !== null && t !== void 0
                              ? t
                              : '',
                            (n = f.sourceFooter) !== null && n !== void 0
                              ? n
                              : '',
                            N
                          );
                        ...
                        K.addEventListener('click', function (e) {
                          ...
                          Ga(
                            ...
                            (t = f.sourceHeader) !== null && t !== void 0
                              ? t
                              : '',
                            (r = f.sourceFooter) !== null && r !== void 0
                              ? r
                              : '',
                            'vega'
                          );
    ...
    26372: (e, t, r) => {
      ...
      function A(e, t) {
        let r =
          arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : y;
        let n = e || b;
        return {
          level(e) {
            if (arguments.length) {
        ...
        return t.reduce((e, t) => {
          for (const r in t) {
            if (r === 'signals') {
              ...
              const n =
                r === 'legend' ? { layout: 1 } : r === 'style' ? true : null;
              T(e, r, t[r], n);
            }
          }
          return e;
      ...
      function Q(e, t, r) {
        ...
        return a >= r - t
          ? [t, r]
          : [(n = Math.min(Math.max(n, t), r - a)), n + a];
      }
      function Z(e) {
        return typeof e === 'function';
      }
          ...
          : (e > t || t == null) && e != null
            ...
            : ((t = t instanceof Date ? +t : t),
              ...
              : t !== t && e === e
                ...
                : 0;
      const re = (e, t) =>
        e.length === 1 ? ne(e[0], t[0]) : ie(e, t, e.length);
      const ne = (e, t) =>
        function (r, n) {
          return te(e(r), e(n)) * t;
        };
