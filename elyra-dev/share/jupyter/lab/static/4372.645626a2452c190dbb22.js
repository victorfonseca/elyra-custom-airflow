      ...
      function i(e) {
        ...
        return {
          ...
          token: function (e, t) {
            ...
            if (k == n.type) {
              ...
              if (
                y == 'function' &&
                n &&
                (n.type == 'statement' || n.type == 'endgroup')
              ) {
          ...
          indent: function (e, i, a) {
            ...
            if (f) c = B(f[0], o.type);
            if (o.type == 'statement')
              return o.indented + (s == '{' ? 0 : t || a.unit);
            else if (g.test(o.type) && o.align && !n)
              return o.column + (c ? 0 : 1);
            ...
            if (t.tlvCodeActive) {
              ...
              if (s) {
                g =
                  ...
                  n === undefined &&
                  !t.tlvInBlockComment &&
                  e.column() == t.tlvIndentationStyle.length * o;
                if (g) {
