...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [3358],
  {
    33358: (t, e, n) => {
      ...
      function d(t, e) {
        return g(t.source, e.source) || t.index - e.index;
      }
      function p(t, e) {
        return g(t.target, e.target) || t.index - e.index;
      }
      function g(t, e) {
        return t.y0 - e.y0;
      }
      ...
      function w() {
        ...
        A.nodeId = function (t) {
          return arguments.length
            ? ((l = typeof t === 'function' ? t : y(t)), A)
            : l;
        };
        A.nodeAlign = function (t) {
          return arguments.length
            ? ((h = typeof t === 'function' ? t : y(t)), A)
            : h;
        };
        ...
        A.nodePadding = function (t) {
          return arguments.length ? ((o = a = +t), A) : o;
        };
        A.nodes = function (t) {
          return arguments.length
            ? ((S = typeof t === 'function' ? t : y(t)), A)
            : S;
        };
        A.links = function (t) {
          return arguments.length
            ? ((E = typeof t === 'function' ? t : y(t)), A)
            : E;
        };
        ...
        function M({ nodes: t, links: e }) {
          ...
          const n = new Map(t.map((e, n) => [l(e, n, t), e]));
          for (const [i, r] of e.entries()) {
            r.index = i;
            let { source: t, target: e } = r;
            if (typeof t !== 'object') t = r.source = v(n, t);
            if (typeof e !== 'object') e = r.target = v(n, e);
            t.sourceLinks.push(r);
            e.targetLinks.push(r);
          }
          if (L != null) {
        ...
        function I({ nodes: t }) {
          for (const e of t) {
            e.value =
              e.fixedValue === undefined
                ? Math.max(u(e.sourceLinks, _), u(e.targetLinks, _))
                : e.fixedValue;
          }
        }
        function T({ nodes: t }) {
          ...
          while (n.size) {
            ...
            if (++r > e) throw new Error('circular link');
            n = i;
            i = new Set();
          }
        }
        ...
        function D({ nodes: e }) {
          const i = f(e, (t) => t.depth) + 1;
          const s = (n - t - r) / (i - 1);
          const o = new Array(i);
          for (const n of e) {
            const e = Math.max(
              0,
              Math.min(i - 1, Math.floor(h.call(null, n, i)))
            );
            n.layer = e;
            n.x0 = t + e * s;
            n.x1 = n.x0 + r;
        ...
        function N(t) {
          const n = s(t, (t) => (i - e - (t.length - 1) * a) / u(t, _));
          for (const r of t) {
            let t = e;
            for (const e of r) {
              e.y0 = t;
        ...
        function P(t) {
          const n = D(t);
          a = Math.min(o, (i - e) / (f(n, (t) => t.length) - 1));
          N(n);
          for (let e = 0; e < K; ++e) {
            const t = Math.pow(0.99, e);
            const i = Math.max(1 - t, (e + 1) / K);
            $(n, t, i);
            O(n, t, i);
          }
        }
        function O(t, e, n) {
          for (let i = 1, r = t.length; i < r; ++i) {
            ...
            if (w === undefined) r.sort(g);
            j(r, n);
          }
        }
        function $(t, e, n) {
          for (let i = t.length, r = i - 2; r >= 0; --r) {
            const i = t[r];
            for (const t of i) {
              let n = 0;
              let i = 0;
        ...
        function W(t, e) {
          ...
          for (const { target: i, width: r } of t.sourceLinks) {
            if (i === e) break;
            n += r + a;
          }
          for (const { source: i, width: r } of e.targetLinks) {
            if (i === t) break;
            n -= r;
          }
          return n;
      ...
      A.prototype = M.prototype = {
        ...
        arcTo: function (t, e, n, i, r) {
          ...
          if (this._x1 === null) {
            ...
            var f = n - s,
              ...
              g = Math.sqrt(d),
              _ = Math.sqrt(u),
              k = r * Math.tan((L - Math.acos((d + u - p) / (2 * g * _))) / 2),
              x = k / _,
              m = k / g;
            if (Math.abs(x - 1) > E) {
              this._ += 'L' + (t + x * c) + ',' + (e + x * h);
            }
            this._ +=
              'A' +
              r +
        ...
        arc: function (t, e, n, i, r, s) {
          ...
          if (this._x1 === null) {
            this._ += 'M' + l + ',' + c;
          } else if (Math.abs(this._x1 - l) > E || Math.abs(this._y1 - c) > E) {
            this._ += 'L' + l + ',' + c;
          }
          if (!n) return;
          if (u < 0) u = (u % S) + S;
      ...
      function $(t) {
        ...
        o.x = function (t) {
          return arguments.length
            ? ((i = typeof t === 'function' ? t : C(+t)), o)
            : i;
        };
        o.y = function (t) {
          return arguments.length
            ? ((r = typeof t === 'function' ? t : C(+t)), o)
            : r;
        };
        o.context = function (t) {
          return arguments.length ? ((s = t == null ? null : t), o) : s;
        };
        return o;
      }
      ...
      function U(t, e, n, i, r) {
        var s = pointRadial(e, n),
          o = pointRadial(e, (n = (n + r) / 2)),
          a = pointRadial(i, n),
          l = pointRadial(i, r);
        t.moveTo(s[0], s[1]);
        t.bezierCurveTo(o[0], o[1], a[0], a[1], l[0], l[1]);
      }
      function F() {
        return $(j);
      }
      ...
      var Y = (function () {
        ...
        var s = {
          ...
          performAction: (0, i.K2)(function t(e, n, i, r, s, o, a) {
            var l = o.length - 1;
            switch (s) {
              case 7:
                const t = r.findOrCreateNode(
                  o[l - 4].trim().replaceAll('""', '"')
                );
                const e = r.findOrCreateNode(
                  o[l - 2].trim().replaceAll('""', '"')
                );
                const n = parseFloat(o[l].trim());
                r.addLink(t, e, n);
                break;
              case 8:
              case 9:
          ...
          table: [
            ...
            { 1: [3] },
            { 5: [1, 3] },
            { 6: 4, 8: 5, 15: 6, 16: 7, 17: 8, 18: e, 20: n },
            { 1: [2, 6], 7: 11, 10: [1, 12] },
            t(n, [2, 4], { 9: 13, 5: [1, 14] }),
            { 12: [1, 15] },
            t(r, [2, 8]),
            ...
            { 1: [2, 5] },
            t(n, [2, 2]),
            { 6: 17, 8: 5, 15: 6, 16: 7, 17: 8, 18: e, 20: n },
            { 15: 18, 16: 7, 17: 8, 18: e, 20: n },
            { 18: [1, 19] },
            t(n, [2, 3]),
            { 12: [1, 20] },
            t(r, [2, 10]),
            { 15: 21, 16: 7, 17: 8, 18: e, 20: n },
            t([1, 5, 10], [2, 7])
          ],
          ...
          parse: (0, i.K2)(function t(e) {
            ...
            while (true) {
              ...
              if (typeof E === 'undefined' || !E.length || !E[0]) {
                ...
                D = [];
                for (I in l[S]) {
                  if (this.terminals_[I] && I > y) {
                    D.push("'" + this.terminals_[I] + "'");
                  }
                }
                if (g.showPosition) {
                  N =
              ...
              switch (E[0]) {
                ...
                case 2:
                  ...
                  if (m) {
                    M._$.range = [
                      a[a.length - (T || 1)].range[0],
                      a[a.length - 1].range[1]
                    ];
                  }
                  A = this.performAction.apply(
                    M,
                    [c, u, h, _.yy, E[1], o, a].concat(p)
                  );
        ...
        var o = (function () {
          var t = {
            ...
            performAction: (0, i.K2)(function t(e, n, i, r) {
              var s = r;
              switch (i) {
                case 0:
                  this.pushState('csv');
      ...
      var it = (0, i.K2)(() => B, 'getNodes');
      var rt = (0, i.K2)(() => Q, 'getLinks');
      var st = (0, i.K2)(
        () => ({
          nodes: B.map((t) => ({ id: t.ID })),
          links: Q.map((t) => ({
            source: t.source.ID,
            target: t.target.ID,
            value: t.value
      ...
      var ot = {
        nodesMap: Z,
        getConfig: (0, i.K2)(() => (0, i.D7)().sankey, 'getConfig'),
        getNodes: it,
        getLinks: rt,
        getGraph: st,
        addLink: tt,
      ...
      var lt = { left: a, right: l, center: h, justify: c };
      var ct = (0, i.K2)(function (t, e, n, s) {
        const { securityLevel: o, sankey: a } = (0, i.D7)();
        const l = i.ME.sankey;
        let c;
        if (o === 'sandbox') {
          c = (0, r.Ltv)('#i' + e);
        ...
        const h =
          o === 'sandbox'
            ? (0, r.Ltv)(c.nodes()[0].contentDocument.body)
            : (0, r.Ltv)('body');
        const u =
          o === 'sandbox' ? h.select(`[id="${e}"]`) : (0, r.Ltv)(`[id="${e}"]`);
        const f = a?.width ?? l.width;
        const y = a?.height ?? l.width;
        const d = a?.useMaxWidth ?? l.useMaxWidth;
        const p = a?.nodeAlignment ?? l.nodeAlignment;
        const g = a?.prefix ?? l.prefix;
        const _ = a?.suffix ?? l.suffix;
        const k = a?.showValues ?? l.showValues;
        const x = s.db.getGraph();
        const m = lt[p];
        const v = 10;
        const b = w()
          .nodeId((t) => t.id)
          .nodeWidth(v)
          .nodePadding(10 + (k ? 15 : 0))
          .nodeAlign(m)
          .extent([
            [0, 0],
            [f, y]
        ...
        u.append('g')
          ...
          .join('g')
          .attr('class', 'node')
          .attr('id', (t) => (t.uid = at.next('node-')).id)
          ...
          .attr('fill', (t) => L(t.id));
        const S = (0, i.K2)(({ id: t, value: e }) => {
          if (!k) {
            return t;
          }
          return `${t}\n${g}${Math.round(e * 100) / 100}${_}`;
        }, 'getText');
        u.append('g')
        ...
        const K = a?.linkColor ?? 'gradient';
        if (K === 'gradient') {
          const t = E.append('linearGradient')
            .attr('id', (t) => (t.uid = at.next('linearGradient-')).id)
            .attr('gradientUnits', 'userSpaceOnUse')
            .attr('x1', (t) => t.source.x1)
            .attr('x2', (t) => t.target.x0);
          t.append('stop')
            .attr('offset', '0%')
            .attr('stop-color', (t) => L(t.source.id));
          t.append('stop')
            .attr('offset', '100%')
            .attr('stop-color', (t) => L(t.target.id));
        }
        let A;
        switch (K) {
          case 'gradient':
            A = (0, i.K2)((t) => t.uid, 'coloring');
            break;
          case 'source':
            A = (0, i.K2)((t) => L(t.source.id), 'coloring');
            break;
          case 'target':
            A = (0, i.K2)((t) => L(t.target.id), 'coloring');
            break;
          default:
            A = K;
        }
      ...
      var yt = ft;
      var dt = q.parse.bind(q);
      q.parse = (t) => dt(ut(t));
      var pt = { styles: yt, parser: q, db: ot, renderer: ht };
    }
  }
]);
