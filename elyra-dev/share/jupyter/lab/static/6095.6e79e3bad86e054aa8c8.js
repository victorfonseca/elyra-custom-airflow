  ...
  [6095],
  {
    86095: (e, o, O) => {
      ...
      const P = s.U1.deserialize({
        ...
        tokenizers: [0],
        topRules: { Module: [0, 3] },
        specialized: [{ term: 9, get: (e) => n[e] || -1 }],
        tokenPrec: 0
      });
      const S = t.LRLanguage.define({
        name: 'wast',
        parser: P.configure({
          props: [
            t.indentNodeProp.add({
              App: (0, t.delimitedIndent)({ closing: ')', align: false })
            }),
            t.foldNodeProp.add({
              App: t.foldInside,
              BlockComment(e) {
            ...
            (0, b.styleTags)({
              ...
              Type: b.tags.typeName,
              Number: b.tags.number,
              String: b.tags.string,
              Identifier: b.tags.variableName,
              LineComment: b.tags.lineComment,
              BlockComment: b.tags.blockComment,
              '( )': b.tags.paren
            })
          ]
        }),
      ...
      function i() {
        return new t.LanguageSupport(S);
      }
    }
  }
]);
