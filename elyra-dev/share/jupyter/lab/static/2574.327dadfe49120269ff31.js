...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [2574],
  {
    92574: (e, t, n) => {
      ...
      var r = n(47228);
      var a = 'from';
      var s = new RegExp('^(\\s*)\\b(' + a + ')\\b', 'i');
      var o = ['run', 'cmd', 'entrypoint', 'shell'];
      var l = new RegExp('^(\\s*)(' + o.join('|') + ')(\\s+\\[)', 'i');
      var i = 'expose';
      ...
      const f = (0, r.I)({
        start: [
          ...
          { regex: s, token: [null, 'keyword'], sol: true, next: 'from' },
    ...
    47228: (e, t, n) => {
      ...
      function i(e) {
        return function (t, n) {
          ...
          for (var s = 0; s < a.length; s++) {
            var o = a[s];
            var l = (!o.data.sol || t.sol()) && t.match(o.regex);
            if (l) {
              if (o.data.next) {
                n.state = o.data.next;
              } else if (o.data.push) {
                ...
                n.state = o.data.push;
              } else if (o.data.pop && n.stack && n.stack.length) {
                n.state = n.stack.pop();
              }
              if (o.data.indent) n.indent.push(t.indentation() + t.indentUnit);
              if (o.data.dedent) n.indent.pop();
              var i = o.token;
              if (i && i.apply) i = i(l);
              if (l.length > 2 && o.token && typeof o.token != 'string') {
                n.pending = [];
                for (var u = 2; u < l.length; u++)
                  if (l[u])
                    n.pending.push({ text: l[u], token: o.token[u - 1] });
      ...
      function u(e, t) {
        return function (n, r) {
          if (
            n.indent == null ||
            (t.dontIndentStates && t.dontIndentStates.indexOf(n.state) > -1)
          )
            return null;
          ...
          e: for (;;) {
            for (var o = 0; o < s.length; o++) {
              ...
              if (l.data.dedent && l.data.dedentIfLineStart !== false) {
                ...
                if (i && i[0]) {
                  a--;
                  if (l.next || l.push) s = e[l.next || l.push];
