...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [2794],
  {
    /***/ 12794: /***/ (
      ...
      // EXTERNAL MODULE: consume shared module (default) @jupyter/web-components@~0.16.6 (singleton) (fallback: ./node_modules/@jupyter/web-components/dist/esm/index.js)
      var index_js_ = __webpack_require__(78173);
      // EXTERNAL MODULE: consume shared module (default) react@^18.2.0 (singleton) (fallback: ./node_modules/react/index.js)
      var react_index_js_ = __webpack_require__(44914);
      var react_index_js_default =
        /*#__PURE__*/ __webpack_require__.n(react_index_js_); // CONCATENATED MODULE: ./node_modules/@jupyter/react-components/lib/react-utils.js
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpAccordion)()
      );

      const Accordion = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          ...
          (0, react_index_js_.useImperativeHandle)(
            forwardedRef,
            () => ref.current,
            [ref.current]
          );
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpAccordionItem)()
      );

      const AccordionItem = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const { className, headingLevel, id, expanded, ...filteredProps } =
            props;
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpAnchoredRegion)()
      );

      const AnchoredRegion = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const {
            className,
          ...
          return react_index_js_default().createElement(
            'jp-anchored-region',
            {
              ...
              'horizontal-positioning-mode':
                props.horizontalPositioningMode ||
                props['horizontal-positioning-mode'],
              'horizontal-default-position':
                props.horizontalDefaultPosition ||
                props['horizontal-default-position'],
              ...
              'vertical-positioning-mode':
                props.verticalPositioningMode ||
                props['vertical-positioning-mode'],
              'vertical-default-position':
                props.verticalDefaultPosition ||
                props['vertical-default-position'],
              'vertical-threshold':
                props.verticalThreshold || props['vertical-threshold'],
              'vertical-scaling':
                props.verticalScaling || props['vertical-scaling'],
              'auto-update-mode':
                props.autoUpdateMode || props['auto-update-mode'],
              class: props.className,
              exportparts: props.exportparts,
              for: props.htmlFor,
              part: props.part,
              tabindex: props.tabIndex,
              'horizontal-viewport-lock': props.horizontalViewportLock
                ? ''
                : undefined,
              'horizontal-inset': props.horizontalInset ? '' : undefined,
              'vertical-viewport-lock': props.verticalViewportLock
                ? ''
                : undefined,
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpBreadcrumb)()
      );

      const Breadcrumb = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpBreadcrumbItem)()
      );

      const BreadcrumbItem = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const {
            className,
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpCheckbox)()
      );

      const Checkbox = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const {
            className,
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpCombobox)()
      );

      const Combobox = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const {
            className,
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpDateField)()
      );

      const DateField = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const {
            className,
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpDataGridCell)()
      );

      const DataGridCell = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const {
            className,
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpDataGridRow)()
      );

      const DataGridRow = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const {
            className,
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpDataGrid)()
      );

      const DataGrid = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const {
            className,
          ...
          return react_index_js_default().createElement(
            'jp-data-grid',
            {
              ...
              ...filteredProps,
              'generate-header':
                props.generateHeader || props['generate-header'],
              'grid-template-columns':
                props.gridTemplateColumns || props['grid-template-columns'],
              class: props.className,
              exportparts: props.exportparts,
      ...
      const Dialog = (0, react_index_js_.forwardRef)((props, forwardedRef) => {
        ...
        return react_index_js_default().createElement(
          'jp-dialog',
          {
            ...
            ...filteredProps,
            'aria-describedby':
              props.ariaDescribedby || props['aria-describedby'],
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpDisclosure)()
      );

      const Disclosure = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const { className, appearance, title, expanded, ...filteredProps } =
            props;
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpMenuItem)()
      );

      const MenuItem = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const {
            className,
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpNumberField)()
      );

      const NumberField = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const {
            className,
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpProgressRing)()
      );

      const ProgressRing = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const { className, value, min, max, paused, ...filteredProps } =
            props;
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpProgress)()
      );

      const Progress = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const { className, value, min, max, paused, ...filteredProps } =
            props;
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpRadioGroup)()
      );

      const RadioGroup = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const {
            className,
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpSkeleton)()
      );

      const Skeleton = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const { className, fill, shape, pattern, shimmer, ...filteredProps } =
            props;
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpSliderLabel)()
      );

      const SliderLabel = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const { className, hideMark, disabled, position, ...filteredProps } =
            props;
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpTabPanel)()
      );

      const TabPanel = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const { className, ...filteredProps } = props;
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpTextArea)()
      );

      const TextArea = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const {
            className,
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpTextField)()
      );

      const TextField = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const {
            className,
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpTreeItem)()
      );

      const TreeItem = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const { className, expanded, selected, disabled, ...filteredProps } =
            props;
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpTreeView)()
      );

      const TreeView = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const {
            className,
          ...
          return react_index_js_default().createElement(
            'jp-tree-view',
            {
              ...
              part: props.part,
              tabindex: props.tabIndex,
              'render-collapsed-nodes': props.renderCollapsedNodes
                ? ''
                : undefined,
              style: { ...props.style }
            },
        ...
        return react_index_js_default().createElement(
          'jp-draft-picker',
          {
            ...
            'suggestions-available-text':
              ...
              props['suggestions-available-text'],
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpPickerMenu)()
      );

      const PickerMenu = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const { className, suggestionsAvailableText, ...filteredProps } =
            props;
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpPickerMenuOption)()
      );

      const PickerMenuOption = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const { className, value, contentsTemplate, ...filteredProps } =
            props;
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpPickerList)()
      );

      const PickerList = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const { className, ...filteredProps } = props;
      ...
      (0, index_js_.provideJupyterDesignSystem)().register(
        (0, index_js_.jpPickerListItem)()
      );

      const PickerListItem = (0, react_index_js_.forwardRef)(
        (props, forwardedRef) => {
          const ref = (0, react_index_js_.useRef)(null);
          const { className, value, contentsTemplate, ...filteredProps } =
            props;
...
//# sourceMappingURL=2794.4df31951bf9fe68a1240.js.map?v=4df31951bf9fe68a1240
