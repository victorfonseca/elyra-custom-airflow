...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [6974],
  {
    ...
    /***/ 66974: /***/ (
      ...
      var dagre = __webpack_require__(82211);
      ...
      var graph = __webpack_require__(65791); // CONCATENATED MODULE: ./node_modules/dagre-d3-es/src/graphlib/json.js
      function write(g) {
        var json = {
          options: {
      ...
      var graphlib = __webpack_require__(84416); // CONCATENATED MODULE: ./node_modules/mermaid/dist/chunks/mermaid.core/dagre-OKDRZEBW.mjs
      ...
      var isDescendant = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
        (id, ancestorId) => {
      ...
      var edgeInCluster = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
        (edge, clusterId) => {
      ...
      var copy = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
        (clusterId, graph, newGraph, rootId) => {
      ...
      chunk_YTJNT7DU /* __name */.K2)((id, graph) => {
      ...
      var findCommonEdges = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
        (graph, id1, id2) => {
          const edges1 = graph
            .edges()
      ...
      chunk_YTJNT7DU /* __name */.K2)((id, graph, clusterId) => {
        const children = graph.children(id);
        chunk_YTJNT7DU /* log */.Rm.trace(
      ...
      var getAnchorId = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
        (id) => {
          if (!clusterDb.has(id)) {
            return id;
          }
      ...
      chunk_YTJNT7DU /* __name */.K2)((graph, depth) => {
        if (!graph || depth > 10) {
      ...
      var extractor = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
        (graph, depth) => {
          chunk_YTJNT7DU /* log */.Rm.warn(
            'extractor - ',
            depth,
      ...
      var sorter = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
        (graph, nodes) => {
          if (nodes.length === 0) {
            return [];
          }
      ...
      chunk_YTJNT7DU /* __name */.K2)(
        (graph) => sorter(graph, graph.children()),
        'sortNodesByHierarchy'
      );

      // src/rendering-util/layout-algorithms/dagre/index.js
      var recursiveRender = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
        async (_elem, graph, diagramType, id, parentCluster, siteConfig) => {
            ...
            graph.nodes().map(async function (v) {
              ...
              if (parentCluster !== void 0) {
                const data = JSON.parse(
                  JSON.stringify(parentCluster.clusterData)
                );
                chunk_YTJNT7DU /* log */.Rm.trace(
              ...
              if (node?.clusterNode) {
                ...
                if (graph.children(v).length > 0) {
                  ...
                  chunk_YTJNT7DU /* log */.Rm.trace(
                    findNonClusterChild(node.id, graph)
                  );
                  ...
                  await (0, chunk_HRU6DDCH /* insertNode */.on)(
                    nodes,
                    graph.node(v),
          ...
          chunk_YTJNT7DU /* __name */.K2)(async () => {
            const edgePromises = graph.edges().map(async function (e) {
              ...
              await (0, chunk_IIMUDSI4 /* insertEdgeLabel */.jP)(
                edgeLabels,
                edge
              );
            });
          ...
          chunk_K557N5IZ /* getSubGraphTitleMargins */.O)(siteConfig);
          await Promise.all(
            sortNodesByHierarchy(graph).map(async function (v) {
              ...
              if (node?.clusterNode) {
                ...
                if (graph.children(v).length > 0) {
                  ...
                  await (0, chunk_HRU6DDCH /* insertCluster */.U)(
                    clusters,
                    node
                  );
                  clusterDb.get(node.id).node = node;
          ...
          graph.edges().forEach(function (e) {
            ...
            edge.points.forEach(
              (point) => (point.y += subGraphTitleTotalMargin / 2)
            );
            const startNode = graph.node(e.v);
            var endNode = graph.node(e.w);
            const paths = (0, chunk_IIMUDSI4 /* insertEdge */.Jo)(
              edgePaths,
              edge,
              clusterDb,
              diagramType,
      ...
      var render = /* @__PURE__ */ (0, chunk_YTJNT7DU /* __name */.K2)(
        async (data4Layout, svg) => {
          ...
          (0, chunk_IIMUDSI4 /* markers_default */.g0)(
            element,
            data4Layout.markers,
            data4Layout.type,
...
//# sourceMappingURL=6974.91f5dcaa6b98e5a7e06e.js.map?v=91f5dcaa6b98e5a7e06e
