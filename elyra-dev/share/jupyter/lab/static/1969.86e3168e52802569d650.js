    ...
    10497: function (t, e, r) {
      ...
      var o =
        ...
        function (t, e) {
          ...
          var n = r.call(t),
            ...
            a;
          try {
            while ((e === void 0 || e-- > 0) && !(i = n.next()).done)
              o.push(i.value);
          } catch (s) {
            a = { error: s };
          } finally {
      ...
      var y = (function (t) {
        ...
        e.create = function (t) {
          ...
          try {
            for (
              var a = i(Object.keys(t)), s = a.next();
              !s.done;
              s = a.next()
            ) {
              var l = s.value;
      ...
      var g = (function () {
        ...
        t.prototype.reset = function (t) {
          ...
          t.outputJax &&
            (r = this.outputJax).reset.apply(r, a([], o(t.outputJax), false));
          return this;
        };
      ...
      var h = (function (t) {
          ...
          if (!this.processed.isSet('findMath')) {
            ...
            try {
              for (
                ...
                try {
                  for (
                    var b = ((n = void 0), a(this.inputJax)), g = b.next();
                    !g.done;
                    g = b.next()
                  ) {
                    var _ = g.value;
                    ...
                    if (_.processStrings) {
                      if (m === null) {
                        (s = o(this.domStrings.find(y), 2)),
                          (m = s[0]),
                          (x = s[1]);
                      }
                      try {
                        for (
                          var S = ((u = void 0), a(_.findMath(m))),
                            O = S.next();
                          !O.done;
                          O = S.next()
                        ) {
        ...
        e.prototype.findSheet = function (t, e) {
          ...
          if (e) {
            try {
              for (
                var i = a(this.adaptor.tags(t, 'style')), o = i.next();
                !o.done;
                o = i.next()
              ) {
                var s = o.value;
        ...
        e.OPTIONS = i(i({}, s.AbstractMathDocument.OPTIONS), {
          renderActions: (0, l.expandable)(
            i(i({}, s.AbstractMathDocument.OPTIONS.renderActions), {
              styles: [f.STATE.INSERTED + 1, '', 'updateStyleSheet', false]
            })
          ),
    ...
    88762: function (t, e) {
      ...
      var s = (function () {
        ...
        t.prototype.unshift = function () {
          ...
          try {
            for (
              var i = o(r.slice(0).reverse()), s = i.next();
              !s.done;
              s = i.next()
            ) {
              var l = s.value;
