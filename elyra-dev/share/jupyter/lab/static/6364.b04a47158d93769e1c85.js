...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [6364],
  {
    ...
    /***/ 27574: /***/ (
      ...
      /* harmony import */ var _utils_index_js__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(57991);
      /* harmony import */ var _color_index_js__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(63221);
      /* IMPORT */

      /* MAIN */
      const channel = (color, channel) => {
        return _utils_index_js__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */.A.lang
          .round(
            _color_index_js__WEBPACK_IMPORTED_MODULE_1__ /* ["default"] */.A.parse(
              color
            )[channel]
          );
      };
    ...
    /***/ 97134: /***/ (
      ...
      function clone(value) {
        return (0,
        _baseClone_js__WEBPACK_IMPORTED_MODULE_0__ /* ["default"] */.A)(
          value,
          CLONE_SYMBOLS_FLAG
        );
      }
    ...
    /***/ 46364: /***/ (
      ...
      /* harmony import */ var _chunk_VV3M67IP_mjs__WEBPACK_IMPORTED_MODULE_0__ =
        __webpack_require__(94746);
      /* harmony import */ var _chunk_K557N5IZ_mjs__WEBPACK_IMPORTED_MODULE_1__ =
        __webpack_require__(57590);
      /* harmony import */ var _chunk_C3MQ5ANM_mjs__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(76261);
      /* harmony import */ var _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_3__ =
        __webpack_require__(96049);
      /* harmony import */ var _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ =
        __webpack_require__(75905);
      /* harmony import */ var lodash_es_clone_js__WEBPACK_IMPORTED_MODULE_5__ =
        __webpack_require__(97134);
      /* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_6__ =
        __webpack_require__(27574);
      /* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_7__ =
        __webpack_require__(3635);
      /* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_8__ =
        __webpack_require__(24982);
      /* harmony import */ var dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_9__ =
        __webpack_require__(84416);

      // src/diagrams/block/parser/block.jison
      var parser = (function () {
        var o = /* @__PURE__ */ (0,
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
            function (k, v, o2, l) {
        ...
        var parser2 = {
          ...
          table: [
            ...
            { 45: [1, 30] },
            { 48: [1, 31] },
            o($Vd, [2, 29], { 33: 32, 36: [1, 33], 38: [1, 34] }),
            { 1: [2, 7] },
            o($V8, [2, 13]),
            { 26: 35, 32: $V4 },
            { 32: [2, 14] },
            ...
            conditions: {
              ...
              INITIAL: {
                rules: [
                  ...
                  27, 30, 32, 34, 37, 55, 56, 57, 58, 59, 60, 61, 62, 63, 64,
                  65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75, 76, 93, 94, 95,
                  96, 97, 98, 99, 105
                ],
                inclusive: true
              }
        ...
        (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
          Parser,
          'Parser'
        );
      ...
      var STYLECLASS_SEP = ',';
      var config = (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .getConfig2 */.D7)();
      var classes = /* @__PURE__ */ new Map();
      var sanitizeText2 = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
        (txt) =>
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .common_default */.Y2.sanitizeText(
            txt,
            config
          ),
        'sanitizeText'
          ...
          for (const block of blockList) {
            ...
            if (block.type === 'column-setting') {
              ...
              if (block.type === 'space') {
                ...
                for (let j = 0; j < w; j++) {
                  const newBlock = (0,
                  lodash_es_clone_js__WEBPACK_IMPORTED_MODULE_5__ /* ["default"] */.A)(
                    block
                  );
      ...
      var db = {
        ...
        _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
          () =>
            (0,
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .getConfig */.zj)()
              .block,
          'getConfig'
        ),
        typeStr2Type,
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
        (color, opacity) => {
          const channel2 =
            khroma__WEBPACK_IMPORTED_MODULE_6__ /* ["default"] */.A;
          const r = channel2(color, 'r');
          const g = channel2(color, 'g');
          const b = channel2(color, 'b');
          return khroma__WEBPACK_IMPORTED_MODULE_7__ /* ["default"] */
            .A(r, g, b, opacity);
        },
        'fade'
      );
...
`,
      ...
      function setBlockSizes(block, db2, siblingWidth = 0, siblingHeight = 0) {
        ...
        if (block.children?.length > 0) {
          ...
          if (width < siblingWidth) {
            ...
            height = siblingHeight;
            const childWidth =
              (siblingWidth - xSize * padding - padding) / xSize;
            const childHeight =
              (siblingHeight - ySize * padding - padding) / ySize;
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.Rm.debug(
              'Size indata abc88',
              block.id,
              'childWidth',
      ...
      function layoutBlocks(block, db2) {
        ...
        if (
          ...
          const widthOfChildren =
            block.children.length * width +
            (block.children.length - 1) * padding;
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.Rm.debug(
            'widthOfChildren 88',
            widthOfChildren,
            'posX'
          ...
          let startingPosX = block?.size?.x
            ? block?.size?.x + (-block?.size?.width / 2 || 0)
            : -padding;
          let rowPos = 0;
          for (const child of block.children) {
            const parent = block;
      ...
      function addHtmlLabel(node) {
        const fo = (0, d3__WEBPACK_IMPORTED_MODULE_8__ /* .select */.Ltv)(
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
        (_vertexText, style, isTitle, isNode) => {
          ...
          if (
            (0,
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .evaluate */._3)(
              (0,
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .getConfig2 */.D7)()
            ...
            const node = {
              isNode,
              label: (0,
              _chunk_C3MQ5ANM_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .replaceIconSubstring */.hE)(
                (0,
                _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .decodeEntities */.Sm)(
                  vertexText
                )
              ),
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
        (svgPath, edge, url, id, diagramType) => {
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
        (svgPath, position, arrowType, url, id, diagramType) => {
          ...
          if (!endMarkerType) {
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.Rm.warn(
              `Unknown arrow type: ${arrowType}`
            );
            return;
          }
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
        (elem, edge) => {
          ...
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .evaluate */._3)(
            config2.flowchart.htmlLabels
          );
          const labelElement =
            edge.labelType === 'markdown'
              ? (0,
                _chunk_C3MQ5ANM_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .createText */.GZ)(
                  elem,
                  edge.label,
                  {
          ...
          if (useHtmlLabels) {
            ...
            const dv = (0, d3__WEBPACK_IMPORTED_MODULE_8__ /* .select */.Ltv)(
              labelElement
            );
          ...
          if (edge.startLabelLeft) {
            const startLabelElement = createLabel_default(
              edge.startLabelLeft,
              edge.labelStyle
            );
            const startEdgeLabelLeft = elem
              .insert('g')
          ...
          if (edge.startLabelRight) {
            ...
            const startEdgeLabelRight = elem
              .insert('g')
              .attr('class', 'edgeTerminals');
            const inner = startEdgeLabelRight
              .insert('g')
              .attr('class', 'inner');
          ...
          if (edge.endLabelLeft) {
            const endLabelElement = createLabel_default(
              edge.endLabelLeft,
              edge.labelStyle
            );
            const endEdgeLabelLeft = elem
              .insert('g')
              .attr('class', 'edgeTerminals');
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
        (edge, paths) => {
          ...
          _chunk_K557N5IZ_mjs__WEBPACK_IMPORTED_MODULE_1__ /* .getSubGraphTitleMargins */.O)(
            siteConfig
          );
          if (edge.label) {
            ...
            if (path) {
              const pos =
                _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .utils_default */._K
                  .calcLabelPosition(path);
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.Rm.debug(
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
        (node, outsidePoint, insidePoint) => {
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.Rm
  ...
  node        : x:${node.x} y:${node.y} w:${node.width} h:${node.height}`);
          ...
          if (
            Math.abs(y - outsidePoint.y) * w >
            Math.abs(x - outsidePoint.x) * h
          ) {
            let q =
            ...
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.Rm.debug(
              `abc89 topp/bott calc, Q ${Q}, q ${q}, R ${R}, r ${r}`,
              res
            );
            return res;
          } else {
            ...
            let _y =
              insidePoint.y < outsidePoint.y
                ...
                : insidePoint.y - q;
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.Rm.debug(
              `sides calc abc89, Q ${Q}, q ${q}, R ${R}, r ${r}`,
              { _x, _y }
            );
            if (r === 0) {
              _x = outsidePoint.x;
        ...
        (_points, boundaryNode) => {
          ...
          _points.forEach((point2) => {
            if (!outsideNode(boundaryNode, point2) && !isInside) {
              ...
              points.forEach((p) => {
                pointPresent =
                  pointPresent || (p.x === inter.x && p.y === inter.y);
              });
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
        function (elem, e, edge, clusterDb, diagramType, graph, id) {
          ...
          const { x, y } = (0,
          _chunk_VV3M67IP_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .getLineFunctionsWithOffset */.R)(
            edge
          );
          const lineFunction = (0,
          d3__WEBPACK_IMPORTED_MODULE_8__ /* .line */.n8j)()
            .x(x)
            .y(y)
            .curve(curve);
          let strokeClasses;
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
        (duplicatedDirections, bbox, node) => {
          const directions =
            expandAndDeduplicateDirections(duplicatedDirections);
          const f = 2;
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
        async (parent, node, _classes, isNode) => {
          const config2 = (0,
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .getConfig2 */.D7)();
          let classes2;
          const useHtmlLabels =
          ...
          if (node.labelType === 'markdown') {
            ...
            _chunk_C3MQ5ANM_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .createText */.GZ)(
              label,
              (0,
              _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .sanitizeText */.jZ)(
                (0,
                _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .decodeEntities */.Sm)(
                  labelText
                ),
                  ...
                  (img) =>
                    new Promise((res) => {
                      function setupImage() {
                        ...
                        if (noImgText) {
                          const bodyFontSize = config2.fontSize
                            ? config2.fontSize
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
        async (parent, node) => {
          ...
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .log */.Rm.info(
            'Classes = ',
            node.classes
          );
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
        (parent, node) => {
          ...
          const text = label
            .node()
            .appendChild(
              createLabel_default(title, node.labelStyle, true, true)
            );
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
        (parent, node) => {
          ...
          const interfaceLabelText = node.classData.annotations[0]
            ? '\xAB' + node.classData.annotations[0] + '\xBB'
            : '';
          ...
          const classTitleLabel = labelContainer
            .node()
            .appendChild(
              createLabel_default(classTitleString, node.labelStyle, true, true)
            );
          (0, d3__WEBPACK_IMPORTED_MODULE_8__ /* .select */.Ltv)(
            classTitleLabel
          ...
          topLine
            ...
            .attr(
              'y2',
              -maxHeight / 2 - halfPadding + lineHeight + verticalPos
            );
      ...
      function getNodeFromBlock(block, db2, positioned = false) {
        ...
        const styles = (0,
        _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .getStylesFromArray */.sM)(
          vertex?.styles ?? []
        );
      ...
      async function insertEdges(elem, edges, blocks2, db2, id) {
        const g =
          new dagre_d3_es_src_graphlib_index_js__WEBPACK_IMPORTED_MODULE_9__ /* .Graph */.T(
            {
              multigraph: true,
              compound: true
            }
      ...
      var draw = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .__name */.K2)(
        async function (text, id, _version, diagObj) {
          ...
          if (securityLevel === 'sandbox') {
            sandboxElement = (0,
            d3__WEBPACK_IMPORTED_MODULE_8__ /* .select */.Ltv)('#i' + id);
          }
          const root =
            securityLevel === 'sandbox'
              ? (0, d3__WEBPACK_IMPORTED_MODULE_8__ /* .select */.Ltv)(
              ...
              : (0, d3__WEBPACK_IMPORTED_MODULE_8__ /* .select */.Ltv)('body');
          const svg =
            securityLevel === 'sandbox'
              ? root.select(`[id="${id}"]`)
              : (0, d3__WEBPACK_IMPORTED_MODULE_8__ /* .select */.Ltv)(
          ...
          if (bounds) {
            ...
            (0,
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_4__ /* .configureSvgSize */.a$)(
              svg,
              height,
              width,
              !!useMaxWidth
...
//# sourceMappingURL=6364.b04a47158d93769e1c85.js.map?v=b04a47158d93769e1c85
