...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [4364],
  {
    54364: (e, t, n) => {
      ...
      const N =
        /\[[^[\]]*?\]\((?:\\.|[^\\\(\)]|\((?:\\.|[^\\\(\)])*\))*\)|`[^`]*?`|<[^<>]*?>/g;
      const G = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/;
      const H = o(G, 'u').replace(/punct/g, Z).getRegex();
      const X = o(G, 'u').replace(/punct/g, j).getRegex();
      const F =
        '^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)' +
        '|[^*]+(?=[^*])' +
        '|(?!\\*)punct(\\*+)(?=[\\s]|$)' +
      ...
      const U = o(F, 'gu')
        .replace(/notPunctSpace/g, D)
        .replace(/punctSpace/g, v)
        .replace(/punct/g, Z)
        .getRegex();
      const J = o(F, 'gu')
        .replace(/notPunctSpace/g, Q)
        .replace(/punctSpace/g, O)
        .replace(/punct/g, j)
        .getRegex();
      const K = o(
        '^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)' +
      ...
      const V = o(/\\(punct)/, 'gu')
        .replace(/punct/g, Z)
        .getRegex();
      const W = o(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/)
        ...
        .getRegex();
      const Y = o(S).replace('(?:--\x3e|$)', '--\x3e').getRegex();
      const ee = o(
        '^comment' +
          '|^</[a-zA-Z][\\w:-]*\\s*>' +
        ...
        .getRegex();
      const te = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/;
      const ne = o(/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/)
        .replace('label', te)
        .replace('href', /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/)
        .replace(
          'title',
      ...
      const ce = {
        ...ae,
        br: o(q).replace('{2,}', '*').getRegex(),
        text: o(ae.text)
          .replace('\\b_', '\\b_| {2,}\\n')
          .replace(/\{2,\}/g, '*')
          .getRegex()
      };
      const he = { normal: _, gfm: P, pedantic: L };
      const pe = { normal: le, gfm: ae, breaks: ce, pedantic: oe };
      const ue = {
        '&': '&amp;',
        '<': '&lt;',
        '>': '&gt;',
      ...
      function ge(e, t) {
        if (t) {
          if (a.escapeTest.test(e)) {
            return e.replace(a.escapeReplace, fe);
          }
        } else {
          if (a.escapeTestNoEncode.test(e)) {
            return e.replace(a.escapeReplaceNoEncode, fe);
          }
        }
        return e;
      }
      ...
      function de(e, t) {
        const n = e.replace(a.findPipe, (e, t, n) => {
            let s = false;
            let r = t;
            while (--r >= 0 && n[r] === '\\') s = !s;
            if (s) {
          ...
          s = n.split(a.splitPipe);
        let r = 0;
        if (!s[0].trim()) {
          s.shift();
        }
        if (s.length > 0 && !s.at(-1)?.trim()) {
          s.pop();
        }
        if (t) {
          if (s.length > t) {
      ...
      function we(e, t, n, s, r) {
        const i = t.href;
        const l = t.title || null;
        const o = e[1].replace(r.other.outputLinkReplace, '$1');
        if (e[0].charAt(0) !== '!') {
          s.state.inLink = true;
          const e = {
            type: 'link',
      ...
      class ye {
        ...
        code(e) {
          ...
          if (t) {
            ...
            return {
              ...
              text: !this.options.pedantic ? xe(e, '\n') : e
            };
          }
        }
        fences(e) {
          ...
          if (t) {
            ...
            if (this.rules.other.endingHash.test(e)) {
              ...
              if (this.options.pedantic) {
                e = t.trim();
              } else if (!t || this.rules.other.endingSpaceChar.test(t)) {
                e = t.trim();
              }
            }
            return {
        ...
        blockquote(e) {
          ...
          if (t) {
            ...
            while (e.length > 0) {
              ...
              this.lexer.blockTokens(a, r, true);
        ...
        list(e) {
          ...
          if (t) {
            ...
            while (e) {
              ...
              if (h && this.rules.other.blankLine.test(c)) {
                s += c + '\n';
              ...
              if (!n) {
                ...
                const n = this.rules.other.hrRegex(p);
                const r = this.rules.other.fencesBeginRegex(p);
                const i = this.rules.other.headingBeginRegex(p);
                const l = this.rules.other.htmlBeginRegex(p);
                while (e) {
                  const u = e.split('\n', 1)[0];
                  let f;
                  c = u;
                  if (this.options.pedantic) {
                    ...
                    f = c.replace(this.rules.other.tabCharGlobal, '    ');
                  }
                  if (r.test(c)) {
                    break;
                  }
                  ...
                  if (
                    f.search(this.rules.other.nonSpaceChar) >= p ||
                    !c.trim()
                  ) {
                    o += '\n' + f.slice(p);
                  } else {
              ...
              if (!r.loose) {
                if (l) {
                  r.loose = true;
                } else if (this.rules.other.doubleBlankLine.test(s)) {
                  l = true;
                }
              }
              let u = null;
              let f;
              if (this.options.gfm) {
                u = this.rules.other.listIsTask.exec(o);
                if (u) {
                  f = u[0] !== '[ ] ';
            ...
            for (let e = 0; e < r.items.length; e++) {
              ...
              if (!r.loose) {
                const t = r.items[e].tokens.filter((e) => e.type === 'space');
                const n =
                  t.length > 0 &&
        ...
        table(e) {
          ...
          for (const l of s) {
            if (this.rules.other.tableAlignRight.test(l)) {
              i.align.push('right');
            } else if (this.rules.other.tableAlignCenter.test(l)) {
              i.align.push('center');
            } else if (this.rules.other.tableAlignLeft.test(l)) {
              i.align.push('left');
            } else {
              i.align.push(null);
            }
        ...
        reflink(e, t) {
          ...
          if (
            ...
            return we(n, s, n[0], this.lexer, this.rules);
          }
        }
        emStrong(e, t, n = '') {
          ...
          const r = s[1] || s[2] || '';
          if (!r || !n || this.rules.inline.punctuation.exec(n)) {
            ...
            while ((s = a.exec(t)) != null) {
              ...
              const a = e.slice(0, n + s.index + t + i);
              if (Math.min(n, i) % 2) {
                const e = a.slice(1, -1);
                return {
                  type: 'em',
      ...
      class $e {
        ...
        constructor(e) {
          ...
          const t = { other: a, block: he.normal, inline: pe.normal };
          if (this.options.pedantic) {
            t.block = he.pedantic;
            t.inline = pe.pedantic;
        ...
        blockTokens(e, t = [], n = false) {
          if (this.options.pedantic) {
            e = e.replace(a.tabCharGlobal, '    ').replace(a.spaceLine, '');
          }
          while (e) {
            let s;
            if (
              this.options.extensions?.block?.some((n) => {
                if ((s = n.call({ lexer: this }, e, t))) {
            ...
            if ((s = this.tokenizer.code(e))) {
              e = e.substring(s.raw.length);
              const n = t.at(-1);
              if (n?.type === 'paragraph' || n?.type === 'text') {
                n.raw += '\n' + s.raw;
                n.text += '\n' + s.text;
            ...
            if ((s = this.tokenizer.def(e))) {
              ...
              if (n?.type === 'paragraph' || n?.type === 'text') {
                ...
                n.text += '\n' + s.raw;
                this.inlineQueue.at(-1).src = n.text;
              } else if (!this.tokens.links[s.tag]) {
          ...
          if (this.tokens.links) {
            ...
            if (e.length > 0) {
              while (
                ...
                if (e.includes(s[0].slice(s[0].lastIndexOf('[') + 1, -1))) {
                  n =
                    n.slice(0, s.index) +
                    '[' +
      ...
      class Re {
        ...
        code({ text: e, lang: t, escaped: n }) {
          const s = (t || '').match(a.notSpaceStart)?.[0];
          const r = e.replace(a.endingNewline, '') + '\n';
          if (!s) {
            return '<pre><code>' + (n ? r : ge(r, true)) + '</code></pre>\n';
          }
          return (
        ...
        tablecell(e) {
          ...
          const s = e.align ? `<${n} align="${e.align}">` : `<${n}>`;
          return s + t + `</${n}>\n`;
        }
        strong({ tokens: e }) {
        ...
        parse(e, t = true) {
          ...
          for (let s = 0; s < e.length; s++) {
            ...
            if (this.options.extensions?.renderers?.[r.type]) {
              const e = r;
              const t = this.options.extensions.renderers[e.type].call(
                { parser: this },
                e
              );
              if (
              ...
              case 'text': {
                ...
                if (t) {
                  n += this.renderer.paragraph({
                    ...
                    raw: l,
                    text: l,
                    tokens: [{ type: 'text', raw: l, text: l, escaped: true }]
                  });
                } else {
                  n += l;
                }
      ...
      class Ae {
        ...
        use(...e) {
          ...
          e.forEach((e) => {
            ...
            if (e.renderer) {
              const t = this.defaults.renderer || new Re(this.defaults);
            ...
            if (e.hooks) {
              const t = this.defaults.hooks || new ze();
            ...
            if (e.walkTokens) {
              ...
              const s = e.walkTokens;
              n.walkTokens = function (e) {
                let n = [];
                n.push(s.call(this, e));
                if (t) {
                  n = n.concat(t.call(this, e));
                }
                return n;
              };
            }
        ...
        parseMarkdown(e) {
          const t = (t, n) => {
            const s = { ...n };
            const r = { ...this.defaults, ...s };
            const i = this.onError(!!r.silent, !!r.async);
            if (this.defaults.async === true && s.async === false) {
              return i(
                new Error(
            ...
            if (r.async) {
              return Promise.resolve(r.hooks ? r.hooks.preprocess(t) : t)
                ...
                .then((e) =>
                  r.walkTokens
                    ? Promise.all(this.walkTokens(e, r.walkTokens)).then(
                        () => e
                      )
                    : e
                )
            ...
            try {
              if (r.hooks) {
                t = r.hooks.preprocess(t);
              }
              let e = l(t, r);
              if (r.hooks) {
                e = r.hooks.processAllTokens(e);
              }
              if (r.walkTokens) {
      ...
      Ie.walkTokens = function (e, t) {
        return _e.walkTokens(e, t);
      };
      Ie.parseInline = _e.parseInline;
      Ie.Parser = Te;
      Ie.parser = Te.parse;
      Ie.Renderer = Re;
      Ie.TextRenderer = Se;
      ...
      Ie.parse = Ie;
      const Pe = Ie.options;
      const Le = Ie.setOptions;
      const Ce = Ie.use;
      const Be = Ie.walkTokens;
      const qe = Ie.parseInline;
      const Ee = Ie;
      const Ze = Te.parse;
      const ve = $e.lex;
    }
