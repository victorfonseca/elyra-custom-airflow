...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [1909],
  {
    /***/ 31909: /***/ (
      ...
      __webpack_require__(11252);
      __webpack_require__(3654);
      __webpack_require__(48600);
      __webpack_require__(62684);
      __webpack_require__(12512);
      __webpack_require__(79224);
      __webpack_require__(82792);
      __webpack_require__(77774);
      __webpack_require__(2362);
      __webpack_require__(12796);
      __webpack_require__(50228);
      __webpack_require__(79712);
      __webpack_require__(69600);
      __webpack_require__(90272);
      __webpack_require__(45320);
      __webpack_require__(13726);
      __webpack_require__(48128);
      __webpack_require__(15472);
      __webpack_require__(95120);
      __webpack_require__(98452);
      __webpack_require__(7932);
      __webpack_require__(75802);
      __webpack_require__(36912);
      __webpack_require__(21018);
      __webpack_require__(68916);
      __webpack_require__(23468);
      __webpack_require__(91610);
      __webpack_require__(18560);
      __webpack_require__(46370);
      __webpack_require__(29302);
      __webpack_require__(82736);
    ...
    /***/ 3654: /***/ function (
      ...
      var Configuration_js_1 = __webpack_require__(56441);
      var TexParser_js_1 = __importDefault(__webpack_require__(75845));
      var SymbolMap_js_1 = __webpack_require__(80209);
      var BaseMethods_js_1 = __importDefault(__webpack_require__(38364));
      ...
      exports.ActionMethods.Mathtip = function (parser, name) {
        ...
        parser.Push(
          parser.create('node', 'maction', [arg, tip], {
            actiontype: 'tooltip'
          })
        );
      };
      ...
      exports.ActionConfiguration = Configuration_js_1.Configuration.create(
        'action',
    ...
    /***/ 48600: /***/ function (
      ...
      var Configuration_js_1 = __webpack_require__(56441);
      var AmsItems_js_1 = __webpack_require__(92902);
      var Tags_js_1 = __webpack_require__(17782);
      var AmsMethods_js_1 = __webpack_require__(98840);
      __webpack_require__(97403);
      var SymbolMap_js_1 = __webpack_require__(80209);
      ...
      var init = function (config) {
        ...
        config.append(
          Configuration_js_1.Configuration.local({
            handler: { macro: [AmsMethods_js_1.NEW_OPS] },
            priority: -1
          })
        );
      };
      exports.AmsConfiguration = Configuration_js_1.Configuration.create(
        'ams',
        {
          handler: {
          ...
          items:
            ((_a = {}),
            (_a[AmsItems_js_1.MultlineItem.prototype.kind] =
              AmsItems_js_1.MultlineItem),
            (_a[AmsItems_js_1.FlalignItem.prototype.kind] =
              AmsItems_js_1.FlalignItem),
            _a),
          tags: { ams: AmsTags },
          init: init,
          config: function (_config, jax) {
            if (jax.parseOptions.options.multlineWidth) {
              jax.parseOptions.options.ams.multlineWidth =
                jax.parseOptions.options.multlineWidth;
            }
    ...
    /***/ 92902: /***/ function (
      ...
      var BaseItems_js_1 = __webpack_require__(94650);
      var ParseUtil_js_1 = __importDefault(__webpack_require__(6980));
      var NodeUtil_js_1 = __importDefault(__webpack_require__(72691));
      var TexError_js_1 = __importDefault(__webpack_require__(98770));
      var TexConstants_js_1 = __webpack_require__(80469);
      var MultlineItem = (function (_super) {
        ...
        MultlineItem.prototype.EndEntry = function () {
          if (this.table.length) {
            ParseUtil_js_1.default.fixInitialMO(
        ...
        MultlineItem.prototype.EndRow = function () {
          if (this.row.length !== 1) {
            throw new TexError_js_1.default(
              'MultlineRowsOneCol',
        ...
        MultlineItem.prototype.EndTable = function () {
          ...
          if (this.table.length) {
            var m = this.table.length - 1,
              label = -1;
            if (
              !NodeUtil_js_1.default.getAttribute(
                NodeUtil_js_1.default.getChildren(this.table[0])[0],
                'columnalign'
              )
            ) {
              NodeUtil_js_1.default.setAttribute(
                NodeUtil_js_1.default.getChildren(this.table[0])[0],
                'columnalign',
            ...
            if (
              !NodeUtil_js_1.default.getAttribute(
                NodeUtil_js_1.default.getChildren(this.table[m])[0],
                'columnalign'
              )
            ) {
              NodeUtil_js_1.default.setAttribute(
            ...
            if (tag) {
              label =
                this.arraydef.side === TexConstants_js_1.TexConstant.Align.LEFT
                  ? 0
                  : this.table.length - 1;
              var mtr = this.table[label];
              var mlabel = this.create(
                'node',
                'mlabeledtr',
                [tag].concat(NodeUtil_js_1.default.getChildren(mtr))
              );
      ...
      var FlalignItem = (function (_super) {
        ...
        FlalignItem.prototype.EndRow = function () {
          ...
          if (this.getProperty('zeroWidthLabel') && mtr.isKind('mlabeledtr')) {
            ...
            var mpadded = this.create(
              'node',
              'mpadded',
              NodeUtil_js_1.default.getChildren(mtd),
              def
            );
    ...
    /***/ 97403: /***/ function (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      var AmsMethods_js_1 = __webpack_require__(98840);
      var sm = __importStar(__webpack_require__(80209));
      var TexConstants_js_1 = __webpack_require__(80469);
      var ParseMethods_js_1 = __importDefault(__webpack_require__(22960));
      var ParseUtil_js_1 = __importDefault(__webpack_require__(6980));
      var MmlNode_js_1 = __webpack_require__(80747);
      var lengths_js_1 = __webpack_require__(86810);
      new sm.CharacterMap(
        'AMSmath-mathchar0mo',
        ParseMethods_js_1.default.mathchar0mo,
        {
      ...
      new sm.RegExpMap(
        ...
        AmsMethods_js_1.AmsMethods.operatorLetter,
        /[-*]/i
      );
      new sm.CommandMap(
        'AMSmath-macros',
      ...
      new sm.EnvironmentMap(
        'AMSmath-environment',
        ParseMethods_js_1.default.environment,
        {
          ...
          align: [
            ...
            true,
            'rl',
            ParseUtil_js_1.default.cols(0, 2)
          ],
          'align*': [
            'EqnArray',
            null,
          ...
          smallmatrix: [
            ...
            null,
            'c',
            ParseUtil_js_1.default.cols(1 / 3),
            '.2em',
            'S',
            1
          ],
      ...
      new sm.DelimiterMap(
        'AMSmath-delimiter',
        ParseMethods_js_1.default.delimiter,
        {
    ...
    /***/ 98840: /***/ function (
      ...
      var TexParser_js_1 = __importDefault(__webpack_require__(75845));
      var TexError_js_1 = __importDefault(__webpack_require__(98770));
      var Symbol_js_1 = __webpack_require__(27151);
      var BaseMethods_js_1 = __importDefault(__webpack_require__(38364));
      var MmlNode_js_1 = __webpack_require__(80747);
      exports.AmsMethods = {};
      exports.AmsMethods.AmsEqnArray = function (
        parser,
        begin,
        numbered,
        taggable,
      ...
      exports.AmsMethods.AlignAt = function (
        parser,
        begin,
        numbered,
        taggable
        ...
        if (taggable) {
          return exports.AmsMethods.EqnArray(
            parser,
            begin,
            numbered,
            taggable,
        ...
        var array = exports.AmsMethods.EqnArray(
          parser,
          begin,
          numbered,
          taggable,
      ...
      exports.AmsMethods.Multline = function (parser, begin, numbered) {
        ...
        var item = parser.itemFactory.create(
          'multline',
          numbered,
          parser.stack
        );
      ...
      exports.AmsMethods.XalignAt = function (parser, begin, numbered, padded) {
        ...
        var item = exports.AmsMethods.FlalignArray(
          parser,
          begin,
          numbered,
          padded,
      ...
      exports.AmsMethods.FlalignArray = function (
        parser,
        begin,
        numbered,
        padded,
      ...
      exports.AmsMethods.HandleDeclareOp = function (parser, name) {
        ...
        parser.configuration.handlers
          .retrieve(exports.NEW_OPS)
          .add(
            cs,
            new Symbol_js_1.Macro(cs, exports.AmsMethods.Macro, [
      ...
      exports.AmsMethods.HandleOperatorName = function (parser, name) {
        ...
        var mml = new TexParser_js_1.default(
          op,
          __assign(__assign({}, parser.stack.env), {
        ...
        if (preScripts) {
          if (preRest) {
            preScripts.replaceChild(
              parser.create('node', 'mphantom', [
                parser.create(
                  'node',
                  'mpadded',
                  [ParseUtil_js_1.default.copyNode(base, parser)],
                  { width: 0 }
                )
              ]),
            ...
            NodeUtil_js_1.default.appendChildren(mml, [
              ...
              NodeUtil_js_1.default.getChildAt(preScripts, 1) ||
                parser.create('node', 'none'),
              NodeUtil_js_1.default.getChildAt(preScripts, 2) ||
                parser.create('node', 'none')
            ]);
          }
        }
        if (postScripts && mml === base) {
          postScripts.replaceChild(
            base,
            NodeUtil_js_1.default.getChildAt(postScripts, 0)
          );
          mml = postScripts;
        }
      ...
      exports.AmsMethods.xArrow = function (parser, name, chr, l, r) {
        ...
        var arrow = parser.create(
          'token',
          'mo',
          { stretchy: true, texClass: MmlNode_js_1.TEXCLASS.REL },
      ...
      exports.AmsMethods.CFrac = function (parser, name) {
        var lr = ParseUtil_js_1.default.trimSpaces(
        ...
        var numNode = new TexParser_js_1.default(
          '\\strut\\textstyle{' + num + '}',
          parser.stack.env,
          parser.configuration
        ).mml();
        var denNode = new TexParser_js_1.default(
          '\\strut\\textstyle{' + den + '}',
          parser.stack.env,
          parser.configuration
        ).mml();
      ...
      exports.AmsMethods.Genfrac = function (
        parser,
        name,
        left,
        right,
        ...
        if (left || right) {
          ...
          frac = ParseUtil_js_1.default.fixedFence(
            parser.configuration,
            left,
            frac,
            right
    ...
    /***/ 14831: /***/ function (
      ...
      var sm = __importStar(__webpack_require__(80209));
      var ParseMethods_js_1 = __importDefault(__webpack_require__(22960));
      var AmsCdMethods_js_1 = __importDefault(__webpack_require__(55828));
      new sm.EnvironmentMap(
        'amscd_environment',
        ParseMethods_js_1.default.environment,
        { CD: 'CD' },
    ...
    /***/ 55828: /***/ function (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      var TexParser_js_1 = __importDefault(__webpack_require__(75845));
      var BaseConfiguration_js_1 = __webpack_require__(11252);
      var MmlNode_js_1 = __webpack_require__(80747);
      var NodeUtil_js_1 = __importDefault(__webpack_require__(72691));
      var AmsCdMethods = {};
        ...
        if (c === '.') {
          ...
          if (c === '>' || c === '<') {
            ...
            if (a || b) {
              ...
              if (a) {
                var nodeA = new TexParser_js_1.default(
                  a,
                  parser.stack.env,
                  parser.configuration
                ).mml();
              ...
              if (b) {
                var nodeB = new TexParser_js_1.default(
                  b,
                  parser.stack.env,
                  parser.configuration
                ).mml();
                NodeUtil_js_1.default.setChild(
                  mml,
                  mml.under,
    ...
    /***/ 12512: /***/ function (
      ...
      exports.BboxConfiguration = Configuration_js_1.Configuration.create(
        'bbox',
        { handler: { macro: ['bbox'] } }
      );
    ...
    /***/ 79224: /***/ function (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.BoldsymbolConfiguration =
        exports.rewriteBoldTokens =
        exports.createBoldToken =
      ...
      var TexConstants_js_1 = __webpack_require__(80469);
      var SymbolMap_js_1 = __webpack_require__(80209);
      var NodeFactory_js_1 = __webpack_require__(55361);
      var BOLDVARIANT = {};
      BOLDVARIANT[TexConstants_js_1.TexConstant.Variant.NORMAL] =
        TexConstants_js_1.TexConstant.Variant.BOLD;
      BOLDVARIANT[TexConstants_js_1.TexConstant.Variant.ITALIC] =
        TexConstants_js_1.TexConstant.Variant.BOLDITALIC;
      BOLDVARIANT[TexConstants_js_1.TexConstant.Variant.FRAKTUR] =
        TexConstants_js_1.TexConstant.Variant.BOLDFRAKTUR;
      BOLDVARIANT[TexConstants_js_1.TexConstant.Variant.SCRIPT] =
        TexConstants_js_1.TexConstant.Variant.BOLDSCRIPT;
      BOLDVARIANT[TexConstants_js_1.TexConstant.Variant.SANSSERIF] =
      ...
      function createBoldToken(factory, kind, def, text) {
        var token = NodeFactory_js_1.NodeFactory.createToken(
          factory,
          kind,
          def,
          text
      ...
      function rewriteBoldTokens(arg) {
        ...
        try {
          for (
            var _b = __values(arg.data.getList('fixBold')), _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
            var node = _c.value;
            if (NodeUtil_js_1.default.getProperty(node, 'fixBold')) {
              var variant = NodeUtil_js_1.default.getAttribute(
                node,
                'mathvariant'
              );
              if (variant == null) {
    ...
    /***/ 82792: /***/ (
      ...
      var Configuration_js_1 = __webpack_require__(56441);
      var BraketItems_js_1 = __webpack_require__(85046);
      __webpack_require__(75755);
      exports.BraketConfiguration = Configuration_js_1.Configuration.create(
        'braket',
        {
          handler: {
          ...
          items:
            ((_a = {}),
            (_a[BraketItems_js_1.BraketItem.prototype.kind] =
              BraketItems_js_1.BraketItem),
            _a)
        }
      );
    ...
    /***/ 85046: /***/ function (
      ...
      var StackItem_js_1 = __webpack_require__(37720);
      var MmlNode_js_1 = __webpack_require__(80747);
      var ParseUtil_js_1 = __importDefault(__webpack_require__(6980));
      var BraketItem = (function (_super) {
        ...
        BraketItem.prototype.toMml = function () {
          ...
          if (this.getProperty('stretchy')) {
            return ParseUtil_js_1.default.fenced(
              this.factory.configuration,
              open,
              inner,
              close
    ...
    /***/ 75755: /***/ function (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      var SymbolMap_js_1 = __webpack_require__(80209);
      var BraketMethods_js_1 = __importDefault(__webpack_require__(22792));
      new SymbolMap_js_1.CommandMap(
        'Braket-macros',
        {
    ...
    /***/ 22792: /***/ function (
      ...
      BraketMethods.Braket = function (
        ...
        parser.Push(
          parser.itemFactory.create('braket').setProperties({
            barmax: barmax,
            barcount: 0,
            open: open,
            close: close,
      ...
      BraketMethods.Bar = function (parser, name) {
        ...
        if (
          ...
          var mml = parser.create(
            'token',
            'mo',
            { texClass: MmlNode_js_1.TEXCLASS.ORD, stretchy: false },
            c
          );
          parser.Push(mml);
          return;
        ...
        if (!stretchy) {
          var node_1 = parser.create(
            'token',
            'mo',
            { stretchy: false, braketbar: true },
            c
          );
          parser.Push(node_1);
          return;
    ...
    /***/ 77774: /***/ (
      ...
      var Configuration_js_1 = __webpack_require__(56441);
      var BussproofsItems_js_1 = __webpack_require__(13224);
      var BussproofsUtil_js_1 = __webpack_require__(86366);
      __webpack_require__(38529);
      exports.BussproofsConfiguration = Configuration_js_1.Configuration.create(
        'bussproofs',
        {
          handler: {
          ...
          items:
            ((_a = {}),
            (_a[BussproofsItems_js_1.ProofTreeItem.prototype.kind] =
              BussproofsItems_js_1.ProofTreeItem),
            _a),
    ...
    /***/ 13224: /***/ function (
      ...
      var TexError_js_1 = __importDefault(__webpack_require__(98770));
      var StackItem_js_1 = __webpack_require__(37720);
      var Stack_js_1 = __importDefault(__webpack_require__(32859));
      var BussproofsUtil = __importStar(__webpack_require__(86366));
    ...
    /***/ 38529: /***/ function (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      var BussproofsMethods_js_1 = __importDefault(__webpack_require__(86158));
      var ParseMethods_js_1 = __importDefault(__webpack_require__(22960));
      var SymbolMap_js_1 = __webpack_require__(80209);
      new SymbolMap_js_1.CommandMap(
        'Bussproofs-macros',
      ...
      new SymbolMap_js_1.EnvironmentMap(
    ...
    /***/ 86158: /***/ function (
      ...
      var paddedContent = function (parser, content) {
        var nodes = ParseUtil_js_1.default.internalMath(
          parser,
          ParseUtil_js_1.default.trimSpaces(content),
          0
        );
        ...
        return parser.create(
          ...
          'mrow',
          __spreadArray(
            __spreadArray([lpad], __read(nodes), false),
            [rpad],
            false
          )
        );
      ...
      BussproofsMethods.Inference = function (parser, name, n) {
        ...
        var rule = createRule(
          ...
          table,
          [conclusion],
          top.getProperty('left'),
          top.getProperty('right'),
          style,
          rootAtTop
        );
      ...
      BussproofsMethods.Label = function (parser, name, side) {
        ...
        var content = ParseUtil_js_1.default.internalMath(
          parser,
      ...
      function parseFCenterLine(parser, name) {
        ...
        var _a = __read(axiom.split('\\fCenter'), 2),
          prem = _a[0],
          conc = _a[1];
        var premise = new TexParser_js_1.default(
          prem,
          parser.stack.env,
          parser.configuration
        ).mml();
        var conclusion = new TexParser_js_1.default(
          conc,
          parser.stack.env,
          parser.configuration
        ).mml();
        var fcenter = new TexParser_js_1.default(
          '\\fCenter',
          parser.stack.env,
          parser.configuration
        ).mml();
    ...
    /***/ 86366: /***/ function (
      ...
      var _a;
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.clearDocument =
        exports.saveDocument =
        exports.makeBsprAttributes =
        exports.removeProperty =
        exports.getProperty =
        exports.setProperty =
        exports.balanceRules =
          void 0;
      var NodeUtil_js_1 = __importDefault(__webpack_require__(72691));
      var ParseUtil_js_1 = __importDefault(__webpack_require__(6980));
      var doc = null;
      ...
      var getConclusion = function (rule, direction) {
        return rule.childNodes[direction === 'up' ? 0 : 1].childNodes[0]
      ...
      var adjustValue = function (inf, right) {
        ...
        var conc = getConclusion(
          rule,
          (0, exports.getProperty)(rule, 'inferenceRule')
        );
      ...
      var addSpace = function (config, inf, space, right) {
        ...
        if (
          (0, exports.getProperty)(inf, 'inferenceRule') ||
        ...
        if (NodeUtil_js_1.default.isType(mspace, 'mspace')) {
          NodeUtil_js_1.default.setAttribute(
            mspace,
            'width',
            ParseUtil_js_1.default.Em(
              ParseUtil_js_1.default.dimen2em(
                NodeUtil_js_1.default.getAttribute(mspace, 'width')
              ) + space
            )
          );
          return;
      ...
      var adjustSequents = function (config) {
        ...
        for (
          var i = sequents.length - 1, seq = void 0;
          (seq = sequents[i]);
          i--
        ) {
          ...
          while ((0, exports.getProperty)(inf, 'inference') === 1) {
            inf = getRule(inf);
            var premise = firstPremise(
              getPremises(inf, (0, exports.getProperty)(inf, 'inferenceRule'))
            );
            var sequent = (0, exports.getProperty)(premise, 'inferenceRule')
              ? getConclusion(
                  premise,
                  (0, exports.getProperty)(premise, 'inferenceRule')
                )
              : premise;
      ...
      var addSequentSpace = function (
        ...
        (0, exports.setProperty)(
          sequent.parent,
          'sequentAdjust_' + direction,
          width
        );
      };
      ...
      var balanceRules = function (arg) {
        ...
        try {
          for (
            var inferences_1 = __values(inferences),
              inferences_1_1 = inferences_1.next();
            !inferences_1_1.done;
            inferences_1_1 = inferences_1.next()
          ) {
            ...
            if (isProof || !(column = getColumn(inf))) {
              addSpace(
                config,
                (0, exports.getProperty)(inf, 'proof') ? inf : inf.parent,
                adjust - w,
                true
              );
              continue;
            ...
            adjust = (0, exports.getProperty)(parentRule, 'maxAdjust')
              ? Math.max(
                  (0, exports.getProperty)(parentRule, 'maxAdjust'),
                  adjust
                )
              : adjust;
          ...
          try {
            if (
              inferences_1_1 &&
              !inferences_1_1.done &&
              (_a = inferences_1.return)
            )
              _a.call(inferences_1);
          } finally {
            if (e_1) throw e_1.error;
          }
        }
      ...
      var blacklistedProperties =
        ((_a = {}), (_a[property_prefix + 'maxAdjust'] = true), _a);
      var setProperty = function (node, property, value) {
        NodeUtil_js_1.default.setProperty(
          node,
      ...
      var getProperty = function (node, property) {
        return NodeUtil_js_1.default.getProperty(
          node,
          property_prefix + property
        );
      };
      ...
      var makeBsprAttributes = function (arg) {
        arg.data.root.walkTree(function (mml, _data) {
          ...
          mml.getPropertyNames().forEach(function (x) {
            if (
              !blacklistedProperties[x] &&
              x.match(RegExp('^' + property_prefix))
            ) {
    ...
    /***/ 2362: /***/ function (
      ...
      var SymbolMap_js_1 = __webpack_require__(80209);
      var ParseUtil_js_1 = __importDefault(__webpack_require__(6980));
      var EncloseConfiguration_js_1 = __webpack_require__(48128);
      exports.CancelMethods = {};
      exports.CancelMethods.Cancel = function (parser, name, notation) {
        var attr = parser.GetBrackets(name, '');
        var math = parser.ParseArg(name);
        var def = ParseUtil_js_1.default.keyvalOptions(
          attr,
          EncloseConfiguration_js_1.ENCLOSE_OPTIONS
        );
      ...
      exports.CancelConfiguration = Configuration_js_1.Configuration.create(
        'cancel',
    ...
    /***/ 12796: /***/ function (
      ...
      var _a;
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.CasesConfiguration =
        exports.CasesMethods =
        exports.CasesTags =
        exports.CasesBeginItem =
          void 0;
      var Configuration_js_1 = __webpack_require__(56441);
      var SymbolMap_js_1 = __webpack_require__(80209);
      var ParseUtil_js_1 = __importDefault(__webpack_require__(6980));
      ...
      var TexError_js_1 = __importDefault(__webpack_require__(98770));
      var BaseItems_js_1 = __webpack_require__(94650);
      var AmsConfiguration_js_1 = __webpack_require__(48600);
      var EmpheqUtil_js_1 = __webpack_require__(99118);
      ...
      var CasesTags = (function (_super) {
        ...
        CasesTags.prototype.formatNumber = function (n, m) {
          ...
          return (
            n.toString() + (m === null ? '' : String.fromCharCode(0x60 + m))
          );
        };
        return CasesTags;
      ...
      exports.CasesMethods = {
        NumCases: function (parser, begin) {
          if (parser.stack.env.closing === begin.getName()) {
            ...
            EmpheqUtil_js_1.EmpheqUtil.left(
              table,
              original,
              left + '\\empheqlbrace\\,',
              parser,
      ...
      new SymbolMap_js_1.EnvironmentMap(
        'cases-env',
        EmpheqUtil_js_1.EmpheqUtil.environment,
        {
      ...
      exports.CasesConfiguration = Configuration_js_1.Configuration.create(
        'cases',
        {
          handler: {
    ...
    /***/ 50228: /***/ function (
      ...
      new SymbolMap_js_1.CommandMap(
        ...
        },
        {
          CenterOver: function (parser, name) {
            ...
            var base = new TexParser_js_1.default(
              arg,
              parser.stack.env,
              parser.configuration
            ).mml();
      ...
      function filterCenterOver(_a) {
        ...
        try {
          for (
            var _c = __values(data.getList('centerOver')), _d = _c.next();
            !_d.done;
            _d = _c.next()
          ) {
            var base = _d.value;
            var texClass = NodeUtil_js_1.default.getTexClass(
              base.childNodes[0].childNodes[0]
            );
            if (texClass !== null) {
              NodeUtil_js_1.default.setProperties(
      ...
      exports.CenternotConfiguration = Configuration_js_1.Configuration.create(
        'centernot',
        {
    ...
    /***/ 79712: /***/ (
      ...
      var SymbolMap_js_1 = __webpack_require__(80209);
      var Configuration_js_1 = __webpack_require__(56441);
      var ColorMethods_js_1 = __webpack_require__(8080);
      var ColorUtil_js_1 = __webpack_require__(21860);
      new SymbolMap_js_1.CommandMap(
        'color',
        {
          color: 'Color',
      ...
      exports.ColorConfiguration = Configuration_js_1.Configuration.create(
        'color',
        {
          handler: {
            macro: ['color']
    ...
    /***/ 54187: /***/ (__unused_webpack_module, exports) => {
      Object.defineProperty(exports, '__esModule', { value: true });
    ...
    /***/ 8080: /***/ function (
      ...
      exports.ColorMethods.ColorBox = function (parser, name) {
        var cname = parser.GetArgument(name);
        var math = ParseUtil_js_1.default.internalMath(
          parser,
          parser.GetArgument(name)
        );
        var colorModel = parser.configuration.packageData.get('color').model;
        ...
        NodeUtil_js_1.default.setProperties(
          node,
          padding(parser.options.color.padding)
        );
        parser.Push(node);
      };
      exports.ColorMethods.FColorBox = function (parser, name) {
        ...
        var node = parser.create('node', 'mpadded', math, {
          mathbackground: colorModel.getColor('named', cname),
          style: 'border: '
            .concat(options.borderWidth, ' solid ')
            .concat(colorModel.getColor('named', fname))
        });
    ...
    /***/ 21860: /***/ function (
      ...
      var TexError_js_1 = __importDefault(__webpack_require__(98770));
      var ColorConstants_js_1 = __webpack_require__(54187);
      ...
      ColorModelProcessors.set('rgb', function (rgb) {
        ...
        try {
          for (
            var rgbParts_1 = __values(rgbParts),
              rgbParts_1_1 = rgbParts_1.next();
            !rgbParts_1_1.done;
            rgbParts_1_1 = rgbParts_1.next()
          ) {
          ...
          try {
            if (rgbParts_1_1 && !rgbParts_1_1.done && (_a = rgbParts_1.return))
              _a.call(rgbParts_1);
          } finally {
            if (e_1) throw e_1.error;
          }
      ...
      ColorModelProcessors.set('RGB', function (rgb) {
        ...
        try {
          for (
            var rgbParts_2 = __values(rgbParts),
              rgbParts_2_1 = rgbParts_2.next();
            !rgbParts_2_1.done;
            rgbParts_2_1 = rgbParts_2.next()
          ) {
          ...
          try {
            if (rgbParts_2_1 && !rgbParts_2_1.done && (_a = rgbParts_2.return))
              _a.call(rgbParts_2);
          } finally {
    ...
    /***/ 90272: /***/ function (
      ...
      var config = function (config, jax) {
        if (!jax.parseOptions.packageData.has('color')) {
          Configuration_js_1.ConfigurationHandler.get('color').config(
            config,
            jax
          );
        }
      };
      exports.ColortblConfiguration = Configuration_js_1.Configuration.create(
        'colortbl',
        {
    ...
    /***/ 45320: /***/ function (
      ...
      var ParseMethods_js_1 = __importDefault(__webpack_require__(22960));
      var Symbol_js_1 = __webpack_require__(27151);
      var NewcommandMethods_js_1 = __importDefault(__webpack_require__(91200));
      var NewcommandItems_js_1 = __webpack_require__(73694);
      ...
      function configMacros(jax) {
        ...
        try {
          for (
            var _b = __values(Object.keys(macros)), _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
            var cs = _c.value;
            var def =
              typeof macros[cs] === 'string' ? [macros[cs]] : macros[cs];
            var macro = Array.isArray(def[2])
              ? new Symbol_js_1.Macro(
                  cs,
                  NewcommandMethods_js_1.default.MacroWithTemplate,
                  def.slice(0, 2).concat(def[2])
                )
              : new Symbol_js_1.Macro(
                  cs,
                  NewcommandMethods_js_1.default.Macro,
                  def
                );
      ...
      function configEnvironments(jax) {
        ...
        try {
          for (
            var _b = __values(Object.keys(environments)), _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
            var env = _c.value;
            handler.add(
              ...
              new Symbol_js_1.Macro(
                env,
                NewcommandMethods_js_1.default.BeginEnv,
      ...
      exports.ConfigMacrosConfiguration =
        Configuration_js_1.Configuration.create('configmacros', {
          init: configmacrosInit,
          config: configmacrosConfig,
          items:
            ((_a = {}),
            (_a[NewcommandItems_js_1.BeginEnvItem.prototype.kind] =
              NewcommandItems_js_1.BeginEnvItem),
            _a),
          options: {
    ...
    /***/ 13726: /***/ function (
      ...
      var _a;
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.EmpheqConfiguration =
        exports.EmpheqMethods =
        exports.EmpheqBeginItem =
          void 0;
      var Configuration_js_1 = __webpack_require__(56441);
      var SymbolMap_js_1 = __webpack_require__(80209);
      var ParseUtil_js_1 = __importDefault(__webpack_require__(6980));
      ...
      exports.EmpheqMethods = {
        Empheq: function (parser, begin) {
          if (parser.stack.env.closing === begin.getName()) {
            ...
            var opts =
              parser.GetBrackets('\\begin{' + begin.getName() + '}') || '';
            var _a = __read(
                (
            ...
            if (opts) {
              begin.setProperties(
                EmpheqUtil_js_1.EmpheqUtil.splitOptions(opts, {
                  left: 1,
                  right: 1
                })
              );
      ...
      exports.EmpheqConfiguration = Configuration_js_1.Configuration.create(
        'empheq',
        {
          handler: {
            macro: ['empheq-macros'],
      ...
      exports.EmpheqUtil = {
        environment: function (parser, env, func, args) {
          ...
          parser.Push(
            func.apply(
              void 0,
              __spreadArray([parser, item], __read(args.slice(1)), false)
            )
          );
        },
        ...
        columnCount: function (table) {
          ...
          try {
            for (
              var _b = __values(table.childNodes), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var row = _c.value;
              var n =
                row.childNodes.length - (row.isKind('mlabeledtr') ? 1 : 0);
              if (n > m) m = n;
            }
          } catch (e_1_1) {
            e_1 = { error: e_1_1 };
        ...
        cellBlock: function (tex, table, parser, env) {
          ...
          var result = new TexParser_js_1.default(
            tex,
            parser.stack.env,
            parser.configuration
          );
          ...
          try {
            for (
              var _b = __values(mml.isInferred ? mml.childNodes : [mml]),
                _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
          ...
          mtd.appendChild(
            parser.create(
              ...
              [
                this.cellBlock(
                  tex,
                  ParseUtil_js_1.default.copyNode(table, parser),
                  parser,
                  env
                ),
        ...
        left: function (table, original, left, parser, env) {
          ...
          try {
            for (
              var _b = __values(table.childNodes.slice(0).reverse()),
                _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
        ...
        right: function (table, original, right, parser, env) {
          ...
          table.attributes.set(
            'columnalign',
            (table.attributes.get('columnalign') || '')
              .split(/ /)
              .slice(0, m)
              .join(' ') + ' left'
          );
          table.attributes.set(
            'columnspacing',
            (table.attributes.get('columnspacing') || '')
              .split(/ /)
              .slice(0, m - 1)
              .join(' ') + ' 0em'
          );
    ...
    /***/ 48128: /***/ function (
      ...
      exports.EncloseConfiguration = Configuration_js_1.Configuration.create(
        'enclose',
    ...
    /***/ 15472: /***/ function (
      ...
      var SymbolMap_js_1 = __webpack_require__(80209);
      var AmsMethods_js_1 = __webpack_require__(98840);
      var NewcommandUtil_js_1 = __importDefault(__webpack_require__(67668));
      var NewcommandConfiguration_js_1 = __webpack_require__(36912);
      var TexError_js_1 = __importDefault(__webpack_require__(98770));
      ...
      exports.ExtpfeilMethods.NewExtArrow = function (parser, name) {
        ...
        NewcommandUtil_js_1.default.addMacro(
          parser,
          cs,
          exports.ExtpfeilMethods.xArrow,
      ...
      exports.ExtpfeilConfiguration = Configuration_js_1.Configuration.create(
        'extpfeil',
        {
    ...
    /***/ 95120: /***/ (
      ...
      exports.GensymbConfiguration = Configuration_js_1.Configuration.create(
        'gensymb',
        {
    ...
    /***/ 98452: /***/ function (
      ...
      var Configuration_js_1 = __webpack_require__(56441);
      var SymbolMap_js_1 = __webpack_require__(80209);
      var HtmlMethods_js_1 = __importDefault(__webpack_require__(2140));
      new SymbolMap_js_1.CommandMap(
        'html_macros',
        {
          href: 'Href',
      ...
      exports.HtmlConfiguration = Configuration_js_1.Configuration.create(
        'html',
    ...
    /***/ 7932: /***/ function (
      ...
      var _a;
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.MathtoolsConfiguration =
        exports.fixPrescripts =
        exports.PAIREDDELIMS =
          void 0;
      var Configuration_js_1 = __webpack_require__(56441);
      var SymbolMap_js_1 = __webpack_require__(80209);
      var NodeUtil_js_1 = __importDefault(__webpack_require__(72691));
      ...
      var MathtoolsUtil_js_1 = __webpack_require__(90352);
      var MathtoolsTags_js_1 = __webpack_require__(81197);
      var MathtoolsItems_js_1 = __webpack_require__(16226);
      ...
      function initMathtools(config) {
        ...
        config.append(
          Configuration_js_1.Configuration.local({
            handler: { macro: [exports.PAIREDDELIMS] },
            priority: -5
          })
        );
      }
      function configMathtools(config, jax) {
        ...
        try {
          for (
            var _b = __values(Object.keys(pairedDelims)), _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
            var cs = _c.value;
            MathtoolsUtil_js_1.MathtoolsUtil.addPairedDelims(
              parser,
              cs,
              pairedDelims[cs]
            );
      ...
      function fixPrescripts(_a) {
        ...
        try {
          for (
            var _e = __values(data.getList('mmultiscripts')), _f = _e.next();
            !_f.done;
            _f = _e.next()
          ) {
            var node = _f.value;
            ...
            try {
              for (
                var _g = ((e_3 = void 0), __values([1, 2])), _h = _g.next();
                !_h.done;
                _h = _g.next()
              ) {
                var i = _h.value;
                if (!childNodes[i]) {
                  NodeUtil_js_1.default.setChild(
                    node,
                    i,
                    data.nodeFactory.create('node', 'none')
                  );
                  n++;
                }
              }
            ...
            try {
              for (
                var _j = ((e_4 = void 0), __values([4, 5])), _k = _j.next();
                !_k.done;
                _k = _j.next()
              ) {
                var i = _k.value;
                if (
                  NodeUtil_js_1.default.isType(childNodes[i], 'mrow') &&
                  NodeUtil_js_1.default.getChildren(childNodes[i]).length === 0
                ) {
                  NodeUtil_js_1.default.setChild(
                    node,
                    i,
      ...
      exports.MathtoolsConfiguration = Configuration_js_1.Configuration.create(
        'mathtools',
        {
          handler: {
          ...
          items:
            ((_a = {}),
            (_a[MathtoolsItems_js_1.MultlinedItem.prototype.kind] =
              MathtoolsItems_js_1.MultlinedItem),
            _a),
          init: initMathtools,
      ...
      var MultlinedItem = (function (_super) {
        ...
        MultlinedItem.prototype.EndTable = function () {
          ...
          if (this.table.length > 1) {
            ...
            if (
              NodeUtil_js_1.default.getAttribute(first, 'columnalign') !==
              TexConstants_js_1.TexConstant.Align.RIGHT
            ) {
              first.appendChild(
            ...
            var last = NodeUtil_js_1.default.getChildren(
              this.table[this.table.length - 1]
            )[0];
            if (
              NodeUtil_js_1.default.getAttribute(last, 'columnalign') !==
              TexConstants_js_1.TexConstant.Align.LEFT
            ) {
    ...
    /***/ 5615: /***/ function (
      ...
      var SymbolMap_js_1 = __webpack_require__(80209);
      var TexConstants_js_1 = __webpack_require__(80469);
      var MathtoolsMethods_js_1 = __webpack_require__(75316);
      new SymbolMap_js_1.CommandMap(
        'mathtools-macros',
        {
          shoveleft: ['HandleShove', TexConstants_js_1.TexConstant.Align.LEFT],
      ...
      new SymbolMap_js_1.DelimiterMap(
    ...
    /***/ 75316: /***/ function (
      ...
      exports.MathtoolsMethods = {
        MtMatrix: function (parser, begin, open, close) {
          var align = parser.GetBrackets(
            '\\begin{'.concat(begin.getName(), '}'),
            'c'
          );
          return exports.MathtoolsMethods.Array(
            parser,
            begin,
            open,
            close,
        ...
        SpreadLines: function (parser, begin) {
          ...
          if (parser.stack.env.closing === begin.getName()) {
            ...
            if (mml.isInferred) {
              try {
                for (
                  var _b = __values(NodeUtil_js_1.default.getChildren(mml)),
                    _c = _b.next();
                  !_c.done;
                  _c = _b.next()
                ) {
        ...
        MathMakeBox: function (parser, name) {
          ...
          var align = (0, Options_js_1.lookup)(
            pos,
            { c: 'center', r: 'right' },
            ''
          );
        ...
        UnderOverBracket: function (parser, name) {
          var thickness = (0, lengths_js_1.length2em)(
            parser.GetBrackets(name, '.1em'),
            0.1
          );
          ...
          var copy = new TexParser_js_1.default(
            arg,
            parser.stack.env,
            parser.configuration
          ).mml();
          var script = parser.create(
            'node',
            'mpadded',
            [parser.create('node', 'mphantom', [copy])],
            {
              style: 'border: '
                .concat(t, ' solid; border-')
                .concat(border, ': none'),
              height: height,
              depth: 0
            }
          );
          var node = ParseUtil_js_1.default.underOver(
            parser,
            base,
            script,
            pos,
          ...
          var munderover = NodeUtil_js_1.default.getChildAt(
            NodeUtil_js_1.default.getChildAt(node, 0),
            0
          );
        ...
        Aboxed: function (parser, name) {
          var top = MathtoolsUtil_js_1.MathtoolsUtil.checkAlignment(
            parser,
            name
          );
          ...
          var tex = ParseUtil_js_1.default.substituteArgs(
            parser,
            [left, right],
        ...
        ShortVDotsWithin: function (parser, _name) {
          var top = parser.stack.Top();
          var star = parser.GetStar();
          exports.MathtoolsMethods.FlushSpaceAbove(
            parser,
            '\\MTFlushSpaceAbove'
          );
          !star && top.EndEntry();
          ...
          star && top.EndEntry();
          exports.MathtoolsMethods.FlushSpaceBelow(
            parser,
            '\\MTFlushSpaceBelow'
          );
        },
        ...
        CenterColon: function (parser, _name, center, force, thin) {
          ...
          if (center && (options['centercolon'] || force)) {
            ...
            mml = parser.create(
              ...
              [mml],
              __assign(
                { voffset: dy, height: '+'.concat(dy), depth: '-'.concat(dy) },
                thin
                  ? {
        ...
        Relation: function (parser, _name, tex, unicode) {
          ...
          if (options['use-unicode'] && unicode) {
            ...
            tex =
              ...
              '}';
            parser.string = ParseUtil_js_1.default.addArgs(
              parser,
              tex,
              parser.string.substr(parser.i)
            );
        ...
        Prescript: function (parser, name) {
          var sup = MathtoolsUtil_js_1.MathtoolsUtil.getScript(
            parser,
            name,
            'sup'
          );
          var sub = MathtoolsUtil_js_1.MathtoolsUtil.getScript(
            parser,
            name,
            'sub'
          );
          var base = MathtoolsUtil_js_1.MathtoolsUtil.getScript(
            parser,
            name,
            'arg'
          );
          if (
            NodeUtil_js_1.default.isType(sup, 'none') &&
            NodeUtil_js_1.default.isType(sub, 'none')
          ) {
            parser.Push(base);
            return;
          }
        ...
        SetOptions: function (parser, name) {
          ...
          try {
            for (
              var _b = __values(Object.keys(keys)), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var id = _c.value;
    ...
    /***/ 81197: /***/ function (
      ...
      function MathtoolsTagFormat(config, jax) {
        ...
        var TagClass = Tags_js_1.TagsFactory.create(
          jax.parseOptions.options.tags
        ).constructor;
        var TagFormat = (function (_super) {
          ...
          function TagFormat() {
            ...
            try {
              for (
                var _b = __values(Object.keys(forms)), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
                var form = _c.value;
    ...
    /***/ 90352: /***/ function (
      ...
      var Options_js_1 = __webpack_require__(34981);
      var MathtoolsMethods_js_1 = __webpack_require__(75316);
      var MathtoolsConfiguration_js_1 = __webpack_require__(7932);
      exports.MathtoolsUtil = {
        setDisplayLevel: function (mml, style) {
          if (!style) return;
          var _a = __read(
              (0, Options_js_1.lookup)(
                style,
                {
                  '\\displaystyle': [true, 0],
                  '\\textstyle': [false, 0],
        ...
        addPairedDelims: function (config, cs, args) {
          var delims = config.handlers.retrieve(
            MathtoolsConfiguration_js_1.PAIREDDELIMS
          );
          delims.add(
            cs,
            new Symbol_js_1.Macro(
              cs,
              MathtoolsMethods_js_1.MathtoolsMethods.PairedDelimiters,
              args
            )
          );
        },
        spreadLines: function (mtable, spread) {
          ...
          if (rowspacing) {
            ...
            rowspacing = rowspacing
              .split(/ /)
              .map(function (s) {
                return ParseUtil_js_1.default.Em(
                  Math.max(0, ParseUtil_js_1.default.dimen2em(s) + add_1)
                );
              })
              .join(' ');
          } else {
        ...
        getScript: function (parser, name, pos) {
          ...
          var format =
            parser.options.mathtools['prescript-'.concat(pos, '-format')];
          format && (arg = ''.concat(format, '{').concat(arg, '}'));
          return new TexParser_js_1.default(
            arg,
            parser.stack.env,
            parser.configuration
          ).mml();
    ...
    /***/ 75802: /***/ function (
      ...
      var BaseMethods_js_1 = __importDefault(__webpack_require__(38364));
      var AmsMethods_js_1 = __webpack_require__(98840);
      var mhchemParser_js_1 = __webpack_require__(62691);
      var MhchemMethods = {};
      ...
      exports.MhchemConfiguration = Configuration_js_1.Configuration.create(
        'mhchem',
    ...
    /***/ 36912: /***/ function (
      ...
      exports.NewcommandConfiguration = Configuration_js_1.Configuration.create(
        'newcommand',
        {
          handler: {
    ...
    /***/ 91200: /***/ function (
      ...
      NewcommandMethods.Let = function (parser, name) {
        ...
        if (c === '\\') {
          ...
          if (macro_1) {
            NewcommandUtil_js_1.default.addDelimiter(
              parser,
              '\\' + cs,
              macro_1.char,
              macro_1.attributes
          ...
          var newArgs = NewcommandUtil_js_1.default.disassembleSymbol(
            cs,
            macro_1
          );
      ...
      NewcommandMethods.MacroWithTemplate = function (parser, name, text, n) {
        ...
        if (argCount) {
          ...
          if (
            params[0] &&
            !NewcommandUtil_js_1.default.MatchParam(parser, params[0])
          ) {
            throw new TexError_js_1.default(
              'MismatchUseDef',
          ...
          for (var i = 0; i < argCount; i++) {
            args.push(
              NewcommandUtil_js_1.default.GetParameter(
                parser,
                name,
                params[i + 1]
              )
      ...
      NewcommandMethods.BeginEnv = function (
        ...
        if (
          begin.getProperty('end') &&
          parser.stack.env['closing'] === begin.getName()
        ) {
          delete parser.stack.env['closing'];
        ...
        if (n) {
          var args = [];
          if (def != null) {
            var optional = parser.GetBrackets(
              '\\begin{' + begin.getName() + '}'
            );
    ...
    /***/ 67668: /***/ function (
      ...
      (function (NewcommandUtil) {
        ...
        function addMacro(parser, cs, func, attr, symbol) {
          ...
          handler.add(
            cs,
            new Symbol_js_1.Macro(symbol ? symbol : cs, func, attr)
          );
        }
    ...
    /***/ 21018: /***/ (
      ...
      exports.NoErrorsConfiguration = Configuration_js_1.Configuration.create(
        'noerrors',
    ...
    /***/ 68916: /***/ function (
      ...
      function noUndefined(parser, name) {
        ...
        try {
          for (
            var _b = __values(['color', 'background', 'size']), _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
            var id = _c.value;
      ...
      exports.NoUndefinedConfiguration =
        Configuration_js_1.Configuration.create('noundefined', {
    ...
    /***/ 23468: /***/ (
      ...
      var Configuration_js_1 = __webpack_require__(56441);
      var PhysicsItems_js_1 = __webpack_require__(34834);
      __webpack_require__(23423);
      exports.PhysicsConfiguration = Configuration_js_1.Configuration.create(
        'physics',
        {
          handler: {
            macro: [
          ...
          items:
            ((_a = {}),
            (_a[PhysicsItems_js_1.AutoOpen.prototype.kind] =
              PhysicsItems_js_1.AutoOpen),
            _a),
          options: {
            physics: {
              italicdiff: false,
    ...
    /***/ 34834: /***/ function (
      ...
      var AutoOpen = (function (_super) {
        ...
        AutoOpen.prototype.toMml = function () {
          ...
          var mml = ParseUtil_js_1.default.fenced(
            this.factory.configuration,
            this.getProperty('open'),
            _super.prototype.toMml.call(this),
            this.getProperty('close'),
            this.getProperty('big')
          );
          NodeUtil_js_1.default.removeProperties(
            mml,
            'open',
            'close',
            'texClass'
        ...
        AutoOpen.errors = Object.assign(
          Object.create(StackItem_js_1.BaseItem.errors),
          {
            stop: [
    ...
    /***/ 23423: /***/ function (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      var SymbolMap_js_1 = __webpack_require__(80209);
      var PhysicsMethods_js_1 = __importDefault(__webpack_require__(66052));
      var TexConstants_js_1 = __webpack_require__(80469);
      var ParseMethods_js_1 = __importDefault(__webpack_require__(22960));
      var MmlNode_js_1 = __webpack_require__(80747);
      new SymbolMap_js_1.CommandMap(
      ...
      new SymbolMap_js_1.CharacterMap(
        'Physics-vector-mo',
        ParseMethods_js_1.default.mathchar0mo,
        {
          dotproduct: [
    ...
    /***/ 66052: /***/ function (
      ...
      PhysicsMethods.VectorBold = function (parser, name) {
        ...
        var node = new TexParser_js_1.default(
          arg,
          parser.stack.env,
          parser.configuration
        ).mml();
      ...
      var vectorApplication = function (parser, kind, name, operator, fences) {
        var op = new TexParser_js_1.default(
          operator,
          parser.stack.env,
          parser.configuration
        ).mml();
      ...
      PhysicsMethods.Expression = function (parser, name, opt, id) {
        ...
        if (exp) {
          var sup = new TexParser_js_1.default(
            exp,
            parser.stack.env,
            parser.configuration
          ).mml();
      ...
      PhysicsMethods.Differential = function (parser, name, op) {
        ...
        if (braces) {
          ...
          parser.Push(
            parser.create('node', 'TeXAtom', [mml], {
              texClass: MmlNode_js_1.TEXCLASS.OP
            })
          );
          return;
        ...
        if (hasKet) {
          macro =
            starBra || starKet
              ...
              : '\\left\\langle{'
                  .concat(bra, '}\\middle\\vert{')
                  .concat(ket, '}\\right\\rangle');
        } else {
          macro =
            starBra || starKet
              ? '\\langle{'.concat(bra, '}\\vert')
              : '\\left\\langle{'
                  .concat(bra, '}\\right\\vert{')
                  .concat(ket, '}');
        }
        parser.Push(
          new TexParser_js_1.default(
      ...
      PhysicsMethods.KetBra = function (parser, name) {
        ...
        if (bra == null) {
          macro = star
            ? '\\vert{'
                .concat(ket, '}\\rangle\\!\\langle{')
                .concat(ket, '}\\vert')
            : '\\left\\vert{'
                .concat(ket, '}\\middle\\rangle\\!\\middle\\langle{')
                .concat(ket, '}\\right\\vert');
        } else {
          macro = star
            ? '\\vert{'
                .concat(ket, '}\\rangle\\!\\langle{')
      ...
      function outputBraket(_a, star1, star2) {
        ...
        return star1 && star2
          ? '\\left\\langle{'
              .concat(arg1, '}\\middle\\vert{')
              .concat(arg2, '}\\middle\\vert{')
              .concat(arg3, '}\\right\\rangle')
          : star1
            ? '\\langle{'
                .concat(arg1, '}\\vert{')
                .concat(arg2, '}\\vert{')
                .concat(arg3, '}\\rangle')
            : '\\left\\langle{'
                .concat(arg1, '}\\right\\vert{')
                .concat(arg2, '}\\left\\vert{')
                .concat(arg3, '}\\right\\rangle');
      }
      ...
      PhysicsMethods.DiagonalMatrix = function (parser, name, anti) {
        ...
        parser.string =
          makeDiagMatrix(elements, anti) + parser.string.slice(endI);
        parser.i = 0;
      };
    ...
    /***/ 91610: /***/ function (
      ...
      exports.SetOptionsUtil = {
        filterPackage: function (parser, extension) {
          if (
            extension !== 'tex' &&
            !Configuration_js_1.ConfigurationHandler.get(extension)
          ) {
            throw new TexError_js_1.default(
              'NotAPackage',
        ...
        filterOption: function (parser, extension, option) {
          ...
          var allow =
            ...
            !(0, Options_js_1.isObject)(options[option])
              ? options[option]
              : null;
          if (
            allow === false ||
            (allow === null && !config.allowOptionsDefault)
          ) {
            throw new TexError_js_1.default(
              'OptionNotSettable',
          ...
          if (
            !((_a =
              extension === 'tex'
                ? parser.options
                : parser.options[extension]) === null || _a === void 0
              ? void 0
              : _a.hasOwnProperty(option))
          ) {
            if (extension === 'tex') {
              throw new TexError_js_1.default(
                'InvalidTexOption',
      ...
      var setOptionsMap = new SymbolMap_js_1.CommandMap(
        'setoptions',
        {
        ...
        },
        {
          SetOptions: function (parser, name) {
            ...
            var options = ParseUtil_js_1.default.keyvalOptions(
              parser.GetArgument(name)
            );
            var config = parser.options.setoptions;
            ...
            try {
              for (
                ...
                if (config.filterOption(parser, extension, key)) {
                  (extension === 'tex'
                    ? parser.options
                    : parser.options[extension])[key] = config.filterValue(
                    parser,
                    extension,
                    key,
                    options[key]
      ...
      function setoptionsConfig(_config, jax) {
        ...
        if (require) {
          setOptionsMap.add(
            'Require',
            new Symbol_js_1.Macro('Require', require._func)
          );
          setOptionsMap.add(
            'require',
            new Symbol_js_1.Macro('require', BaseMethods_js_1.default.Macro, [
      ...
      exports.SetOptionsConfiguration = Configuration_js_1.Configuration.create(
        'setoptions',
        {
    ...
    /***/ 18560: /***/ function (
      ...
      exports.TagFormatConfiguration = Configuration_js_1.Configuration.create(
        'tagformat',
        {
    ...
    /***/ 46370: /***/ (
      ...
      var Configuration_js_1 = __webpack_require__(56441);
      __webpack_require__(47173);
      exports.TextcompConfiguration = Configuration_js_1.Configuration.create(
        'textcomp',
        {
    ...
    /***/ 47173: /***/ function (
      ...
      var SymbolMap_js_1 = __webpack_require__(80209);
      var TexConstants_js_1 = __webpack_require__(80469);
      var TextMacrosMethods_js_1 = __webpack_require__(56774);
      var ParseUtil_js_1 = __importDefault(__webpack_require__(6980));
      var TextParser_js_1 = __webpack_require__(53880);
      new SymbolMap_js_1.CommandMap(
        'textcomp-macros',
        {
        ...
        },
        {
          Insert: function (parser, name, c, font) {
            if (parser instanceof TextParser_js_1.TextParser) {
              if (!font) {
                TextMacrosMethods_js_1.TextMacrosMethods.Insert(
                  parser,
                  name,
                  c
                );
            ...
            parser.Push(
              ParseUtil_js_1.default.internalText(
                parser,
                c,
    ...
    /***/ 29302: /***/ function (
      ...
      var Configuration_js_1 = __webpack_require__(56441);
      var ParseOptions_js_1 = __importDefault(__webpack_require__(24404));
      var Tags_js_1 = __webpack_require__(17782);
      var BaseItems_js_1 = __webpack_require__(94650);
      var TextParser_js_1 = __webpack_require__(53880);
      var TextMacrosMethods_js_1 = __webpack_require__(56774);
      __webpack_require__(5705);
      exports.TextBaseConfiguration = Configuration_js_1.Configuration.create(
        'text-base',
        {
          parser: 'text',
          handler: {
          ...
          fallback: {
            ...
            macro: function (parser, name) {
              ...
              if (
                macro &&
                macro._func !== TextMacrosMethods_js_1.TextMacrosMethods.Macro
              ) {
                parser.Error(
                  'MathMacro',
          ...
          items:
            ((_a = {}),
            (_a[BaseItems_js_1.StartItem.prototype.kind] =
              BaseItems_js_1.StartItem),
            (_a[BaseItems_js_1.StopItem.prototype.kind] =
              BaseItems_js_1.StopItem),
            (_a[BaseItems_js_1.MmlItem.prototype.kind] =
              BaseItems_js_1.MmlItem),
            (_a[BaseItems_js_1.StyleItem.prototype.kind] =
              BaseItems_js_1.StyleItem),
            _a)
        }
      );
      function internalMath(parser, text, level, mathvariant) {
        ...
        return [
          new TextParser_js_1.TextParser(
            text,
      ...
      exports.TextMacrosConfiguration = Configuration_js_1.Configuration.create(
        'textmacros',
        {
          config: function (_config, jax) {
          ...
          preprocessors: [
            function (data) {
              ...
              config.parseOptions.nodeFactory.setMmlFactory(
                config.jax.mmlFactory
              );
            }
          ],
          options: {
    ...
    /***/ 56774: /***/ function (
      ...
      var TexParser_js_1 = __importDefault(__webpack_require__(75845));
      var Retries_js_1 = __webpack_require__(9841);
      var BaseMethods_js_1 = __importDefault(__webpack_require__(38364));
      exports.TextMacrosMethods = {
        ...
        Emph: function (parser, name) {
          var variant =
            parser.stack.env.mathvariant === '-tex-mathit'
              ? 'normal'
              : '-tex-mathit';
      ...
      var TextParser = (function (_super) {
        ...
        TextParser.prototype.saveText = function () {
          if (this.text) {
            ...
            var text = ParseUtil_js_1.default.internalText(
              this,
              this.text,
              mathvariant ? { mathvariant: mathvariant } : {}
            );
        ...
        TextParser.prototype.PushMath = function (mml) {
          ...
          try {
            for (
              var _b = __values(['mathsize', 'mathcolor']), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var name_1 = _c.value;
        ...
        TextParser.prototype.addAttributes = function (mml) {
          ...
          try {
            for (
              var _b = __values(['mathsize', 'mathcolor', 'mathvariant']),
                _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
        ...
        TextParser.prototype.Error = function (id, message) {
          ...
          throw new (TexError_js_1.default.bind.apply(
            TexError_js_1.default,
            __spreadArray([void 0, id, message], __read(args), false)
          ))();
        };
        return TextParser;
    ...
    /***/ 69112: /***/ function (
      ...
      var ParseUtil_js_1 = __importDefault(__webpack_require__(6980));
      var NodeUtil_js_1 = __importDefault(__webpack_require__(72691));
      var Entities_js_1 = __webpack_require__(38316);
      ...
      exports.UnicodeMethods.Unicode = function (parser, name) {
        ...
        var n = ParseUtil_js_1.default
          .trimSpaces(parser.GetArgument(name))
          .replace(/^0x/, 'x');
        ...
        var node = parser.create(
          'token',
          'mtext',
          def,
          (0, Entities_js_1.numeric)(n)
        );
      ...
      exports.UnicodeConfiguration = Configuration_js_1.Configuration.create(
        'unicode',
    ...
    /***/ 82736: /***/ (
      ...
      exports.UpgreekConfiguration = Configuration_js_1.Configuration.create(
        'upgreek',
        {
    ...
    /***/ 22232: /***/ function (
      ...
      exports.VerbConfiguration = Configuration_js_1.Configuration.create(
        'verb',
        { handler: { macro: ['verb'] } }
      );
    ...
    /***/ 62691: /***/ (__unused_webpack_module, exports) => {
      /*!
       *************************************************************************
       *
       *  mhchemParser.ts
      ...
      var mhchemParser = (function () {
        ...
        mhchemParser.toTex = function (input, type) {
          return _mhchemTexify.go(
            _mhchemParser.go(input, type),
            type !== 'tex'
          );
        };
        return mhchemParser;
        ...
        stateMachines: {
          ...
          ce: {
            ...
            actions: {
              ...
              '- after o/d': function (buffer, m, isAfterD) {
                var c1 = _mhchemParser.patterns.match_(
                  'orbital',
                  buffer.o || ''
                );
          ...
          pu: {
            ...
            actions: {
              ...
              output: function (buffer) {
                var ret;
                var md = _mhchemParser.patterns.match_(
                  '{(...)}',
                  buffer.d || ''
                );
                if (md && md.remainder === '') {
                ...
                var mq = _mhchemParser.patterns.match_(
                  '{(...)}',
                  buffer.q || ''
                );
                if (mq && mq.remainder === '') {
          ...
          'pu-2': {
            ...
            actions: {
              ...
              output: function (buffer) {
                var ret = [];
                if (buffer.rm) {
                  var mrm = _mhchemParser.patterns.match_(
                    '{(...)}',
                    buffer.rm || ''
                  );
          ...
          switch (buf.type_) {
            case 'chemfive':
              ...
              if (b5.b || b5.p) {
                ...
                res += '{\\vphantom{A}}';
                res +=
                  '^{\\smash[t]{\\vphantom{2}}\\llap{' + (b5.b || '') + '}}';
                res +=
                  '_{\\vphantom{2}\\llap{\\smash[t]{' + (b5.p || '') + '}}}';
              }
              if (b5.o) {
                if (b5.o.match(/^[+\-]/)) {
                  b5.o = '{' + b5.o + '}';
...
//# sourceMappingURL=1909.8af8be6e2de3dbea2fcf.js.map?v=8af8be6e2de3dbea2fcf
