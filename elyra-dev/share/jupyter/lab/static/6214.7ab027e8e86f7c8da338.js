...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [6214],
  {
    /***/ 26214: /***/ (
      ...
      /* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_2__ =
        __webpack_require__(63170);
      /* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_3__ =
        __webpack_require__(77470);
      /* harmony import */ var khroma__WEBPACK_IMPORTED_MODULE_4__ =
      ...
      (0, _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__export */.VA)(
        timelineDb_exports,
        {
          addEvent: () => addEvent,
      ...
      var tasks = [];
      var rawTasks = [];
      var getCommonDb = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__name */.K2)(
        () =>
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .commonDb_exports */.Wt,
        'getCommonDb'
      );
      ...
      var addEvent = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__name */.K2)(
        function (event) {
          const currentTask = rawTasks.find(
            (task) => task.id === currentTaskId - 1
          );
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__name */.K2)(
        function (element, faceData) {
          ...
          function smile(face2) {
            const arc = (0, d3__WEBPACK_IMPORTED_MODULE_1__ /* .arc */.JLW)()
      ...
      function wrap(text, width) {
        text.each(function () {
          var text2 = (0, d3__WEBPACK_IMPORTED_MODULE_1__ /* .select */.Ltv)(
              this
            ),
            words = text2
              .text()
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__name */.K2)(
        function (elem, node, fullSection, conf) {
          ...
          const fontSize = conf.fontSize?.replace
      ...
      var getVirtualNodeHeight = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__name */.K2)(
        function (elem, node, conf) {
        ...
        function (text, id, version, diagObj) {
          ...
          if (sections2 && sections2.length > 0) {
            sections2.forEach((section) => {
              const tasksForSection = tasks2.filter(
          ...
          (0,
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .setupGraphViewbox */.ot)(
            void 0,
            svg,
      ...
      var drawEvents = /* @__PURE__ */ (0,
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__name */.K2)(
        function (diagram2, events, sectionColor, masterX, masterY, conf) {
      ...
      _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_0__ /* .__name */.K2)(
        (options) => {
          ...
          for (let i = 0; i < options.THEME_COLOR_LIMIT; i++) {
            ...
            if (
              (0, khroma__WEBPACK_IMPORTED_MODULE_2__ /* ["default"] */.A)(
                options['lineColor' + i]
              )
            ) {
              options['lineColor' + i] = (0,
              khroma__WEBPACK_IMPORTED_MODULE_3__ /* ["default"] */.A)(
                options['lineColor' + i],
                20
              );
            } else {
              options['lineColor' + i] = (0,
              khroma__WEBPACK_IMPORTED_MODULE_4__ /* ["default"] */.A)(
                options['lineColor' + i],
                20
              );
            }
...
//# sourceMappingURL=6214.7ab027e8e86f7c8da338.js.map?v=7ab027e8e86f7c8da338
