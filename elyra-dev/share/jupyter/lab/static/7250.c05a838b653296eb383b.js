...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [7250],
  {
    /***/ 97250: /***/ (
      ...
      var index_js_ = __webpack_require__(45145); // CONCATENATED MODULE: ./node_modules/@lezer/rust/dist/index.es.js
      ...
      const literalTokens = new dist /* ExternalTokenizer */.Lu(
        (input, stack) => {
          if (isNum(input.next)) {
            let isFloat = false;
            do {
      ...
      const rustHighlighting = (0, index_js_.styleTags)({
        ...
        'CallExpression/Identifier': index_js_.tags.function(
          index_js_.tags.variableName
        ),
        BoundIdentifier: index_js_.tags.definition(index_js_.tags.variableName),
        'FunctionItem/BoundIdentifier': index_js_.tags.function(
      ...
      const parser = dist /* LRParser */.U1.deserialize({
        ...
        specialized: [
          { term: 281, get: (value) => spec_identifier[value] || -1 }
        ],
        tokenPrec: 15596
      });
      ...
      var dist_index_js_ = __webpack_require__(4452); // CONCATENATED MODULE: ./node_modules/@codemirror/lang-rust/dist/index.js
      /**
        ...
        parser: /*@__PURE__*/ parser.configure({
          props: [
            /*@__PURE__*/ dist_index_js_.indentNodeProp.add({
              IfExpression: /*@__PURE__*/ (0, dist_index_js_.continuedIndent)({
                except: /^\s*({|else\b)/
              }),
              'String BlockComment': () => null,
              AttributeItem: (cx) => cx.continue(),
              'Statement MatchArm': /*@__PURE__*/ (0,
              dist_index_js_.continuedIndent)()
            }),
...
//# sourceMappingURL=7250.c05a838b653296eb383b.js.map?v=c05a838b653296eb383b
