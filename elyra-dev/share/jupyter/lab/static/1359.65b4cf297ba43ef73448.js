  ...
  [1359],
  {
    /***/ 41359: /***/ (
      ...
      /* harmony export */ __webpack_require__.d(__webpack_exports__, {
        /* harmony export */ Lh: () =>
          /* binding */ classRenderer_v3_unified_default,
      ...
      var ClassMember = class {
        ...
        getDisplayDetails() {
          let displayText =
            this.visibility +
            (0,
            _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .parseGenericTypes */.QO)(
              this.id
            );
      ...
      var ClassDB = class {
        constructor() {
          ...
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .__name */.K2)(
            (element) => {
              let tooltipElem = (0,
              d3__WEBPACK_IMPORTED_MODULE_4__ /* .select */.Ltv)(
                '.mermaidTooltip'
              );
              if ((tooltipElem._groups || tooltipElem)[0][0] === null) {
                tooltipElem = (0,
                d3__WEBPACK_IMPORTED_MODULE_4__ /* .select */.Ltv)('body')
                  .append('div')
        ...
        addRelation(classRelation) {
          _chunk_YTJNT7DU_mjs__WEBPACK_IMPORTED_MODULE_3__ /* .log */.Rm.debug(
            'Adding relation: ' + JSON.stringify(classRelation)
          );
          const invalidTypes = [
          ...
          if (typeof member === 'string') {
            ...
            if (memberString.startsWith('<<') && memberString.endsWith('>>')) {
              theClass.annotations.push(
                sanitizeText2(
                  memberString.substring(2, memberString.length - 2)
                )
              );
        ...
        getData() {
          ...
          for (const classRelation of this.relations) {
            ...
            const edge = {
              id: (0,
              _chunk_O4NI6UNU_mjs__WEBPACK_IMPORTED_MODULE_2__ /* .getEdgeId */.rY)(
                classRelation.id1,
                classRelation.id2,
                {
                  prefix: 'id',
              ...
              pattern:
                classRelation.relation.lineType == 1 ? 'dashed' : 'solid',
              look: config.look
            };
            edges.push(edge);
          }
...
//# sourceMappingURL=1359.65b4cf297ba43ef73448.js.map?v=65b4cf297ba43ef73448
