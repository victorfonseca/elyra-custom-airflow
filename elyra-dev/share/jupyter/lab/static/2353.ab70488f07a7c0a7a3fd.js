    ...
    80747: function (t, e, r) {
      ...
      var l = (function (t) {
        ...
        function r(e, r, i) {
          ...
          n.setChildren(i);
          n.attributes = new E.Attributes(
            e.getNodeClass(n.kind).defaults,
        ...
        r.prototype.copy = function (t) {
          ...
          if (this.attributes) {
            ...
            try {
              for (
                var a = O(Object.keys(s)), M = a.next();
                !M.done;
                M = a.next()
              ) {
                var l = M.value;
        ...
        r.prototype.appendChild = function (e) {
          ...
          if (e.isInferred) {
            ...
            try {
              for (
                var E = O(o.getPropertyNames()), s = E.next();
                !s.done;
                s = E.next()
              ) {
                var a = s.value;
        ...
        r.prototype.setInheritedAttributes = function (t, e, i, n) {
          ...
          try {
            for (
              var M = O(Object.keys(t)), l = M.next();
              !l.done;
              l = M.next()
            ) {
              var u = l.value;
          ...
          if (
            N >= 0 &&
            N !== Infinity &&
            ((N === 1 && this.childNodes.length === 0) ||
              (N !== 1 && this.childNodes.length !== N))
          ) {
        ...
        r.prototype.setChildInheritedAttributes = function (t, e, r, i) {
          ...
          try {
            for (
              var E = O(this.childNodes), s = E.next();
              !s.done;
              s = E.next()
            ) {
              var a = s.value;
        ...
        r.prototype.addInheritedAttributes = function (t, e) {
          ...
          try {
            for (
              var E = O(Object.keys(e)), s = E.next();
              !s.done;
              s = E.next()
            ) {
              var a = s.value;
        ...
        r.prototype.verifyTree = function (t) {
          ...
          if (t['checkArity']) {
            if (
              e >= 0 &&
              e !== Infinity &&
              ((e === 1 && this.childNodes.length === 0) ||
                (e !== 1 && this.childNodes.length !== e))
            ) {
              this.mError(
        ...
        r.prototype.verifyAttributes = function (t) {
          ...
          if (t['checkAttributes']) {
            ...
            try {
              for (
                var o = O(i.getExplicitNames()), E = o.next();
                !E.done;
                E = o.next()
              ) {
                var s = E.value;
        ...
        r.prototype.verifyChildren = function (t) {
          ...
          try {
            for (
              var i = O(this.childNodes), n = i.next();
              !n.done;
              n = i.next()
            ) {
              var o = n.value;
      ...
      var u = (function (t) {
        ...
        e.prototype.walkTree = function (t, e) {
          ...
          try {
            for (
              var n = O(this.childNodes), o = n.next();
              !o.done;
              o = n.next()
            ) {
              var E = o.value;
      ...
      var f = (function (t) {
        ...
        r.prototype.setTeXclass = function (t) {
          ...
          try {
            for (
              var o = O(this.childNodes.slice(1)), E = o.next();
              !E.done;
              E = o.next()
            ) {
              var s = E.value;
    ...
    38669: function (t, e, r) {
      ...
      var M = (function (t) {
        ...
        e.prototype.coreText = function (t) {
          ...
          while (
            (((t.isKind('mrow') ||
              (t.isKind('TeXAtom') && t.texClass !== E.TEXCLASS.VCENTER) ||
              t.isKind('mstyle') ||
              t.isKind('mphantom')) &&
        ...
        e.prototype.adjustTeXclass = function (t) {
          ...
          if (t) {
            if (
              ...
              (e === E.TEXCLASS.BIN || e === E.TEXCLASS.REL)
            ) {
        ...
        e.prototype.checkOperatorTable = function (t) {
          ...
          if (l) {
            ...
            try {
              for (
                var u = o(Object.keys(l[3] || {})), c = u.next();
                !c.done;
                c = u.next()
              ) {
                var f = c.value;
    ...
    84465: function (t, e) {
      ...
      var O = (function () {
        function t(t, e, r) {
          ...
          try {
            for (
              var o = n(Object.keys(e)), E = o.next();
              !E.done;
              E = o.next()
            ) {
              var s = E.value;
        ...
        t.prototype.copy = function () {
          ...
          try {
            for (
              var O = n(this.childNodes || []), o = O.next();
              !o.done;
              o = O.next()
            ) {
              var E = o.value;
    ...
    34981: function (t, e) {
      ...
      function o(t) {
        return (
          typeof t === 'object' &&
          t !== null &&
          (t.constructor === O || t.constructor === E)
        );
      }
      e.isObject = o;
      e.APPEND = '[+]';
      ...
      function p(t) {
        ...
        try {
          for (var a = r(o), M = a.next(); !M.done; M = a.next()) {
            ...
            try {
              for (
                var f = ((n = void 0), r(Object.keys(t || {}))), L = f.next();
                !L.done;
                L = f.next()
              ) {
                var R = L.value;
