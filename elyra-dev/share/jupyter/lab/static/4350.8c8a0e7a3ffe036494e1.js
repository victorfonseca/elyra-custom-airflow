  ...
  [4350],
  {
    ...
    45948: (e, n, t) => {
      ...
      function x(e) {
        ...
        i = i.map(O);
        const o = O(e.slice(1).trim());
        if (o.between) {
          return { between: i, stream: o };
        } else {
          o.between = i;
        }
        return o;
      ...
      function w(e) {
        ...
        h = y(e, m, u);
        if (h < p) {
          t.push(e.substring(f, h).trim());
          f = m = ++h;
        }
        m = y(e, m, r);
        if (m === p) {
          t.push(e.substring(f, p).trim());
        } else {
          t.push(e.substring(f, m).trim());
          v = [];
          f = ++m;
          if (f === p) throw 'Unmatched left bracket: ' + e;
        }
        while (m < p) {
          m = y(e, m, s);
          if (m === p) throw 'Unmatched left bracket: ' + e;
          v.push(e.substring(f, m).trim());
          if (m < p - 1 && e[++m] !== r) throw 'Expected left bracket: ' + e;
          f = ++m;
        }
        if (!(p = t.length) || d.test(t[p - 1])) {
    ...
    54350: (e, n, t) => {
      ...
      t.d(n, {
        accessPathDepth: () => Q,
        accessPathWithDatum: () => W,
        compile: () => Iw,
        contains: () => F,
        deepEqual: () => h,
        deleteNestedProperty: () => R,
        duplicate: () => b,
        entries: () => M,
        every: () => D,
        fieldIntersection: () => _,
        flatAccessWithDatum: () => H,
        getFirstDefined: () => X,
        hasIntersection: () => B,
        hash: () => w,
        internalField: () => ne,
      ...
      Set.prototype['toJSON'] = function () {
        return `Set(${[...this].map((e) => l()(e)).join(',')})`;
      };
      const x = l();
      function w(e) {
        if ((0, r.Et)(e)) {
      ...
      function U(e, n) {
        if (p(e)) {
          ...
          return `(${e.and.map((e) => U(e, n)).join(') && (')})`;
        } else if (f(e)) {
          return `(${e.or.map((e) => U(e, n)).join(') || (')})`;
        } else {
          return n(e);
        }
      }
      ...
      function W(e, n = 'datum') {
        const t = (0, r.iv)(e);
        const i = [];
        for (let s = 1; s <= t.length; s++) {
          const e = `[${t.slice(0, s).map(r.r$).join('][')}]`;
          i.push(`${n}${e}`);
        }
        return i.join(' && ');
      }
      function H(e, n = 'datum') {
        return `${n}[${(0, r.r$)((0, r.iv)(e).join('.'))}]`;
      }
      function G(e) {
        return e.replace(/(\[|\]|\.|'|")/g, '\\$1');
      }
      function Y(e) {
        return `${(0, r.iv)(e).map(G).join('\\.')}`;
      }
      function K(e, n, t) {
        return e.replace(
      ...
      function V(e) {
        return `${(0, r.iv)(e).join('.')}`;
      }
      function Q(e) {
        if (!e) {
          return 0;
        }
        return (0, r.iv)(e).length;
      }
      function X(...e) {
        for (const n of e) {
          if (n !== undefined) {
      ...
      const ke = 'angle';
      const Ce = 'opacity';
      const Se = 'fillOpacity';
      const Ee = 'strokeOpacity';
      const Be = 'strokeWidth';
      const Pe = 'strokeDash';
      const _e = 'text';
      const ze = 'order';
      const Ne = 'detail';
      ...
      const Le = 'href';
      const qe = 'url';
      const Ue = 'description';
      const Re = { x: 1, y: 1, x2: 1, y2: 1 };
      const Ie = { theta: 1, theta2: 1, radius: 1, radius2: 1 };
      function We(e) {
        return e in Ie;
      }
      const He = { longitude: 1, longitude2: 1, latitude: 1, latitude2: 1 };
      function Ge(e) {
        switch (e) {
          case ve:
            return 'y';
      ...
      const Ve = Object.assign(
        Object.assign(Object.assign(Object.assign({}, Re), Ie), He),
        {
          xOffset: 1,
          yOffset: 1,
          color: 1,
      ...
      function Qe(e) {
        return e === je || e === Fe || e === $e;
      }
      const Xe = { row: 1, column: 1, facet: 1 };
      const Je = N(Xe);
      const Ze = Object.assign(Object.assign({}, Ve), Xe);
      const en = N(Ze);
      const { order: nn, detail: tn, tooltip: rn } = Ze,
        sn = se(Ze, ['order', 'detail', 'tooltip']);
      const { row: on, column: an, facet: un } = sn,
        cn = se(sn, ['row', 'column', 'facet']);
      const ln = N(sn);
      const fn = N(cn);
      function dn(e) {
        return !!cn[e];
      ...
      const In = { theta: 1, radius: 1 };
      const Wn = N(In);
      function Hn(e) {
        return e === 'width' ? ce : le;
      }
      const Gn = { xOffset: 1, yOffset: 1 };
      const Yn = N(Gn);
      function Kn(e) {
        return e in Gn;
      }
      ...
      const at = Object.assign(
        Object.assign(Object.assign(Object.assign({}, qn), In), Gn),
        it
      );
      const ut = N(at);
      function ct(e) {
      ...
      function Ot(e) {
        return (0, r.Kg)(e) && !!ht[e];
      }
      const xt = new Set(['count', 'valid', 'missing', 'distinct']);
      function wt(e) {
        return (0, r.Kg)(e) && xt.has(e);
      }
      function jt(e) {
        return (0, r.Kg)(e) && F(['min', 'max'], e);
      }
      const Ft = new Set(['count', 'sum', 'distinct', 'valid', 'missing']);
      const $t = new Set([
        'mean',
        'average',
        'median',
      ...
      function Dt(e) {
        ...
        return (
          'bin' +
          N(e)
            .map((n) => (St(e[n]) ? q(`_${n}_${M(e[n])}`) : q(`_${n}_${e[n]}`)))
            .join('')
        );
      }
      function At(e) {
        return e === true || (Ct(e) && !e.binned);
      }
      function kt(e) {
        return e === 'binned' || (Ct(e) && e.binned === true);
      }
      function Ct(e) {
        return (0, r.Gv)(e);
      }
      ...
      function zt(e) {
        ...
        return {
          titleMarkConfig: h,
          subtitleMarkConfig: O,
          nonMarkTitleProperties: b,
          subtitle: y
        };
      }
      function Nt(e) {
        return (0, r.Kg)(e) || ((0, r.cy)(e) && (0, r.Kg)(e[0]));
      }
      function Tt(e) {
      ...
      function Zt(e) {
        ...
        return (0, r.r$)(e.value);
      }
      function ei(e) {
        if (Tt(e)) {
          return e.signal;
        }
        return e == null ? null : (0, r.r$)(e);
      }
      function ni(e, n, t) {
        for (const i of t) {
      ...
      function ai(e, n) {
        return (0, r.YO)(e).reduce(
          (e, t) => {
            var i;
            e.field.push(Du(t, n));
            e.order.push(
              (i = t.sort) !== null && i !== void 0 ? i : 'ascending'
            );
            return e;
          },
          { field: [], order: [] }
      ...
      function li(e, n) {
        ...
        if (t == null || i === null) {
          ...
          return { explicit: e.explicit, value: ui(t, i) };
        }
      ...
      function mi(e) {
        return e
          ? `Dropping "fit-${e}" because spec has discrete ${vn(e)}.`
      ...
      const Pi = 'Attempt to add the same child twice.';
      function _i(e) {
      ...
      const Dr = 'Invalid channel for axis.';
      function Ar(e) {
      ...
      class Wr {
        ...
        warn(...e) {
          if (qr(this, Ur, 'f') >= Warn) this.warns.push(...e);
          return this;
        }
        info(...e) {
          if (qr(this, Ur, 'f') >= Info) this.infos.push(...e);
          return this;
        }
        debug(...e) {
          if (qr(this, Ur, 'f') >= Debug) this.debugs.push(...e);
          return this;
        }
        error(...e) {
          if (qr(this, Ur, 'f') >= ErrorLevel) throw Error(...e);
          return this;
        }
      }
      Ur = new WeakMap();
      ...
      function ws(e, n, { end: t } = { end: false }) {
        const i = W(n);
        const r = bs(e) ? 'utc' : '';
        function s(e) {
          if (e === 'quarter') {
      ...
      function ks(e) {
        return (
          !!(e === null || e === void 0 ? void 0 : e.field) &&
          e.equal !== undefined
        );
      }
      function Cs(e) {
      ...
      function Ps(e) {
        if (e === null || e === void 0 ? void 0 : e.field) {
          if ((0, r.cy)(e.range) && e.range.length === 2) {
            return true;
          } else if (Tt(e.range)) {
            return true;
          }
      ...
      function Ns(e) {
        return _s(e) || ks(e) || Ps(e) || Cs(e) || Es(e) || Ss(e) || Bs(e);
      }
      function Ts(e, n) {
        return Ju(e, { timeUnit: n, wrapTime: true });
      }
      function Ms(e, n) {
        return e.map((e) => Ts(e, n));
      }
      function Ls(e, n = true) {
        var t;
        const { field: i } = e;
        const r =
          (t = $s(e.timeUnit)) === null || t === void 0 ? void 0 : t.unit;
        const s = r ? `time(${ws(r, i)})` : Du(e, { expr: 'datum' });
        if (ks(e)) {
          return `${s}===${Ts(e.equal, r)}`;
        } else if (Cs(e)) {
          const n = e.lt;
          return `${s}<${Ts(n, r)}`;
        } else if (Es(e)) {
          ...
          return `indexof([${Ms(e.oneOf, r).join(',')}], ${s}) !== -1`;
        } else if (zs(e)) {
          return qs(s, e.valid);
        } else if (Ps(e)) {
          const { range: t } = e;
          const i = Tt(t) ? { signal: `${t.signal}[0]` } : t[0];
          const o = Tt(t) ? { signal: `${t.signal}[1]` } : t[1];
          if (i !== null && o !== null && n) {
            return 'inrange(' + s + ', [' + Ts(i, r) + ', ' + Ts(o, r) + '])';
          }
          const a = [];
          if (i !== null) {
            a.push(`${s} >= ${Ts(i, r)}`);
      ...
      function Us(e) {
        ...
        if (Ns(e) && e.timeUnit) {
          return Object.assign(Object.assign({}, e), {
            timeUnit:
              (n = $s(e.timeUnit)) === null || n === void 0 ? void 0 : n.unit
          });
        }
        return e;
      }
      ...
      const Ys = Is.quantitative;
      const Ks = Is.ordinal;
      const Vs = Is.temporal;
      const Qs = Is.nominal;
      const Xs = Is.geojson;
      const Js = N(Is);
      function Zs(e) {
      ...
      const uo = new Set([...ao, 'time', 'utc']);
      function co(e) {
        return ao.has(e);
      }
      const lo = new Set(['quantile', 'quantize', 'threshold']);
      const fo = new Set([...uo, ...lo, 'sequential', 'identity']);
      ...
      function jo(e) {
        return (0, Rs.isObject)(e) && 'field' in e;
      }
      const Fo = {
        type: 1,
        domain: 1,
      ...
      function _o(e, n) {
        switch (n) {
          ...
          case 'zero':
            return (
              ho(e) && !F(['log', 'time', 'utc', 'threshold', 'quantile'], e)
            );
        }
      }
      function zo(e, n) {
      ...
      function No(e, n) {
        if (F([Ks, Qs], n)) {
          ...
          return F([no.TIME, no.UTC, undefined], e);
        } else if (n === Ys) {
          return co(e) || yo(e) || e === undefined;
        }
        return true;
      }
      function To(e, n, t = false) {
        if (!ct(e)) {
          return false;
        }
        switch (e) {
          ...
          case Ee:
          case ke:
            return bo(n) || yo(n) || F(['band', 'point', 'ordinal'], n);
          case je:
          case Fe:
          case $e:
            return n !== 'band';
      ...
      function xa(e) {
        ...
        const o = ka(e);
        if (fu(t) && !wt(t.aggregate) && r && bo(r.get('type'))) {
          return wa({ fieldDef: t, channel: n, markDef: i, ref: o, config: s });
        }
        return o;
      }
      function wa({ fieldDef: e, channel: n, markDef: t, ref: i, config: r }) {
        if (ea(t.type)) {
          return i;
        }
      ...
      function Fa(e, n = true) {
        return qs((0, r.Kg)(e) ? e : Du(e, { expr: 'datum' }), !n);
      }
      function $a(e) {
        const { datum: n } = e;
        if (Jr(n)) {
      ...
      function Aa({
        ...
        const a = Du(n, { expr: o, suffix: r });
        const u =
          t !== undefined
            ? Du(t, { expr: o })
            : Du(n, { suffix: 'end', expr: o });
        const c = {};
        if (s === 0 || s === 1) {
          c.scale = e;
          const n = s === 0 ? a : u;
      ...
      function ka({
        ...
        if (n) {
          if (bu(n)) {
            ...
            if (yu(n)) {
              ...
              const { bin: a, timeUnit: l, type: d } = n;
              if (At(a) || (f && l && d === Vs)) {
                if (u === null || u === void 0 ? void 0 : u.impute) {
                  return Da(n, o, { binSuffix: 'mid' }, { offset: c });
                }
                if (f && !mo(r)) {
                  return Aa({
                    scaleName: o,
                ...
                return Da(n, o, ec(n, e) ? { binSuffix: 'range' } : {}, {
                  offset: c
                });
              } else if (kt(a)) {
                if (fu(t)) {
            ...
            return Da(n, o, mo(r) ? { binSuffix: 'range' } : {}, {
              offset: c,
              band:
                r === 'band'
                  ? (d = f !== null && f !== void 0 ? f : n.bandPosition) !==
                      null && d !== void 0
                    ? d
                    : 0.5
                  : undefined
            ...
            const t = n.value;
            const i = c ? { offset: c } : {};
            return Object.assign(Object.assign({}, Ca(e, t)), i);
          }
        }
        if ((0, r.Tn)(l)) {
          l = l();
        ...
        if (l) {
          return Object.assign(Object.assign({}, l), c ? { offset: c } : {});
        }
        return l;
      }
      function Ca(e, n) {
      ...
      function Pa({
        ...
        if (Qu(e)) {
          const t = Ia({
            ...
            isUTCScale:
              Ou(e) &&
              ((a = e.scale) === null || a === void 0 ? void 0 : a.type) ===
                no.UTC
          });
          return t ? { signal: t } : undefined;
        }
        n = Ma({ type: c, specifiedFormat: n, config: s, normalizeStack: r });
        if (fu(e) && At(e.bin)) {
          const r = Du(e, { expr: i, binSuffix: 'end' });
          return { signal: Ra(u, r, n, t, s) };
        } else if (n || du(e) === 'quantitative') {
          return { signal: `${qa(u, n)}` };
        } else {
      ...
      function _a(e, n, t) {
        if (fu(e)) {
          if (t) {
            return `${Du(e, { expr: n, suffix: 'end' })}-${Du(e, { expr: n, suffix: 'start' })}`;
          } else {
            return Du(e, { expr: n });
          }
        } else {
      ...
      function za({
        ...
        o !== null && o !== void 0 ? o : (o = _a(e, i, r));
        if (o !== 'datum.value' && fu(e) && At(e.bin)) {
          const r = Du(e, { expr: i, binSuffix: 'end' });
          return { signal: Ra(o, r, n, t, s) };
        }
        return { signal: Ea(t, o, n) };
      }
      function Na(e, n, t, i, r, s) {
        var o;
        if (Sa(i)) {
          return undefined;
        } else if (t === undefined && i === undefined && r.customFormatTypes) {
          if (du(e) === 'quantitative') {
            if (
        ...
        if (xu(e) && e.stack === 'normalize' && r.normalizedNumberFormat) {
          return Ma({ type: 'quantitative', config: r, normalizeStack: true });
        }
        if (Qu(e)) {
          const n = fu(e)
            ? (o = $s(e.timeUnit)) === null || o === void 0
        ...
        return Ma({ type: n, specifiedFormat: t, config: r });
      }
      function Ta(e, n, t) {
        var i;
        if (e && (Tt(e) || e === 'number' || e === 'time')) {
          return e;
        }
        if (Qu(n) && t !== 'time' && t !== 'utc') {
          return fu(n) &&
            ((i = $s(n === null || n === void 0 ? void 0 : n.timeUnit)) ===
              null || i === void 0
              ? void 0
              : i.utc)
            ? 'utc'
      ...
      function Ua(e, n, t, i) {
        ...
        return qa(
          e,
          (s = (0, r.Kg)(n) ? n : undefined) !== null && s !== void 0
            ? s
            : i.numberFormat
        );
      }
      function Ra(e, n, t, i, r) {
        if (
          t === undefined &&
          i === undefined &&
          r.customFormatTypes &&
          ...
          return Ra(e, n, r.numberFormat, r.numberFormatType, r);
        }
        const s = Ua(e, t, i, r);
        const o = Ua(n, t, i, r);
        return `${qs(e, false)} ? "null" : ${s} + "${Ba}" + ${o}`;
      }
      function Ia({
        field: e,
        timeUnit: n,
      ...
      function ru({ fieldDef: e, fieldDef2: n, markDef: t, config: i }) {
        if (bu(e) && e.bandPosition !== undefined) {
      ...
      function su({
        ...
        var a, u, c;
        const l = vn(e);
        const f = ii(o ? 'size' : l, i, r, { vgChannel: l });
        if (f !== undefined) {
          return f;
        }
        if (fu(n)) {
        ...
        if (na(i.type)) {
          ...
          return (c = r[i.type]) === null || c === void 0
            ? void 0
            : c.discreteBandSize;
        }
        return undefined;
      ...
      function ou(e, n, t, i) {
        if (At(e.bin) || (e.timeUnit && yu(e) && e.type === 'temporal')) {
          return (
            ru({ fieldDef: e, fieldDef2: n, markDef: t, config: i }) !==
            undefined
          );
        }
        return false;
      ...
      function uu(e) {
        ...
        return !!n && !(0, r.cy)(n) && fu(n);
      }
      function cu(e) {
        const n = e === null || e === void 0 ? void 0 : e['condition'];
        return !!n && !(0, r.cy)(n) && bu(n);
      }
      function lu(e) {
        const n = e === null || e === void 0 ? void 0 : e['condition'];
        return !!n && ((0, r.cy)(n) || vu(n));
      }
      function fu(e) {
      ...
      function gu(e) {
        return (yu(e) && !Au(e)) || hu(e);
      }
      function mu(e) {
        return du(e) === 'quantitative' || hu(e);
      }
      function hu(e) {
        return pu(e) && (0, r.Et)(e.datum);
      }
      function bu(e) {
        return fu(e) || pu(e);
      }
      ...
      function Au(e) {
        ...
        throw new Error(Ri(e.type));
      }
      function ku(e) {
        var n;
        return (
          Ou(e) && yo((n = e.scale) === null || n === void 0 ? void 0 : n.type)
        );
      }
      function Cu(e) {
      ...
      function Su(e, n) {
        ...
        if (o === 'count') {
          ...
          const e = (t = $s(s)) === null || t === void 0 ? void 0 : t.unit;
          if (e) {
            return `${i} (${Os(e).join('-')})`;
          }
        } else if (o) {
      ...
      function Nu(e, n, { allowDisabling: t, includeDefault: i = true }) {
        var r, s;
        const o = (r = Tu(e)) === null || r === void 0 ? void 0 : r.title;
        if (!fu(e)) {
          return o !== null && o !== void 0 ? o : e.title;
        }
        const a = e;
        const u = i ? Mu(a, n) : undefined;
        if (t) {
          return X(o, a.title, u);
        } else {
          return (s = o !== null && o !== void 0 ? o : a.title) !== null &&
            s !== void 0
            ? s
            : u;
        }
      ...
      function Tu(e) {
        if (xu(e) && e.axis) {
          return e.axis;
        } else if (wu(e) && e.legend) {
          return e.legend;
        } else if (Xa(e) && e.header) {
          return e.header;
        }
        return undefined;
      }
      ...
      function Lu(e) {
        ...
        if (ju(e)) {
          ...
          const t = (n = Tu(e)) !== null && n !== void 0 ? n : {};
      ...
      function qu(e, n) {
        ...
        if (
          Ou(e) &&
          ((t = e.scale) === null || t === void 0 ? void 0 : t.type)
        ) {
      ...
      function Iu(e, n, t, i = {}) {
        ...
        if (bu(e)) {
          ...
          return Object.assign(Object.assign({}, e), {
            condition: Wu(e.condition, n, t, i)
          });
        }
        return e;
      }
      function Wu(e, n, t, i) {
        if (ju(e)) {
          ...
          if (Sa(s) && !t.customFormatTypes) {
            Vr(Ni(n));
            return Wu(o, n, t, i);
          }
        } else {
          const r = xu(e) ? 'axis' : wu(e) ? 'legend' : Xa(e) ? 'header' : null;
          if (r && e[r]) {
            const s = e[r],
              { format: o, formatType: a } = s,
              u = Za(s, ['format', 'formatType']);
            if (Sa(a) && !t.customFormatTypes) {
              Vr(Ni(n));
              return Wu(
                Object.assign(Object.assign({}, e), { [r]: u }),
                n,
                t,
                i
              );
      ...
      function Gu(e, n, { compositeMark: t = false } = {}) {
        ...
        if (yu(u)) {
          const { compatible: e, warning: t } = Vu(u, n) || {};
          if (e === false) {
            Vr(t);
          }
        }
        if (iu(u) && (0, r.Kg)(u.sort)) {
          const { sort: e } = u;
          if (Ga(e)) {
      ...
      function Yu(e, n) {
        if ((0, r.Lm)(e)) {
          ...
          return Object.assign(Object.assign({}, e), { maxbins: Et(n) });
        } else {
          return e;
        }
      }
      const Ku = { compatible: true };
      function Vu(e, n) {
        const t = e.type;
      ...
      function Qu(e) {
        const { formatType: n } = Lu(e);
        return n === 'time' || (!n && Xu(e));
      }
      function Xu(e) {
        return e && (e['type'] === 'temporal' || (fu(e) && !!e.timeUnit));
      }
      function Ju(
        e,
        { timeUnit: n, type: t, wrapTime: i, undefinedIfExprNotRequired: s }
      ) {
        var o;
        const a = n && ((o = $s(n)) === null || o === void 0 ? void 0 : o.unit);
        let u = a || t === 'temporal';
        let c;
        if (Bt(e)) {
          c = e.expr;
          ...
          u = true;
          c = as(e);
        } else if ((0, r.Kg)(e) || (0, r.Et)(e)) {
          if (u) {
            c = `datetime(${x(e)})`;
            if (ps(a)) {
              if (
                ((0, r.Et)(e) && e < 1e4) ||
                ((0, r.Kg)(e) && isNaN(Date.parse(e)))
              ) {
                c = as({ [a]: e });
              }
            }
      ...
      function Zu(e, n) {
        ...
        return n.map((n) => {
          const i = Ju(n, {
            timeUnit: fu(e) ? e.timeUnit : undefined,
            type: t,
      ...
      function ec(e, n) {
        ...
        return ct(n) && ['ordinal', 'nominal'].includes(e.type);
      }
      const nc = {
      ...
      const ic = ['domain', 'grid', 'labels', 'ticks', 'title'];
      const rc = {
        grid: 'grid',
        gridCap: 'grid',
        gridColor: 'grid',
      ...
      const oc = Object.assign(Object.assign({}, sc), {
        style: 1,
        labelExpr: 1,
        encoding: 1
      });
        ...
        jc(e, (a, u) => {
          if (fu(a)) {
            const { field: c, aggregate: l, bin: f, timeUnit: d } = a,
              p = pc(a, ['field', 'aggregate', 'bin', 'timeUnit']);
            if (l || d || f) {
              const e = Tu(a);
              const g = e === null || e === void 0 ? void 0 : e.title;
              let m = Du(a, { forAs: true });
              const h = Object.assign(
                Object.assign(
                  Object.assign(
                    {},
                    g ? [] : { title: Nu(a, n, { allowDisabling: true }) }
                  ),
                  p
                ),
                { field: m }
              ...
              if (l) {
                ...
                if (vt(l)) {
                  e = 'argmax';
                  m = Du({ op: 'argmax', field: l.argmax }, { forAs: true });
                  h.field = `${m}.${c}`;
                } else if (yt(l)) {
                  e = 'argmin';
                  m = Du({ op: 'argmin', field: l.argmin }, { forAs: true });
                  h.field = `${m}.${c}`;
                } else if (
                  l !== 'boxplot' &&
                  l !== 'errorbar' &&
                ...
                if (yu(a) && At(f)) {
                  ...
                  t.push(Du(a, { binSuffix: 'end' }));
                  if (ec(a, u)) {
                    t.push(Du(a, { binSuffix: 'range' }));
                  }
                  if (Rn(u)) {
      ...
      function vc(e, n, t) {
        ...
        if (!i) {
          ...
          const t = e[n === fe ? ce : le];
          if (fu(t) && fu(e[n]) && kt(t.bin)) {
            return true;
          } else {
            return false;
          }
      ...
      function Oc(e, n, t, i) {
        ...
        for (let o of jn) {
          ...
          if (o === je && (t ? 'fill' in e : 'stroke' in e)) {
            Vr(Gi('encoding', { fill: 'fill' in e, stroke: 'stroke' in e }));
            continue;
          }
          if (
            o === Ne ||
            ...
            if (o === Me && a === null) {
              s[o] = null;
            } else if (!fu(a) && !pu(a) && !vu(a) && !au(a) && !Tt(a)) {
              Vr(Ki(a, o));
              continue;
            }
            s[o] = Iu(a, o, i);
      ...
      function xc(e, n) {
        const t = {};
        for (const i of N(e)) {
          const r = Iu(e[i], i, n, { compositeMark: true });
          t[i] = r;
        }
        return t;
      }
      ...
      function kc(e, n, t, i = true) {
        ...
        const r = e.map(({ fieldPrefix: e, titlePrefix: t }) => {
          ...
          return {
            field: e + n.field,
            type: n.type,
            title: Tt(t) ? { signal: `${t}"${escape(r)}"` } : t + r
          };
        });
        const s = wc(t).map(Fu);
        return { tooltip: [...r, ...C(s, w)] };
      }
      function Cc(e) {
        const { title: n, field: t } = e;
        return X(n, t);
      }
      function Sc(e, n, t, i, s) {
        const { scale: o, axis: a } = t;
        return ({
          partName: u,
          mark: c,
          positionPrefix: l,
          endPositionPrefix: f = undefined,
          extraEncoding: d = {}
        }) => {
          const p = Cc(t);
          return Ec(e, u, s, {
      ...
      function Bc(e, n, t) {
        ...
        const u = i[`${r}Error2`];
        return {
          continuousAxisChannelDef: Pc(s, t),
          continuousAxisChannelDef2: Pc(o, t),
          continuousAxisChannelDefError: Pc(a, t),
          continuousAxisChannelDefError2: Pc(u, t),
          continuousAxis: r
        };
      }
      function Pc(e, n) {
      ...
      function _c(e, n) {
        ...
        if (gu(r)) {
          if (gu(s)) {
            const e = fu(r) && r.aggregate;
            const t = fu(s) && s.aggregate;
            if (!e && t === n) {
              return 'vertical';
            } else if (!t && e === n) {
              return 'horizontal';
      ...
      const Nc = 'boxplot';
      const Tc = ['box', 'median', 'outliers', 'rule', 'ticks'];
      const Mc = new dc(Nc, qc);
      function Lc(e) {
        if ((0, r.Et)(e)) {
          return 'tukey';
        }
      ...
      function qc(e, { config: n }) {
        var t, i;
        e = Object.assign(Object.assign({}, e), {
          encoding: xc(e.encoding, n)
        });
        const { mark: s, encoding: o, params: a, projection: u } = e,
          c = zc(e, ['mark', 'encoding', 'params', 'projection']);
        const l = ia(s) ? s : { type: s };
        if (a) {
          Vr(Oi('boxplot'));
        }
        const f =
          (t = l.extent) !== null && t !== void 0 ? t : n.boxplot.extent;
        const d = ii('size', l, n);
        const p = l.invalid;
        const g = Lc(f);
        const {
        ...
        const { color: A, size: k } = j,
          C = zc(j, ['color', 'size']);
        const S = (e) => Sc(l, v, y, e, n.boxplot);
        const E = S(C);
        const B = S(j);
        const P = S(Object.assign(Object.assign({}, C), k ? { size: k } : {}));
        const _ = kc(
          [
            {
        ...
        const L = [
          ...
          ...B({
            partName: 'box',
            mark: Object.assign(
              Object.assign({ type: 'bar' }, d ? { size: d } : {}),
              { orient: $, invalid: p, ariaRoleDescription: 'box' }
            ),
          ...
          ...P({
            ...
            mark: Object.assign(
              Object.assign(
                Object.assign(
                  { type: 'tick', invalid: p },
                  (0, r.Gv)(n.boxplot.median) && n.boxplot.median.color
        ...
        if (g === 'min-max') {
          return Object.assign(Object.assign({}, c), {
            transform: ((i = c.transform) !== null && i !== void 0
              ? i
              : []
            ).concat(b),
            layer: L
        ...
        const q = `datum["lower_box_${y.field}"]`;
        const U = `datum["upper_box_${y.field}"]`;
        const R = `(${U} - ${q})`;
        const I = `${q} - ${f} * ${R}`;
        const W = `${U} + ${f} * ${R}`;
        const H = `datum["${y.field}"]`;
        const G = { joinaggregate: Uc(y.field), groupby: x };
        const Y = {
          transform: [
            { filter: `(${I} <= ${H}) && (${H} <= ${W})` },
            {
        ...
        const { tooltip: K } = C,
          V = zc(C, ['tooltip']);
        const { scale: Q, axis: X } = y;
        const J = Cc(y);
        const Z = O(X, ['title']);
        const ee = Ec(l, 'outliers', n.boxplot, {
          transform: [{ filter: `(${H} < ${I}) || (${H} > ${W})` }],
          mark: 'point',
          encoding: Object.assign(
            Object.assign(
              Object.assign(
        ...
        const te = [...m, ...h, G];
        if (ee) {
          ne = { transform: te, layer: [ee, Y] };
        } else {
          ne = Y;
          ne.transform.unshift(...te);
        }
        return Object.assign(Object.assign({}, c), {
          layer: [ne, { transform: b, layer: L }]
        });
      }
      function Uc(e) {
        return [
      ...
      function Rc(e, n, t) {
        const i = _c(e, Nc);
        const { continuousAxisChannelDef: r, continuousAxis: s } = Bc(e, i, Nc);
        const o = r.field;
        const a = Lc(n);
        const u = [
          ...Uc(o),
        ...
        const l = e.encoding,
          f = s,
          d = l[f],
          p = zc(l, [typeof f === 'symbol' ? f : f + '']);
        const { customTooltipWithoutAggregatedField: g, filteredEncoding: m } =
          Ac(p);
        const {
          bins: h,
          timeUnits: b,
      ...
      const Wc = 'errorbar';
      const Hc = ['ticks', 'rule'];
      const Gc = new dc(Wc, Yc);
      function Yc(e, { config: n }) {
        e = Object.assign(Object.assign({}, e), {
          encoding: xc(e.encoding, n)
        });
        const {
      ...
      function Kc(e, n) {
        const { encoding: t } = e;
        if (Vc(t)) {
          return { orient: _c(e, n), inputType: 'raw' };
        }
        const i = Qc(t);
        const r = Xc(t);
        const s = t.x;
      ...
      function Qc(e) {
        return bu(e.x2) || bu(e.y2);
      }
      function Xc(e) {
        return bu(e.xError) || bu(e.xError2) || bu(e.yError) || bu(e.yError2);
      }
      function Jc(e, n, t) {
        var i;
        const { mark: r, encoding: s, params: o, projection: a } = e,
          u = Ic(e, ['mark', 'encoding', 'params', 'projection']);
        const c = ia(r) ? r : { type: r };
        if (o) {
          Vr(Oi(n));
        }
        const { orient: l, inputType: f } = Kc(e, n);
        const {
        ...
        return {
          transform: [
            ...
            ...E,
            ...B,
            ...(N.length === 0 ? [] : [{ aggregate: N, groupby: T }]),
            ...y
          ],
          groupby: T,
          continuousAxisChannelDef: d,
      ...
      function Zc(e, n, t, i, r, s, o, a) {
        ...
        if (s === 'raw') {
          ...
          if (t === 'stderr' || t === 'stdev') {
            ...
            f = [
              { fieldPrefix: 'center_', titlePrefix: I(n) },
              { fieldPrefix: 'upper_', titlePrefix: el(n, t, '+') },
            ...
            f = [
              {
                fieldPrefix: 'upper_',
                titlePrefix: Nu(
                  { field: l, aggregate: i, type: 'quantitative' },
                  a,
              ...
              },
              {
                fieldPrefix: 'lower_',
                titlePrefix: Nu(
                  { field: l, aggregate: n, type: 'quantitative' },
                  a,
                  { allowDisabling: false }
                )
              },
              {
                fieldPrefix: 'center_',
                titlePrefix: Nu(
                  { field: l, aggregate: e, type: 'quantitative' },
                  a,
                  { allowDisabling: false }
                )
              }
          ...
          for (const e of c) {
            f.push({
              ...
              titlePrefix: K(K(e.calculate, 'datum["', ''), '"]', '')
            });
          }
        }
        return {
      ...
      const nl = 'errorband';
      const tl = ['band', 'borders'];
      const il = new dc(nl, rl);
      function rl(e, { config: n }) {
        e = Object.assign(Object.assign({}, e), {
          encoding: xc(e.encoding, n)
        });
        const {
        ...
        const c = o;
        const l = Sc(c, r, i, s, n.errorband);
        ...
        if (f) {
          ...
          p = Object.assign(Object.assign(Object.assign({}, p), g), {
            aria: false
          });
      ...
      const dl = N(ll);
      const pl = N(fl);
      const gl = { header: 1, headerRow: 1, headerColumn: 1, headerFacet: 1 };
      const ml = N(gl);
      const hl = [
        'size',
        'shape',
      ...
      function wl(e) {
        return (
          e === 'legend' || !!(e === null || e === void 0 ? void 0 : e.legend)
        );
      }
      function jl(e) {
        return wl(e) && (0, r.Gv)(e);
      }
      function Fl(e) {
      ...
      function El({ step: e, offsetIsDiscrete: n }) {
        var t;
        if (n) {
      ...
      function Bl(e) {
        return (0, r.Gv)(e) && e['step'] !== undefined;
      }
      function Pl(e) {
        return e['view'] || e['width'] || e['height'];
      }
      const _l = 20;
      const zl = { align: 1, bounds: 1, center: 1, columns: 1, spacing: 1 };
      const Nl = N(zl);
      function Tl(e, n, t) {
        var i, s;
        const o = t[n];
        const a = {};
        const { spacing: u, columns: c } = o;
        if (u !== undefined) {
          a.spacing = u;
        }
        if (c !== undefined) {
          if ((Ja(e) && !Qa(e.facet)) || kl(e)) {
            a.columns = c;
          }
        }
        if (Cl(e)) {
          ...
          if (e[l] !== undefined) {
            if (l === 'spacing') {
              ...
              a[l] = (0, r.Et)(n)
                ? n
                : {
                    row: (i = n.row) !== null && i !== void 0 ? i : u,
                    column: (s = n.column) !== null && s !== void 0 ? s : u
                  };
            } else {
              a[l] = e[l];
            }
      ...
      function Ul(e, n) {
        ...
        return X(i, { step: e.step });
      }
      const Rl = 20;
      const Il = { continuousWidth: 200, continuousHeight: 200, step: Rl };
      function Wl(e) {
        return e && !!e['scheme'];
      }
      const Hl = {
      ...
      function Vl(e = {}) {
        return {
          signals: [
            {
              name: 'color',
              value: (0, r.Gv)(e) ? Object.assign(Object.assign({}, Kl), e) : Kl
            }
          ],
      ...
      function Ql(e) {
        return {
          signals: [
            {
              name: 'fontSize',
              value: (0, r.Gv)(e) ? Object.assign(Object.assign({}, Yl), e) : Yl
            }
          ],
      ...
      function nf(e = {}) {
        const { color: n, font: t, fontSize: i, selection: s } = e,
          o = Ml(e, ['color', 'font', 'fontSize', 'selection']);
        const a = (0, r.io)(
          {},
          b(Hl),
          t ? Xl(t) : {},
        ...
        if (s) {
          (0, Rs.writeConfig)(a, 'selection', s, true);
        }
        const u = O(a, ef);
      ...
      function of(e) {
        ...
        if (e.mark) {
          ...
          if (e.mark.tooltip && (0, r.Gv)(e.mark.tooltip)) {
            delete e.mark.tooltip;
          }
        }
        if (e.params) {
          e.signals = (e.signals || []).concat(Dl(e.params));
          delete e.params;
        }
        for (const n of tf) {
          for (const i of ca) {
        ...
        return z(e) ? undefined : e;
      }
      function af(e) {
        const {
          titleMarkConfig: n,
          subtitleMarkConfig: t,
          subtitle: i
        } = zt(e.title);
        if (!z(n)) {
      ...
      function ff(e) {
        return !(0, r.cy)(e.repeat) && e.repeat['layer'];
      }
      var df =
        (undefined && undefined.__rest) ||
        function (e, n) {
      ...
      const hf = new Set([Lo, Uo, qo, Go, Wo, Qo, Xo, Io, Yo, Ko]);
      const bf = new Set([Uo, qo, Lo]);
      function yf(e) {
        return fu(e) && du(e) === 'quantitative' && !e.bin;
      }
      function vf(e, n) {
        var t, i;
        ...
        if (fu(s) && fu(o)) {
          if (yf(s) && yf(o)) {
            ...
            const e = fu(s) && !!s.aggregate;
            const a = fu(o) && !!o.aggregate;
            if (e !== a) {
              return e ? n : r;
            } else {
              const e =
                (t = s.scale) === null || t === void 0 ? void 0 : t.type;
              const a =
                (i = o.scale) === null || i === void 0 ? void 0 : i.type;
              if (e && e !== 'linear') {
                return r;
              } else if (a && a !== 'linear') {
                return n;
      ...
      function xf(e, n) {
        ...
        const a = n[o];
        const u = fu(a) ? Du(a, {}) : undefined;
        const c = Of(o);
        const l = [];
        const f = new Set();
        if (n[c]) {
          const e = n[c];
          const t = fu(e) ? Du(e, {}) : undefined;
          if (t && t !== u) {
            l.push(c);
            f.add(t);
          }
          const i = c === 'x' ? 'xOffset' : 'yOffset';
          const r = n[i];
          const s = fu(r) ? Du(r, {}) : undefined;
          if (s && s !== u) {
            l.push(i);
            f.add(s);
          }
        }
        const d = Ln.reduce((e, t) => {
          if (t !== 'tooltip' && gc(n, t)) {
            const i = n[t];
            for (const n of (0, r.YO)(i)) {
              const i = Uu(n);
              if (i.aggregate) {
                continue;
              }
        ...
        if (
          ((t = a === null || a === void 0 ? void 0 : a.scale) === null ||
          t === void 0
            ? void 0
            : t.type) &&
          ((i = a === null || a === void 0 ? void 0 : a.scale) === null ||
          i === void 0
            ? void 0
            : i.type) !== no.LINEAR
        ) {
        ...
        if (fu(a) && a.aggregate && !Ft.has(a.aggregate)) {
          Vr(Cr(a.aggregate));
        }
        return {
          groupbyChannels: l,
          groupbyFields: f,
          fieldChannel: o,
          impute: a.impute === null ? false : ea(s),
          stackBy: d,
          offset: p
        };
      }
      ...
      function $f(e, n = {}, t) {
        if (e.point === 'transparent') {
          ...
          return (0, r.Gv)(e.point) ? e.point : {};
        } else if (e.point !== undefined) {
          return null;
        } else {
          if (n.point || t.shape) {
            return (0, r.Gv)(n.point) ? n.point : {};
          }
          return undefined;
        }
      }
      ...
      class Af {
        ...
        hasMatchingType(e, n) {
          if (fc(e)) {
            ...
            switch (r.type) {
              ...
              case 'rule':
              case 'trail':
                return !!$f(r, n[r.type], i);
              case 'area':
                return !!$f(r, n[r.type], i) || !!Df(r, n[r.type]);
            }
          }
          return false;
        }
        run(e, n, t) {
          ...
          const { params: r, projection: s, mark: o, encoding: a } = e,
            u = wf(e, ['params', 'projection', 'mark', 'encoding']);
          const c = xc(a, i);
          const l = ia(o) ? o : { type: o };
          const f = $f(l, i[l.type], c);
          const d = l.type === 'area' && Df(l, i[l.type]);
          const p = [
            ...
            p.push(
              Object.assign(Object.assign({}, s ? { projection: s } : {}), {
                mark: Object.assign(
                  Object.assign(
                    { type: 'line' },
                    v(l, ['clip', 'interpolate', 'tension', 'tooltip'])
                  ),
                  d
                ),
                encoding: m
          ...
          return t(
            ...
            Object.assign(Object.assign({}, n), { config: Ff(i) })
          );
        }
      }
      var kf =
        ...
        run(e, n, t) {
          ...
          return t(
            Object.assign(Object.assign({}, e), {
              mark: (0, r.Gv)(s)
                ? Object.assign(Object.assign({}, s), { type: 'rule' })
                : 'rule'
            }),
            n
          );
      ...
      class Mf extends pf {
        constructor() {
          super(...arguments);
          this.nonFacetUnitNormalizers = [Mc, Gc, il, new Af(), new Nf()];
        }
        map(e, n) {
          if (fc(e)) {
            const t = gc(e.encoding, oe);
            const i = gc(e.encoding, ae);
            const r = gc(e.encoding, ue);
            if (t || i || r) {
        ...
        mapUnit(e, n) {
          ...
          const r = Sf(e.encoding, n.repeater);
          const s = Object.assign(
            Object.assign({}, e),
            r ? { encoding: r } : {}
          );
          ...
          if (s || o) {
            ...
            return Object.assign(Object.assign({}, r), {
              layer: a.map((e) => {
                ...
                const r = `${(i.name || '') + c}child__layer_${q(e)}`;
        ...
        mapNonLayerRepeat(e, n) {
          ...
          const { repeat: i, spec: s, data: o } = e,
            a = Tf(e, ['repeat', 'spec', 'data']);
          if (!(0, r.cy)(i) && e.columns) {
            e = O(e, ['columns']);
            Vr(Ci('repeat'));
          }
          const u = [];
          const { repeater: c = {}, repeaterPrefix: l = '' } = n;
          const f = (!(0, r.cy)(i) && i.row) || [c ? c.row : null];
          const d = (!(0, r.cy)(i) && i.column) || [c ? c.column : null];
          const p = ((0, r.cy)(i) && i) || [c ? c.repeat : null];
          for (const m of p) {
            for (const e of f) {
              for (const t of d) {
                const o = { repeat: m, row: e, column: t, layer: c.layer };
                const a =
                  (s.name || '') +
                  l +
                  'child__' +
          ...
          const g = (0, r.cy)(i) ? e.columns : i.column ? i.column.length : 1;
          return Object.assign(
            Object.assign(
              {
                data: (t = s.data) !== null && t !== void 0 ? t : o,
                align: 'all'
              },
              a
            ),
        ...
        mapUnitWithParentEncodingOrProjection(e, n) {
          ...
          const a = qf({ parentProjection: s, projection: i });
          const u = Lf({ parentEncoding: r, encoding: Sf(t, n.repeater) });
          return this.mapUnit(
            Object.assign(
        ...
        getFacetMappingAndLayout(e, n) {
          ...
          if (i || r) {
            ...
            for (const i of [oe, ae]) {
              ...
              if (r) {
                const { align: e, center: s, spacing: a, columns: u } = r,
                  c = Tf(r, ['align', 'center', 'spacing', 'columns']);
                n[i] = c;
            ...
            const { align: e, center: t, spacing: i, columns: r } = s,
              o = Tf(s, ['align', 'center', 'spacing', 'columns']);
            return {
              facetMapping: Cf(o, n.repeater),
        ...
        mapLayer(e, n) {
          var { parentEncoding: t, parentProjection: i } = n,
            r = Tf(n, ['parentEncoding', 'parentProjection']);
          const { encoding: s, projection: o } = e,
            a = Tf(e, ['encoding', 'projection']);
          const u = Object.assign(Object.assign({}, r), {
            parentEncoding: Lf({ parentEncoding: t, encoding: s, layer: true }),
            parentProjection: qf({ parentProjection: i, projection: o })
          });
          return super.mapLayer(a, u);
        }
      }
      function Lf({ parentEncoding: e, encoding: n = {}, layer: t }) {
        let i = {};
        if (e) {
          const s = new Set([...N(e), ...N(n)]);
          for (const o of s) {
            const s = n[o];
            const a = e[o];
            if (bu(s)) {
              ...
              i[o] = Object.assign(Object.assign({}, s), {
                condition: Object.assign(Object.assign({}, a), s.condition)
              });
            } else if (s || s === null) {
              i[o] = s;
            } else if (t || vu(a) || Tt(a) || bu(a) || (0, r.cy)(a)) {
              i[o] = a;
            }
          }
        } else {
        ...
        return !i || z(i) ? undefined : i;
      }
      function qf(e) {
        const { parentProjection: n, projection: t } = e;
        if (n && t) {
          Vr(Ti({ parentProjection: n, projection: t }));
        }
          ...
          if (i) {
            return Object.assign(Object.assign({}, r), {
              params: M(i).map(([e, t]) => {
                ...
                for (const c of T(
                  (i = n.selectionPredicates[e]) !== null && i !== void 0
                    ? i
                    : {}
                )) {
                  c.empty = a !== 'none';
      ...
      function dd(e, n) {
        ...
        if (
          Ou(r) &&
          ((i = (t = r.scale) === null || t === void 0 ? void 0 : t.domain) ===
            null || i === void 0
            ? void 0
            : i.selection)
        ) {
        ...
        if (au(r)) {
          if ((0, Rs.isArray)(r.condition)) {
            r.condition = r.condition.map((e) => {
              const { selection: t, param: i, test: r } = e,
                s = cd(e, ['selection', 'param', 'test']);
              return i
                ? e
                : Object.assign(Object.assign({}, s), { test: gd(e, n) });
            });
          } else {
            const e = dd(r.condition, n),
              { selection: t, param: i, test: s } = e,
              o = cd(e, ['selection', 'param', 'test']);
            r.condition = i
              ? r.condition
              : Object.assign(Object.assign({}, o), {
                  test: gd(r.condition, n)
                });
          }
        }
        return r;
      ...
      function gd(e, n) {
        const t = (e) =>
          m(e, (e) => {
            ...
            var r;
            const s =
              (t = n.emptySelections[e]) !== null && t !== void 0 ? t : true;
        ...
        return e.selection
          ? t(e.selection)
          : m(e.test || e.filter, (e) => (e.selection ? t(e.selection) : e));
      }
      class md extends pf {
        map(e, n) {
          var t;
        ...
        mapUnit(e, n) {
          ...
          const r = ((t = n.path) !== null && t !== void 0 ? t : []).concat(
            e.name
          );
          const s = [];
          for (const o of i) {
      ...
      for (const Yw of [
        ...
        const e = md.prototype[Yw];
        md.prototype[Yw] = function (n, t) {
      ...
      function hd(e, n) {
        ...
        return e.name
          ? Object.assign(Object.assign({}, n), {
              path: ((t = n.path) !== null && t !== void 0 ? t : []).concat(
                e.name
              )
            })
          : n;
      ...
      function bd(e, n) {
        ...
        const s = jd(t, { width: i, height: r, autosize: e.autosize }, n);
      ...
      function wd(e) {
        return (0, r.Kg)(e) ? { type: e } : e !== null && e !== void 0 ? e : {};
      }
      function jd(e, n, t) {
      ...
      function $d(e) {
        return e ? `fit-${Hn(e)}` : 'fit';
      }
      const Dd = ['background', 'padding'];
      function Ad(e, n) {
        const t = {};
        for (const i of Dd) {
          if (e && e[i] !== undefined) {
      ...
      class kd {
        ...
        clone() {
          return new kd(b(this.explicit), b(this.implicit));
        }
        combine() {
          return Object.assign(Object.assign({}, this.explicit), this.implicit);
        }
        get(e) {
          return X(this.explicit[e], this.implicit[e]);
        }
        getWithExplicit(e) {
      ...
      function Td(e) {
        return 'name' in e && !zd(e) && !Nd(e) && !Md(e);
      }
      function Md(e) {
        return e && (Ld(e) || qd(e) || Ud(e));
      }
      function Ld(e) {
      ...
      function Hd(e, n = true, t = r.D_) {
        if ((0, r.cy)(e)) {
          const i = e.map((e) => Hd(e, n, t));
          return n ? `[${i.join(', ')}]` : i;
        } else if (Jr(e)) {
          if (n) {
            return t(as(e));
      ...
      function Gd(e, n) {
        ...
        for (const i of T(
          ...
          const t = i.name;
          let s = `${t}${Sg}, ${i.resolve === 'global' ? 'true' : `{unit: ${Ng(e)}}`}`;
          for (const r of _g) {
          ...
          n.push({
            ...
            on: [
              {
                events: { signal: i.name + Sg },
                update: `modify(${(0, r.r$)(i.name + Cg)}, ${s})`
              }
            ]
          });
        }
      ...
      function Yd(e, n) {
        if (e.component.selection && N(e.component.selection).length) {
          const t = (0, r.r$)(e.getName('cell'));
          n.unshift({
            name: 'facet',
            value: {},
            on: [
              {
                events: (0, Id.P)('mousemove', 'scope'),
      ...
      function Kd(e, n) {
        ...
        for (const s of T(
          ...
          if (a.length === 0) {
            ...
            n.push({ name: s.name, update: `${Pg}(${o}, ${(0, r.r$)(e)}${t}` });
          }
          i = true;
          for (const i of _g) {
      ...
      function Vd(e, n) {
        var t;
        const i = [...n];
        const r = Ng(e, { escape: false });
        for (const s of T(
          (t = e.component.selection) !== null && t !== void 0 ? t : {}
        )) {
          const e = { name: s.name + Cg };
          if (s.project.hasSelectionId) {
            e.transform = [{ type: 'collect', sort: { field: Ol } }];
          }
          if (s.init) {
            ...
            e.values = s.project.hasSelectionId
              ? s.init.map((e) => ({ unit: r, [Ol]: Hd(e, false)[0] }))
              : s.init.map((e) => ({
                  unit: r,
                  fields: n,
                  values: Hd(e, false)
          ...
          const n = i.filter((e) => e.name === s.name + Cg);
          if (!n.length) {
            i.push(e);
          }
        }
      ...
      function Jd(e, n, t, i) {
        const s = tb(e, n.param, n);
        return {
          signal:
            ho(t.get('type')) && (0, r.cy)(i) && i[0] > i[1]
              ? `isValid(${s}) && reverse(${s})`
              : s
        };
      }
      ...
      class ip extends ep {
        ...
        static makeFromEncoding(e, n) {
          const t = n.reduceFieldDef((e, n) => {
            ...
            if (i) {
              const r = Du(n, { forAs: true });
              e[w({ as: r, field: t, timeUnit: i })] = {
                as: r,
                field: t,
                timeUnit: i
              };
        ...
        removeFormulas(e) {
          const n = {};
          for (const [t, i] of M(this.formula)) {
            if (!e.has(i.as)) {
              n[t] = i;
            }
          }
        ...
        producedFields() {
          return new Set(T(this.formula).map((e) => e.as));
        }
        dependentFields() {
          return new Set(T(this.formula).map((e) => e.field));
        }
        hash() {
      ...
      const ap = {
        ...
        parse: (e, n, t) => {
          ...
          const p = t.value !== undefined ? (0, r.YO)(t.value) : null;
          let { fields: g, encodings: m } = (0, r.Gv)(t.select) ? t.select : {};
          if (!g && !m && p) {
            for (const e of p) {
              if (!(0, r.Gv)(e)) {
                continue;
          ...
          for (const r of m !== null && m !== void 0 ? m : []) {
            ...
            if (n) {
              ...
              if (!a[t]) {
                ...
                o.hasSelectionId = o.hasSelectionId || t === Ol;
              }
            } else {
              Vr(bi(r));
            }
          ...
          for (const r of g !== null && g !== void 0 ? g : []) {
            ...
            e.signals = Object.assign({}, l(e, 'data'));
            o.items.push(e);
            o.hasField[r] = e;
            o.hasSelectionId = o.hasSelectionId || r === Ol;
          }
          if (p) {
            n.init = p.map((e) =>
              o.items.map((n) =>
                (0, r.Gv)(e)
                  ? e[n.channel] !== undefined
                    ? e[n.channel]
                    : e[n.field]
                  : e
              )
      ...
      const cp = {
        ...
        topLevelSignals: (e, n, t) => {
          ...
          let o = s.update;
          if (o.indexOf(Pg) >= 0) {
            s.update = `{${i.map((e) => `${(0, r.r$)(Y(e.field))}: ${e.signals.data}`).join(', ')}}`;
          } else {
            for (const e of i) {
              const n = `${(0, r.r$)(Y(e.field))}: ${e.signals.data}`;
              if (!o.includes(n)) {
      ...
      function dp(e) {
        ...
        return (
          e.parent &&
          tx(e.parent) &&
          ((n = !e.parent.parent) !== null && n !== void 0
            ? n
            : dp(e.parent.parent))
        );
      }
      ...
      const hp = {
        ...
        signals: (e, n, t) => {
          const i = n.name;
          const s = i + sp;
          const o = lp.defined(n);
          const a = n.init ? n.init[0] : null;
          const u = [];
          const c = [];
          if (n.translate && !o) {
            const e = `!event.item || event.item.mark.name !== ${(0, r.r$)(i + gp)}`;
            vp(n, (n, t) => {
              var i;
              var s;
              const o = (0, r.YO)(
                (i = (s = t.between[0]).filter) !== null && i !== void 0
                  ? i
                  : (s.filter = [])
              );
              if (!o.includes(e)) {
          ...
          n.project.items.forEach((i, s) => {
            ...
            c.push({
              ...
              expr:
                `(!isArray(${d}) || ` +
                `(${h}invert(${g}, ${p})[0] === ${h}${d}[0] && ` +
                `${h}invert(${g}, ${p})[1] === ${h}${d}[1]))`
            });
          });
          if (!o && c.length) {
            t.push({
              ...
              on: [
                {
                  events: c.map((e) => ({ scale: e.scaleName })),
                  update: `${c.map((e) => e.expr).join(' && ')} ? ${i + mp} : {}`
                }
              ]
            });
          }
          const l = `unit: ${Ng(e)}, fields: ${s}, values`;
          return t.concat(
            Object.assign(
              Object.assign(
                { name: i + Sg },
        ...
        marks: (e, n, t) => {
          ...
          const u = o === null || o === void 0 ? void 0 : o.signals.visual;
          const c = `data(${(0, r.r$)(n.name + Cg)})`;
          if (lp.defined(n) || (!s && !o)) {
            return t;
          }
          const l = {
            x: s !== undefined ? { signal: `${a}[0]` } : { value: 0 },
            y: o !== undefined ? { signal: `${u}[0]` } : { value: 0 },
            x2:
              s !== undefined
                ? { signal: `${a}[1]` }
                : { field: { group: 'width' } },
          ...
          return [
            {
              ...
              clip: true,
              encode: {
                enter: { fill: { value: d }, fillOpacity: { value: p } },
                update: l
              }
            },
            ...t,
            {
              ...
              encode: {
                enter: Object.assign(
                  Object.assign({}, g ? { cursor: { value: g } } : {}),
                  { fill: { value: 'transparent' } }
                ),
                update: Object.assign(Object.assign({}, l), h)
              }
            }
          ];
        }
      ...
      function yp(e, n, t, i) {
        ...
        const u = lp.defined(n);
        const c = (0, r.r$)(e.scaleName(s));
        const l = e.getScaleComponent(s);
        const f = l ? l.get('type') : undefined;
        const d = (e) => `scale(${c}, ${e})`;
        const p = e.getSizeSignalRef(s === ce ? 'width' : 'height').signal;
        const g = `${s}(unit)`;
        const m = vp(n, (e, n) => [
          ...e,
          { events: n.between[0], update: `[${g}, ${g}]` },
          { events: n, update: `[${o}[0], clamp(${g}, 0, ${p})]` }
        ]);
        m.push({
          events: { signal: n.name + mp },
          update: ho(f) ? `[${d(`${a}[0]`)}, ${d(`${a}[1]`)}]` : `[0, 0]`
        });
        return u
          ? [{ name: a, on: [] }]
          : [
              Object.assign(
                Object.assign(
                  { name: o },
                  i ? { init: Hd(i, true, d) } : { value: [] }
                ),
                { on: m }
              ),
              Object.assign(
                Object.assign({ name: a }, i ? { init: Hd(i) } : {}),
                {
                  on: [
                    {
                      events: { signal: o },
                      update: `${o}[0] === ${o}[1] ? null : invert(${c}, ${o})`
                    }
                  ]
                }
              )
      ...
      const Op = {
        ...
        signals: (e, n, t) => {
          ...
          const o = s + sp;
          const a = n.project;
          const u = '(item().isVoronoi ? datum.datum : datum)';
          const c = T(
            (i = e.component.selection) !== null && i !== void 0 ? i : {}
          )
            .reduce(
              (e, n) => (n.type === 'interval' ? e.concat(n.name + gp) : e),
              []
            )
            .map((e) => `indexof(item().mark.name, '${e}') < 0`)
            .join(' && ');
          const l = `datum && item().mark.marktype !== 'group' && indexof(item().mark.role, 'legend') < 0${c ? ` && ${c}` : ''}`;
          let f = `unit: ${Ng(e)}, `;
            ...
            const n = a.items
              .map((n) => {
                ...
                return (t === null || t === void 0 ? void 0 : t.bin)
                  ? `[${u}[${(0, r.r$)(e.vgField(n.channel, {}))}], ` +
                      `${u}[${(0, r.r$)(e.vgField(n.channel, { binSuffix: 'end' }))}]]`
                  : `${u}[${(0, r.r$)(n.field)}]`;
              })
              .join(', ');
            f += `fields: ${o}, values: [${n}]`;
          ...
          return t.concat([
            {
              name: s + Sg,
              on: d
                ? [{ events: d, update: `${l} ? {${f}} : null`, force: true }]
                : []
            }
          ]);
        }
      ...
      function jp(e, n = 'text') {
        const t = e.encoding[n];
        return wp(e, t, n, (n) => Fp(n, e.config));
      }
      function Fp(e, n, t = 'datum') {
        if (e) {
          if (vu(e)) {
            return Xt(e.value);
          }
          if (bu(e)) {
            const { format: i, formatType: r } = Lu(e);
            return Pa({
              fieldOrDatumDef: e,
              format: i,
              formatType: r,
      ...
      function $p(e, n = {}) {
        ...
        const a = t.tooltip;
        if ((0, r.cy)(a)) {
          return { tooltip: Ap({ tooltip: a }, o, s, n) };
        } else {
          const u = n.reactiveGeom ? 'datum.datum' : 'datum';
          return wp(e, a, 'tooltip', (e) => {
            const a = Fp(e, s, u);
            if (a) {
              return a;
            }
      ...
      function Dp(e, n, t, { reactiveGeom: i } = {}) {
        ...
        function u(i, u) {
          ...
          const l = yu(i)
            ? i
            : Object.assign(Object.assign({}, i), { type: e[c].type });
          const f = l.title || Mu(l, t);
          const d = (0, r.YO)(f).join(', ');
          let p;
          if (Rn(u)) {
            const n = u === 'x' ? 'x2' : 'y2';
            const i = Uu(e[n]);
            if (kt(l.bin) && i) {
              const e = Du(l, { expr: o });
              const r = Du(i, { expr: o });
              const { format: a, formatType: u } = Lu(l);
              p = Ra(e, r, a, u, t);
              s[n] = true;
            }
          }
          if (
            ...
            const { format: e, formatType: n } = Lu(l);
            p = Pa({
              fieldOrDatumDef: l,
              format: e,
              formatType: n,
          ...
          p !== null && p !== void 0 ? p : (p = Fp(l, t, o).signal);
          a.push({ channel: u, key: d, value: p });
        }
        jc(e, (e, n) => {
          if (fu(e)) {
            u(e, n);
        ...
        const c = {};
        for (const { channel: r, key: l, value: f } of a) {
          if (!s[r] && !c[l]) {
            c[l] = f;
          }
        }
      ...
      function Ap(e, n, t, { reactiveGeom: i } = {}) {
        const r = Dp(e, n, t, { reactiveGeom: i });
        const s = M(r).map(([e, n]) => `"${e}": ${n}`);
      ...
      function kp(e) {
        ...
        return Object.assign(
          Object.assign(Object.assign({}, i ? { aria: i } : {}), Cp(e)),
          Sp(e)
        );
      }
      function Cp(e) {
        ...
        return n in Wt ? {} : { ariaRoleDescription: { value: n } };
      }
      function Sp(e) {
        const { encoding: n, markDef: t, config: i, stack: r } = e;
        const s = n.description;
        if (s) {
          return wp(e, s, 'description', (n) => Fp(n, e.config));
        }
        const o = ii('description', t, i);
        if (o != null) {
          return { description: Xt(o) };
        }
        if (i.aria === false) {
          return {};
        }
      ...
      function Ep(e, n, t = {}) {
        ...
        if (a === undefined) {
          u !== null && u !== void 0
            ? u
            : (u = ii(e, i, s, { vgChannel: o, ignoreVgConfig: true }));
          if (u !== undefined) {
            a = Xt(u);
          }
        }
        const c = r[e];
        return wp(n, c, o !== null && o !== void 0 ? o : e, (t) =>
          ka({
            channel: e,
            channelDef: t,
            markDef: i,
      ...
      function Bp(e, n = { filled: undefined }) {
        var t, i, r, s;
        const { markDef: o, encoding: a, config: u } = e;
        const { type: c } = o;
        const l =
          (t = n.filled) !== null && t !== void 0 ? t : ii('filled', o, u);
        const f = F(['bar', 'point', 'circle', 'square', 'geoshape'], c)
          ? 'transparent'
          : undefined;
        const d =
          (r =
            (i = ii(l === true ? 'color' : undefined, o, u, {
              vgChannel: 'fill'
            })) !== null && i !== void 0
              ? i
            ...
            : f;
        const p =
          (s = ii(l === false ? 'color' : undefined, o, u, {
            vgChannel: 'stroke'
          })) !== null && s !== void 0
            ? s
        ...
        const m = Object.assign(
          Object.assign({}, d ? { fill: Xt(d) } : {}),
          p ? { stroke: Xt(p) } : {}
        );
        if (o.color && (l ? o.fill : o.stroke)) {
          Vr(Gi('property', { fill: 'fill' in o, stroke: 'stroke' in o }));
        }
        return Object.assign(
          Object.assign(
            Object.assign(
              Object.assign({}, m),
              Ep('color', e, { vgChannel: g, defaultValue: l ? d : p })
            ),
            Ep('fill', e, { defaultValue: a.fill ? d : undefined })
          ),
          Ep('stroke', e, { defaultValue: a.stroke ? p : undefined })
        );
      }
      function Pp(e) {
        const { encoding: n, mark: t } = e;
        const i = n.order;
        if (!ea(t) && vu(i)) {
          return wp(e, i, 'zindex', (e) => Xt(e.value));
        }
        return {};
      }
      function _p({
        ...
        const u = n[s];
        if (u) {
          return { offsetType: 'visual', offset: u };
        }
        return {};
      }
      function zp(e, n, { defaultPos: t, vgChannel: i }) {
        const { encoding: r, markDef: s, config: o, stack: a } = n;
        const u = r[e];
        const c = r[yn(e)];
        const l = n.scaleName(e);
        const f = n.getScaleComponent(e);
        const { offset: d, offsetType: p } = _p({
          channel: e,
          markDef: s,
          encoding: r,
          model: n,
      ...
      function Np(e) {
        ...
        if (bu(t) && r && n === r.fieldChannel) {
          ...
          return Da(t, i, { suffix: 'end' }, { offset: s });
        }
        return xa(e);
      }
      function Tp({
      ...
      const Mp = { left: 'x', center: 'xc', right: 'x2' };
      const Lp = { top: 'y', middle: 'yc', bottom: 'y2' };
      function qp(e, n, t, i = 'middle') {
        if (e === 'radius' || e === 'theta') {
          return bn(e);
        }
        ...
        if (e === 'x') {
          return Mp[o || (i === 'top' ? 'left' : 'center')];
        } else {
          return Lp[o || i];
        }
      }
      function Up(e, n, { defaultPos: t, defaultPos2: i, range: r }) {
        if (r) {
          return Rp(e, n, { defaultPos: t, defaultPos2: i });
        }
        return zp(e, n, { defaultPos: t });
      }
      function Rp(e, n, { defaultPos: t, defaultPos2: i }) {
        const { markDef: r, config: s } = n;
        const o = yn(e);
        const a = vn(e);
        const u = Ip(n, i, o);
        const c = u[a] ? qp(e, r, s) : bn(e);
        return Object.assign(
          Object.assign({}, zp(e, n, { defaultPos: t, vgChannel: c })),
          u
        );
      }
      function Ip(e, n, t) {
        ...
        const { offset: g } =
          t in i || t in s
            ? _p({ channel: t, markDef: s, encoding: i, model: e })
            : _p({ channel: u, markDef: s, encoding: i, model: e });
        ...
        return (
          Hp(t, s) ||
          Hp(t, { [t]: si(t, s, a.style), [c]: si(c, s, a.style) }) ||
          Hp(t, a[r]) ||
          Hp(t, a.mark) || {
            [l]: Tp({
              model: e,
      ...
      function Wp({
        ...
        if (bu(n) && a && e.charAt(0) === a.fieldChannel.charAt(0)) {
          return Da(n, s, { suffix: 'start' }, { offset: u });
        }
        return xa({
          channel: e,
          channelDef: t,
      ...
      function Gp(e, n) {
        ...
        const g = o.orient;
        const m =
          (i = (t = s[c]) !== null && t !== void 0 ? t : s.size) !== null &&
          i !== void 0
            ? i
            : ii('size', o, r, { vgChannel: c });
        const h =
          a === 'bar' && (n === 'x' ? g === 'vertical' : g === 'horizontal');
        if (
          fu(l) &&
          (At(l.bin) || kt(l.bin) || (l.timeUnit && !f)) &&
          !(m && !ga(m)) &&
          !mo(p)
        ) {
          return Qp({ fieldDef: l, fieldDef2: f, channel: n, model: e });
        } else if (((bu(l) && mo(p)) || h) && !f) {
          return Kp(l, n, e);
        } else {
          return Rp(n, e, {
      ...
      function Kp(e, n, t) {
        ...
        const u = i.orient;
        const c = t.scaleName(n);
        const l = t.getScaleComponent(n);
        const f = vn(n);
        const d = yn(n);
        const p = On(n);
        const g = t.scaleName(p);
        const m =
          (u === 'horizontal' && n === 'y') || (u === 'vertical' && n === 'x');
        let h;
        if (s.size || i.size) {
          if (m) {
            h = Ep('size', t, { vgChannel: f, defaultRef: Xt(i.size) });
          } else {
            Vr(dr(i.type));
          }
        }
        ...
        const y = su({
          ...
          markDef: i,
          config: o,
          scaleType: l === null || l === void 0 ? void 0 : l.get('type'),
          useVlSizeChannel: m
        });
        h = h || { [f]: Yp(f, g || c, l, o, y) };
        const v =
          (l === null || l === void 0 ? void 0 : l.get('type')) === 'band' &&
          ga(y) &&
          !b
            ? 'top'
            : 'middle';
        const O = qp(n, i, o, v);
        const x = O === 'xc' || O === 'yc';
        const { offset: w, offsetType: j } = _p({
          channel: n,
          markDef: i,
          encoding: s,
          model: t,
        ...
        if (f) {
          return Object.assign({ [O]: F }, h);
        } else {
          const e = bn(d);
          const n = h[f];
          const t = w ? Object.assign(Object.assign({}, n), { offset: w }) : n;
          return {
            [O]: F,
            [e]: (0, r.cy)(F)
              ? [F[0], Object.assign(Object.assign({}, F[1]), { offset: t })]
              : Object.assign(Object.assign({}, F), { offset: t })
          };
        }
      }
      ...
      function Qp({ fieldDef: e, fieldDef2: n, channel: t, model: i }) {
        var r, s, o;
        const { config: a, markDef: u, encoding: c } = i;
        const l = i.getScaleComponent(t);
        const f = i.scaleName(t);
        const d = l ? l.get('type') : undefined;
        const p = l.get('reverse');
        const g = su({
          channel: t,
          fieldDef: e,
          markDef: u,
        ...
        const m =
          (r = i.component.axes[t]) === null || r === void 0 ? void 0 : r[0];
        const h =
          (s = m === null || m === void 0 ? void 0 : m.get('translate')) !==
            null && s !== void 0
            ? s
            : 0.5;
        const b = Rn(t)
          ? (o = ii('binSpacing', u, a)) !== null && o !== void 0
            ? o
            : 0
          : 0;
        const y = yn(t);
        ...
        if (At(e.bin) || e.timeUnit) {
          return {
            ...
            [v]: Xp({
              fieldDef: e,
              scaleName: f,
              bandPosition: Tt(w) ? { signal: `1-${w.signal}` } : 1 - w,
              offset: Vp(t, b, p, h, x)
            })
          };
        } else if (kt(e.bin)) {
          const i = Da(e, f, {}, { offset: Vp(y, b, p, h, x) });
          if (fu(n)) {
            return { [O]: i, [v]: Da(n, f, {}, { offset: Vp(t, b, p, h, x) }) };
          } else if (Ct(e.bin) && e.bin.step) {
            return {
              [O]: i,
              [v]: {
                signal: `scale("${f}", ${Du(e, { expr: 'datum' })} + ${e.bin.step})`,
                offset: Vp(t, b, p, h, x)
              }
            };
          }
      ...
      function Xp({ fieldDef: e, scaleName: n, bandPosition: t, offset: i }) {
        return Aa({
          scaleName: n,
          fieldOrDatumDef: e,
          bandPosition: t,
      ...
      const Jp = new Set(['aria', 'width', 'height']);
      function Zp(e, n) {
        const { fill: t = undefined, stroke: i = undefined } =
          n.color === 'include' ? Bp(e) : {};
        return Object.assign(
          Object.assign(
            Object.assign(
              Object.assign(
      ...
      function eg(e, n, t) {
        ...
        if (a === 'hide' && t && !ea(s)) {
          const i = tg(e, { invalid: true, channels: ut });
          if (i) {
            return { [n]: [{ test: i, value: null }, ...(0, r.YO)(t)] };
          }
        }
        return t ? { [n]: t } : {};
      }
      function ng(e, n) {
        return It.reduce((t, i) => {
          if (!Jp.has(i) && e[i] !== undefined && n[i] !== 'ignore') {
            t[i] = Xt(e[i]);
          }
          return t;
        }, {});
        ...
        const i = t.reduce((n, t) => {
          ...
          if (r) {
            ...
            const o = e.vgField(t, {
              expr: 'datum',
              binSuffix: (
                (i = e.stack) === null || i === void 0 ? void 0 : i.impute
              )
                ? 'mid'
                : undefined
            });
      ...
      const cg = {
        ...
        topLevelSignals: (e, n, t) => {
          ...
          const u = ug.defined(n)
            ? '(item().isVoronoi ? datum.datum : datum)'
            : 'datum';
          s.items.forEach((e, s) => {
            var c, l;
            const f = q(`${i}_${e.field}`);
                  ...
                  ),
                  {
                    on: n.events
                      ? [
                          {
                            events: n.events,
                            update: `datum && item().mark.marktype !== 'group' ? ${u}[${(0, r.r$)(e.field)}] : null`
                          }
                        ]
                      : [],
                    bind:
                      (l =
                        (c = o[e.field]) !== null && c !== void 0
                          ? c
                          : o[e.channel]) !== null && l !== void 0
                        ? l
                        : o
                  }
                )
        ...
        signals: (e, n, t) => {
          const i = n.name;
          const r = n.project;
          const s = t.filter((e) => e.name === i + Sg)[0];
          const o = i + sp;
          const a = r.items.map((e) => q(`${i}_${e.field}`));
      ...
      const gg = {
        ...
        parse: (e, n) => {
          if (n.clear) {
            n.clear = (0, r.Kg)(n.clear) ? (0, Id.P)(n.clear, 'view') : n.clear;
          }
        },
        topLevelSignals: (e, n, t) => {
          if (lg.defined(n)) {
        ...
        signals: (e, n, t) => {
          ...
          if (n.type === 'interval') {
            ...
            let e = t.findIndex((e) => e.name === n.name + Sg);
            i(e, 'null');
            if (pg.defined(n)) {
      ...
      const hg = {
        defined: (e) => {
          const n = e.resolve === 'global' && e.bind && wl(e.bind);
          const t =
            e.project.items.length === 1 && e.project.items[0].field !== Ol;
          if (n && !t) {
            Vr(ji);
          }
          return n && t;
        ...
        parse: (e, n, t) => {
          var i;
          const s = b(t);
          s.select = (0, r.Kg)(s.select)
            ? { type: s.select, toggle: n.toggle }
            : Object.assign(Object.assign({}, s.select), { toggle: n.toggle });
          Mg(n, s);
          if ((0, Rs.isObject)(t.select) && (t.select.on || t.select.clear)) {
            const e =
              'event.item && indexof(event.item.mark.role, "legend") < 0';
            for (const t of n.events) {
              t.filter = (0, r.YO)(
                (i = t.filter) !== null && i !== void 0 ? i : []
              );
          ...
          const o = jl(n.bind) ? n.bind.legend : 'click';
          const a = (0, r.Kg)(o) ? (0, Id.P)(o, 'view') : (0, r.YO)(o);
          n.bind = { legend: { merge: a } };
        },
        topLevelSignals: (e, n, t) => {
          const i = n.name;
          const r = jl(n.bind) && n.bind.legend;
          const s = (e) => (n) => {
            const t = b(n);
            t.markname = e;
            return t;
        ...
        signals: (e, n, t) => {
          const i = n.name;
          const r = n.project;
          const s = t.find((e) => e.name === i + Sg);
          const o = i + sp;
          const a = r.items
            .filter((e) => e.hasLegend)
            .map((e) => q(`${i}_${q(e.field)}_legend`));
          const u = a.map((e) => `${e} !== null`).join(' && ');
          ...
          const l = t.find((e) => e.name === i + fg);
          const f = jl(n.bind) && n.bind.legend;
          if (l) {
            if (!n.events) l.on[0].events = f;
            else
              l.on.push(
                Object.assign(Object.assign({}, l.on[0]), { events: f })
              );
          }
          return t;
        }
      ...
      function yg(e, n, t) {
        var i, r, s, o;
        const a =
          (i = e.fieldDef(n)) === null || i === void 0 ? void 0 : i.field;
        for (const u of T(
          ...
          if (e && hg.defined(u)) {
            const n =
              (o = t.get('selections')) !== null && o !== void 0 ? o : [];
            n.push(u.name);
      ...
      const xg = {
        ...
        signals: (e, n, t) => {
          const i = n.name;
          const r = lp.defined(n);
          const s = i + vg;
          const { x: o, y: a } = n.project.hasChannel;
          let u = (0, Id.P)(n.translate, 'scope');
          if (!r) {
            u = u.map((e) => ((e.between[0].markname = i + gp), e));
          }
          t.push(
            {
              name: s,
              ...
              on: [
                {
                  ...
                  update:
                    '{x: x(unit), y: y(unit)' +
                    (o !== undefined
                      ? `, extent_x: ${r ? fp(e, ce) : `slice(${o.signals.visual})`}`
                      : '') +
                    (a !== undefined
                      ? `, extent_y: ${r ? fp(e, le) : `slice(${a.signals.visual})`}`
                      : '') +
                    '}'
                }
              ]
      ...
      const wg = xg;
      function jg(e, n, t, i, r) {
        var s, o;
        const a = n.name;
        const u = a + vg;
        const c = a + Og;
        const l = t.channel;
        const f = lp.defined(n);
        const d = r.filter(
          (e) => e.name === t.signals[f ? 'data' : 'visual']
        )[0];
      ...
      const Fg = '_zoom_anchor';
      const $g = '_zoom_delta';
      const Dg = {
        defined: (e) => e.type === 'interval' && e.zoom,
        signals: (e, n, t) => {
          const i = n.name;
          const s = lp.defined(n);
          const o = i + $g;
          const { x: a, y: u } = n.project.hasChannel;
          const c = (0, r.r$)(e.scaleName(ce));
          const l = (0, r.r$)(e.scaleName(le));
          let f = (0, Id.P)(n.zoom, 'scope');
          if (!s) {
      ...
      const Ag = Dg;
      function kg(e, n, t, i, r) {
        var s, o;
        const a = n.name;
        const u = t.channel;
        const c = lp.defined(n);
        const l = r.filter(
          (e) => e.name === t.signals[c ? 'data' : 'visual']
        )[0];
        const f = e.getSizeSignalRef(i).signal;
        const d = e.getScaleComponent(u);
        const p = d.get('type');
        const g = c ? fp(e, u) : l.name;
        const m = a + $g;
        const h = `${a}${Fg}.${u}`;
        const b = !c
          ? 'zoomLinear'
      ...
      const Sg = '_tuple';
      const Eg = '_modify';
      const Bg = '_selection_domain_';
      const Pg = 'vlSelectionResolve';
      const _g = [xp, bp, up, pg, lg, lp, bg, mg, wg, Ag, ug];
      function zg(e) {
        let n = e.parent;
        while (n) {
          if (ex(n)) break;
      ...
      function Ng(e, { escape: n } = { escape: true }) {
        let t = n ? (0, r.r$)(e.name) : e.name;
        const i = zg(e);
        if (i) {
          const { facet: e } = i;
          for (const n of Je) {
            if (e[n]) {
              t += ` + '__facet_${n}_' + (facet[${(0, r.r$)(i.vgField(n))}])`;
            }
          }
        }
        return t;
      ...
      function Tg(e) {
        var n;
        return T(
          (n = e.component.selection) !== null && n !== void 0 ? n : {}
        ).reduce((e, n) => e || n.project.hasSelectionId, false);
      }
      function Mg(e, n) {
        if ((0, Rs.isString)(n.select) || !n.select.on) delete e.events;
        if ((0, Rs.isString)(n.select) || !n.select.clear) delete e.clear;
        if ((0, Rs.isString)(n.select) || !n.select.toggle) delete e.toggle;
      }
      const Lg = 'RawCode';
      const qg = 'Literal';
      const Ug = 'Property';
      const Rg = 'Identifier';
      const Ig = 'ArrayExpression';
      const Wg = 'BinaryExpression';
      const Hg = 'CallExpression';
      const Gg = 'ConditionalExpression';
      const Yg = 'LogicalExpression';
      const Kg = 'MemberExpression';
      const Vg = 'ObjectExpression';
      const Qg = 'UnaryExpression';
      function Xg(e) {
        this.type = e;
      }
      Xg.prototype.visit = function (e) {
        let n, t, i;
        if (e(this)) return 1;
        for (n = Jg(this), t = 0, i = n.length; t < i; ++t) {
      ...
      Zg[lm] = 'Punctuator';
      Zg[fm] = 'String';
      Zg[dm] = 'RegularExpression';
      var pm = 'ArrayExpression',
        gm = 'BinaryExpression',
        mm = 'CallExpression',
        hm = 'ConditionalExpression',
        bm = 'Identifier',
        ym = 'Literal',
        vm = 'LogicalExpression',
        Om = 'MemberExpression',
        xm = 'ObjectExpression',
        wm = 'Property',
        jm = 'UnaryExpression';
      var Fm = 'Unexpected token %0',
        $m = 'Unexpected number',
        Dm = 'Unexpected string',
        Am = 'Unexpected identifier',
        km = 'Unexpected reserved word',
        Cm = 'Unexpected end of input',
        Sm = 'Invalid regular expression',
        Em = 'Invalid regular expression: missing /',
        Bm = 'Octal literals are not allowed in strict mode.',
        Pm =
      ...
      function Wm(e) {
        return (
          ...
          (e >= 97 && e <= 122) ||
          e === 92 ||
          (e >= 128 && Nm.test(String.fromCharCode(e)))
        );
      }
      function Hm(e) {
        return (
          ...
          (e >= 48 && e <= 57) ||
          e === 92 ||
          (e >= 128 && Tm.test(String.fromCharCode(e)))
        );
      }
      const Gm = {
        if: 1,
      ...
      function Qm() {
        ...
        if (e === 92) {
          if (em.charCodeAt(nm) !== 117) {
            wh({}, Fm, _m);
          }
          ++nm;
          e = Km('u');
          if (!e || e === '\\' || !Wm(e.charCodeAt(0))) {
            wh({}, Fm, _m);
          }
          n = e;
        }
      ...
      function Xm() {
        ...
        return em.slice(e, nm);
      }
      function Jm() {
        var e, n, t;
        e = nm;
        n = em.charCodeAt(nm) === 92 ? Qm() : Xm();
        if (n.length === 1) {
          t = om;
        } else if (Gm.hasOwnProperty(n)) {
          t = am;
        } else if (n === 'null') {
          t = um;
        ...
        return { type: t, value: n, start: e, end: nm };
      }
      function Zm() {
        var e = nm,
          n = em.charCodeAt(nm),
        ...
        if (o === '>>>=') {
          nm += 4;
          return { type: lm, value: o, start: e, end: nm };
        }
        s = o.substr(0, 3);
        if (s === '>>>' || s === '<<=' || s === '>>=') {
          nm += 3;
          return { type: lm, value: s, start: e, end: nm };
        }
        r = s.substr(0, 2);
        if ((i === r[1] && '+-<>&|'.indexOf(i) >= 0) || r === '=>') {
          nm += 2;
          return { type: lm, value: r, start: e, end: nm };
        }
        if (r === '//') {
          wh({}, Fm, _m);
        }
        if ('<>=!+-*%&|^/'.indexOf(i) >= 0) {
          ++nm;
          return { type: lm, value: i, start: e, end: nm };
        }
        wh({}, Fm, _m);
      }
      function eh(e) {
        ...
        if (Wm(em.charCodeAt(nm))) {
          wh({}, Fm, _m);
        }
        return { type: cm, value: parseInt('0x' + n, 16), start: e, end: nm };
      }
      function nh(e) {
        let n = '0' + em[nm++];
        while (nm < tm) {
        ...
        if (Wm(em.charCodeAt(nm)) || Lm(em.charCodeAt(nm))) {
          wh({}, Fm, _m);
        }
        return {
          type: cm,
      ...
      function th() {
        ...
        if (t !== '.') {
          ...
          if (e === '0') {
            ...
            if (t && Lm(t.charCodeAt(0))) {
              wh({}, Fm, _m);
            }
          }
          while (Lm(em.charCodeAt(nm))) {
            e += em[nm++];
          }
          t = em[nm];
        }
        ...
        return { type: cm, value: parseFloat(e), start: n, end: nm };
      }
      function ih() {
        var e = '',
          n,
          ...
          s = false;
        n = em[nm];
        Mm(n === "'" || n === '"', 'String literal must starts with a quote');
        t = nm;
        ++nm;
        while (nm < tm) {
          i = em[nm++];
              ...
              switch (i) {
                ...
                default:
                  if (Um(i)) {
                    ...
                    if (nm < tm && Um(em[nm])) {
                      s = true;
                      r = r * 8 + '01234567'.indexOf(em[nm++]);
                      if ('0123'.indexOf(i) >= 0 && nm < tm && Um(em[nm])) {
                        r = r * 8 + '01234567'.indexOf(em[nm++]);
                      }
                    }
        ...
        return { type: fm, value: e, octal: s, start: t, end: nm };
      }
      function rh(e, n) {
        let t = e;
        if (n.indexOf('u') >= 0) {
      ...
      function sh() {
        var e, n, t, i, r;
        e = em[nm];
        Mm(e === '/', 'Regular expression literal must start with a slash');
        n = em[nm++];
        t = false;
        i = false;
        while (nm < tm) {
          ...
          if (e === '\\') {
            e = em[nm++];
            if (Im(e.charCodeAt(0))) {
              wh({}, Em);
            }
            n += e;
          } else if (Im(e.charCodeAt(0))) {
            wh({}, Em);
          } else if (t) {
            if (e === ']') {
              t = false;
      ...
      function uh(e) {
        return e.type === om || e.type === am || e.type === rm || e.type === um;
      }
      function ch() {
        Ym();
        if (nm >= tm) {
          return { type: sm, start: nm, end: nm };
        }
        const e = em.charCodeAt(nm);
        if (Wm(e)) {
          return Jm();
      ...
      function wh(e, n) {
        var t,
          ...
          r = n.replace(/%(\d)/g, (e, n) => {
            Mm(n < i.length, 'Message reference must be in range');
            return i[n];
          });
        t = new Error(r);
        t.index = nm;
      ...
      function Fh(e) {
        const n = lh();
        if (n.type !== lm || n.value !== e) {
          jh(n);
        }
      }
      function $h(e) {
        return im.type === lm && im.value === e;
      }
      function Dh(e) {
        return im.type === am && im.value === e;
      }
      function Ah() {
        const e = [];
        nm = im.start;
      ...
      function qh() {
        ...
        if (im.type !== lm && im.type !== am) {
          ...
          n = qh();
          n = xh(e.value, n);
        } else if (Dh('delete') || Dh('void') || Dh('typeof')) {
          throw new Error(zm);
        } else {
          n = Lh();
        }
      ...
      function Jh(e) {
        ...
        const t = new Set();
        n.visit((e) => {
          if (e.type === 'MemberExpression' && Xh(e)) {
            t.add(Qh(e).slice(1).join('.'));
          }
        });
        return t;
      }
      class Zh extends ep {
        clone() {
          return new Zh(null, this.model, b(this.filter));
        }
        constructor(e, n, t) {
          super(e);
          this.model = n;
          this.filter = t;
          this.expr = rb(this.model, this.filter, this);
          this._dependentFields = Jh(this.expr);
        }
        dependentFields() {
      ...
      function eb(e, n) {
        ...
        for (const o of n) {
          const n = q(o.name);
          const a = o.select;
          const u = (0, r.Kg)(a) ? a : a.type;
          const c = (0, r.Gv)(a) ? b(a) : { type: u };
          const l = s[u];
          for (const e in l) {
            ...
            if (e === 'mark') {
              c[e] = Object.assign(Object.assign({}, l[e]), c[e]);
            }
            if (c[e] === undefined || c[e] === true) {
              c[e] = (t = l[e]) !== null && t !== void 0 ? t : c[e];
            }
          }
          const f = (i[n] = Object.assign(Object.assign({}, c), {
            name: n,
            type: u,
            init: o.value,
            bind: o.bind,
      ...
      function nb(e, n, t, i = 'datum') {
        const s = (0, r.Kg)(n) ? n : n.param;
        const o = q(s);
        const a = (0, r.r$)(o + Cg);
        let u;
        try {
          u = e.getSelectionComponent(o, s);
        } catch (p) {
          return `!!${o}`;
        }
        if (u.project.timeUnit) {
          const n = t !== null && t !== void 0 ? t : e.component.data.raw;
          const i = u.project.timeUnit.clone();
          if (n.parent) {
        ...
        const c = u.project.hasSelectionId
          ? 'vlSelectionIdTest('
          : 'vlSelectionTest(';
        const l = u.resolve === 'global' ? ')' : `, ${(0, r.r$)(u.resolve)})`;
        const f = `${c}${a}, ${i}${l}`;
          ...
          if (!e.length || e.length > 1) {
            ...
            Vr(
              (!e.length ? 'No ' : 'Multiple ') +
                `matching ${(0, r.r$)(s)} encoding found for selection ${(0, r.r$)(t.param)}. ` +
                `Using "field": ${(0, r.r$)(o)}.`
            );
          } else {
            o = e[0].field;
      ...
      function ib(e, n) {
        ...
        for (const [i, r] of M(
          ...
          e.component.data.outputNodes[t] = r.materialized = new np(
            new Zh(n, e, { param: i }),
            t,
            Rd.Lookup,
      ...
      function ab(e, n, t, i) {
        ...
        (o = (u = e.encode[n]).update) !== null && o !== void 0
          ? o
          : (u.update = {});
        e.encode[n].update[t] = i;
      }
      function ub(e, n, t, i = { header: false }) {
        var s, o;
        const a = e.combine(),
          {
            disable: u,
        ...
        for (const m in g) {
            ...
            if (s) {
              ...
              const r = [
                ...i.map((e) => {
                  const { test: n } = e,
                    t = sb(e, ['test']);
                  return Object.assign({ test: rb(null, n) }, t);
                }),
                n
              ];
              ab(g, t, e, r);
          ...
          if (F(['labelAlign', 'labelBaseline'], m) && g[m] === null) {
            delete g[m];
          }
        }
        if (n === 'grid') {
          ...
          return Object.assign(Object.assign({ scale: l, orient: c }, g), {
            domain: false,
            labels: false,
            aria: false,
            maxExtent: 0,
          ...
          if (f !== undefined) {
            ...
            if (
              ((o =
                (s = g.encode) === null || s === void 0 ? void 0 : s.labels) ===
                null || o === void 0
                ? void 0
                : o.update) &&
              Tt(g.encode.labels.update.text)
            ) {
              e = K(f, 'datum.label', g.encode.labels.update.text.signal);
            }
            ab(g, 'labels', 'text', { signal: e });
          }
        ...
        return Object.assign.apply(null, [
          ...
          ...e.map((e) => {
            if (e === 'axisOrient') {
              ...
              const o = new Set([...N(r), ...N(s)]);
              const a = {};
              for (const n of o.values()) {
                a[n] = {
                  signal: `${i['signal']} === "${e}" ? ${ei(r[n])} : ${ei(s[n])}`
                };
              }
              return a;
            }
      ...
      function db(e, n, t, i) {
        ...
        const o = Tt(t) ? 'axisOrient' : `axis${I(t)}`;
        const a = [...r, ...r.map((e) => s + e.substr(4))];
        const u = ['axis', o, s];
        return {
          vlOnlyAxisConfig: fb(a, i, e, t),
          vgAxisConfig: fb(u, i, e, t),
          axisConfigStyle: pb([...u, ...a], i)
        };
      }
      function pb(e, n) {
        var t;
      ...
      function gb(e, n, t, i = {}) {
        ...
        for (const o of [
          ...
          if (
            ((r = i[o]) === null || r === void 0 ? void 0 : r[e]) !== undefined
          ) {
      ...
      const mb = {
        ...
        labelOverlap: ({ axis: e, fieldOrDatumDef: n, scaleType: t }) => {
          ...
          return (i = e.labelOverlap) !== null && i !== void 0
            ? i
            : jb(n.type, t, fu(n) && !!n.timeUnit, fu(n) ? n.sort : undefined);
        },
        orient: ({ orient: e }) => e,
        tickCount: ({
          channel: e,
        ...
        title: ({ axis: e, model: n, channel: t }) => {
          ...
          return ui(r ? [tu(r)] : [], fu(o) ? [tu(o)] : []);
        },
        values: ({ axis: e, fieldOrDatumDef: n }) => Ab(e, n),
        zindex: ({ axis: e, fieldOrDatumDef: n, mark: t }) => {
          var i;
          return (i = e.zindex) !== null && i !== void 0 ? i : kb(t, n);
        }
      };
      function hb(e, n) {
        return (
          !mo(e) &&
          fu(n) &&
          !At(n === null || n === void 0 ? void 0 : n.bin) &&
          !kt(n === null || n === void 0 ? void 0 : n.bin)
        );
      }
      function bb(e, n) {
        const t = n === 'x' ? 'y' : 'x';
      ...
      function yb(e, n, t, i, r) {
        const s = n === null || n === void 0 ? void 0 : n.labelAngle;
        if (s !== undefined) {
          return Tt(s) ? s : ie(s);
        } else {
          const { configValue: s } = gb(
            'labelAngle',
            i,
          ...
          if (s !== undefined) {
            ...
            if (t === ce && F([Qs, Ks], e.type) && !(fu(e) && e.timeUnit)) {
              return 270;
            }
            return undefined;
          }
      ...
      function Ob(e, n, t, i) {
        if (e !== undefined) {
          if (t === 'x') {
            if (Tt(e)) {
              const t = vb(e);
              const i = Tt(n) ? `(${n.signal} === "top")` : n === 'top';
              return {
                signal:
            ...
            if (Tt(e)) {
              const t = vb(e);
              const r = Tt(n) ? `(${n.signal} === "left")` : n === 'left';
      ...
      function wb(e, n) {
        if (n === 'x' && F(['quantitative', 'temporal'], e)) {
          return true;
        }
        return undefined;
      }
      function jb(e, n, t, i) {
        if ((t && !(0, r.Gv)(i)) || (e !== 'nominal' && e !== 'ordinal')) {
          if (n === 'log' || n === 'symlog') {
            return 'greedy';
          }
          return true;
      ...
      function $b({ fieldOrDatumDef: e, scaleType: n, size: t, values: i }) {
        var r;
        if (!i && !mo(n) && n !== 'log') {
          if (fu(e)) {
            if (At(e.bin)) {
            ...
            if (
              ...
              F(
                ...
                (r = $s(e.timeUnit)) === null || r === void 0 ? void 0 : r.unit
              )
            ) {
              return undefined;
            }
      ...
      class Cb extends ep {
        clone() {
          return new Cb(null, b(this.transform));
        }
        constructor(e, n) {
          super(e);
          this.transform = n;
          this._dependentFields = Jh(this.transform.calculate);
        }
            ...
            if (Va(n.sort)) {
              ...
              const o =
                s
                  .map(
                    (e, n) =>
                      `${Ls({ field: i, timeUnit: r, equal: e })} ? ${n} : `
                  )
                  .join('') + s.length;
              e = new Cb(e, { calculate: o, as: Sb(n, t, { forAs: true }) });
            }
          });
          return e;
        }
      ...
      function Nb(e, n) {
        ...
        const {
          ...
          titleAngle: o,
          titleOrient: a
        } = Pb(['titleAnchor', 'titleAngle', 'titleOrient'], r.header, i, n);
        const u = Eb(n, a);
        const c = ie(o);
        return {
          name: `${n}-title`,
      ...
      function Tb(e, n, t = 'middle') {
        ...
        const i = xb(n, e === 'row' ? 'left' : 'top', e === 'row' ? 'y' : 'x');
        return i ? { align: i } : {};
      }
      function Mb(e, n) {
        const t = Ob(
      ...
      function qb(e, n) {
        ...
        if (Ka(i)) {
          return {
            field: Du(i, { expr: 'datum' }),
            order: (t = i.order) !== null && t !== void 0 ? t : 'ascending'
          };
        } else if ((0, r.cy)(i)) {
          return { field: Sb(e, n, { expr: 'datum' }), order: 'ascending' };
        } else {
          return {
            field: Du(e, { expr: 'datum' }),
      ...
      function Rb(e, n, t, i, r) {
        if (r) {
          ...
          if (o && r.labels) {
            const { labelOrient: e } = Pb(['labelOrient'], o.header, a, n);
            if (
              (n === 'row' && !F(['top', 'bottom'], e)) ||
              (n === 'column' && !F(['left', 'right'], e))
            ) {
              s = Ub(o, n, a);
            }
          }
          const u = ex(e) && !Qa(e.facet);
          const c = r.axes;
                ...
                Object.assign(
                  Object.assign(
                    Object.assign(
                      ...
                      i.facetFieldDef
                        ? {
                            from: { data: e.getName(`${n}_domain`) },
                            sort: qb(o, n)
                          }
                        : {}
                    ),
                    l && u
                      ? { from: { data: e.getName(`facet_domain_${n}`) } }
                      : {}
                  ),
                  s ? { title: s } : {}
                ),
                r.sizeSignal
                  ? { encode: { update: { [a]: r.sizeSignal } } }
                  : {}
              ),
              l ? { axes: c } : {}
            );
      ...
      const Ib = { column: { start: 0, end: 1 }, row: { start: 1, end: 0 } };
      function Wb(e, n) {
        return Ib[n][e];
      }
      function Hb(e, n) {
        ...
        for (const i of Je) {
          ...
          if (r === null || r === void 0 ? void 0 : r.facetFieldDef) {
            const { titleAnchor: e, titleOrient: s } = Pb(
        ...
        return z(t) ? undefined : t;
      }
      function Gb(e, n, t, i, r) {
        const s = {};
        for (const o of i) {
          if (!r[o]) {
            continue;
          }
          const i = Bb(o, n === null || n === void 0 ? void 0 : n.header, e, t);
          if (i !== undefined) {
            s[r[o]] = i;
          }
        }
        ...
        if (i === 'step') {
          ...
          if (n) {
            ...
            if (mo(i) && Mt(s)) {
              ...
              return [
                Vb(i, s),
                { name: r, update: Qb(i, n, `domain('${i}').length`) }
              ];
            }
          }
          throw new Error(
          ...
          const i = Ll(e.config.view, n ? 'width' : 'height');
          const s = `isFinite(${t}) ? ${t} : ${i}`;
          return [
            { name: r, init: s, on: [{ update: s, events: 'window:resize' }] }
          ];
        } else {
      ...
      function Qb(e, n, t) {
        ...
        const s = X(n.get('paddingOuter'), r);
      ...
      function Jb(e, n) {
        return N(e).reduce((t, i) => {
          const r = e[i];
          return Object.assign(
            Object.assign({}, t),
            wp(n, r, i, (e) => Xt(e.value))
          );
        }, {});
      }
      function Zb(e, n) {
      ...
      const ny = Object.assign(Object.assign({}, yl), {
        disable: 1,
        labelExpr: 1,
        selections: 1,
        opacity: 1,
      ...
      const ty = N(ny);
      class iy extends kd {}
      const ry = { symbols: sy, gradient: oy, labels: ay, entries: uy };
      function sy(
        e,
        {
          fieldOrDatumDef: n,
        ...
        let O = Object.assign(
          Object.assign({}, ni({}, t, aa)),
          Bp(t, { filled: v })
        );
        const x =
          (a = s.get('symbolOpacity')) !== null && a !== void 0
            ? a
            : b.legend.symbolOpacity;
        const w =
          (u = s.get('symbolFillColor')) !== null && u !== void 0
            ? u
            : b.legend.symbolFillColor;
        const j =
          (c = s.get('symbolStrokeColor')) !== null && c !== void 0
            ? c
            : b.legend.symbolStrokeColor;
        const F =
          x === undefined
            ? (l = cy(h.opacity)) !== null && l !== void 0
              ? l
              : m.opacity
            : undefined;
        if (O.fill) {
          if (i === 'fill' || (v && i === je)) {
            ...
            if (O.fill['field']) {
              if (w) {
                ...
                O.fill = Xt(
                  (f = b.legend.symbolBaseFillColor) !== null && f !== void 0
                    ? f
                    : 'black'
                );
                O.fillOpacity = Xt(F !== null && F !== void 0 ? F : 1);
              }
            } else if ((0, r.cy)(O.fill)) {
              const e =
                (g =
                  (p = ly(
                    (d = h.fill) !== null && d !== void 0 ? d : h.color
                  )) !== null && p !== void 0
                    ? p
                    : m.fill) !== null && g !== void 0
                  ? g
                  : v && m.color;
              if (e) {
                O.fill = Xt(e);
        ...
        if (i !== Ce) {
          const e = fu(n) && dy(t, s, n);
          if (e) {
            O.opacity = [
              Object.assign(
                { test: e },
                Xt(F !== null && F !== void 0 ? F : 1)
              ),
              Xt(b.legend.unselectedOpacity)
            ];
          } else if (F) {
            O.opacity = Xt(F);
          }
        ...
        return z(O) ? undefined : O;
      }
      function oy(e, { model: n, legendType: t, legendCmpt: i }) {
        var r;
        if (t !== 'gradient') {
          return undefined;
        }
        ...
        const l = c === undefined ? cy(a.opacity) || o.opacity : undefined;
        if (l) {
          u.opacity = Xt(l);
        }
        u = Object.assign(Object.assign({}, u), e);
        return z(u) ? undefined : u;
      }
      function ay(
        e,
        { fieldOrDatumDef: n, model: t, channel: i, legendCmpt: r }
      ) {
        const s = t.legend(i) || {};
        const o = t.config;
        const a = fu(n) ? dy(t, r, n) : undefined;
        const u = a
        ...
        } else if (c === undefined && l === undefined && o.customFormatTypes) {
        ...
        return z(d) ? undefined : d;
      }
      function uy(e, { legendCmpt: n }) {
      ...
      function cy(e) {
        return fy(e, (e, n) => Math.max(e, n.value));
      }
      function ly(e) {
        return fy(e, (e, n) => X(e, n.value));
      }
      function fy(e, n) {
        if (lu(e)) {
          return (0, r.YO)(e.condition).reduce(n, e.value);
        } else if (vu(e)) {
          return e.value;
        }
        return undefined;
      ...
      function dy(e, n, t) {
        ...
        const s = (0, r.r$)(t.field);
        return i
          .map((e) => {
            const n = (0, r.r$)(q(e) + Cg);
      ...
      const py = {
        ...
        format: ({ fieldOrDatumDef: e, legend: n, config: t }) => {
          ...
          return Na(e, e.type, i, r, t, false);
        },
        ...
        gradientLength: (e) => {
          ...
          return (t =
            (n = i.gradientLength) !== null && n !== void 0
              ? n
              : r.gradientLength) !== null && t !== void 0
            ? t
            : xy(e);
        },
        labelOverlap: ({ legend: e, legendConfig: n, scaleType: t }) => {
          var i, r;
          return (r =
            (i = e.labelOverlap) !== null && i !== void 0
              ? i
              : n.labelOverlap) !== null && r !== void 0
            ? r
            : jy(t);
        },
        symbolType: ({ legend: e, markDef: n, channel: t, encoding: i }) => {
          ...
          return (r = e.symbolType) !== null && r !== void 0
            ? r
            : my(n.type, t, i.shape, n.shape);
        },
        title: ({ fieldOrDatumDef: e, config: n }) =>
          Nu(e, n, { allowDisabling: true }),
        ...
        values: ({ fieldOrDatumDef: e, legend: n }) => gy(n, e)
      };
      function gy(e, n) {
        const t = e.values;
        if ((0, r.cy)(t)) {
      ...
      function my(e, n, t, i) {
        var r;
        if (n !== 'shape') {
          const e = (r = ly(t)) !== null && r !== void 0 ? r : i;
          if (e) {
            return e;
          }
        }
      ...
      function by(e) {
        const { legend: n } = e;
        return X(n.type, yy(e));
      }
      function yy({ channel: e, timeUnit: n, scaleType: t }) {
        if (Qe(e)) {
          if (F(['quarter', 'month', 'day'], n)) {
            return 'symbol';
          }
          if (bo(t)) {
            return 'gradient';
      ...
      function vy({ legendConfig: e, legendType: n, orient: t, legend: i }) {
        var r, s;
        return (s =
          (r = i.direction) !== null && r !== void 0
            ? r
            : e[n ? 'gradientDirection' : 'symbolDirection']) !== null &&
          s !== void 0
          ? s
          : Oy(t, n);
      }
      ...
      function xy({
        ...
        if (bo(r)) {
          if (t === 'horizontal') {
            if (i === 'top' || i === 'bottom') {
              return wy(n, 'width', o, s);
            } else {
              return o;
            }
          } else {
            return wy(n, 'height', u, a);
          }
        }
        return undefined;
      }
      ...
      function jy(e) {
        if (F(['quantile', 'threshold', 'log', 'symlog'], e)) {
          return 'greedy';
        }
        return undefined;
      }
      function Fy(e) {
        const n = ZO(e) ? $y(e) : Cy(e);
      ...
      function $y(e) {
        const { encoding: n } = e;
        const t = {};
        for (const i of [je, ...hl]) {
          const r = Ru(n[i]);
          if (!r || !e.getScaleComponent(i)) {
            continue;
          }
          if (i === De && fu(r) && r.type === Xs) {
            continue;
          }
          t[i] = ky(e, i);
        }
      ...
      function ky(e, n) {
        ...
        const p = Ru(a[n]);
        const g = fu(p)
          ? (t = $s(p.timeUnit)) === null || t === void 0
            ? void 0
            : t.unit
          : undefined;
        const m = s.orient || u.legend.orient || 'right';
        const h = by({ legend: s, channel: n, timeUnit: g, scaleType: d });
        const b = vy({ legend: s, legendType: h, orient: m, legendConfig: c });
        const y = {
          legend: s,
          channel: n,
          model: e,
        ...
        for (const j of ty) {
          ...
          const t = j in py ? py[j](y) : s[j];
          if (t !== undefined) {
            const i = Ay(t, j, s, e.fieldDef(n));
        ...
        for (const j of [
          ...
          const n = Jb((r = v[j]) !== null && r !== void 0 ? r : {}, e);
          const t = j in ry ? ry[j](n, w) : n;
          if (t !== undefined && !z(t)) {
            x[j] = Object.assign(
              Object.assign(
                Object.assign(
                  {},
                  (O === null || O === void 0 ? void 0 : O.length) && fu(p)
                    ? { name: `${q(p.field)}_legend_${j}` }
                    : {}
                ),
        ...
        if (!z(x)) {
          l.set(
            'encode',
            x,
            !!(s === null || s === void 0 ? void 0 : s.encoding)
          );
        }
        return l;
      }
      function Cy(e) {
        ...
        for (const i of e.children) {
          Fy(i);
          for (const r of N(i.component.legends)) {
            t.legend[r] = ey(e.component.resolve, r);
            if (t.legend[r] === 'shared') {
              n[r] = Sy(n[r], i.component.legends[r]);
              if (!n[r]) {
      ...
      function Sy(e, n) {
        ...
        if (u) {
          if (
            (i =
              (t = e.implicit) === null || t === void 0 ? void 0 : t.encode) ===
              null || i === void 0
              ? void 0
              : i.gradient
          ) {
            R(e.implicit, ['encode', 'gradient']);
          }
          if (
            (s =
              (r = e.explicit) === null || r === void 0 ? void 0 : r.encode) ===
              null || s === void 0
              ? void 0
              : s.gradient
          ) {
            R(e.explicit, ['encode', 'gradient']);
          }
        }
        return e;
      }
      ...
      function zy(e, n) {
        ...
        const s = e.combine(),
          ...
          c = By(s, ['disable', 'labelExpr', 'selections']);
        if (o) {
          return undefined;
        }
        ...
        if (a !== undefined) {
          ...
          if (
            ((r =
              (i = c.encode) === null || i === void 0 ? void 0 : i.labels) ===
              null || r === void 0
              ? void 0
              : r.update) &&
            Tt(c.encode.labels.update.text)
          ) {
            e = K(a, 'datum.label', c.encode.labels.update.text.signal);
          }
          Py(c, 'labels', 'text', { signal: e });
        }
        return c;
      }
      function Ny(e) {
      ...
      function Ty(e) {
        return e.children.reduce(
          (e, n) => e.concat(n.assembleProjections()),
          My(e)
        );
      }
      function My(e) {
        ...
        if (!n.data) {
          ...
          const s = n.data.reduce((n, t) => {
            const i = Tt(t) ? t.signal : `data('${e.lookupDataSource(t)}')`;
            if (!F(n, i)) {
              n.push(i);
            }
            return n;
      ...
      function Uy(e) {
        e.component.projection = ZO(e) ? Ry(e) : Hy(e);
      }
      function Ry(e) {
        var n;
        if (e.hasProjection) {
          const t = Pt(e.specifiedProjection);
          const i = !(t && (t.scale != null || t.translate != null));
          const r = i
            ? [e.getSizeSignalRef('width'), e.getSizeSignalRef('height')]
            : undefined;
          const s = i ? Iy(e) : undefined;
          const o = new qy(
            e.projectionName(true),
            Object.assign(
              Object.assign(
                {},
                (n = Pt(e.config.projection)) !== null && n !== void 0 ? n : {}
              ),
              t !== null && t !== void 0 ? t : {}
            ),
            r,
      ...
      function Iy(e) {
        ...
        for (const i of [
          ...
          if (Ru(t[i[0]]) || Ru(t[i[1]])) {
            n.push({ signal: e.getName(`geojson_${n.length}`) });
          }
        }
        if (e.channelHasField(De) && e.typedFieldDef(De).type === Xs) {
          n.push({ signal: e.getName(`geojson_${n.length}`) });
        }
        if (n.length === 0) {
          n.push(e.requestDataName(Rd.Main));
        }
        return n;
      }
      function Wy(e, n) {
        const t = D(Ly, (t) => {
          if (!(0, r.mQ)(e.explicit, t) && !(0, r.mQ)(n.explicit, t)) {
            return true;
          }
          if (
            (0, r.mQ)(e.explicit, t) &&
      ...
      function Hy(e) {
        ...
        if (n && t) {
          ...
          const i = new qy(t, n.specifiedProjection, n.size, b(n.data));
          for (const n of e.children) {
      ...
      function Yy(e, n, t, i) {
        ...
        if (ec(n, t)) {
          const o = ZO(e)
            ? (s =
                (r = e.axis(t)) !== null && r !== void 0 ? r : e.legend(t)) !==
                null && s !== void 0
              ? s
              : {}
            : {};
          const a = Du(n, { expr: 'datum' });
          const u = Du(n, { expr: 'datum', binSuffix: 'end' });
          return {
            formulaAs: Du(n, { binSuffix: 'range', forAs: true }),
            formula: Ra(a, u, o.format, o.formatType, i)
          };
        }
        return {};
      }
      ...
      function Qy(e, n, t) {
        var i;
        const r = (i = Yu(t, undefined)) !== null && i !== void 0 ? i : {};
        const s = Ky(r, n);
      ...
      function Jy(e, n, t) {
        ...
        let s;
        if (Xy(e)) {
          i = (0, r.Kg)(e.as) ? [e.as, `${e.as}_end`] : [e.as[0], e.as[1]];
        } else {
          i = [
            Du(e, { forAs: true }),
            Du(e, { binSuffix: 'end', forAs: true })
          ];
        }
        const o = Object.assign({}, Yu(n, undefined));
        const a = Ky(o, e.field);
        const { signal: u, extentSignal: c } = Vy(t, a);
        if (St(o.extent)) {
          const e = o.extent;
          s = tb(t, e.param, e);
          delete o.extent;
      ...
      class Zy extends ep {
        clone() {
          return new Zy(null, b(this.bins));
        }
        constructor(e, n) {
          super(e);
          this.bins = n;
        ...
        static makeFromEncoding(e, n) {
          const t = n.reduceFieldDef((e, t, i) => {
            if (yu(t) && At(t.bin)) {
              const { key: r, binComponent: s } = Jy(t, t.bin, n);
              e[r] = Object.assign(
        ...
        static makeFromTransform(e, n, t) {
          const { key: i, binComponent: r } = Jy(n, n.bin, t);
          return new Zy(e, { [i]: r });
        }
        merge(e, n) {
          for (const t of N(e.bins)) {
            if (t in this.bins) {
              n(e.bins[t].signal, this.bins[t].signal);
              this.bins[t].as = C([...this.bins[t].as, ...e.bins[t].as], w);
            } else {
        ...
        dependentFields() {
          return new Set(T(this.bins).map((e) => e.field));
        }
        hash() {
          return `Bin ${w(this.bins)}`;
        }
        assemble() {
          return T(this.bins).flatMap((e) => {
            const n = [];
            const [t, ...i] = e.as;
            const r = e.bin,
              { extent: s } = r,
            ...
            const a = Object.assign(
              Object.assign(
                Object.assign(
                  { type: 'bin', field: Y(e.field), as: t, signal: e.signal },
                  !St(s) ? { extent: s } : { extent: null }
                ),
      ...
      function ev(e, n, t, i) {
        var r;
        const s = ZO(i) ? i.encoding[yn(n)] : undefined;
        if (yu(t) && ZO(i) && ou(t, s, i.markDef, i.config)) {
          e.add(Du(t, {}));
          e.add(Du(t, { suffix: 'end' }));
          if (t.bin && ec(t, n)) {
            e.add(Du(t, { binSuffix: 'range' }));
          }
        } else if (Ye(n)) {
          const t = Ge(n);
          e.add(i.getName(t));
        ...
        if (
          Ou(t) &&
          jo((r = t.scale) === null || r === void 0 ? void 0 : r.range)
        ) {
      ...
      class tv extends ep {
        clone() {
          return new tv(null, new Set(this.dimensions), b(this.measures));
        }
        constructor(e, n, t) {
          super(e);
          this.dimensions = n;
          ...
          n.forEachFieldDef((e, t) => {
            ...
            if (c) {
              if (c === 'count') {
                ...
                i['*']['count'] = new Set([Du(e, { forAs: true })]);
              } else {
                if (yt(c) || vt(c)) {
                  const e = yt(c) ? 'argmin' : 'argmax';
                  const n = c[e];
                  (o = i[n]) !== null && o !== void 0 ? o : (i[n] = {});
                  i[n][e] = new Set([Du({ op: e, field: n }, { forAs: true })]);
                } else {
                  (a = i[l]) !== null && a !== void 0 ? a : (i[l] = {});
                  i[l][c] = new Set([Du(e, { forAs: true })]);
                }
                if (ct(t) && n.scaleDomain(t) === 'unaggregated') {
                  (u = i[l]) !== null && u !== void 0 ? u : (i[l] = {});
                  i[l]['min'] = new Set([
                    Du({ field: l, aggregate: 'min' }, { forAs: true })
                  ]);
                  i[l]['max'] = new Set([
                    Du({ field: l, aggregate: 'max' }, { forAs: true })
                  ]);
                }
              }
            } else {
        ...
        static makeFromTransform(e, n) {
          ...
          for (const a of n.aggregate) {
            ...
            if (e) {
              if (e === 'count') {
                ...
                o['*']['count'] = new Set([r ? r : Du(a, { forAs: true })]);
              } else {
                (i = o[n]) !== null && i !== void 0 ? i : (o[n] = {});
                o[n][e] = new Set([r ? r : Du(a, { forAs: true })]);
              }
            }
          }
          ...
          if (s.size + N(o).length === 0) {
            return null;
          }
          return new tv(e, s, o);
        }
        merge(e) {
          if (E(this.dimensions, e.dimensions)) {
            nv(this.measures, e.measures);
            return true;
          }
          Xr('different dimensions, cannot merge');
          return false;
        }
        addDimensions(e) {
        ...
        dependentFields() {
          return new Set([...this.dimensions, ...N(this.measures)]);
        }
        producedFields() {
          const e = new Set();
          for (const n of N(this.measures)) {
            for (const t of N(this.measures[n])) {
        ...
        hash() {
          return `Aggregate ${w({ dimensions: this.dimensions, measures: this.measures })}`;
        }
        assemble() {
          const e = [];
          const n = [];
          const t = [];
          for (const r of N(this.measures)) {
            for (const i of N(this.measures[r])) {
      ...
      class iv extends ep {
              ...
              this[s] = Object.assign(
                {
                  ...
                  fields: [
                    Du(e),
                    ...(At(t) ? [Du(e, { binSuffix: 'end' })] : [])
                  ]
                },
                Ka(i)
                  ? { sortField: i }
                  : (0, r.cy)(i)
                    ? { sortIndexField: Sb(e, s) }
                    : {}
              );
            }
          }
        ...
        assembleRowColumnHeaderData(e, n, t) {
          ...
          if (a) {
            const { op: e = Wa, field: n } = a;
            r.push(n);
            s.push(e);
            o.push(Du(a, { forAs: true }));
          } else if (u) {
            r.push(u);
            s.push('max');
            o.push(u);
        ...
        assembleFacetHeaderData(e) {
          ...
          for (const c of _b) {
            for (const e of zb) {
              ...
              for (const e of i) {
                if (
                  ((t = e.axes) === null || t === void 0 ? void 0 : t.length) >
                  0
                ) {
                  o[c] = true;
                  break;
      ...
      function sv(e, n) {
        ...
        if (n === 'number') {
          ...
          const e = rv(n.slice(5, n.length));
          return `timeParse(${t},'${e}')`;
        } else if (n.startsWith('utc:')) {
          const e = rv(n.slice(4, n.length));
          return `utcParse(${t},'${e}')`;
        } else {
          Vr(Ei(n));
          return null;
      ...
      function av(e) {
        ...
        function t(e) {
          if (Qu(e)) {
            n[e.field] = 'date';
          } else if (e.type === 'quantitative' && jt(e.aggregate)) {
            n[e.field] = 'number';
          } else if (Q(e.field) > 1) {
            if (!(e.field in n)) {
              n[e.field] = 'flatten';
            }
          } else if (Ou(e) && Ka(e.sort) && Q(e.sort.field) > 1) {
        ...
        if (ZO(e)) {
          ...
          if (ea(t) && !e.encoding.order) {
            ...
            const t = r[e];
            if (fu(t) && t.type === 'quantitative' && !(t.field in n)) {
              n[t.field] = 'number';
            }
          }
        }
      ...
      function uv(e) {
        const n = {};
        if (ZO(e) && e.component.selection) {
          for (const t of N(e.component.selection)) {
            const i = e.component.selection[t];
            for (const e of i.project.items) {
              if (!e.channel && Q(e.field) > 1) {
                n[e.field] = 'flatten';
              }
            }
          }
      ...
      class cv extends ep {
        clone() {
          return new cv(null, b(this._parse));
        }
        constructor(e, n) {
          super(e);
          this._parse = n;
        ...
        static makeWithAncestors(e, n, t, i) {
          ...
          i.copyAll(r);
          const s = {};
          for (const o of N(r.combine())) {
            const e = r.get(o);
            if (e !== null) {
              s[o] = e;
            }
          }
          if (N(s).length === 0 || i.parseNothing) {
            return null;
          }
          return new cv(e, s);
        }
        ...
        producedFields() {
          return new Set(N(this._parse));
        }
        dependentFields() {
          return new Set(N(this._parse));
        }
        assembleTransforms(e = false) {
          return N(this._parse)
            .filter((n) => (e ? Q(n) > 1 : true))
            .map((e) => {
              const n = sv(e, this._parse[e]);
              if (!n) {
                return null;
              }
      ...
      class lv extends ep {
        ...
        assemble() {
          return { type: 'identifier', as: Ol };
        }
      }
      class fv extends ep {
        clone() {
          return new fv(null, this.params);
        }
        constructor(e, n) {
          super(e);
          this.params = n;
      ...
      class dv extends ep {
        clone() {
          return new dv(null, this.params);
        }
        constructor(e, n) {
          super(e);
          this.params = n;
        ...
        producedFields() {
          var e;
          return new Set([
            (e = this.params.as) !== null && e !== void 0 ? e : 'data'
          ]);
        }
        hash() {
      ...
      class pv extends ep {
        constructor(e) {
          ...
          if (Nd(e)) {
            ...
            if (!n.type) {
              let t = /(?:\.([^.]+))?$/.exec(e.url)[1];
              if (!F(['json', 'csv', 'tsv', 'dsv', 'topojson'], t)) {
                t = 'json';
              }
              n.type = t;
            }
      ...
      var hv;
      function bv(e) {
        return e instanceof pv || e instanceof fv || e instanceof dv;
      }
      class yv {
        constructor() {
          hv.set(this, void 0);
      ...
      class wv extends Ov {
        constructor(e) {
          super();
          this.requiresSelectionId = e && Tg(e);
        }
        run(e) {
          if (e instanceof lv) {
            if (
              !(
                ...
                (bv(e.parent) ||
                  e.parent instanceof tv ||
                  e.parent instanceof cv)
              )
            ) {
              this.setModified();
              e.remove();
          ...
          for (const n of e.children) {
            if (n instanceof cv) {
              if (e instanceof cv) {
                ...
                if (_(e.producedFields(), n.dependentFields())) {
                  continue;
                }
                this.setModified();
                n.swapWithParent();
      ...
      class Dv extends vv {
        run(e) {
          const n = [...e.children];
          const t = e.children.filter((e) => e instanceof cv);
          if (e.numChildren() > 1 && t.length >= 1) {
            ...
            if (!z(i)) {
              ...
              for (const r of n) {
                ...
                e.removeChild(r);
                r.parent = t;
                if (r instanceof cv && N(r.parse).length === 0) {
                  r.remove();
                }
              }
            }
      ...
      class Av extends vv {
        run(e) {
          if (e instanceof np || e.numChildren() > 0 || e instanceof iv) {
          } else if (e instanceof pv) {
          } else {
            this.setModified();
            e.remove();
          }
      ...
      class Cv extends vv {
        run(e) {
          const n = e.children.filter((e) => e instanceof tv);
          const t = {};
          for (const i of n) {
            const e = w(i.groupBy);
            if (!(e in t)) {
      ...
      class Sv extends vv {
        ...
        run(e) {
          ...
          for (const r of e.children) {
            if (r instanceof Zy) {
              if (n && !_(e.producedFields(), r.dependentFields())) {
                t.push(r);
              } else {
                i.push(r);
              }
      ...
      class Bv extends ep {
        clone() {
          return new Bv(null, b(this.transform));
        }
        constructor(e, n) {
          super(e);
          this.transform = n;
        ...
        getDefaultName(e) {
          var n;
          return (n = e.as) !== null && n !== void 0 ? n : Du(e);
        }
        hash() {
      ...
      function _v(e) {
        return (0, r.cy)(e) && e.every((e) => (0, r.Kg)(e)) && e.length > 1;
      }
      class zv extends ep {
        clone() {
          return new zv(null, b(this._stack));
        }
        constructor(e, n) {
          super(e);
          this._stack = n;
        ...
        static makeFromEncoding(e, n) {
          ...
          return new zv(e, {
            ...
            impute: u,
            as: [
              n.vgField(o, { suffix: 'start', forAs: true }),
              n.vgField(o, { suffix: 'end', forAs: true })
            ]
          });
        }
        get stack() {
          ...
          if (e.length > 0) {
            return e
              .map((e) => {
                if (e.bin) {
                  if (n) {
                    return [Du(e, { binSuffix: 'mid' })];
                  }
                  return [Du(e, {}), Du(e, { binSuffix: 'end' })];
                }
                return [Du(e)];
              })
              .flat();
        ...
        assemble() {
          ...
          if (a) {
            for (const s of t) {
              ...
              if (o) {
                const n = Du(s, { expr: 'datum' });
                const i = Du(s, { expr: 'datum', binSuffix: 'end' });
                e.push({
                  type: 'formula',
                  expr: `${t}*${n}+${1 - t}*${i}`,
                  as: Du(s, { binSuffix: 'mid', forAs: true })
                });
              }
              e.push({
                type: 'impute',
      ...
      class Nv extends ep {
        clone() {
          return new Nv(null, b(this.transform));
        }
        constructor(e, n) {
          super(e);
          this.transform = n;
        ...
        dependentFields() {
          var e, n;
          const t = new Set();
          ((e = this.transform.groupby) !== null && e !== void 0
            ? e
            : []
          ).forEach(t.add, t);
          ((n = this.transform.sort) !== null && n !== void 0 ? n : []).forEach(
            (e) => t.add(e.field)
          );
      ...
      function Lv(e) {
        if (e instanceof np && e.type === Rd.Main) {
          if (e.numChildren() === 1) {
            const n = e.children[0];
            if (!(n instanceof iv)) {
              n.swapWithParent();
      ...
      function Hv(e, n) {
        ...
        Rv(e.sources);
        if (Math.max(t, i) === Uv) {
          Vr(`Maximum optimization runs(${Uv}) reached.`);
        }
      }
      class Gv {
        constructor(e) {
          ...
          for (const n of e.children) {
            ...
            if (e) {
              if (i === undefined) {
                ...
                i = Pd(i, e.getWithExplicit('domains'), 'domains', 'scale', oO);
              }
      ...
      function Xv(e, n, t, i) {
        if (e === 'unaggregated') {
          const { valid: e, reason: i } = sO(n, t);
          if (!e) {
            Vr(i);
            return undefined;
          }
        } else if (e === undefined && i.useUnaggregatedDomain) {
          const { valid: e } = sO(n, t);
          if (e) {
            return 'unaggregated';
          }
        }
      ...
      function Jv(e, n) {
        ...
        const { encoding: i } = e;
        const r = Xv(e.scaleDomain(n), e.typedFieldDef(n), t, e.config.scale);
      ...
      function Zv(e, n, t) {
        return e.map((e) => {
          const i = Ju(e, { timeUnit: t, type: n });
          return { signal: `{data: ${i}}` };
        });
      }
      function eO(e, n, t) {
        var i;
        const r = (i = $s(t)) === null || i === void 0 ? void 0 : i.unit;
        if (n === 'temporal' || r) {
          return Zv(e, n, r);
        }
        return [e];
      ...
      function nO(e, n, t, i) {
        ...
        const u = o['timeUnit'];
        if (wo(n)) {
          const r = nO(e, undefined, t, i);
          const s = eO(n.unionWith, a, u);
          return Cd([...s, ...r.value]);
        } else if (Tt(n)) {
          return Cd([n]);
        ...
        if (c && i === c.fieldChannel) {
          if (c.offset === 'normalize') {
            return Sd([[0, 1]]);
          }
          const e = t.requestDataName(Rd.Main);
          return Sd([
            { data: e, field: t.vgField(i, { suffix: 'start' }) },
            { data: e, field: t.vgField(i, { suffix: 'end' }) }
          ]);
        }
        const l = ct(i) && fu(o) ? rO(t, i, e) : undefined;
        if (pu(o)) {
          const e = eO([o.datum], a, u);
          return Sd(e);
        }
        const f = o;
        if (n === 'unaggregated') {
          ...
          const { field: n } = o;
          return Sd([
            { data: e, field: Du({ field: n, aggregate: 'min' }) },
            { data: e, field: Du({ field: n, aggregate: 'max' }) }
          ]);
        } else if (At(f.bin)) {
          if (mo(e)) {
            if (e === 'bin-ordinal') {
            ...
            return Sd([
              {
                data: L(l)
                  ? t.requestDataName(Rd.Main)
                  : t.requestDataName(Rd.Raw),
                field: t.vgField(i, ec(f, i) ? { binSuffix: 'range' } : {}),
                sort:
                  l === true || !(0, r.Gv)(l)
                    ? { field: t.vgField(i, {}), op: 'min' }
                    : l
              }
            ]);
          } else {
            ...
            if (At(e)) {
              ...
              return Sd([
                { data: t.requestDataName(Rd.Main), field: t.vgField(i, {}) }
              ]);
            }
          }
        } else if (
          f.timeUnit &&
          F(['time', 'utc'], e) &&
          ou(f, ZO(t) ? t.encoding[yn(i)] : undefined, t.markDef, t.config)
        ) {
          const e = t.requestDataName(Rd.Main);
          return Sd([
      ...
      function iO(e, n) {
        ...
        const o = xo(r) && r;
        const a = Ct(s) && St(s.extent) && s.extent;
        if (o || a) {
      ...
      function rO(e, n, t) {
        ...
        const r = i.sort;
        if (Va(r)) {
          return { op: 'min', field: Sb(i, n), order: 'ascending' };
        }
        const { stack: s } = e;
        const o = s
          ? new Set([
        ...
        if (Ka(r)) {
          ...
          const c = s && !o.has(u);
          if (yt(a) || vt(a)) {
            return tO({ field: Du(i), order: t }, c);
          } else if (Ot(a) || !a) {
            return tO({ op: a, field: u, order: t }, c);
          }
        } else if (r === 'descending') {
          return { op: 'min', field: e.vgField(n), order: 'descending' };
        } else if (F(['ascending', undefined], r)) {
          return true;
        }
        return undefined;
      }
      function sO(e, n) {
        ...
        if (!t) {
          return { valid: false, reason: cr(e) };
        }
        if ((0, r.Kg)(t) && !$t.has(t)) {
          return { valid: false, reason: lr(t) };
        }
        if (i === 'quantitative') {
          if (n === 'log') {
      ...
      function aO(e) {
        ...
        const i = C(
          t.map((e) => {
            if (L(e) || !('op' in e) || ((0, r.Kg)(e.op) && e.op in bt)) {
              return e;
            }
            Vr(xr(e));
            return true;
        ...
        if (o.length === 1 && o[0] !== null) {
          const e = Object.assign(
            { data: o[0], fields: n.map((e) => e.field) },
            s ? { sort: s } : {}
          );
          return e;
        }
      ...
      function uO(e) {
        if (Ut(e) && (0, r.Kg)(e.field)) {
          return e.field;
        } else if (Lt(e)) {
          let n;
          for (const t of e.fields) {
            if (Ut(t) && (0, r.Kg)(t.field)) {
              if (!n) {
                n = t.field;
              } else if (n !== t.field) {
                Vr(jr);
      ...
      function fO(e) {
        if (tx(e) || nx(e)) {
          return e.children.reduce((e, n) => e.concat(fO(n)), dO(e));
        } else {
          return dO(e);
        }
      }
      function dO(e) {
        return N(e.component.scales).reduce((n, t) => {
          ...
          const d = pO(r.range, s, t, e);
          const p = cO(e, t);
          const g = a ? Jd(e, a, i, p) : null;
          n.push(
            Object.assign(
              Object.assign(
                Object.assign(
      ...
      class gO extends kd {
        ...
        domainDefinitelyIncludesZero() {
          ...
          return $(
            this.get('domains'),
            (e) => (0, r.cy)(e) && e.length === 2 && e[0] <= 0 && e[1] >= 0
          );
        }
      }
      const mO = ['range', 'scheme'];
      function hO(e) {
        const n = e.component.scales;
        for (const t of ut) {
          const i = n[t];
      ...
      function bO(e, n) {
        ...
        if (t === null || t === void 0 ? void 0 : t.bin) {
          ...
          const o = vn(n);
          const a = e.getName(o);
          if ((0, r.Gv)(i) && i.binned && i.step !== undefined) {
            return new Gv(() => {
              const t = e.scaleName(n);
      ...
      function yO(e, n) {
              ...
              switch (d) {
                case 'range': {
                  ...
                  if ((0, r.cy)(i)) {
                    ...
                    return Cd({
                      data: n.requestDataName(Rd.Main),
                      field: i.field,
        ...
        const a = e === ce || e === 'xOffset' ? 'width' : 'height';
        const u = i[a];
        if (Bl(u)) {
          if (Rn(e)) {
            if (mo(o)) {
        ...
        if (
          ...
          return Cd([
            c !== null && c !== void 0 ? c : f[0],
            l !== null && l !== void 0 ? l : f[1]
          ]);
        }
        return Sd(f);
      }
      ...
      function OO(e, n) {
        ...
        switch (e) {
          ...
          case le: {
            ...
            const s = n.getName(r);
            if (e === le && ho(c)) {
              return [Gv.fromName(o, s), 0];
            } else {
              return [0, Gv.fromName(o, s)];
            }
          }
          case pe:
          case ge:
      ...
      function xO(e, n, t) {
        var i, r, s, o, a;
        const { encoding: u } = n;
        const c = n.getScaleComponent(t);
        const l = xn(t);
        const f = u[l];
        const d = El({ step: e, offsetIsDiscrete: bu(f) && Gs(f.type) });
        if (d === 'offset' && mc(u, l)) {
          const t = n.getScaleComponent(l);
          const u = n.scaleName(l);
          let f = `domain('${u}').length`;
          if (t.get('type') === 'band') {
            const e =
              (r =
                (i = t.get('paddingInner')) !== null && i !== void 0
                  ? i
                  : t.get('padding')) !== null && r !== void 0
                ? r
                : 0;
            const n =
              (o =
                (s = t.get('paddingOuter')) !== null && s !== void 0
                  ? s
                  : t.get('padding')) !== null && o !== void 0
                ? o
                : 0;
            f = `bandspace(${f}, ${e}, ${n})`;
          }
          const d =
            (a = c.get('paddingInner')) !== null && a !== void 0
              ? a
              : c.get('padding');
          return { signal: `${e.step} * ${f} / (1-${Jt(d)})` };
        } else {
          return e.step;
        }
      }
      function wO(e, n) {
        const t = El({ step: e, offsetIsDiscrete: mo(n) });
        if (t === 'offset') {
          return { step: e.step };
        }
        return undefined;
      ...
      function jO(e, n, t) {
        ...
        if (s === 'band') {
          const e = FO(i, n.size, n.config.view);
          if (Bl(e)) {
            const n = wO(e, t);
            if (n) {
              return n;
      ...
      function AO(e, n, t) {
        if (n) {
          if (Tt(n)) {
            return { signal: `${n.signal} ? 0 : ${AO(e, false, t)}` };
          } else {
            return 0;
          }
        }
        ...
        throw new Error(Qi('size', e));
      }
      const kO = 0.95;
      function CO(e, n, t, i) {
        const s = { x: bO(t, 'x'), y: bO(t, 'y') };
        switch (e) {
          case 'bar':
          case 'tick': {
            ...
            const e = SO(n, s, i.view);
            if ((0, r.Et)(e)) {
              return e - 1;
            } else {
              return new Gv(() => `${e.signal} - 1`);
            }
          }
          case 'line':
          case 'trail':
          ...
          case 'circle': {
            ...
            const e = SO(n, s, i.view);
            if ((0, r.Et)(e)) {
              return Math.pow(kO * e, 2);
            } else {
              return new Gv(() => `pow(${kO} * ${e.signal}, 2)`);
            }
          }
        }
        throw new Error(Qi('size', e));
      ...
      function SO(e, n, t) {
        const i = Bl(e.width) ? e.width.step : ql(t, 'width');
        const r = Bl(e.height) ? e.height.step : ql(t, 'height');
        if (n.x || n.y) {
          return new Gv(() => {
          ...
          if (h && b === undefined) {
            if (d !== undefined) {
              ...
              switch (n) {
                case 'domainMax':
                case 'domainMin':
                  if (Jr(u[n]) || t === 'temporal' || e) {
                    c.set(
                      n,
                      { signal: Ju(u[n], { type: t, timeUnit: e }) },
                      true
                    );
                  } else {
                    c.set(n, u[n], true);
      ...
      const PO = {
        bins: ({ model: e, fieldOrDatumDef: n }) =>
          fu(n) ? NO(e, n) : undefined,
        interpolate: ({ channel: e, fieldOrDatumDef: n }) => TO(e, n.type),
        nice: ({
          scaleType: e,
          channel: n,
          domain: t,
        ...
        reverse: ({
          ...
          const r = fu(e) ? e.sort : undefined;
          return RO(n, r, t, i.scale);
        },
        zero: ({
          channel: e,
          fieldOrDatumDef: n,
      ...
      function NO(e, n) {
        const t = n.bin;
        if (At(t)) {
          const i = Qy(e, n.field, t);
          return new Gv(() => e.getSignalName(i));
        } else if (kt(t) && Ct(t) && t.step !== undefined) {
          return { step: t.step };
        }
        return undefined;
      }
      function TO(e, n) {
        if (F([je, Fe, $e], e) && n !== 'nominal') {
          return 'hcl';
        }
        return undefined;
      }
      function MO(e, n, t, i, s, o) {
        var a;
        if (
          ((a = Uu(o)) === null || a === void 0 ? void 0 : a.bin) ||
          (0, r.cy)(t) ||
          s != null ||
          i != null ||
          F([no.TIME, no.UTC], e)
        ...
        return Rn(n) ? true : undefined;
      }
      function LO(e, n, t, i, r, s) {
        if (Rn(e)) {
          if (bo(n)) {
            ...
            if (n === 'bar' && !(fu(i) && (i.bin || i.timeUnit))) {
              if (
                (o === 'vertical' && e === 'x') ||
                (o === 'horizontal' && e === 'y')
              ) {
      ...
      function UO(e, n, t, i, r, s = false) {
        if (e !== undefined) {
          return undefined;
        }
        if (Rn(n)) {
          const { bandPaddingOuter: e, bandWithNestedOffsetPaddingOuter: n } =
            r;
          if (s) {
            return n;
          }
          if (t === no.BAND) {
            return X(e, Tt(i) ? { signal: `${i.signal}/2` } : i / 2);
          }
        } else if (Kn(n)) {
          if (t === no.POINT) {
            return 0.5;
      ...
      function IO(e, n, t, i, s, o, a) {
        const u = !!t && t !== 'unaggregated';
        if (u) {
          if (ho(s)) {
            if ((0, r.cy)(t)) {
              const e = t[0];
        ...
        if (!(fu(n) && n.bin) && F([...Un, ...Wn], e)) {
          const { orient: n, type: t } = i;
          if (F(['bar', 'area', 'line', 'trail'], t)) {
            if (
              (n === 'horizontal' && e === 'y') ||
              (n === 'vertical' && e === 'x')
            ) {
      ...
      function HO(e, n, t, i) {
        ...
        switch (n.type) {
          ...
          case 'ordinal': {
            ...
            if (Rn(e) || Kn(e)) {
              if (F(['rect', 'bar', 'image', 'rule'], t.type)) {
                return 'band';
              }
              if (i) {
                return 'band';
              }
            } else if (t.type === 'arc' && e in In) {
              return 'band';
            }
            const s = t[vn(e)];
            if (ga(s)) {
            ...
            if (
              xu(n) &&
              ((r = n.axis) === null || r === void 0 ? void 0 : r.tickBand)
            ) {
              return 'band';
            }
            return 'point';
          ...
          case 'temporal':
            if (Qe(e)) {
              ...
              Vr(tr(e, 'temporal'));
              return 'ordinal';
            } else if (fu(n) && n.timeUnit && $s(n.timeUnit).utc) {
              return 'utc';
            }
            return 'time';
          case 'quantitative':
        ...
        throw new Error(Ri(n.type));
      }
      function GO(e, { ignoreRange: n } = {}) {
        YO(e);
        Kv(e);
        for (const t of Po) {
          EO(e, t);
      ...
      function YO(e) {
        if (ZO(e)) {
          e.component.scales = KO(e);
        } else {
          e.component.scales = QO(e);
        }
      }
      function KO(e) {
        ...
        for (const s of ut) {
          ...
          if (o && a !== null && a !== false) {
            a !== null && a !== void 0 ? a : (a = {});
            const t = hc(n, s);
            const u = WO(a, s, o, i, t);
            r[s] = new gO(e.scaleName(`${s}`, true), {
              value: u,
              explicit: a.type === u
            });
          }
      ...
      function QO(e) {
        ...
        for (const o of e.children) {
          YO(o);
          for (const i of N(o.component.scales)) {
            (n = (t = s.scale)[i]) !== null && n !== void 0
              ? n
              : (t[i] = Zb(i, e));
            if (s.scale[i] === 'shared') {
              const e = r[i];
      ...
      class ix {
        constructor(e, n, t, i, r, s, o) {
          ...
          this.correctDataNames = (e) => {
            ...
            if (
              (i = (t = e.from) === null || t === void 0 ? void 0 : t.facet) ===
                null || i === void 0
                ? void 0
                : i.data
            ) {
          ...
          this.title = Nt(e.title)
            ? { text: e.title }
            : e.title
              ? Pt(e.title)
              : undefined;
          this.scaleNameMap = t ? t.scaleNameMap : new JO();
          this.projectionNameMap = t ? t.projectionNameMap : new JO();
          this.signalNameMap = t ? t.signalNameMap : new JO();
          this.data = e.data;
          this.description = e.description;
          this.transforms = ud(
            (u = e.transform) !== null && u !== void 0 ? u : []
          );
          this.layout = n === 'layer' || n === 'unit' ? {} : Tl(e, n, r);
          this.component = {
            data: {
              sources: t ? t.component.data.sources : [],
              outputNodes: t ? t.component.data.outputNodes : {},
              outputNodeRefCounts: t
        ...
        assembleGroupEncodeEntry(e) {
          ...
          if (!e) {
            if (this.description) {
              n['description'] = Xt(this.description);
            }
        ...
        assembleHeaderMarks() {
          ...
          for (const t of _b) {
            n = n.concat(Lb(this, t));
          }
          return n;
        }
        assembleAxes() {
          return lb(this.component.axes, this.config);
        }
        assembleLegends() {
          return _y(this);
        }
        ...
        assembleTitle() {
          ...
          const o = Object.assign(
            Object.assign(
              Object.assign({}, zt(this.config.title).nonMarkTitleProperties),
              s
            ),
            r ? { encode: { update: r } } : {}
          );
          if (o.text) {
            if (F(['unit', 'layer'], this.type)) {
              if (F(['middle', undefined], o.anchor)) {
                (n = o.frame) !== null && n !== void 0
                  ? n
                  : (o.frame = 'group');
              }
            } else {
              (t = o.anchor) !== null && t !== void 0
                ? t
                : (o.anchor = 'start');
            }
            return z(o) ? undefined : o;
        ...
        assembleGroup(e = []) {
          ...
          const i = !this.parent || ex(this.parent) ? fO(this) : [];
          if (i.length > 0) {
            n.scales = i;
          }
        ...
        getName(e) {
          return q((this.name ? `${this.name}_` : '') + e);
        }
        getDataName(e) {
          return this.getName(Rd[e].toLowerCase());
        }
        requestDataName(e) {
        ...
        scaleName(e, n) {
          ...
          if (
            (pn(e) && ct(e) && this.component.scales[e]) ||
      ...
      class ox extends ep {
        clone() {
          return new ox(null, b(this.transform));
        }
        constructor(e, n) {
          var t, i, r;
          super(e);
      ...
      class ax extends ep {
        clone() {
          return new ax(null, Object.assign({}, this.filter));
        }
        constructor(e, n) {
          super(e);
          this.filter = n;
        ...
        static make(e, n) {
          ...
          const o = n.reduceFieldDef((e, t, r) => {
            const s = ct(r) && n.getScaleComponent(r);
            if (s) {
              const n = s.get('type');
        ...
        assemble() {
          const e = N(this.filter).reduce((e, n) => {
            const t = this.filter[n];
            const i = Du(t, { expr: 'datum' });
            if (t !== null) {
              if (t.type === 'temporal') {
      ...
      class ux extends ep {
        clone() {
          return new ux(this.parent, b(this.transform));
        }
        constructor(e, n) {
          super(e);
          this.transform = n;
      ...
      class cx extends ep {
        clone() {
          return new cx(null, b(this.transform));
        }
        constructor(e, n) {
          var t, i, r;
          super(e);
      ...
      class lx extends ep {
        clone() {
          return new lx(null, b(this.fields), this.geojson, this.signal);
        }
        static parseAll(e, n) {
          ...
          for (const i of [
            ...
            if (r[0] || r[1]) {
              e = new lx(e, r, null, n.getName(`geojson_${t++}`));
            }
          }
          if (n.channelHasField(De)) {
            const i = n.typedFieldDef(De);
            if (i.type === Xs) {
              e = new lx(e, null, i.field, n.getName(`geojson_${t++}`));
            }
          }
          return e;
        }
        ...
        hash() {
          return `GeoJSON ${this.geojson} ${this.signal} ${w(this.fields)}`;
        }
        assemble() {
          return [
            ...(this.geojson
      ...
      class fx extends ep {
        clone() {
          return new fx(null, this.projection, b(this.fields), b(this.as));
        }
        constructor(e, n, t, i) {
          super(e);
          this.projection = n;
        ...
        dependentFields() {
          return new Set(this.fields.filter(r.Kg));
        }
        producedFields() {
          return new Set(this.as);
        }
        hash() {
          return `Geopoint ${this.projection} ${w(this.fields)} ${w(this.as)}`;
        }
        assemble() {
          return {
            type: 'geopoint',
      ...
      class dx extends ep {
        clone() {
          return new dx(null, b(this.transform));
        }
        constructor(e, n) {
          super(e);
          this.transform = n;
            ...
            Object.assign(
              Object.assign(
                Object.assign(
                  ...
                  t ? { keyvals: Rf(t) ? this.processSequence(t) : t } : {}
                ),
                { method: 'value' }
              ),
              r ? { groupby: r } : {}
      ...
      class gx extends ep {
        clone() {
          return new gx(null, b(this.transform));
        }
        constructor(e, n) {
          var t, i, r;
          super(e);
      ...
      class mx extends ep {
        clone() {
          return new mx(null, b(this.transform), this.secondary);
        }
        constructor(e, n, t) {
          super(e);
          this.transform = n;
        ...
        static make(e, n, t, i) {
          ...
          if (Wf(s)) {
            ...
            o = new np(e, t, Rd.Lookup, n.component.data.outputNodeRefCounts);
            ...
            let i;
            try {
              i = n.getSelectionComponent(q(e), e);
            } catch (a) {
              throw new Error(Fi(e));
            }
            o = i.materialized;
        ...
        producedFields() {
          return new Set(
            this.transform.as
              ? (0, r.YO)(this.transform.as)
              : this.transform.from.fields
          );
        }
        hash() {
          return `Lookup ${w({ transform: this.transform, secondary: this.secondary })}`;
        }
        assemble() {
          let e;
          if (this.transform.from.fields) {
            e = Object.assign(
              ...
              this.transform.as ? { as: (0, r.YO)(this.transform.as) } : {}
            );
          } else {
      ...
      class bx extends ep {
        clone() {
          return new bx(null, b(this.transform));
        }
        constructor(e, n) {
          var t, i, r;
          super(e);
      ...
      class vx extends ep {
        clone() {
          return new vx(null, b(this.transform));
        }
        constructor(e, n) {
          var t, i, r;
          super(e);
      ...
      class Ox extends ep {
        ...
        addDimensions(e) {
          var n;
          this.transform.groupby = C(
            ((n = this.transform.groupby) !== null && n !== void 0
              ? n
              : []
            ).concat(e),
            (e) => e
      ...
      class xx extends ep {
        clone() {
          return new xx(null, b(this.transform));
        }
        constructor(e, n) {
          super(e);
          this.transform = n;
      ...
      function wx(e) {
        ...
        function t(i, r) {
          ...
          if (i instanceof cv) {
            if (i.parent instanceof pv && !r.source) {
              r.format = Object.assign(
                Object.assign(
                  {},
                  (s = r.format) !== null && s !== void 0 ? s : {}
                ),
      ...
      function Fx(e, n) {
        ...
        for (const [u, c] of r.entries()) {
          if (
            ((t = c.transform) !== null && t !== void 0 ? t : []).length ===
              0 &&
            !c.source
          ) {
      ...
      function Ax(e, n) {
        ...
        if (e.channelHasField(n)) {
          const u = i[n];
          const c = Bb('title', null, s, n);
          let l = Nu(u, s, {
            allowDisabling: true,
            includeDefault: c === undefined || !!c
          });
          if (o.component.layoutHeaders[n].title) {
            l = (0, r.cy)(l) ? l.join(', ') : l;
            l += ` / ${o.component.layoutHeaders[n].title}`;
            o.component.layoutHeaders[n].title = null;
          }
          const f = Bb('labelOrient', u.header, s, n);
          const d =
            u.header !== null
              ? X(
                  (t = u.header) === null || t === void 0 ? void 0 : t.labels,
                  s.header.labels,
                  true
                )
              : false;
          const p = F(['bottom', 'right'], f) ? 'footer' : 'header';
          a.layoutHeaders[n] = {
        ...
        if (i.component.axes[n]) {
          ...
          if (s.axis[n] === 'shared') {
            ...
            for (const r of i.component.axes[n]) {
              const n = $x(r.get('orient'));
              (t = o[n]) !== null && t !== void 0
                ? t
                : (o[n] = [kx(e, s, false)]);
              const i = ub(r, 'main', e.config, { header: true });
              if (i) {
                o[n][0].axes.push(i);
              }
      ...
      function Px(e, n) {
        ...
        for (const u of e.children) {
          ...
          const o = (t = s.scale[r]) !== null && t !== void 0 ? t : Zb(r, e);
      ...
      function _x(e) {
        ...
        for (const i of Un) {
          ...
          if (n[r]) {
            const e = n[r];
            t.layoutSize.set(r, Bl(e) ? 'step' : e, true);
          } else {
            const n = zx(e, r);
      ...
      class Tx extends rx {
        constructor(e, n, t, i) {
          ...
          this.child = Uw(e.spec, this, this.getName('child'), undefined, i);
        ...
        getHeaderLayoutMixins() {
          ...
          for (const r of Je) {
            for (const s of zb) {
              ...
              if (u) {
                const n = Bb('titleOrient', u.header, this.config, r);
        ...
        columnDistinctSignal() {
          if (this.parent && this.parent instanceof Tx) {
            return undefined;
          } else {
                ...
                this.channelHasField('column')
                  ? {
                      encode: {
                        update: {
                          columns: {
                            field: Du(this.facet.column, { prefix: 'distinct' })
                          }
                        }
                      }
                    }
        ...
        getCardinalityAggregateForChild() {
          ...
          const n = [];
          const t = [];
          if (this.child instanceof Tx) {
            if (this.child.channelHasField('column')) {
              const i = Du(this.child.facet.column);
              e.push(i);
              n.push('distinct');
              t.push(`distinct_${i}`);
            }
        ...
        assembleFacet() {
          ...
          const u = [];
          for (const l of Je) {
            const e = this.facet[l];
            if (e) {
              u.push(Du(e));
              const { bin: n, sort: c } = e;
              if (At(n)) {
                u.push(Du(e, { binSuffix: 'end' }));
              }
              if (Ka(c)) {
                const { field: n, op: r = Wa } = c;
                const u = Nx(e, c);
                if (t && i) {
                  s.push(u);
                  o.push('max');
        ...
        facetSortFields(e) {
          ...
          if (t) {
            if (Ka(t.sort)) {
              return [Nx(t, t.sort, { expr: 'datum' })];
            } else if ((0, r.cy)(t.sort)) {
              return [Sb(t, e, { expr: 'datum' })];
            }
            return [Du(t, { expr: 'datum' })];
          }
          return [];
        }
        facetSortOrder(e) {
          ...
          if (t) {
            const { sort: e } = t;
            const n = (Ka(e) ? e.order : !(0, r.cy)(e) && e) || 'ascending';
            return [n];
          }
          return [];
        }
              ...
              Object.assign(
                Object.assign(
                  ...
                  ),
                  {
                    ...
                    sort: {
                      field: Je.map((e) => this.facetSortFields(e)).flat(),
                      order: Je.map((e) => this.facetSortOrder(e)).flat()
                    }
                  }
                ),
                t.length > 0 ? { data: t } : {}
      ...
      function Mx(e, n) {
        ...
        if (t && i) {
          ...
          for (const r of [t, i]) {
            if (Ka(r.sort)) {
              const { field: t, op: i = Wa } = r.sort;
              e = n = new Bv(e, {
                joinaggregate: [
                  { op: i, field: t, as: Nx(r, r.sort, { forAs: true }) }
                ],
                groupby: [Du(r)]
              });
            }
      ...
      function Lx(e, n) {
        ...
        for (const o of n) {
          ...
          const a =
            (t = e['format']) === null || t === void 0 ? void 0 : t.mesh;
          const u =
            (i = n.format) === null || i === void 0 ? void 0 : i.feature;
          if (a && u) {
            continue;
          }
          const c =
            (r = e['format']) === null || r === void 0 ? void 0 : r.feature;
          if ((c || u) && c !== u) {
            continue;
          }
      ...
      function qx(e, n) {
        if (e.data || !e.parent) {
          ...
          if (t) {
            if (!Md(e.data)) {
              t.data.format = A({}, e.data.format, t.data.format);
            }
      ...
      function Ux(e, n, t) {
        ...
        for (const o of n.transforms) {
          ...
          if (nd(o)) {
            ...
            const r = ov(o);
            u = e =
              (i = cv.makeWithAncestors(e, {}, r, t)) !== null && i !== void 0
                ? i
                : e;
            e = new Zh(e, n, o.filter);
          } else if (td(o)) {
            u = e = Zy.makeFromTransform(e, o, n);
            a = 'number';
          } else if (rd(o)) {
            a = 'date';
            const n = t.getWithExplicit(o.field);
            if (n.value === undefined) {
              e = new cv(e, { [o.field]: a });
              t.set(o.field, a, false);
            }
            u = e = ip.makeFromTransform(e, o);
          } else if (sd(o)) {
            u = e = tv.makeFromTransform(e, o);
            a = 'number';
            if (Tg(n)) {
              e = new lv(e);
            }
      ...
      function Rx(e) {
        ...
        let f = qx(e, e.component.data.sources);
        const { outputNodes: d, outputNodeRefCounts: p } = e.component.data;
        const g = e.data;
        const m = g && (Md(g) || zd(g) || Nd(g));
        const h =
          !m && e.parent
        ...
        if (Md(g)) {
          if (Ld(g)) {
            f = new dv(f, g.sequence);
          } else if (Ud(g)) {
            f = new fv(f, g.graticule);
          }
          h.parseNothing = true;
        } else if (
          ((n = g === null || g === void 0 ? void 0 : g.format) === null ||
          n === void 0
            ? void 0
            : n.parse) === null
        ) {
        ...
        f = (t = cv.makeExplicit(f, e, h)) !== null && t !== void 0 ? t : f;
        f = new lv(f);
        const b = e.parent && tx(e.parent);
        if (ZO(e) || ex(e)) {
          if (b) {
            f =
              (i = Zy.makeFromEncoding(f, e)) !== null && i !== void 0 ? i : f;
          }
        }
        ...
        if (ZO(e) || ex(e)) {
          if (!b) {
            f =
              (s = Zy.makeFromEncoding(f, e)) !== null && s !== void 0 ? s : f;
          }
          f = (o = ip.makeFromEncoding(f, e)) !== null && o !== void 0 ? o : f;
          f = Cb.parseAllForSortIndex(f, e);
        }
        const O = e.getDataName(Rd.Raw);
        const x = new np(f, O, Rd.Raw, p);
        d[O] = x;
        f = x;
        if (ZO(e)) {
          const n = tv.makeFromEncoding(f, e);
          if (n) {
            f = n;
            if (Tg(e)) {
              f = new lv(f);
          ...
          f = (a = dx.makeFromEncoding(f, e)) !== null && a !== void 0 ? a : f;
          f = (u = zv.makeFromEncoding(f, e)) !== null && u !== void 0 ? u : f;
        }
        if (ZO(e)) {
          f = (c = ax.make(f, e)) !== null && c !== void 0 ? c : f;
        }
        const w = e.getDataName(Rd.Main);
        const j = new np(f, w, Rd.Main, p);
        d[w] = j;
        f = j;
        if (ZO(e)) {
          ib(e, j);
        ...
        if (ex(e)) {
          ...
          f = (l = Mx(f, e.facet)) !== null && l !== void 0 ? l : f;
          F = new iv(f, e, n, j.getSource());
          d[n] = F;
        }
      ...
      class Ix extends ix {
        constructor(e, n, t, i) {
          ...
          if (
            ((s =
              (r = e.resolve) === null || r === void 0 ? void 0 : r.axis) ===
              null || s === void 0
              ? void 0
              : s.x) === 'shared' ||
            ((a =
              (o = e.resolve) === null || o === void 0 ? void 0 : o.axis) ===
              null || a === void 0
              ? void 0
              : a.y) === 'shared'
          ) {
          ...
          this.children = this.getChildren(e).map((e, n) =>
            Uw(e, this, this.getName(`concat_${n}`), undefined, i)
          );
        }
        parseData() {
          this.component.data = Rx(this);
        ...
        parseSelections() {
          ...
          for (const e of this.children) {
            e.parseSelections();
            for (const n of N(e.component.selection)) {
        ...
        assembleDefaultLayout() {
          ...
          return Object.assign(
            Object.assign({}, e != null ? { columns: e } : {}),
      ...
      const Hx = Object.assign(
        Object.assign({ disable: 1, gridScale: 1, scale: 1 }, sc),
      ...
      class Yx extends kd {
        ...
        clone() {
          return new Yx(b(this.explicit), b(this.implicit), this.mainExtracted);
        }
        hasAxisPart(e) {
          if (e === 'axis') {
            return true;
        ...
        hasOrientSignalRef() {
          return Tt(this.explicit.orient);
        }
      }
      function Kx(e, n, t) {
        var i;
        const { encoding: r, config: s } = e;
        const o = (i = Ru(r[n])) !== null && i !== void 0 ? i : Ru(r[yn(n)]);
        const a = e.axis(n) || {};
        ...
        } else if (u === undefined && c === undefined && s.customFormatTypes) {
          if (du(o) === 'quantitative') {
            if (
              xu(o) &&
              o.stack === 'normalize' &&
              s.normalizedNumberFormatType
            ) {
              return Object.assign(
                {
                  text: za({
      ...
      const Qx = { bottom: 'top', top: 'bottom', left: 'right', right: 'left' };
      function Xx(e) {
        var n;
        ...
        for (const s of e.children) {
          ...
          for (const n of N(s.component.axes)) {
            i.axis[n] = ey(e.component.resolve, n);
            if (i.axis[n] === 'shared') {
              t[n] = Jx(t[n], s.component.axes[n]);
              if (!t[n]) {
            ...
            (e, n) => {
              switch (t) {
                case 'title':
                  return li(e, n);
                case 'gridScale':
                  return { explicit: e.explicit, value: X(e.value, n.value) };
              }
              return Bd(e, n, t, 'axis');
            }
          );
      ...
      function ew(e, n, t, i, r) {
        ...
        switch (n) {
          case 'titleAngle':
          case 'labelAngle':
            return e === (Tt(t.labelAngle) ? t.labelAngle : ie(t.labelAngle));
          case 'values':
            return !!t.values;
          case 'encode':
      ...
      function tw(e, n) {
        ...
        const p =
          s !== undefined
            ...
            : gb(
                'disable',
                c.style,
                s === null || s === void 0 ? void 0 : s.style,
                d
              ).configValue;
        ...
        for (const y of Gx) {
          const t = y in mb ? mb[y](m) : ac(y) ? s[y] : undefined;
          const i = t !== undefined;
          const r = ew(t, y, s, n, e);
          if (i && r) {
            o.set(y, t, r);
          } else {
            const { configValue: e = undefined, configFrom: n = undefined } =
              ac(y) && y !== 'values' ? gb(y, c.style, s.style, d) : {};
            const a = e !== undefined;
            if (i && !a) {
              o.set(y, t, r);
            } else if (
        ...
        const b = ic.reduce((t, i) => {
          var r;
          if (!o.hasAxisPart(i)) {
            return t;
          }
          const s = Jb((r = h[i]) !== null && r !== void 0 ? r : {}, n);
          const a = i === 'labels' ? Kx(n, e, s) : s;
          if (a !== undefined && !z(a)) {
            t[i] = { update: a };
          }
          return t;
      ...
      function rw(e, n, t) {
        ...
        if (i.type === 'bar' && i.orient) {
          ...
          if (e !== undefined) {
            const t =
              (i.orient === 'horizontal' && n.x2) ||
              (i.orient === 'vertical' && n.y2)
                ? ['cornerRadius']
                : ma[i.orient];
            for (const n of t) {
              i[n] = e;
      ...
      function aw(e, n, { graticule: t }) {
        if (t) {
          return false;
        }
        const i = ri('filled', e, n);
        const r = e.type;
        return X(i, r !== Wo && r !== Io && r !== Go);
      }
      function uw(e, n, t) {
        switch (e) {
          case Wo:
        ...
        switch (e) {
          case Uo:
            if (
              fu(i) &&
              (kt(i.bin) || (fu(r) && r.aggregate && !i.aggregate))
            ) {
              return 'vertical';
            }
            if (
              fu(r) &&
              (kt(r.bin) || (fu(i) && i.aggregate && !r.aggregate))
            ) {
              return 'horizontal';
            }
            if (o || s) {
              ...
              if (!s) {
                if ((fu(i) && i.type === Ys && !At(i.bin)) || hu(i)) {
                  if (fu(r) && kt(r.bin)) {
                    return 'horizontal';
                  }
                }
              ...
              if (!o) {
                if ((fu(r) && r.type === Ys && !At(r.bin)) || hu(r)) {
                  if (fu(i) && kt(i.bin)) {
                    return 'vertical';
                  }
                }
          ...
          case Go:
            if (s && !(fu(i) && kt(i.bin)) && o && !(fu(r) && kt(r.bin))) {
              return undefined;
            }
          case qo:
            if (o) {
            ...
            Object.assign(
              Object.assign(
                Object.assign(
                  ...
                  zp('x', e, { defaultPos: 'mid' })
                ),
                zp('y', e, { defaultPos: 'mid' })
              ),
              Gp(e, 'radius')
            ),
            Gp(e, 'theta')
        ...
        encodeEntry: (e) =>
          Object.assign(
            Object.assign(
              ...
              Ep('size', e, { vgChannel: 'strokeWidth' })
            ),
            ig(e)
          )
      };
      ...
      const yw = { vgMark: 'symbol', encodeEntry: (e) => hw(e) };
      const vw = { vgMark: 'symbol', encodeEntry: (e) => hw(e, 'circle') };
      const Ow = { vgMark: 'symbol', encodeEntry: (e) => hw(e, 'square') };
      const xw = {
        vgMark: 'rect',
        encodeEntry: (e) =>
          Object.assign(
                ...
                Object.assign(
                  Object.assign(
                    Object.assign(
                      ...
                      Ep('size', e, { vgChannel: 'fontSize' })
                    ),
                    Ep('angle', e)
                  ),
                  sg('align', Fw(e.markDef, t, n))
                ),
                sg('baseline', $w(e.markDef, t, n))
              ),
              zp('radius', e, { defaultPos: null })
            ),
            zp('theta', e, { defaultPos: null })
          );
        }
      };
      function Fw(e, n, t) {
            ...
            Object.assign(
              Object.assign(
                Object.assign(
                  ...
                  zp('x', e, { defaultPos: 'mid', vgChannel: 'xc' })
                ),
                zp('y', e, { defaultPos: 'mid', vgChannel: 'yc' })
              ),
              Ep('size', e, { defaultValue: Aw(e), vgChannel: r })
            ),
            { [s]: Xt(ii('thickness', t, n)) }
          );
        }
      };
      function Aw(e) {
        ...
        const u =
          (n = ii('size', i, t, { vgChannel: o })) !== null && n !== void 0
            ? n
            : t.tick.bandSize;
        if (u !== undefined) {
          return u;
      ...
      function Cw(e) {
        if (F([Io, qo, Vo], e.mark)) {
          const n = $c(e.mark, e.encoding);
          if (n.length > 0) {
            return Ew(e, n);
          }
        } else if (e.mark === Uo) {
          const n = Ht.some((n) => ii(n, e.markDef, e.config));
        ...
        return [
          {
            ...
            from: {
              facet: {
                name: Sw + e.requestDataName(Rd.Main),
                data: e.requestDataName(Rd.Main),
                groupby: n
              }
            },
            encode: {
            ...
            marks: zw(e, { fromPrefix: Sw })
          }
        ];
      }
      const Bw = 'stack_group_';
      function Pw(e) {
        var n;
        const [t] = zw(e, { fromPrefix: Bw });
        ...
        if (e.stack.fieldChannel === 'x') {
          o = Object.assign(
            Object.assign(
              {},
              v(t.encode.update, ['y', 'yc', 'y2', 'height', ...Ht])
            ),
            {
          ...
          t.encode.update = Object.assign(
            Object.assign({}, O(t.encode.update, ['y', 'yc', 'y2'])),
            { height: { field: { group: 'height' } } }
          );
        } else {
          o = Object.assign(
            Object.assign({}, v(t.encode.update, ['x', 'xc', 'x2', 'width'])),
            {
          ...
          t.encode.update = Object.assign(
            Object.assign({}, O(t.encode.update, ['x', 'xc', 'x2'])),
            { width: { field: { group: 'width' } } }
          );
        }
        for (const l of Ht) {
          const n = ri(l, e.markDef, e.config);
          if (t.encode.update[l]) {
            o[l] = t.encode.update[l];
            delete t.encode.update[l];
          } else if (n) {
            o[l] = Xt(n);
          }
          if (n) {
            t.encode.update[l] = { value: 0 };
          }
        }
        const u = [];
        if (
          ((n = e.stack.groupbyChannels) === null || n === void 0
            ? void 0
            : n.length) > 0
        ) {
          for (const n of e.stack.groupbyChannels) {
            ...
            if (
              (t === null || t === void 0 ? void 0 : t.bin) ||
              (t === null || t === void 0 ? void 0 : t.timeUnit)
            ) {
              u.push(Du(t, { binSuffix: 'end' }));
            }
          }
        }
        const c = [
        ...
        o = c.reduce((n, i) => {
          if (t.encode.update[i]) {
            ...
            if (t !== undefined) {
              return Object.assign(Object.assign({}, n), { [i]: Xt(t) });
            } else {
              return n;
            }
          }
        ...
        return [
          {
            ...
            from: {
              facet: {
                data: e.requestDataName(Rd.Main),
                name: Bw + e.requestDataName(Rd.Main),
                groupby: u,
                aggregate: {
                  fields: [
                    r({ suffix: 'start' }),
      ...
      function _w(e) {
        ...
        const u = t.order;
        if (
          (!(0, r.cy)(u) && vu(u) && j(u.value)) ||
          (!u && j(ii('order', o, a)))
        ) {
          return undefined;
        } else if (((0, r.cy)(u) || fu(u)) && !i) {
          return ai(u, { expr: 'datum' });
        } else if (ea(s)) {
          ...
          if (fu(s)) {
            ...
            if ((0, r.cy)(t)) {
              return {
                field: Du(s, { prefix: i, suffix: 'sort_index', expr: 'datum' })
              };
            } else if (Ka(t)) {
              return {
                field: Du(
                  {
                    aggregate: bc(e.encoding) ? t.op : undefined,
                    field: t.field
                  },
                  { expr: 'datum' }
                )
              ...
              return { field: Du(n, { expr: 'datum' }), order: t.order };
            } else if (t === null) {
              return undefined;
            } else {
              return {
      ...
      function zw(e, n = { fromPrefix: '' }) {
        const { mark: t, markDef: i, encoding: r, config: s } = e;
        const o = X(i.clip, Nw(e), Tw(e));
        const a = ti(i);
        const u = r.key;
        const c = _w(e);
        const l = Mw(e);
        const f = ii('aria', i, s);
        const d = kw[t].postEncodingTransform
          ? kw[t].postEncodingTransform(e)
          : null;
        return [
          Object.assign(
            Object.assign(
                ...
                Object.assign(
                  Object.assign(
                    Object.assign(
                      Object.assign(
                        Object.assign(
                          { name: e.getName('marks'), type: kw[t].vgMark },
                          o ? { clip: true } : {}
                        ),
                        a ? { style: a } : {}
                      ),
              ...
              {
                from: { data: n.fromPrefix + e.requestDataName(Rd.Main) },
                encode: { update: kw[t].encodeEntry(e) }
              }
            ),
            d ? { transform: d } : {}
          )
      ...
      function Nw(e) {
        ...
        return (n === null || n === void 0
          ...
          (t === null || t === void 0 ? void 0 : t.get('selectionExtent'))
          ? true
          : undefined;
      }
      function Tw(e) {
      ...
      function Mw(e) {
        ...
        const n = N(e.component.selection).length;
        let t = n;
        let i = e.parent;
        while (i && t === 0) {
          t = N(i.component.selection).length;
          i = i.parent;
        }
      ...
      class Lw extends rx {
        constructor(e, n, t, i = {}, r) {
          var s;
          super(e, 'unit', n, t, r, undefined, Pl(e) ? e.view : undefined);
          ...
          if (o.filled === undefined) {
            o.filled = aw(o, r, { graticule: e.data && Ud(e.data) });
          }
          const u = (this.encoding = Oc(e.encoding || {}, a, o.filled, r));
          this.markDef = rw(o, u, r);
          this.size = iw({
            encoding: u,
            size: Pl(e)
              ? Object.assign(
          ...
          this.selection = (
            (s = e.params) !== null && s !== void 0 ? s : []
          ).filter((e) => Fl(e));
        }
        get hasProjection() {
          const { encoding: e } = this;
          const n = this.mark === Jo;
          const t = e && Ke.some((n) => bu(e[n]));
          return n || t;
        }
        scaleDomain(e) {
        ...
        initScales(e, n) {
          return ut.reduce((e, t) => {
            var i;
            const r = Ru(n[t]);
            if (r) {
              e[t] = this.initScale(
                (i = r.scale) !== null && i !== void 0 ? i : {}
              );
            }
            return e;
          }, {});
        ...
        initAxes(e) {
          return Un.reduce((n, t) => {
            const i = e[t];
            if (bu(i) || (t === ce && bu(e.x2)) || (t === le && bu(e.y2))) {
              const e = bu(i) ? i.axis : undefined;
        ...
        parseSelections() {
          this.component.selection = eb(this, this.selection);
        }
        parseMarkGroup() {
          this.component.mark = Cw(this);
        }
        parseAxesAndHeaders() {
          this.component.axes = Vx(this);
        }
        assembleSelectionTopLevelSignals(e) {
          return Kd(this, e);
        }
        assembleSignals() {
          return [...cb(this), ...Gd(this, [])];
        }
        assembleSelectionData(e) {
          return Vd(this, e);
        }
      ...
      class qw extends ix {
        constructor(e, n, t, i, r) {
          ...
          this.children = e.layer.map((e, n) => {
            if (cf(e)) {
              return new qw(e, this, this.getName(`layer_${n}`), s, r);
            } else if (fc(e)) {
              return new Lw(e, this, this.getName(`layer_${n}`), s, r);
            }
            throw new Error(fi(e));
          });
        }
        ...
        assembleGroupStyle() {
          ...
          for (const t of this.children) {
            for (const n of (0, r.YO)(t.assembleGroupStyle())) {
              e.add(n);
            }
          }
      ...
      function Uw(e, n, t, i, r) {
        if (Ja(e)) {
          ...
          return new qw(e, n, t, i, r);
        } else if (fc(e)) {
          return new Lw(e, n, t, i, r);
        } else if (Al(e)) {
          return new Ix(e, n, t, r);
        }
        throw new Error(fi(e));
      }
      var Rw =
      ...
      function Iw(e, n = {}) {
        ...
        try {
          const t = nf((0, r.io)(n.config, e.config));
          const i = bd(e, t);
          const s = Uw(i, null, '', undefined, t);
          s.parse();
          Hv(s.component.data, s);
          const o = Hw(s, Ww(e, i.autosize, t, s), e.datasets, e.usermeta);
          ...
          function g(s, a) {
            ...
            if (Object.getOwnPropertySymbols) {
              ...
              for (var y = 0; y < O.length; y++) {
                var x = O[y];
                var w = Object.getOwnPropertyDescriptor(s, x);
                if (w && !w.enumerable && !l) {
                  continue;
                }
                m[x] = g(s[x], a - 1);
            ...
            if (l) {
              ...
              for (var y = 0; y < j.length; y++) {
                var F = j[y];
                var w = Object.getOwnPropertyDescriptor(s, F);
                if (w && w.enumerable) {
                  continue;
                }
                m[F] = g(s[F], a - 1);
                Object.defineProperty(m, F, { enumerable: false });
              }
            }
            return m;
          }
