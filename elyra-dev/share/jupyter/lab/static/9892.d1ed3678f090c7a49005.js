/*! For license information please see 9892.d1ed3678f090c7a49005.js.LICENSE.txt */
'use strict';
  ...
  [9892],
  {
              ...
              if (h.has(f)) {
                if (n > e) {
                  const u = {
                    ...
                    expression:
                      r.length > 1
                        ? { type: 'Alternative', expressions: r }
                        : r.length === 1
                          ? r[0]
                          : null
                  };
        ...
        Group(u) {
          ...
          if (e !== -1) {
            b.push({
              oldGroupNumber: e,
              newGroupNumber: r,
              measurementGroups: d && d.map((u) => u.number),
              groupName: u.node.name
            });
            C.set(e, r);
          }
          u.update({ number: r });
    ...
    85162: (u) => {
      ...
      function t(u) {
            ...
            for (
              ...
              try {
                u: for (
                  ...
                  try {
                    for (
                      var O = Object.keys(g)[Symbol.iterator](), R;
                      !(w = (R = O.next()).done);
                      w = true
                    ) {
                      var N = R.value;
        ...
        try {
          for (
            var A = v.entries()[Symbol.iterator](), k;
            !(C = (k = A.next()).done);
            C = true
          ) {
            var P = k.value;
      ...
      function n(u, e) {
        ...
        for (var r = 0; r < u.length; r++) {
          ...
          if (
            [].concat(d(a)).sort().join(',') !==
            [].concat(d(t)).sort().join(',')
          ) {
            return false;
          }
        }
    ...
    70860: (u, e, r) => {
      ...
      function o(u) {
        for (
          var e = arguments.length, r = Array(e > 1 ? e - 1 : 0), d = 1;
          d < e;
          d++
        ) {
          r[d - 1] = arguments[d];
        ...
        d(e, [
          {
            ...
            value: function u(e) {
              ...
              if (e.length === 0) {
                ...
                try {
                  for (
                    var n = this.getTransitionsOnSymbol(c)[Symbol.iterator](),
                      f;
                    !(d = (f = n.next()).done);
                    d = true
                  ) {
              ...
              try {
                for (
                  var S = this.getTransitionsOnSymbol(c)[Symbol.iterator](), x;
                  !(m = (x = S.next()).done);
                  m = true
                ) {
                  var A = x.value;
          ...
          },
          {
            ...
            value: function u() {
              if (!this._acceptingStateNumbers) {
                ...
                try {
                  for (
                    var a = this.getAcceptingStates()[Symbol.iterator](), t;
                    !(e = (t = a.next()).done);
                    e = true
                  ) {
                    var n = t.value;
            ...
            value: function u() {
              ...
              if (!this._transitionTable) {
                ...
                r.forEach(function (u) {
                  ...
                  e._transitionTable[u.number][c] = []
                    .concat(t(u.getEpsilonClosure()))
                    .map(function (u) {
                      return u.number;
                    });
                });
    ...
    70436: (u) => {
      ...
      function d(u) {
        ...
        return (
          u.type === 'Char' &&
          u.kind === 'meta' &&
          (e ? u.value === e : /^\\[dws]$/i.test(u.value))
        );
      }
      function a(u) {
      ...
      function o(u, e) {
        if (e && e.type === 'ClassRange') {
          if (l(u, e)) {
            ...
            u.type === 'ClassRange' &&
            u.from.codePoint <= e.to.codePoint + 1 &&
            u.to.codePoint >= e.from.codePoint - 1
          ) {
    ...
    4090: (u) => {
      ...
      function n(u) {
        return (
          u.type === 'ClassRange' && u.from.value === '0' && u.to.value === '9'
        );
      }
      function f(u, e) {
        var r =
      ...
      function c(u) {
        return (
          u.type === 'ClassRange' && u.from.value === 'a' && u.to.value === 'z'
        );
      }
      function o(u) {
        return (
      ...
      function f(u, e, r) {
        ...
        while (f < n) {
          ...
          if (f === 0) {
            ...
            c = a.getForNode({
              type: 'Alternative',
              expressions: [].concat(d(t.expressions.slice(r - f, r)), [e.node])
            });
            o = a.getForNode({
              type: 'Alternative',
              expressions: [].concat(d(t.expressions.slice(i, r - f)))
            });
          }
          if (c.hasEqualSource(o)) {
            ...
            e.replace({
              type: 'Repetition',
              expression:
                f === 0 && c.node.type !== 'Repetition'
                  ? c.node
                  : { type: 'Group', capturing: false, expression: c.node },
              quantifier: {
                type: 'Quantifier',
                kind: 'Range',
                from: 2,
        ...
        while (f < r) {
          ...
          if (i.node.type === 'Repetition' && i.node.quantifier.greedy) {
            ...
            if (f + 1 === r) {
              ...
              o = a.getForNode({
                type: 'Alternative',
                expressions: [].concat(d(t.expressions.slice(f + 1, r + 1)))
              });
            }
            if (c.hasEqualSource(o)) {
              for (var s = f; s < r; s++) {
      ...
      function c(u, e, r) {
        ...
        if (e.node.type === 'Repetition' && e.node.quantifier.greedy) {
          ...
          if (f.node.type === 'Alternative') {
            ...
            i = a.getForNode({
              type: 'Alternative',
              expressions: [].concat(d(t.expressions.slice(r - c, r)))
            });
          } else {
            c = 1;
            i = u.getChild(r - 1);
    ...
    53256: (u, e, r) => {
      u.exports = new Map([
        ['charSurrogatePairToSingleUnicode', r(8988)],
        ['charCodeToSimpleChar', r(88111)],
        ['charCaseInsensitiveLowerCaseTransform', r(98002)],
        ['charClassRemoveDuplicates', r(322)],
        ['quantifiersMerge', r(31837)],
        ['quantifierRangeToSymbol', r(88190)],
        ['charClassClassrangesToChars', r(76953)],
        ['charClassToMeta', r(4090)],
        ['charClassToSingleChar', r(11810)],
        ['charEscapeUnescape', r(6632)],
        ['charClassClassrangesMerge', r(70436)],
        ['disjunctionRemoveDuplicates', r(61013)],
        ['groupSingleCharsToCharClass', r(5808)],
        ['removeEmptyGroup', r(72097)],
        ['ungroup', r(95435)],
        ['combineRepeatingPatterns', r(97648)]
      ]);
    },
    88190: (u) => {
      u.exports = {
    ...
    31837: (u, e, r) => {
        ...
        Repetition: function u(e) {
          ...
          if (f.node.type === 'Repetition') {
            ...
            var s = n(r.quantifier),
              ...
              b = s.to;
            if (
              f.node.quantifier.greedy !== r.quantifier.greedy &&
              !t(f.node.quantifier) &&
              !t(r.quantifier)
            ) {
              return;
      ...
      function t(u) {
        return (
          u.greedy &&
          (u.kind === '+' || u.kind === '*' || (u.kind === 'Range' && !u.to))
        );
      }
      function n(u) {
        var e = void 0,
          ...
          if (n.node.type === 'Alternative') {
            ...
            if (f.node.type === 'Alternative') {
              f.replace({
                type: 'Alternative',
                expressions: [].concat(
                  e(t.expressions.slice(0, d.index)),
                  e(n.node.expressions),
                  e(t.expressions.slice(d.index + 1))
                )
              });
            }
          } else {
    ...
    97e3: (u, e, r) => {
      ...
      var l = [
          ...
          function (u, e, r, d, a, t) {
            ...
            if (!f.options.allowGroupNameDuplicates && S.hasOwnProperty(s)) {
              throw new SyntaxError(
                'Duplicate of the named group "' + s + '".'
              );
            }
            S[s] = u.groupNumber;
            i = j(
        ...
        [
          ...
          function (u, e, r, d, a, t) {
            c = o(d, t);
            i = j(
              { type: 'CharacterClass', negative: true, expressions: e },
              c
            );
          }
        ],
        ...
        parse: function u(e, r) {
          ...
          do {
            ...
            if (m[0] === 's') {
              ...
              s = this.onShift(o);
              h.push(
                { symbol: b[s.type], semanticValue: s.value, loc: C },
                Number(m.slice(1))
              );
              o = v.getNextToken();
            } else if (m[0] === 'r') {
      ...
      function w(u, e) {
        ...
        if (n) {
          ...
          if (!P.isValidValue(a, t)) {
            throw new SyntaxError(
              'Invalid ' + a + ' unicode property value: ' + t + '.'
            );
          }
        }
        return j(
      ...
      function E(u, e, r) {
        ...
        return j(
          { type: 'Char', value: u, kind: e, symbol: a, codePoint: t },
          r
        );
      }
      var T = 'gimsuxy';
      ...
      function R(u, e) {
        ...
        if (r > 0 && r <= C) {
          return j(
            { type: 'Backreference', kind: 'number', number: r, reference: r },
            e
          );
        }
      ...
      function F(u, e) {
        ...
        if (r && !d) {
          throw new SyntaxError(
            'invalid group Unicode name "' + u + '", use `u` flag.'
          );
        }
        return u;
      }
    ...
    33166: (u) => {
      ...
      function r(u) {
        if (u.type !== 'Disjunction') {
          throw new TypeError(
            'Expected "Disjunction" node, got "' + u.type + '"'
          );
        }
        var d = [];
              ...
              try {
                for (
                  ...
                  if (typeof p[e.type] === 'function') {
                    ...
                    typeof p[e.type] === 'object' &&
                    typeof p[e.type].pre === 'function'
                  ) {
                    v = p[e.type].pre;
                  }
                  if (v) {
        ...
        e(
          ...
          [
            ...
            },
            {
              ...
              value: function u(e) {
                return (
                  JSON.stringify(this.node, n) === JSON.stringify(e.node, n)
                );
              }
            },
            {
          ...
          [
            ...
            },
            {
              ...
              value: function e(r) {
                return (u.traversingIndexStack[
                  u.traversingIndexStack.length - 1
                ] += r);
              }
            },
            {
