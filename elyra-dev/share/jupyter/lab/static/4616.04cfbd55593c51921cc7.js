...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [4616],
  {
    44616: (e, t, n) => {
      ...
      function r(e) {
        var t = {};
        for (var n = 0, r = e.length; n < r; ++n) t[e[n]] = true;
        return t;
      }
      var i = [
          'alias',
      ...
      function p(e, t) {
        ...
        var n = e.next(),
          r;
        if (n == '`' || n == "'" || n == '"') {
          return c(m(n, 'string', n == '"' || n == '`'), e, t);
        } else if (n == '/') {
          if (d(e)) return c(m(n, 'string.special', true), e, t);
          else return 'operator';
        } else if (n == '%') {
          var i = 'string',
            a = true;
          if (e.eat('s')) i = 'atom';
          else if (e.eat(/[WQ]/)) i = 'string';
          else if (e.eat(/[r]/)) i = 'string.special';
          else if (e.eat(/[wxq]/)) {
            i = 'string';
            a = false;
          }
          ...
          if (f.propertyIsEnumerable(l)) l = f[l];
          return c(m(l, i, a, true), e, t);
        } else if (n == '#') {
          e.skipToEnd();
          return 'comment';
        } else if (
          ...
          if (e.eat("'")) return c(m("'", 'atom', false), e, t);
          if (e.eat('"')) return c(m('"', 'atom', true), e, t);
          if (e.eat(/[\<\>]/)) {
            e.eat(/[\<\>]/);
            return 'atom';
          }
      ...
      const b = {
        ...
        token: function (e, t) {
          ...
          if (n == 'variable') {
            ...
            if (n == 'keyword') {
              i = f;
              if (l.propertyIsEnumerable(f)) r = 'indent';
              else if (o.propertyIsEnumerable(f)) r = 'dedent';
              else if (
                (f == 'if' || f == 'unless') &&
                e.column() == e.indentation()
              )
                r = 'indent';
              else if (f == 'do' && t.context.indented < t.indented)
                r = 'indent';
            }
          }
          if (s || (n && n != 'comment')) t.lastTok = i;
          if (s == '|') t.varList = !t.varList;
          if (r == 'indent' || /[\(\[\{]/.test(s))
            t.context = { prev: t.context, type: s || n, indented: t.indented };
          else if ((r == 'dedent' || /[\)\]\}]/.test(s)) && t.context.prev)
            t.context = t.context.prev;
          if (e.eol()) t.continuedLine = s == '\\' || n == 'operator';
          return n;
        },
        indent: function (e, t, n) {
          ...
          return i.indented + (a ? 0 : n.unit) + (e.continuedLine ? n.unit : 0);
        },
        languageData: {
