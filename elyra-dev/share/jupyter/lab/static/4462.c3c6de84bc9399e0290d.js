...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [4462],
  {
    84462: (e, t, r) => {
      ...
      var a = ['domain', 'regexp', 'url-prefix', 'url'];
      var n = [
        'all',
        'aural',
        'braille',
      ...
      var b = i.concat(a, n, o, l, s, u, d, c, m, p, f, h);
      function g(e) {
      ...
      var v = k(i),
        ...
        P = g(m),
        U = k(p),
        E = new RegExp(/^\-(moz|ms|o|webkit)-/i),
        O = k(f),
        W = '',
        A = {},
        R,
      ...
      function Z(e, t) {
        ...
        t.context.line.firstWord = W ? W[0].replace(/^\s*/, '') : '';
        ...
        if (R == '.' && e.match(/^\.[a-z][\w-]*/i)) {
          return ['qualifier', 'qualifier'];
        }
        if (e.match(_)) {
          if (e.peek() == '(') t.tokenize = F;
      ...
      function F(e, t) {
        e.next();
        if (!e.match(/\s*[\"\')]/, false)) t.tokenize = D(')');
      ...
      function G(e, t, r, i) {
        i = i >= 0 ? i : t.indentUnit;
        e.context = new I(r, t.indentation() + i, e.context);
        return r;
      }
      function H(e, t, r) {
      ...
      function Q(e) {
        e = e.toLowerCase();
        return e in x || e in N;
      }
      function V(e) {
        return e.toLowerCase() in U;
      }
      function ee(e) {
        return e.toLowerCase().match(E);
      }
      function te(e) {
        var t = e.toLowerCase();
        var r = 'variable';
        if (M(e)) r = 'tag';
        else if (V(e)) r = 'block-keyword';
        else if (Q(e)) r = 'property';
        else if (t in q || t in O) r = 'atom';
        else if (t == 'return' || t in j) r = 'keyword';
      ...
      function ne(e) {
        return e.sol() || e.string.match(new RegExp('^\\s*' + w(e.current())));
      }
      function oe(e) {
      ...
      A.block = function (e, t, r) {
        if ((e == 'comment' && ne(t)) || (e == ',' && oe(t)) || e == 'mixin') {
        ...
        if (/@(font-face|media|supports|(-moz-)?document)/.test(e)) {
          return G(r, t, oe(t) ? 'block' : 'atBlock');
        }
        ...
        if (e && e.charAt(0) == '@') {
          if (t.indentation() > 0 && Q(t.current().slice(1))) {
            Y = 'variable';
            return 'block';
          }
        ...
        if (e == 'word') {
          ...
          if (Y == 'tag') {
            ...
            if (
              t.string.match(new RegExp('\\[\\s*' + i + '|' + i + '\\s*\\]'))
            ) {
              Y = 'atom';
              return 'block';
            }
            if (y.test(i)) {
              if (
                ...
                Y = 'variable';
                if (V(le(t))) return 'block';
                return G(r, t, 'block', 0);
              }
            }
            if (oe(t)) return G(r, t, 'block');
          }
          if (Y == 'block-keyword') {
            Y = 'keyword';
          ...
          if (i == 'return') return G(r, t, 'block', 0);
          if (Y == 'variable' && t.string.match(/^\s?\$[\w-\.\[\]\'\"]+$/)) {
            return G(r, t, 'block');
          }
        }
      ...
      A.parens = function (e, t, r) {
        ...
        if (e == ')') {
          ...
          if (
            (t.string.match(/^[a-z][\w-]*\(/i) && oe(t)) ||
            V(le(t)) ||
            /(\.|#|:|\[|\*|&|>|~|\+|\/)/.test(le(t)) ||
            (!t.string.match(/^-?[a-z][\w-\.\[\]\'\"]*\s*=/) && M(le(t)))
          ) {
            return G(r, t, 'block');
          }
          if (
        ...
        if (e && e.charAt(0) == '@' && Q(t.current().slice(1))) {
          Y = 'variable';
        }
        if (e == 'word') {
          var i = t.current();
      ...
      A.vendorPrefixes = function (e, t, r) {
        if (e == 'word') {
          Y = 'property';
          return G(r, t, 'block', 0);
        }
      ...
      A.atBlock = function (e, t, r) {
        ...
        if (e == 'word') {
          ...
          if (/^(only|not|and|or)$/.test(i)) Y = 'keyword';
          else if ($.hasOwnProperty(i)) Y = 'tag';
          else if (C.hasOwnProperty(i)) Y = 'attribute';
          else if (B.hasOwnProperty(i)) Y = 'property';
          else if (z.hasOwnProperty(i)) Y = 'string.special';
          else Y = te(t.current());
          if (Y == 'tag' && oe(t)) {
            return G(r, t, 'block');
          }
      ...
      A.atBlock_parens = function (e, t, r) {
        ...
        if (e == 'word') {
          var i = t.current().toLowerCase();
          Y = te(i);
          if (/^(max|min)/.test(i)) Y = 'property';
          if (Y == 'tag') {
            y.test(i) ? (Y = 'variable') : (Y = 'atom');
          }
          return r.context.type;
        }
        return A.atBlock(e, t, r);
      };
      ...
      A.interpolation = function (e, t, r) {
        if (e == '{') H(r, t) && G(r, t, 'block');
        if (e == '}') {
          if (
            t.string.match(/^\s*(\.|#|:|\[|\*|&|>|~|\+|\/)/i) ||
            (t.string.match(/^\s*[a-z]/i) && M(le(t)))
          ) {
            return G(r, t, 'block');
          }
      ...
      A.variableName = function (e, t, r) {
        if (
          ...
          if (t.current().match(/^\.[\w-]+/i)) Y = 'variable';
          return 'variableName';
        }
        return K(e, t, r);
      };
          ...
          if (
            ...
            ((a == '}' &&
              (i.type == 'block' ||
                ...
                i.type == 'keyframes')) ||
              (a == ')' &&
                (i.type == 'parens' || i.type == 'atBlock_parens')) ||
              (a == '{' && i.type == 'at'))
          ) {
            n = i.indent - r.unit;
          } else if (!/(\})/.test(a)) {
