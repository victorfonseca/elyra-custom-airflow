...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [4928],
  {
    ...
    /***/ 4928: /***/ function (
      ...
      var Options_js_1 = __webpack_require__(34981);
      var FindTeX_js_1 = __webpack_require__(12787);
      var FilterUtil_js_1 = __importDefault(__webpack_require__(73525));
      ...
      var TeX = (function (_super) {
        ...
        function TeX(options) {
          ...
          _this.findTeX =
            _this.options['FindTeX'] || new FindTeX_js_1.FindTeX(find);
          ...
          var parseOptions = (_this._parseOptions =
            new ParseOptions_js_1.default(configuration, [
              _this.options,
        ...
        TeX.configure = function (packages) {
          var configuration = new Configuration_js_1.ParserConfiguration(
            packages,
            ['tex']
          );
          configuration.init();
        ...
        TeX.prototype.compile = function (math, document) {
          ...
          var globalEnv;
          try {
            var parser = new TexParser_js_1.default(
              this.latex,
          ...
          if (
            globalEnv === null || globalEnv === void 0
              ? void 0
              : globalEnv.indentalign
          ) {
        ...
        TeX.NAME = 'TeX';
        TeX.OPTIONS = __assign(
          __assign({}, InputJax_js_1.AbstractInputJax.OPTIONS),
          {
            FindTeX: null,
            packages: ['base'],
    ...
    /***/ 73525: /***/ function (
      ...
      (function (FilterUtil) {
        FilterUtil.cleanStretchy = function (arg) {
          ...
          try {
            for (
              var _b = __values(options.getList('fixStretchy')), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var mo = _c.value;
              if (NodeUtil_js_1.default.getProperty(mo, 'fixStretchy')) {
                ...
                if (
                  !NodeUtil_js_1.default.getTexClass(mo) &&
                  (!symbol || !symbol[2])
                ) {
        ...
        FilterUtil.cleanAttributes = function (arg) {
          ...
          node.walkTree(function (mml, _d) {
            ...
            var keep = new Set(
              (attribs.get('mjx-keep-attrs') || '').split(/ /)
            );
            delete attribs.getAllAttributes()['mjx-keep-attrs'];
            try {
              for (
                var _b = __values(attribs.getExplicitNames()), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
                var key = _c.value;
        ...
        FilterUtil.combineRelations = function (arg) {
          ...
          try {
            for (
              var _c = __values(arg.data.getList('mo')), _e = _c.next();
              !_e.done;
              _e = _c.next()
            ) {
              var mo = _e.value;
              if (
                ...
                !mo.parent ||
                (mo.parent &&
                  !NodeUtil_js_1.default.isType(mo.parent, 'mrow')) ||
                NodeUtil_js_1.default.getTexClass(mo) !==
              ...
              var variantForm = NodeUtil_js_1.default.getProperty(
                mo,
                'variantForm'
              );
              while (
                ...
                NodeUtil_js_1.default.getTexClass(m2) ===
                  MmlNode_js_1.TEXCLASS.REL
              ) {
                if (
                  variantForm ===
                  ...
                  NodeUtil_js_1.default.appendChildren(
                    mo,
                    NodeUtil_js_1.default.getChildren(m2)
                  );
                  _copyExplicit(['stretchy', 'rspace'], mo, m2);
                  try {
                    for (
                      var _f =
                          ((e_4 = void 0), __values(m2.getPropertyNames())),
                        _g = _f.next();
                      !_g.done;
                      _g = _f.next()
                    ) {
        ...
        var _compareExplicit = function (node1, node2) {
          ...
          try {
            for (
              var exp1_1 = __values(exp1), exp1_1_1 = exp1_1.next();
              !exp1_1_1.done;
              exp1_1_1 = exp1_1.next()
            ) {
        ...
        var _cleanSubSup = function (options, low, up) {
          ...
          try {
            for (
              var _b = __values(options.getList('m' + low + up)),
                _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
        ...
        var _moveLimits = function (options, underover, subsup) {
          ...
          try {
            for (
              var _b = __values(options.getList(underover)), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var mml = _c.value;
              ...
              if (
                ...
                var node = options.nodeFactory.create(
                  'node',
                  subsup,
                  mml.childNodes
                );
    ...
    /***/ 12787: /***/ function (
      ...
      var FindMath_js_1 = __webpack_require__(28499);
      ...
      var FindTeX = (function (_super) {
        ...
        FindTeX.prototype.endPattern = function (end, endp) {
          return new RegExp(
            (endp || (0, string_js_1.quotePattern)(end)) +
              '|\\\\(?:[a-zA-Z]|.)|[{}]',
            'g'
          );
        };
        FindTeX.prototype.findEnd = function (text, n, start, end) {
          ...
          while ((match = pattern.exec(text))) {
            if ((match[1] || match[0]) === close && braces === 0) {
              return (0, MathItem_js_1.protoItem)(
                start[0],
        ...
        FindTeX.prototype.findMathInString = function (math, n, text) {
          ...
          while ((start = this.start.exec(text))) {
            if (start[this.env] !== undefined && this.env) {
              var end =
                '\\\\end\\s*(\\{' +
                (0, string_js_1.quotePattern)(start[this.env]) +
                '\\})';
              ...
              if (math_1.length === 2) {
                match = (0, MathItem_js_1.protoItem)(
                  '',
                  math_1.substr(1),
                  '',
                  n,
...
//# sourceMappingURL=4928.54946277f2c70fd3db72.js.map?v=54946277f2c70fd3db72
