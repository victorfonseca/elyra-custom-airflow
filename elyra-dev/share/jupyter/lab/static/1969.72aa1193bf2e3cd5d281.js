...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [1969],
  {
    /***/ 50780: /***/ function (
      ...
      var MathDocument_js_1 = __webpack_require__(10497);
    ...
    /***/ 77137: /***/ (
      ...
      var AbstractInputJax = (function () {
        ...
        AbstractInputJax.prototype.executeFilters = function (
          filters,
          math,
          document,
          data
    ...
    /***/ 10497: /***/ function (
      ...
      Object.defineProperty(exports, '__esModule', { value: true });
      exports.AbstractMathDocument =
        exports.resetAllOptions =
        exports.resetOptions =
        exports.RenderList =
          void 0;
      var Options_js_1 = __webpack_require__(34981);
      var InputJax_js_1 = __webpack_require__(77137);
      var OutputJax_js_1 = __webpack_require__(63380);
      var MathList_js_1 = __webpack_require__(76808);
      var MathItem_js_1 = __webpack_require__(24971);
      var MmlFactory_js_1 = __webpack_require__(44001);
      var BitField_js_1 = __webpack_require__(58578);
      ...
      var RenderList = (function (_super) {
        ...
        RenderList.create = function (actions) {
          ...
          try {
            for (
              var _b = __values(Object.keys(actions)), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var id = _c.value;
        ...
        RenderList.action = function (id, action) {
          ...
          if (action.length === 1 || typeof action[1] === 'boolean') {
            ...
            (_a = __read(this.methodActions(id), 2)),
              (renderDoc = _a[0]),
              (renderMath = _a[1]);
            ...
            if (typeof action[2] === 'string') {
              ...
              var _e = __read(action.slice(1), 2),
                method1 = _e[0],
                method2 = _e[1];
              (_b = __read(this.methodActions(method1, method2), 2)),
                (renderDoc = _b[0]),
                (renderMath = _b[1]);
            } else {
              action.length === 3 && (convert = action[2]);
              (_c = __read(this.methodActions(action[1]), 2)),
                (renderDoc = _c[0]),
                (renderMath = _c[1]);
            }
          } else {
            action.length === 4 && (convert = action[3]);
            (_d = __read(action.slice(1), 2)),
              (renderDoc = _d[0]),
              (renderMath = _d[1]);
          }
          return [
        ...
        RenderList.prototype.renderDoc = function (document, start) {
          ...
          try {
            for (
              var _b = __values(this.items), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var item = _c.value;
      ...
      var AbstractMathDocument = (function () {
        function AbstractMathDocument(document, adaptor, options) {
          ...
          this.mmlFactory =
            this.options['MmlFactory'] || new MmlFactory_js_1.MmlFactory();
          this.inputJax.map(function (jax) {
        ...
        AbstractMathDocument.prototype.compile = function () {
          ...
          if (!this.processed.isSet('compile')) {
            ...
            try {
              for (
                var _c = __values(this.math), _d = _c.next();
                !_d.done;
                _d = _c.next()
              ) {
                var math = _d.value;
            ...
            try {
              for (
                var recompile_1 = __values(recompile),
                  recompile_1_1 = recompile_1.next();
                !recompile_1_1.done;
                recompile_1_1 = recompile_1.next()
              ) {
        ...
        AbstractMathDocument.prototype.typeset = function () {
          ...
          if (!this.processed.isSet('typeset')) {
            try {
              for (
                var _b = __values(this.math), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
                var math = _c.value;
        ...
        AbstractMathDocument.prototype.updateDocument = function () {
          ...
          if (!this.processed.isSet('updateDocument')) {
            try {
              for (
                var _b = __values(this.math.reversed()), _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
                var math = _c.value;
        ...
        AbstractMathDocument.prototype.removeFromDocument = function (
          _restore
        ) {
          if (_restore === void 0) {
            _restore = false;
        ...
        AbstractMathDocument.prototype.reset = function (options) {
          ...
          options = (0, Options_js_1.userOptions)(
            Object.assign({}, exports.resetOptions),
            options
          );
          options.all && Object.assign(options, exports.resetAllOptions);
          options.processed && this.processed.reset();
          options.inputJax &&
            this.inputJax.forEach(function (jax) {
              return jax.reset.apply(
                jax,
                __spreadArray([], __read(options.inputJax), false)
              );
            });
          options.outputJax &&
            (_a = this.outputJax).reset.apply(
              _a,
              __spreadArray([], __read(options.outputJax), false)
            );
          return this;
        };
        ...
        AbstractMathDocument.prototype.clearMathItemsWithin = function (
          containers
        ) {
          var _a;
          var items = this.getMathItemsWithin(containers);
          (_a = this.math).remove.apply(
            _a,
            __spreadArray([], __read(items), false)
          );
          return items;
        };
        AbstractMathDocument.prototype.getMathItemsWithin = function (
          elements
        ) {
          var e_11, _a, e_12, _b;
          ...
          try {
            ITEMS: for (
              ...
              try {
                for (
                  var containers_1 = ((e_12 = void 0), __values(containers)),
                  ...
                  if (
                    item.start.node &&
                    adaptor.contains(container, item.start.node)
                  ) {
                    items.push(item);
                    continue ITEMS;
                  }
                ...
                try {
                  if (
                    containers_1_1 &&
                    !containers_1_1.done &&
                    (_b = containers_1.return)
                  )
                    _b.call(containers_1);
                } finally {
        ...
        AbstractMathDocument.ProcessBits = (0, BitField_js_1.BitFieldClass)(
          'findMath',
          'compile',
          'getMetrics',
          'typeset',
    ...
    /***/ 76808: /***/ function (
      ...
      var LinkedList_js_1 = __webpack_require__(88762);
    ...
    /***/ 78608: /***/ function (
      ...
      var MathDocument_js_1 = __webpack_require__(10497);
      var Options_js_1 = __webpack_require__(34981);
      var HTMLMathItem_js_1 = __webpack_require__(72680);
      var HTMLMathList_js_1 = __webpack_require__(16499);
      var HTMLDomStrings_js_1 = __webpack_require__(15391);
      var MathItem_js_1 = __webpack_require__(24971);
      var HTMLDocument = (function (_super) {
        ...
        function HTMLDocument(document, adaptor, options) {
          var _this = this;
          var _a = __read(
              (0, Options_js_1.separateOptions)(
                options,
                HTMLDomStrings_js_1.HTMLDomStrings.OPTIONS
              ),
              2
            ),
            html = _a[0],
          ...
          _this.domStrings =
            _this.options['DomStrings'] ||
            new HTMLDomStrings_js_1.HTMLDomStrings(dom);
          _this.domStrings.adaptor = adaptor;
          _this.styles = [];
          return _this;
        }
        HTMLDocument.prototype.findPosition = function (
          N,
          index,
          delim,
          nodes
          ...
          try {
            for (
              var _b = __values(nodes[N]), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var list = _c.value;
        ...
        HTMLDocument.prototype.findMath = function (options) {
          ...
          if (!this.processed.isSet('findMath')) {
            ...
            try {
              for (
                var _f = __values(
                    this.adaptor.getElements(options['elements'], this.document)
                  ),
                  _g = _f.next();
                !_g.done;
                _g = _f.next()
                ...
                try {
                  for (
                    var _j = ((e_3 = void 0), __values(this.inputJax)),
                      _k = _j.next();
                    !_k.done;
                    _k = _j.next()
                  ) {
                    ...
                    if (jax.processStrings) {
                      if (strings === null) {
                        (_c = __read(this.domStrings.find(container), 2)),
                          (strings = _c[0]),
                          (nodes = _c[1]);
                      }
                      try {
                        for (
                          var _l =
                              ((e_4 = void 0), __values(jax.findMath(strings))),
                            _m = _l.next();
                          !_m.done;
                          _m = _l.next()
                        ) {
                      ...
                      try {
                        for (
                          var _o =
                              ((e_5 = void 0),
                              __values(jax.findMath(container))),
                            _p = _o.next();
                          !_p.done;
                          _p = _o.next()
                        ) {
                          var math = _p.value;
                          var item = new this.options.MathItem(
                            math.math,
                            jax,
                            math.display,
                            math.start,
        ...
        HTMLDocument.prototype.addStyleSheet = function () {
          ...
          if (sheet && !adaptor.parent(sheet)) {
            ...
            var styles = this.findSheet(
              head,
              adaptor.getAttribute(sheet, 'id')
            );
            if (styles) {
        ...
        HTMLDocument.prototype.findSheet = function (head, id) {
          ...
          if (id) {
            try {
              for (
                var _b = __values(this.adaptor.tags(head, 'style')),
                  _c = _b.next();
                !_c.done;
                _c = _b.next()
              ) {
        ...
        HTMLDocument.OPTIONS = __assign(
          __assign({}, MathDocument_js_1.AbstractMathDocument.OPTIONS),
          {
            renderActions: (0, Options_js_1.expandable)(
              __assign(
                __assign(
    ...
    /***/ 15391: /***/ function (
      ...
      var HTMLDomStrings = (function () {
        ...
        HTMLDomStrings.prototype.getPatterns = function () {
          ...
          var ignore = (0, Options_js_1.makeArray)(
            this.options['ignoreHtmlClass']
          );
          var process = (0, Options_js_1.makeArray)(
        ...
        HTMLDomStrings.prototype.find = function (node) {
          ...
          while (node && node !== stop) {
            ...
            if (kind === '#text') {
              ...
              (_a = __read(this.handleContainer(node, ignore), 2)),
                (node = _a[0]),
                (ignore = _a[1]);
            } else {
    ...
    /***/ 1969: /***/ function (
      ...
      var Handler_js_1 = __webpack_require__(50780);
      var HTMLDocument_js_1 = __webpack_require__(78608);
    ...
    /***/ 58578: /***/ function (__unused_webpack_module, exports) {
      var __extends =
        (this && this.__extends) ||
        (function () {
          var extendStatics = function (d, b) {
    ...
    /***/ 88762: /***/ function (__unused_webpack_module, exports) {
      var __generator =
      ...
      var LinkedList = (function () {
        ...
        LinkedList.prototype.unshift = function () {
          ...
          try {
            for (
              var _b = __values(args.slice(0).reverse()), _c = _b.next();
              !_c.done;
              _c = _b.next()
            ) {
              var data = _c.value;
        ...
        LinkedList.prototype.merge = function (list, isBefore) {
          ...
          while (lcur.data !== exports.END && mcur.data !== exports.END) {
            if (isBefore(mcur.data, lcur.data)) {
              (_a = __read([lcur, mcur], 2)),
                (mcur.prev.next = _a[0]),
                (lcur.prev.next = _a[1]);
              (_b = __read([lcur.prev, mcur.prev], 2)),
                (mcur.prev = _b[0]),
                (lcur.prev = _b[1]);
              (_c = __read([list.list, this.list], 2)),
                (this.list.prev.next = _c[0]),
                (list.list.prev.next = _c[1]);
              (_d = __read([list.list.prev, this.list.prev], 2)),
                (this.list.prev = _d[0]),
                (list.list.prev = _d[1]);
              (_e = __read([mcur.next, lcur], 2)),
                (lcur = _e[0]),
                (mcur = _e[1]);
            } else {
              lcur = lcur.next;
...
//# sourceMappingURL=1969.72aa1193bf2e3cd5d281.js.map?v=72aa1193bf2e3cd5d281
