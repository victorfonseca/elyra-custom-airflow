  ...
  [4090],
  {
      ...
      var n =
        ...
        function (t, e) {
          ...
          var i = r.call(t),
            ...
            a;
          try {
            while ((e === void 0 || e-- > 0) && !(n = i.next()).done)
              o.push(n.value);
          } catch (s) {
            a = { error: s };
          } finally {
    ...
    24090: function (t, e, r) {
      ...
      var v = (function (t) {
        ...
        e.prototype.addWrapperStyles = function (e) {
          ...
          try {
            for (
              var n = l(this.wrapperUsage.update()), o = n.next();
              !o.done;
              o = n.next()
            ) {
              var a = o.value;
        ...
        e.prototype.unknownText = function (t, e, r) {
          ...
          return this.html('mjx-utext', { variant: e, style: i }, [
            this.text(t)
          ]);
        };
        e.prototype.measureTextNode = function (t) {
          ...
          var o =
            e.nodeSize(r, this.math.metrics.em)[0] / this.math.metrics.scale;
          e.remove(this.container);
          e.remove(n);
          return { w: o, h: 0.75, d: 0.2 };
        };
        e.NAME = 'CHTML';
        e.OPTIONS = n(n({}, h.CommonOutputJax.OPTIONS), {
          adaptiveCSS: true,
      ...
      var f = function (t, e) {
        return l.CommonDiagonalStrike(function (t) {
          return function (r, i) {
            ...
            var p = r.adjustBorder(
              r.html(t, {
                style: {
                  width: r.em(u),
                  transform:
                    'rotate(' + r.fixed(-e * c) + 'rad) translateY(' + f + 'em)'
                }
              })
            );
    ...
    44614: function (t, e, r) {
      ...
      var p = (function (t) {
        ...
        r.prototype.handleAttributes = function () {
          ...
          try {
            for (
              var h = s(o.getExplicitNames()), c = h.next();
              !c.done;
              c = h.next()
            ) {
              var u = c.value;
      ...
      var l = (function (t) {
        ...
        e.prototype.toCHTML = function (e) {
          ...
          this.adaptor.setAttribute(
            this.chtml,
            'texclass',
            s.TEXCLASSNAMES[this.node.texClass]
          );
          ...
          if (o === '-explicitFont') {
            ...
            try {
              for (var l = n(s), h = l.next(); !h.done; h = l.next()) {
                ...
                var f = u.f ? ' TEX-' + u.f : '';
                var p = u.unknown
                  ? this.jax.unknownText(String.fromCodePoint(c), o)
                  : this.html('mjx-c', { class: this.char(c) + f });
                i.append(t, p);
              ...
              function (t, e) {
                ...
                if (r.node.isKind('mtext')) {
                  ...
                  var o = n.append(
                    ...
                    t.html(
                      'mjx-tool',
                      { style: { bottom: t.em(-t.dy), right: t.em(-t.dx) } },
                      [t.html('mjx-tip')]
                    )
                  );
    ...
    64474: function (t, e, r) {
      ...
      var h = (function (t) {
        ...
        e.prototype.setChildPWidths = function (e, r, i) {
          ...
          return this.parent
            ? t.prototype.setChildPWidths.call(this, e, r, i)
            : false;
        };
    ...
    2696: function (t, e, r) {
      ...
      var v = (function (t) {
        ...
        e.prototype.toCHTML = function (t) {
          ...
          try {
            for (
              var h = s(Object.keys(this.notations)), c = h.next();
              !c.done;
              c = h.next()
            ) {
              var f = c.value;
        ...
        e.styles = {
          ...
          'mjx-menclose > mjx-arrow[double] > mjx-aline': {
            left: (0, p.em)(u.THICKNESS * (u.ARROWX - 1)),
            height: 0
          },
          'mjx-menclose > mjx-arrow > mjx-rthead': {
            ...
            'border-top':
              (0, p.em)(u.THICKNESS * u.ARROWY) + ' solid transparent'
          },
        ...
        e.notations = new Map([
          ...
          [
            'roundedbox',
            { renderer: u.RenderElement('rbox'), bbox: u.fullBBox }
          ],
    ...
    79901: function (t, e, r) {
      ...
      var l = (function (t) {
            ...
            this.html('mjx-frac', l, [
              ...
              this.html('mjx-dbox', {}, [
                this.html('mjx-dtable', {}, [
                  ...
                  this.html('mjx-row', {}, [
                    (M = this.html('mjx-den', c, [this.html('mjx-dstrut', u)]))
                  ])
                ])
              ])
            ])
        ...
        e.prototype.makeAtop = function (t) {
          ...
          this.adaptor.append(
            this.chtml,
            this.html('mjx-frac', s, [
              (p = this.html('mjx-num', l)),
              (d = this.html('mjx-den', h))
            ])
          );
    ...
    96672: function (t, e, r) {
      ...
      var s = (function (t) {
        ...
        e.styles = {
          'mjx-mglyph > img': { display: 'inline-block', border: 0, padding: 0 }
        };
        return e;
      ...
      var l = (function (t) {
        ...
        e.prototype.toCHTML = function (t) {
          ...
          if (a && this.size < 0) {
            ...
            try {
              for (
                var h = n(this.childNodes), c = h.next();
                !c.done;
                c = h.next()
              ) {
                var u = c.value;
    ...
    38655: function (t, e, r) {
      ...
      var h = (function (t) {
        ...
        e.prototype.toCHTML = function (t) {
          ...
          try {
            for (
              var m = o(this.childNodes), b = m.next();
              !b.done;
              b = m.next()
            ) {
              var g = b.value;
      ...
      var l = (function (t) {
        ...
        e.prototype.toCHTML = function (t) {
          ...
          var y = this.adaptor.append(
            c,
            this.html('mjx-sqrt', {}, [
              (u = this.html('mjx-surd')),
              (f = this.html('mjx-box', { style: { paddingTop: this.em(s) } }))
            ])
          );
    ...
    46605: function (t, e, r) {
      ...
      var c = (function (t) {
        ...
        e.prototype.toCHTML = function (t) {
          ...
          try {
            for (
              var o = n(this.childNodes), a = o.next();
              !a.done;
              a = o.next()
            ) {
              var s = a.value;
        ...
        e.prototype.padRows = function () {
          ...
          try {
            for (
              var i = n(r.childNodes(this.itable)), o = i.next();
              !o.done;
              o = i.next()
            ) {
              var a = o.value;
        ...
        e.prototype.handleColumnSpacing = function () {
          ...
          try {
            for (
              var l = n(this.tableRows), h = l.next();
              !h.done;
              h = l.next()
            ) {
              var c = h.value;
              ...
              try {
                for (
                  var f = ((r = void 0), n(c.tableCells)), p = f.next();
                  !p.done;
                  p = f.next()
                ) {
                  var d = p.value;
        ...
        e.prototype.handleRowLines = function () {
          ...
          try {
            for (
              ...
              try {
                for (
                  var u = ((r = void 0), n(this.adaptor.childNodes(h.chtml))),
                    f = u.next();
                  !f.done;
                  f = u.next()
                ) {
        ...
        e.prototype.updateRowHeights = function () {
          ...
          for (var a = 0; a < this.numRows; a++) {
            ...
            this.setRowHeight(
              s,
              e[a] + r[a] + o[a] + o[a + 1] + this.rLines[a]
            );
            if (e[a] !== i[a] || r[a] !== n[a]) {
        ...
        e.prototype.toCHTML = function (e) {
          ...
          if (
            ...
            (this.parent.kind !== 'mlabeledtr' ||
              ...
              i !== this.parent.parent.node.attributes.get('side'))
          ) {
    ...
    49821: function (t, e, r) {
      ...
      var u = (function (t) {
        ...
        e.prototype.toCHTML = function (e) {
          ...
          var n = this.adaptor.append(
            this.adaptor.append(i, this.html('mjx-row')),
            this.html('mjx-base')
          );
          var o = this.adaptor.append(
            this.adaptor.append(i, this.html('mjx-row')),
            this.html('mjx-under')
          );
    ...
    98526: function (t, e, r) {
      ...
      var l = (function (t) {
        ...
        e.prototype.adjustUnderDepth = function (t, e) {
          ...
          var n = this.adaptor;
          var a = this.em(e.d);
          var s = this.html('mjx-box', {
            style: { 'margin-bottom': a, 'vertical-align': a }
          });
          try {
            for (
              var l = o(n.childNodes(n.firstChild(t))), h = l.next();
              !h.done;
              h = l.next()
            ) {
              var c = h.value;
            ...
            i + 'arrow',
            {
              ...
              bbox: function (t) {
                ...
                var d =
                  n +
                  (u > Math.PI / 2 - i
                    ? t.thickness * f * Math.sin(u + i - Math.PI / 2)
                    : 0);
                return [p, d, p, d];
              },
              remove: l
      ...
      var p = (function (t) {
        ...
        e.prototype.getMetricMaps = function (t) {
          ...
          try {
            for (var _ = a(w.keys()), M = _.next(); !M.done; M = _.next()) {
              ...
              try {
                for (
                  var C = ((o = void 0), a(d[j].keys())), S = C.next();
                  !S.done;
                  S = C.next()
                ) {
                  var b = S.value;
          ...
          try {
            for (var O = a(w.keys()), T = O.next(); !T.done; T = O.next()) {
              ...
              try {
                for (
                  var B = ((u = void 0), a(d[j].values())), L = B.next();
                  !L.done;
                  L = B.next()
                ) {
                  var b = L.value;
        ...
        e.prototype.measureMetrics = function (t, e) {
          ...
          var u = Math.max(
            ...
            this.options.matchFontHeight ? h / this.font.params.x_height / n : 1
          );
          var f = 1e6;
          return {
            em: n,
        ...
        e.prototype.styleSheet = function (t) {
          ...
          var s = this.html('style', { id: 'MJX-styles' }, [
        ...
        e.prototype.addWrapperStyles = function (t) {
          ...
          try {
            for (
              var i = a(this.factory.getKinds()), n = i.next();
              !n.done;
              n = i.next()
            ) {
              var o = n.value;
        ...
        e.prototype.getFontData = function (t) {
          ...
          return [
            ...
            t.get('font-style') === 'italic',
            t.get('font-weight') === 'bold'
          ];
        };
        e.NAME = 'Common';
    ...
    85677: function (t, e, r) {
      ...
      var g = (function (t) {
        ...
        e.prototype.getOuterBBox = function (t) {
          ...
          try {
            for (
              var o = s(y.BBox.StyleAdjust), a = o.next();
              !a.done;
              a = o.next()
            ) {
              var h = l(a.value, 2),
        ...
        e.prototype.getMathMLSpacing = function () {
          ...
          this.bbox.L = i.isSet('lspace')
            ? Math.max(0, this.length2em(i.get('lspace')))
            : b(n, t.lspace);
          this.bbox.R = i.isSet('rspace')
            ? Math.max(0, this.length2em(i.get('rspace')))
            : b(n, t.rspace);
        ...
        e.prototype.getText = function () {
          ...
          if (this.node.isToken) {
            try {
              for (
                var i = s(this.node.childNodes), n = i.next();
                !n.done;
                n = i.next()
              ) {
                var o = n.value;
        ...
        e.prototype.getAlignShift = function () {
          var t;
          var e = (t = this.node.attributes).getList.apply(
              t,
              h([], l(u.indentAttributes), false)
            ),
            r = e.indentalign,
            i = e.indentshift,
      ...
      function f(t) {
        return (function (t) {
          ...
          e.prototype.getParameters = function () {
            ...
            if (i !== undefined) {
              var n = s((0, u.split)(i), 3),
                ...
                l = n[2];
              this.arrowhead = {
                x: o ? parseFloat(o) : c.ARROWX,
                y: a ? parseFloat(a) : c.ARROWY,
                dx: l ? parseFloat(l) : c.ARROWDX
              };
            }
          };
          e.prototype.getNotations = function () {
            ...
            try {
              for (
                var i = h((0, u.split)(this.node.attributes.get('notation'))),
                  n = i.next();
                !n.done;
                n = i.next()
              ) {
          ...
          e.prototype.removeRedundantNotations = function () {
            ...
            try {
              for (
                var n = h(Object.keys(this.notations)), o = n.next();
                !o.done;
                o = n.next()
              ) {
                var a = o.value;
          ...
          e.prototype.initializeNotations = function () {
            ...
            try {
              for (
                var r = h(Object.keys(this.notations)), i = r.next();
                !i.done;
                i = r.next()
              ) {
                var n = i.value;
          ...
          e.prototype.getBBoxExtenders = function () {
            ...
            try {
              for (
                var i = h(Object.keys(this.notations)), n = i.next();
                !n.done;
                n = i.next()
              ) {
                var o = n.value;
      ...
      function a(t) {
        return (function (t) {
          ...
          e.prototype.addMrowChildren = function () {
            ...
            try {
              for (
                var a = o(this.childNodes.slice(1)), s = a.next();
                !s.done;
                s = a.next()
              ) {
                var l = s.value;
      ...
      function o(t) {
        return (function (t) {
          ...
          e.prototype.getTUV = function (t, e) {
            ...
            return {
              T: (t ? 3.5 : 1.5) * e,
              u: (t ? r.num1 : r.num2) - i - n,
              v: (t ? r.denom1 : r.denom2) + i - n
            };
          };
          ...
          e.prototype.getBevelData = function (t) {
            ...
            var i = t ? 0.4 : 0.15;
            var n =
              Math.max(e.scale * (e.h + e.d), r.scale * (r.h + r.d)) + 2 * i;
            var o = this.font.params.axis_height;
      ...
      function l(t) {
        return (function (t) {
          ...
          r.prototype.getScriptBBoxLists = function () {
            ...
            try {
              for (
                var o = a(this.childNodes), s = o.next();
                !s.done;
                s = o.next()
              ) {
                var l = s.value;
          ...
          r.prototype.getUVQ = function (e, r) {
            ...
            if (!this.UVQ) {
              ...
              if (e.h === 0 && e.d === 0) {
                ...
                (i = n(t.prototype.getUVQ.call(this, e, r), 3)),
                  (a = i[0]),
                  (s = i[1]),
                  (l = i[2]);
              }
        ...
        return (function (t) {
          ...
          e.prototype.stretchChildren = function () {
            ...
            if (u && f > 1) {
              ...
              try {
                for (
                  var v = a(this.childNodes), m = v.next();
                  !m.done;
                  m = v.next()
                ) {
                  var c = m.value;
      ...
      function s(t) {
        return (function (t) {
          ...
          function e() {
            ...
            var u = i.node.attributes.get('displaystyle')
              ? i.font.params.x_height
              : c;
            i.surdH = l + h + 2 * c + u / 4;
          ...
          e.prototype.getPQ = function (t) {
            ...
            var r = this.node.attributes.get('displaystyle')
        ...
        return (
          (e = (function (t) {
            ...
            e.prototype.getUVQ = function (t, e) {
              ...
              var s = this.baseCharZero(
                r.d * this.baseScale + n.sub_drop * t.rscale
              );
              ...
              h = Math.max(
                this.length2em(this.node.attributes.get('superscriptshift'), h),
                h
              );
              c = Math.max(
      ...
      function c(t) {
        return (function (t) {
          ...
          function e() {
            ...
            i.isTop =
              !i.container ||
              (i.container.node.isKind('math') && !i.container.parent);
            if (i.isTop) {
              i.jax.table = i;
            }
            ...
            i.fSpace = i.frame
              ? i.convertLengths(i.getAttributeArray('framespacing'))
              : [0, 0];
          ...
          e.prototype.stretchColumns = function () {
            for (var t = 0; t < this.numCols; t++) {
              var e =
                typeof this.cWidths[t] === 'number' ? this.cWidths[t] : null;
          ...
          e.prototype.stretchColumn = function (t, e) {
            ...
            try {
              for (
                var c = a(this.tableRows), u = c.next();
                !u.done;
                u = c.next()
              ) {
                var f = u.value;
            ...
            if (y && v > 1) {
              if (e === null) {
                ...
                try {
                  for (
                    var b = a(this.tableRows), g = b.next();
                    !g.done;
                    g = b.next()
                  ) {
                    var f = g.value;
          ...
          e.prototype.setChildPWidths = function (t, e, r) {
            ...
            var u =
              Math.max(o, this.length2em(i, Math.max(e, a + o + s))) -
              (c ? a + s : 0);
            ...
            this.pWidth =
              (0, h.sum)(p.concat(this.cLines, this.cSpace)) +
              2 * (this.fLine + this.fSpace[0]);
            if (this.isTop) {
          ...
          e.prototype.setColumnPWidths = function () {
            ...
            try {
              for (
                var i = a(this.pwidthCells), o = i.next();
                !o.done;
                o = i.next()
              ) {
                var s = n(o.value, 2),
      ...
      function i(t) {
        return (function (t) {
          ...
          e.prototype.getWrapWidth = function (t) {
            ...
            return typeof e.cWidths[i] === 'number'
              ? e.cWidths[i]
              : e.getTableData().W[i];
          };
          e.prototype.getChildAlign = function (t) {
        ...
        return (function (t) {
          ...
          e.prototype.computeBBox = function (e) {
            ...
            var h = i(
                this.getDeltaW(
                  [n, o, r],
                  [0, this.isLineBelow ? 0 : -l, this.isLineAbove ? 0 : l]
                ),
                3
              ),
              c = h[0],
          ...
          (e = (function (t) {
            ...
            function e() {
              ...
              i.isMathAccent =
                i.baseIsChar &&
                i.scriptChild &&
                !!i.scriptChild.coreMO().node.getProperty('mathaccent');
              i.checkLineAccents();
              i.baseRemoveIc =
                !i.isLineAbove &&
                !i.isLineBelow &&
                (!i.constructor.useIC || i.isMathAccent);
              return i;
            }
                ...
                ((t.childNodes.length === 1 &&
                  (t.node.isKind('mrow') ||
                    (t.node.isKind('TeXAtom') &&
                      t.node.texClass !== s.TEXCLASS.VCENTER) ||
            ...
            e.prototype.getV = function () {
              ...
              var r = this.font.params;
              var i = this.length2em(
                this.node.attributes.get('subscriptshift'),
                r.sub1
              );
              return Math.max(
                this.baseCharZero(t.d * this.baseScale + r.sub_drop * e.rscale),
                i,
                e.h * e.rscale - (4 / 5) * r.x_height
              );
            };
            e.prototype.getU = function () {
              ...
              var e = this.scriptChild.getOuterBBox();
              var r = this.font.params;
              var i = this.node.attributes.getList(
                'displaystyle',
                'superscriptshift'
              );
              ...
              return Math.max(
                this.baseCharZero(t.h * this.baseScale - r.sup_drop * e.rscale),
                a,
            ...
            e.prototype.getUnderKV = function (t, e) {
              ...
              var l =
                (r ? s : Math.max(i.big_op_spacing2, i.big_op_spacing4 - n)) -
                a;
            ...
            e.prototype.getDelta = function (t) {
              ...
              var r = this.baseCore.getOuterBBox(),
                ...
                n = r.ic;
              return (
                ((e && !t ? i : 0) + this.font.skewIcFactor * n) *
                this.baseScale
              );
            };
            e.prototype.stretchChildren = function () {
              ...
              if (u && f > 1) {
                ...
                try {
                  for (
                    var y = a(this.childNodes), v = y.next();
                    !v.done;
                    v = y.next()
                  ) {
                    var c = v.value;
    ...
    14454: function (t, e) {
      ...
      var i = (function () {
        ...
        t.prototype.addStyles = function (t) {
          ...
          try {
            for (
              var n = r(Object.keys(t)), o = n.next();
              !o.done;
              o = n.next()
            ) {
              var a = o.value;
    ...
    24161: function (t, e) {
      ...
      function l(t) {
        ...
        try {
          for (
            var o = r(g.connect[t].children), a = o.next();
            !a.done;
            a = o.next()
          ) {
            var l = a.value;
      ...
      function c(t) {
        ...
        try {
          for (
            var n = r(g.connect[t].children), o = n.next();
            !o.done;
            o = n.next()
          ) {
            var a = o.value;
      ...
      function p(t) {
        ...
        try {
          for (
            var l = r(s(this.styles[t])), h = l.next();
            !h.done;
            h = l.next()
          ) {
            var c = h.value;
        ...
        try {
          for (
            var u = r(g.connect[t].children), p = u.next();
            !p.done;
            p = u.next()
          ) {
            var d = p.value;
      ...
      function v(t) {
        ...
        try {
          for (var c = r(l), u = c.next(); !u.done; u = c.next()) {
            ...
            try {
              for (
                var p = ((o = void 0), r(Object.keys(y))), d = p.next();
                !d.done;
                d = p.next()
              ) {
                var v = d.value;
      ...
      var g = (function () {
        ...
        Object.defineProperty(t.prototype, 'cssText', {
          get: function () {
            ...
            try {
              for (
                var n = r(Object.keys(this.styles)), o = n.next();
                !o.done;
                o = n.next()
              ) {
                var a = o.value;
