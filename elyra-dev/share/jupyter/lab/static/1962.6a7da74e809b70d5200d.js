    ...
    91962: (e, t, a) => {
      ...
      function K(e, t) {
        ...
        for (let a = 0; a < e.length; a++)
          this.hash +=
            (this.hash << 4) + e.charCodeAt(a) + (e.charCodeAt(a) << 8);
      }
      const ee = [f, g, h, m, S];
      const te = new n.Aj({
        start: null,
      ...
      const ae = new n.Lu(
        (e, t) => {
          ...
          if (a) {
            ...
            if (l && E[l]) return e.acceptToken(V, -2);
            ...
            if (l && Z[l] && Z[l][n]) e.acceptToken(V, -1);
      ...
      function le(e) {
        for (; e; e = e.parent)
          if (e.name == 'svg' || e.name == 'math') return true;
        return false;
      }
      const re = new n.Lu((e, t) => {
        ...
        return new n.Lu((n) => {
          for (let r = 0, s = 0, o = 0; ; o++) {
            ...
            if (
              (r == 0 && n.next == j) ||
              (r == 1 && n.next == J) ||
              (r >= 2 && r < l && n.next == e.charCodeAt(r - 2))
            ) {
              r++;
              s++;
      ...
      function ce(e, t) {
        ...
        for (let n of e.getChildren(q)) {
          let e = n.getChild(w),
            l = n.getChild($) || n.getChild(Q);
          if (e)
            a[t.read(e.from, e.to)] = !l
              ? ''
              : l.type.id == $
                ? t.read(l.from + 1, l.to - 1)
                : t.read(l.from, l.to);
        }
        return a;
      }
      ...
      function fe(e, t, a) {
        let n;
        for (let l of a) {
          if (!l.attrs || l.attrs(n || (n = ce(e.node.parent.firstChild, t))))
            return { parser: l.parser };
        }
        return null;
      }
      function he(e = [], t = []) {
            ...
            for (let r of s) {
              if (r.tag == n && (!r.attrs || r.attrs(l || (l = ce(a, t))))) {
                ...
                return {
                  parser: r.parser,
                  overlay: [
                    { from: e.to, to: t.type.id == Y ? t.from : a.parent.to }
                  ]
                };
              }
            }
      ...
      class Qe {
        constructor(e, t) {
          this.tags = Object.assign(Object.assign({}, qe), e);
      ...
      function ke(e, t) {
        ...
        for (let n = Ae(t); n && !n.type.isTop; n = Ae(n.parent)) {
          ...
          if (
            l &&
            a.indexOf(l) < 0 &&
            (t.name == 'EndTag' || t.from >= n.firstChild.to)
          )
            a.push(l);
        }
        return a;
      ...
      function Ge(e, t, a, n) {
        ...
        for (let s of ke(e.doc, a))
          l.push({ label: '</' + s + '>', type: 'type', boost: 99 - r++ });
        return {
          from: n,
          to: n,
          options: l,
      ...
      function Ee(e, t, a, n, l) {
        ...
        return {
          from: n,
          to: l,
          options: u.map((e) => ({ label: e, type: 'property' })),
          validFor: Ye
        };
      }
      function Ze(e, t, a, n, l) {
        ...
        if (s) {
          ...
          if (O) {
            ...
            for (let e of O)
              o.push({ label: e, apply: a + e + r, type: 'constant' });
          }
        }
      ...
      function De(e, t) {
        ...
        if (l.name == 'TagName') {
          return l.parent && /CloseTag$/.test(l.parent.name)
            ? Be(a, l, l.from, n)
            : Me(a, e, l, l.from, n);
        } else if (l.name == 'StartTag') {
          return Me(a, e, l, n, n);
        } else if (
          l.name == 'StartCloseTag' ||
          l.name == 'IncompleteCloseTag'
        ) {
          return Be(a, l, n, n);
        } else if (
          l.name == 'OpenTag' ||
          l.name == 'SelfClosingTag' ||
          l.name == 'AttributeName'
        ) {
          return Ee(a, e, l, l.name == 'AttributeName' ? l.from : n, n);
        } else if (
          l.name == 'Is' ||
          l.name == 'AttributeValue' ||
          l.name == 'UnquotedAttributeValue'
        ) {
          return Ze(a, e, l, l.name == 'Is' ? n : l.from, n);
        } else if (
          t.explicit &&
      ...
      const He = Se.javascriptLanguage.parser.configure({
      ...
      const Ne = [
        {
          ...
          parser: Se.typescriptLanguage.parser
        },
        {
          tag: 'script',
          attrs: (e) => e.type == 'text/babel' || e.type == 'text/jsx',
          parser: Se.jsxLanguage.parser
        },
        {
          tag: 'script',
          attrs: (e) => e.type == 'text/typescript-jsx',
          parser: Se.tsxLanguage.parser
        },
        {
          tag: 'script',
          attrs(e) {
      ...
      const Ie = [
        {
          name: 'style',
          parser: me.cssLanguage.parser.configure({ top: 'Styles' })
        }
      ].concat(
            ...
            xe.indentNodeProp.add({
              ...
              Document(e) {
                ...
                if (
                  ...
                  !(
                    (a = t.lastChild) &&
                    (a.name == 'CloseTag' || a.name == 'SelfClosingTag')
                  )
                )
                  return e.lineIndent(t.from) + e.unit;
                return null;
              }
            }),
            xe.foldNodeProp.add({
      ...
      function Je(e = {}) {
        ...
        if (
          ...
          a = he(
            (e.nestedLanguages || []).concat(Ne),
            (e.nestedAttributes || []).concat(Ie)
          );
        let n = a
          ? je.configure({ wrap: a, dialect: t })
          : t
            ? Ue.configure({ dialect: t })
            : Ue;
      ...
      const ze = ge.EditorView.inputHandler.of((e, t, a, n, l) => {
        ...
        let o = s.changeByRange((e) => {
          ...
          let { head: o } = e,
            u = (0, xe.syntaxTree)(s).resolveInner(o, -1),
            O;
          if (r && n == '>' && u.name == 'EndTag') {
            let n = u.parent;
            if (
              ((a =
                (t = n.parent) === null || t === void 0
                  ? void 0
                  : t.lastChild) === null || a === void 0
                ? void 0
                : a.name) != 'CloseTag' &&
              (O = Xe(s.doc, n.parent, o)) &&
              !Le.has(O)
            ) {
            ...
            if (
              u.from == o - 2 &&
              ((l = e.lastChild) === null || l === void 0 ? void 0 : l.name) !=
                'CloseTag' &&
              (O = Xe(s.doc, e, o)) &&
              !Le.has(O)
            ) {
              ...
              let t = `${O}>`;
              return {
                range: Pe.EditorSelection.cursor(o + t.length, -1),
                changes: { from: o, to: e, insert: t }
              };
            }
          }
          return { range: e };
