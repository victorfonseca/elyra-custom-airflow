...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [7425],
  {
    /***/ 37425: /***/ (
      ...
      var index_js_ = __webpack_require__(45145); // CONCATENATED MODULE: ./node_modules/@lezer/css/dist/index.js
   ...
   expressed by Lezer's built-in tokenizer. */
      ...
      const identifiers = new dist /* ExternalTokenizer */.Lu(
        (input, stack) => {
      ...
      var common_dist_index_js_ = __webpack_require__(66575); // CONCATENATED MODULE: ./node_modules/@codemirror/lang-css/dist/index.js
      ...
      function isVarArg(node, doc) {
        ...
        if (
          (callee === null || callee === void 0 ? void 0 : callee.name) !=
          'Callee'
        )
          return false;
      ...
      const VariablesByNode =
        /*@__PURE__*/ new common_dist_index_js_.NodeWeakMap();
      ...
      function variableNames(doc, node, isVariable) {
        if (node.to - node.from > 4096) {
          ...
          let result = [],
            seen = new Set(),
            cursor = node.cursor(
              common_dist_index_js_.IterMode.IncludeAnonymous
            );
...
*/
      const defineCSSCompletionSource = (isVariable) => (context) => {
        let { state, pos } = context,
          node = (0, dist_index_js_.syntaxTree)(state).resolveInner(pos, -1);
        let isDash =
          node.type.isError &&
          node.from == node.to - 1 &&
...
*/
      function css() {
        return new dist_index_js_.LanguageSupport(
          cssLanguage,
...
//# sourceMappingURL=7425.7d2de17f7b601e7b8b4b.js.map?v=7d2de17f7b601e7b8b4b
