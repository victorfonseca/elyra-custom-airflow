    ...
    /***/ 65521: /***/ (
      ...
      __webpack_require__.d(__webpack_exports__, {
        ...
        convertYMapEventToMapChange: () =>
          /* reexport */ convertYMapEventToMapChange,
...
|----------------------------------------------------------------------------*/
      ...
      var index_js_ = __webpack_require__(5592);
      ...
      var index_es6_js_ = __webpack_require__(2336);
      // EXTERNAL MODULE: ./node_modules/lib0/time.js
      var lib0_time = __webpack_require__(64191);
      // EXTERNAL MODULE: ./node_modules/lib0/math.js
      var math = __webpack_require__(63616);
      ...
      var lib0_function = __webpack_require__(53110);
      // EXTERNAL MODULE: consume shared module (default) yjs@^13.5.40 (singleton) (fallback: ./node_modules/yjs/dist/yjs.mjs)
      var yjs_mjs_ = __webpack_require__(74356); // CONCATENATED MODULE: ./node_modules/y-protocols/awareness.js
      /**
      ...
      class Awareness extends observable /* Observable */.c {
        ...
        setLocalState(state) {
          ...
          const clock =
            currLocalMeta === undefined ? 0 : currLocalMeta.clock + 1;
          ...
          this.meta.set(clientID, {
            clock,
            lastUpdated: lib0_time /* getUnixTime */
              ._g()
          });
          const added = [];
          const updated = [];
      ...
      const encodeAwarenessUpdate = (
        ...
        for (let i = 0; i < len; i++) {
          ...
          const clock = /** @type {MetaClientState} */ (
            awareness.meta.get(clientID)
          ).clock;
...
|----------------------------------------------------------------------------*/
      ...
      const createCell = (cell, notebook) => {
        ...
        ymodel.set(
          'id',
          (_a = cell.id) !== null && _a !== void 0 ? _a : index_js_.UUID.uuid4()
        );
        let ycell;
        switch (cell.cell_type) {
          ...
          case 'code': {
            ...
            const cCell = cell;
            ycell.execution_count =
              (_b = cCell.execution_count) !== null && _b !== void 0
                ? _b
                : null;
            if (cCell.outputs) {
      ...
      class YBaseCell {
        ...
        constructor(ymodel, ysource, options = {}, ymetadata) {
          ...
          this._ymetadata =
            ymetadata !== null && ymetadata !== void 0
              ? ymetadata
              : this.ymodel.get('metadata');
        ...
        get awareness() {
          var _a, _b, _c;
          return (_c =
            (_a = this._awareness) !== null && _a !== void 0
              ? _a
              : (_b = this.notebook) === null || _b === void 0
                ? void 0
                : _b.awareness) !== null && _c !== void 0
            ? _c
            : null;
        }
        /**
        ...
        get undoManager() {
          ...
          return (
            (_a = this.notebook) === null || _a === void 0
              ? void 0
              : _a.disableDocumentWideUndoRedo
          )
            ? this._undoManager
        ...
        clearUndoHistory() {
          var _a;
          (_a = this.undoManager) === null || _a === void 0
            ? void 0
            : _a.clear();
        }
        /**
        ...
        setMetadata(metadata, value) {
          ...
          if (typeof metadata === 'string') {
            ...
            if (
              index_js_.JSONExt.deepEqual(
                (_a = this.getMetadata(key)) !== null && _a !== void 0
                  ? _a
                  : null,
                value
              )
            ...
            this.transact(() => {
              ...
              if (key === 'collapsed') {
                const jupyter =
                  (_a = this.getMetadata('jupyter')) !== null && _a !== void 0
                    ? _a
                    : {};
            ...
            if (clone.collapsed != null) {
              ...
              ((_b =
                clone === null || clone === void 0 ? void 0 : clone.jupyter) ===
                null || _b === void 0
                ? void 0
                : _b.outputs_hidden) != null
            ) {
        ...
        getChanges(events) {
          ...
          const modelEvent = events.find(
            (event) => event.target === this.ymodel
          );
      ...
      class YCodeCell extends YBaseCell {
        ...
        get executionState() {
          var _a;
          return (_a = this.ymodel.get('execution_state')) !== null &&
            _a !== void 0
            ? _a
            : 'idle';
        }
        ...
        updateOutputs(start, end, outputs = [], origin = null) {
          const fin =
            end < this._youtputs.length
              ? end - start
              : this._youtputs.length - start;
          this.transact(
            () => {
      ...
      class YNotebook extends YDocument {
        ...
        constructor(options = {}) {
          ...
          this._onYCellsChanged = (event) => {
            ...
            event.changes.added.forEach((item) => {
              ...
              if (!this._ycellMapping.has(type)) {
                const c = createCellModelFromSharedType(type, {
                  notebook: this
                });
            ...
            event.changes.delta.forEach((d) => {
              if (d.insert != null) {
                const insertedCells = d.insert.map((ycell) =>
          ...
          this._disableDocumentWideUndoRedo =
            (_a = options.disableDocumentWideUndoRedo) !== null && _a !== void 0
              ? _a
              : false;
        ...
        static create(options = {}) {
          ...
          const ynotebook = new YNotebook({
            disableDocumentWideUndoRedo:
              (_a = options.disableDocumentWideUndoRedo) !== null &&
              _a !== void 0
                ? _a
                : false
          });
          const data = {
            cells:
              (_c =
                (_b = options.data) === null || _b === void 0
                  ? void 0
                  : _b.cells) !== null && _c !== void 0
                ? _c
                : [],
            nbformat:
              (_e =
                (_d = options.data) === null || _d === void 0
                  ? void 0
                  : _d.nbformat) !== null && _e !== void 0
                ? _e
                : 4,
            nbformat_minor:
              (_g =
                (_f = options.data) === null || _f === void 0
                  ? void 0
                  : _f.nbformat_minor) !== null && _g !== void 0
                ? _g
                : 5,
            metadata:
              (_j =
                (_h = options.data) === null || _h === void 0
                  ? void 0
                  : _h.metadata) !== null && _j !== void 0
                ? _j
                : {}
          };
        ...
        setMetadata(metadata, value) {
          ...
          if (typeof metadata === 'string') {
            ...
            if (
              index_js_.JSONExt.deepEqual(
                (_a = this.getMetadata(metadata)) !== null && _a !== void 0
                  ? _a
                  : null,
                value
              )
            ...
            if (
              !this.metadata ||
              !index_js_.JSONExt.deepEqual(this.metadata, metadata)
            ) {
              const clone = index_js_.JSONExt.deepCopy(metadata);
              const ymetadata = this.ymeta.get('metadata');
              // Transiently the metadata can be missing - like during destruction
...
//# sourceMappingURL=5521.05b348e542a3e578db7e.js.map?v=05b348e542a3e578db7e
