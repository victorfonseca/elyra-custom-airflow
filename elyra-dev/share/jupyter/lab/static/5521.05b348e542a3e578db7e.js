...
var yjs_mjs_ = __webpack_require__(74356);
...
/* harmony import */ var _object_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(70641);
/**
...
const equalityDeep = (a, b) => {
  ...
  switch (a.constructor) {
    ...
    case Object:
      if (_object_js__WEBPACK_IMPORTED_MODULE_0__/* .length */ .Bw(a) !== _object_js__WEBPACK_IMPORTED_MODULE_0__/* .length */ .Bw(b)) {
        return false
      }
      for (const key in a) {
        if (!_object_js__WEBPACK_IMPORTED_MODULE_0__/* .hasProperty */ .i5(a, key) || !equalityDeep(a[key], b[key])) {
          return false
        }
      }
      break
...
/* harmony export */ });
/* harmony import */ var _map_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(61662);
/* harmony import */ var _set_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(25404);
/* harmony import */ var _array_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(32421);
/**
...
class Observable {
  constructor () {
     ...
     * @type {Map<N, any>}
     */
    this._observers = _map_js__WEBPACK_IMPORTED_MODULE_0__/* .create */ .vt()
  }
   ...
   */
  on (name, f) {
    _map_js__WEBPACK_IMPORTED_MODULE_0__/* .setIfUndefined */ ._4(this._observers, name, _set_js__WEBPACK_IMPORTED_MODULE_1__/* .create */ .vt).add(f)
  }
  ...
  emit (name, args) {
    ...
    return _array_js__WEBPACK_IMPORTED_MODULE_2__/* .from */ .HT((this._observers.get(name) || _map_js__WEBPACK_IMPORTED_MODULE_0__/* .create */ .vt()).values()).forEach(f => f(...args))
  }
