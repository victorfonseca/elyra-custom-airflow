...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [8103],
  {
    /***/ 88103: /***/ (
      ...
      var index_js_ = __webpack_require__(45145); // CONCATENATED MODULE: ./node_modules/@lezer/javascript/dist/index.es.js
   ...
   expressed by lezer's built-in tokenizer. */
      ...
      const insertSemicolon = new dist /* ExternalTokenizer */.Lu(
        (input, stack) => {
          let { next } = input;
          if (
      ...
      const noSemicolon = new dist /* ExternalTokenizer */.Lu(
        (input, stack) => {
          let { next } = input,
            after;
      ...
      const incdecToken = new dist /* ExternalTokenizer */.Lu(
        (input, stack) => {
          let { next } = input;
      ...
      const jsHighlight = (0, index_js_.styleTags)({
        ...
        'for while do if else switch try catch finally return throw break continue default case':
          index_js_.tags.controlKeyword,
        'in of await yield void typeof delete instanceof':
          index_js_.tags.operatorKeyword,
        'let var const function class extends':
          index_js_.tags.definitionKeyword,
        ...
        'CallExpression/VariableName TaggedTemplateExpression/VariableName':
          index_js_.tags.function(index_js_.tags.variableName),
        VariableDefinition: index_js_.tags.definition(
          index_js_.tags.variableName
        ),
        Label: index_js_.tags.labelName,
        PropertyName: index_js_.tags.propertyName,
        PrivatePropertyName: index_js_.tags.special(
          index_js_.tags.propertyName
        ),
        'CallExpression/MemberExpression/PropertyName': index_js_.tags.function(
          index_js_.tags.propertyName
        ),
        'FunctionDeclaration/VariableDefinition': index_js_.tags.function(
          index_js_.tags.definition(index_js_.tags.variableName)
        ),
        'ClassDeclaration/VariableDefinition': index_js_.tags.definition(
          index_js_.tags.className
        ),
        PropertyDefinition: index_js_.tags.definition(
          index_js_.tags.propertyName
        ),
        PrivatePropertyDefinition: index_js_.tags.definition(
          index_js_.tags.special(index_js_.tags.propertyName)
        ),
        ...
        'InterpolationStart InterpolationEnd': index_js_.tags.special(
          index_js_.tags.brace
        ),
        ...
        'JSXAttribute/JSXIdentifier JSXAttribute/JSXNameSpacedName':
          index_js_.tags.attributeName,
        'JSXBuiltin/JSXIdentifier': index_js_.tags.standard(
          index_js_.tags.tagName
        )
      });
      ...
      const parser = dist /* LRParser */.U1.deserialize({
        ...
        specialized: [
          { term: 311, get: (value) => spec_identifier[value] || -1 },
          { term: 327, get: (value) => spec_word[value] || -1 },
      ...
      var state_dist_index_js_ = __webpack_require__(71674);
      ...
      var view_dist_index_js_ = __webpack_require__(22819);
      ...
      var common_dist_index_js_ = __webpack_require__(66575); // CONCATENATED MODULE: ./node_modules/@codemirror/lang-javascript/dist/index.js
      /**
A collection of JavaScript-related
[snippets](https://codemirror.net/6/docs/ref/#autocomplete.snippet).
*/
      const snippets = [
        /*@__PURE__*/ (0, autocomplete_dist /* snippetCompletion */.Gw)(
...
*/
      ...
      function getScope(doc, node) {
        ...
        node
          .cursor(common_dist_index_js_.IterMode.IncludeAnonymous)
          .iterate((node) => {
            if (top) {
              top = false;
            } else if (node.name) {
...
*/
      function localCompletionSource(context) {
        let inner = (0, dist_index_js_.syntaxTree)(context.state).resolveInner(
          context.pos,
          -1
        );
      ...
      function scopeCompletionSource(scope) {
        ...
        return (context) => {
          ...
          if (!options)
            cache.set(
              target,
              (options = enumeratePropertyCompletions(
                target,
                !path.path.length
              ))
            );
...
*/
          ...
          parser: /*@__PURE__*/ parser.configure({
            props: [
              /*@__PURE__*/ dist_index_js_.indentNodeProp.add({
                IfStatement: /*@__PURE__*/ (0, dist_index_js_.continuedIndent)({
                  except: /^\s*({|else\b)/
                }),
                TryStatement: /*@__PURE__*/ (0, dist_index_js_.continuedIndent)(
                ...
                Block: /*@__PURE__*/ (0, dist_index_js_.delimitedIndent)({
                  closing: '}'
                }),
                ArrowFunction: (cx) => cx.baseIndent + cx.unit,
                'TemplateString BlockComment': () => null,
                'Statement Property': /*@__PURE__*/ (0,
                dist_index_js_.continuedIndent)({ except: /^{/ }),
                JSXElement(context) {
      ...
      const jsxSublanguage = {
        ...
        facet: /*@__PURE__*/ (0, dist_index_js_.defineLanguageFacet)({
...
*/
      const jsxLanguage = /*@__PURE__*/ javascriptLanguage.configure({
        dialect: 'jsx',
        props: [
          /*@__PURE__*/ dist_index_js_.sublanguageProp.add((n) =>
      ...
      function javascript(config = {}) {
        ...
        return new dist_index_js_.LanguageSupport(lang, [
          javascriptLanguage.data.of({
            autocomplete: (0, autocomplete_dist /* ifNotIn */.Ar)(
              dontComplete,
              (0, autocomplete_dist /* completeFromList */.et)(completions)
            )
          }),
          javascriptLanguage.data.of({
...
*/
      const autoCloseTags =
        /*@__PURE__*/ view_dist_index_js_.EditorView.inputHandler.of(
          (view, from, to, text, defaultInsert) => {
            ...
            let closeTags = state.changeByRange((range) => {
              var _a;
              let { head } = range,
                around = (0, dist_index_js_.syntaxTree)(state).resolveInner(
                  head - 1,
                  -1
                ),
                name;
              ...
              if (
                ...
                if (
                  ...
                  let insert = `${name}>`;
                  return {
                    range: state_dist_index_js_.EditorSelection.cursor(
                      head + insert.length,
                      -1
                    ),
...
//# sourceMappingURL=8103.245762f29e5ab0faf9c9.js.map?v=245762f29e5ab0faf9c9
