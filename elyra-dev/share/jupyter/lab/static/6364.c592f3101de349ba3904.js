    ...
    65791: (t, e, r) => {
      ...
      class w {
        ...
        edge(t, e, r) {
          var a =
            arguments.length === 1
              ? E(this._isDirected, arguments[0])
              : v(this._isDirected, t, e, r);
    ...
    46364: (t, e, r) => {
          ...
          performAction: (0, o.K2)(function t(e, r, a, s, i, n, o) {
            ...
            switch (i) {
              ...
              case 23:
                ...
                this.$ = [
                  ...
                  },
                  {
                    id: n[l].id,
                    label: n[l].label,
                    type: s.typeStr2Type(n[l].typeStr),
                    directions: n[l].directions
                  }
                ];
                break;
              ...
              case 26:
                ...
                this.$ = {
                  type: 'column-setting',
                  columns: n[l] === 'auto' ? -1 : parseInt(n[l])
                };
                break;
              case 27:
                s.getLogger().debug(
      ...
      function ut(t, e, r = 0, a = 0) {
        ...
        if (t.children?.length > 0) {
          ...
          for (const e of t.children) {
            if (e.size) {
              o.Rm.debug(
                `abc95 Setting size of children of ${t.id} id=${e.id} ${s} ${i} ${JSON.stringify(e.size)}`
              );
              e.size.width =
                s * (e.widthInColumns ?? 1) +
                ct * ((e.widthInColumns ?? 1) - 1);
              e.size.height = i;
              e.size.x = 0;
              e.size.y = 0;
              o.Rm.debug(
                `abc95 updating size of ${t.id} children child:${e.id} maxWidth:${s} maxHeight:${i}`
              );
            }
          }
          for (const r of t.children) {
          ...
          if (u < r) {
            o.Rm.debug(
              `Detected to small siebling: abc95 ${t.id} sieblingWidth ${r} sieblingHeight ${a} width ${u}`
            );
            u = r;
            g = a;
            const e = (r - h * ct - ct) / h;
          ...
          o.Rm.debug(
            `abc95 (finale calc) ${t.id} xSize ${h} ySize ${d} columns ${l}${t.children.length} width=${Math.max(u, t.size?.width || 0)}`
          );
          if (u < (t?.size?.width || 0)) {
            u = t?.size?.width || 0;
            const e =
              l > 0 ? Math.min(t.children.length, l) : t.children.length;
            if (e > 0) {
              const r = (u - e * ct - ct) / e;
              o.Rm.debug(
        ...
        if (t.children && t.children.length > 0) {
          ...
          for (const c of t.children) {
            ...
            if (a.size) {
              ...
              c.size.x = n + ct + t;
              o.Rm.debug(
                `abc91 layout blocks (calc) px, pyid:${c.id} startingPos=X${n} new startingPosX${c.size.x} ${t} padding=${ct} width=${s} halfWidth=${t} => x:${c.size.x} y:${c.size.y} ${c.widthInColumns} (width * (child?.w || 1)) / 2 ${(s * (c?.widthInColumns ?? 1)) / 2}`
              );
              n = c.size.x + t;
              c.size.y =
                a.size.y - a.size.height / 2 + u * (h + ct) + h / 2 + ct;
              o.Rm.debug(
                `abc88 layout blocks (calc) px, pyid:${c.id}startingPosX${n}${ct}${t}=>x:${c.size.x}y:${c.size.y}${c.widthInColumns}(width * (child?.w || 1)) / 2${(s * (c?.widthInColumns ?? 1)) / 2}`
              );
            }
            if (c.children) {
              gt(c, e);
        ...
        if (t.children) {
          for (const i of t.children) {
            ({
              ...
              maxX: a,
              maxY: s
            } = pt(i, { minX: e, minY: r, maxX: a, maxY: s }));
          }
        }
      ...
      var Dt = (0, o.K2)((t, e) => {
        ...
        if (t.startLabelLeft) {
          ...
          let s = t.y;
          if (r) {
            const e = n._K.calcTerminalLabelPosition(
      ...
      var Kt = (0, o.K2)((t, e, r) => {
        ...
        if (Math.abs(s - e.y) * n > Math.abs(a - e.x) * c) {
          ...
          o.Rm.debug(`sides calc abc89, Q ${h}, q ${t}, R ${d}, r ${l}`, {
            _x: s,
            _y: i
          });
          if (l === 0) {
      ...
      var Ct = (0, o.K2)(function (t, e, r, s, i, n, l) {
        ...
        let w = '';
        if (
          (0, o.D7)().flowchart.arrowMarkerAbsolute ||
          (0, o.D7)().state.arrowMarkerAbsolute
        ) {
          w =
      ...
      var Zt = (0, o.K2)(async (t, e, r, a) => {
        ...
        if (e.labelType === 'markdown') {
          ...
          y = p.appendChild(
            mt((0, o.jZ)((0, n.Sm)(g), s), e.labelStyle, false, a)
          );
        }
        let f = y.getBBox();
        const b = e.padding / 2;
      ...
      var Jt = (0, o.K2)(async (t, e) => {
        ...
        const {
          ...
          bbox: s,
          halfPadding: i
        } = await Zt(t, e, 'node ' + e.classes, true);
      ...
      var te = (0, o.K2)(
        (t, e) => `${e ? e : 'node default'}${Qt(t.classes)} ${Qt(t.class)}`,
        'getClassesFromNode'
      );
      ...
      var ue = (0, o.K2)(async (t, e) => {
        const {
          ...
          bbox: a,
          halfPadding: s
        } = await Zt(t, e, 'node ' + e.classes + ' ' + e.class, true);
      ...
      var fe = (0, o.K2)((t, e) => {
        ...
        const y = n
          .node()
          .appendChild(
            mt(g.join ? g.join('<br/>') : g, e.labelStyle, true, true)
          );
        if ((0, o._3)((0, o.D7)().flowchart.htmlLabels)) {
          const t = y.children[0];
          const e = (0, d.Ltv)(y);
        ...
        n.attr(
          'transform',
          'translate(' + -u.width / 2 + ', ' + (-u.height / 2 - f + 3) + ')'
        );
      ...
      var ve = (0, o.K2)((t, e) => {
        ...
        const b = e.classData.annotations[0]
        ...
        e.classData.members.forEach((t) => {
          ...
          const i = p
            .node()
            .appendChild(
              mt(s, r.cssStyle ? r.cssStyle : e.labelStyle, true, true)
            );
          let n = i.getBBox();
          if ((0, o._3)((0, o.D7)().flowchart.htmlLabels)) {
      ...
      var Be = (0, o.K2)(async function (t, e, r, a) {
        ...
        const c =
          s === 'sandbox'
            ? (0, d.Ltv)(l.nodes()[0].contentDocument.body)
            : (0, d.Ltv)('body');
        const h =
          s === 'sandbox' ? c.select(`[id="${e}"]`) : (0, d.Ltv)(`[id="${e}"]`);
