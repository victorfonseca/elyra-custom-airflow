...
(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [6294],
  {
    26294: (e, t, n) => {
      ...
      var c = r('catch class do else finally for if switch try while');
      var p = r('true false null');
      var f = { '#': a };
      var d = /[+\-*&%=<>!?|\/]/;
      var m;
      function h(e, t) {
        ...
        if (i.propertyIsEnumerable(a)) {
          if (c.propertyIsEnumerable(a)) m = 'newstatement';
          return 'keyword';
        } else if (o.propertyIsEnumerable(a)) {
          if (c.propertyIsEnumerable(a)) m = 'newstatement';
          return 'variable';
        } else if (l.propertyIsEnumerable(a)) {
          if (c.propertyIsEnumerable(a)) m = 'newstatement';
          return 'modifier';
        } else if (s.propertyIsEnumerable(a)) {
          if (c.propertyIsEnumerable(a)) m = 'newstatement';
          return 'type';
        } else if (u.propertyIsEnumerable(a)) {
          if (c.propertyIsEnumerable(a)) m = 'newstatement';
          return 'builtin';
        } else {
          var h = a.length - 1;
          while (h >= 0 && (!isNaN(a[h]) || a[h] == '_')) --h;
          if (h > 0) {
            var b = a.substr(0, h + 1);
            if (s.propertyIsEnumerable(b)) {
              if (c.propertyIsEnumerable(b)) m = 'newstatement';
              return 'type';
            }
          }
        }
        if (p.propertyIsEnumerable(a)) return 'atom';
        return null;
      }
      function y(e) {
        return function (t, n) {
      ...
      const k = {
        ...
        token: function (e, t) {
          ...
          if ((m == ';' || m == ':') && n.type == 'statement') w(t);
          else if (m == '{') g(t, e.column(), '}');
          else if (m == '[') g(t, e.column(), ']');
          else if (m == '(') g(t, e.column(), ')');
          else if (m == '}') {
            while (n.type == 'statement') n = w(t);
            if (n.type == '}') n = w(t);
            while (n.type == 'statement') n = w(t);
          } else if (m == n.type) w(t);
          else if (
            n.type == '}' ||
            n.type == 'top' ||
            (n.type == 'statement' && m == 'newstatement')
          )
        ...
        indent: function (e, t, n) {
          if (e.tokenize != h && e.tokenize != null) return 0;
          var r = e.context,
            a = t && t.charAt(0);
          if (r.type == 'statement' && a == '}') r = r.prev;
          var i = a == r.type;
          if (r.type == 'statement')
            return r.indented + (a == '{' ? 0 : n.unit);
          else if (r.align) return r.column + (i ? 0 : 1);
          else return r.indented + (i ? 0 : n.unit);
        },
