(self['webpackChunk_jupyterlab_application_top'] =
  ...
  [6733],
  {
    /***/ 26733: /***/ (
      ...
      __webpack_require__.d(__webpack_exports__, {
        ADDITIONAL_PROPERTIES_KEY: () =>
          /* reexport */ ADDITIONAL_PROPERTIES_KEY,
        ...
        RJSF_ADDITONAL_PROPERTIES_FLAG: () =>
          /* reexport */ RJSF_ADDITONAL_PROPERTIES_FLAG,
        ...
        getDiscriminatorFieldFromSchema: () =>
          /* reexport */ getDiscriminatorFieldFromSchema,
        ...
        getOptionMatchingSimpleDiscriminator: () =>
          /* reexport */ getOptionMatchingSimpleDiscriminator,
        ...
        mergeDefaultsWithFormData: () =>
          /* reexport */ mergeDefaultsWithFormData,
      ...
      const UI_GLOBAL_OPTIONS_KEY = 'ui:globalOptions'; // CONCATENATED MODULE: ./node_modules/@rjsf/utils/lib/getUiOptions.js
      ...
      var isPlainObject_default =
        /*#__PURE__*/ __webpack_require__.n(isPlainObject); // CONCATENATED MODULE: ./node_modules/@rjsf/utils/lib/createErrorHandler.js
      ...
      var isEqualWith = __webpack_require__(29132);
      var isEqualWith_default =
        /*#__PURE__*/ __webpack_require__.n(isEqualWith); // CONCATENATED MODULE: ./node_modules/@rjsf/utils/lib/deepEquals.js
      ...
      var omit_default = /*#__PURE__*/ __webpack_require__.n(omit); // CONCATENATED MODULE: ./node_modules/@rjsf/utils/lib/findSchemaDefinition.js
      ...
      var lodash_isObject = __webpack_require__(23805);
      var isObject_default =
        /*#__PURE__*/ __webpack_require__.n(lodash_isObject);
      // EXTERNAL MODULE: ./node_modules/lodash/isString.js
      var isString = __webpack_require__(85015);
      var isString_default = /*#__PURE__*/ __webpack_require__.n(isString);
      // EXTERNAL MODULE: ./node_modules/lodash/reduce.js
      var reduce = __webpack_require__(40860);
      var reduce_default = /*#__PURE__*/ __webpack_require__.n(reduce);
      // EXTERNAL MODULE: ./node_modules/lodash/times.js
      var times = __webpack_require__(6638);
      var times_default = /*#__PURE__*/ __webpack_require__.n(times); // CONCATENATED MODULE: ./node_modules/@rjsf/utils/lib/getOptionMatchingSimpleDiscriminator.js
      ...
      function getOptionMatchingSimpleDiscriminator(
        ...
        if (formData && discriminatorField) {
          ...
          for (let i = 0; i < options.length; i++) {
            ...
            const discriminator = get_default()(
              option,
      ...
      function getMatchingOption(
        ...
        for (let i = 0; i < options.length; i++) {
          ...
          if (
            discriminatorField &&
            has_default()(option, [PROPERTIES_KEY, discriminatorField])
          ) {
            const value = get_default()(formData, discriminatorField);
            const discriminator = get_default()(
              option,
      ...
      var src_default = /*#__PURE__*/ __webpack_require__.n(src); // CONCATENATED MODULE: ./node_modules/@rjsf/utils/lib/getDiscriminatorFieldFromSchema.js
      ...
      var union_default = /*#__PURE__*/ __webpack_require__.n(union); // CONCATENATED MODULE: ./node_modules/@rjsf/utils/lib/getSchemaType.js
          ...
          (permutations, list) => {
            ...
            if (list.length > 1) {
              return list.flatMap((element) =>
                times_default()(permutations.length, (i) =>
      ...
      function resolveAllReferences(schema, rootSchema, recurseList) {
        ...
        if (PROPERTIES_KEY in resolvedSchema) {
          const updatedProps = transform_default()(
        ...
        return isEqual_default()(schema, resolvedSchema)
          ? schema
          : resolvedSchema;
      }
      ...
      function processDependencies(
        ...
        for (const dependencyKey in dependencies) {
          ...
          if (
            !expandAllBranches &&
            get_default()(formData, [dependencyKey]) === undefined
          ) {
            continue;
          }
          ...
          const [remainingDependencies, dependencyValue] =
            splitKeyElementFromObject(dependencyKey, dependencies);
          ...
          if (isObject_default()(schema.properties)) {
            totalScore += reduce_default()(
              ...
              (score, value, key) => {
                ...
                if (
                  (has_default()(value, ONE_OF_KEY) ||
                    has_default()(value, ANY_OF_KEY)) &&
                  formValue
                ) {
                  const key = has_default()(value, ONE_OF_KEY)
                    ? ONE_OF_KEY
                    : ANY_OF_KEY;
            ...
            isString_default()(schema.type) &&
            schema.type === guessType(formData)
          ) {
            totalScore += 1;
          }
        }
      ...
      function getClosestMatchingOption(
        ...
        if (!allValidIndexes.length) {
          ...
          times_default()(resolvedOptions.length, (i) =>
      ...
      function isSelect(validator, theSchema, rootSchema = {}) {
        ...
        if (Array.isArray(altSchemas)) {
          return altSchemas.every(
            (altSchemas) =>
              typeof altSchemas !== 'boolean' && isConstant(altSchemas)
          );
        }
        return false;
      ...
      function maybeAddDefaultToObject(
        ...
        if (includeUndefinedValues) {
          ...
          if (isObject(computedDefault)) {
            ...
            if (
              (!isEmpty_default()(computedDefault) ||
                requiredFields.includes(key)) &&
      ...
      function computeDefaults(
          ...
          schemaToCompute =
            oneOf[
              getClosestMatchingOption(
                validator,
                rootSchema,
                isEmpty_default()(formData) ? undefined : formData,
                oneOf,
                0,
                discriminator
              )
        ...
        switch (getSchemaType(schema)) {
            ...
            const objectDefaults = Object.keys(schema.properties || {}).reduce(
              (acc, key) => {
                ...
                const computedDefault = computeDefaults(
                  validator,
                  get_default()(schema, [PROPERTIES_KEY, key]),
                  {
                    rootSchema,
                    _recurseList,
                    experimental_defaultFormStateBehavior,
          ...
          case 'array': {
            ...
            const defaultsLength = Array.isArray(defaults)
              ? defaults.length
              : 0;
            if (
              !schema.minItems ||
      ...
      function sanitizeDataForNewSchema(
        ...
        if (has_default()(newSchema, PROPERTIES_KEY)) {
          ...
          const keys = Object.keys(
            get_default()(newSchema, PROPERTIES_KEY, {})
          );
          // Create a place to store nested data that will be a side-effect of the filter
          const nestedData = {};
          keys.forEach((key) => {
            const formValue = get_default()(data, key);
            let oldKeyedSchema = get_default()(
              oldSchema,
              [PROPERTIES_KEY, key],
              {}
            );
            let newKeyedSchema = get_default()(
              newSchema,
              [PROPERTIES_KEY, key],
              {}
            );
            ...
            if (
              ...
              if (
                ...
                const newOptionDefault = get_default()(
                  newKeyedSchema,
                  'default',
                  NO_VALUE
                );
                const oldOptionDefault = get_default()(
                  oldKeyedSchema,
                  'default',
                  NO_VALUE
                );
                if (
                  ...
                  if (oldOptionDefault === formValue) {
                    ...
                    get_default()(newKeyedSchema, 'readOnly') === true
                  ) {
                    // If the new schema has the default set to read-only, treat it like a const and remove the value
                    removeOldSchemaData[key] = undefined;
                  }
                }
                const newOptionConst = get_default()(
                  newKeyedSchema,
                  'const',
                  NO_VALUE
                );
                const oldOptionConst = get_default()(
                  oldKeyedSchema,
                  'const',
                  NO_VALUE
                );
          ...
          get_default()(oldSchema, 'type') === 'array' &&
          get_default()(newSchema, 'type') === 'array' &&
          Array.isArray(data)
        ) {
      ...
      function toIdSchemaInternal(
        ...
        if (
          ITEMS_KEY in schema &&
          !get_default()(schema, [ITEMS_KEY, REF_KEY])
        ) {
          return toIdSchemaInternal(
            validator,
            get_default()(schema, ITEMS_KEY),
            idPrefix,
            idSeparator,
            id,
            rootSchema,
      ...
      var isNil_default = /*#__PURE__*/ __webpack_require__.n(isNil); // CONCATENATED MODULE: ./node_modules/@rjsf/utils/lib/enumOptionsSelectValue.js
      ...
      var cloneDeep_default = /*#__PURE__*/ __webpack_require__.n(cloneDeep); // CONCATENATED MODULE: ./node_modules/@rjsf/utils/lib/ErrorSchemaBuilder.js
      ...
      class ErrorSchemaBuilder {
        ...
        getOrCreateErrorBlock(pathOfError) {
          ...
          let errorBlock = hasPath
            ? get_default()(this.errorSchema, pathOfError)
            : this.errorSchema;
        ...
        resetAllErrors(initialSchema) {
          this.errorSchema = initialSchema
            ? cloneDeep_default()(initialSchema)
            : {};
          return this;
        }
      ...
      var react_is = __webpack_require__(44363); // CONCATENATED MODULE: ./node_modules/@rjsf/utils/lib/getWidget.js
      ...
      function mergeWidgetOptions(AWidget) {
        ...
        if (!MergedWidget) {
          ...
          MergedWidget = ({ options, ...props }) => {
            return (0, jsx_runtime.jsx)(AWidget, {
      ...
      function getWidget(schema, widget, registeredWidgets = {}) {
        ...
        if (
          ...
          (widget &&
            react_is.isForwardRef((0, index_js_.createElement)(widget))) ||
          ...
          return schema.enum.map((value, i) => {
            const label =
              (schemaWithEnumNames.enumNames &&
                schemaWithEnumNames.enumNames[i]) ||
              String(value);
            return { label, value };
          });
        }
      ...
      var toPath_default = /*#__PURE__*/ __webpack_require__.n(toPath); // CONCATENATED MODULE: ./node_modules/@rjsf/utils/lib/toErrorSchema.js
      ...
      var forEach_default = /*#__PURE__*/ __webpack_require__.n(forEach); // CONCATENATED MODULE: ./node_modules/@rjsf/utils/lib/parser/ParserValidator.js
    ...
    /***/ 5109: /***/ (
      ...
      const flatten = __webpack_require__(35970);
      const flattenDeep = __webpack_require__(3176);
      const isPlainObject = __webpack_require__(11331);
      const uniq = __webpack_require__(63375);
      const uniqWith = __webpack_require__(9063);
      const without = __webpack_require__(91648);
    ...
    /***/ 11051: /***/ (
      ...
      const compare = __webpack_require__(90370);
      const forEach = __webpack_require__(39754);
      const {
        allUniqueKeys,
        deleteUndefinedProps,
        has,
    ...
    /***/ 33978: /***/ (
      ...
      const compare = __webpack_require__(90370);
      const computeLcm = __webpack_require__(78867);
      const defaultsDeep = __webpack_require__(74354);
      const flatten = __webpack_require__(35970);
      const flattenDeep = __webpack_require__(3176);
      const intersection = __webpack_require__(5287);
      const intersectionWith = __webpack_require__(80191);
      const isEqual = __webpack_require__(2404);
      const isPlainObject = __webpack_require__(11331);
      const pullAll = __webpack_require__(12358);
      const sortBy = __webpack_require__(33031);
      const uniq = __webpack_require__(63375);
      const uniqWith = __webpack_require__(9063);

      const propertiesResolver = __webpack_require__(7894);
      const itemsResolver = __webpack_require__(11051);
    ...
    /***/ 56239: /***/ (__unused_webpack_module, exports) => {
      var hasExcape = /~/;
    ...
    /***/ 87805: /***/ (
      ...
      var baseAssignValue = __webpack_require__(98598),
    ...
    /***/ 22799: /***/ (__unused_webpack_module, exports) => {
      'use strict';
      /**
       * @license React
...
//# sourceMappingURL=6733.eaeb7a44d6e8f8522d8d.js.map?v=eaeb7a44d6e8f8522d8d
